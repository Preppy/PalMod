...
static_assert(ARRAYSIZE(g_GameFriendlyName) == 169, "Increment the value check here once you've determined whether or not you want to add the new game into the above array.");
