...
sSupportedGameList SupportedGameList[] =
{
    ...
    { KOF02UM_S,        L"KOF02UM for Steam", L"KOF02UM|pal_a*.bin;bar.bin;max2bg.bin|", GamePlatform::Steam },
    ...
    { RBFF1_A,          L"Real Bout Fatal Fury", L"Real Bout Fatal Fury|095-p1.*|", GamePlatform::NEOGEO },
