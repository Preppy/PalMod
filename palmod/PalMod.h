...
const DWORD PAL_MAXWIDTH_8COLORSPERLINE = 8;
const DWORD PAL_MAXWIDTH_16COLORSPERLINE = 16;
const DWORD PAL_MAXAMT_8COLORSPERLINE = 128;
const DWORD PAL_MAXAMT_16COLORSPERLINE = 256;
