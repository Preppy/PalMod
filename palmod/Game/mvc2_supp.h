...
namespace MVC2_SupplementProcessing
{
    ...
    const std::vector<UINT16> mvc2_6color_supp_const =
    {
        //Special copy:
        //Cyclops
        //Chun-Li
    ...
    // We have to fork this in order to accommodate for the non-linear extras in the expansion.
    ...
    const std::vector<UINT16> mvc2_16color_supp_const =
    {
        //Special copy:
        //Cyclops
        //Chun-Li
