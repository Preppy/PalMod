...
class CGame_KOFEX2_GBA : public CGameClassByDir
{
private:
    ...
    {
        {
            ...
            { L"King of Fighters EX 2, The - Howling Blood (USA).gba", 0x800000 },
        },
    ...
    const sCoreGameData m_sCoreGameData
    {
        ...
        L"The King of Fighters EX2: Howling Blood (GBA)",
...
public:
    CGame_KOFEX2_GBA(uint32_t nConfirmedROMSize = -1) { InitializeGame(nConfirmedROMSize, m_sCoreGameData); };
