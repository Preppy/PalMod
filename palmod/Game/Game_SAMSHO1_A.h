...
class CGame_SAMSHO1_PS2 : public CGameClassByDir
{
private:
    static inline const sDirectoryLoadingData m_sFileLoadingData =
    {
        {
            { L"samsho.rom", 0x180000, INVALID_UNIT_VALUE_16, true, L"u_sam1.afs", 0xc3c800 },
        },
        FileReadType::Sequential,
    };
    ...
    const std::vector<sCRC32ValueSet> m_rgCRC32Data =
    {
        { L"Samurai Shodown (PS2)", L"samsho.rom", 0x13049404, 0 },
        { L"Samurai Shodown (PS2 AFS)", L"u_sam1.afs", 0xAE06BDA2, 0x5c000 },
    };
...
public:
    CGame_SAMSHO1_PS2(uint32_t nConfirmedROMSize) { InitializeGame(nConfirmedROMSize, m_sCoreGameData); };
