...
size_t CGame_KOF95_A::rgExtraCountAll[KOF95_A_NUMUNIT + 1];
size_t CGame_KOF95_A::rgExtraLoc[KOF95_A_NUMUNIT + 1];
...
sFileRule CGame_KOF95_A::GetRule(size_t nUnitId)
{
...
size_t CGame_KOF95_A::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, KOF95_A_NUMUNIT, nUnitId, KOF95_A_EXTRA_CUSTOM);
}

size_t CGame_KOF95_A::GetExtraLoc(size_t nUnitId)
{
...
size_t CGame_KOF95_A::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_KOF95_A::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_KOF95_A::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(KOF95_A_UNITS, KOF95_A_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_KOF95_A::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_KOF95_A::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(KOF95_A_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_KOF95_A::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_KOF95_A::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_KOF95_A::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
