...
const sGame_PaletteDataset MVC_A_ROLL_PALETTES_P1[] =
{
    ...
    { "P1 Beat Plane 1", 0x4d9a4, 0x4d9c4, 0x1C, 0x26 },
    { "P1 Beat Plane 2", 0x4d9c4, 0x4d9e4, 0x1C, 0x26 },
    { "P1 Beat Plane 3", 0x4d9e4, 0x4da04, 0x1C, 0x26 },
    { "P1 Beat Plane 4", 0x4da04, 0x4da24, 0x1C, 0x26 },
    { "P1 Beat Plane 5", 0x4da24, 0x4da44, 0x1C, 0x26 },
    { "P1 Beat Plane 6", 0x4da44, 0x4da64, 0x1C, 0x26 },
    { "P1 Beat Plane 7", 0x4da64, 0x4da84, 0x1C, 0x26 },
    { "P1 Beat Plane 8", 0x4da84, 0x4daa4, 0x1C, 0x26 },
    { "P1 Beat Plane 9", 0x4daa4, 0x4dac4, 0x1C, 0x26 },
...
const sGame_PaletteDataset MVC_A_ROLL_PALETTES_P2[] =
{
    ...
    { "P2 Beat Plane 1", 0x4e484, 0x4e4a4, 0x1C, 0x26 },
    { "P2 Beat Plane 2", 0x4e4a4, 0x4e4c4, 0x1C, 0x26 },
    { "P2 Beat Plane 3", 0x4e4c4, 0x4e4e4, 0x1C, 0x26 },
    { "P2 Beat Plane 4", 0x4e4e4, 0x4e504, 0x1C, 0x26 },
    { "P2 Beat Plane 5", 0x4e504, 0x4e524, 0x1C, 0x26 },
    { "P2 Beat Plane 6", 0x4e524, 0x4e544, 0x1C, 0x26 },
    { "P2 Beat Plane 7", 0x4e544, 0x4e564, 0x1C, 0x26 },
    { "P2 Beat Plane 8", 0x4e564, 0x4e584, 0x1C, 0x26 },
    { "P2 Beat Plane 9", 0x4e584, 0x4e5a4, 0x1C, 0x26 },
...
const sGame_PaletteDataset MVC_A_ASSIST_PALETTES[] =
{
    ...
    { "Devilot P1: Dave and Xavier", 0x510e4, 0x51104, 0x3C, 6 },
    ...
    { "Devilot P2: Dave and Xavier", 0x51144, 0x51164, 0x3C, 6 },
    { "Devilot P2: Platform", 0x51164, 0x51184, 0x3C, 2 },
    { "Devilot P2: Burnt", 0x511c4, 0x511e4, 0x3C, 3, true },
    { "Devilot P2: Burnt Dave and Xavier", 0x511e4, 0x51204, 0x3C, 5 },
