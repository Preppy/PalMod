...
const sGame_PaletteDataset MVC_A_MEGAMAN_PALETTES_P1[] =
{
    ...
    { "P1 Beat 1", 0x4c2c4, 0x4c2e4, 0x1C, 0x02 }, // 1D
    ...
    { "P1 Rush Drill Metal 1", 0x4c9e4 + 0x00, 0x4c9e4 + 0x20, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 2", 0x4c9e4 + 0x20, 0x4c9e4 + 0x40, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 3", 0x4c9e4 + 0x40, 0x4c9e4 + 0x60, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 4", 0x4c9e4 + 0x60, 0x4c9e4 + 0x80, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 5", 0x4c9e4 + 0x80, 0x4c9e4 + 0xA0, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 6", 0x4c9e4 + 0xA0, 0x4c9e4 + 0xC0, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 7", 0x4c9e4 + 0xC0, 0x4c9e4 + 0xE0, 0x1D, 0x0C },
    { "P1 Rush Drill Metal 8", 0x4c9e4 + 0xE0, 0x4c9e4 + 0x100, 0x1D, 0x0C },
...
const sGame_PaletteDataset MVC_A_MEGAMAN_PALETTES_P2[] =
{
    ...
    { "P2 Rush Drill Metal 1", 0x4d4c4 + 0x00, 0x4d4c4 + 0x20, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 2", 0x4d4c4 + 0x20, 0x4d4c4 + 0x40, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 3", 0x4d4c4 + 0x40, 0x4d4c4 + 0x60, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 4", 0x4d4c4 + 0x60, 0x4d4c4 + 0x80, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 5", 0x4d4c4 + 0x80, 0x4d4c4 + 0xA0, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 6", 0x4d4c4 + 0xA0, 0x4d4c4 + 0xC0, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 7", 0x4d4c4 + 0xC0, 0x4d4c4 + 0xE0, 0x1D, 0x0C },
    { "P2 Rush Drill Metal 8", 0x4d4c4 + 0xE0, 0x4d4c4 + 0x100, 0x1D, 0x0C },
...
const sGame_PaletteDataset MVC_A_ONSLAUGHT_PALETTES[] =
{
    ...
    { "Main Body & Arm (2nd Form)", 0x4BBA4, 0x4BBC4, 0x3B, 0x04 },
    ...
    { "Hyper Grav", 0x4BCA4, 0x4BCC4, 0x3B, 0x05 },
...
{
 { "Captain America P1 VSP", 0x0055e44, 0x0055f04, 0x0B, 0x13},
    { "Captain America P2 VSP", 0x0057104, 0x00571c4, 0x0B, 0x13},
    { "Captain Commando P1 VSP", 0x0056444, 0x0056504, 0x38, 0x13},
    { "Captain Commando P2 VSP", 0x0057704, 0x00577c4, 0x38, 0x13},
    { "Chun-Li P1 VSP", 0x0056504, 0x00565c4, 0x1B, 0x13},
    { "Chun-Li P2 VSP", 0x00577c4, 0x0057884, 0x1B, 0x13},
    { "Shadow Lady P1 VSP", 0x0056c84, 0x0056d44, 0x1B, 0x13},
    { "Shadow Lady P2 VSP", 0x0057f44, 0x0058004, 0x1B, 0x13},
    { "Gambit P1 VSP", 0x0056084, 0x0056144, 0x28, 0x13},
    { "Gambit P2 VSP", 0x0057344, 0x0057404, 0x28, 0x13},
    ...
    { "Jin P1 VSP", 0x00565c4, 0x0056684, 0x37, 0x13},
    { "Jin P2 VSP", 0x0057884, 0x0057944, 0x37, 0x13},
    { "Megaman P1 VSP", 0x00568c4, 0x0056944, 0x1C, 0x13 },
    { "Megaman P2 VSP", 0x0057b84, 0x0057c04, 0x1C, 0x13 },
    { "Morrigan P1 VSP", 0x0056804, 0x00568c4, 0x03, 0x13},
    { "Morrigan P2 VSP", 0x0057ac4, 0x0057b84, 0x03, 0x13},
    { "Lilith P1 VSP", 0x0056d44, 0x0056e04, 0x03, 0x13},
    { "Lilith P2 VSP", 0x0058004, 0x00580c4, 0x03, 0x13},
    { "Onslaught P1 VSP", 0x0056984, 0x00569e4, 0x3B, 0x13 },
    { "Roll P1 VSP", 0x00562c4, 0x0056384, 0x1D, 0x13},
    { "Roll P2 VSP", 0x0057584, 0x0057644, 0x1D, 0x13},
    { "Ryu P1 VSP", 0x0056384, 0x0056444, 0x00, 0x13},
    { "Ryu P2 VSP", 0x0057644, 0x0057704, 0x00, 0x13},
    { "Ken P1 VSP", 0x0056e04, 0x0056ec4, 0x00, 0x13},
    { "Ken P2 VSP", 0x00580c4, 0x0058184, 0x00, 0x13},
    { "Gouki P1 VSP", 0x0056ec4, 0x0056f84, 0x00, 0x13},
    { "Gouki P2 VSP", 0x0058184, 0x0058244, 0x00, 0x13},
    { "Spider-Man P1 VSP", 0x0056204, 0x0056284, 0x0C, 0x13 },
    { "Spider-Man P2 VSP", 0x00574c4, 0x0057544, 0x0C, 0x13 },
    { "Strider Hiryu P1 VSP", 0x0056744, 0x0056804, 0x05, 0x13},
    { "Strider Hiryu P2 VSP", 0x0057a04, 0x0057ac4, 0x05, 0x13},
    ...
    { "Wolverine P1 VSP", 0x0055fc4, 0x0056084, 0x07, 0x13},
    { "Wolverine P2 VSP", 0x0057284, 0x0057344, 0x07, 0x13},
    { "Zangief P1 VSP", 0x0056684, 0x0056724, 0x01, 0x13},
    { "Zangief P2 VSP", 0x0057944, 0x00579e4, 0x01, 0x13},
    { "Mech-Zangief P1 VSP", 0x0056f84, 0x0057024, 0x01, 0x13},
    { "Mech-Zangief P2 VSP", 0x0058244, 0x00582e4, 0x01, 0x13},
};
...
const sGame_PaletteDataset MVC_A_SUPERPORT_PALETTES[] =
{
    ...
    { "Ken P1 Super", 0x0054be4, 0x0054c84, 0x00, 0x12 },
    { "Ken P2 Super", 0x0055b84, 0x0055c24, 0x00, 0x12 },
    { "Gouki P1 Super", 0x0054c84, 0x0054d24, 0x00, 0x12 },
    { "Gouki P2 Super", 0x0055c24, 0x0055cc4, 0x00, 0x12 },
    ...
    { "Gold War Machine P2 Super", 0x00559a4, 0x0055a24, 0x2E, 0x12 },
