...
{
    { L"Background (1/2)", 0x33818, 0x33a18, indexCPS2Sprites_MVCAssets, -1, &pairFullyLinkedNode },
    { L"Background (2/2)", 0x33a18, 0x33b78 },
    { L"Background Animations 1", 0x33b78, 0x33c18 },
    { L"Background Animations 2", 0x33c18, 0x33cb8 },

    { L"Background Post Wall Break", 0x33cd8, 0x33d78 },
    ...
    { L"Middle Wave / People", 0x391f8, 0x39278 },
    { L"Middle?", 0x395f8, 0x39618 },
    { L"Middle Animations?", 0x39618, 0x397f8 },

    { L"Foreground (1/3)", 0x30378, 0x30578 },
    { L"Foreground (2/3)", 0x30578, 0x30778 },
    { L"Foreground (3/3)", 0x30778, 0x30878 },

    { L"Foreground Post Wall Break", 0x30878, 0x30978 },

    { L"Foreground Animation Cycle?", 0x30978, 0x30a98 },
    { L"Foreground Fan: Animation Cycle 1/4", 0x30a98, 0x30ab8 },
        { L"Foreground Fan: Animation Cycle 2/4", 0x30ab8, 0x30ad8 },
        { L"Foreground Fan: Animation Cycle 3/4", 0x30ad8, 0x30af8 },
        { L"Foreground Fan: Animation Cycle 4/4", 0x30af8, 0x30b18 },

    { L"Sprites", 0x51402, 0x51562 },
};

const sGame_PaletteDataset MVC_A_NEO_STAGE_PALETTES[] =
{
    { L"Background (1/2)", 0x39c78, 0x39e78, indexCPS2Sprites_MVCAssets, -1, &pairFullyLinkedNode },
    { L"Background (2/2)", 0x39e78, 0x3a078 },
    { L"Background Building: Animation Cycle 1/4", 0x3a078, 0x3a098 },
    { L"Background Building: Animation Cycle 2/4", 0x3a098, 0x3a0b8 },
    { L"Background Building: Animation Cycle 3/4", 0x3a0b8, 0x3a0d8 },
    { L"Background Building: Animation Cycle 4/4", 0x3a0d8, 0x3a0f8 },

    { L"Foreground (1/2)", 0x346b8, 0x348b8 },
    { L"Foreground (2/2)", 0x348b8, 0x34ab8 },

    { L"Foreground Left lights (top): Animation Cycle 1/3",     0x34ab8, 0x34ad8 },
    { L"Foreground Left lights (top): Animation Cycle 2/3",     0x34ad8, 0x34af8 },
    { L"Foreground Left lights (top): Animation Cycle 3/3",     0x34af8, 0x34b18 },
    { L"Foreground Animations: Unused 1",                       0x34b18, 0x34b38 },

    { L"Foreground Left lights (bottom): Animation Cycle 1/3",  0x34b38, 0x34b58 },
    { L"Foreground Left lights (bottom): Animation Cycle 2/3",  0x34b58, 0x34b78 },
    { L"Foreground Left lights (bottom): Animation Cycle 3/3",  0x34b78, 0x34b98 },
    { L"Foreground Animations: Unused 2",                       0x34b98, 0x34bb8 },

    { L"Foreground Right light (top): Animation Cycle 1/3",     0x34bb8, 0x34bd8 },
    { L"Foreground Right light (top): Animation Cycle 2/3",     0x34bd8, 0x34bf8 },
    { L"Foreground Right light (top): Animation Cycle 3/3",     0x34bf8, 0x34c18 },
    { L"Foreground Animations: Unused 3",                       0x34c18, 0x34c38 },

    { L"Foreground Right light (bottom): Animation Cycle 1/3",  0x34c38, 0x34c58 },
    { L"Foreground Right light (bottom): Animation Cycle 2/3",  0x34c58, 0x34c78 },
    { L"Foreground Right light (bottom): Animation Cycle 3/3",  0x34c78, 0x34c98 },
    { L"Foreground Animations: Unused 4",                       0x34c98, 0x34cb8 },

    { L"Foreground Right light (bulb): Animation Cycle 1/3",    0x34cb8, 0x34cd8 },
    { L"Foreground Right light (bulb): Animation Cycle 2/3",    0x34cd8, 0x34cf8 },
    { L"Foreground Right light (bulb): Animation Cycle 3/3",    0x34cf8, 0x34d18 },

    { L"Sprites", 0x51622, 0x516c2 },

    { L"Blimp (1/2)", 0x310f8, 0x312f8 },
    { L"Blimp (2/2)", 0x312f8, 0x314f8 },
};

const sGame_PaletteDataset MVC_A_AVENGERS_STAGE_PALETTES[] =
{
    { L"Background (Outside Buildings)", 0x3a8f8, 0x3aa38, indexCPS2Sprites_MVCAssets, -1, &pairFullyLinkedNode },

    { L"Middle (1/3)", 0x31d58, 0x31f58 },
    { L"Middle (2/3)", 0x31f58, 0x32158 },
    { L"Middle (3/3)", 0x32158, 0x321f8 },

    { L"Foreground (1/3)", 0x35bd8, 0x35dd8 },
    { L"Foreground (2/3)", 0x35dd8, 0x35fd8 },
    { L"Foreground (3/3)", 0x35fd8, 0x36198 },
        
    { L"Sprites", 0x51802, 0x518a2 },
};

const sGame_PaletteDataset MVC_A_DAILYBUGLE_STAGE_PALETTES[] =
{
    { L"Background (1/2)", 0x3b0f8, 0x3b2f8, indexCPS2Sprites_MVCAssets, -1, &pairFullyLinkedNode },
    { L"Background (2/2)", 0x3b2f8, 0x3b4f8 },

    { L"Middle (1/2)", 0x36598, 0x36798 },
    { L"Middle (2/2)", 0x36798, 0x36998 },

    { L"Foreground", 0x325f8, 0x327f8 },

    { L"Sprites", 0x51942, 0x519e2 },
};

const sGame_PaletteDataset MVC_A_CLIFF_STAGE_PALETTES[] =
{
    { L"Background Sky: Animation Cycle 1/44", 0x3b4f8, 0x3b5f8, indexCPS2Sprites_MVCAssets, -1, &pairFullyLinkedNode },

    { L"Middle Rocks: Animation Cycle 1/41", 0x36998, 0x36a78 },

    { L"Foreground Rocks: Animation Cycle 2/25", 0x32a18, 0x32a38 },

    { L"Sprites", 0x519e2, 0x51aa2 },
};

const sGame_PaletteDataset MVC_A_CLIFF_STAGE_PALETTES_ANIMS[] =
{
    { L"Background Sky: Animation Cycle 2/44", 0x3b5f8, 0x3b6f8 },
    { L"Background Sky: Animation Cycle 3/44", 0x3b6f8, 0x3b7f8 },
    { L"Background Sky: Animation Cycle 4/44", 0x3b7f8, 0x3b8f8 },
    { L"Background Sky: Animation Cycle 5/44", 0x3b8f8, 0x3b9f8 },
    { L"Background Sky: Animation Cycle 6/44", 0x3b9f8, 0x3baf8 },
    { L"Background Sky: Animation Cycle 7/44", 0x3baf8, 0x3bbf8 },
    { L"Background Sky: Animation Cycle 8/44", 0x3bbf8, 0x3bcf8 },
    { L"Background Sky: Animation Cycle 9/44", 0x3bcf8, 0x3bdf8 },
    { L"Background Sky: Animation Cycle 10/44", 0x3bdf8, 0x3bef8 },
    { L"Background Sky: Animation Cycle 11/44", 0x3bef8, 0x3bff8 },
    { L"Background Sky: Animation Cycle 12/44", 0x3bff8, 0x3c0f8 },
    { L"Background Sky: Animation Cycle 13/44", 0x3c0f8, 0x3c1f8 },
    { L"Background Sky: Animation Cycle 14/44", 0x3c1f8, 0x3c2f8 },
    { L"Background Sky: Animation Cycle 15/44", 0x3c2f8, 0x3c3f8 },
    { L"Background Sky: Animation Cycle 16/44", 0x3c3f8, 0x3c4f8 },
    { L"Background Sky: Animation Cycle 17/44", 0x3c4f8, 0x3c5f8 },
    { L"Background Sky: Animation Cycle 18/44", 0x3c5f8, 0x3c6f8 },
    { L"Background Sky: Animation Cycle 19/44", 0x3c6f8, 0x3c7f8 },
    { L"Background Sky: Animation Cycle 20/44", 0x3c7f8, 0x3c8f8 },
    { L"Background Sky: Animation Cycle 21/44", 0x3c8f8, 0x3c9f8 },
    { L"Background Sky: Animation Cycle 22/44", 0x3c9f8, 0x3caf8 },
    { L"Background Sky: Animation Cycle 23/44", 0x3caf8, 0x3cbf8 },
    { L"Background Sky: Animation Cycle 24/44", 0x3cbf8, 0x3ccf8 },
    { L"Background Sky: Animation Cycle 25/44", 0x3ccf8, 0x3cdf8 },
    { L"Background Sky: Animation Cycle 26/44", 0x3cdf8, 0x3cef8 },
    { L"Background Sky: Animation Cycle 27/44", 0x3cef8, 0x3cff8 },
    { L"Background Sky: Animation Cycle 28/44", 0x3cff8, 0x3d0f8 },
    { L"Background Sky: Animation Cycle 29/44", 0x3d0f8, 0x3d1f8 },
    { L"Background Sky: Animation Cycle 30/44", 0x3d1f8, 0x3d2f8 },
    { L"Background Sky: Animation Cycle 31/44", 0x3d2f8, 0x3d3f8 },
    { L"Background Sky: Animation Cycle 32/44", 0x3d3f8, 0x3d4f8 },
    { L"Background Sky: Animation Cycle 33/44", 0x3d4f8, 0x3d5f8 },
    { L"Background Sky: Animation Cycle 34/44", 0x3d5f8, 0x3d6f8 },
    { L"Background Sky: Animation Cycle 35/44", 0x3d6f8, 0x3d7f8 },
    { L"Background Sky: Animation Cycle 36/44", 0x3d7f8, 0x3d8f8 },
    { L"Background Sky: Animation Cycle 37/44", 0x3d8f8, 0x3d9f8 },
    { L"Background Sky: Animation Cycle 38/44", 0x3d9f8, 0x3daf8 },
    { L"Background Sky: Animation Cycle 39/44", 0x3daf8, 0x3dbf8 },
    { L"Background Sky: Animation Cycle 40/44", 0x3dbf8, 0x3dcf8 },
    { L"Background Sky: Animation Cycle 41/44", 0x3dcf8, 0x3ddf8 },
    { L"Background Sky: Animation Cycle 42/44", 0x3ddf8, 0x3def8 },
    { L"Background Sky: Animation Cycle 43/44", 0x3def8, 0x3dff8 },
    { L"Background Sky: Animation Cycle 44/44", 0x3dff8, 0x3e0f8 },

    { L"Middle Rocks: Animation Cycle 2/41", 0x36a78, 0x36b58 },
    { L"Middle Rocks: Animation Cycle 3/41", 0x36b58, 0x36c38 },
    { L"Middle Rocks: Animation Cycle 4/41", 0x36c38, 0x36d18 },
    { L"Middle Rocks: Animation Cycle 5/41", 0x36d98, 0x36e78 },
    { L"Middle Rocks: Animation Cycle 6/41", 0x36e78, 0x36f58 },
    { L"Middle Rocks: Animation Cycle 7/41", 0x36f58, 0x37038 },
    { L"Middle Rocks: Animation Cycle 8/41", 0x37038, 0x37118 },
    { L"Middle Rocks: Animation Cycle 9/41", 0x37118, 0x371f8 },
    { L"Middle Rocks: Animation Cycle 10/41", 0x371f8, 0x372d8 },
    { L"Middle Rocks: Animation Cycle 11/41", 0x372d8, 0x373b8 },
    { L"Middle Rocks: Animation Cycle 12/41", 0x373b8, 0x37498 },
    { L"Middle Rocks: Animation Cycle 13/41", 0x37498, 0x37578 },
    { L"Middle Rocks: Animation Cycle 14/41", 0x37578, 0x37658 },
    { L"Middle Rocks: Animation Cycle 15/41", 0x37658, 0x37738 },
    { L"Middle Rocks: Animation Cycle 16/41", 0x37738, 0x37818 },
    { L"Middle Rocks: Animation Cycle 17/41", 0x37818, 0x378f8 },
    { L"Middle Rocks: Animation Cycle 18/41", 0x378f8, 0x379d8 },
    { L"Middle Rocks: Animation Cycle 19/41", 0x379d8, 0x37ab8 },
    { L"Middle Rocks: Animation Cycle 20/41", 0x37ab8, 0x37b98 },
    { L"Middle Rocks: Animation Cycle 21/41", 0x37b98, 0x37c78 },
    { L"Middle Rocks: Animation Cycle 22/41", 0x37c78, 0x37d58 },
    { L"Middle Rocks: Animation Cycle 23/41", 0x37d58, 0x37e38 },
    { L"Middle Rocks: Animation Cycle 24/41", 0x37e38, 0x37f18 },
    { L"Middle Rocks: Animation Cycle 25/41", 0x37f18, 0x37ff8 },
    { L"Middle Rocks: Animation Cycle 26/41", 0x37ff8, 0x380d8 },
    { L"Middle Rocks: Animation Cycle 27/41", 0x380d8, 0x381b8 },
    { L"Middle Rocks: Animation Cycle 28/41", 0x381b8, 0x38298 },
    { L"Middle Rocks: Animation Cycle 29/41", 0x38298, 0x38378 },
    { L"Middle Rocks: Animation Cycle 30/41", 0x38378, 0x38458 },
    { L"Middle Rocks: Animation Cycle 31/41", 0x38458, 0x38538 },
    { L"Middle Rocks: Animation Cycle 32/41", 0x38538, 0x38618 },
    { L"Middle Rocks: Animation Cycle 33/41", 0x38618, 0x386f8 },
    { L"Middle Rocks: Animation Cycle 34/41", 0x386f8, 0x387d8 },
    { L"Middle Rocks: Animation Cycle 35/41", 0x387d8, 0x388b8 },
    { L"Middle Rocks: Animation Cycle 36/41", 0x388b8, 0x38998 },
    { L"Middle Rocks: Animation Cycle 37/41", 0x38998, 0x38a78 },
    { L"Middle Rocks: Animation Cycle 38/41", 0x38a78, 0x38b58 },
    { L"Middle Rocks: Animation Cycle 39/41", 0x38b58, 0x38c38 },
    { L"Middle Rocks: Animation Cycle 40/41", 0x38c38, 0x38d18 },
    { L"Middle Rocks: Animation Cycle 41/41", 0x38d18, 0x38df8 },

    { L"Foreground Rocks: Animation Cycle 1/25", 0x329f8, 0x32a18 },
    { L"Foreground Rocks: Animation Cycle 3/25", 0x32a38, 0x32a58 },
    { L"Foreground Rocks: Animation Cycle 4/25", 0x32a58, 0x32a78 },
    { L"Foreground Rocks: Animation Cycle 5/25", 0x32a78, 0x32a98 },
    { L"Foreground Rocks: Animation Cycle 6/25", 0x32a98, 0x32ab8 },
    { L"Foreground Rocks: Animation Cycle 7/25", 0x32ab8, 0x32ad8 },
    { L"Foreground Rocks: Animation Cycle 8/25", 0x32ad8, 0x32af8 },
    { L"Foreground Rocks: Animation Cycle 9/25", 0x32af8, 0x32b18 },
    { L"Foreground Rocks: Animation Cycle 10/25", 0x32b18, 0x32b38 },
    { L"Foreground Rocks: Animation Cycle 11/25", 0x32b38, 0x32b58 },
    { L"Foreground Rocks: Animation Cycle 12/25", 0x32b58, 0x32b78 },
    { L"Foreground Rocks: Animation Cycle 13/25", 0x32b78, 0x32b98 },
    { L"Foreground Rocks: Animation Cycle 14/25", 0x32b98, 0x32bb8 },
    { L"Foreground Rocks: Animation Cycle 15/25", 0x32bb8, 0x32bd8 },
    { L"Foreground Rocks: Animation Cycle 16/25", 0x32bd8, 0x32bf8 },
    { L"Foreground Rocks: Animation Cycle 17/25", 0x32bf8, 0x32c18 },
    { L"Foreground Rocks: Animation Cycle 18/25", 0x32c18, 0x32c38 },
    { L"Foreground Rocks: Animation Cycle 19/25", 0x32c38, 0x32c58 },
    { L"Foreground Rocks: Animation Cycle 20/25", 0x32c58, 0x32c78 },
    { L"Foreground Rocks: Animation Cycle 21/25", 0x32c78, 0x32c98 },
    { L"Foreground Rocks: Animation Cycle 22/25", 0x32c98, 0x32cb8 },
    { L"Foreground Rocks: Animation Cycle 23/25", 0x32cb8, 0x32cd8 },
    { L"Foreground Rocks: Animation Cycle 24/25", 0x32cd8, 0x32cf8 },
    { L"Foreground Rocks: Animation Cycle 25/25", 0x32cf8, 0x32d18 },

    { L"Foreground Rocks: Animation Cycle 2 1/32", 0x32df8, 0x32e18 },
    { L"Foreground Rocks: Animation Cycle 2 2/32", 0x32e18, 0x32e38 },
    { L"Foreground Rocks: Animation Cycle 2 3/32", 0x32e38, 0x32e58 },
    { L"Foreground Rocks: Animation Cycle 2 4/32", 0x32e58, 0x32e78 },
    { L"Foreground Rocks: Animation Cycle 2 5/32", 0x32e78, 0x32e98 },
    { L"Foreground Rocks: Animation Cycle 2 6/32", 0x32e98, 0x32eb8 },
    { L"Foreground Rocks: Animation Cycle 2 7/32", 0x32eb8, 0x32ed8 },
    { L"Foreground Rocks: Animation Cycle 2 8/32", 0x32ed8, 0x32ef8 },
    { L"Foreground Rocks: Animation Cycle 2 9/32", 0x32ef8, 0x32f18 },
    { L"Foreground Rocks: Animation Cycle 2 10/32", 0x32f18, 0x32f38 },
    { L"Foreground Rocks: Animation Cycle 2 11/32", 0x32f38, 0x32f58 },
    { L"Foreground Rocks: Animation Cycle 2 12/32", 0x32f58, 0x32f78 },
    { L"Foreground Rocks: Animation Cycle 2 13/32", 0x32f78, 0x32f98 },
    { L"Foreground Rocks: Animation Cycle 2 14/32", 0x32f98, 0x32fb8 },
    { L"Foreground Rocks: Animation Cycle 2 15/32", 0x32fb8, 0x32fd8 },
    { L"Foreground Rocks: Animation Cycle 2 16/32", 0x32fd8, 0x32ff8 },

    { L"Foreground Rocks: Animation Cycle 2 17/32", 0x32ff8, 0x33018 },
    { L"Foreground Rocks: Animation Cycle 2 18/32", 0x33018, 0x33038 },
    { L"Foreground Rocks: Animation Cycle 2 19/32", 0x33038, 0x33058 },
    { L"Foreground Rocks: Animation Cycle 2 20/32", 0x33058, 0x33078 },
    { L"Foreground Rocks: Animation Cycle 2 21/32", 0x33078, 0x33098 },
    { L"Foreground Rocks: Animation Cycle 2 22/32", 0x33098, 0x330b8 },
    { L"Foreground Rocks: Animation Cycle 2 23/32", 0x330b8, 0x330d8 },
    { L"Foreground Rocks: Animation Cycle 2 24/32", 0x330d8, 0x330f8 },
    { L"Foreground Rocks: Animation Cycle 2 25/32", 0x330f8, 0x33118 },
    { L"Foreground Rocks: Animation Cycle 2 26/32", 0x33118, 0x33138 },
    { L"Foreground Rocks: Animation Cycle 2 27/32", 0x33138, 0x33158 },
    { L"Foreground Rocks: Animation Cycle 2 28/32", 0x33158, 0x33178 },
    { L"Foreground Rocks: Animation Cycle 2 29/32", 0x33178, 0x33198 },
    { L"Foreground Rocks: Animation Cycle 2 30/32", 0x33198, 0x331b8 },
    { L"Foreground Rocks: Animation Cycle 2 31/32", 0x331b8, 0x331d8 },
    { L"Foreground Rocks: Animation Cycle 2 32/32", 0x331d8, 0x331f8 },
