...
const sGame_PaletteDataset REDEARTH_A_31_OPENING_LEO_PALETTES[] =
{
    ...
    { L"Leo Opening Cinematic - Leo's Head 3", 0x325e00, 0x325e80 },
    { L"Leo Opening Cinematic - Leo's Head 4", 0x325c00, 0x325c80 },
    { L"Leo Opening Cinematic - Leo's Head 5", 0x325c80, 0x325d00 },
    { L"Leo Opening Cinematic - Leo's Head 6", 0x325f00, 0x325f80 },
    { L"Leo Opening Cinematic - Leo's Head 7", 0x325d00, 0x325d80 },
    { L"Leo Opening Cinematic - Leo's Head 8", 0x325e80, 0x325f00 },
...
{
    { L"Sky & Background", 0x738400, 0x738480 },
    { L"Background Building on the Right", 0x738480, 0x738500 },
    { L"Ground", 0x738080, 0x738100 },
    { L"Center Pillars & Eagle Statue", 0x738300, 0x738380 },
    { L"Middle Ground Pillars & Ground Part", 0x738580, 0x738600 },
    { L"Background Pillars & Ground Part", 0x738600, 0x738680 },
    { L"Ram Statue's Head & part of Palm Trees", 0x738500, 0x738580 },
    { L"Palm Trees & Part of Ram Statue", 0x738180, 0x738200 },
    { L"Gigantic Rock on the right & Grass", 0x738200, 0x738280 },
    { L"Left Pillars & Ground Part", 0x738280, 0x738300 },
    { L"Small Part of Left Pillars & Bricks", 0x738100, 0x738180 },
    { L"Tiger & Lizard Type Dragon Statues", 0x738380, 0x738400 },
    { L"Wall on the left & Ground Part", 0x738680, 0x738700 },
    { L"Palm Tree on the Right Side", 0x738700, 0x738780 }, 
};

const sGame_PaletteDataset REDEARTH_A_STAGES_SANGYPT_INTRO1_PALETTES[] =
{
    { L"Ground", 0x738780, 0x738800 },
    { L"Small Part of Left Pillars & Bricks", 0x738800, 0x738880 },
    { L"Palm Trees & Part of Ram Statue", 0x738880, 0x738900 },
    { L"Gigantic Rock on the right & Grass", 0x738900, 0x738980 },
    { L"Left Pillars & Ground Part", 0x738980, 0x738a00 },
    { L"Center Pillars & Eagle Statue", 0x738a00, 0x738a80 },
    { L"Tiger & Lizard Type Dragon Statues", 0x738a80, 0x738b00 },
    { L"Sky & Background", 0x738b00, 0x738b80 },
    { L"Background Building on the Right", 0x738b80, 0x738c00 },
    { L"Ram Statue's Head & part of Palm Trees", 0x738c00, 0x738c80 },
...
{
    { L"Ground", 0x738e00, 0x738e80 },
    { L"Small Part of Left Pillars & Bricks", 0x738e80, 0x738f00 },
    { L"Palm Trees & Part of Ram Statue", 0x738f00, 0x738f80 },
    { L"Gigantic Rock on the right & Grass", 0x738f80, 0x739000 },
    { L"Left Pillars & Ground Part", 0x739000, 0x739080 },
    { L"Center Pillars & Eagle Statue", 0x739080, 0x739100 },
    { L"Tiger & Lizard Type Dragon Statues", 0x739100, 0x739180 },
    { L"Sky & Background", 0x739180, 0x739200 },
    { L"Background Building on the Right", 0x739200, 0x739280 },
    { L"Ram Statue's Head & part of Palm Trees", 0x739280, 0x739300 },
...
{
    { L"Poison Dogma 1", 0x7a0000, 0x7a0080 },
    { L"Poison Dogma 2", 0x7a0080, 0x7a0100 },
    { L"Poison Dogma 3", 0x7a0100, 0x7a0180 },
    { L"Poison Dogma 4", 0x7a0180, 0x7a0200 },
    { L"Poison Dogma 5", 0x7a0200, 0x7a0280 },
    { L"Poison Dogma 6", 0x7a0280, 0x7a0300 },
    { L"Poison Dogma 7", 0x7a0300, 0x7a0380 },
    { L"Poison Dogma 8", 0x7a0380, 0x7a0400 },
    { L"Poison Dogma 9", 0x7a0400, 0x7a0480 },
    { L"Poison Dogma 10", 0x7a0480, 0x7a0500 },
    { L"Poison Dogma 11", 0x7a0500, 0x7a0580 },
    { L"Poison Dogma 12", 0x7a0580, 0x7a0600 },
    { L"Poison Dogma 13", 0x7a0600, 0x7a0680 },
    { L"Poison Dogma 14", 0x7a0680, 0x7a0700 },
    { L"Poison Dogma 15", 0x7a0700, 0x7a0780 },
    { L"Poison Dogma 16", 0x7a0780, 0x7a0800 },

    { L"Wind Rafale 1", 0x7a0800, 0x7a0880 },
    { L"Wind Rafale 2", 0x7a0880, 0x7a0900 },
    { L"Wind Rafale 3", 0x7a0900, 0x7a0980 },
    { L"Wind Rafale 4", 0x7a0980, 0x7a0a00 },
    { L"Wind Rafale 5", 0x7a0a00, 0x7a0a80 },
    { L"Wind Rafale 6", 0x7a0a80, 0x7a0b00 },
    { L"Wind Rafale 7", 0x7a0b00, 0x7a0b80 },
    { L"Wind Rafale 8", 0x7a0b80, 0x7a0c00 },
    { L"Wind Rafale 9", 0x7a0c00, 0x7a0c80 },
    { L"Wind Rafale 10", 0x7a0c80, 0x7a0d00 },
    { L"Wind Rafale 11", 0x7a0d00, 0x7a0d80 },
    { L"Wind Rafale 12", 0x7a0d80, 0x7a0e00 },
    { L"Wind Rafale 13", 0x7a0e00, 0x7a0e80 },
    { L"Wind Rafale 14", 0x7a0e80, 0x7a0f00 },
    { L"Wind Rafale 15", 0x7a0f00, 0x7a0f80 },
    { L"Wind Rafale 16", 0x7a0f80, 0x7a1000 },

    { L"Thunder Gorubarus 1", 0x7a1000, 0x7a1080 },
    { L"Thunder Gorubarus 2", 0x7a1080, 0x7a1100 },
    { L"Thunder Gorubarus 3", 0x7a1100, 0x7a1180 },
    { L"Thunder Gorubarus 4", 0x7a1180, 0x7a1200 },
    { L"Thunder Gorubarus 5", 0x7a1200, 0x7a1280 },
    { L"Thunder Gorubarus 6", 0x7a1280, 0x7a1300 },
    { L"Thunder Gorubarus 7", 0x7a1300, 0x7a1380 },
    { L"Thunder Gorubarus 8", 0x7a1380, 0x7a1400 },
    { L"Thunder Gorubarus 9", 0x7a1400, 0x7a1480 },
    { L"Thunder Gorubarus 10", 0x7a1480, 0x7a1500 },
    { L"Thunder Gorubarus 11", 0x7a1500, 0x7a1580 },
    { L"Thunder Gorubarus 12", 0x7a1580, 0x7a1600 },
    { L"Thunder Gorubarus 13", 0x7a1600, 0x7a1680 },
    { L"Thunder Gorubarus 14", 0x7a1680, 0x7a1700 },
    { L"Thunder Gorubarus 15", 0x7a1700, 0x7a1780 },
    { L"Thunder Gorubarus 16", 0x7a1780, 0x7a1800 },

    { L"Flame Goranda 1", 0x7a1800, 0x7a1880 },
    { L"Flame Goranda 2", 0x7a1880, 0x7a1900 },
    { L"Flame Goranda 3", 0x7a1900, 0x7a1980 },
    { L"Flame Goranda 4", 0x7a1980, 0x7a1a00 },
    { L"Flame Goranda 5", 0x7a1a00, 0x7a1a80 },
    { L"Flame Goranda 6", 0x7a1a80, 0x7a1b00 },
    { L"Flame Goranda 7", 0x7a1b00, 0x7a1b80 },
    { L"Flame Goranda 8", 0x7a1b80, 0x7a1c00 },
    { L"Flame Goranda 9", 0x7a1c00, 0x7a1c80 },
    { L"Flame Goranda 10", 0x7a1c80, 0x7a1d00 },
    { L"Flame Goranda 11", 0x7a1d00, 0x7a1d80 },
    { L"Flame Goranda 12", 0x7a1d80, 0x7a1e00 },
    { L"Flame Goranda 13", 0x7a1e00, 0x7a1e80 },
    { L"Flame Goranda 14", 0x7a1e80, 0x7a1f00 },
    { L"Flame Goranda 15", 0x7a1f00, 0x7a1f80 },
    { L"Flame Goranda 16", 0x7a1f80, 0x7a2000 },

    { L"Meteor Giamateus 1", 0x7a2000, 0x7a2080 },
    { L"Meteor Giamateus 2", 0x7a2080, 0x7a2100 },
    { L"Meteor Giamateus 3", 0x7a2100, 0x7a2180 },
    { L"Meteor Giamateus 4", 0x7a2180, 0x7a2200 },
    { L"Meteor Giamateus 5", 0x7a2200, 0x7a2280 },
    { L"Meteor Giamateus 6", 0x7a2280, 0x7a2300 },
    { L"Meteor Giamateus 7", 0x7a2300, 0x7a2380 },
    { L"Meteor Giamateus 8", 0x7a2380, 0x7a2400 },
    { L"Meteor Giamateus 9", 0x7a2400, 0x7a2480 },
    { L"Meteor Giamateus 10", 0x7a2480, 0x7a2500 },
    { L"Meteor Giamateus 11", 0x7a2500, 0x7a2580 },
    { L"Meteor Giamateus 12", 0x7a2580, 0x7a2600 },
    { L"Meteor Giamateus 13", 0x7a2600, 0x7a2680 },
    { L"Meteor Giamateus 14", 0x7a2680, 0x7a2700 },
    { L"Meteor Giamateus 15", 0x7a2700, 0x7a2780 },
    { L"Meteor Giamateus 16", 0x7a2780, 0x7a2800 }, 

    { L"Ice Soulfunil 1", 0x7a2800, 0x7a2880 },
    { L"Ice Soulfunil 2", 0x7a2880, 0x7a2900 },
    { L"Ice Soulfunil 3", 0x7a2900, 0x7a2980 },
    { L"Ice Soulfunil 4", 0x7a2980, 0x7a2a00 },
    { L"Ice Soulfunil 5", 0x7a2a00, 0x7a2a80 },
    { L"Ice Soulfunil 6", 0x7a2a80, 0x7a2b00 },
    { L"Ice Soulfunil 7", 0x7a2b00, 0x7a2b80 },
    { L"Ice Soulfunil 8", 0x7a2b80, 0x7a2c00 },
    { L"Ice Soulfunil 9", 0x7a2c00, 0x7a2c80 },
    { L"Ice Soulfunil 10", 0x7a2c80, 0x7a2d00 },
    { L"Ice Soulfunil 11", 0x7a2d00, 0x7a2d80 },
    { L"Ice Soulfunil 12", 0x7a2d80, 0x7a2e00 },
    { L"Ice Soulfunil 13", 0x7a2e00, 0x7a2e80 },
    { L"Ice Soulfunil 14", 0x7a2e80, 0x7a2f00 },
    { L"Ice Soulfunil 15", 0x7a2f00, 0x7a2f80 },
    { L"Ice Soulfunil 16", 0x7a2f80, 0x7a3000 },
};
