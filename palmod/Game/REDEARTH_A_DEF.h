...
const sGame_PaletteDataset REDEARTH_A_LEO_PALETTES[] =
{
    { _T("Leo Character Select"), 0x1DF200, 0x1DF280 },
    { _T("Leo Character Selected"), 0x1DEB80, 0x1DEC00 },
    { _T("Leo Character Select Portrait "), 0x1DEF00, 0x1DEF80 },
    { _T("Leo Punch"), 0x408000, 0x408080 },
    { _T("Leo Punch Vs/Winning/Losing Screen"), 0x1E4680, 0x1E4700 },
    { _T("Leo Punch Vs/Winning/Losing Sword"), 0x1E4700, 0x1E4780 },
    { _T("Leo Punch LifeBar Portrait"), 0x406640, 0x406680 },
    { _T("Leo Kick"), 0x414800, 0x414880 },
    { _T("Leo Kick Vs/Winning/Losing Screen"), 0x1E4D00, 0x1E4D80 },
    { _T("Leo Kick Vs/Winning/Losing Sword"), 0x1E4D80, 0x1E4E00 },
    { _T("Leo Kick LifeBar Portrait"), 0x406680, 0x4066C0 },
    { _T("Leo Rusty Sword"), 0x408100, 0x408180 },
    { _T("Leo Bronze Sword"), 0x408180, 0x408200 },
    { _T("Leo Black Sword"), 0x408300, 0x408380 },
    { _T("Leo Fire Sword"), 0x408600, 0x408680 },
    { _T("Leo Lightning Sword"), 0x408700, 0x408780 },
};

const sGame_PaletteDataset REDEARTH_A_KENJI_PALETTES[] =
{
...
const sGame_PaletteDataset REDEARTH_A_TESSA_PALETTES[] =
{
    ...
    { _T("TessaP Bottled Ice"), 0x40E500, 0x40E580 },
    { _T("TessaP Al (Aru) Cat"), 0x40E780, 0x40E800 },
    { _T("TessaP Al (Aru) Cat Returning"), 0x40E800, 0x40E880 },
    { _T("TessaP Ivan (Ibun) Cat"), 0x40E880, 0x40E900 },
    { _T("TessaP Ivan (Ibun) Cat Returning"), 0x40E900, 0x40E980 },
    { _T("TessaP Ice"), 0x40E980, 0x40EA00 },
    { _T("TessaP Reverie Sword"), 0x40EB80, 0x40EC00 },
    { _T("TessaP Staves"), 0x40EC00, 0x40EC80 },
    { _T("TessaP Kaeru (Frog)"), 0x40EE80, 0x40EF00 },
    { _T("TessaP Hato (Dove)"), 0x40EF80, 0x40F000 },
    { _T("TessaP Suitcat"), 0x40FF00, 0x40FF80 },
    { _T("TessaP Suitcat (Mustard)"), 0x40FF80, 0x410000 },
    { _T("TessaP Chakra Wave"), 0x40EF00, 0x40EF80 },
    { _T("TessaP Cannon Magic Pattern"), 0x40E700, 0x40E780 },
    { _T("TessaP Cannon Transition"), 0x40F880, 0x40F900 },
    { _T("TessaP Hyper Cannon (Superball and Winscreen)"), 0x40F900, 0x40F980 },
    { _T("TessaP Glace Cannon"), 0x40F980, 0x40FA00 },
    { _T("TessaP Glace Pixies"), 0x40F600, 0x40F680 },
    { _T("TessaP Glace Pixies CP"), 0x40F580, 0x40F600 },
    { _T("TessaP Flamma Cannon"), 0x40FA00, 0x40FA80 },
    { _T("TessaP Flamma Pixies"), 0x40F500, 0x40F580 },
    { _T("TessaP Flamma Pixies CP"), 0x40F480, 0x40F500 },
    { _T("TessaP Electron Cannon"), 0x40FA80, 0x40FB00 },
    { _T("TessaP Electron Pixies CP"), 0x40F400, 0x40F480 },
    { _T("TessaP Death Phenomenon - On Hit"), 0x40FD80, 0x40FE00 },
    { _T("TessaP Death Phenomenon - On Whiff"), 0x40FE00, 0x40FE80 },
    { _T("TessaP Jammin' Ghost"), 0x40F780, 0x40F800 },
    { _T("TessaP Manot Arm"), 0x40F200, 0x40F280 },
    { _T("TessaP GC/Pursuit Wrecking Ball"), 0x40F300, 0x40F380 },
    { _T("TessaP Wrecking Ball Angels and Electron Pixies"), 0x40F380, 0x40F400 },
    { _T("TessaP Grab Saw"), 0x40F080, 0x40F100 },
    { _T("TessaP GC/Grab/Pursuit Lever"), 0x40F100, 0x40F180 },
    { _T("TessaP Magic Guard Wall and Lever"), 0x40EB00, 0x40EB80 },
    { _T("TessaP Magic Guard Batteries"), 0x40EE00, 0x40EE80 },
    { _T("TessaP Magic Guard Flash and Burn 1"), 0x410E00, 0x410E80 },
    { _T("TessaP Burn Palette 2"), 0x410E80, 0x410F00 },
    { _T("TessaP Shocked Palette 1"), 0x410F00, 0x410F80 },
    { _T("TessaP Shocked Palette 2"), 0x410F80, 0x411000 },
    { _T("TessaP Poisoned Palette 1"), 0x411000, 0x411080 },
    { _T("TessaP Poisoned Palette 2"), 0x411080, 0x411100 },
    { _T("TessaP Poisoned Palette 3"), 0x411100, 0x411180 },
    { _T("TessaP Poisoned Palette 4"), 0x411180, 0x411200 },
    { _T("TessaP Petrified Palette 1"), 0x411200, 0x411280 },
    { _T("TessaP Petrified Palette 2"), 0x411280, 0x411300 },
    { _T("TessaP Petrified Palette 3"), 0x411300, 0x411380 },
    { _T("TessaP Ice Palette 1"), 0x411380, 0x411400 },
    { _T("TessaP Ice Palette 2"), 0x411400, 0x411480 },
    { _T("TessaP Ice Palette 3"), 0x411480, 0x411500 },
    { _T("TessaP Ice Palette 4"), 0x411500, 0x411580 },
    { _T("TessaP Ice Palette 5"), 0x411580, 0x411600 },
...
const sGame_PaletteDataset REDEARTH_A_MAILING_PALETTES[] =
{
...
const sGame_PaletteDataset REDEARTHA_BOSSES_PALETTES[] =
{
    { _T("Kongou"), 0x424200, 0x424280 },
...
const sGame_PaletteDataset REDEARTH_A_CHARACTERSELECT_PALETTES[] =
{
    ...
    { _T("Vs Screen Transistion (1/4)"), 0x406000, 0x406100 },
    { _T("Vs Screen Transistion (2/4)"), 0x406100, 0x406200 },
    { _T("Vs Screen Transistion (3/4)"), 0x406200, 0x406300 },
    { _T("Vs Screen Transistion (4/4)"), 0x406300, 0x406400 },
...
{
    { _T("Palettes"), DESC_NODETYPE_TREE, (void*)REDEARTH_A_LEO_PALETTES, ARRAYSIZE(REDEARTH_A_LEO_PALETTES) },
};

const sDescTreeNode REDEARTH_A_KENJI_COLLECTION[] =
{
    { _T("Palettes"), DESC_NODETYPE_TREE, (void*)REDEARTH_A_KENJI_PALETTES, ARRAYSIZE(REDEARTH_A_KENJI_PALETTES) },
};

const sDescTreeNode REDEARTH_A_TESSA_COLLECTION[] =
{
    { _T("Palettes"), DESC_NODETYPE_TREE, (void*)REDEARTH_A_TESSA_PALETTES, ARRAYSIZE(REDEARTH_A_TESSA_PALETTES) },
};

const sDescTreeNode REDEARTH_A_MAILING_COLLECTION[] =
{
    { _T("Palettes"), DESC_NODETYPE_TREE, (void*)REDEARTH_A_MAILING_PALETTES, ARRAYSIZE(REDEARTH_A_MAILING_PALETTES) },
};

const sDescTreeNode REDEARTH_A_BOSSES_COLLECTION[] =
{
    { _T("Palettes"), DESC_NODETYPE_TREE, (void*)REDEARTHA_BOSSES_PALETTES, ARRAYSIZE(REDEARTHA_BOSSES_PALETTES) },
};
...
const sDescTreeNode REDEARTH_A_UNITS[] =
{
    ...
    { _T("Bosses"),             DESC_NODETYPE_TREE, (void*)REDEARTH_A_BOSSES_COLLECTION, ARRAYSIZE(REDEARTH_A_BOSSES_COLLECTION) },
