...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_A[] =
{
    ...
    { L"A - Extra Move 1", 0x47cb900, 0x47cb920, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"A - Extra Move 2", 0x47cb920, 0x47cb940, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_B[] =
{
    ...
    { L"B - Extra Move 1", 0x47cbb00, 0x47cbb20, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"B - Extra Move 2", 0x47cbb20, 0x47cbb40, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_C[] =
{
    ...
    { L"C - Extra Move 1", 0x47cbd00, 0x47cbd20, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"C - Extra Move 2", 0x47cbd20, 0x47cbd40, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_D[] =
{
    ...
    { L"D - Extra Move 1", 0x47cbf00, 0x47cbf20, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"D - Extra Move 2", 0x47cbf20, 0x47cbf40, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_EA[] =
{
    ...
    { L"E+A - Extra Move 1", 0x47cc100, 0x47cc120, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"E+A - Extra Move 2", 0x47cc120, 0x47cc140, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_EB[] =
{
    ...
    { L"E+B - Extra Move 1", 0x47cc300, 0x47cc320, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"E+B - Extra Move 2", 0x47cc320, 0x47cc340, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_EC[] =
{
    ...
    { L"E+C - Extra Move 1", 0x47cc500, 0x47cc520, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"E+C - Extra Move 2", 0x47cc520, 0x47cc540, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_ED[] =
{
    ...
    { L"E+D - Extra Move 1", 0x47cc700, 0x47cc720, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"E+D - Extra Move 2", 0x47cc720, 0x47cc740, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_SA[] =
{
    ...
    { L"Start+A - Extra Move 1", 0x47cc900, 0x47cc920, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"Start+A - Extra Move 2", 0x47cc920, 0x47cc940, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_SB[] =
{
    ...
    { L"Start+B - Extra Move 1", 0x47ccb00, 0x47ccb20, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"Start+B - Extra Move 2", 0x47ccb20, 0x47ccb40, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_SC[] =
{
    ...
    { L"Start+C - Extra Move 1", 0x47ccd00, 0x47ccd20, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"Start+C - Extra Move 2", 0x47ccd20, 0x47ccd40, indexKOFXISprites_Shion, 0x11, &pairPrevious },
...
const sGame_PaletteDataset KOFXI_A_SHION_PALETTES_SD[] =
{
    ...
    { L"Start+D - Extra Move 1", 0x47ccf00, 0x47ccf20, indexKOFXISprites_Shion, 0x10, &pairNext },
    { L"Start+D - Extra Move 2", 0x47ccf20, 0x47ccf40, indexKOFXISprites_Shion, 0x11, &pairPrevious },
