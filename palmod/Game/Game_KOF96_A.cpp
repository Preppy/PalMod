...
CGame_KOF96_A::CGame_KOF96_A(UINT32 nConfirmedROMSize)
{
    ...
    m_nSafeCountForThisRom = GetExtraCt(m_nExtraUnit) + 870;
...
sDescTreeNode* CGame_KOF96_A::InitDescTree()
{
    ...
    CString strMsg;
    bool fHaveExtras = (GetExtraCt(KOF96_A_EXTRALOC) > 0);
    strMsg.Format(L"CGame_KOF96_A::InitDescTree: Building desc tree for KOF96_A %s extras...\n", fHaveExtras ? L"with" : L"without");
    ...
    strMsg.Format(L"CGame_KOF96_A::InitDescTree: Loaded %u palettes for KOF96\n", nTotalPaletteCount);
    OutputDebugString(strMsg);
