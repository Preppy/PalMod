...
MBAACCFileData MBAACCCharacterData[] =
{
    ...
    { L"sion.pal",	    L"Sion Eltnam Atlasia",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Sion },
    { L"arc.pal",   	L"Arcueid Brunestud",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Arcueid },
    { L"ciel.pal",	    L"Ciel",						65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Ciel },
    { L"akiha.pal", 	L"Akiha Tohno",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Akiha },
    ...
    { L"shiki.pal",	    L"Shiki Tohno",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Tohno },
    { L"miyako.pal",	L"Miyako Arima",				65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Miyako },
    { L"warakia.pal",	L"Warachia",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Warachia },
    { L"nero.pal",	    L"Nero Chaos",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Nero },
    { L"V_sion.pal",	L"Sion TATARI",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_VSion },
    { L"warc.pal",	    L"Red Arcueid",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_RedArcueid },
    { L"akaakiha.pal",	L"Akiha Vermillion",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_VAkiha },
    { L"m_hisui.pal",	L"Mech-Hisui",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_MechHisui },
    { L"nanaya.pal",	L"Shiki Nanaya",				65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Nanaya },
    { L"satsuki.pal",	L"Satsuki Yumiduka",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Satsuki },
    ...
    { L"aoko.pal",  	L"Aoko Aozaki",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Aoko },
    { L"wlen.pal",	    L"White Len",					65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_WhiteLen },
    { L"nechaos.pal",	L"Neco-Arc Chaos",				65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_NAC },
    //G_CHAOS, NECO CHAOS BLACK G666 is mentioned in code but doesnt seem to have a .pal file, will leave here for now
    { L"kishima.pal",	L"Kouma Kishima",				65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Kouma },
    { L"s_akiha.pal",	L"Akiha Tohno (Seifuku)",		65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Seifuku },
    { L"ries.pal",  	L"Riesbyfe Stridberg",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Riesbyfe },
    { L"roa.pal",	    L"Roa",							65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Roa },

    //Name = MECH_AND_NECO
    { L"m_hisui_m.pal",	L"Mech-Hisui (Master)",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_NecoMech },
    { L"neco_p.pal",	L"Neco-Arc (Puppt)",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_NecoMech },

    //Name = MECH_AND_KOHAKU
    { L"kohaku_m.pal",	L"Kohaku (Master)",				65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_KohaMech },
    { L"m_hisui_p.pal",	L"Mech_Hisui (Puppt)",			65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_KohaMech },

    { L"ryougi.pal",	L"Shiki Ryougi",				65540, MBAACCNormalPalettes, ARRAYSIZE(MBAACCNormalPalettes), 0x4, indexMBAACCSprites_Ryougi },
