...
{
    { _T("Small Body (Intro)"), 0x71ECE, 0x71EEE, 0x4F, 0x00 },
    { _T("Giant Head"),         0x71E8E, 0x71EAE, 0x4F, 0x01 },
    { _T("Giant Body"),         0x59EF4, 0x59F34, 0x4F, 0x03 },
    { _T("Giant Arm"),          0x71E6E, 0x71E8E, 0x4F, 0x02 },
    { _T("Shoulder Gun"),       0x71EAE, 0x71ECE, 0x4F, 0x04 },
    { _T("Shockwave"),          0x71EEE, 0x71F0E },
    { _T("?"),                  0x71F0E, 0x71F2E },
    { _T("Apocalypse Drone"),   0x71F2E, 0x71F4E, 0x4F, 0x05 },
    { _T("Hand: Mace and Drill"), 0x71F4E, 0x71F6E },
};

const sGame_PaletteDataset MSHVSF_A_ARMORED_SPIDERMAN_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x7340E, 0x7342E, 0x0C },
    { _T("Extra 01: webs"),          0x7342E, 0x7344E, 0x0C, 2 },
};

const sGame_PaletteDataset MSHVSF_A_ARMORED_SPIDERMAN_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x7346E, 0x7348E, 0x0C },
    { _T("Extra 02: webs"),         0x7348E, 0x734AE, 0x0C, 2 },
};

const sGame_PaletteDataset MSHVSF_A_BLACKHEART_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),       0x7258E, 0x725AE, 0x35 },
    { _T("Extra 01"),               0x725AE, 0x725CE },
};
const sGame_PaletteDataset MSHVSF_A_BLACKHEART_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x725EE, 0x7260E, 0x35 },
    { _T("Extra 02"),               0x7260E, 0x7262E },
};

const sGame_PaletteDataset MSHVSF_A_MEPHISTO_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x7334E, 0x7336E, 0x35 },
};
const sGame_PaletteDataset MSHVSF_A_MEPHISTO_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x733AE, 0x733CE, 0x35 },
};
...
const sGame_PaletteDataset MSHVSF_A_BLACKHEART_MEPHISTO_PALETTES_SHARED[] =
{
    ...
    { _T("P1 HP/HK Demons"), 0x769CE, 0x769EE, 0x35, 0x02 },
    ...
    { _T("Blackheart P2 HP/HK Demons (hurt)"), 0x7262E, 0x7264E, 0x35, 0x02 },
    { _T("Mephisto P2 HP/HK Demons (hurt)"), 0x733EE, 0x7340E, 0x35, 0x02 },
...
{
    { _T("P1 Color (Punch)"),           0x7210E, 0x7212E, 0x0B, 0, &pairCaptainAmericaShield },
    { _T("P1 Shield"),                  0x7212E, 0x7214E, 0x0B, 1 },
    { _T("P1 Charging Star"),           0x7214E, 0x7216E, 0x0B, 2 },

};
const sGame_PaletteDataset MSHVSF_A_CAPTAIN_AMERICA_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),            0x7216E, 0x7218E, 0x0B, 0, &pairCaptainAmericaShield },
    { _T("P2 Shield"),                  0x7218E, 0x721AE, 0x0B, 1 },
    { _T("P2 Charging Star"),           0x721AE, 0x721CE, 0x0B, 2 },
};

const sGame_PaletteDataset MSHVSF_A_CHUNLI_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),   0x727CE, 0x727EE, 0x1B },
    { _T("P1 Extras 1"),        0x727EE, 0x7280E, 0x1B, 1 },
    { _T("P1 Kikosho"),         0x7280E, 0x7282E, 0x1B, 2 },
};
const sGame_PaletteDataset MSHVSF_A_CHUNLI_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),    0x7282E, 0x7284E, 0x1B },
    { _T("P2 Extras 1"),        0x7284E, 0x7286E, 0x1B, 1 },
    { _T("P2 Kikosho"),         0x7286E, 0x7288E, 0x1B, 2 },
};
...
{
    { _T("P1 Color (Punch)"), 0x71F8E, 0x71FAE, 0x06 },
    { _T("P1 HK Extra"), 0x71FAE, 0x71FCE, 0x06, 1 },
    { _T("P1 Optic Blast Super"), 0x71FCE, 0x71FEE, 0x06, 2 },
    { _T("P1 Intro 1"), 0x7616E, 0x7618E, 0x06 },
    { _T("P1 Intro 2"), 0x7618E, 0x761AE, 0x06 },
    { _T("P1 Intro 3"), 0x761AE, 0x761CE, 0x06 },
    { _T("P1 Intro 4"), 0x761CE, 0x761EE, 0x06 },
    { _T("P1 Intro 5"), 0x761EE, 0x7620E, 0x06 },
    { _T("P1 Intro 6"), 0x7620E, 0x7622E, 0x06 },
    { _T("P1 Intro 7"), 0x7622E, 0x7624E, 0x06 },
    { _T("P1 Intro 8"), 0x7624E, 0x7626E, 0x06 },
    { _T("P1 Extra Lighting"), 0x7640E, 0x7642E, 0x06 },
};
const sGame_PaletteDataset MSHVSF_A_CYCLOPS_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"), 0x71FEE, 0x7200E, 0x06 },
    { _T("P2 HK Extra"), 0x7200E, 0x7202E, 0x06, 1 },
    { _T("P2 Optic Blast Super"), 0x7202E, 0x7204E, 0x06, 2 },
    { _T("P2 Intro 1"), 0x7626E, 0x7628E, 0x06 },
    { _T("P2 Intro 2"), 0x7628E, 0x762AE, 0x06 },
    { _T("P2 Intro 3"), 0x762AE, 0x762CE, 0x06 },
    { _T("P2 Intro 4"), 0x762CE, 0x762EE, 0x06 },
    { _T("P2 Intro 5"), 0x762EE, 0x7630E, 0x06 },
    { _T("P2 Intro 6"), 0x7630E, 0x7632E, 0x06 },
    { _T("P2 Intro 7"), 0x7632E, 0x7634E, 0x06 },
    { _T("P2 Intro 8"), 0x7634E, 0x7636E, 0x06 },
    { _T("P2 Extra Lighting 2"), 0x7644E, 0x7646E, 0x06 },
};
const sGame_PaletteDataset MSHVSF_A_CYCLOPS_PALETTES_SHARED[] =
{
    { _T("P1 Optic Light Extra?"), 0x7642E, 0x7644E, 0x06 },
    { _T("P2 Laser FX"), 0x720EE, 0x7210E, 0x06, 3 },
    { _T("P2 Optic Blast Palette?"), 0x7638E, 0x763AE },
};

const sGame_PaletteDataset MSHVSF_A_DAN_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x72E0E, 0x72E2E,  0x23 },
    { _T("P1 gadoken"), 0x72E2E, 0x72E4E, 0x23, 1 },
};
const sGame_PaletteDataset MSHVSF_A_DAN_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x72E6E, 0x72E8E, 0x23 },
    { _T("P2 gadoken"), 0x72E8E, 0x72EAE, 0x23, 1 },
};

const sGame_PaletteDataset MSHVSF_A_DARK_SAKURA_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x7310E, 0x7312E,  0x22 },
    { _T("P1 Hadouken"), 0x7312E, 0x7314E, 0x27, 1 },
};
const sGame_PaletteDataset MSHVSF_A_DARK_SAKURA_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x7316E, 0x7318E, 0x22 },
    { _T("P2 Hadouken"), 0x7318E, 0x731AE, 0x27, 1 },
};

const sGame_PaletteDataset MSHVSF_A_DHALSIM_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x7288E, 0x728AE, 0x25 },
    { _T("P1 Extras 1 Flames"),      0x728AE, 0x728CE, 0x25, 1 },
    { _T("P1 Extras Sally"),         0x728CE, 0x728EE, 0x25, 2 },
    { _T("P1 Teleport 1"), 0x76CCE, 0x76CEE, 0x25, 0xb },
    { _T("P1 Teleport 2"), 0x76CEE, 0x76D0E, 0x25, 0xb },
    { _T("P1 Teleport 3"), 0x76D0E, 0x76D2E, 0x25, 0xb },
    { _T("P1 Teleport 4"), 0x76D2E, 0x76D4E, 0x25, 0xb },
    //{ _T("P1 Teleport 5"), 0x76D4E, 0x76D6E, 0x25, 0xb }, // This is just the all-white frame.

};
const sGame_PaletteDataset MSHVSF_A_DHALSIM_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x728EE, 0x7290E, 0x25 },
    { _T("P2 Extras 1 Flames"),     0x7290E, 0x7292E, 0x25, 1 },
    { _T("P2 Extras Sally"),        0x7292E, 0x7294E, 0x25, 2 },
    { _T("P2 Teleport 1"),          0x76D6E, 0x76D8E, 0x25, 0xb },
    { _T("P2 Teleport 2"),          0x76D8E, 0x76DAE, 0x25, 0xb },
    { _T("P2 Teleport 3"),          0x76DAE, 0x76DCE, 0x25, 0xb },
    { _T("P2 Teleport 4"),          0x76DCE, 0x76DEE, 0x25, 0xb },
};
...
{
    { _T("P1 Color (Punch)"),        0x721CE, 0x721EE, 0x0D },
    { _T("P1 Extras 1"),             0x721EE, 0x7220E, 0x0D, 1 },
    { _T("P1 Extras 2"),             0x7220E, 0x7222E, 0x0D, 2 },
};
const sGame_PaletteDataset MSHVSF_A_HULK_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),         0x7222E, 0x7224E, 0x0D },
    { _T("P2 Extras 1"),             0x7224E, 0x7226E, 0x0D, 1 },
    { _T("P2 Extras 2 "),            0x7226E, 0x7228E, 0x0D, 2 },
};

const sGame_PaletteDataset MSHVSF_A_KEN_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x7270E, 0x7272E, 0x27 },
    { _T("P1 Hadouken"),             0x7272E, 0x7274E, 0x27, 1 },
    { _T("P1 Shoryuken"),            0x7274E, 0x7276E, 0x27, 2 },
};
const sGame_PaletteDataset MSHVSF_A_KEN_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"), 0x7276E, 0x7278E, 0x27 },
    { _T("P2 Hadouken"), 0x7278E, 0x727AE, 0x27, 1 },
    { _T("P2 Shoryuken"), 0x727AE, 0x727CE, 0x27, 2 },
};

const sGame_PaletteDataset MSHVSF_A_MBIPSON_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),       0x72B0E, 0x72B2E,  0x26 },
...
{
    { _T("P2 Color (Kick)"),        0x72B6E, 0x72B8E, 0x26 },
...
{
    { _T("P1 Color (Punch)"),       0x72F8E, 0x72FAE, 0x01 },
    { _T("P1 Vodka Fire"),          0x72FAE, 0x72FCE, 0x01, 3 },
};
const sGame_PaletteDataset MSHVSF_A_MECH_ZANGIEF_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x72FEE, 0x7300E, 0x01 },
    { _T("P2 Vodka Fire"),          0x7300E, 0x7302E, 0x01, 3 },
};
const sGame_PaletteDataset MSHVSF_A_MECH_ZANGIEF_PALETTES_SHARED[] =
{
    { _T("P1+P2 Super Armor "), 0x7304E, 0x7306E, 0x01 },
};

const sGame_PaletteDataset MSHVSF_A_NORIMARO_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),       0x72D4E, 0x72D6E, 0x53 },
    { _T("P1 Extras 1"),            0x7710E, 0x7712E, 0x53 },
    { _T("P1 Extras 2"),            0x7716E, 0x7718E, },
};
const sGame_PaletteDataset MSHVSF_A_NORIMARO_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x72DAE, 0x72DCE, 0x53 },
    { _T("P2 Extras 1"),            0x7718E, 0x771AE, 0x53 },
...
{
    { _T("P1 Color (Punch)"),       0x7240E, 0x7242E, 0x30 },
    { _T("P1 Intro 1"), 0x764AE, 0x764CE, 0x30 }, 
    { _T("P1 Intro 2"), 0x764CE, 0x764EE, 0x30 },
    { _T("P1 Intro 3"), 0x764EE, 0x7650E, 0x30 },
    { _T("P1 Intro 4"), 0x7650E, 0x7652E, 0x30 },
    { _T("P1 Intro Shockwave 1"), 0x7242E, 0x7244E, 0x30, 1 },
    { _T("P1 Intro Shockwave 2"), 0x7244E, 0x7246E, 0x30, 1 },
};
const sGame_PaletteDataset MSHVSF_A_OMEGARED_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),       0x7246E, 0x7248E, 0x30 },
    { _T("P2 Intro 1"), 0x7652E, 0x7654E, 0x30 },
    { _T("P2 Intro 2"), 0x7654E, 0x7656E, 0x30 },
    { _T("P2 Intro 3"), 0x7656E, 0x7658E, 0x30 },
    { _T("P2 Intro 4"), 0x7658E, 0x765AE, 0x30 },
    { _T("P2 Intro Shockwave 1"), 0x7248E, 0x724AE, 0x30, 1 },
    { _T("P2 Intro Shockwave 2"), 0x724AE, 0x724CE, 0x30, 2 },
...
{
    { _T("P1 Color (Punch)"),        0x72C8E, 0x72CAE,  0x22 },
    { _T("P1 Extras 1 Hadouken"), 0x72CAE, 0x72CCE, 0x27, 1 },
...
{
    { _T("P2 Color (Kick)"),        0x72CEE, 0x72D0E, 0x22 },
    { _T("P2 Extras 1 Hadouken"), 0x72D0E, 0x72D2E, 0x27, 1 },
...
{
    { _T("P1 Color (Punch)"),       0x731CE, 0x731EE, 0x21 },
    { _T("P1 Sonic Boom"), 0x731EE, 0x7320E, 0x21, 1 },
    { _T("P1 Flash Kick"), 0x7320E, 0x7322E, 0x21, 2 },
};
const sGame_PaletteDataset MSHVSF_A_SHADOW_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x7322E, 0x7324E,  0x21 },
    { _T("P2 Sonic Boom"), 0x7324E, 0x7326E, 0x21, 1 },
    { _T("P2 Flash Kick"), 0x7326E, 0x7328E, 0x21, 2 }, 
};
...
{ // 2 is web
    { _T("P1 Color (Punch)"), 0x724CE, 0x724EE, 0x0C },
    { _T("P1 Extras 1"), 0x724EE, 0x7250E, 0x0C, 0x2 },
    { _T("P1 Spotlight"), 0x7250E, 0x7252E, 0x0C, 13 },
    { _T("P1 Intro 1"), 0x765CE, 0x765EE, 0x0C, 0x0B },
    { _T("P1 Intro 2"), 0x765EE, 0x7660E, 0x0C, 0x0B },
    { _T("P1 Intro 3"), 0x7660E, 0x7662E, 0x0C, 0x0B },
    { _T("P1 Intro 4"), 0x7662E, 0x7664E, 0x0C, 0x0B },
    { _T("P1 Intro 5"), 0x7664E, 0x7666E, 0x0C, 0x0B },
    { _T("P1 Intro 6"), 0x7666E, 0x7668E, 0x0C, 0x0B },
    { _T("P1 Intro 7"), 0x7668E, 0x766AE, 0x0C, 0x0B },
    { _T("P1 Intro 8"), 0x766AE, 0x766CE, 0x0C, 0x0B },
};
const sGame_PaletteDataset MSHVSF_A_SPIDERMAN_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"), 0x7252E, 0x7254E, 0x0C },
    { _T("P2 Extras 1"), 0x7254E, 0x7256E, 0x0C, 0x2 },
    { _T("P2 Spotlight"), 0x7256E, 0x7258E, 0x0C, 13 },
    { _T("P2 Intro 1"), 0x767CE, 0x767EE, 0x0C, 0x0B },
    { _T("P2 Intro 2"), 0x767EE, 0x7680E, 0x0C, 0x0B },
    { _T("P2 Intro 3"), 0x7680E, 0x7682E, 0x0C, 0x0B },
    { _T("P2 Intro 4"), 0x7682E, 0x7684E, 0x0C, 0x0B },
    { _T("P2 Intro 5"), 0x7684E, 0x7686E, 0x0C, 0x0B },
    { _T("P2 Intro 6"), 0x7686E, 0x7688E, 0x0C, 0x0B },
    { _T("P2 Intro 7"), 0x7688E, 0x768AE, 0x0C, 0x0B },
    { _T("P2 Intro 8"), 0x768AE, 0x768CE, 0x0C, 0x0B },
};
const sGame_PaletteDataset MSHVSF_A_SPIDERMAN_PALETTES_SHARED[] =
{
    { _T("P1 Extras 2: Spotlight"), 0x766CE, 0x766EE, 0x0C, 0x0C },
};

const sGame_PaletteDataset MSHVSF_A_USAGENT_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),        0x7328E, 0x732AE, 0x0B, 0, &pairCaptainAmericaShield },
    { _T("P1 Shield"), 0x732AE, 0x732CE, 0x0B, 1 },
    { _T("P1 Charging Star"), 0x732CE, 0x732EE, 0x0B, 2 },

};
const sGame_PaletteDataset MSHVSF_A_USAGENT_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x732EE, 0x7330E, 0x0B, 0, &pairCaptainAmericaShield },
    { _T("P2 Shield"), 0x7330E, 0x7332E, 0x0B, 1 },
    { _T("P2 Charging Star"), 0x7332E, 0x7334E, 0x0B, 2 },
};

const sGame_PaletteDataset MSHVSF_A_WOLVERINE_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),       0x7228E, 0x722AE, 0x07, 0, &pairWolvieClaws },
    { _T("P1 Claws"), 0x722AE, 0x722CE, 0x07, 1 },
    { _T("P1 Extras 1"), 0x722CE, 0x722EE, 0x07, 2 },
    { _T("P1 Extras 2 (Fatal Claw)"), 0x7804E, 0x7806E },
};
const sGame_PaletteDataset MSHVSF_A_WOLVERINE_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x722EE, 0x7230E, 0x07, 0, &pairWolvieClaws },
    { _T("P2 Claws"), 0x7230E, 0x7232E, 0x07, 1 },
    { _T("P2 Extras 1"), 0x7232E, 0x7234E, 0x07, 2 },
    { _T("P2 Extras 2 (Fatal Claw)"), 0x7806E, 0x7808E },
};

const sGame_PaletteDataset MSHVSF_A_ZANGIEF_PALETTES_P1COLOR_PUNCH[] =
{
    { _T("P1 Color (Punch)"),   0x7294E, 0x7296E, 0x01 },
    { _T("P1 Banishing Fist"),  0x7296E, 0x7298E, 0x01, 1 },
    { _T("P1 Extra 2"),         0x7298E, 0x729AE },
    { _T("P1 FAB 1"),           0x72A4E, 0x72A6E, 0x01 },
    { _T("P1 FAB 2"),           0x72A6E, 0x72A8E, 0x01 },
    { _T("P1 FAB 3"),           0x72A8E, 0x72AAE, 0x01 },
};
const sGame_PaletteDataset MSHVSF_A_ZANGIEF_PALETTES_P2COLOR_KICK[] =
{
    { _T("P2 Color (Kick)"),        0x729AE, 0x729CE, 0x01 },
    { _T("P2 Banishing Fist"),      0x729CE, 0x729EE, 0x01, 1 },
    { _T("P2 Extra 2"),             0x729EE, 0x72A0E },
    { _T("P2 FAB 1"),               0x72AAE, 0x72ACE, 0x01 },
    { _T("P2 FAB 2"),               0x72ACE, 0x72AEE, 0x01 },
    { _T("P2 FAB 3"),               0x72AEE, 0x72B0E, 0x01 },
};

const sGame_PaletteDataset MSHVSF_A_CSI_PALETTES[] =
{
    { _T("Zangief CSI"), 0x7990E, 0x7992E, 0x01, 0x30 },
    { _T("M. Bison CSI"), 0x7992E, 0x7994E, 0x26, 0x30 },
    { _T("Dhalsim CSI"), 0x798EE, 0x7990E, 0x25, 0x30 },
    { _T("Sakura CSI"), 0x7996E, 0x7998E, 0x22, 0x30 },
    { _T("Akuma CSI"), 0x7994E, 0x7996E, 0x1E, 0x30 },
    { _T("Chun-Li CSI"), 0x798CE, 0x798EE, 0x1B, 0x30 },
    { _T("Cyclops CSI"), 0x7978E, 0x797AE, 0x06, 0x30 },
    { _T("Spider-Man CSI"), 0x7984E, 0x7986E, 0x0C, 0x30 },
    { _T("Captain America CSI"), 0x797AE, 0x797CE, 0x0B, 0x30 },
    { _T("Ken CSI"), 0x798AE, 0x798CE, 0x27, 0x30 },
    { _T("Ryu CSI"), 0x7988E, 0x798AE, 0x0, 0x30 },
    { _T("Dan CSI"), 0x799AE, 0x799CE, 0x23, 0x30 },
    { _T("Shuma-Gorath CSI"), 0x7980E, 0x7982E, 0x2D, 0x30 },
    { _T("Wolverine CSI"), 0x797EE, 0x7980E, 0x07, 0x30 },
    { _T("Hulk CSI"), 0x797CE, 0x797EE, 0x0D, 0x30 },
    { _T("Blackheart CSI"), 0x7986E, 0x7988E, 0x35, 0x30 },
    { _T("Norimaro CSI"), 0x7998E, 0x799AE, 0x53, 0x30 },
    { _T("Omega Red CSI"), 0x7982E, 0x7984E, 0x30, 0x30 },
};

const sGame_PaletteDataset MSHVSF_A_SSP_PALETTES[] =
{
    // P1 to P2 SSP is diff 0x10E0
    { _T("A. Spider-Man P1 SSP"), 0x7DA4E, 0x7DA8E, 0x0C, 0x31 },
    { _T("A. Spider-Man P2 SSP"), 0x7EB2E, 0x7EB6E, 0x0C, 0x31 },
    { _T("Akuma P1 SSP"), 0x7D40E, 0x7D48E, 0x1E, 0x31 },
    { _T("Akuma P2 SSP"), 0x7E4EE, 0x7E56E, 0x1E, 0x31 },
    { _T("Blackheart P1 SSP"), 0x7CFAE, 0x7D02E, 0x35, 0x31 },
    { _T("Blackheart P2 SSP"), 0x7E08E, 0x7E10E, 0x35, 0x31 },
    { _T("Captain America P1 SSP"), 0x7CBEE, 0x7CC8E, 0x0B, 0x31 },
    { _T("Captain America P2 SSP"), 0x7DCCE, 0x7DD6E, 0x0B, 0x31 },
    { _T("Chun-Li P1 SSP"), 0x7D18E, 0x7D20E, 0x1b, 0x31 },
    { _T("Chun-Li P2 SSP"), 0x7E26E, 0x7E2EE, 0x1b, 0x31 },
    { _T("Cyber Akuma P1 SSP"), 0x7D68E, 0x7D70E, 0x54, 0x31 },
    { _T("Cyber Akuma P2 SSP"), 0x7E76E, 0x7E7EE, 0x54, 0x31 },
    { _T("Cyclops P1 SSP"), 0x7CB4E, 0x7CBEE, 0x06, 0x31 },
    { _T("Cyclops P2 SSP"), 0x7DC2E, 0x7DCCE, 0x06, 0x31 },
    { _T("Dan P1 SSP"), 0x7D5EE, 0x7D66E, 0x23, 0x31 },
    { _T("Dan P2 SSP"), 0x7E6CE, 0x7E74E, 0x23, 0x31 },
    { _T("Dark Sakura P1 SSP"), 0x7D7CE, 0x7D84E, 0x22, 0x31 },
    { _T("Dark Sakura P2 SSP"), 0x7E8AE, 0x7E92E, 0x22, 0x31 },
    { _T("Dhalsim P1 SSP"), 0x7D22E, 0x7D2AE, 0x25, 0x31 },
    { _T("Dhalsim P2 SSP"), 0x7E30E, 0x7E38E, 0x25, 0x31 },
    { _T("Hulk P1 SSP"), 0x7CC8E, 0x7CCEE, 0x0D, 0x31 },
    { _T("Hulk P2 SSP"), 0x7DD6E, 0x7DDCE, 0x0D, 0x31 },
    { _T("Ken P1 SSP"), 0x7D0EE, 0x7D16E, 0x27, 0x31 },
    { _T("Ken P2 SSP"), 0x7E1CE, 0x7E24E, 0x27, 0x31 },
    { _T("M. Bison P1 SSP"), 0x7D36E, 0x7D3EE, 0x26, 0x31 },
    { _T("M. Bison P2 SSP"), 0x7E44E, 0x7E4CE, 0x26, 0x31 },
    { _T("Mech Zangief P1 SSP"), 0x7D72E, 0x7D78E, 0x01, 0x31 },
    { _T("Mech Zangief P2 SSP"), 0x7E80E, 0x7E86E, 0x01, 0x31 },
    { _T("Mephisto P1 SSP"), 0x7D9AE, 0x7DA2E, 0x35, 0x31 },
    { _T("Mephisto P2 SSP"), 0x7EA8E, 0x7EB0E, 0x35, 0x31 },
    { _T("Norimaro P1 SSP"), 0x7D54E, 0x7D5EE, 0x53, 0x31 },
    { _T("Norimaro P2 SSP"), 0x7E62E, 0x7E6CE, 0x53, 0x31 },
    { _T("Omega Red P1 SSP"), 0x7CE6E, 0x7CEEE, 0x30, 0x31 },
    { _T("Omega Red P2 SSP"), 0x7DF4E, 0x7DFCE, 0x30, 0x31 },
    { _T("Ryu P1 SSP"), 0x7D04E, 0x7D0CE, 0x00, 0x31 },
    { _T("Ryu P2 SSP"), 0x7E12E, 0x7E1AE, 0x00, 0x31 },
    { _T("Sakura P1 SSP"), 0x7D4AE, 0x7D52E, 0x22, 0x31 },
    { _T("Sakura P2 SSP"), 0x7E58E, 0x7E60E, 0x22, 0x31 },
    { _T("Shadow P1 SSP"), 0x7D86E, 0x7D90E, 0x21, 0x31 },
    { _T("Shadow P2 SSP"), 0x7E94E, 0x7E9EE, 0x21, 0x31 },
    { _T("Shuma-Gorath P1 SSP"), 0x7CDCE, 0x7CE2E, 0x2D, 0x31, },
    { _T("Shuma-Gorath P2 SSP"), 0x7DEAE, 0x7DF0E, 0x2D, 0x31 },
    { _T("Spider-Man P1 SSP"), 0x7CF0E, 0x7CF4E, 0x0C, 0x31 },
    { _T("Spider-Man P2 SSP"), 0x7DFEE, 0x7E02E, 0x0C, 0x31 },
    { _T("US Agent P1 SSP"), 0x7D90E, 0x7D9AE, 0x0B, 0x31 },
    { _T("US Agent P2 SSP"), 0x7E9EE, 0x7EA8E, 0x0B, 0x31 },
    { _T("Wolverine P1 SSP"), 0x7CD2E, 0x7CDAE, 0x07, 0x31 },
    { _T("Wolverine P2 SSP"), 0x7DE0E, 0x7DE8E, 0x07, 0x31 },
    { _T("Zangief P1 SSP"), 0x7D2CE, 0x7D32E, 0x01, 0x31 },
    { _T("Zangief P2 SSP"), 0x7E3AE, 0x7E40E, 0x01, 0x31 },
...
{
    { _T("P1 Color (Punch)"),    DESC_NODETYPE_TREE,    (void*)MSHVSF_A_GOUKI_PALETTES_P1COLOR_PUNCH,    ARRAYSIZE(MSHVSF_A_GOUKI_PALETTES_P1COLOR_PUNCH) },
    { _T("P2 Color (Kick)"),     DESC_NODETYPE_TREE,    (void*)MSHVSF_A_GOUKI_PALETTES_P2COLOR_KICK,     ARRAYSIZE(MSHVSF_A_GOUKI_PALETTES_P2COLOR_KICK) },
};
...
{
    { _T("P1 Color (Punch)"),    DESC_NODETYPE_TREE,    (void*)MSHVSF_A_CYBER_GOUKI_PALETTES_P1COLOR_PUNCH,    ARRAYSIZE(MSHVSF_A_CYBER_GOUKI_PALETTES_P1COLOR_PUNCH) },
    { _T("P2 Color (Kick)"),     DESC_NODETYPE_TREE,    (void*)MSHVSF_A_CYBER_GOUKI_PALETTES_P2COLOR_KICK,     ARRAYSIZE(MSHVSF_A_CYBER_GOUKI_PALETTES_P2COLOR_KICK) },
};
...
const sDescTreeNode MSHVSF_A_UNITS_6A[MSHVSF_A_NUM_IND_6A] =
{
    ...
    { _T("Cyber Akuma"),         DESC_NODETYPE_TREE, (void*)MSHVSF_A_CYBER_GOUKI_COLLECTION,         ARRAYSIZE(MSHVSF_A_CYBER_GOUKI_COLLECTION) },
    ...
    { _T("Gouki"),               DESC_NODETYPE_TREE, (void*)MSHVSF_A_GOUKI_COLLECTION,               ARRAYSIZE(MSHVSF_A_GOUKI_COLLECTION) },
