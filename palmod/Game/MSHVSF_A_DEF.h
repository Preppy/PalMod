...
{
    { L"VS Screen FB # 1", 0x75dc, 0x761c },
    { L"VS Screen VS Text 1", 0x7b7c, 0x7b9c },
    { L"VS Screen VS Text 2", 0x7b9c, 0x7bbc },
    { L"VS Screen VS Text 3", 0x7bbc, 0x7bdc },
    { L"VS Screen VS Text 4", 0x7bdc, 0x7bfc },
    { L"VS Screen VS Text 5", 0x7bfc, 0x7c1c },
    { L"VS Screen VS Text 6", 0x7c1c, 0x7c3c },
    { L"VS Screen VS Text 7", 0x7c3c, 0x7c5c },
    { L"VS Screen VS Text 8", 0x7c5c, 0x7c7c },
    { L"VS Screen VS Text 9", 0x7c7c, 0x7c9c },
    { L"VS Screen VS Text 10", 0x7c9c, 0x7cbc },
    { L"VS Screen VS Text 11", 0x7cbc, 0x7cdc },
    { L"VS Screen VS Text 12", 0x7cdc, 0x7cfc },
    { L"VS Screen VS Text 13", 0x7cfc, 0x7d1c },
    { L"VS Screen VS Text 14", 0x7d1c, 0x7d3c },
    { L"VS Screen VS Text 15", 0x7d3c, 0x7d5c },
    { L"VS Screen VS Text 16", 0x7d5c, 0x7d7c },
    { L"VS Screen VS Text 17", 0x7d7c, 0x7d9c },
    { L"VS Screen VS Text 18", 0x7d9c, 0x7dbc },
    { L"VS Screen VS Text 19", 0x7dbc, 0x7ddc },
    { L"VS Screen VS Text 20", 0x7ddc, 0x7dfc },
    { L"VS Screen VS Text 21", 0x7dfc, 0x7e1c },
    { L"VS Screen VS Text 22", 0x7e1c, 0x7e3c },
    { L"VS Screen VS Text 23", 0x7e3c, 0x7e5c },
    { L"VS Screen VS Text 24", 0x7e5c, 0x7e7c },
    { L"VS Screen VS Text 25", 0x7e7c, 0x7e9c },
    { L"VS Screen VS Text 26", 0x7e9c, 0x7ebc },
    { L"VS Screen VS Text 27", 0x7ebc, 0x7edc },
    { L"VS Screen VS Text 28", 0x7edc, 0x7efc },
    { L"VS Screen FB #2 / READY", 0x737c, 0x739c },
    { L"FIGHT 1", 0x777c, 0x779c },
    { L"FIGHT 2", 0x779c, 0x77bc },
    { L"FIGHT 3", 0x77bc, 0x77dc },
    { L"FIGHT 4", 0x77dc, 0x77fc },
    { L"FIGHT 5", 0x77fc, 0x781c },
    { L"FIGHT 6", 0x781c, 0x783c },
    { L"FIGHT 7", 0x783c, 0x785c },
    { L"FIGHT 8", 0x785c, 0x787c },
    { L"FIGHT 9", 0x787c, 0x789c },
    { L"FIGHT 10", 0x789c, 0x78bc },
    { L"FIGHT 11", 0x78bc, 0x78dc },
    { L"FIGHT 12", 0x78dc, 0x78fc },
    { L"FIGHT 13", 0x78fc, 0x791c },
    { L"FIGHT 14", 0x791c, 0x793c },
    { L"FIGHT 15", 0x793c, 0x795c },
    { L"FIGHT 16", 0x795c, 0x797c },
    { L"FIGHT 17", 0x797c, 0x799c },
    { L"FIGHT 18", 0x799c, 0x79bc },
    { L"KO 1", 0x7efc, 0x7f1c },
    { L"KO 2", 0x7f1c, 0x7f3c },
    { L"KO 3", 0x7f3c, 0x7f5c },
    { L"KO 4", 0x7f5c, 0x7f7c },
    { L"KO 5", 0x7f7c, 0x7f9c },
    { L"KO 6", 0x7f9c, 0x7fbc },
    { L"KO 7", 0x7fbc, 0x7fdc },
    { L"KO 8", 0x7fdc, 0x7ffc },
    { L"KO 9", 0x7ffc, 0x801c },
    { L"KO 10", 0x801c, 0x803c },
    { L"KO 11", 0x803c, 0x805c },
    { L"KO 12", 0x805c, 0x807c },
    { L"KO 13", 0x807c, 0x809c },
    { L"KO 14", 0x809c, 0x80bc },
    { L"KO 15", 0x80bc, 0x80dc },
    { L"KO 16", 0x80dc, 0x80fc },
    { L"KO 17", 0x80fc, 0x811c },
    { L"KO 18", 0x811c, 0x813c },
    { L"KO 19", 0x813c, 0x815c },
    { L"KO 20", 0x815c, 0x817c },
    { L"KO 21", 0x817c, 0x819c },
    { L"KO 22", 0x819c, 0x81bc },
    { L"KO 23", 0x81bc, 0x81dc },
    { L"KO 24", 0x81dc, 0x81fc },
    { L"KO 25", 0x81fc, 0x821c },
    { L"KO 26", 0x821c, 0x823c },
    { L"KO 27", 0x823c, 0x825c },
    { L"KO 28", 0x825c, 0x827c },
    { L"PERFECT 1", 0x82bc, 0x82dc },
    { L"PERFECT 2", 0x82dc, 0x82fc },
    { L"PERFECT 3", 0x82fc, 0x831c },
    { L"PERFECT 4", 0x831c, 0x833c },
    { L"PERFECT 5", 0x833c, 0x835c },
    { L"PERFECT 6", 0x835c, 0x837c },
    { L"PERFECT 7", 0x837c, 0x839c },
    { L"PERFECT 8", 0x839c, 0x83bc },
    { L"PERFECT 9", 0x83bc, 0x83dc },
    { L"PERFECT 10", 0x83dc, 0x83fc },
    { L"PERFECT 11", 0x83fc, 0x841c },
    { L"PERFECT 12", 0x841c, 0x843c },
    { L"PERFECT 13", 0x843c, 0x845c },
    { L"PERFECT 14", 0x845c, 0x847c },
    { L"PERFECT 15", 0x847c, 0x849c },
    { L"WIN 1", 0x849c, 0x84bc },
    { L"WIN 2", 0x84bc, 0x84dc },
    { L"WIN 3", 0x84dc, 0x84fc },
    { L"WIN 4", 0x84fc, 0x851c },
    { L"WIN 5", 0x851c, 0x853c },
    { L"WIN 6", 0x853c, 0x855c },
    { L"WIN 7", 0x855c, 0x857c },
    { L"WIN 8", 0x857c, 0x859c },
    { L"WIN 9", 0x859c, 0x85bc },
    { L"WIN 10", 0x85bc, 0x85dc },
    { L"WIN 11", 0x85dc, 0x85fc },
    { L"WIN 12", 0x85fc, 0x861c },
    { L"WIN 13", 0x861c, 0x863c },
    { L"WIN 14", 0x863c, 0x865c },
    { L"WIN 15", 0x865c, 0x867c },
    { L"WIN 16", 0x867c, 0x869c },
    { L"WIN 17", 0x869c, 0x86bc },
    { L"TIME OVER 1", 0x827c, 0x829c },
    { L"TIME OVER 2", 0x829c, 0x82bc },
    { L"DRAW GAME", 0x86bc, 0x86dc },
};
