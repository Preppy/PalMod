...
{
private:
    static uint32_t m_nTotalPaletteCountForBMKNS;

    static uint32_t rgExtraCountAll[BMKNS_SNES_NUMUNIT + 1];
    static uint32_t rgExtraLoc[BMKNS_SNES_NUMUNIT + 1];
...
public:
    CGame_BMKNS_SNES(uint32_t nConfirmedROMSize);
    ~CGame_BMKNS_SNES();
