...
{
    { L"Terry Bogard P1", 0x40200, 0x40220 },
    { L"Terry Bogard Portrait P1", 0x408a0, 0x408c0 },
};

const sGame_PaletteDataset FatalFuryS_A_Terry_PALETTES_P2[] =
{
    { L"Terry Bogard P2", 0x41000, 0x41020 },
    { L"Terry Bogard Portrait P2", 0x418a0, 0x418c0 },
};
...
{
    { L"Andy Bogard P1", 0x40220, 0x40240 },
    { L"Andy Bogard Portrait P1", 0x408c0, 0x408e0 },
};

const sGame_PaletteDataset FatalFuryS_A_Andy_PALETTES_P2[] =
{
    { L"Andy Bogard P2", 0x41020, 0x41040 },
    { L"Andy Bogard Portrait P2", 0x418c0, 0x418e0 },
};
...
{
    { L"Joe Higashi P1", 0x40240, 0x40260 },
    { L"Joe Higashi Portrait P1", 0x408e0, 0x40900 },
    { L"Joe Higashi Hurricane Upper P1", 0x40480, 0x404a0 },
};

const sGame_PaletteDataset FatalFuryS_A_Joe_PALETTES_P2[] =
{
    { L"Joe Higashi P2", 0x41040, 0x41060 },
    { L"Joe Higashi Portrait P2", 0x418e0, 0x41900 },
...
{
    { L"Big Bear P1", 0x40260, 0x40280 },
    { L"Big Bear Portrait P1", 0x40900, 0x40920 },
};

const sGame_PaletteDataset FatalFuryS_A_BigBear_PALETTES_P2[] =
{
    { L"Big Bear P2", 0x41060, 0x41080 },
    { L"Big Bear Portrait P2", 0x41900, 0x41920 },
};
...
{
    { L"Jubei Yamada P1", 0x40280, 0x402a0 },
    { L"Jubei Yamada Portrait P1", 0x40920, 0x40940 },
...
{
    { L"Jubei Yamada P2", 0x41080, 0x410a0 },
    { L"Jubei Yamada Portrait P2", 0x41920, 0x41940 },
...
{
    { L"Cheng Sinzan P1", 0x402a0, 0x402c0 },
    { L"Cheng Sinzan Portrait P1", 0x40940, 0x40960 },
};

const sGame_PaletteDataset FatalFuryS_A_Cheng_PALETTES_P2[] =
{
    { L"Cheng Sinzan P2", 0x410a0, 0x410c0 },
...
{
    { L"Kim Kaphwan P1", 0x402c0, 0x402e0 },
    { L"Kim Kaphwan Portrait P1", 0x40960, 0x40980 },
};

const sGame_PaletteDataset FatalFuryS_A_Kim_PALETTES_P2[] =
{
    { L"Kim Kaphwan P2", 0x410c0, 0x410e0 },
    { L"Kim Kaphwan Portrait P2", 0x41960, 0x41980 },
};
...
{
    { L"Mai Shiranui P1", 0x40300, 0x40320 },
    { L"Mai Shiranui Portrait P1", 0x409a0, 0x409c0 },
    { L"Mai Flames P1", 0x404e0, 0x40500 },
};

const sGame_PaletteDataset FatalFuryS_A_Mai_PALETTES_P2[] =
{
    { L"Mai Shiranui P2", 0x41100, 0x41120 },
    { L"Mai Shiranui Portrait P2", 0x419a0, 0x419c0 },
...
{
    { L"Duck King P1", 0x40380, 0x403a0 },
    { L"Duck King Portrait P1", 0x40b20, 0x40b40 },
    { L"Duck King P-Chan P1", 0x40640, 0x40660 },
};

const sGame_PaletteDataset FatalFuryS_A_Duck_PALETTES_P2[] =
{
    { L"Duck King P2", 0x41180, 0x411a0 },
    { L"Duck King Portrait P2", 0x41b20, 0x41b40 },
...
{
    { L"Tung Fu Rue P1", 0x403a0, 0x403c0 },
    { L"Tung Fu Rue Portrait P1", 0x40b40, 0x40b60 },
    { L"Tung Fu Rue Effects P1", 0x40600, 0x40620 },
};

const sGame_PaletteDataset FatalFuryS_A_Tung_PALETTES_P2[] =
{
    { L"Tung Fu Rue P2", 0x411a0, 0x411c0 },
    { L"Tung Fu Rue Portrait P2", 0x41b40, 0x41b60 },
...
{
    { L"Billy Kane P1", 0x402e0, 0x40300 },
    { L"Billy Kane Portrait P1", 0x40980, 0x409a0 },
    { L"Billy Kane Flames P1", 0x40520, 0x40540 },
};

const sGame_PaletteDataset FatalFuryS_A_Billy_PALETTES_P2[] =
{
    { L"Billy Kane P2", 0x410e0, 0x41100 },
    { L"Billy Kane Portrait P2", 0x41980, 0x419a0 },
...
{
    { L"Axel Hawk P1", 0x40340, 0x40360 },
    { L"Axel Hawk Portrait P1", 0x409c0, 0x409e0 },
    { L"Axel Hawk Tornado Upper P1", 0x40660, 0x40680 },
};

const sGame_PaletteDataset FatalFuryS_A_AxelHawk_PALETTES_P2[] =
{
    { L"Axel Hawk P2", 0x41140, 0x41160 },
    { L"Axel Hawk Portrait P2", 0x419c0, 0x419e0 },
...
{
    { L"Laurence Blood P1", 0x40320, 0x40340 },
    { L"Laurence Blood Portrait P1", 0x409e0, 0x40a00 },
...
{
    { L"Laurence Blood P2", 0x41120, 0x41140 },
    { L"Laurence Blood Portrait P2", 0x419e0, 0x41a00 },
...
{
    { L"Geese Howard P1", 0x403c0, 0x403e0 },
    { L"Geese Howard Portrait P1", 0x40ba0, 0x40bc0 },
    { L"Geese Howard Effects P1", 0x40500, 0x40520 },
};

const sGame_PaletteDataset FatalFuryS_A_Geese_PALETTES_P2[] =
{
    { L"Geese Howard P2", 0x411c0, 0x411e0 },
    { L"Geese Howard Portrait P2", 0x41ba0, 0x41bc0 },
...
{
    { L"Wolfgang Krauser P1", 0x40360, 0x40380 },
    { L"Wolfgang Krauser Portrait P1", 0x40c80, 0x40ca0 },
    { L"Wolfgang Krauser Cape & Armor P1", 0x404a0, 0x404c0 },
};

const sGame_PaletteDataset FatalFuryS_A_Wolfgang_PALETTES_P2[] =
{
    { L"Wolfgang Krauser P2", 0x41160, 0x41180 },
    { L"Wolfgang Krauser Portrait P2", 0x41c80, 0x41ca0 },
...
{
    { L"Ryo Sakazaki P1", 0x403e0, 0x40400 },
    { L"Ryo Sakazaki Portrait P1", 0x40bc0, 0x40be0 },
    { L"Ryo Sakazaki Effects P1", 0x405a0, 0x405c0 },
};

const sGame_PaletteDataset FatalFuryS_A_Ryo_PALETTES_P2[] =
{
    { L"Ryo Sakazaki P2", 0x411e0, 0x41200 },
    { L"Ryo Sakazaki Portrait P2", 0x41bc0, 0x41be0 },
...
{
    { L"Terry Intro", 0x40a40, 0x40a60 },
    { L"Andy Intro", 0x40a60, 0x40a80 },
    { L"Joe Intro", 0x40a80, 0x40aa0 },
    { L"Geese Intro", 0x40aa0, 0x40ac0 },
    { L"Krauser Intro", 0x40ac0, 0x40ae0 },
    { L"Intro Extra 1", 0x40a00, 0x40a20 },
    { L"Intro Extra 2", 0x40a20, 0x40a40 },
    { L"Blue Intro Background", 0x40be0, 0x40c00 },
    { L"Red Intro Background", 0x40c00, 0x40c20 },
};

const sGame_PaletteDataset FatalFuryS_A_BONUS_STARTMENU_PALETTES[] =
{
    { L"GAROU Logo 1/6", 0x40800, 0x40820 },
    { L"GAROU Logo 2/6", 0x47040, 0x47060 },
    { L"GAROU Logo 3/6", 0x47060, 0x47080 },
    { L"GAROU Logo 4/6", 0x47080, 0x470a0 },
    { L"GAROU Logo 5/6", 0x470a0, 0x470c0 },
    { L"GAROU Logo 6/6", 0x470c0, 0x470e0 },
    { L"FATAL FURY Logo 1/6", 0x40c60, 0x40c80 },
    { L"FATAL FURY Logo 2/6", 0x47100, 0x47120 },
    { L"FATAL FURY Logo 3/6", 0x47120, 0x47140 },
    { L"FATAL FURY Logo 4/6", 0x47140, 0x47160 },
    { L"FATAL FURY Logo 5/6", 0x47160, 0x47180 },
    { L"FATAL FURY Logo 6/6", 0x47180, 0x471a0 },
    { L"SPECIAL Logo", 0x40ae0, 0x40b00 },
    { L"SPECIAL Logo Shadow", 0x401c0, 0x401e0 },
    { L"Mini SNK Logo", 0x40020, 0x40040 },
    { L"Demo Logo", 0x40040, 0x40060 },
};
...
{
    { L"Select Background", 0x40b00, 0x40b20 },
    { L"Select Cursor", 0x40dc0, 0x40de0 },
    { L"Select Icons", 0x40e00, 0x40fe0 },
    { L"Defeated Icons", 0x41e00, 0x41fe0 },
    { L"Character Names P1", 0x41a40, 0x41a60 },
    { L"Faded Character Names P1", 0x41a60, 0x41a80 },
    { L"Character Names P2 ", 0x41420, 0x41440 },
    { L"Faded Character Names P2", 0x41820, 0x41840 },
    { L"VS Map", 0x40c20, 0x40c60 },
    { L"VS Logo", 0x40860, 0x40880 },
    { L"Tutorial/Win Background", 0x40880, 0x408a0 },
