...
BOOL CGame_NEOGEO_A::SaveFile(CFile* SaveFile, UINT16 nUnitId)
{
...
COLORREF* CGame_NEOGEO_A::CreatePal(UINT16 nUnitId, UINT16 nPalId)
{
    LoadSpecificPaletteData(nUnitId, nPalId);
