...
uint32_t CGame_MartialMasters_A::rgExtraCountAll[MartialMasters_A_NUMUNIT + 1];
uint32_t CGame_MartialMasters_A::rgExtraLoc[MartialMasters_A_NUMUNIT + 1];

uint32_t CGame_MartialMasters_A::m_nTotalPaletteCountForMartialMasters = 0;
uint32_t CGame_MartialMasters_A::m_nConfirmedROMSize = -1;
...
CGame_MartialMasters_A::CGame_MartialMasters_A(uint32_t nConfirmedROMSize)
{
...
uint32_t CGame_MartialMasters_A::GetExtraLoc(uint32_t nUnitId)
{
...
sDescTreeNode* CGame_MartialMasters_A::InitDescTree()
{
    ...
    LoadExtraFileForGame(EXTRA_FILENAME_MartialMasters_A, &MartialMasters_A_EXTRA_CUSTOM, MartialMasters_A_EXTRALOC, m_nConfirmedROMSize);

    uint16_t nUnitCt = MartialMasters_A_NUMUNIT + (GetExtraCt(MartialMasters_A_EXTRALOC) ? 1 : 0);
...
sFileRule CGame_MartialMasters_A::GetRule(uint32_t nUnitId)
{
...
uint32_t CGame_MartialMasters_A::GetCollectionCountForUnit(uint32_t nUnitId)
{
...
uint32_t CGame_MartialMasters_A::GetNodeCountForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
...
LPCWSTR CGame_MartialMasters_A::GetDescriptionForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetDescriptionForCollection(MartialMasters_A_UNITS, MartialMasters_A_EXTRALOC, nUnitId, nCollectionId);
}

uint32_t CGame_MartialMasters_A::GetPaletteCountForUnit(uint32_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_MartialMasters_A::GetPaletteSet(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetPaletteSet(MartialMasters_A_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_MartialMasters_A::GetNodeFromPaletteId(uint32_t nUnitId, uint32_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_MartialMasters_A::GetSpecificPalette(uint32_t nUnitId, uint32_t nPaletteId)
{
...
void CGame_MartialMasters_A::LoadSpecificPaletteData(uint32_t nUnitId, uint32_t nPalId)
{
    ...
    else // MartialMasters_A_EXTRALOC
    {
        ...
        stExtraDef* pCurrDef = &MartialMasters_A_EXTRA_CUSTOM[GetExtraLoc(nUnitId) + nPalId];
