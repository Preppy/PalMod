...
CGame_MartialMasters_A::CGame_MartialMasters_A(UINT32 nConfirmedROMSize)
{
    ...
    createPalOptions = {
                        ...
                        PALWriteOutputOptions::WRITE_MAX           // This is the number of colors to write when saving to the game ROM before we need to add another reserved color/counter UINT16.
