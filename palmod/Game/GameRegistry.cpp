...
#include "Game_MK1_PS2.h"
#include "Game_MK1_SNES.h"
#include "Game_MK2_A.h"
#include "Game_MK2_SEGA.h"
...
#include "Game_WorldHeroes2_A.h"
#include "Game_WorldHeroes2Jet_A.h"
...
static_assert(NUM_GAMES == 303, "Increment after deciding whether to add the new game to the Read Me.");
...
namespace KnownGameInfo
{
    ...
    CGameClass* Make_DANKUGA_A(uint32_t /* nConfirmedROMSize */, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_DanKuGa_A_DIR(INVALID_VALUE_32); }
    ...
    CGameClass* Make_MK1_PS2(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_MK1_PS2(nConfirmedROMSize); }
    ...
    CGameClass* Make_MK2_PS2(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_MK2_PS2(nConfirmedROMSize); }
    ...
    CGameClass* Make_MWARR_A(uint32_t /* nConfirmedROMSize */, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_MWarr_A_DIR(INVALID_VALUE_32); }
    ...
    CGameClass* Make_UMK3_PS2(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_UMK3_PS2(nConfirmedROMSize); }
    ...
    CGameClass* Make_WorldHeroes2_A(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_WorldHeroes2_A(nConfirmedROMSize); }
    CGameClass* Make_WorldHeroes2_PS2(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_WorldHeroes2_PS2(nConfirmedROMSize); }
    CGameClass* Make_WorldHeroes2Jet_A(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_WorldHeroes2Jet_A(nConfirmedROMSize); }
    CGameClass* Make_WorldHeroes2Jet_PS2(uint32_t nConfirmedROMSize, int /* nExtraGameData */, LPCWSTR /* pszFilePath */) { return new CGame_WorldHeroes2Jet_PS2(nConfirmedROMSize); }
...
// Please note that this is sorted by the File Open Data display string, *not* by gameID.
    std::vector<CoreGameData> GameRegistryAtoM =
    {
        ...
        },
        {
            ...
            { AOF1_A,           L"Art of Fighting 1", L"Art of Fighting 1|044-p1.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_ArtOfFighting },
            Make_AOF1_A,
        ...
        },
        {
            ...
            { AOF3_A,           L"Art of Fighting 3", L"Art of Fighting 3: Characters (p1), Stages (p2)|096-p1.*;096-p2.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_ArtOfFighting },
            Make_AOF3_A,
        ...
        },
        {
            ...
            { BMKNS_SNES,       L"Battle Master: KnS", L"Battle Master: KnS (SNES)|battle master - kyuukyoku no senshi-tachi (japan).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_BMKNS_SNES,
        ...
        },
        {
            ...
            { BLEACH_DS,        L"Bleach Dark Souls", L"Bleach Dark Souls (DS)|3494*Europe*nds;2761*US*nds|", GamePlatform::Nintendo, GameSeries::Nintendo_DS },
            Make_BLEACH_DS,
        ...
        },
        {
            ...
            { BSSMSJR_SNES,     L"Bishojo Senshi Sailor Moon S - JR", L"Bishojo Senshi Sailor Moon S - JR (SNES)|Bishoujo Senshi Sailor Moon S - Jougai Rantou! Shuyaku Soudatsusen (J*).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_BSSMSJR_SNES,
        ...
        },
        {
            ...
            { CFJ_S,           L"CFE/CFJ (READ-ONLY!)", L"Capcom Fighting Evolution (Steam: Read-only!)|cfj.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection2 },
            Make_CFJ_S,
            CGame_CFJ_S::GetRule,
        },
        {
            ...
            { CFTE_SNES,        L"Clay Fighter:TE", L"Clay Fighter:TE (SNES)|Clay Fighter - Tournament Edition (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_CFTE_SNES,
        ...
        },
        {
            COTA_S,
            L"X-Men: COTA (Steam)",
            { COTA_S,           L"COTA", L"COTA (Steam)|xmcota?.21D3D8A7;f000.bin|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_COTA_S,
        ...
        },
        {
            ...
            { CVS1_A,           L"CvS1", L"CvS1 (NAOMI)|Capcom_vs_SNK_Millenium_Fight_2000.bin;Capcom_vs_SNK_Millenium_Fight_2000_Unlocked.bin;mpr-23504.ic1|", GamePlatform::Sega, GameSeries::Sega_NAOMI },
            Make_CVS1_A,
        ...
        },
        {
            ...
            { CVS1_S,           L"CvS1", L"CvS1 (Steam)|cvs1.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection2 },
            Make_CVS1_S,
        ...
        },
        {
            CVS2_A,
            L"CvS2 (NAOMI Arcade)",
            { CVS2_A,           L"CvS2", L"CvS2 (NAOMI)|SNKGD_SL.bin|", GamePlatform::Sega, GameSeries::Sega_NAOMI },
            Make_CVS2_A,
        ...
        },
        {
            CVS2_S,
            L"CvS2 (Steam)",
            { CVS2_S,           L"CvS2", L"CvS2 (Steam)|cvs2.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection2 },
            Make_CVS2_S,
        ...
        },
        {
            ...
            { CYBERBOTS_S,      L"Cyberbots", L"Cyberbots (Steam)|cybots?.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_CYBERBOTS_S,
        ...
        },
        {
            ...
            { DBZEB_DS,         L"Dragon Ball Z: Extreme Butoden (3DS)", L"Dragon Ball Z: Extreme Butoden (Nintendo 3DS)|3DS1366*(USA)-decrypted.3ds;Dragon*Butoden*.*|", GamePlatform::Nintendo, GameSeries::Nintendo_DS },
            Make_DBZEB_DS,
        ...
        },
        {
            ...
            { DBZHD_SNES,       L"Dragon Ball Z: Hyper Dimension", L"Dragon Ball Z: Hyper Dimension (SNES)|dragon ball z - hyper dimension (*).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_DBZHD_SNES,
        ...
        },
        {
            ...
            { FatalFury1_A,     L"Fatal Fury: King of Fighters", L"Fatal Fury: KoF (Neo-Geo)|033-p1.*;033-p1bh.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_FatalFury1_A,
        ...
        },
        {
            ...
            { FatalFury1_PS2,     L"Fatal Fury: King of Fighters", L"Fatal Fury: KoF (PS2)|033prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume1 },
            Make_FatalFury1_PS2,
        ...
        },
        {
            ...
            { FatalFury2_A,     L"Fatal Fury 2", L"Fatal Fury 2 (Neo-Geo)|047-p1.*;047-epr.ep1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_FatalFury2_A,
        ...
        },
        {
            FatalFury2_PS2,
            L"Fatal Fury 2 (PS2)",
            { FatalFury2_PS2,     L"Fatal Fury 2", L"Fatal Fury 2 (PS2)|047prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume1 },
            Make_FatalFury2_PS2,
        ...
        },
        {
            ...
            { FatalFuryS_A,     L"Fatal Fury Special", L"Fatal Fury Special (Neo-Geo)|058-p1.*;058-p1bs.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_FatalFuryS_A,
        ...
        },
        {
            ...
            { FatalFuryS_PS2,     L"Fatal Fury Special", L"Fatal Fury Special (PS2)|058prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume1 },
            Make_FatalFuryS_PS2,
        ...
        },
        {
            ...
            { FatalFuryS_SNES,  L"Fatal Fury Special", L"Fatal Fury Special (SNES)|Fatal Fury Special (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
        ...
        },
        {
            ...
            { FatalFury3_A,     L"Fatal Fury 3", L"Fatal Fury 3|069-p1.*;069-p1bh.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_FatalFury3_A,
        ...
        },
        {
            FatalFury3_PS2,
            L"Fatal Fury 3 (PS2)",
            { FatalFury3_PS2,     L"Fatal Fury 3", L"Fatal Fury 3 (PS2)|069prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume1 },
            Make_FatalFury3_PS2,
        ...
        },
        {
            ...
            { FightersHistory3_SNES,       L"Fighter's History - Mizoguchi Kikiippatsu!! (Japan)", L"Fighter's History - Mizoguchi Kikiippatsu!! (SNES JPN)|Fighter's History - Mizoguchi Kikiippatsu!! (Japan).sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
        ...
        },
        {
            ...
            { Garou_A,          L"Garou: MotW", L"Garou: MotW (Neo-Geo)|kf.neo-sma;253-sma.bin;253-sma.kf|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_Garou_A,
        ...
        },
        {
            ...
            { GarouP_A,         L"Garou: MotW (Prototype)", L"Garou: MotW (Prototype)|proto_253-p1.p1;253-p1p.bin;253-sma.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_GarouP_A,
        ...
        },
        {
            ...
            { GGDS_NDS,         L"Guilty Gear: Dust Strikers", L"Guilty Gear: Dust Strikers (Nintendo DS)|0590*(Japan).nds|", GamePlatform::Nintendo, GameSeries::Nintendo_DS },
            Make_GGDS_NDS,
        ...
        },
        {
            ...
            { GUNDAM_SNES,      L"Gundam Wing: Endless Duel", L"Gundam Wing: Endless Duel (SNES)|Shin Kidou Senki Gundam W - Endless Duel (Japan).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_GUNDAM_SNES,
        ...
        },
        {
            ...
            { HIppo_GBA,        L"Hajime no Ippo - The Fighting! (Japan)", L"Hajime no Ippo - The Fighting! (GBA)|Hajime no Ippo - The Fighting! (Japan).gba|", GamePlatform::Nintendo, GameSeries::Nintendo_GBA },
            Make_HIppo_GBA,
        ...
        },
        {
            ...
            { HSF2_A,           L"HSF2", L"HSF2: Portraits (*.03), Characters (*.04), Stages (*.10) (CPS2)|hs2?.03?;hs2?.04?;hs2*.10|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_HSF2_A,
        ...
        },
        {
            HSF2_S,
            L"Hyper Street Fighter 2",
            { HSF2_S,           L"Hyper Street Fighter 2", L"HSF2 (Steam)|hsf2.21D3D8A7;hsf2j.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_HSF2_S,
        ...
        },
        {
            ...
            { JOJOSRPG_SNES,    L"Jojo's: RPG", L"Jojo's: RPG (SNES)|JoJo no Kimyou na Bouken (Japan).sfc;JoJo no Kimyou na Bouken (Japan) (Translated En).sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_JOJOSRPG_SNES,
        ...
        },
        {
            ...
            { JusticeLeagueTF_SNES, L"Justice League Task Force", L"Justice League Task Force (SNES)|Justice League Task Force (USA).sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
        ...
        },
        {
            ...
            { KI_SNES,          L"Killer Instinct", L"Killer Instinct (SNES)|Killer Instinct (USA)*.s?c;sns-akle-0.u1|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_KI_SNES,
        ...
        },
        {
            ...
            { KIZUNA_PS2,         L"Kizuna Encounter", L"Kizuna Encounter (PS2)|216prg.bin|", GamePlatform::PS2, GameSeries::PS2_FuunSuperCombo },
            Make_KIZUNA_PS2,
        ...
        },
        {
            ...
            { KOF94_A,          L"KOF94", L"KOF94|055-p1.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF94_A,
        ...
        },
        {
            ...
            { KOF95_A,          L"KOF95", L"KOF95|084-p*1.*;084-p2sp.p2;084-epr.ep4|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF95_A,
        ...
        },
        {
            ...
            { KOF96_A,          L"KOF96", L"KOF96|214-p2.sp2;214-p2.bin;214ae-p2.p2|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF96_A,
        ...
        },
        {
            ...
            { KOF97_A,          L"KOF97", L"KOF97|232-p2.*;kof97_p2.rom;kf97-p2p.bin;97cbt-p2.bin;kf97-p2p.bin;232-p2ps.sp2;232-rc.sp2;232t.p2;232t2020-p2.sp2;232xt-p2.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF97_A,
        ...
        },
        {
            ...
            { KOF97AE_A,        L"KOF97AE", L"KOF97AE|232ae.p2;232ae-p2.sp2;232aef-p2.sp2|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF97AE_A,
        ...
        },
        {
            ...
            { KOF98_A,          L"KOF98", L"KOF98|242-p2.*;kof98_p2.rom;242cb-p2.sp2;242pfe.p2;242mix.p2;98eckvs-p2.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF98_A,
        ...
        },
        {
            ...
            { KOF98AE2016_A,    L"KOF98AE2016 (Romhack)", L"KOF98AE2016 (Romhack)|242ae-p2.sp2;242ae-p2.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF98AE2016_A,
        ...
        },
        {
            ...
            { KOF99_A,        L"KOF99", L"KOF99|152-p2.*;kf99eur.p2;251-p2p.*;proto_251-p2.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF99_A,
        ...
        },
        {
            ...
            { KOF99AE_A,        L"KOF99AE", L"KOF99AE: A,B (p2), C,D,AC,BD (p3)|kof99ae_p2.bin;kof99ae_p3.bin;152-p2ae.sp2;152-p3ae.p3|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF99_A,
            CGame_KOF99_A::GetRule,
        },
        {
            ...
            { KOF00N_A,         L"KOF00N", L"KOF00N|257-pg2.sp2;257-p2n.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF00N_A,
        ...
        },
        {
            ...
            { KOF01_A,          L"KOF01", L"KOF01|262-p2-08-e0.sp2;5003-p2.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF01_A,
        ...
        },
        {
            ...
            { KOF02_A,          L"KOF02", L"KOF02 (Neo-Geo)|265*p2*;kf2k2ru35-p2.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF02_A,
        ...
        },
        {
            ...
            { KOF02PS2_A,       L"KOF02 (2002PS2)", L"KOF02 (2002PS2)|265ps2*p2*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF02PS2_A,
        ...
        },
        {
            ...
            {},
            Make_KOF02UM_PS2_DIR_8887_TOUGEKI,
            CGame_KOF02UM_PS2_DIR::GetRule_8887_Tougeki,
            CGame_KOF02UM_PS2_DIR::GetNextRule_8887_Tougeki,
        ...
        },
        {
            ...
            {},
            Make_KOF02UM_PS2_DIR_8887,
            CGame_KOF02UM_PS2_DIR::GetRule_8887,
            CGame_KOF02UM_PS2_DIR::GetNextRule_8887,
            CGame_KOF02UM_PS2_DIR::GetRuleCtr,
            CGame_KOF02UM_PS2_DIR::ResetRuleCtr,
        },
        {
            ...
            {},
            Make_KOF02UM_PS2_DIR_BGR555,
            CGame_KOF02UM_PS2_DIR::GetRule_BGR555,
            CGame_KOF02UM_PS2_DIR::GetNextRule_BGR555,
            CGame_KOF02UM_PS2_DIR::GetRuleCtr,
            CGame_KOF02UM_PS2_DIR::ResetRuleCtr,
        },
        {
        ...
        },
        {
            ...
            {},
            Make_KOF02UM_S_DIR_8887,
            CGame_KOF02UM_S_DIR::GetRule_8887,
            CGame_KOF02UM_S_DIR::GetNextRule_8887,
        ...
        },
        {
            ...
            { KOF03_A,          L"KOF03 (bootleg 1 or 2004 EX Ultra Plus)", L"KOF03 (bootleg 1 or 2004 EX Ultra Plus)|2k3-p1.bin;2k3-p1up.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_KOF },
            Make_KOF03_A,
        ...
        },
        {
            ...
            { KOFEX2_GBA,          L"KOFEX2", L"KOFEX2|*King of Fighters EX 2*(USA).gba|", GamePlatform::Nintendo, GameSeries::Nintendo_GBA },
            Make_KOFEX2_GBA,
        ...
        },
        {
            ...
            { LASTBLADE_A,      L"Last Blade", L"Last Blade (Neo-Geo)|234-p1.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_LastBlade },
            Make_LASTBLADE_A,
        ...
        },
        {
            ...
            { LASTBLADE2_A,     L"Last Blade 2", L"Last Blade 2 (Neo-Geo)|243-pg1.*;LB2_P1.ROM|", GamePlatform::NEOGEO, GameSeries::NeoGeo_LastBlade },
            Make_LASTBLADE2_A,
        ...
        },
        {
            ...
            { MAGICALDROPII_A,  L"Magical Drop II", L"Magical Drop II|221-p1*.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_MagicalDrop },
        ...
        },
        {
            ...
            { MAGICALDROPIII_A, L"Magical Drop III", L"Magical Drop III|233-p1*.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_MagicalDrop },
        ...
        },
        {
            MSH_S,
            L"MSH (Steam)",
            { MSH_S,            L"Marvel Super Heroes", L"MSH (Steam)|msh?.21D3D8A7;f000.bin|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_MSH_S,
            CGame_MSH_S::GetRule,
        },
        {
            MVC_A,
            L"MvC (CPS2 Arcade)",
            { MVC_A,            L"Marvel vs Capcom (CPS2)", L"MvC (CPS2)|mvc*.06*|", GamePlatform::CapcomCPS12, GameSeries::CPS_MvC },
            Make_MVC_A,
            CGame_MVC_A::GetRule,
        },
        {
            MVC_D,
            L"MvC (Dreamcast)",
            { MVC_D,            L"Marvel vs Capcom (Dreamcast)", L"MvC (Dreamcast)|0.bin|", GamePlatform::CapcomCPS12, GameSeries::CPS_MvC },
            Make_MVC_D,
            CGame_MVC_D::GetRule,
        },
        {
        ...
        },
        {
            MVC_S,
            L"MvC (Steam)",
            { MVC_S,            L"Marvel vs Capcom", L"MvC (Steam)|mvsc?.21D3D8A7;f000.bin|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_MVC_S,
            CGame_MVC_S::GetRule,
        },
        {
            MMX_SNES,
            L"Mega Man X (SNES)",
            { MMX_SNES,         L"Mega Man X", L"Mega Man X (SNES)|Mega*Man X (USA).s?c;sns-rx-0 p0.u1|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MMX_SNES,
        ...
        },
        {
            MMX2_SNES,
            L"Mega Man X2 (SNES)",
            { MMX2_SNES,        L"Mega Man X2", L"Mega Man X2 (SNES)|Mega*Man X2 (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MMX2_SNES,
        ...
        },
        {
            MMX3_SNES,
            L"Mega Man X3 (SNES)",
            { MMX3_SNES,        L"Mega Man X3", L"Mega Man X3 (SNES)|Mega*Man X3 (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MMX3_SNES,
        ...
        },
        {
            MMPR_SNES,
            L"MMPR:TFE (SNES)",
            { MMPR_SNES,        L"MMPR:TFE", L"MMPR:TFE (SNES)|Mighty Morphin Power Rangers - The Fighting Edition (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MMPR_SNES,
        ...
        },
        {
            MK1_PS2,
            L"Mortal Kombat (PS2)",
            { MK1_PS2,            L"Mortal Kombat", L"Mortal Kombat (PS2)|mk1.sr|", GamePlatform::PS2, GameSeries::PS2_MortalKombat },
            Make_MK1_PS2,
            CGame_MK1_PS2::GetRule,
        },
        {
            MK1_SEGA,
            L"Mortal Kombat (Sega Mega Drive)",
            { MK1_SEGA,         L"Mortal Kombat", L"Mortal Kombat (Mega Drive)|mortal kombat (world)*.*;mortal kombat.smd|", GamePlatform::Sega, GameSeries::Sega_MegaDrive },
            Make_MK1_SEGA,
        ...
        },
        {
            ...
            { MK1_SNES,         L"Mortal Kombat", L"Mortal Kombat (SNES)|Mortal Kombat (USA).sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MK1_SNES,
        ...
        },
        {
            ...
            { MK2_PS2,            L"Mortal Kombat II", L"Mortal Kombat 2 (PS2)|mk2.sr|", GamePlatform::PS2, GameSeries::PS2_MortalKombat },
            Make_MK2_PS2,
            CGame_MK2_PS2::GetRule,
        },
        {
            MK2_SEGA,
            L"Mortal Kombat (Sega Mega Drive)",
            { MK2_SEGA,         L"Mortal Kombat II", L"Mortal Kombat II (Mega Drive)|s376-u2.1+s382-u1.1.bin;mortal kombat II (world)*.md|", GamePlatform::Sega, GameSeries::Sega_MegaDrive },
            Make_MK2_SEGA,
        ...
        },
        {
            ...
            { MK2_SNES,         L"Mortal Kombat II", L"Mortal Kombat 2 (SNES)|MK2 USA.sfc;Mortal Kombat II (USA)*.sfc;Mortal_Kombat_II_USA.sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MK2_SNES,
        ...
        },
        {
            ...
            { MK3_SEGA,         L"Mortal Kombat 3", L"Mortal Kombat 3 (Mega Drive)|mortal kombat 3 (usa).*|", GamePlatform::Sega, GameSeries::Sega_MegaDrive },
            Make_MK3_SEGA,
        ...
        },
        {
            ...
            { MSHVSF_A,         L"MSHvSF", L"MSHvSF: Characters (*.06a), Portraits (*.07b)|mvs*.06a;mvs*.07b|", GamePlatform::CapcomCPS12, GameSeries::CPS_MvC },
            Make_MSHVSF_A,
        ...
        },
        {
            MSHVSF_S,
            L"MSHvSF (Steam)",
            { MSHVSF_S,         L"MSHvSF", L"MSHvSF (Steam)|mshvsf?.21D3D8A7;f000.bin|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_MSHVSF_A,
            CGame_MSHVSF_A::GetRule,
        },
        {
            ...
            { MSHWOTG_SNES,     L"MSH: War of the Gems", L"MSH: War of the Gems (SNES)|Marvel Super Heroes in War of the Gems (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_MSHWOTG_SNES,
        ...
        },
        {
            ...
            { MVC2_A,           L"MvC2", L"MvC2 Arcade (MarvelVsCapcom2_unlocked.bin)|marvel vs. capcom 2.dat;marvel*2*.bin|", GamePlatform::Sega, GameSeries::Sega_NAOMI },
            Make_MVC2_A,
        ...
        },
        {
            MVC2_S,
            L"MvC2 (Steam: AFS)",
            { MVC2_S,           L"MvC2", L"MvC2 (Steam)|mvsc2.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_MVC2_S,
    ...
    std::vector<CoreGameData> GameRegistryNtoZ =
    {
        ...
        },
        {
            PrimalRage_SNES,
            L"Primal Rage (SNES)",
            { PrimalRage_SNES,  L"Primal Rage", L"Primal Rage (SNES)|Primal Rage (USA).sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
        ...
        },
        {
            ...
            { PUNISHER_S,    L"The Punisher", L"The Punisher (Steam)|punisher?.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_Punisher_S,
        ...
        },
        {
            ...
            { RANMACRH_SNES,    L"Ranma Nibunnoichi: CRH", L"Ranma Nibunnoichi: CRH (SNES)|Ranma Nibunnoichi - Chougi Ranbu Hen (J).s?c;ranma 1-2 - chougi ranbu hen (japan).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_RANMACRH_SNES,
        ...
        },
        {
            ...
            { RANMAHB_SNES,     L"Ranma Nibunnoichi: HB", L"Ranma Nibunnoichi: HB (SNES)|ranma 1-2 - hard battle (usa).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_RANMAHB_SNES,
        ...
        },
        {
            ...
            { RBFF1_A,          L"Real Bout Fatal Fury", L"Real Bout Fatal Fury (Neo-Geo)|095-p1.*;095-p1k.p1;rbff1_p1.rom|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_RBFF1_A,
        ...
        },
        {
            ...
            { RBFF1_PS2,          L"Real Bout Fatal Fury", L"Real Bout Fatal Fury (PS2)|095prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume2 },
            Make_RBFF1_PS2,
        ...
        },
        {
            ...
            { RBFF2_A,          L"Real Bout Fatal Fury 2", L"Real Bout Fatal Fury 2 (Neo-Geo)|240-p1.*;240-pg1.*;rb2_p1.rom;140-p1k.*;240-p1fc.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_RBFF2_A,
        ...
        },
        {
            ...
            { RBFF2_PS2,          L"Real Bout Fatal Fury 2", L"Real Bout Fatal Fury 2 (PS2)|240prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume2 },
            Make_RBFF2_PS2,
        ...
        },
        {
            ...
            { RBFFS_A,          L"Real Bout Fatal Fury Special", L"Real Bout Fatal Fury Special (Neo-Geo)|223*p1*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_FatalFury },
            Make_RBFFS_A,
        ...
        },
        {
            ...
            { RBFFS_PS2,          L"Real Bout Fatal Fury Special", L"Real Bout Fatal Fury Special (PS2)|223prg.bin|", GamePlatform::PS2, GameSeries::PS2_FatalFuryVolume2 },
            Make_RBFFS_PS2,
        ...
        },
        {
            REDEARTH_S,
            L"Red Earth (Steam)",
            { REDEARTH_S,       L"Red Earth", L"Red Earth (Steam)|redearth.21D3D8A7;warzard.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_REDEARTH_S,
        ...
        },
        {
            ...
            { SAMSHO1_A,        L"Samurai Shodown", L"Samurai Shodown (Neo-Geo)|045-p1.p1;045-p1.bin;045-p2.rom|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO1_A,
        ...
        },
        {
            ...
            { SAMSHO1_PS2,        L"Samurai Shodown", L"Samurai Shodown (PS2)|samsho.rom;u_sam1.afs|", GamePlatform::PS2, GameSeries::PS2_SamuraiShodown },
            Make_SAMSHO1_PS2,
        ...
        },
        {
            ...
            { SAMSHO2_A,        L"Samurai Shodown II", L"Samurai Shodown II (Neo-Geo)|063-p1.*;063-p1-kan.p1;063-p1new.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO2_A,
        ...
        },
        {
            ...
            { SAMSHO2_PS2,        L"Samurai Shodown II", L"Samurai Shodown II (PS2)|samsho2.rom;u_sam2.afs|", GamePlatform::PS2, GameSeries::PS2_SamuraiShodown },
            Make_SAMSHO2_PS2,
        ...
        },
        {
            ...
            { SAMSHO3_A,        L"Samurai Shodown III", L"Samurai Shodown III (Neo-Geo)|087-p5.p5|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO3_A,
        ...
        },
        {
            ...
            { SAMSHO3_PS2,        L"Samurai Shodown III", L"Samurai Shodown III (PS2)|samsho3.rom;u_sam3.afs|", GamePlatform::PS2, GameSeries::PS2_SamuraiShodown },
            Make_SAMSHO3_PS2,
        ...
        },
        {
            ...
            { SAMSHO4_A,        L"Samurai Shodown IV", L"Samurai Shodown IV (Neo-Geo)|sams4_p1.rom;222-p1.*;222_p1.*;222-p1k.p1;222-p1sp.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO4_A,
        ...
        },
        {
            ...
            { SAMSHO4_PS2,        L"Samurai Shodown IV", L"Samurai Shodown IV (PS2)|samsho4.rom;u_sam4.afs|", GamePlatform::PS2, GameSeries::PS2_SamuraiShodown },
            Make_SAMSHO4_PS2,
        ...
        },
        {
            ...
            { SAMSHO5_A,        L"Samurai Shodown V", L"Samurai Shodown V (Neo-Geo)|270-p1.*;p1.bin;270-p1c.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO5_A,
        ...
        },
        {
            ...
            { SAMSHO5_PS2,        L"Samurai Shodown V", L"Samurai Shodown V (PS2)|samsho5.rom;u_sam5.afs|", GamePlatform::PS2, GameSeries::PS2_SamuraiShodown },
            Make_SAMSHO5_PS2,
        ...
        },
        {
            ...
            { SAMSHO5X_A,       L"Samurai Shodown V (Xbox)", L"Samurai Shodown V (Xbox)|ssvx_p1.rom|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO5X_A,
            CGame_SAMSHO5_A::GetRule,
        },
        {
            ...
            { SAMSHO5SP_A,      L"Samurai Shodown V Special", L"Samurai Shodown V Special (Neo-Geo)|272-p1*.*;273-p1.bin|", GamePlatform::NEOGEO, GameSeries::NeoGeo_SamuraiShodown },
            Make_SAMSHO5SP_A,
        ...
        },
        {
            SAVAGEREIGN_PS2,
            L"Savage Reign (PS2)",
            { SAVAGEREIGN_PS2,    L"Savage Reign", L"Savage Reign (PS2)|059prg.bin|", GamePlatform::PS2, GameSeries::PS2_FuunSuperCombo },
        ...
        },
        {
            SFA1_A,
            L"SFA1 (CPS2 Arcade)",
            { SFA1_A,           L"SFA1", L"SFA1 (CPS2)|sfz.06|", GamePlatform::CapcomCPS12, GameSeries::CPS_SFA },
            Make_SFA1_A,
        ...
        },
        {
            SFA1_S,
            L"SFA1 (CPS2 Steam)",
            { SFA1_S,           L"SFA1", L"SFA1 (Steam)|bundleStreetFighterAlpha.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SFA1_S,
        ...
        },
        {
            SFA2_A,
            L"SFA2 (CPS2 Arcade)",
            { SFA2_A,           L"SFA2", L"SFA2: Characters (sz*.07), Bonus (sz*.08) (CPS2)|sz*.07*;sz*.08*|", GamePlatform::CapcomCPS12, GameSeries::CPS_SFA },
            Make_SFA2_A,
        ...
        },
        {
            ...
            { SFA2_Hack_A,      L"SFA2 Hack", L"SFA2 Hack (sz2u.09)|sz2u.09|", GamePlatform::CapcomCPS12, GameSeries::CPS_SFA },
            Make_SFA2_Hack_A,
            CGame_SFA2_A::GetRule,
        },
        {
            SFA2_S,
            L"SFA2 (Steam)",
            { SFA2_S,           L"SFA2", L"SFA2 (Steam)|bundleStreetFighterAlpha2.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SFA2_S,
        ...
        },
        {
            SFA3_A,
            L"SFA3 (CPS2 Arcade)",
            { SFA3_A,           L"SFA3", L"SFA3 (CPS2)|sz3*.09*|", GamePlatform::CapcomCPS12, GameSeries::CPS_SFA },
            Make_SFA3_A,
        ...
        },
        {
            SFA3_S,
            L"SFA3 (Steam)",
            { SFA3_S,           L"SFA3", L"SFA3 (Steam)|bundleStreetFighterAlpha3.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SFA3_S,
        ...
        },
        {
            ...
            { SFZ3U_A,          L"SFA3/SFZ3 Upper", L"SFA3/SFZ3 Upper (NAOMI)|StreetFighterZero3Upper.bin;Street_Fighter_Zero_3_Upper.dat|", GamePlatform::Sega, GameSeries::Sega_NAOMI },
            Make_SFZ3U_A,
        ...
        },
        {
            ...
            { SFZ3U_S,           L"SFA3/SFZ3 Upper", L"SFA3/SFZ3 Upper (Steam)|z3u.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection2 },
            Make_SFZ3U_S,
        ...
        },
        {
            ...
            { SFZ3M_S,           L"SFA3/SFZ3 Max", L"SFA3/SFZ3 Max (Steam)|z3uu.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection2 },
            Make_SFZ3M_S,
        ...
        },
        {
            ...
            { SFIII1_A,         L"SFIII:NG", L"SFIII:NG (CPS3)|50|", GamePlatform::CapcomCPS3, GameSeries::CPS3_SF3 },
            Make_SFIII1_A,
        ...
        },
        {
            SFIII1_S,
            L"SFIII:NG (Steam)",
            { SFIII1_S,         L"SFIII:NG", L"SFIII:NG (Steam)|bundleStreetFighterIII.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SFIII1_S,
        ...
        },
        {
            ...
            { SFIII2_A,         L"SFIII:2I", L"SFIII:2I (CPS3)|50|", GamePlatform::CapcomCPS3, GameSeries::CPS3_SF3 },
            Make_SFIII2_A,
        ...
        },
        {
            SFIII2_S,
            L"SFIII:SI (Steam)",
            { SFIII2_S,         L"SFIII:SI", L"SFIII:SI (Steam)|bundleStreetFighterIII_2ndImpact.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SFIII2_S,
        ...
        },
        {
            SFIII3_S,
            L"SFIII:3S (Steam)",
            { SFIII3_S,         L"SFIII:3S", L"SFIII:3S (Steam)|bundleStreetFighterIII_3rdStrike.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SFIII3_S,
        ...
        },
        {
            ...
            { SF1_S,            L"Street Fighter", L"Street Fighter (Steam)|bundleStreetFighter.mbundle;StreetFighter.u.68k|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SF1_S,
        ...
        },
        {
            ...
            { SF2WW_A,            L"SF2:WW", L"SF2:WW (CPS1)|sf2e_28g.9e;sf2_29b.10e|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_SF2WW_A,
        ...
        },
        {
            ...
            { SF2WW_S,            L"SF2:WW", L"SF2:WW (Steam)|bundleStreetFighterII.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SF2WW_S,
        ...
        },
        {
            ...
            { SF2CE_A,          L"SF2:CE", L"SF2:CE: Select (21), Characters (22), Continue (23) (CPS1)|s92*21*6f;s92*22*7f;s92*23*8f|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_SF2CE_A,
        ...
        },
        {
            SF2CE_S,
            L"SF2:CE (Steam)",
            { SF2CE_S,          L"SF2:CE", L"SF2:CE (Steam)|bundleStreetFighterII_CE.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SF2CE_S,
        ...
        },
        {
            ...
            { SF2HF_A,          L"SF2:HF", L"SF2:HF: Select (21), Characters (22), Continue (23) (CPS1)|s2t*21.6f;s2t*22.7f;s2t*_23.8f;sf2_21.bin;sf2_22.bin;sf2.23|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_SF2HF_A,
        ...
        },
        {
            SF2HF_S,
            L"SF2:HF (Steam)",
            { SF2HF_S,          L"SF2:HF", L"SF2:HF (Steam)|bundleStreetFighterII_HF.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SF2HF_S,
        ...
        },
        {
            SHAQFU_SNES,
            L"Shaq Fu (SNES)",
            { SHAQFU_SNES,      L"Shaq Fu", L"Shaq Fu (SNES)|Shaq Fu (USA).sfc;sns-aqfe-0.u1|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_SHAQFU_SNES,
        ...
        },
        {
            ...
            { SVG_SNES,         L"Super Variable Geo (Japan)", L"Super Variable Geo (Japan SNES)|Super Variable Geo (J*).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_SVG_SNES,
        ...
        },
        {
            ...
            { SSF2_A,            L"SSF2", L"SSF2 (CPS2): Portraits (03), Characters (04), Stages (07)|ssfe-03b;ssf?.03*;ssf?.3t;ssf?.04*;ssf?.4t;ssf?.07*;ssf?.7t|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_SSF2_A,
        ...
        },
        {
            ...
            { SSF2_SNES,         L"Super Street Fighter 2", L"Super Street Fighter 2 (SNES)|Super Street Fighter II *).sfc|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_SSF2_SNES,
        ...
        },
        {
            ...
            { SSF2_S,            L"SSF2", L"SSF2 (Steam)|bundleSuperStreetFighterII.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SSF2_S,
        ...
        },
        {
            SSF2T_A,
            L"SSF2T (CPS2 Arcade)",
            { SSF2T_A,          L"SSF2T", L"SSF2T: Portraits (*.03c), Characters (*.04a), Stages (*.08) (CPS2)|sfx*.03*;sfx*.04a;sf*.08|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_SSF2T_A,
        ...
        },
        {
            SSF2T_NL,
            L"SSF2T (New Legacy)",
            { SSF2T_NL,          L"SSF2T: New Legacy Hack", L"SSF2T: New Legacy: Portraits (*.03), Characters (*.04), Stages (*.08), New Legacy Extensions (*.09)|sfnl.03;sfnl.04;sfnl.08;sfnl.09|", GamePlatform::CapcomCPS12, GameSeries::CPS_SF2 },
            Make_SSF2T_A,
            CGame_SSF2T_A::GetRule,
        },
        {
            SSF2T_GBA,
            L"SSF2T:Revival (GBA)",
            { SSF2T_GBA,        L"SSF2T: Revival", L"SSF2T: Revival (GBA)|Super*Street*Fighter*.gba|", GamePlatform::Nintendo, GameSeries::Nintendo_GBA },
            Make_SSF2T_GBA,
        ...
        },
        {
            SSF2T_S,
            L"SSF2T (Steam)",
            { SSF2T_S,          L"SSF2T", L"SSF2T (Steam)|bundleSuperStreetFighterIITurbo.mbundle|", GamePlatform::Steam, GameSeries::Steam_SF30th },
            Make_SSF2T_S,
        ...
        },
        {
            GEMFIGHTER_S,
            L"Super Gem Fighter Mini Mix (USA 970904)",
            { GEMFIGHTER_S,     L"Super Gem Fighter Minimix", L"Super Gem Fighter (Steam)|pfghtj.21D3D8A7;sgemf.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_GEMFIGHTER_S,
        ...
        },
        {
            ...
            { SPF2T_S,          L"Super Puzzle Fighter II Turbo", L"Super Puzzle Fighter II Turbo (Steam)|spf2tu.21D3D8A7;spf2xj.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_SPF2T_S,
        ...
        },
        {
            ...
            { TekkenAdvance_GBA, L"Tekken Advance (USA)", L"Tekken Advance (USA GBA)|Tekken Advance (USA).gba|", GamePlatform::Nintendo, GameSeries::Nintendo_GBA },
...

        {
            ...
            { TMNTTF_SNES,      L"Teenage Mutant Ninja Turtles: TF", L"Teenage Mutant Ninja Turtles: TF (SNES)|sns-ky-0.u1;teenage mutant ninja turtles - tournament fighters (U*.s*c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_TMNTTF_SNES,
        ...
        },
        {
            ...
            { TOPF2005_SEGA,    L"Top Fighter 2005", L"Top Fighter 2005|top fighter 2005 (unl).bin|", GamePlatform::Sega, GameSeries::Sega_MegaDrive },
            Make_TOPF2005_SEGA,
        ...
        },
        {
            ...
            { UMK3_DS,          L"Ultimate Mortal Kombat 3", L"Ultimate Mortal Kombat 3 (DS)|Ultimate Mortal Kombat (USA) (En,Fr,De,Es,It).nds|", GamePlatform::Nintendo, GameSeries::Nintendo_DS },
            Make_UMK3_DS,
        ...
        },
        {
            ...
            { UMK3_SEGA,         L"Ultimate Mortal Kombat 3", L"Ultimate Mortal Kombat 3 (Mega Drive)|ultimate mortal kombat 3 (usa).*|", GamePlatform::Sega, GameSeries::Sega_MegaDrive },
            Make_UMK3_SEGA,
        ...
        },
        {
            ...
            { UMK3_PS2,           L"Ultimate Mortal Kombat 3", L"Ultimate Mortal Kombat 3 (PS2)|umk3.sr|", GamePlatform::PS2, GameSeries::PS2_MortalKombat },
            Make_UMK3_PS2,
            CGame_UMK3_PS2::GetRule,
        },
        {
            UMK3_SNES,
            L"Ultimate Mortal Kombat 3 (USA SNES)",
            { UMK3_SNES,        L"Ultimate Mortal Kombat 3", L"Ultimate Mortal Kombat 3 (SNES)|Ultimate Mortal Kombat 3 (USA).sfc;sns-a3ze.u1|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_UMK3_SNES,
        ...
        },
        {
            ...
            { VampireNightWarriors_A,   L"Vampire: The Night Warriors", L"Vampire: The Night Warriors: Characters (rom 9), Portraits (rom 4) (CPS2)|vam*.09?; vam*.04?|", GamePlatform::CapcomCPS12, GameSeries::CPS_VampireSavior },
        ...
        },
        {
            ...
            { VampireNightWarriors_S,   L"Vampire: The Night Warriors", L"Vampire: The Night Warriors (Steam)|dstlku.21D3D8A7;vampj.21d3d8a7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
        ...
        },
        {
            ...
            { VampireHunter_A,          L"Vampire Hunter: Darkstalkers' Revenge", L"Vampire Hunter: Darkstalkers' Revenge (CPS2)|vph?.09?|", GamePlatform::CapcomCPS12, GameSeries::CPS_VampireSavior },
        ...
        },
        {
            ...
            { VampireHunter_S,          L"Vampire Hunter: Darkstalkers' Revenge", L"Vampire Hunter: Darkstalkers' Revenge (Steam)|nwarru.21D3D8A7;vhuntjr2.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
        ...
        },
        {
            ...
            { VHUNT2_A,         L"Vampire Hunter 2", L"Vampire Hunter 2 (CPS2: Characters (09), Stages (10))|vh2j.09;vh2j.10|", GamePlatform::CapcomCPS12, GameSeries::CPS_VampireSavior },
            Make_VHUNT2_A,
        ...
        },
        {
            ...
            { VHUNT2_S,         L"Vampire Hunter 2", L"Vampire Hunter 2 (Steam)|vhunt2.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_VHUNT2_S,
        ...
        },
        {
            ...
            { VSAV_A,           L"Vampire Savior", L"Vampire Savior (CPS2)|vm3*.10b|", GamePlatform::CapcomCPS12, GameSeries::CPS_VampireSavior },
            Make_VSAV_A,
        ...
        },
        {
            ...
            { VSAV_S,           L"Vampire Savior", L"Vampire Savior (Steam)|vsavj.21D3D8A7;vsavu.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_VSAV_S,
        ...
        },
        {
            ...
            { VSAV2_A,          L"Vampire Savior 2", L"Vampire Savior 2 (CPS2)|vs2j.10|", GamePlatform::CapcomCPS12, GameSeries::CPS_VampireSavior },
            Make_VSAV2_A,
        ...
        },
        {
            ...
            { VSAV2_S,          L"Vampire Savior 2", L"Vampire Savior 2 (Steam)|vsav2.21D3D8A7|", GamePlatform::Steam, GameSeries::Steam_CapcomFightCollection },
            Make_VSAV2_S,
        ...
        },
        {
            ...
            { VirtuaFighter2_GEN,          L"Virtua Fighter 2", L"Virtua Fighter 2 (Genesis)|mpr-19107+mpr-19108.bin;Virtua Fighter 2 (USA, Europe).md|", GamePlatform::Sega, GameSeries::Sega_MegaDrive },
        ...
        },
        {
            ...
            { WorldHeroes_A, L"World Heroes", L"World Heroes (Neo-Geo)|053-*.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_WorldHeroes },
            Make_WorldHeroes_A,
        ...
        },
        {
            WorldHeroes_PS2,
            L"World Heroes (PS2)",
            { WorldHeroes_PS2, L"World Heroes", L"World Heroes (PS2)|053prg.bin|", GamePlatform::PS2, GameSeries::PS2_WorldHeroes },
        ...
        },
        {
            ...
            { WorldHeroes2_A, L"World Heroes 2", L"World Heroes 2 (Neo-Geo)|057-*.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_WorldHeroes },
            Make_WorldHeroes2_A,
            CGame_WorldHeroes2_A::GetRule,
        },
        {
            WorldHeroes2_PS2,
            L"World Heroes 2 (PS2)",
            { WorldHeroes2_PS2, L"World Heroes 2", L"World Heroes 2 (PS2)|057prg.bin|", GamePlatform::PS2, GameSeries::PS2_WorldHeroes },
            Make_WorldHeroes2_PS2,
            CGame_WorldHeroes2_PS2::GetRule,
        },
        {
            WorldHeroes2Jet_A,
            L"World Heroes 2 Jet (Neo-Geo)",
            { WorldHeroes2Jet_A, L"World Heroes 2 Jet", L"World Heroes 2 Jet (Neo-Geo)|064-*.p1|", GamePlatform::NEOGEO, GameSeries::NeoGeo_WorldHeroes },
            Make_WorldHeroes2Jet_A,
            CGame_WorldHeroes2Jet_A::GetRule,
        },
        {
            WorldHeroes2Jet_PS2,
            L"World Heroes 2 Jet (PS2)",
            { WorldHeroes2Jet_PS2, L"World Heroes 2 Jet", L"World Heroes 2 Jet (PS2)|064prg.bin|", GamePlatform::PS2, GameSeries::PS2_WorldHeroes },
            Make_WorldHeroes2Jet_PS2,
            CGame_WorldHeroes2Jet_PS2::GetRule,
        },
        {
            WorldHeroesPerfect_A,
            L"World Heroes Perfect (Neo-Geo)",
            { WorldHeroesPerfect_A, L"World Heroes Perfect", L"World Heroes Perfect (Neo-Geo)|090-p1.*|", GamePlatform::NEOGEO, GameSeries::NeoGeo_WorldHeroes },
        ...
        },
        {
            ...
            { WorldHeroesPerfect_PS2, L"World Heroes Perfect", L"World Heroes Perfect (PS2)|090prg.bin|", GamePlatform::PS2, GameSeries::PS2_WorldHeroes },
        ...
        },
        {
            ...
            { XMMA_SNES,        L"X-Men: Mutant Apocalypse", L"X-Men: Mutant Apocalypse (SNES)|X-Men - Mutant Apocalypse (USA).s?c|", GamePlatform::Nintendo, GameSeries::Nintendo_SNES },
            Make_XMMA_SNES,
        ...
        },
        {
            XMVSF_A,
            L"XMvSF (CPS2 Arcade)",
            { XMVSF_A,          L"XMvSF", L"XMvSF (CPS2)|xvs*.05*|", GamePlatform::CapcomCPS12, GameSeries::CPS_MvC },
            Make_XMVSF_A,
        ...
        },
        {
            XMVSF_S,
            L"XMvSF",
            { XMVSF_S,          L"XMvSF", L"XMvSF (Steam)|xmvsf*.21D3D8A7;f000.bin|", GamePlatform::Steam, GameSeries::Steam_MvCC },
            Make_XMVSF_S,
    ...
    static_assert(NUM_GAMES == 303, "New GameID defined: please update GameRegistry with the associated data.");
    ...
    void SetExtraLoadingDataForGame(int nGameFlag, LPCWSTR pszFileNameLowercase, int& nGameRule)
    {
        switch (nGameFlag)
        {
            ...
            case CVS1_A:
                ...
                break;
            case DBZEB_DS:
                CGame_DBZEB_DS::SetSpecialRuleForFileName(pszFileNameLowercase);
                break;
            case FatalFury2_A:
