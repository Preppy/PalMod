...
{
    { L"Krizalid Striker Portrait", 0x399222, 0x399242, indexKOF01Sprites_Zero, 0x19 },
    { L"Lon Striker Portrait",      0x399242, 0x399262, indexKOF01Sprites_Zero, 0x1a },
    { L"Glugan Striker Portrait",   0x399262, 0x399282, indexKOF01Sprites_Zero, 0x18 },
};
...
const sGame_PaletteDataset KOF01_A_K_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398322, 0x398342, indexKOF01Sprites_K, 0x60 },
    ...
    { L"Win Portrait", 0x39d122, 0x39d162, indexKOF01Sprites_K, 0x40 },
    { L"Lifebar Portrait", 0x3b8922, 0x3b8942, indexKOF01Sprites_K, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7d22, 0x3b7d42, indexKOF01Sprites_K, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_K_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398342, 0x398362, indexKOF01Sprites_K, 0x60 },
    ...
    { L"Win Portrait", 0x39d162, 0x39d1a2, indexKOF01Sprites_K, 0x40 },
    { L"Lifebar Portrait", 0x3b8942, 0x3b8962, indexKOF01Sprites_K, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8222, 0x3b8242, indexKOF01Sprites_K, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_MAXIMA_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398382, 0x3983a2, indexKOF01Sprites_Maxima, 0x60 },
    ...
    { L"Win Portrait", 0x39d1a2, 0x39d1e2, indexKOF01Sprites_Maxima, 0x40 },
    { L"Lifebar Portrait", 0x3b8962, 0x3b8982, indexKOF01Sprites_Maxima, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7d42, 0x3b7d62, indexKOF01Sprites_Maxima, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_MAXIMA_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3983a2, 0x3983c2, indexKOF01Sprites_Maxima, 0x60 },
    ...
    { L"Win Portrait", 0x39d1e2, 0x39d222, indexKOF01Sprites_Maxima, 0x40 },
    { L"Lifebar Portrait", 0x3b8982, 0x3b89a2, indexKOF01Sprites_Maxima, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8242, 0x3b8262, indexKOF01Sprites_Maxima, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_WHIP_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3983e2, 0x398402, indexKOF01Sprites_Whip, 0x60 },
    ...
    { L"Win Portrait", 0x39d222, 0x39d262, indexKOF01Sprites_Whip, 0x40 },
    { L"Lifebar Portrait", 0x3b89a2, 0x3b89c2, indexKOF01Sprites_Whip, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7d62, 0x3b7d82, indexKOF01Sprites_Whip, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_WHIP_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398402, 0x398422, indexKOF01Sprites_Whip, 0x60 },
    ...
    { L"Win Portrait", 0x39d262, 0x39d2a2, indexKOF01Sprites_Whip, 0x40 },
    { L"Lifebar Portrait", 0x3b89c2, 0x3b89e2, indexKOF01Sprites_Whip, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8262, 0x3b8282, indexKOF01Sprites_Whip, 0x61 },
};

const sGame_PaletteDataset KOF01_A_LIN_PUNCH_PALETTES[] =
{
    { L"Lin Punch", 0x387d22, 0x387d42, indexKOF01Sprites_Lin },
    { L"Character Extra 1", 0x387d42, 0x387d62, indexKOF01Sprites_Lin },
    { L"Character Extra 2", 0x387d62, 0x387d82, indexKOF01Sprites_Lin },
    { L"Electric Palette", 0x387d82, 0x387da2, indexKOF01Sprites_Lin },
    { L"Lin Poison Palette (Unused)", 0x387da2, 0x387dc2, indexKOF01Sprites_Lin },
    { L"Freeze Palette (Unused)", 0x387dc2, 0x387de2, indexKOF01Sprites_Lin },
    { L"Super Trail", 0x387de2, 0x387e02, indexKOF01Sprites_Lin },
    { L"Striker Portrait", 0x398442, 0x398462, indexKOF01Sprites_Lin, 0x60 },
    { L"Order Select Portrait", 0x3993e2, 0x399402, indexKOF01Sprites_Lin, 0x44 },
    { L"Select/VS Portrait", 0x39a2e2, 0x39a322, indexKOF01Sprites_Lin, 0x42 },
    { L"Win Portrait", 0x39d2a2, 0x39d2e2, indexKOF01Sprites_Lin, 0x40 },
    { L"Lifebar Portrait", 0x3b89e2, 0x3b8a02, indexKOF01Sprites_Lin, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7d82, 0x3b7da2, indexKOF01Sprites_Lin, 0x61 },
};

const sGame_PaletteDataset KOF01_A_LIN_KICK_PALETTES[] =
{
    { L"Lin Kick", 0x387f22, 0x387f42, indexKOF01Sprites_Lin },
    { L"Character Extra 1", 0x387f42, 0x387f62, indexKOF01Sprites_Lin },
    { L"Character Extra 2", 0x387f62, 0x387f82, indexKOF01Sprites_Lin },
    { L"Electric Palette", 0x387f82, 0x387fa2, indexKOF01Sprites_Lin },
    { L"Lin Poison Palette (Unused)", 0x387fa2, 0x387fc2, indexKOF01Sprites_Lin },
    { L"Freeze Palette (Unused)", 0x387fc2, 0x387fe2, indexKOF01Sprites_Lin },
    { L"Super Trail", 0x387fe2, 0x388002, indexKOF01Sprites_Lin },
    { L"Striker Portrait", 0x398462, 0x398482, indexKOF01Sprites_Lin, 0x60 },
    { L"Order Select Portrait", 0x399402, 0x399422, indexKOF01Sprites_Lin, 0x44 },
    { L"Select/VS Portrait", 0x39a322, 0x39a362, indexKOF01Sprites_Lin, 0x42 },
    { L"Win Portrait", 0x39d2e2, 0x39d322, indexKOF01Sprites_Lin, 0x40 },
    { L"Lifebar Portrait", 0x3b8a02, 0x3b8a22, indexKOF01Sprites_Lin, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8282, 0x3b82a2, indexKOF01Sprites_Lin, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_KYO_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3984a2, 0x3984c2, indexKOF01Sprites_Kyo, 0x60 },
    ...
    { L"Win Portrait", 0x39d322, 0x39d362, indexKOF01Sprites_Kyo, 0x40 },
    { L"Lifebar Portrait", 0x3b8a22, 0x3b8a42, indexKOF01Sprites_Kyo, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7da2, 0x3b7dc2, indexKOF01Sprites_Kyo, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_KYO_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3984c2, 0x3984e2, indexKOF01Sprites_Kyo, 0x60 },
    ...
    { L"Win Portrait", 0x39d362, 0x39d3a2, indexKOF01Sprites_Kyo, 0x40 },
    { L"Lifebar Portrait", 0x3b8a42, 0x3b8a62, indexKOF01Sprites_Kyo, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b82a2, 0x3b82c2, indexKOF01Sprites_Kyo, 0x61 },
};

const sGame_PaletteDataset KOF01_A_BENIMARU_PUNCH_PALETTES[] =
{
    { L"Benimaru Punch", 0x388522, 0x388542, indexKOF01Sprites_Benimaru },
    { L"Character Extra 1", 0x388542, 0x388562, indexKOF01Sprites_Benimaru },
    { L"Character Extra 2", 0x388562, 0x388582, indexKOF01Sprites_Benimaru },
    { L"Electric Palette", 0x388582, 0x3885a2, indexKOF01Sprites_Benimaru },
    { L"Lin Poison Palette (Unused)", 0x3885a2, 0x3885c2, indexKOF01Sprites_Benimaru },
    { L"Freeze Palette (Unused)", 0x3885c2, 0x3885e2, indexKOF01Sprites_Benimaru },
    { L"Super Trail", 0x3885e2, 0x388602, indexKOF01Sprites_Benimaru },
    { L"Striker Portrait", 0x398502, 0x398522, indexKOF01Sprites_Benimaru, 0x60 },
    { L"Order Select Portrait", 0x399462, 0x399482, indexKOF01Sprites_Benimaru, 0x44 },
    { L"Select/VS Portrait", 0x39a562, 0x39a5a2, indexKOF01Sprites_Benimaru, 0x42 },
    { L"Win Portrait", 0x39d3a2, 0x39d3e2, indexKOF01Sprites_Benimaru, 0x40 },
    { L"Lifebar Portrait", 0x3b8a62, 0x3b8a82, indexKOF01Sprites_Benimaru, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7dc2, 0x3b7de2, indexKOF01Sprites_Benimaru, 0x61 },
};

const sGame_PaletteDataset KOF01_A_BENIMARU_KICK_PALETTES[] =
{
    { L"Benimaru Kick", 0x388722, 0x388742, indexKOF01Sprites_Benimaru },
    { L"Character Extra 1", 0x388742, 0x388762, indexKOF01Sprites_Benimaru },
    { L"Character Extra 2", 0x388762, 0x388782, indexKOF01Sprites_Benimaru },
    { L"Electric Palette", 0x388782, 0x3887a2, indexKOF01Sprites_Benimaru },
    { L"Lin Poison Palette (Unused)", 0x3887a2, 0x3887c2, indexKOF01Sprites_Benimaru },
    { L"Freeze Palette (Unused)", 0x3887c2, 0x3887e2, indexKOF01Sprites_Benimaru },
    { L"Super Trail", 0x3887e2, 0x388802, indexKOF01Sprites_Benimaru },
    { L"Striker Portrait", 0x398522, 0x398542, indexKOF01Sprites_Benimaru, 0x60 },
    { L"Order Select Portrait", 0x399482, 0x3994a2, indexKOF01Sprites_Benimaru, 0x44 },
    { L"Select/VS Portrait", 0x39a5a2, 0x39a5e2, indexKOF01Sprites_Benimaru, 0x42 },
    { L"Win Portrait", 0x39d3e2, 0x39d422, indexKOF01Sprites_Benimaru, 0x40 },
    { L"Lifebar Portrait", 0x3b8a82, 0x3b8aa2, indexKOF01Sprites_Benimaru, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b82c2, 0x3b82e2, indexKOF01Sprites_Benimaru, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_GORO_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398562, 0x398582, indexKOF01Sprites_Goro, 0x60 },
    ...
    { L"Win Portrait", 0x39d422, 0x39d462, indexKOF01Sprites_Goro, 0x40 },
    { L"Lifebar Portrait", 0x3b8aa2, 0x3b8ac2, indexKOF01Sprites_Goro, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7de2, 0x3b7e02, indexKOF01Sprites_Goro, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_GORO_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398582, 0x3985a2, indexKOF01Sprites_Goro, 0x60 },
    ...
    { L"Win Portrait", 0x39d462, 0x39d4a2, indexKOF01Sprites_Goro, 0x40 },
    { L"Lifebar Portrait", 0x3b8ac2, 0x3b8ae2, indexKOF01Sprites_Goro, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b82e2, 0x3b8302, indexKOF01Sprites_Goro, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_SHINGO_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3985c2, 0x3985e2, indexKOF01Sprites_Shingo, 0x60 },
    ...
    { L"Win Portrait", 0x39d4a2, 0x39d4e2, indexKOF01Sprites_Shingo, 0x40 },
    { L"Lifebar Portrait", 0x3b8ae2, 0x3b8b02, indexKOF01Sprites_Shingo, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7e02, 0x3b7e22, indexKOF01Sprites_Shingo, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_SHINGO_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3985e2, 0x398602, indexKOF01Sprites_Shingo, 0x60 },
    ...
    { L"Win Portrait", 0x39d4e2, 0x39d522, indexKOF01Sprites_Shingo, 0x40 },
    { L"Lifebar Portrait", 0x3b8b02, 0x3b8b22, indexKOF01Sprites_Shingo, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8302, 0x3b8322, indexKOF01Sprites_Shingo, 0x61 },
};

const sGame_PaletteDataset KOF01_A_IORI_PUNCH_PALETTES[] =
{
    { L"Iori Punch", 0x389122, 0x389142, indexKOF01Sprites_Iori },
    { L"Character Extra 1", 0x389142, 0x389162, indexKOF01Sprites_Iori },
    { L"Character Extra 2", 0x389162, 0x389182, indexKOF01Sprites_Iori },
    { L"Electric Palette", 0x389182, 0x3891a2, indexKOF01Sprites_Iori },
    { L"Lin Poison Palette (Unused)", 0x3891a2, 0x3891c2, indexKOF01Sprites_Iori },
    { L"Freeze Palette (Unused)", 0x3891c2, 0x3891e2, indexKOF01Sprites_Iori },
    { L"Super Trail", 0x3891e2, 0x389202, indexKOF01Sprites_Iori },
    { L"Striker Portrait", 0x398622, 0x398642, indexKOF01Sprites_Iori, 0x60 },
    { L"Order Select Portrait", 0x399522, 0x399542, indexKOF01Sprites_Iori, 0x44 },
    { L"Select/VS Portrait", 0x39a922, 0x39a962, indexKOF01Sprites_Iori, 0x42 },
    { L"Win Portrait", 0x39d522, 0x39d562, indexKOF01Sprites_Iori, 0x40 },
    { L"Lifebar Portrait", 0x3b8b22, 0x3b8b42, indexKOF01Sprites_Iori, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7e22, 0x3b7e42, indexKOF01Sprites_Iori, 0x61 },
};

const sGame_PaletteDataset KOF01_A_IORI_KICK_PALETTES[] =
{
    { L"Iori Kick", 0x389322, 0x389342, indexKOF01Sprites_Iori },
    { L"Character Extra 1", 0x389342, 0x389362, indexKOF01Sprites_Iori },
    { L"Character Extra 2", 0x389362, 0x389382, indexKOF01Sprites_Iori },
    { L"Electric Palette", 0x389382, 0x3893a2, indexKOF01Sprites_Iori },
    { L"Lin Poison Palette (Unused)", 0x3893a2, 0x3893c2, indexKOF01Sprites_Iori },
    { L"Freeze Palette (Unused)", 0x3893c2, 0x3893e2, indexKOF01Sprites_Iori },
    { L"Super Trail", 0x3893e2, 0x389402, indexKOF01Sprites_Iori },
    { L"Striker Portrait", 0x398642, 0x398662, indexKOF01Sprites_Iori, 0x60 },
    { L"Order Select Portrait", 0x399542, 0x399562, indexKOF01Sprites_Iori, 0x44 },
    { L"Select/VS Portrait", 0x39a962, 0x39a9a2, indexKOF01Sprites_Iori, 0x42 },
    { L"Win Portrait", 0x39d562, 0x39d5a2, indexKOF01Sprites_Iori, 0x40 },
    { L"Lifebar Portrait", 0x3b8b42, 0x3b8b62, indexKOF01Sprites_Iori, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8322, 0x3b8342, indexKOF01Sprites_Iori, 0x61 },
};

const sGame_PaletteDataset KOF01_A_VANESSA_PUNCH_PALETTES[] =
{
    { L"Vanessa Punch", 0x389522, 0x389542, indexKOF01Sprites_Vanessa },
    { L"Character Extra 1", 0x389542, 0x389562, indexKOF01Sprites_Vanessa },
    { L"Character Extra 2", 0x389562, 0x389582, indexKOF01Sprites_Vanessa },
    { L"Electric Palette", 0x389582, 0x3895a2, indexKOF01Sprites_Vanessa },
    { L"Lin Poison Palette (Unused)", 0x3895a2, 0x3895c2, indexKOF01Sprites_Vanessa },
    { L"Freeze Palette (Unused)", 0x3895c2, 0x3895e2, indexKOF01Sprites_Vanessa },
    { L"Super Trail", 0x3895e2, 0x389602, indexKOF01Sprites_Vanessa },
    { L"Striker Portrait", 0x398682, 0x3986a2, indexKOF01Sprites_Vanessa, 0x60 },
    { L"Order Select Portrait", 0x399562, 0x399582, indexKOF01Sprites_Vanessa, 0x44 },
    { L"Select/VS Portrait", 0x39aa62, 0x39aaa2, indexKOF01Sprites_Vanessa, 0x42 },
    { L"Win Portrait", 0x39d5a2, 0x39d5e2, indexKOF01Sprites_Vanessa, 0x40 },
    { L"Lifebar Portrait", 0x3b8b62, 0x3b8b82, indexKOF01Sprites_Vanessa, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7e42, 0x3b7e62, indexKOF01Sprites_Vanessa, 0x61 },
};

const sGame_PaletteDataset KOF01_A_VANESSA_KICK_PALETTES[] =
{
    { L"Vanessa Kick", 0x389722, 0x389742, indexKOF01Sprites_Vanessa },
    { L"Character Extra 1", 0x389742, 0x389762, indexKOF01Sprites_Vanessa },
    { L"Character Extra 2", 0x389762, 0x389782, indexKOF01Sprites_Vanessa },
    { L"Electric Palette", 0x389782, 0x3897a2, indexKOF01Sprites_Vanessa },
    { L"Lin Poison Palette (Unused)", 0x3897a2, 0x3897c2, indexKOF01Sprites_Vanessa },
    { L"Freeze Palette (Unused)", 0x3897c2, 0x3897e2, indexKOF01Sprites_Vanessa },
    { L"Super Trail", 0x3897e2, 0x389802, indexKOF01Sprites_Vanessa },
    { L"Striker Portrait", 0x3986a2, 0x3986c2, indexKOF01Sprites_Vanessa, 0x60 },
    { L"Order Select Portrait", 0x399582, 0x3995a2, indexKOF01Sprites_Vanessa, 0x44 },
    { L"Select/VS Portrait", 0x39aaa2, 0x39aae2, indexKOF01Sprites_Vanessa, 0x42 },
    { L"Win Portrait", 0x39d5e2, 0x39d622, indexKOF01Sprites_Vanessa, 0x40 },
    { L"Lifebar Portrait", 0x3b8b82, 0x3b8ba2, indexKOF01Sprites_Vanessa, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8342, 0x3b8362, indexKOF01Sprites_Vanessa, 0x61 },
};

const sGame_PaletteDataset KOF01_A_SETH_PUNCH_PALETTES[] =
{
    { L"Seth Punch", 0x389922, 0x389942, indexKOF01Sprites_Seth },
    { L"Character Extra 1", 0x389942, 0x389962, indexKOF01Sprites_Seth },
    { L"Character Extra 2", 0x389962, 0x389982, indexKOF01Sprites_Seth },
    { L"Electric Palette", 0x389982, 0x3899a2, indexKOF01Sprites_Seth },
    { L"Lin Poison Palette (Unused)", 0x3899a2, 0x3899c2, indexKOF01Sprites_Seth },
    { L"Freeze Palette (Unused)", 0x3899c2, 0x3899e2, indexKOF01Sprites_Seth },
    { L"Super Trail", 0x3899e2, 0x389a02, indexKOF01Sprites_Seth },
    { L"Striker Portrait", 0x3986e2, 0x398702, indexKOF01Sprites_Seth, 0x60 },
    { L"Order Select Portrait", 0x3995a2, 0x3995c2, indexKOF01Sprites_Seth, 0x44 },
    { L"Select/VS Portrait", 0x39aba2, 0x39abe2, indexKOF01Sprites_Seth, 0x42 },
    { L"Win Portrait", 0x39d622, 0x39d662, indexKOF01Sprites_Seth, 0x40 },
    { L"Lifebar Portrait", 0x3b8ba2, 0x3b8bc2, indexKOF01Sprites_Seth, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7e62, 0x3b7e82, indexKOF01Sprites_Seth, 0x61 },
};

const sGame_PaletteDataset KOF01_A_SETH_KICK_PALETTES[] =
{
    { L"Seth Kick", 0x389b22, 0x389b42, indexKOF01Sprites_Seth },
    { L"Character Extra 1", 0x389b42, 0x389b62, indexKOF01Sprites_Seth },
    { L"Character Extra 2", 0x389b62, 0x389b82, indexKOF01Sprites_Seth },
    { L"Electric Palette", 0x389b82, 0x389ba2, indexKOF01Sprites_Seth },
    { L"Lin Poison Palette (Unused)", 0x389ba2, 0x389bc2, indexKOF01Sprites_Seth },
    { L"Freeze Palette (Unused)", 0x389bc2, 0x389be2, indexKOF01Sprites_Seth },
    { L"Super Trail", 0x389be2, 0x389c02, indexKOF01Sprites_Seth },
    { L"Striker Portrait", 0x398702, 0x398722, indexKOF01Sprites_Seth, 0x60 },
    { L"Order Select Portrait", 0x3995c2, 0x3995e2, indexKOF01Sprites_Seth, 0x44 },
    { L"Select/VS Portrait", 0x39abe2, 0x39ac22, indexKOF01Sprites_Seth, 0x42 },
    { L"Win Portrait", 0x39d662, 0x39d6a2, indexKOF01Sprites_Seth, 0x40 },
    { L"Lifebar Portrait", 0x3b8bc2, 0x3b8be2, indexKOF01Sprites_Seth, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8362, 0x3b8382, indexKOF01Sprites_Seth, 0x61 },
};

const sGame_PaletteDataset KOF01_A_RAMON_PUNCH_PALETTES[] =
{
    { L"Ramon Punch", 0x389d22, 0x389d42, indexKOF01Sprites_Ramon },
    { L"Character Extra 1", 0x389d42, 0x389d62, indexKOF01Sprites_Ramon },
    { L"Character Extra 2", 0x389d62, 0x389d82, indexKOF01Sprites_Ramon },
    { L"Electric Palette", 0x389d82, 0x389da2, indexKOF01Sprites_Ramon },
    { L"Lin Poison Palette (Unused)", 0x389da2, 0x389dc2, indexKOF01Sprites_Ramon },
    { L"Freeze Palette (Unused)", 0x389dc2, 0x389de2, indexKOF01Sprites_Ramon },
    { L"Super Trail", 0x389de2, 0x389e02, indexKOF01Sprites_Ramon },
    { L"Striker Portrait", 0x398742, 0x398762, indexKOF01Sprites_Ramon, 0x60 },
    { L"Order Select Portrait", 0x3995e2, 0x399602, indexKOF01Sprites_Ramon, 0x44 },
    { L"Select/VS Portrait", 0x39ace2, 0x39ad22, indexKOF01Sprites_Ramon, 0x42 },
    { L"Win Portrait", 0x39d6a2, 0x39d6e2, indexKOF01Sprites_Ramon, 0x40 },
    { L"Lifebar Portrait", 0x3b8be2, 0x3b8c02, indexKOF01Sprites_Ramon, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7e82, 0x3b7ea2, indexKOF01Sprites_Ramon, 0x61 },
};

const sGame_PaletteDataset KOF01_A_RAMON_KICK_PALETTES[] =
{
    { L"Ramon Kick", 0x389f22, 0x389f42, indexKOF01Sprites_Ramon },
    { L"Character Extra 1", 0x389f42, 0x389f62, indexKOF01Sprites_Ramon },
    { L"Character Extra 2", 0x389f62, 0x389f82, indexKOF01Sprites_Ramon },
    { L"Electric Palette", 0x389f82, 0x389fa2, indexKOF01Sprites_Ramon },
    { L"Lin Poison Palette (Unused)", 0x389fa2, 0x389fc2, indexKOF01Sprites_Ramon },
    { L"Freeze Palette (Unused)", 0x389fc2, 0x389fe2, indexKOF01Sprites_Ramon },
    { L"Super Trail", 0x389fe2, 0x38a002, indexKOF01Sprites_Ramon },
    { L"Striker Portrait", 0x398762, 0x398782, indexKOF01Sprites_Ramon, 0x60 },
    { L"Order Select Portrait", 0x399602, 0x399622, indexKOF01Sprites_Ramon, 0x44 },
    { L"Select/VS Portrait", 0x39ad22, 0x39ad62, indexKOF01Sprites_Ramon, 0x42 },
    { L"Win Portrait", 0x39d6e2, 0x39d722, indexKOF01Sprites_Ramon, 0x40 },
    { L"Lifebar Portrait", 0x3b8c02, 0x3b8c22, indexKOF01Sprites_Ramon, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8382, 0x3b83a2, indexKOF01Sprites_Ramon, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_LEONA_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3987a2, 0x3987c2, indexKOF01Sprites_Leona, 0x60 },
    ...
    { L"Win Portrait", 0x39d722, 0x39d762, indexKOF01Sprites_Leona, 0x40 },
    { L"Lifebar Portrait", 0x3b8c22, 0x3b8c42, indexKOF01Sprites_Leona, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7ea2, 0x3b7ec2, indexKOF01Sprites_Leona, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_LEONA_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3987c2, 0x3987e2, indexKOF01Sprites_Leona, 0x60 },
    ...
    { L"Win Portrait", 0x39d762, 0x39d7a2, indexKOF01Sprites_Leona, 0x40 },
    { L"Lifebar Portrait", 0x3b8c42, 0x3b8c62, indexKOF01Sprites_Leona, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b83a2, 0x3b83c2, indexKOF01Sprites_Leona, 0x61 },
};

const sGame_PaletteDataset KOF01_A_RALF_PUNCH_PALETTES[] =
{
    { L"Ralf Punch", 0x38a522, 0x38a542, indexKOF01Sprites_Ralf },
    { L"Character Extra 1", 0x38a542, 0x38a562, indexKOF01Sprites_Ralf },
    { L"Character Extra 2", 0x38a562, 0x38a582, indexKOF01Sprites_Ralf },
    { L"Electric Palette", 0x38a582, 0x38a5a2, indexKOF01Sprites_Ralf },
    { L"Lin Poison Palette (Unused)", 0x38a5a2, 0x38a5c2, indexKOF01Sprites_Ralf },
    { L"Freeze Palette (Unused)", 0x38a5c2, 0x38a5e2, indexKOF01Sprites_Ralf },
    { L"Super Trail", 0x38a5e2, 0x38a602, indexKOF01Sprites_Ralf },
    { L"Striker Portrait", 0x398802, 0x398822, indexKOF01Sprites_Ralf, 0x60 },
    { L"Order Select Portrait", 0x399662, 0x399682, indexKOF01Sprites_Ralf, 0x44 },
    { L"Select/VS Portrait", 0x39af62, 0x39afa2, indexKOF01Sprites_Ralf, 0x42 },
    { L"Win Portrait", 0x39d7a2, 0x39d7e2, indexKOF01Sprites_Ralf, 0x40 },
    { L"Lifebar Portrait", 0x3b8c62, 0x3b8c82, indexKOF01Sprites_Ralf, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7ec2, 0x3b7ee2, indexKOF01Sprites_Ralf, 0x61 },
};

const sGame_PaletteDataset KOF01_A_RALF_KICK_PALETTES[] =
{
    { L"Ralf Kick", 0x38a722, 0x38a742, indexKOF01Sprites_Ralf },
    { L"Character Extra 1", 0x38a742, 0x38a762, indexKOF01Sprites_Ralf },
    { L"Character Extra 2", 0x38a762, 0x38a782, indexKOF01Sprites_Ralf },
    { L"Electric Palette", 0x38a782, 0x38a7a2, indexKOF01Sprites_Ralf },
    { L"Lin Poison Palette (Unused)", 0x38a7a2, 0x38a7c2, indexKOF01Sprites_Ralf },
    { L"Freeze Palette (Unused)", 0x38a7c2, 0x38a7e2, indexKOF01Sprites_Ralf },
    { L"Super Trail", 0x38a7e2, 0x38a802, indexKOF01Sprites_Ralf },
    { L"Striker Portrait", 0x398822, 0x398842, indexKOF01Sprites_Ralf, 0x60 },
    { L"Order Select Portrait", 0x399682, 0x3996a2, indexKOF01Sprites_Ralf, 0x44 },
    { L"Select/VS Portrait", 0x39afa2, 0x39afe2, indexKOF01Sprites_Ralf, 0x42 },
    { L"Win Portrait", 0x39d7e2, 0x39d822, indexKOF01Sprites_Ralf, 0x40 },
    { L"Lifebar Portrait", 0x3b8c82, 0x3b8ca2, indexKOF01Sprites_Ralf, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b83c2, 0x3b83e2, indexKOF01Sprites_Ralf, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_CLARK_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398862, 0x398882, indexKOF01Sprites_Clark, 0x60 },
    ...
    { L"Win Portrait", 0x39d822, 0x39d862, indexKOF01Sprites_Clark, 0x40 },
    { L"Lifebar Portrait", 0x3b8ca2, 0x3b8cc2, indexKOF01Sprites_Clark, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7ee2, 0x3b7f02, indexKOF01Sprites_Clark, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_CLARK_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398882, 0x3988a2, indexKOF01Sprites_Clark, 0x60 },
    ...
    { L"Win Portrait", 0x39d862, 0x39d8a2, indexKOF01Sprites_Clark, 0x40 },
    { L"Lifebar Portrait", 0x3b8cc2, 0x3b8ce2, indexKOF01Sprites_Clark, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b83e2, 0x3b8402, indexKOF01Sprites_Clark, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_HEIDERN_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3988c2, 0x3988e2, indexKOF01Sprites_Heidern, 0x60 },
    { L"Order Select Portrait", 0x3996e2, 0x399702, indexKOF01Sprites_Heidern, 0x44 },
    { L"Select/VS Portrait", 0x39b1e2, 0x39b222, indexKOF01Sprites_Heidern, 0x42 },
    { L"Win Portrait", 0x39d8a2, 0x39d8e2, indexKOF01Sprites_Heidern, 0x40 },
    { L"Lifebar Portrait", 0x3b8ce2, 0x3b8d02, indexKOF01Sprites_Heidern, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7f02, 0x3b7f22, indexKOF01Sprites_Heidern, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_HEIDERN_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3988e2, 0x398902, indexKOF01Sprites_Heidern, 0x60 },
    { L"Order Select Portrait", 0x399702, 0x399722, indexKOF01Sprites_Heidern, 0x44 },
    { L"Select/VS Portrait", 0x39b222, 0x39b262, indexKOF01Sprites_Heidern, 0x42 },
    { L"Win Portrait", 0x39d8e2, 0x39d922, indexKOF01Sprites_Heidern, 0x40 },
    { L"Lifebar Portrait", 0x3b8d02, 0x3b8d22, indexKOF01Sprites_Heidern, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8402, 0x3b8422, indexKOF01Sprites_Heidern, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_TERRY_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398922, 0x398942, indexKOF01Sprites_Terry, 0x60 },
    ...
    { L"Win Portrait", 0x39d922, 0x39d962, indexKOF01Sprites_Terry, 0x40 },
    { L"Lifebar Portrait", 0x3b8d22, 0x3b8d42, indexKOF01Sprites_Terry, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7f22, 0x3b7f42, indexKOF01Sprites_Terry, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_TERRY_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398942, 0x398962, indexKOF01Sprites_Terry, 0x60 },
    ...
    { L"Win Portrait", 0x39d962, 0x39d9a2, indexKOF01Sprites_Terry, 0x40 },
    { L"Lifebar Portrait", 0x3b8d42, 0x3b8d62, indexKOF01Sprites_Terry, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8422, 0x3b8442, indexKOF01Sprites_Terry, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ANDY_PUNCH_PALETTES[] =
{
    { L"Andy Punch", 0x38b522, 0x38b542, indexKOF01Sprites_Andy },
    { L"Character Extra 1", 0x38b542, 0x38b562, indexKOF01Sprites_Andy },
    { L"Character Extra 2", 0x38b562, 0x38b582, indexKOF01Sprites_Andy },
    { L"Electric Palette", 0x38b582, 0x38b5a2, indexKOF01Sprites_Andy },
    { L"Lin Poison Palette (Unused)", 0x38b5a2, 0x38b5c2, indexKOF01Sprites_Andy },
    { L"Freeze Palette (Unused)", 0x38b5c2, 0x38b5e2, indexKOF01Sprites_Andy },
    { L"Super Trail", 0x38b5e2, 0x38b602, indexKOF01Sprites_Andy },
    { L"Striker Portrait", 0x398982, 0x3989a2, indexKOF01Sprites_Andy, 0x60 },
    { L"Order Select Portrait", 0x399762, 0x399782, indexKOF01Sprites_Andy, 0x44 },
    { L"Select/VS Portrait", 0x39b462, 0x39b4a2, indexKOF01Sprites_Andy, 0x42 },
    { L"Win Portrait", 0x39d9a2, 0x39d9e2, indexKOF01Sprites_Andy, 0x40 },
    { L"Lifebar Portrait", 0x3b8d62, 0x3b8d82, indexKOF01Sprites_Andy, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7f42, 0x3b7f62, indexKOF01Sprites_Andy, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ANDY_KICK_PALETTES[] =
{
    { L"Andy Kick", 0x38b722, 0x38b742, indexKOF01Sprites_Andy },
    { L"Character Extra 1", 0x38b742, 0x38b762, indexKOF01Sprites_Andy },
    { L"Character Extra 2", 0x38b762, 0x38b782, indexKOF01Sprites_Andy },
    { L"Electric Palette", 0x38b782, 0x38b7a2, indexKOF01Sprites_Andy },
    { L"Lin Poison Palette (Unused)", 0x38b7a2, 0x38b7c2, indexKOF01Sprites_Andy },
    { L"Freeze Palette (Unused)", 0x38b7c2, 0x38b7e2, indexKOF01Sprites_Andy },
    { L"Super Trail", 0x38b7e2, 0x38b802, indexKOF01Sprites_Andy },
    { L"Striker Portrait", 0x3989a2, 0x3989c2, indexKOF01Sprites_Andy, 0x60 },
    { L"Order Select Portrait", 0x399782, 0x3997a2, indexKOF01Sprites_Andy, 0x44 },
    { L"Select/VS Portrait", 0x39b4a2, 0x39b4e2, indexKOF01Sprites_Andy, 0x42 },
    { L"Win Portrait", 0x39d9e2, 0x39da22, indexKOF01Sprites_Andy, 0x40 },
    { L"Lifebar Portrait", 0x3b8d82, 0x3b8da2, indexKOF01Sprites_Andy, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8442, 0x3b8462, indexKOF01Sprites_Andy, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_JOE_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3989e2, 0x398a02, indexKOF01Sprites_Joe, 0x60 },
    ...
    { L"Win Portrait", 0x39da22, 0x39da62, indexKOF01Sprites_Joe, 0x40 },
    { L"Lifebar Portrait", 0x3b8da2, 0x3b8dc2, indexKOF01Sprites_Joe, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7f62, 0x3b7f82, indexKOF01Sprites_Joe, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_JOE_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398a02, 0x398a22, indexKOF01Sprites_Joe, 0x60 },
    ...
    { L"Win Portrait", 0x39da62, 0x39daa2, indexKOF01Sprites_Joe, 0x40 },
    { L"Lifebar Portrait", 0x3b8dc2, 0x3b8de2, indexKOF01Sprites_Joe, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8462, 0x3b8482, indexKOF01Sprites_Joe, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_MARY_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398a42, 0x398a62, indexKOF01Sprites_Mary, 0x60 },
    ...
    { L"Win Portrait", 0x39daa2, 0x39dae2, indexKOF01Sprites_Mary, 0x40 },
    { L"Lifebar Portrait", 0x3b8de2, 0x3b8e02, indexKOF01Sprites_Mary, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7f82, 0x3b7fa2, indexKOF01Sprites_Mary, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_MARY_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398a62, 0x398a82, indexKOF01Sprites_Mary, 0x60 },
    ...
    { L"Win Portrait", 0x39dae2, 0x39db22, indexKOF01Sprites_Mary, 0x40 },
    { L"Lifebar Portrait", 0x3b8e02, 0x3b8e22, indexKOF01Sprites_Mary, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8482, 0x3b84a2, indexKOF01Sprites_Mary, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_RYO_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398aa2, 0x398ac2, indexKOF01Sprites_Ryo, 0x60 },
    ...
    { L"Win Portrait", 0x39db22, 0x39db62, indexKOF01Sprites_Ryo, 0x40 },
    { L"Lifebar Portrait", 0x3b8e22, 0x3b8e42, indexKOF01Sprites_Ryo, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7fa2, 0x3b7fc2, indexKOF01Sprites_Ryo, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_RYO_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398ac2, 0x398ae2, indexKOF01Sprites_Ryo, 0x60 },
    ...
    { L"Win Portrait", 0x39db62, 0x39dba2, indexKOF01Sprites_Ryo, 0x40 },
    { L"Lifebar Portrait", 0x3b8e42, 0x3b8e62, indexKOF01Sprites_Ryo, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b84a2, 0x3b84c2, indexKOF01Sprites_Ryo, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ROBERT_PUNCH_PALETTES[] =
{
    { L"Robert Punch", 0x38c522, 0x38c542, indexKOF01Sprites_Robert },
    { L"Character Extra 1", 0x38c542, 0x38c562, indexKOF01Sprites_Robert },
    { L"Character Extra 2", 0x38c562, 0x38c582, indexKOF01Sprites_Robert },
    { L"Electric Palette", 0x38c582, 0x38c5a2, indexKOF01Sprites_Robert },
    { L"Lin Poison Palette (Unused)", 0x38c5a2, 0x38c5c2, indexKOF01Sprites_Robert },
    { L"Freeze Palette (Unused)", 0x38c5c2, 0x38c5e2, indexKOF01Sprites_Robert },
    { L"Super Trail", 0x38c5e2, 0x38c602, indexKOF01Sprites_Robert },
    { L"Striker Portrait", 0x398b02, 0x398b22, indexKOF01Sprites_Robert, 0x60 },
    { L"Order Select Portrait", 0x399862, 0x399882, indexKOF01Sprites_Robert, 0x44 },
    { L"Select/VS Portrait", 0x39b962, 0x39b9a2, indexKOF01Sprites_Robert, 0x42 },
    { L"Win Portrait", 0x39dba2, 0x39dbe2, indexKOF01Sprites_Robert, 0x40 },
    { L"Lifebar Portrait", 0x3b8e62, 0x3b8e82, indexKOF01Sprites_Robert, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7fc2, 0x3b7fe2, indexKOF01Sprites_Robert, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ROBERT_KICK_PALETTES[] =
{
    { L"Robert Kick", 0x38c722, 0x38c742, indexKOF01Sprites_Robert },
    { L"Character Extra 1", 0x38c742, 0x38c762, indexKOF01Sprites_Robert },
    { L"Character Extra 2", 0x38c762, 0x38c782, indexKOF01Sprites_Robert },
    { L"Electric Palette", 0x38c782, 0x38c7a2, indexKOF01Sprites_Robert },
    { L"Lin Poison Palette (Unused)", 0x38c7a2, 0x38c7c2, indexKOF01Sprites_Robert },
    { L"Freeze Palette (Unused)", 0x38c7c2, 0x38c7e2, indexKOF01Sprites_Robert },
    { L"Super Trail", 0x38c7e2, 0x38c802, indexKOF01Sprites_Robert },
    { L"Striker Portrait", 0x398b22, 0x398b42, indexKOF01Sprites_Robert, 0x60 },
    { L"Order Select Portrait", 0x399882, 0x3998a2, indexKOF01Sprites_Robert, 0x44 },
    { L"Select/VS Portrait", 0x39b9a2, 0x39b9e2, indexKOF01Sprites_Robert, 0x42 },
    { L"Win Portrait", 0x39dbe2, 0x39dc22, indexKOF01Sprites_Robert, 0x40 },
    { L"Lifebar Portrait", 0x3b8e82, 0x3b8ea2, indexKOF01Sprites_Robert, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b84c2, 0x3b84e2, indexKOF01Sprites_Robert, 0x61 },
};

const sGame_PaletteDataset KOF01_A_YURI_PUNCH_PALETTES[] =
{
    { L"Yuri Punch", 0x38c922, 0x38c942, indexKOF01Sprites_Yuri },
    { L"Character Extra 1", 0x38c942, 0x38c962, indexKOF01Sprites_Yuri },
    { L"Character Extra 2", 0x38c962, 0x38c982, indexKOF01Sprites_Yuri },
    { L"Electric Palette", 0x38c982, 0x38c9a2, indexKOF01Sprites_Yuri },
    { L"Lin Poison Palette (Unused)", 0x38c9a2, 0x38c9c2, indexKOF01Sprites_Yuri },
    { L"Freeze Palette (Unused)", 0x38c9c2, 0x38c9e2, indexKOF01Sprites_Yuri },
    { L"Super Trail", 0x38c9e2, 0x38ca02, indexKOF01Sprites_Yuri },
    { L"Striker Portrait", 0x398b62, 0x398b82, indexKOF01Sprites_Yuri, 0x60 },
    { L"Order Select Portrait", 0x3998a2, 0x3998c2, indexKOF01Sprites_Yuri, 0x44 },
    { L"Select/VS Portrait", 0x39baa2, 0x39bae2, indexKOF01Sprites_Yuri, 0x42 },
    { L"Win Portrait", 0x39dc22, 0x39dc62, indexKOF01Sprites_Yuri, 0x40 },
    { L"Lifebar Portrait", 0x3b8ea2, 0x3b8ec2, indexKOF01Sprites_Yuri, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b7fe2, 0x3b8002, indexKOF01Sprites_Yuri, 0x61 },
};

const sGame_PaletteDataset KOF01_A_YURI_KICK_PALETTES[] =
{
    { L"Yuri Kick", 0x38cb22, 0x38cb42, indexKOF01Sprites_Yuri },
    { L"Character Extra 1", 0x38cb42, 0x38cb62, indexKOF01Sprites_Yuri },
    { L"Character Extra 2", 0x38cb62, 0x38cb82, indexKOF01Sprites_Yuri },
    { L"Electric Palette", 0x38cb82, 0x38cba2, indexKOF01Sprites_Yuri },
    { L"Lin Poison Palette (Unused)", 0x38cba2, 0x38cbc2, indexKOF01Sprites_Yuri },
    { L"Freeze Palette (Unused)", 0x38cbc2, 0x38cbe2, indexKOF01Sprites_Yuri },
    { L"Super Trail", 0x38cbe2, 0x38cc02, indexKOF01Sprites_Yuri },
    { L"Striker Portrait", 0x398b82, 0x398ba2, indexKOF01Sprites_Yuri, 0x60 },
    { L"Order Select Portrait", 0x3998c2, 0x3998e2, indexKOF01Sprites_Yuri, 0x44 },
    { L"Select/VS Portrait", 0x39bae2, 0x39bb22, indexKOF01Sprites_Yuri, 0x42 },
    { L"Win Portrait", 0x39dc62, 0x39dca2, indexKOF01Sprites_Yuri, 0x40 },
    { L"Lifebar Portrait", 0x3b8ec2, 0x3b8ee2, indexKOF01Sprites_Yuri, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b84e2, 0x3b8502, indexKOF01Sprites_Yuri, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_TAKUMA_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398bc2, 0x398be2, indexKOF01Sprites_Takuma, 0x60 },
    ...
    { L"Win Portrait", 0x39dca2, 0x39dce2, indexKOF01Sprites_Takuma, 0x40 },
    { L"Lifebar Portrait", 0x3b8ee2, 0x3b8f02, indexKOF01Sprites_Takuma, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8002, 0x3b8022, indexKOF01Sprites_Takuma, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_TAKUMA_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398be2, 0x398c02, indexKOF01Sprites_Takuma, 0x60 },
    ...
    { L"Win Portrait", 0x39dce2, 0x39dd22, indexKOF01Sprites_Takuma, 0x40 },
    { L"Lifebar Portrait", 0x3b8f02, 0x3b8f22, indexKOF01Sprites_Takuma, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8502, 0x3b8522, indexKOF01Sprites_Takuma, 0x61 },
};

const sGame_PaletteDataset KOF01_A_KING_PUNCH_PALETTES[] =
{
    { L"King Punch", 0x38d122, 0x38d142, indexKOF01Sprites_King },
    { L"Character Extra 1", 0x38d142, 0x38d162, indexKOF01Sprites_King },
    { L"Character Extra 2", 0x38d162, 0x38d182, indexKOF01Sprites_King },
    { L"Electric Palette", 0x38d182, 0x38d1a2, indexKOF01Sprites_King },
    { L"Lin Poison Palette (Unused)", 0x38d1a2, 0x38d1c2, indexKOF01Sprites_King },
    { L"Freeze Palette (Unused)", 0x38d1c2, 0x38d1e2, indexKOF01Sprites_King },
    { L"Super Trail", 0x38d1e2, 0x38d202, indexKOF01Sprites_King },
    { L"Striker Portrait", 0x398c22, 0x398c42, indexKOF01Sprites_King, 0x60 },
    { L"Order Select Portrait", 0x399922, 0x399942, indexKOF01Sprites_King, 0x44 },
    { L"Select/VS Portrait", 0x39bd22, 0x39bd62, indexKOF01Sprites_King, 0x42 },
    { L"Win Portrait", 0x39dd22, 0x39dd62, indexKOF01Sprites_King, 0x40 },
    { L"Lifebar Portrait", 0x3b8f22, 0x3b8f42, indexKOF01Sprites_King, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8022, 0x3b8042, indexKOF01Sprites_King, 0x61 },
};

const sGame_PaletteDataset KOF01_A_KING_KICK_PALETTES[] =
{
    { L"King Kick", 0x38d322, 0x38d342, indexKOF01Sprites_King },
    { L"Character Extra 1", 0x38d342, 0x38d362, indexKOF01Sprites_King },
    { L"Character Extra 2", 0x38d362, 0x38d382, indexKOF01Sprites_King },
    { L"Electric Palette", 0x38d382, 0x38d3a2, indexKOF01Sprites_King },
    { L"Lin Poison Palette (Unused)", 0x38d3a2, 0x38d3c2, indexKOF01Sprites_King },
    { L"Freeze Palette (Unused)", 0x38d3c2, 0x38d3e2, indexKOF01Sprites_King },
    { L"Super Trail", 0x38d3e2, 0x38d402, indexKOF01Sprites_King },
    { L"Striker Portrait", 0x398c42, 0x398c62, indexKOF01Sprites_King, 0x60 },
    { L"Order Select Portrait", 0x399942, 0x399962, indexKOF01Sprites_King, 0x44 },
    { L"Select/VS Portrait", 0x39bd62, 0x39bda2, indexKOF01Sprites_King, 0x42 },
    { L"Win Portrait", 0x39dd62, 0x39dda2, indexKOF01Sprites_King, 0x40 },
    { L"Lifebar Portrait", 0x3b8f42, 0x3b8f62, indexKOF01Sprites_King, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8522, 0x3b8542, indexKOF01Sprites_King, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_MAI_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398c82, 0x398ca2, indexKOF01Sprites_Mai, 0x60 },
    ...
    { L"Win Portrait", 0x39dda2, 0x39dde2, indexKOF01Sprites_Mai, 0x40 },
    { L"Lifebar Portrait", 0x3b8f62, 0x3b8f82, indexKOF01Sprites_Mai, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8042, 0x3b8062, indexKOF01Sprites_Mai, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_MAI_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398ca2, 0x398cc2, indexKOF01Sprites_Mai, 0x60 },
    ...
    { L"Win Portrait", 0x39dde2, 0x39de22, indexKOF01Sprites_Mai, 0x40 },
    { L"Lifebar Portrait", 0x3b8f82, 0x3b8fa2, indexKOF01Sprites_Mai, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8542, 0x3b8562, indexKOF01Sprites_Mai, 0x61 },
};

const sGame_PaletteDataset KOF01_A_HINAKO_PUNCH_PALETTES[] =
{
    { L"Hinako Punch", 0x38d922, 0x38d942, indexKOF01Sprites_Hinako },
    { L"Character Extra 1", 0x38d942, 0x38d962 },
    { L"Character Extra 2: Win pose dog", 0x38d962, 0x38d982, indexKOF01Sprites_Hinako, 0x10 },
    { L"Electric Palette", 0x38d982, 0x38d9a2, indexKOF01Sprites_Hinako },
    { L"Lin Poison Palette (Unused)", 0x38d9a2, 0x38d9c2, indexKOF01Sprites_Hinako },
    { L"Freeze Palette (Unused)", 0x38d9c2, 0x38d9e2, indexKOF01Sprites_Hinako },
    { L"Super Trail", 0x38d9e2, 0x38da02, indexKOF01Sprites_Hinako },
    { L"Striker Portrait", 0x398ce2, 0x398d02, indexKOF01Sprites_Hinako, 0x60 },
    { L"Order Select Portrait", 0x3999a2, 0x3999c2, indexKOF01Sprites_Hinako, 0x44 },
    { L"Select/VS Portrait", 0x39bfa2, 0x39bfe2, indexKOF01Sprites_Hinako, 0x42 },
    { L"Win Portrait", 0x39de22, 0x39de62, indexKOF01Sprites_Hinako, 0x40 },
    { L"Lifebar Portrait", 0x3b8fa2, 0x3b8fc2, indexKOF01Sprites_Hinako, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8062, 0x3b8082, indexKOF01Sprites_Hinako, 0x61 },
};

const sGame_PaletteDataset KOF01_A_HINAKO_KICK_PALETTES[] =
{
    { L"Hinako Kick", 0x38db22, 0x38db42, indexKOF01Sprites_Hinako },
    { L"Character Extra 1", 0x38db42, 0x38db62 },
    { L"Character Extra 2: Win pose dog", 0x38db62, 0x38db82, indexKOF01Sprites_Hinako, 0x10 },
    { L"Electric Palette", 0x38db82, 0x38dba2, indexKOF01Sprites_Hinako },
    { L"Lin Poison Palette (Unused)", 0x38dba2, 0x38dbc2, indexKOF01Sprites_Hinako },
    { L"Freeze Palette (Unused)", 0x38dbc2, 0x38dbe2, indexKOF01Sprites_Hinako },
    { L"Super Trail", 0x38dbe2, 0x38dc02, indexKOF01Sprites_Hinako },
    { L"Striker Portrait", 0x398d02, 0x398d22, indexKOF01Sprites_Hinako, 0x60 },
    { L"Order Select Portrait", 0x3999c2, 0x3999e2, indexKOF01Sprites_Hinako, 0x44 },
    { L"Select/VS Portrait", 0x39bfe2, 0x39c022, indexKOF01Sprites_Hinako, 0x42 },
    { L"Win Portrait", 0x39de62, 0x39dea2, indexKOF01Sprites_Hinako, 0x40 },
    { L"Lifebar Portrait", 0x3b8fc2, 0x3b8fe2, indexKOF01Sprites_Hinako, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8562, 0x3b8582, indexKOF01Sprites_Hinako, 0x61 },
};

const sGame_PaletteDataset KOF01_A_XIANGFEI_PUNCH_PALETTES[] =
{
    { L"Xiangfei Punch", 0x38dd22, 0x38dd42, indexKOF99Sprites_Xiangfei },
    { L"Character Extra 1", 0x38dd42, 0x38dd62, indexKOF99Sprites_Xiangfei },
    ...
    { L"Striker Portrait", 0x398d42, 0x398d62, indexKOF01Sprites_Xiangfei, 0x60 },
    ...
    { L"Win Portrait", 0x39dea2, 0x39dee2, indexKOF01Sprites_Xiangfei, 0x40 },
    { L"Lifebar Portrait", 0x3b8fe2, 0x3b9002, indexKOF01Sprites_Xiangfei, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8082, 0x3b80a2, indexKOF01Sprites_Xiangfei, 0x61 },
};

const sGame_PaletteDataset KOF01_A_XIANGFEI_KICK_PALETTES[] =
{
    { L"Xiangfei Kick", 0x38df22, 0x38df42, indexKOF99Sprites_Xiangfei },
    { L"Character Extra 1", 0x38df42, 0x38df62, indexKOF99Sprites_Xiangfei },
    ...
    { L"Striker Portrait", 0x398d62, 0x398d82, indexKOF01Sprites_Xiangfei, 0x60 },
    ...
    { L"Win Portrait", 0x39dee2, 0x39df22, indexKOF01Sprites_Xiangfei, 0x40 },
    { L"Lifebar Portrait", 0x3b9002, 0x3b9022, indexKOF01Sprites_Xiangfei, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8582, 0x3b85a2, indexKOF01Sprites_Xiangfei, 0x61 },
};

const sGame_PaletteDataset KOF01_A_KULA_PUNCH_PALETTES[] =
{
    { L"Kula Punch", 0x38e122, 0x38e142, indexKOF01Sprites_Kula },
    { L"Character Extra 1", 0x38e142, 0x38e162, indexKOF01Sprites_Kula },
    { L"Character Extra 2", 0x38e162, 0x38e182, indexKOF01Sprites_Kula },
    { L"Electric Palette", 0x38e182, 0x38e1a2, indexKOF01Sprites_Kula },
    { L"Lin Poison Palette (Unused)", 0x38e1a2, 0x38e1c2, indexKOF01Sprites_Kula },
    { L"Freeze Palette (Unused)", 0x38e1c2, 0x38e1e2, indexKOF01Sprites_Kula },
    { L"Super Trail", 0x38e1e2, 0x38e202, indexKOF01Sprites_Kula },
    { L"Striker Portrait", 0x398da2, 0x398dc2, indexKOF01Sprites_Kula, 0x60 },
    { L"Order Select Portrait", 0x399a22, 0x399a42, indexKOF01Sprites_Kula, 0x44 },
    { L"Select/VS Portrait", 0x39c222, 0x39c262, indexKOF01Sprites_Kula, 0x42 },
    // You must reinsert below this after regenerating this header
    { L"Win Portrait", 0x39df22, 0x39df62, indexKOF01Sprites_Kula, 0x40, &pairNext },
    { L"Diana Win Portrait Punch Extra", 0x39e622, 0x39e642, indexKOF01Sprites_Kula, 0x41 },
    // You must reinsert above this after regenerating this header
    { L"Lifebar Portrait", 0x3b9022, 0x3b9042, indexKOF01Sprites_Kula, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b80a2, 0x3b80c2, indexKOF01Sprites_Kula, 0x61 },
};

const sGame_PaletteDataset KOF01_A_KULA_KICK_PALETTES[] =
{
    { L"Kula Kick", 0x38e322, 0x38e342, indexKOF01Sprites_Kula },
    { L"Character Extra 1", 0x38e342, 0x38e362, indexKOF01Sprites_Kula },
    { L"Character Extra 2", 0x38e362, 0x38e382, indexKOF01Sprites_Kula },
    { L"Electric Palette", 0x38e382, 0x38e3a2, indexKOF01Sprites_Kula },
    { L"Lin Poison Palette (Unused)", 0x38e3a2, 0x38e3c2, indexKOF01Sprites_Kula },
    { L"Freeze Palette (Unused)", 0x38e3c2, 0x38e3e2, indexKOF01Sprites_Kula },
    { L"Super Trail", 0x38e3e2, 0x38e402, indexKOF01Sprites_Kula },
    { L"Striker Portrait", 0x398dc2, 0x398de2, indexKOF01Sprites_Kula, 0x60 },
    { L"Order Select Portrait", 0x399a42, 0x399a62, indexKOF01Sprites_Kula, 0x44 },
    { L"Select/VS Portrait", 0x39c262, 0x39c2a2, indexKOF01Sprites_Kula, 0x42 },
    // You must reinsert below this after regenerating this header
    { L"Win Portrait", 0x39df62, 0x39dfa2, indexKOF01Sprites_Kula, 0x40, &pairNext },
    { L"Diana Win Portrait Kick Extra", 0x39e642, 0x39e662, indexKOF01Sprites_Kula, 0x41 },
    // You must reinsert above this after regenerating this header
    { L"Lifebar Portrait", 0x3b9042, 0x3b9062, indexKOF01Sprites_Kula, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b85a2, 0x3b85c2, indexKOF01Sprites_Kula, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_FOXY_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398e02, 0x398e22, indexKOF01Sprites_Foxy, 0x60 },
    { L"Order Select Portrait", 0x399a62, 0x399a82, indexKOF01Sprites_Foxy, 0x44 },
    { L"Select/VS Portrait", 0x39c362, 0x39c3a2, indexKOF01Sprites_Foxy, 0x42 },
    { L"Win Portrait", 0x39dfa2, 0x39dfe2, indexKOF01Sprites_Foxy, 0x40 },
    { L"Lifebar Portrait", 0x3b9062, 0x3b9082, indexKOF01Sprites_Foxy, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b80c2, 0x3b80e2, indexKOF01Sprites_Foxy, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_FOXY_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398e22, 0x398e42, indexKOF01Sprites_Foxy, 0x60 },
    { L"Order Select Portrait", 0x399a82, 0x399aa2, indexKOF01Sprites_Foxy, 0x44 },
    { L"Select/VS Portrait", 0x39c3a2, 0x39c3e2, indexKOF01Sprites_Foxy, 0x42 },
    { L"Win Portrait", 0x39dfe2, 0x39e022, indexKOF01Sprites_Foxy, 0x40 },
    { L"Lifebar Portrait", 0x3b9082, 0x3b90a2, indexKOF01Sprites_Foxy, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b85c2, 0x3b85e2, indexKOF01Sprites_Foxy, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_K9999_PUNCH_PALETTES[] =
{
    ...
    { L"Super Trail", 0x38e9e2, 0x38ea02, indexKOF01Sprites_K9999 },
    { L"Striker Portrait", 0x398e62, 0x398e82, indexKOF01Sprites_K9999, 0x60 },
    { L"Order Select Portrait", 0x399aa2, 0x399ac2, indexKOF01Sprites_K9999, 0x44 },
    { L"Select/VS Portrait", 0x39c4a2, 0x39c4e2, indexKOF01Sprites_K9999, 0x42 },
    { L"Win Portrait", 0x39e022, 0x39e062, indexKOF01Sprites_K9999, 0x40 },
    { L"Lifebar Portrait", 0x3b90a2, 0x3b90c2, indexKOF01Sprites_K9999, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b80e2, 0x3b8102, indexKOF01Sprites_K9999, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_K9999_KICK_PALETTES[] =
{
    ...
    { L"Super Trail", 0x38ebe2, 0x38ec02, indexKOF01Sprites_K9999 },
    { L"Striker Portrait", 0x398e82, 0x398ea2, indexKOF01Sprites_K9999, 0x60 },
    { L"Order Select Portrait", 0x399ac2, 0x399ae2, indexKOF01Sprites_K9999, 0x44 },
    { L"Select/VS Portrait", 0x39c4e2, 0x39c522, indexKOF01Sprites_K9999, 0x42 },
    { L"Win Portrait", 0x39e062, 0x39e0a2, indexKOF01Sprites_K9999, 0x40 },
    { L"Lifebar Portrait", 0x3b90c2, 0x3b90e2, indexKOF01Sprites_K9999, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b85e2, 0x3b8602, indexKOF01Sprites_K9999, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ANGEL_PUNCH_PALETTES[] =
{
    { L"Angel Punch", 0x38ed22, 0x38ed42, indexKOF01Sprites_Angel },
    { L"Character Extra 1", 0x38ed42, 0x38ed62, indexKOF01Sprites_Angel },
    { L"Character Extra 2", 0x38ed62, 0x38ed82, indexKOF01Sprites_Angel },
    { L"Electric Palette", 0x38ed82, 0x38eda2, indexKOF01Sprites_Angel },
    { L"Lin Poison Palette (Unused)", 0x38eda2, 0x38edc2, indexKOF01Sprites_Angel },
    { L"Freeze Palette (Unused)", 0x38edc2, 0x38ede2, indexKOF01Sprites_Angel },
    { L"Super Trail", 0x38ede2, 0x38ee02, indexKOF01Sprites_Angel },
    { L"Striker Portrait", 0x398ec2, 0x398ee2, indexKOF01Sprites_Angel, 0x60 },
    { L"Order Select Portrait", 0x399ae2, 0x399b02, indexKOF01Sprites_Angel, 0x44 },
    { L"Select/VS Portrait", 0x39c5e2, 0x39c622, indexKOF01Sprites_Angel, 0x42 },
    { L"Win Portrait", 0x39e0a2, 0x39e0e2, indexKOF01Sprites_Angel, 0x40 },
    { L"Lifebar Portrait", 0x3b90e2, 0x3b9102, indexKOF01Sprites_Angel, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8102, 0x3b8122, indexKOF01Sprites_Angel, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ANGEL_KICK_PALETTES[] =
{
    { L"Angel Kick", 0x38ef22, 0x38ef42, indexKOF01Sprites_Angel },
    { L"Character Extra 1", 0x38ef42, 0x38ef62, indexKOF01Sprites_Angel },
    { L"Character Extra 2", 0x38ef62, 0x38ef82, indexKOF01Sprites_Angel },
    { L"Electric Palette", 0x38ef82, 0x38efa2, indexKOF01Sprites_Angel },
    { L"Lin Poison Palette (Unused)", 0x38efa2, 0x38efc2, indexKOF01Sprites_Angel },
    { L"Freeze Palette (Unused)", 0x38efc2, 0x38efe2, indexKOF01Sprites_Angel },
    { L"Super Trail", 0x38efe2, 0x38f002, indexKOF01Sprites_Angel },
    { L"Striker Portrait", 0x398ee2, 0x398f02, indexKOF01Sprites_Angel, 0x60 },
    { L"Order Select Portrait", 0x399b02, 0x399b22, indexKOF01Sprites_Angel, 0x44 },
    { L"Select/VS Portrait", 0x39c622, 0x39c662, indexKOF01Sprites_Angel, 0x42 },
    { L"Win Portrait", 0x39e0e2, 0x39e122, indexKOF01Sprites_Angel, 0x40 },
    { L"Lifebar Portrait", 0x3b9102, 0x3b9122, indexKOF01Sprites_Angel, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8602, 0x3b8622, indexKOF01Sprites_Angel, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_ATHENA_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398f22, 0x398f42, indexKOF01Sprites_Athena, 0x60 },
    { L"Order Select Portrait", 0x399b22, 0x399b42, indexKOF01Sprites_Athena, 0x44 },
    { L"Select/VS Portrait", 0x39c722, 0x39c762, indexKOF01Sprites_Athena, 0x42 },
    { L"Win Portrait", 0x39e122, 0x39e162, indexKOF01Sprites_Athena, 0x40 },
    { L"Lifebar Portrait", 0x3b9122, 0x3b9142, indexKOF01Sprites_Athena, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8122, 0x3b8142, indexKOF01Sprites_Athena, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_ATHENA_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398f42, 0x398f62, indexKOF01Sprites_Athena, 0x60 },
    { L"Order Select Portrait", 0x399b42, 0x399b62, indexKOF01Sprites_Athena, 0x44 },
    { L"Select/VS Portrait", 0x39c762, 0x39c7a2, indexKOF01Sprites_Athena, 0x42 },
    { L"Win Portrait", 0x39e162, 0x39e1a2, indexKOF01Sprites_Athena, 0x40 },
    { L"Lifebar Portrait", 0x3b9142, 0x3b9162, indexKOF01Sprites_Athena, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8622, 0x3b8642, indexKOF01Sprites_Athena, 0x61 },
};

const sGame_PaletteDataset KOF01_A_KENSOU_PUNCH_PALETTES[] =
{
    { L"Kensou Punch", 0x38f522, 0x38f542, indexKOF01Sprites_Kensou },
    { L"Character Extra 1", 0x38f542, 0x38f562, indexKOF01Sprites_Kensou },
    { L"Character Extra 2", 0x38f562, 0x38f582, indexKOF01Sprites_Kensou },
    { L"Electric Palette", 0x38f582, 0x38f5a2, indexKOF01Sprites_Kensou },
    { L"Lin Poison Palette (Unused)", 0x38f5a2, 0x38f5c2, indexKOF01Sprites_Kensou },
    { L"Freeze Palette (Unused)", 0x38f5c2, 0x38f5e2, indexKOF01Sprites_Kensou },
    { L"Super Trail", 0x38f5e2, 0x38f602, indexKOF01Sprites_Kensou },
    { L"Striker Portrait", 0x398f82, 0x398fa2, indexKOF01Sprites_Kensou, 0x60 },
    { L"Order Select Portrait", 0x399b62, 0x399b82, indexKOF01Sprites_Kensou, 0x44 },
    { L"Select/VS Portrait", 0x39c862, 0x39c8a2, indexKOF01Sprites_Kensou, 0x42 },
    { L"Win Portrait", 0x39e1a2, 0x39e1e2, indexKOF01Sprites_Kensou, 0x40 },
    { L"Lifebar Portrait", 0x3b9162, 0x3b9182, indexKOF01Sprites_Kensou, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8142, 0x3b8162, indexKOF01Sprites_Kensou, 0x61 },
};

const sGame_PaletteDataset KOF01_A_KENSOU_KICK_PALETTES[] =
{
    { L"Kensou Kick", 0x38f722, 0x38f742, indexKOF01Sprites_Kensou },
    { L"Character Extra 1", 0x38f742, 0x38f762, indexKOF01Sprites_Kensou },
    { L"Character Extra 2", 0x38f762, 0x38f782, indexKOF01Sprites_Kensou },
    { L"Electric Palette", 0x38f782, 0x38f7a2, indexKOF01Sprites_Kensou },
    { L"Lin Poison Palette (Unused)", 0x38f7a2, 0x38f7c2, indexKOF01Sprites_Kensou },
    { L"Freeze Palette (Unused)", 0x38f7c2, 0x38f7e2, indexKOF01Sprites_Kensou },
    { L"Super Trail", 0x38f7e2, 0x38f802, indexKOF01Sprites_Kensou },
    { L"Striker Portrait", 0x398fa2, 0x398fc2, indexKOF01Sprites_Kensou, 0x60 },
    { L"Order Select Portrait", 0x399b82, 0x399ba2, indexKOF01Sprites_Kensou, 0x44 },
    { L"Select/VS Portrait", 0x39c8a2, 0x39c8e2, indexKOF01Sprites_Kensou, 0x42 },
    { L"Win Portrait", 0x39e1e2, 0x39e222, indexKOF01Sprites_Kensou, 0x40 },
    { L"Lifebar Portrait", 0x3b9182, 0x3b91a2, indexKOF01Sprites_Kensou, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8642, 0x3b8662, indexKOF01Sprites_Kensou, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_CHIN_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x398fe2, 0x399002, indexKOF01Sprites_Chin, 0x60 },
    ...
    { L"Win Portrait", 0x39e222, 0x39e262, indexKOF01Sprites_Chin, 0x40 },
    { L"Lifebar Portrait", 0x3b91a2, 0x3b91c2, indexKOF01Sprites_Chin, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8162, 0x3b8182, indexKOF01Sprites_Chin, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_CHIN_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x399002, 0x399022, indexKOF01Sprites_Chin, 0x60 },
    ...
    { L"Win Portrait", 0x39e262, 0x39e2a2, indexKOF01Sprites_Chin, 0x40 },
    { L"Lifebar Portrait", 0x3b91c2, 0x3b91e2, indexKOF01Sprites_Chin, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8662, 0x3b8682, indexKOF01Sprites_Chin, 0x61 },
};

const sGame_PaletteDataset KOF01_A_BAO_PUNCH_PALETTES[] =
{
    { L"Bao Punch", 0x38fd22, 0x38fd42, indexKOF01Sprites_Bao },
    { L"Character Extra 1", 0x38fd42, 0x38fd62, indexKOF01Sprites_Bao },
    { L"Character Extra 2", 0x38fd62, 0x38fd82, indexKOF01Sprites_Bao },
    { L"Electric Palette", 0x38fd82, 0x38fda2, indexKOF01Sprites_Bao },
    { L"Lin Poison Palette (Unused)", 0x38fda2, 0x38fdc2, indexKOF01Sprites_Bao },
    { L"Freeze Palette (Unused)", 0x38fdc2, 0x38fde2, indexKOF01Sprites_Bao },
    { L"Super Trail", 0x38fde2, 0x38fe02, indexKOF01Sprites_Bao },
    { L"Striker Portrait", 0x399042, 0x399062, indexKOF01Sprites_Bao, 0x60 },
    { L"Order Select Portrait", 0x399be2, 0x399c02, indexKOF01Sprites_Bao, 0x44 },
    { L"Select/VS Portrait", 0x39cae2, 0x39cb22, indexKOF01Sprites_Bao, 0x42 },
    { L"Win Portrait", 0x39e2a2, 0x39e2e2, indexKOF01Sprites_Bao, 0x40 },
    { L"Lifebar Portrait", 0x3b91e2, 0x3b9202, indexKOF01Sprites_Bao, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8182, 0x3b81a2, indexKOF01Sprites_Bao, 0x61 },
};

const sGame_PaletteDataset KOF01_A_BAO_KICK_PALETTES[] =
{
    { L"Bao Kick", 0x38ff22, 0x38ff42, indexKOF01Sprites_Bao },
    { L"Character Extra 1", 0x38ff42, 0x38ff62, indexKOF01Sprites_Bao },
    { L"Character Extra 2", 0x38ff62, 0x38ff82, indexKOF01Sprites_Bao },
    { L"Electric Palette", 0x38ff82, 0x38ffa2, indexKOF01Sprites_Bao },
    { L"Lin Poison Palette (Unused)", 0x38ffa2, 0x38ffc2, indexKOF01Sprites_Bao },
    { L"Freeze Palette (Unused)", 0x38ffc2, 0x38ffe2, indexKOF01Sprites_Bao },
    { L"Super Trail", 0x38ffe2, 0x390002, indexKOF01Sprites_Bao },
    { L"Striker Portrait", 0x399062, 0x399082, indexKOF01Sprites_Bao, 0x60 },
    { L"Order Select Portrait", 0x399c02, 0x399c22, indexKOF01Sprites_Bao, 0x44 },
    { L"Select/VS Portrait", 0x39cb22, 0x39cb62, indexKOF01Sprites_Bao, 0x42 },
    { L"Win Portrait", 0x39e2e2, 0x39e322, indexKOF01Sprites_Bao, 0x40 },
    { L"Lifebar Portrait", 0x3b9202, 0x3b9222, indexKOF01Sprites_Bao, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8682, 0x3b86a2, indexKOF01Sprites_Bao, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_KIM_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3990a2, 0x3990c2, indexKOF01Sprites_Kim, 0x60 },
    ...
    { L"Win Portrait", 0x39e322, 0x39e362, indexKOF01Sprites_Kim, 0x40 },
    { L"Lifebar Portrait", 0x3b9222, 0x3b9242, indexKOF01Sprites_Kim, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b81a2, 0x3b81c2, indexKOF01Sprites_Kim, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_KIM_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x3990c2, 0x3990e2, indexKOF01Sprites_Kim, 0x60 },
    ...
    { L"Win Portrait", 0x39e362, 0x39e3a2, indexKOF01Sprites_Kim, 0x40 },
    { L"Lifebar Portrait", 0x3b9242, 0x3b9262, indexKOF01Sprites_Kim, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b86a2, 0x3b86c2, indexKOF01Sprites_Kim, 0x61 },
};

const sGame_PaletteDataset KOF01_A_CHANG_PUNCH_PALETTES[] =
{
    { L"Chang Punch", 0x390522, 0x390542, indexKOF01Sprites_Chang },
    { L"Character Extra 1", 0x390542, 0x390562, indexKOF01Sprites_Chang },
    { L"Character Extra 2", 0x390562, 0x390582, indexKOF01Sprites_Chang },
    { L"Electric Palette", 0x390582, 0x3905a2, indexKOF01Sprites_Chang },
    { L"Lin Poison Palette (Unused)", 0x3905a2, 0x3905c2, indexKOF01Sprites_Chang },
    { L"Freeze Palette (Unused)", 0x3905c2, 0x3905e2, indexKOF01Sprites_Chang },
    { L"Super Trail", 0x3905e2, 0x390602, indexKOF01Sprites_Chang },
    { L"Striker Portrait", 0x399102, 0x399122, indexKOF01Sprites_Chang, 0x60 },
    { L"Order Select Portrait", 0x399c62, 0x399c82, indexKOF01Sprites_Chang, 0x44 },
    { L"Select/VS Portrait", 0x39cd62, 0x39cda2, indexKOF01Sprites_Chang, 0x42 },
    { L"Win Portrait", 0x39e3a2, 0x39e3e2, indexKOF01Sprites_Chang, 0x40 },
    { L"Lifebar Portrait", 0x3b9262, 0x3b9282, indexKOF01Sprites_Chang, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b81c2, 0x3b81e2, indexKOF01Sprites_Chang, 0x61 },
};

const sGame_PaletteDataset KOF01_A_CHANG_KICK_PALETTES[] =
{
    { L"Chang Kick", 0x390722, 0x390742, indexKOF01Sprites_Chang },
    { L"Character Extra 1", 0x390742, 0x390762, indexKOF01Sprites_Chang },
    { L"Character Extra 2", 0x390762, 0x390782, indexKOF01Sprites_Chang },
    { L"Electric Palette", 0x390782, 0x3907a2, indexKOF01Sprites_Chang },
    { L"Lin Poison Palette (Unused)", 0x3907a2, 0x3907c2, indexKOF01Sprites_Chang },
    { L"Freeze Palette (Unused)", 0x3907c2, 0x3907e2, indexKOF01Sprites_Chang },
    { L"Super Trail", 0x3907e2, 0x390802, indexKOF01Sprites_Chang },
    { L"Striker Portrait", 0x399122, 0x399142, indexKOF01Sprites_Chang, 0x60 },
    { L"Order Select Portrait", 0x399c82, 0x399ca2, indexKOF01Sprites_Chang, 0x44 },
    { L"Select/VS Portrait", 0x39cda2, 0x39cde2, indexKOF01Sprites_Chang, 0x42 },
    { L"Win Portrait", 0x39e3e2, 0x39e422, indexKOF01Sprites_Chang, 0x40 },
    { L"Lifebar Portrait", 0x3b9282, 0x3b92a2, indexKOF01Sprites_Chang, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b86c2, 0x3b86e2, indexKOF01Sprites_Chang, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_CHOI_PUNCH_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x399162, 0x399182, indexKOF01Sprites_Choi, 0x60 },
    ...
    { L"Win Portrait", 0x39e422, 0x39e462, indexKOF01Sprites_Choi, 0x40 },
    { L"Lifebar Portrait", 0x3b92a2, 0x3b92c2, indexKOF01Sprites_Choi, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b81e2, 0x3b8202, indexKOF01Sprites_Choi, 0x61 },
};
...
const sGame_PaletteDataset KOF01_A_CHOI_KICK_PALETTES[] =
{
    ...
    { L"Striker Portrait", 0x399182, 0x3991a2, indexKOF01Sprites_Choi, 0x60 },
    ...
    { L"Win Portrait", 0x39e462, 0x39e4a2, indexKOF01Sprites_Choi, 0x40 },
    { L"Lifebar Portrait", 0x3b92c2, 0x3b92e2, indexKOF01Sprites_Choi, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b86e2, 0x3b8702, indexKOF01Sprites_Choi, 0x61 },
};

const sGame_PaletteDataset KOF01_A_MAYLEE_PUNCH_PALETTES[] =
{
    { L"May Lee Punch", 0x390d22, 0x390d42, indexKOF01Sprites_MayLee },
    { L"Character Extra 1", 0x390d42, 0x390d62, indexKOF01Sprites_MayLee },
    { L"Character Extra 2", 0x390d62, 0x390d82, indexKOF01Sprites_MayLee },
    { L"Electric Palette", 0x390d82, 0x390da2, indexKOF01Sprites_MayLee },
    { L"Lin Poison Palette (Unused)", 0x390da2, 0x390dc2, indexKOF01Sprites_MayLee },
    { L"Freeze Palette (Unused)", 0x390dc2, 0x390de2, indexKOF01Sprites_MayLee },
    { L"Super Trail", 0x390de2, 0x390e02, indexKOF01Sprites_MayLee },
    { L"Striker Portrait", 0x3991c2, 0x3991e2, indexKOF01Sprites_MayLee, 0x60 },
    { L"Order Select Portrait", 0x399ce2, 0x399d02, indexKOF01Sprites_MayLee, 0x44 },
    { L"Select/VS Portrait", 0x39cfe2, 0x39d022, indexKOF01Sprites_MayLee, 0x42 },
    { L"Win Portrait", 0x39e4a2, 0x39e4e2, indexKOF01Sprites_MayLee, 0x40 },
    { L"Lifebar Portrait", 0x3b92e2, 0x3b9302, indexKOF01Sprites_MayLee, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8202, 0x3b8222, indexKOF01Sprites_MayLee, 0x61 },
};

const sGame_PaletteDataset KOF01_A_MAYLEE_KICK_PALETTES[] =
{
    { L"May Lee Kick", 0x390f22, 0x390f42, indexKOF01Sprites_MayLee },
    { L"Character Extra 1", 0x390f42, 0x390f62, indexKOF01Sprites_MayLee },
    { L"Character Extra 2", 0x390f62, 0x390f82, indexKOF01Sprites_MayLee },
    { L"Electric Palette", 0x390f82, 0x390fa2, indexKOF01Sprites_MayLee },
    { L"Lin Poison Palette (Unused)", 0x390fa2, 0x390fc2, indexKOF01Sprites_MayLee },
    { L"Freeze Palette (Unused)", 0x390fc2, 0x390fe2, indexKOF01Sprites_MayLee },
    { L"Super Trail", 0x390fe2, 0x391002, indexKOF01Sprites_MayLee },
    { L"Striker Portrait", 0x3991e2, 0x399202, indexKOF01Sprites_MayLee, 0x60 },
    { L"Order Select Portrait", 0x399d02, 0x399d22, indexKOF01Sprites_MayLee, 0x44 },
    { L"Select/VS Portrait", 0x39d022, 0x39d062, indexKOF01Sprites_MayLee, 0x42 },
    { L"Win Portrait", 0x39e4e2, 0x39e522, indexKOF01Sprites_MayLee, 0x40 },
    { L"Lifebar Portrait", 0x3b9302, 0x3b9322, indexKOF01Sprites_MayLee, 0x43 },
    { L"Next Character Lifebar Portrait", 0x3b8702, 0x3b8722, indexKOF01Sprites_MayLee, 0x61 },
};

const sGame_PaletteDataset KOF01_A_ZERO_PUNCH_PALETTES[] =
{
    { L"Zero Punch", 0x391122, 0x391142, indexKOF01Sprites_Zero },
    { L"Character Extra 1", 0x391142, 0x391162, indexKOF01Sprites_Zero },
    { L"Character Extra 2", 0x391162, 0x391182, indexKOF01Sprites_Zero },
    { L"Electric Palette", 0x391182, 0x3911a2, indexKOF01Sprites_Zero },
    { L"Lin Poison Palette (Unused)", 0x3911a2, 0x3911c2, indexKOF01Sprites_Zero },
    { L"Freeze Palette (Unused)", 0x3911c2, 0x3911e2, indexKOF01Sprites_Zero },
    { L"Super Trail", 0x3911e2, 0x391202, indexKOF01Sprites_Zero },
    { L"Order Select Portrait", 0x399d22, 0x399d42, indexKOF01Sprites_Zero, 0x44 },
    { L"Win Portrait", 0x39e522, 0x39e562, indexKOF01Sprites_Zero, 0x40 },
    { L"Lifebar Portrait", 0x3b9322, 0x3b9342, indexKOF01Sprites_Zero, 0x43 },
};

const sGame_PaletteDataset KOF01_A_ZERO_KICK_PALETTES[] =
{
    { L"Zero Kick", 0x391322, 0x391342, indexKOF01Sprites_Zero },
    { L"Character Extra 1", 0x391342, 0x391362, indexKOF01Sprites_Zero },
    { L"Character Extra 2", 0x391362, 0x391382, indexKOF01Sprites_Zero },
    { L"Electric Palette", 0x391382, 0x3913a2, indexKOF01Sprites_Zero },
    { L"Lin Poison Palette (Unused)", 0x3913a2, 0x3913c2, indexKOF01Sprites_Zero },
    { L"Freeze Palette (Unused)", 0x3913c2, 0x3913e2, indexKOF01Sprites_Zero },
    { L"Super Trail", 0x3913e2, 0x391402, indexKOF01Sprites_Zero },
    { L"Order Select Portrait", 0x399d42, 0x399d62, indexKOF01Sprites_Zero, 0x44 },
    { L"Win Portrait", 0x39e562, 0x39e5a2, indexKOF01Sprites_Zero, 0x40 },
    { L"Lifebar Portrait", 0x3b9342, 0x3b9362, indexKOF01Sprites_Zero, 0x43 },
};

const sGame_PaletteDataset KOF01_A_IGNIZ_PUNCH_PALETTES[] =
{
    { L"Igniz Punch", 0x391522, 0x391542, indexKOF01Sprites_Igniz },
    { L"Character Extra 1", 0x391542, 0x391562, indexKOF01Sprites_Igniz },
    { L"Character Extra 2", 0x391562, 0x391582, indexKOF01Sprites_Igniz },
    { L"Electric Palette", 0x391582, 0x3915a2, indexKOF01Sprites_Igniz },
    { L"Lin Poison Palette (Unused)", 0x3915a2, 0x3915c2, indexKOF01Sprites_Igniz },
    { L"Freeze Palette (Unused)", 0x3915c2, 0x3915e2, indexKOF01Sprites_Igniz },
    { L"Super Trail", 0x3915e2, 0x391602, indexKOF01Sprites_Igniz },
    { L"Order Select Portrait", 0x399d62, 0x399d82, indexKOF01Sprites_Igniz, 0x44 },
    { L"Win Portrait", 0x39e5a2, 0x39e5e2, indexKOF01Sprites_Igniz, 0x40 },
    { L"Lifebar Portrait", 0x3b9362, 0x3b9382, indexKOF01Sprites_Igniz, 0x43 },
};

const sGame_PaletteDataset KOF01_A_IGNIZ_KICK_PALETTES[] =
{
    { L"Igniz Kick", 0x391722, 0x391742, indexKOF01Sprites_Igniz },
    { L"Character Extra 1", 0x391742, 0x391762, indexKOF01Sprites_Igniz },
    { L"Character Extra 2", 0x391762, 0x391782, indexKOF01Sprites_Igniz },
    { L"Electric Palette", 0x391782, 0x3917a2, indexKOF01Sprites_Igniz },
    { L"Lin Poison Palette (Unused)", 0x3917a2, 0x3917c2, indexKOF01Sprites_Igniz },
    { L"Freeze Palette (Unused)", 0x3917c2, 0x3917e2, indexKOF01Sprites_Igniz },
    { L"Super Trail", 0x3917e2, 0x391802, indexKOF01Sprites_Igniz },
    { L"Order Select Portrait", 0x399d82, 0x399da2, indexKOF01Sprites_Igniz, 0x44 },
    { L"Win Portrait", 0x39e5e2, 0x39e622, indexKOF01Sprites_Igniz, 0x40 },
    { L"Lifebar Portrait", 0x3b9382, 0x3b93a2, indexKOF01Sprites_Igniz, 0x43 },
};

const sGame_PaletteDataset KOF01_A_K_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x399fa2, 0x399fe2, indexKOF01Sprites_K, 0x62 },
    { L"Win Portrait Assist 2", 0x399fe2, 0x39a022, indexKOF01Sprites_K, 0x62 },
    { L"Win Portrait Assist 3", 0x39a022, 0x39a062, indexKOF01Sprites_K, 0x62 },
};

const sGame_PaletteDataset KOF01_A_MAXIMA_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a0e2, 0x39a122, indexKOF01Sprites_Maxima, 0x62 },
    { L"Win Portrait Assist 2", 0x39a122, 0x39a162, indexKOF01Sprites_Maxima, 0x62 },
    { L"Win Portrait Assist 3", 0x39a162, 0x39a1a2, indexKOF01Sprites_Maxima, 0x62 },
};

const sGame_PaletteDataset KOF01_A_WHIP_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a222, 0x39a262, indexKOF01Sprites_Whip, 0x62 },
    { L"Win Portrait Assist 2", 0x39a262, 0x39a2a2, indexKOF01Sprites_Whip, 0x62 },
    { L"Win Portrait Assist 3", 0x39a2a2, 0x39a2e2, indexKOF01Sprites_Whip, 0x62 },
};

const sGame_PaletteDataset KOF01_A_LIN_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a362, 0x39a3a2, indexKOF01Sprites_Lin, 0x62 },
    { L"Win Portrait Assist 2", 0x39a3a2, 0x39a3e2, indexKOF01Sprites_Lin, 0x62 },
    { L"Win Portrait Assist 3", 0x39a3e2, 0x39a422, indexKOF01Sprites_Lin, 0x62 },
};

const sGame_PaletteDataset KOF01_A_KYO_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a4a2, 0x39a4e2, indexKOF01Sprites_Kyo, 0x62 },
    { L"Win Portrait Assist 2", 0x39a4e2, 0x39a522, indexKOF01Sprites_Kyo, 0x62 },
    { L"Win Portrait Assist 3", 0x39a522, 0x39a562, indexKOF01Sprites_Kyo, 0x62 },
};

const sGame_PaletteDataset KOF01_A_BENIMARU_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a5e2, 0x39a622, indexKOF01Sprites_Benimaru, 0x62 },
    { L"Win Portrait Assist 2", 0x39a622, 0x39a662, indexKOF01Sprites_Benimaru, 0x62 },
    { L"Win Portrait Assist 3", 0x39a662, 0x39a6a2, indexKOF01Sprites_Benimaru, 0x62 },
};

const sGame_PaletteDataset KOF01_A_GORO_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a722, 0x39a762, indexKOF01Sprites_Goro, 0x62 },
    { L"Win Portrait Assist 2", 0x39a762, 0x39a7a2, indexKOF01Sprites_Goro, 0x62 },
    { L"Win Portrait Assist 3", 0x39a7a2, 0x39a7e2, indexKOF01Sprites_Goro, 0x62 },
};

const sGame_PaletteDataset KOF01_A_SHINGO_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a862, 0x39a8a2, indexKOF01Sprites_Shingo, 0x62 },
    { L"Win Portrait Assist 2", 0x39a8a2, 0x39a8e2, indexKOF01Sprites_Shingo, 0x62 },
    { L"Win Portrait Assist 3", 0x39a8e2, 0x39a922, indexKOF01Sprites_Shingo, 0x62 },
};

const sGame_PaletteDataset KOF01_A_IORI_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39a9a2, 0x39a9e2, indexKOF01Sprites_Iori, 0x62 },
    { L"Win Portrait Assist 2", 0x39a9e2, 0x39aa22, indexKOF01Sprites_Iori, 0x62 },
    { L"Win Portrait Assist 3", 0x39aa22, 0x39aa62, indexKOF01Sprites_Iori, 0x62 },
};

const sGame_PaletteDataset KOF01_A_VANESSA_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39aae2, 0x39ab22, indexKOF01Sprites_Vanessa, 0x62 },
    { L"Win Portrait Assist 2", 0x39ab22, 0x39ab62, indexKOF01Sprites_Vanessa, 0x62 },
    { L"Win Portrait Assist 3", 0x39ab62, 0x39aba2, indexKOF01Sprites_Vanessa, 0x62 },
};

const sGame_PaletteDataset KOF01_A_SETH_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39ac22, 0x39ac62, indexKOF01Sprites_Seth, 0x62 },
    { L"Win Portrait Assist 2", 0x39ac62, 0x39aca2, indexKOF01Sprites_Seth, 0x62 },
    { L"Win Portrait Assist 3", 0x39aca2, 0x39ace2, indexKOF01Sprites_Seth, 0x62 },
};

const sGame_PaletteDataset KOF01_A_RAMON_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39ad62, 0x39ada2, indexKOF01Sprites_Ramon, 0x62 },
    { L"Win Portrait Assist 2", 0x39ada2, 0x39ade2, indexKOF01Sprites_Ramon, 0x62 },
    { L"Win Portrait Assist 3", 0x39ade2, 0x39ae22, indexKOF01Sprites_Ramon, 0x62 },
};

const sGame_PaletteDataset KOF01_A_LEONA_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39aea2, 0x39aee2, indexKOF01Sprites_Leona, 0x62 },
    { L"Win Portrait Assist 2", 0x39aee2, 0x39af22, indexKOF01Sprites_Leona, 0x62 },
    { L"Win Portrait Assist 3", 0x39af22, 0x39af62, indexKOF01Sprites_Leona, 0x62 },
};

const sGame_PaletteDataset KOF01_A_RALF_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39afe2, 0x39b022, indexKOF01Sprites_Ralf, 0x62 },
    { L"Win Portrait Assist 2", 0x39b022, 0x39b062, indexKOF01Sprites_Ralf, 0x62 },
    { L"Win Portrait Assist 3", 0x39b062, 0x39b0a2, indexKOF01Sprites_Ralf, 0x62 },
};

const sGame_PaletteDataset KOF01_A_CLARK_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b122, 0x39b162, indexKOF01Sprites_Clark, 0x62 },
    { L"Win Portrait Assist 2", 0x39b162, 0x39b1a2, indexKOF01Sprites_Clark, 0x62 },
    { L"Win Portrait Assist 3", 0x39b1a2, 0x39b1e2, indexKOF01Sprites_Clark, 0x62 },
};

const sGame_PaletteDataset KOF01_A_HEIDERN_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b262, 0x39b2a2, indexKOF01Sprites_Heidern, 0x62 },
    { L"Win Portrait Assist 2", 0x39b2a2, 0x39b2e2, indexKOF01Sprites_Heidern, 0x62 },
    { L"Win Portrait Assist 3", 0x39b2e2, 0x39b322, indexKOF01Sprites_Heidern, 0x62 },
};

const sGame_PaletteDataset KOF01_A_TERRY_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b3a2, 0x39b3e2, indexKOF01Sprites_Terry, 0x62 },
    { L"Win Portrait Assist 2", 0x39b3e2, 0x39b422, indexKOF01Sprites_Terry, 0x62 },
    { L"Win Portrait Assist 3", 0x39b422, 0x39b462, indexKOF01Sprites_Terry, 0x62 },
};

const sGame_PaletteDataset KOF01_A_ANDY_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b4e2, 0x39b522, indexKOF01Sprites_Andy, 0x62 },
    { L"Win Portrait Assist 2", 0x39b522, 0x39b562, indexKOF01Sprites_Andy, 0x62 },
    { L"Win Portrait Assist 3", 0x39b562, 0x39b5a2, indexKOF01Sprites_Andy, 0x62 },
};

const sGame_PaletteDataset KOF01_A_JOE_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b622, 0x39b662, indexKOF01Sprites_Joe, 0x62 },
    { L"Win Portrait Assist 2", 0x39b662, 0x39b6a2, indexKOF01Sprites_Joe, 0x62 },
    { L"Win Portrait Assist 3", 0x39b6a2, 0x39b6e2, indexKOF01Sprites_Joe, 0x62 },
};

const sGame_PaletteDataset KOF01_A_MARY_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b762, 0x39b7a2, indexKOF01Sprites_Mary, 0x62 },
    { L"Win Portrait Assist 2", 0x39b7a2, 0x39b7e2, indexKOF01Sprites_Mary, 0x62 },
    { L"Win Portrait Assist 3", 0x39b7e2, 0x39b822, indexKOF01Sprites_Mary, 0x62 },
};

const sGame_PaletteDataset KOF01_A_RYO_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b8a2, 0x39b8e2, indexKOF01Sprites_Ryo, 0x62 },
    { L"Win Portrait Assist 2", 0x39b8e2, 0x39b922, indexKOF01Sprites_Ryo, 0x62 },
    { L"Win Portrait Assist 3", 0x39b922, 0x39b962, indexKOF01Sprites_Ryo, 0x62 },
};

const sGame_PaletteDataset KOF01_A_ROBERT_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39b9e2, 0x39ba22, indexKOF01Sprites_Robert, 0x62 },
    { L"Win Portrait Assist 2", 0x39ba22, 0x39ba62, indexKOF01Sprites_Robert, 0x62 },
    { L"Win Portrait Assist 3", 0x39ba62, 0x39baa2, indexKOF01Sprites_Robert, 0x62 },
};

const sGame_PaletteDataset KOF01_A_YURI_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39bb22, 0x39bb62, indexKOF01Sprites_Yuri, 0x62 },
    { L"Win Portrait Assist 2", 0x39bb62, 0x39bba2, indexKOF01Sprites_Yuri, 0x62 },
    { L"Win Portrait Assist 3", 0x39bba2, 0x39bbe2, indexKOF01Sprites_Yuri, 0x62 },
};

const sGame_PaletteDataset KOF01_A_TAKUMA_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39bc62, 0x39bca2, indexKOF01Sprites_Takuma, 0x62 },
    { L"Win Portrait Assist 2", 0x39bca2, 0x39bce2, indexKOF01Sprites_Takuma, 0x62 },
    { L"Win Portrait Assist 3", 0x39bce2, 0x39bd22, indexKOF01Sprites_Takuma, 0x62 },
};

const sGame_PaletteDataset KOF01_A_KING_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39bda2, 0x39bde2, indexKOF01Sprites_King, 0x62 },
    { L"Win Portrait Assist 2", 0x39bde2, 0x39be22, indexKOF01Sprites_King, 0x62 },
    { L"Win Portrait Assist 3", 0x39be22, 0x39be62, indexKOF01Sprites_King, 0x62 },
};

const sGame_PaletteDataset KOF01_A_MAI_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39bee2, 0x39bf22, indexKOF01Sprites_Mai, 0x62 },
    { L"Win Portrait Assist 2", 0x39bf22, 0x39bf62, indexKOF01Sprites_Mai, 0x62 },
    { L"Win Portrait Assist 3", 0x39bf62, 0x39bfa2, indexKOF01Sprites_Mai, 0x62 },
};

const sGame_PaletteDataset KOF01_A_HINAKO_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c022, 0x39c062, indexKOF01Sprites_Hinako, 0x62 },
    { L"Win Portrait Assist 2", 0x39c062, 0x39c0a2, indexKOF01Sprites_Hinako, 0x62 },
    { L"Win Portrait Assist 3", 0x39c0a2, 0x39c0e2, indexKOF01Sprites_Hinako, 0x62 },
};

const sGame_PaletteDataset KOF01_A_XIANGFEI_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c162, 0x39c1a2, indexKOF01Sprites_Xiangfei, 0x62 },
    { L"Win Portrait Assist 2", 0x39c1a2, 0x39c1e2, indexKOF01Sprites_Xiangfei, 0x62 },
    { L"Win Portrait Assist 3", 0x39c1e2, 0x39c222, indexKOF01Sprites_Xiangfei, 0x62 },
};

const sGame_PaletteDataset KOF01_A_KULA_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c2a2, 0x39c2e2, indexKOF01Sprites_Kula, 0x62 },
    { L"Win Portrait Assist 2", 0x39c2e2, 0x39c322, indexKOF01Sprites_Kula, 0x62 },
    { L"Win Portrait Assist 3", 0x39c322, 0x39c362, indexKOF01Sprites_Kula, 0x62 },
};

const sGame_PaletteDataset KOF01_A_FOXY_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c3e2, 0x39c422, indexKOF01Sprites_Foxy, 0x62 },
    { L"Win Portrait Assist 2", 0x39c422, 0x39c462, indexKOF01Sprites_Foxy, 0x62 },
    { L"Win Portrait Assist 3", 0x39c462, 0x39c4a2, indexKOF01Sprites_Foxy, 0x62 },
};

const sGame_PaletteDataset KOF01_A_K9999_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c522, 0x39c562, indexKOF01Sprites_K9999, 0x62 },
    { L"Win Portrait Assist 2", 0x39c562, 0x39c5a2, indexKOF01Sprites_K9999, 0x62 },
    { L"Win Portrait Assist 3", 0x39c5a2, 0x39c5e2, indexKOF01Sprites_K9999, 0x62 },
};

const sGame_PaletteDataset KOF01_A_ANGEL_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c662, 0x39c6a2, indexKOF01Sprites_Angel, 0x62 },
    { L"Win Portrait Assist 2", 0x39c6a2, 0x39c6e2, indexKOF01Sprites_Angel, 0x62 },
    { L"Win Portrait Assist 3", 0x39c6e2, 0x39c722, indexKOF01Sprites_Angel, 0x62 },
};

const sGame_PaletteDataset KOF01_A_ATHENA_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c7a2, 0x39c7e2, indexKOF01Sprites_Athena, 0x62 },
    { L"Win Portrait Assist 2", 0x39c7e2, 0x39c822, indexKOF01Sprites_Athena, 0x62 },
    { L"Win Portrait Assist 3", 0x39c822, 0x39c862, indexKOF01Sprites_Athena, 0x62 },
};

const sGame_PaletteDataset KOF01_A_KENSOU_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39c8e2, 0x39c922, indexKOF01Sprites_Kensou, 0x62 },
    { L"Win Portrait Assist 2", 0x39c922, 0x39c962, indexKOF01Sprites_Kensou, 0x62 },
    { L"Win Portrait Assist 3", 0x39c962, 0x39c9a2, indexKOF01Sprites_Kensou, 0x62 },
};

const sGame_PaletteDataset KOF01_A_CHIN_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39ca22, 0x39ca62, indexKOF01Sprites_Chin, 0x62 },
    { L"Win Portrait Assist 2", 0x39ca62, 0x39caa2, indexKOF01Sprites_Chin, 0x62 },
    { L"Win Portrait Assist 3", 0x39caa2, 0x39cae2, indexKOF01Sprites_Chin, 0x62 },
};

const sGame_PaletteDataset KOF01_A_BAO_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39cb62, 0x39cba2, indexKOF01Sprites_Bao, 0x62 },
    { L"Win Portrait Assist 2", 0x39cba2, 0x39cbe2, indexKOF01Sprites_Bao, 0x62 },
    { L"Win Portrait Assist 3", 0x39cbe2, 0x39cc22, indexKOF01Sprites_Bao, 0x62 },
};

const sGame_PaletteDataset KOF01_A_KIM_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39cca2, 0x39cce2, indexKOF01Sprites_Kim, 0x62 },
    { L"Win Portrait Assist 2", 0x39cce2, 0x39cd22, indexKOF01Sprites_Kim, 0x62 },
    { L"Win Portrait Assist 3", 0x39cd22, 0x39cd62, indexKOF01Sprites_Kim, 0x62 },
};

const sGame_PaletteDataset KOF01_A_CHANG_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39cde2, 0x39ce22, indexKOF01Sprites_Chang, 0x62 },
    { L"Win Portrait Assist 2", 0x39ce22, 0x39ce62, indexKOF01Sprites_Chang, 0x62 },
    { L"Win Portrait Assist 3", 0x39ce62, 0x39cea2, indexKOF01Sprites_Chang, 0x62 },
};

const sGame_PaletteDataset KOF01_A_CHOI_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39cf22, 0x39cf62, indexKOF01Sprites_Choi, 0x62 },
    { L"Win Portrait Assist 2", 0x39cf62, 0x39cfa2, indexKOF01Sprites_Choi, 0x62 },
    { L"Win Portrait Assist 3", 0x39cfa2, 0x39cfe2, indexKOF01Sprites_Choi, 0x62 },
};

const sGame_PaletteDataset KOF01_A_MAYLEE_WINPORTRAIT_PALETTES[] =
{
    { L"Win Portrait Assist 1", 0x39d062, 0x39d0a2, indexKOF01Sprites_MayLee, 0x62 },
    { L"Win Portrait Assist 2", 0x39d0a2, 0x39d0e2, indexKOF01Sprites_MayLee, 0x62 },
    { L"Win Portrait Assist 3", 0x39d0e2, 0x39d122, indexKOF01Sprites_MayLee, 0x62 },
};
...
const sDescTreeNode KOF01_A_ZERO_STRIKER_COLLECTION[] =
{
    { L"Strikers", DESC_NODETYPE_TREE, (void*)KOF01_A_ZERO_STRIKER_PALETTES, ARRAYSIZE(KOF01_A_ZERO_STRIKER_PALETTES) },
    { L"Portraits", DESC_NODETYPE_TREE, (void*)KOF01_A_ZERO_STRIKER_PORTRAIT_PALETTES, ARRAYSIZE(KOF01_A_ZERO_STRIKER_PORTRAIT_PALETTES) },
};
...
const sDescTreeNode KOF01_A_UNITS[] =
{
    ...
    { L"Zero Strikers",     DESC_NODETYPE_TREE, (void*)KOF01_A_ZERO_STRIKER_COLLECTION, ARRAYSIZE(KOF01_A_ZERO_STRIKER_COLLECTION) },
