...
const sGame_PaletteDataset KOF01_A_K_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x399f22, 0x399f62, indexKOF01Sprites_K, 0x42 },
...
const sGame_PaletteDataset KOF01_A_K_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x399f62, 0x399fa2, indexKOF01Sprites_K, 0x42 },
...
const sGame_PaletteDataset KOF01_A_MAXIMA_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a062, 0x39a0a2, indexKOF01Sprites_Maxima, 0x42 },
...
const sGame_PaletteDataset KOF01_A_MAXIMA_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a0a2, 0x39a0e2, indexKOF01Sprites_Maxima, 0x42 },
...
const sGame_PaletteDataset KOF01_A_WHIP_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a1a2, 0x39a1e2, indexKOF01Sprites_Whip, 0x42 },
...
const sGame_PaletteDataset KOF01_A_WHIP_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a1e2, 0x39a222, indexKOF01Sprites_Whip, 0x42 },
...
{
    { L"Lin Punch", 0x387d22, 0x387d42, indexKOF02UMSprites_Lin },
    { L"Character Extra 1", 0x387d42, 0x387d62, indexKOF02UMSprites_Lin },
    { L"Character Extra 2", 0x387d62, 0x387d82, indexKOF02UMSprites_Lin },
    { L"Electric Palette", 0x387d82, 0x387da2, indexKOF02UMSprites_Lin },
    { L"Lin Poison Palette (Unused)", 0x387da2, 0x387dc2, indexKOF02UMSprites_Lin },
    { L"Freeze Palette (Unused)", 0x387dc2, 0x387de2, indexKOF02UMSprites_Lin },
    { L"Super Trail", 0x387de2, 0x387e02, indexKOF02UMSprites_Lin },
    { L"Striker Portrait", 0x398442, 0x398462 },
    { L"Order Select Portrait", 0x3993e2, 0x399402, indexKOF01Sprites_Lin, 0x44 },
    { L"Select Portrait", 0x39a2e2, 0x39a322, indexKOF01Sprites_Lin, 0x42 },
...
{
    { L"Lin Kick", 0x387f22, 0x387f42, indexKOF02UMSprites_Lin },
    { L"Character Extra 1", 0x387f42, 0x387f62, indexKOF02UMSprites_Lin },
    { L"Character Extra 2", 0x387f62, 0x387f82, indexKOF02UMSprites_Lin },
    { L"Electric Palette", 0x387f82, 0x387fa2, indexKOF02UMSprites_Lin },
    { L"Lin Poison Palette (Unused)", 0x387fa2, 0x387fc2, indexKOF02UMSprites_Lin },
    { L"Freeze Palette (Unused)", 0x387fc2, 0x387fe2, indexKOF02UMSprites_Lin },
    { L"Super Trail", 0x387fe2, 0x388002, indexKOF02UMSprites_Lin },
    { L"Striker Portrait", 0x398462, 0x398482 },
    { L"Order Select Portrait", 0x399402, 0x399422, indexKOF01Sprites_Lin, 0x44 },
    { L"Select Portrait", 0x39a322, 0x39a362, indexKOF01Sprites_Lin, 0x42 },
...
const sGame_PaletteDataset KOF01_A_KYO_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a422, 0x39a462, indexKOF01Sprites_Kyo, 0x42 },
...
const sGame_PaletteDataset KOF01_A_KYO_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a462, 0x39a4a2, indexKOF01Sprites_Kyo, 0x42 },
...
{
    { L"Benimaru Punch", 0x388522, 0x388542, indexKOF02UMSprites_Benimaru },
    { L"Character Extra 1", 0x388542, 0x388562, indexKOF02UMSprites_Benimaru },
    { L"Character Extra 2", 0x388562, 0x388582, indexKOF02UMSprites_Benimaru },
    { L"Electric Palette", 0x388582, 0x3885a2, indexKOF02UMSprites_Benimaru },
    { L"Lin Poison Palette (Unused)", 0x3885a2, 0x3885c2, indexKOF02UMSprites_Benimaru },
    { L"Freeze Palette (Unused)", 0x3885c2, 0x3885e2, indexKOF02UMSprites_Benimaru },
    { L"Super Trail", 0x3885e2, 0x388602, indexKOF02UMSprites_Benimaru },
    { L"Striker Portrait", 0x398502, 0x398522 },
    { L"Order Select Portrait", 0x399462, 0x399482, indexKOF01Sprites_Benimaru, 0x44 },
    { L"Select Portrait", 0x39a562, 0x39a5a2, indexKOF01Sprites_Benimaru, 0x42 },
...
{
    { L"Benimaru Kick", 0x388722, 0x388742, indexKOF02UMSprites_Benimaru },
    { L"Character Extra 1", 0x388742, 0x388762, indexKOF02UMSprites_Benimaru },
    { L"Character Extra 2", 0x388762, 0x388782, indexKOF02UMSprites_Benimaru },
    { L"Electric Palette", 0x388782, 0x3887a2, indexKOF02UMSprites_Benimaru },
    { L"Lin Poison Palette (Unused)", 0x3887a2, 0x3887c2, indexKOF02UMSprites_Benimaru },
    { L"Freeze Palette (Unused)", 0x3887c2, 0x3887e2, indexKOF02UMSprites_Benimaru },
    { L"Super Trail", 0x3887e2, 0x388802, indexKOF02UMSprites_Benimaru },
    { L"Striker Portrait", 0x398522, 0x398542 },
    { L"Order Select Portrait", 0x399482, 0x3994a2, indexKOF01Sprites_Benimaru, 0x44 },
    { L"Select Portrait", 0x39a5a2, 0x39a5e2, indexKOF01Sprites_Benimaru, 0x42 },
...
const sGame_PaletteDataset KOF01_A_GORO_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a6a2, 0x39a6e2, indexKOF01Sprites_Goro, 0x42 },
...
const sGame_PaletteDataset KOF01_A_GORO_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a6e2, 0x39a722, indexKOF01Sprites_Goro, 0x42 },
...
const sGame_PaletteDataset KOF01_A_SHINGO_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a7e2, 0x39a822, indexKOF01Sprites_Shingo, 0x42 },
...
const sGame_PaletteDataset KOF01_A_SHINGO_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39a822, 0x39a862, indexKOF01Sprites_Shingo, 0x42 },
...
{
    { L"Iori Punch", 0x389122, 0x389142, indexKOF02UMSprites_Iori },
    { L"Character Extra 1", 0x389142, 0x389162, indexKOF02UMSprites_Iori },
    { L"Character Extra 2", 0x389162, 0x389182, indexKOF02UMSprites_Iori },
    { L"Electric Palette", 0x389182, 0x3891a2, indexKOF02UMSprites_Iori },
    { L"Lin Poison Palette (Unused)", 0x3891a2, 0x3891c2, indexKOF02UMSprites_Iori },
    { L"Freeze Palette (Unused)", 0x3891c2, 0x3891e2, indexKOF02UMSprites_Iori },
    { L"Super Trail", 0x3891e2, 0x389202, indexKOF02UMSprites_Iori },
    { L"Striker Portrait", 0x398622, 0x398642 },
    { L"Order Select Portrait", 0x399522, 0x399542, indexKOF01Sprites_Iori, 0x44 },
    { L"Select Portrait", 0x39a922, 0x39a962, indexKOF01Sprites_Iori, 0x42 },
...
{
    { L"Iori Kick", 0x389322, 0x389342, indexKOF02UMSprites_Iori },
    { L"Character Extra 1", 0x389342, 0x389362, indexKOF02UMSprites_Iori },
    { L"Character Extra 2", 0x389362, 0x389382, indexKOF02UMSprites_Iori },
    { L"Electric Palette", 0x389382, 0x3893a2, indexKOF02UMSprites_Iori },
    { L"Lin Poison Palette (Unused)", 0x3893a2, 0x3893c2, indexKOF02UMSprites_Iori },
    { L"Freeze Palette (Unused)", 0x3893c2, 0x3893e2, indexKOF02UMSprites_Iori },
    { L"Super Trail", 0x3893e2, 0x389402, indexKOF02UMSprites_Iori },
    { L"Striker Portrait", 0x398642, 0x398662 },
    { L"Order Select Portrait", 0x399542, 0x399562, indexKOF01Sprites_Iori, 0x44 },
    { L"Select Portrait", 0x39a962, 0x39a9a2, indexKOF01Sprites_Iori, 0x42 },
...
{
    { L"Vanessa Punch", 0x389522, 0x389542, indexKOF02UMSprites_Vanessa },
    { L"Character Extra 1", 0x389542, 0x389562, indexKOF02UMSprites_Vanessa },
    { L"Character Extra 2", 0x389562, 0x389582, indexKOF02UMSprites_Vanessa },
    { L"Electric Palette", 0x389582, 0x3895a2, indexKOF02UMSprites_Vanessa },
    { L"Lin Poison Palette (Unused)", 0x3895a2, 0x3895c2, indexKOF02UMSprites_Vanessa },
    { L"Freeze Palette (Unused)", 0x3895c2, 0x3895e2, indexKOF02UMSprites_Vanessa },
    { L"Super Trail", 0x3895e2, 0x389602, indexKOF02UMSprites_Vanessa },
    { L"Striker Portrait", 0x398682, 0x3986a2 },
    { L"Order Select Portrait", 0x399562, 0x399582, indexKOF01Sprites_Vanessa, 0x44 },
    { L"Select Portrait", 0x39aa62, 0x39aaa2, indexKOF01Sprites_Vanessa, 0x42 },
...
{
    { L"Vanessa Kick", 0x389722, 0x389742, indexKOF02UMSprites_Vanessa },
    { L"Character Extra 1", 0x389742, 0x389762, indexKOF02UMSprites_Vanessa },
    { L"Character Extra 2", 0x389762, 0x389782, indexKOF02UMSprites_Vanessa },
    { L"Electric Palette", 0x389782, 0x3897a2, indexKOF02UMSprites_Vanessa },
    { L"Lin Poison Palette (Unused)", 0x3897a2, 0x3897c2, indexKOF02UMSprites_Vanessa },
    { L"Freeze Palette (Unused)", 0x3897c2, 0x3897e2, indexKOF02UMSprites_Vanessa },
    { L"Super Trail", 0x3897e2, 0x389802, indexKOF02UMSprites_Vanessa },
    { L"Striker Portrait", 0x3986a2, 0x3986c2 },
    { L"Order Select Portrait", 0x399582, 0x3995a2, indexKOF01Sprites_Vanessa, 0x44 },
    { L"Select Portrait", 0x39aaa2, 0x39aae2, indexKOF01Sprites_Vanessa, 0x42 },
...
{
    { L"Seth Punch", 0x389922, 0x389942, indexKOF02UMSprites_Seth },
    { L"Character Extra 1", 0x389942, 0x389962, indexKOF02UMSprites_Seth },
    { L"Character Extra 2", 0x389962, 0x389982, indexKOF02UMSprites_Seth },
    { L"Electric Palette", 0x389982, 0x3899a2, indexKOF02UMSprites_Seth },
    { L"Lin Poison Palette (Unused)", 0x3899a2, 0x3899c2, indexKOF02UMSprites_Seth },
    { L"Freeze Palette (Unused)", 0x3899c2, 0x3899e2, indexKOF02UMSprites_Seth },
    { L"Super Trail", 0x3899e2, 0x389a02, indexKOF02UMSprites_Seth },
    { L"Striker Portrait", 0x3986e2, 0x398702 },
    { L"Order Select Portrait", 0x3995a2, 0x3995c2, indexKOF01Sprites_Seth, 0x44 },
    { L"Select Portrait", 0x39aba2, 0x39abe2, indexKOF01Sprites_Seth, 0x42 },
...
{
    { L"Seth Kick", 0x389b22, 0x389b42, indexKOF02UMSprites_Seth },
    { L"Character Extra 1", 0x389b42, 0x389b62, indexKOF02UMSprites_Seth },
    { L"Character Extra 2", 0x389b62, 0x389b82, indexKOF02UMSprites_Seth },
    { L"Electric Palette", 0x389b82, 0x389ba2, indexKOF02UMSprites_Seth },
    { L"Lin Poison Palette (Unused)", 0x389ba2, 0x389bc2, indexKOF02UMSprites_Seth },
    { L"Freeze Palette (Unused)", 0x389bc2, 0x389be2, indexKOF02UMSprites_Seth },
    { L"Super Trail", 0x389be2, 0x389c02, indexKOF02UMSprites_Seth },
    { L"Striker Portrait", 0x398702, 0x398722 },
    { L"Order Select Portrait", 0x3995c2, 0x3995e2, indexKOF01Sprites_Seth, 0x44 },
    { L"Select Portrait", 0x39abe2, 0x39ac22, indexKOF01Sprites_Seth, 0x42 },
...
{
    { L"Ramon Punch", 0x389d22, 0x389d42, indexKOF02UMSprites_Ramon },
    { L"Character Extra 1", 0x389d42, 0x389d62, indexKOF02UMSprites_Ramon },
    { L"Character Extra 2", 0x389d62, 0x389d82, indexKOF02UMSprites_Ramon },
    { L"Electric Palette", 0x389d82, 0x389da2, indexKOF02UMSprites_Ramon },
    { L"Lin Poison Palette (Unused)", 0x389da2, 0x389dc2, indexKOF02UMSprites_Ramon },
    { L"Freeze Palette (Unused)", 0x389dc2, 0x389de2, indexKOF02UMSprites_Ramon },
    { L"Super Trail", 0x389de2, 0x389e02, indexKOF02UMSprites_Ramon },
    { L"Striker Portrait", 0x398742, 0x398762 },
    { L"Order Select Portrait", 0x3995e2, 0x399602, indexKOF01Sprites_Ramon, 0x44 },
    { L"Select Portrait", 0x39ace2, 0x39ad22, indexKOF01Sprites_Ramon, 0x42 },
...
{
    { L"Ramon Kick", 0x389f22, 0x389f42, indexKOF02UMSprites_Ramon },
    { L"Character Extra 1", 0x389f42, 0x389f62, indexKOF02UMSprites_Ramon },
    { L"Character Extra 2", 0x389f62, 0x389f82, indexKOF02UMSprites_Ramon },
    { L"Electric Palette", 0x389f82, 0x389fa2, indexKOF02UMSprites_Ramon },
    { L"Lin Poison Palette (Unused)", 0x389fa2, 0x389fc2, indexKOF02UMSprites_Ramon },
    { L"Freeze Palette (Unused)", 0x389fc2, 0x389fe2, indexKOF02UMSprites_Ramon },
    { L"Super Trail", 0x389fe2, 0x38a002, indexKOF02UMSprites_Ramon },
    { L"Striker Portrait", 0x398762, 0x398782 },
    { L"Order Select Portrait", 0x399602, 0x399622, indexKOF01Sprites_Ramon, 0x44 },
    { L"Select Portrait", 0x39ad22, 0x39ad62, indexKOF01Sprites_Ramon, 0x42 },
...
const sGame_PaletteDataset KOF01_A_LEONA_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39ae22, 0x39ae62, indexKOF01Sprites_Leona, 0x42 },
...
const sGame_PaletteDataset KOF01_A_LEONA_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39ae62, 0x39aea2, indexKOF01Sprites_Leona, 0x42 },
...
{
    { L"Ralf Punch", 0x38a522, 0x38a542, indexKOF02UMSprites_Ralf },
    { L"Character Extra 1", 0x38a542, 0x38a562, indexKOF02UMSprites_Ralf },
    { L"Character Extra 2", 0x38a562, 0x38a582, indexKOF02UMSprites_Ralf },
    { L"Electric Palette", 0x38a582, 0x38a5a2, indexKOF02UMSprites_Ralf },
    { L"Lin Poison Palette (Unused)", 0x38a5a2, 0x38a5c2, indexKOF02UMSprites_Ralf },
    { L"Freeze Palette (Unused)", 0x38a5c2, 0x38a5e2, indexKOF02UMSprites_Ralf },
    { L"Super Trail", 0x38a5e2, 0x38a602, indexKOF02UMSprites_Ralf },
    { L"Striker Portrait", 0x398802, 0x398822 },
    { L"Order Select Portrait", 0x399662, 0x399682, indexKOF01Sprites_Ralf, 0x44 },
    { L"Select Portrait", 0x39af62, 0x39afa2, indexKOF01Sprites_Ralf, 0x42 },
...
{
    { L"Ralf Kick", 0x38a722, 0x38a742, indexKOF02UMSprites_Ralf },
    { L"Character Extra 1", 0x38a742, 0x38a762, indexKOF02UMSprites_Ralf },
    { L"Character Extra 2", 0x38a762, 0x38a782, indexKOF02UMSprites_Ralf },
    { L"Electric Palette", 0x38a782, 0x38a7a2, indexKOF02UMSprites_Ralf },
    { L"Lin Poison Palette (Unused)", 0x38a7a2, 0x38a7c2, indexKOF02UMSprites_Ralf },
    { L"Freeze Palette (Unused)", 0x38a7c2, 0x38a7e2, indexKOF02UMSprites_Ralf },
    { L"Super Trail", 0x38a7e2, 0x38a802, indexKOF02UMSprites_Ralf },
    { L"Striker Portrait", 0x398822, 0x398842 },
    { L"Order Select Portrait", 0x399682, 0x3996a2, indexKOF01Sprites_Ralf, 0x44 },
    { L"Select Portrait", 0x39afa2, 0x39afe2, indexKOF01Sprites_Ralf, 0x42 },
...
const sGame_PaletteDataset KOF01_A_CLARK_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b0a2, 0x39b0e2, indexKOF01Sprites_Clark, 0x42 },
...
const sGame_PaletteDataset KOF01_A_CLARK_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b0e2, 0x39b122, indexKOF01Sprites_Clark, 0x42 },
...
const sGame_PaletteDataset KOF01_A_HEIDERN_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b1e2, 0x39b222, indexKOF01Sprites_Heidern, 0x42 },
...
const sGame_PaletteDataset KOF01_A_HEIDERN_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b222, 0x39b262, indexKOF01Sprites_Heidern, 0x42 },
...
const sGame_PaletteDataset KOF01_A_TERRY_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b322, 0x39b362, indexKOF01Sprites_Terry, 0x42 },
...
const sGame_PaletteDataset KOF01_A_TERRY_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b362, 0x39b3a2, indexKOF01Sprites_Terry, 0x42 },
...
{
    { L"Andy Punch", 0x38b522, 0x38b542, indexKOF02UMSprites_Andy },
    { L"Character Extra 1", 0x38b542, 0x38b562, indexKOF02UMSprites_Andy },
    { L"Character Extra 2", 0x38b562, 0x38b582, indexKOF02UMSprites_Andy },
    { L"Electric Palette", 0x38b582, 0x38b5a2, indexKOF02UMSprites_Andy },
    { L"Lin Poison Palette (Unused)", 0x38b5a2, 0x38b5c2, indexKOF02UMSprites_Andy },
    { L"Freeze Palette (Unused)", 0x38b5c2, 0x38b5e2, indexKOF02UMSprites_Andy },
    { L"Super Trail", 0x38b5e2, 0x38b602, indexKOF02UMSprites_Andy },
    { L"Striker Portrait", 0x398982, 0x3989a2 },
    { L"Order Select Portrait", 0x399762, 0x399782, indexKOF01Sprites_Andy, 0x44 },
    { L"Select Portrait", 0x39b462, 0x39b4a2, indexKOF01Sprites_Andy, 0x42 },
...
{
    { L"Andy Kick", 0x38b722, 0x38b742, indexKOF02UMSprites_Andy },
    { L"Character Extra 1", 0x38b742, 0x38b762, indexKOF02UMSprites_Andy },
    { L"Character Extra 2", 0x38b762, 0x38b782, indexKOF02UMSprites_Andy },
    { L"Electric Palette", 0x38b782, 0x38b7a2, indexKOF02UMSprites_Andy },
    { L"Lin Poison Palette (Unused)", 0x38b7a2, 0x38b7c2, indexKOF02UMSprites_Andy },
    { L"Freeze Palette (Unused)", 0x38b7c2, 0x38b7e2, indexKOF02UMSprites_Andy },
    { L"Super Trail", 0x38b7e2, 0x38b802, indexKOF02UMSprites_Andy },
    { L"Striker Portrait", 0x3989a2, 0x3989c2 },
    { L"Order Select Portrait", 0x399782, 0x3997a2, indexKOF01Sprites_Andy, 0x44 },
    { L"Select Portrait", 0x39b4a2, 0x39b4e2, indexKOF01Sprites_Andy, 0x42 },
...
const sGame_PaletteDataset KOF01_A_JOE_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b5a2, 0x39b5e2, indexKOF01Sprites_Joe, 0x42 },
...
const sGame_PaletteDataset KOF01_A_JOE_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b5e2, 0x39b622, indexKOF01Sprites_Joe, 0x42 },
...
const sGame_PaletteDataset KOF01_A_MARY_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b6e2, 0x39b722, indexKOF01Sprites_Mary, 0x42 },
...
const sGame_PaletteDataset KOF01_A_MARY_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b722, 0x39b762, indexKOF01Sprites_Mary, 0x42 },
...
const sGame_PaletteDataset KOF01_A_RYO_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b822, 0x39b862, indexKOF01Sprites_Ryo, 0x42 },
...
const sGame_PaletteDataset KOF01_A_RYO_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39b862, 0x39b8a2, indexKOF01Sprites_Ryo, 0x42 },
...
{
    { L"Robert Punch", 0x38c522, 0x38c542, indexKOF02UMSprites_Robert },
    { L"Character Extra 1", 0x38c542, 0x38c562, indexKOF02UMSprites_Robert },
    { L"Character Extra 2", 0x38c562, 0x38c582, indexKOF02UMSprites_Robert },
    { L"Electric Palette", 0x38c582, 0x38c5a2, indexKOF02UMSprites_Robert },
    { L"Lin Poison Palette (Unused)", 0x38c5a2, 0x38c5c2, indexKOF02UMSprites_Robert },
    { L"Freeze Palette (Unused)", 0x38c5c2, 0x38c5e2, indexKOF02UMSprites_Robert },
    { L"Super Trail", 0x38c5e2, 0x38c602, indexKOF02UMSprites_Robert },
    { L"Striker Portrait", 0x398b02, 0x398b22 },
    { L"Order Select Portrait", 0x399862, 0x399882, indexKOF01Sprites_Robert, 0x44 },
    { L"Select Portrait", 0x39b962, 0x39b9a2, indexKOF01Sprites_Robert, 0x42 },
...
{
    { L"Robert Kick", 0x38c722, 0x38c742, indexKOF02UMSprites_Robert },
    { L"Character Extra 1", 0x38c742, 0x38c762, indexKOF02UMSprites_Robert },
    { L"Character Extra 2", 0x38c762, 0x38c782, indexKOF02UMSprites_Robert },
    { L"Electric Palette", 0x38c782, 0x38c7a2, indexKOF02UMSprites_Robert },
    { L"Lin Poison Palette (Unused)", 0x38c7a2, 0x38c7c2, indexKOF02UMSprites_Robert },
    { L"Freeze Palette (Unused)", 0x38c7c2, 0x38c7e2, indexKOF02UMSprites_Robert },
    { L"Super Trail", 0x38c7e2, 0x38c802, indexKOF02UMSprites_Robert },
    { L"Striker Portrait", 0x398b22, 0x398b42 },
    { L"Order Select Portrait", 0x399882, 0x3998a2, indexKOF01Sprites_Robert, 0x44 },
    { L"Select Portrait", 0x39b9a2, 0x39b9e2, indexKOF01Sprites_Robert, 0x42 },
...
{
    { L"Yuri Punch", 0x38c922, 0x38c942, indexKOF02UMSprites_Yuri },
    { L"Character Extra 1", 0x38c942, 0x38c962, indexKOF02UMSprites_Yuri },
    { L"Character Extra 2", 0x38c962, 0x38c982, indexKOF02UMSprites_Yuri },
    { L"Electric Palette", 0x38c982, 0x38c9a2, indexKOF02UMSprites_Yuri },
    { L"Lin Poison Palette (Unused)", 0x38c9a2, 0x38c9c2, indexKOF02UMSprites_Yuri },
    { L"Freeze Palette (Unused)", 0x38c9c2, 0x38c9e2, indexKOF02UMSprites_Yuri },
    { L"Super Trail", 0x38c9e2, 0x38ca02, indexKOF02UMSprites_Yuri },
    { L"Striker Portrait", 0x398b62, 0x398b82 },
    { L"Order Select Portrait", 0x3998a2, 0x3998c2, indexKOF01Sprites_Yuri, 0x44 },
    { L"Select Portrait", 0x39baa2, 0x39bae2, indexKOF01Sprites_Yuri, 0x42 },
...
{
    { L"Yuri Kick", 0x38cb22, 0x38cb42, indexKOF02UMSprites_Yuri },
    { L"Character Extra 1", 0x38cb42, 0x38cb62, indexKOF02UMSprites_Yuri },
    { L"Character Extra 2", 0x38cb62, 0x38cb82, indexKOF02UMSprites_Yuri },
    { L"Electric Palette", 0x38cb82, 0x38cba2, indexKOF02UMSprites_Yuri },
    { L"Lin Poison Palette (Unused)", 0x38cba2, 0x38cbc2, indexKOF02UMSprites_Yuri },
    { L"Freeze Palette (Unused)", 0x38cbc2, 0x38cbe2, indexKOF02UMSprites_Yuri },
    { L"Super Trail", 0x38cbe2, 0x38cc02, indexKOF02UMSprites_Yuri },
    { L"Striker Portrait", 0x398b82, 0x398ba2 },
    { L"Order Select Portrait", 0x3998c2, 0x3998e2, indexKOF01Sprites_Yuri, 0x44 },
    { L"Select Portrait", 0x39bae2, 0x39bb22, indexKOF01Sprites_Yuri, 0x42 },
...
const sGame_PaletteDataset KOF01_A_TAKUMA_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39bbe2, 0x39bc22, indexKOF01Sprites_Takuma, 0x42 },
...
const sGame_PaletteDataset KOF01_A_TAKUMA_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39bc22, 0x39bc62, indexKOF01Sprites_Takuma, 0x42 },
...
{
    { L"King Punch", 0x38d122, 0x38d142, indexKOF02UMSprites_King },
    { L"Character Extra 1", 0x38d142, 0x38d162, indexKOF02UMSprites_King },
    { L"Character Extra 2", 0x38d162, 0x38d182, indexKOF02UMSprites_King },
    { L"Electric Palette", 0x38d182, 0x38d1a2, indexKOF02UMSprites_King },
    { L"Lin Poison Palette (Unused)", 0x38d1a2, 0x38d1c2, indexKOF02UMSprites_King },
    { L"Freeze Palette (Unused)", 0x38d1c2, 0x38d1e2, indexKOF02UMSprites_King },
    { L"Super Trail", 0x38d1e2, 0x38d202, indexKOF02UMSprites_King },
    { L"Striker Portrait", 0x398c22, 0x398c42 },
    { L"Order Select Portrait", 0x399922, 0x399942, indexKOF01Sprites_King, 0x44 },
    { L"Select Portrait", 0x39bd22, 0x39bd62, indexKOF01Sprites_King, 0x42 },
...
{
    { L"King Kick", 0x38d322, 0x38d342, indexKOF02UMSprites_King },
    { L"Character Extra 1", 0x38d342, 0x38d362, indexKOF02UMSprites_King },
    { L"Character Extra 2", 0x38d362, 0x38d382, indexKOF02UMSprites_King },
    { L"Electric Palette", 0x38d382, 0x38d3a2, indexKOF02UMSprites_King },
    { L"Lin Poison Palette (Unused)", 0x38d3a2, 0x38d3c2, indexKOF02UMSprites_King },
    { L"Freeze Palette (Unused)", 0x38d3c2, 0x38d3e2, indexKOF02UMSprites_King },
    { L"Super Trail", 0x38d3e2, 0x38d402, indexKOF02UMSprites_King },
    { L"Striker Portrait", 0x398c42, 0x398c62 },
    { L"Order Select Portrait", 0x399942, 0x399962, indexKOF01Sprites_King, 0x44 },
    { L"Select Portrait", 0x39bd62, 0x39bda2, indexKOF01Sprites_King, 0x42 },
...
const sGame_PaletteDataset KOF01_A_MAI_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39be62, 0x39bea2, indexKOF01Sprites_Mai, 0x42 },
...
const sGame_PaletteDataset KOF01_A_MAI_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39bea2, 0x39bee2, indexKOF01Sprites_Mai, 0x42 },
...
const sGame_PaletteDataset KOF01_A_HINAKO_PUNCH_PALETTES[] =
{
    ...
    { L"Super Trail", 0x38d9e2, 0x38da02, indexKOF02UMSprites_Hinako },
    { L"Striker Portrait", 0x398ce2, 0x398d02 },
    { L"Order Select Portrait", 0x3999a2, 0x3999c2, indexKOF01Sprites_Hinako, 0x44 },
    { L"Select Portrait", 0x39bfa2, 0x39bfe2, indexKOF01Sprites_Hinako, 0x42 },
...
const sGame_PaletteDataset KOF01_A_HINAKO_KICK_PALETTES[] =
{
    ...
    { L"Super Trail", 0x38dbe2, 0x38dc02, indexKOF02UMSprites_Hinako },
    { L"Striker Portrait", 0x398d02, 0x398d22 },
    { L"Order Select Portrait", 0x3999c2, 0x3999e2, indexKOF01Sprites_Hinako, 0x44 },
    { L"Select Portrait", 0x39bfe2, 0x39c022, indexKOF01Sprites_Hinako, 0x42 },
...
const sGame_PaletteDataset KOF01_A_XIANGFEI_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c0e2, 0x39c122, indexKOF01Sprites_Xiangfei, 0x42 },
...
const sGame_PaletteDataset KOF01_A_XIANGFEI_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c122, 0x39c162, indexKOF01Sprites_Xiangfei, 0x42 },
...
{
    { L"Kula Punch", 0x38e122, 0x38e142, indexKOF02UMSprites_Kula },
    { L"Character Extra 1", 0x38e142, 0x38e162, indexKOF02UMSprites_Kula },
    { L"Character Extra 2", 0x38e162, 0x38e182, indexKOF02UMSprites_Kula },
    { L"Electric Palette", 0x38e182, 0x38e1a2, indexKOF02UMSprites_Kula },
    { L"Lin Poison Palette (Unused)", 0x38e1a2, 0x38e1c2, indexKOF02UMSprites_Kula },
    { L"Freeze Palette (Unused)", 0x38e1c2, 0x38e1e2, indexKOF02UMSprites_Kula },
    { L"Super Trail", 0x38e1e2, 0x38e202, indexKOF02UMSprites_Kula },
    { L"Striker Portrait", 0x398da2, 0x398dc2 },
    { L"Order Select Portrait", 0x399a22, 0x399a42, indexKOF01Sprites_Kula, 0x44 },
    { L"Select Portrait", 0x39c222, 0x39c262, indexKOF01Sprites_Kula, 0x42 },
...
{
    { L"Kula Kick", 0x38e322, 0x38e342, indexKOF02UMSprites_Kula },
    { L"Character Extra 1", 0x38e342, 0x38e362, indexKOF02UMSprites_Kula },
    { L"Character Extra 2", 0x38e362, 0x38e382, indexKOF02UMSprites_Kula },
    { L"Electric Palette", 0x38e382, 0x38e3a2, indexKOF02UMSprites_Kula },
    { L"Lin Poison Palette (Unused)", 0x38e3a2, 0x38e3c2, indexKOF02UMSprites_Kula },
    { L"Freeze Palette (Unused)", 0x38e3c2, 0x38e3e2, indexKOF02UMSprites_Kula },
    { L"Super Trail", 0x38e3e2, 0x38e402, indexKOF02UMSprites_Kula },
    { L"Striker Portrait", 0x398dc2, 0x398de2 },
    { L"Order Select Portrait", 0x399a42, 0x399a62, indexKOF01Sprites_Kula, 0x44 },
    { L"Select Portrait", 0x39c262, 0x39c2a2, indexKOF01Sprites_Kula, 0x42 },
    // You must reinsert below this after regenerating this header
...
const sGame_PaletteDataset KOF01_A_FOXY_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c362, 0x39c3a2, indexKOF01Sprites_Foxy, 0x42 },
...
const sGame_PaletteDataset KOF01_A_FOXY_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c3a2, 0x39c3e2, indexKOF01Sprites_Foxy, 0x42 },
...
{
    { L"K9999 Punch", 0x38e922, 0x38e942, indexKOF02UMSprites_K9999 },
    { L"Character Extra 1", 0x38e942, 0x38e962, indexKOF02UMSprites_K9999 },
    { L"Character Extra 2", 0x38e962, 0x38e982, indexKOF02UMSprites_K9999 },
    { L"Electric Palette", 0x38e982, 0x38e9a2, indexKOF02UMSprites_K9999 },
    { L"Lin Poison Palette (Unused)", 0x38e9a2, 0x38e9c2, indexKOF02UMSprites_K9999 },
    { L"Freeze Palette (Unused)", 0x38e9c2, 0x38e9e2, indexKOF02UMSprites_K9999 },
    { L"Super Trail", 0x38e9e2, 0x38ea02, indexKOF02UMSprites_K9999 },
    { L"Striker Portrait", 0x398e62, 0x398e82 },
    { L"Order Select Portrait", 0x399aa2, 0x399ac2, indexKOF01Sprites_K9999, 0x44 },
    { L"Select Portrait", 0x39c4a2, 0x39c4e2, indexKOF01Sprites_K9999, 0x42 },
...
{
    { L"K9999 Kick", 0x38eb22, 0x38eb42, indexKOF02UMSprites_K9999 },
    { L"Character Extra 1", 0x38eb42, 0x38eb62, indexKOF02UMSprites_K9999 },
    { L"Character Extra 2", 0x38eb62, 0x38eb82, indexKOF02UMSprites_K9999 },
    { L"Electric Palette", 0x38eb82, 0x38eba2, indexKOF02UMSprites_K9999 },
    { L"Lin Poison Palette (Unused)", 0x38eba2, 0x38ebc2, indexKOF02UMSprites_K9999 },
    { L"Freeze Palette (Unused)", 0x38ebc2, 0x38ebe2, indexKOF02UMSprites_K9999 },
    { L"Super Trail", 0x38ebe2, 0x38ec02, indexKOF02UMSprites_K9999 },
    { L"Striker Portrait", 0x398e82, 0x398ea2 },
    { L"Order Select Portrait", 0x399ac2, 0x399ae2, indexKOF01Sprites_K9999, 0x44 },
    { L"Select Portrait", 0x39c4e2, 0x39c522, indexKOF01Sprites_K9999, 0x42 },
...
{
    { L"Angel Punch", 0x38ed22, 0x38ed42, indexKOF02UMSprites_Angel },
    { L"Character Extra 1", 0x38ed42, 0x38ed62, indexKOF02UMSprites_Angel },
    { L"Character Extra 2", 0x38ed62, 0x38ed82, indexKOF02UMSprites_Angel },
    { L"Electric Palette", 0x38ed82, 0x38eda2, indexKOF02UMSprites_Angel },
    { L"Lin Poison Palette (Unused)", 0x38eda2, 0x38edc2, indexKOF02UMSprites_Angel },
    { L"Freeze Palette (Unused)", 0x38edc2, 0x38ede2, indexKOF02UMSprites_Angel },
    { L"Super Trail", 0x38ede2, 0x38ee02, indexKOF02UMSprites_Angel },
    { L"Striker Portrait", 0x398ec2, 0x398ee2 },
    { L"Order Select Portrait", 0x399ae2, 0x399b02, indexKOF01Sprites_Angel, 0x44 },
    { L"Select Portrait", 0x39c5e2, 0x39c622, indexKOF01Sprites_Angel, 0x42 },
...
{
    { L"Angel Kick", 0x38ef22, 0x38ef42, indexKOF02UMSprites_Angel },
    { L"Character Extra 1", 0x38ef42, 0x38ef62, indexKOF02UMSprites_Angel },
    { L"Character Extra 2", 0x38ef62, 0x38ef82, indexKOF02UMSprites_Angel },
    { L"Electric Palette", 0x38ef82, 0x38efa2, indexKOF02UMSprites_Angel },
    { L"Lin Poison Palette (Unused)", 0x38efa2, 0x38efc2, indexKOF02UMSprites_Angel },
    { L"Freeze Palette (Unused)", 0x38efc2, 0x38efe2, indexKOF02UMSprites_Angel },
    { L"Super Trail", 0x38efe2, 0x38f002, indexKOF02UMSprites_Angel },
    { L"Striker Portrait", 0x398ee2, 0x398f02 },
    { L"Order Select Portrait", 0x399b02, 0x399b22, indexKOF01Sprites_Angel, 0x44 },
    { L"Select Portrait", 0x39c622, 0x39c662, indexKOF01Sprites_Angel, 0x42 },
...
const sGame_PaletteDataset KOF01_A_ATHENA_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c722, 0x39c762, indexKOF01Sprites_Athena, 0x42 },
...
const sGame_PaletteDataset KOF01_A_ATHENA_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c762, 0x39c7a2, indexKOF01Sprites_Athena, 0x42 },
...
{
    { L"Kensou Punch", 0x38f522, 0x38f542, indexKOF02UMSprites_Kensou },
    { L"Character Extra 1", 0x38f542, 0x38f562, indexKOF02UMSprites_Kensou },
    { L"Character Extra 2", 0x38f562, 0x38f582, indexKOF02UMSprites_Kensou },
    { L"Electric Palette", 0x38f582, 0x38f5a2, indexKOF02UMSprites_Kensou },
    { L"Lin Poison Palette (Unused)", 0x38f5a2, 0x38f5c2, indexKOF02UMSprites_Kensou },
    { L"Freeze Palette (Unused)", 0x38f5c2, 0x38f5e2, indexKOF02UMSprites_Kensou },
    { L"Super Trail", 0x38f5e2, 0x38f602, indexKOF02UMSprites_Kensou },
    { L"Striker Portrait", 0x398f82, 0x398fa2 },
    { L"Order Select Portrait", 0x399b62, 0x399b82, indexKOF01Sprites_Kensou, 0x44 },
    { L"Select Portrait", 0x39c862, 0x39c8a2, indexKOF01Sprites_Kensou, 0x42 },
...
{
    { L"Kensou Kick", 0x38f722, 0x38f742, indexKOF02UMSprites_Kensou },
    { L"Character Extra 1", 0x38f742, 0x38f762, indexKOF02UMSprites_Kensou },
    { L"Character Extra 2", 0x38f762, 0x38f782, indexKOF02UMSprites_Kensou },
    { L"Electric Palette", 0x38f782, 0x38f7a2, indexKOF02UMSprites_Kensou },
    { L"Lin Poison Palette (Unused)", 0x38f7a2, 0x38f7c2, indexKOF02UMSprites_Kensou },
    { L"Freeze Palette (Unused)", 0x38f7c2, 0x38f7e2, indexKOF02UMSprites_Kensou },
    { L"Super Trail", 0x38f7e2, 0x38f802, indexKOF02UMSprites_Kensou },
    { L"Striker Portrait", 0x398fa2, 0x398fc2 },
    { L"Order Select Portrait", 0x399b82, 0x399ba2, indexKOF01Sprites_Kensou, 0x44 },
    { L"Select Portrait", 0x39c8a2, 0x39c8e2, indexKOF01Sprites_Kensou, 0x42 },
...
const sGame_PaletteDataset KOF01_A_CHIN_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c9a2, 0x39c9e2, indexKOF01Sprites_Chin, 0x42 },
...
const sGame_PaletteDataset KOF01_A_CHIN_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39c9e2, 0x39ca22, indexKOF01Sprites_Chin, 0x42 },
...
{
    { L"Bao Punch", 0x38fd22, 0x38fd42, indexKOF02UMSprites_Bao },
    { L"Character Extra 1", 0x38fd42, 0x38fd62, indexKOF02UMSprites_Bao },
    { L"Character Extra 2", 0x38fd62, 0x38fd82, indexKOF02UMSprites_Bao },
    { L"Electric Palette", 0x38fd82, 0x38fda2, indexKOF02UMSprites_Bao },
    { L"Lin Poison Palette (Unused)", 0x38fda2, 0x38fdc2, indexKOF02UMSprites_Bao },
    { L"Freeze Palette (Unused)", 0x38fdc2, 0x38fde2, indexKOF02UMSprites_Bao },
    { L"Super Trail", 0x38fde2, 0x38fe02, indexKOF02UMSprites_Bao },
    { L"Striker Portrait", 0x399042, 0x399062 },
    { L"Order Select Portrait", 0x399be2, 0x399c02, indexKOF01Sprites_Bao, 0x44 },
    { L"Select Portrait", 0x39cae2, 0x39cb22, indexKOF01Sprites_Bao, 0x42 },
...
{
    { L"Bao Kick", 0x38ff22, 0x38ff42, indexKOF02UMSprites_Bao },
    { L"Character Extra 1", 0x38ff42, 0x38ff62, indexKOF02UMSprites_Bao },
    { L"Character Extra 2", 0x38ff62, 0x38ff82, indexKOF02UMSprites_Bao },
    { L"Electric Palette", 0x38ff82, 0x38ffa2, indexKOF02UMSprites_Bao },
    { L"Lin Poison Palette (Unused)", 0x38ffa2, 0x38ffc2, indexKOF02UMSprites_Bao },
    { L"Freeze Palette (Unused)", 0x38ffc2, 0x38ffe2, indexKOF02UMSprites_Bao },
    { L"Super Trail", 0x38ffe2, 0x390002, indexKOF02UMSprites_Bao },
    { L"Striker Portrait", 0x399062, 0x399082 },
    { L"Order Select Portrait", 0x399c02, 0x399c22, indexKOF01Sprites_Bao, 0x44 },
    { L"Select Portrait", 0x39cb22, 0x39cb62, indexKOF01Sprites_Bao, 0x42 },
...
const sGame_PaletteDataset KOF01_A_KIM_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39cc22, 0x39cc62, indexKOF01Sprites_Kim, 0x42 },
...
const sGame_PaletteDataset KOF01_A_KIM_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39cc62, 0x39cca2, indexKOF01Sprites_Kim, 0x42 },
...
{
    { L"Chang Punch", 0x390522, 0x390542, indexKOF02UMSprites_Chang },
    { L"Character Extra 1", 0x390542, 0x390562, indexKOF02UMSprites_Chang },
    { L"Character Extra 2", 0x390562, 0x390582, indexKOF02UMSprites_Chang },
    { L"Electric Palette", 0x390582, 0x3905a2, indexKOF02UMSprites_Chang },
    { L"Lin Poison Palette (Unused)", 0x3905a2, 0x3905c2, indexKOF02UMSprites_Chang },
    { L"Freeze Palette (Unused)", 0x3905c2, 0x3905e2, indexKOF02UMSprites_Chang },
    { L"Super Trail", 0x3905e2, 0x390602, indexKOF02UMSprites_Chang },
    { L"Striker Portrait", 0x399102, 0x399122 },
    { L"Order Select Portrait", 0x399c62, 0x399c82, indexKOF01Sprites_Chang, 0x44 },
    { L"Select Portrait", 0x39cd62, 0x39cda2, indexKOF01Sprites_Chang, 0x42 },
...
{
    { L"Chang Kick", 0x390722, 0x390742, indexKOF02UMSprites_Chang },
    { L"Character Extra 1", 0x390742, 0x390762, indexKOF02UMSprites_Chang },
    { L"Character Extra 2", 0x390762, 0x390782, indexKOF02UMSprites_Chang },
    { L"Electric Palette", 0x390782, 0x3907a2, indexKOF02UMSprites_Chang },
    { L"Lin Poison Palette (Unused)", 0x3907a2, 0x3907c2, indexKOF02UMSprites_Chang },
    { L"Freeze Palette (Unused)", 0x3907c2, 0x3907e2, indexKOF02UMSprites_Chang },
    { L"Super Trail", 0x3907e2, 0x390802, indexKOF02UMSprites_Chang },
    { L"Striker Portrait", 0x399122, 0x399142 },
    { L"Order Select Portrait", 0x399c82, 0x399ca2, indexKOF01Sprites_Chang, 0x44 },
    { L"Select Portrait", 0x39cda2, 0x39cde2, indexKOF01Sprites_Chang, 0x42 },
...
const sGame_PaletteDataset KOF01_A_CHOI_PUNCH_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39cea2, 0x39cee2, indexKOF01Sprites_Choi, 0x42 },
...
const sGame_PaletteDataset KOF01_A_CHOI_KICK_PALETTES[] =
{
    ...
    { L"Select Portrait", 0x39cee2, 0x39cf22, indexKOF01Sprites_Choi, 0x42 },
...
{
    { L"May Lee Punch", 0x390d22, 0x390d42, indexKOF02UMSprites_MayLee },
    { L"Character Extra 1", 0x390d42, 0x390d62, indexKOF02UMSprites_MayLee },
    { L"Character Extra 2", 0x390d62, 0x390d82, indexKOF02UMSprites_MayLee },
    { L"Electric Palette", 0x390d82, 0x390da2, indexKOF02UMSprites_MayLee },
    { L"Lin Poison Palette (Unused)", 0x390da2, 0x390dc2, indexKOF02UMSprites_MayLee },
    { L"Freeze Palette (Unused)", 0x390dc2, 0x390de2, indexKOF02UMSprites_MayLee },
    { L"Super Trail", 0x390de2, 0x390e02, indexKOF02UMSprites_MayLee },
    { L"Striker Portrait", 0x3991c2, 0x3991e2 },
    { L"Order Select Portrait", 0x399ce2, 0x399d02, indexKOF01Sprites_MayLee, 0x44 },
    { L"Select Portrait", 0x39cfe2, 0x39d022, indexKOF01Sprites_MayLee, 0x42 },
...
{
    { L"May Lee Kick", 0x390f22, 0x390f42, indexKOF02UMSprites_MayLee },
    { L"Character Extra 1", 0x390f42, 0x390f62, indexKOF02UMSprites_MayLee },
    { L"Character Extra 2", 0x390f62, 0x390f82, indexKOF02UMSprites_MayLee },
    { L"Electric Palette", 0x390f82, 0x390fa2, indexKOF02UMSprites_MayLee },
    { L"Lin Poison Palette (Unused)", 0x390fa2, 0x390fc2, indexKOF02UMSprites_MayLee },
    { L"Freeze Palette (Unused)", 0x390fc2, 0x390fe2, indexKOF02UMSprites_MayLee },
    { L"Super Trail", 0x390fe2, 0x391002, indexKOF02UMSprites_MayLee },
    { L"Striker Portrait", 0x3991e2, 0x399202 },
    { L"Order Select Portrait", 0x399d02, 0x399d22, indexKOF01Sprites_MayLee, 0x44 },
    { L"Select Portrait", 0x39d022, 0x39d062, indexKOF01Sprites_MayLee, 0x42 },
...
{
    { L"Zero Punch", 0x391122, 0x391142, indexKOF02UMSprites_ZeroOG },
    { L"Character Extra 1", 0x391142, 0x391162, indexKOF02UMSprites_ZeroOG },
    { L"Character Extra 2", 0x391162, 0x391182, indexKOF02UMSprites_ZeroOG },
    { L"Electric Palette", 0x391182, 0x3911a2, indexKOF02UMSprites_ZeroOG },
    { L"Lin Poison Palette (Unused)", 0x3911a2, 0x3911c2, indexKOF02UMSprites_ZeroOG },
    { L"Freeze Palette (Unused)", 0x3911c2, 0x3911e2, indexKOF02UMSprites_ZeroOG },
    { L"Super Trail", 0x3911e2, 0x391202, indexKOF02UMSprites_ZeroOG },
...
{
    { L"Zero Kick", 0x391322, 0x391342, indexKOF02UMSprites_ZeroOG },
    { L"Character Extra 1", 0x391342, 0x391362, indexKOF02UMSprites_ZeroOG },
    { L"Character Extra 2", 0x391362, 0x391382, indexKOF02UMSprites_ZeroOG },
    { L"Electric Palette", 0x391382, 0x3913a2, indexKOF02UMSprites_ZeroOG },
    { L"Lin Poison Palette (Unused)", 0x3913a2, 0x3913c2, indexKOF02UMSprites_ZeroOG },
    { L"Freeze Palette (Unused)", 0x3913c2, 0x3913e2, indexKOF02UMSprites_ZeroOG },
    { L"Super Trail", 0x3913e2, 0x391402, indexKOF02UMSprites_ZeroOG },
...
{
    { L"Igniz Punch", 0x391522, 0x391542, indexKOF02UMSprites_Igniz },
    { L"Character Extra 1", 0x391542, 0x391562, indexKOF02UMSprites_Igniz },
    { L"Character Extra 2", 0x391562, 0x391582, indexKOF02UMSprites_Igniz },
    { L"Electric Palette", 0x391582, 0x3915a2, indexKOF02UMSprites_Igniz },
    { L"Lin Poison Palette (Unused)", 0x3915a2, 0x3915c2, indexKOF02UMSprites_Igniz },
    { L"Freeze Palette (Unused)", 0x3915c2, 0x3915e2, indexKOF02UMSprites_Igniz },
    { L"Super Trail", 0x3915e2, 0x391602, indexKOF02UMSprites_Igniz },
...
{
    { L"Igniz Kick", 0x391722, 0x391742, indexKOF02UMSprites_Igniz },
    { L"Character Extra 1", 0x391742, 0x391762, indexKOF02UMSprites_Igniz },
    { L"Character Extra 2", 0x391762, 0x391782, indexKOF02UMSprites_Igniz },
    { L"Electric Palette", 0x391782, 0x3917a2, indexKOF02UMSprites_Igniz },
    { L"Lin Poison Palette (Unused)", 0x3917a2, 0x3917c2, indexKOF02UMSprites_Igniz },
    { L"Freeze Palette (Unused)", 0x3917c2, 0x3917e2, indexKOF02UMSprites_Igniz },
    { L"Super Trail", 0x3917e2, 0x391802, indexKOF02UMSprites_Igniz },
