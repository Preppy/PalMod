...
{
    { L"Rai A", 0xC8D8, 0xC8F8 },
    { L"Rai A Flashing", 0xC978, 0xC998 },
    { L"Rai A SEL Portrait", 0x11558, 0x115B8 },
    { L"Rai A HUD Portrait", 0x176D8, 0x176F8 },
};

const sGame_PaletteDataset WakuWaku7_A_RAI_B_PALETTES[] =
{
    { L"Rai B", 0xC8F8, 0xC918 },
    { L"Rai B Flashing", 0xC998, 0xCab8 },
    { L"Rai B SEL Portrait", 0x115B8, 0x11618 },
    { L"Rai B HUD Portrait", 0x176F8, 0x17718 },
};

const sGame_PaletteDataset WakuWaku7_A_RAI_C_PALETTES[] =
{
    { L"Rai C", 0xC918, 0xC938 },
    { L"Rai C Flashing", 0xCab8, 0xCad8 },
    { L"Rai C SEL Portrait", 0x11618, 0x11678 },
    { L"Rai C HUD Portrait", 0x17718, 0x17738 },
};

const sGame_PaletteDataset WakuWaku7_A_RAI_D_PALETTES[] =
{
    { L"Rai D", 0xC938, 0xC958 },
    { L"Rai D Flashing", 0xCad8, 0xCaf8 },
    { L"Rai D SEL Portrait", 0x11678, 0x116D8 },
    { L"Rai D HUD Portrait", 0x17738, 0x17758 },
};

const sGame_PaletteDataset WakuWaku7_A_RAI_DARK_PALETTES[] =
{
    { L"Rai Dark", 0xC958, 0xC978 },
    { L"Rai Dark Flashing", 0xCaf8, 0xCb18 },
    { L"Rai Dark SEL Portrait", 0x116D8, 0x11738 },
    { L"Rai Dark HUD Portrait", 0x17758, 0x17778 },
};
...
{
    { L"Arina A", 0xD1F8, 0xD218 },
    { L"Arina A SEL Portrait", 0x11BD8, 0x11C18 },
    { L"Arina A HUD Portrait", 0x17778, 0x17798 },
};

const sGame_PaletteDataset WakuWaku7_A_ARINA_B_PALETTES[] =
{
    { L"Arina B", 0xD218, 0xD238 },
    { L"Arina B SEL Portrait", 0x11C18, 0x11C58 },
    { L"Arina B HUD Portrait", 0x17798, 0x177B8 },
};

const sGame_PaletteDataset WakuWaku7_A_ARINA_C_PALETTES[] =
{
    { L"Arina C", 0xD238, 0xD258 },
    { L"Arina C SEL Portrait", 0x11C58, 0x11C98 },
    { L"Arina C HUD Portrait", 0x177B8, 0x177D8 },
};

const sGame_PaletteDataset WakuWaku7_A_ARINA_D_PALETTES[] =
{
    { L"Arina D", 0xD258, 0xD278 },
    { L"Arina D SEL Portrait", 0x11C98, 0x11CD8 },
    { L"Arina D HUD Portrait", 0x177D8, 0x177F8 },
};

const sGame_PaletteDataset WakuWaku7_A_ARINA_DARK_PALETTES[] =
{
    { L"Arina Dark", 0xD5F8, 0xD618 },
    { L"Arina Dark SEL Portrait", 0x11CD8, 0x11D18 },
    { L"Arina Dark HUD Portrait", 0x177F8, 0x17818 },
};

const sGame_PaletteDataset WakuWaku7_A_DANDYJ_A_PALETTES[] =
{
    { L"Dandy J A", 0xE078, 0xE098 },
    { L"Natsumi and Ranpoo A", 0xE4F8, 0xE518 },
    { L"Dandy J A SEL Portrait", 0x117F8, 0x11818 },
    { L"Dandy J A HUD Portrait", 0x17978, 0x17998 },
};

const sGame_PaletteDataset WakuWaku7_A_DANDYJ_B_PALETTES[] =
{
    { L"Dandy J B", 0xE098, 0xE0B8 },
    { L"Natsumi and Ranpoo B", 0xE518, 0xE538 },
    { L"Dandy J B SEL Portrait", 0x11818, 0x11838 },
    { L"Dandy J B HUD Portrait", 0x17998, 0x179B8 },
};

const sGame_PaletteDataset WakuWaku7_A_DANDYJ_C_PALETTES[] =
{
    { L"Dandy J C", 0xE0B8, 0xE0D8 },
    { L"Natsumi and Ranpoo C", 0xE538, 0xE558 },
    { L"Dandy J C SEL Portrait", 0x11838, 0x11858 },
    { L"Dandy J C HUD Portrait", 0x179B8, 0x179D8 },
};

const sGame_PaletteDataset WakuWaku7_A_DANDYJ_D_PALETTES[] =
{
    { L"Dandy J D", 0xE0D8, 0xE0F8 },
    { L"Natsumi and Ranpoo D", 0xE558, 0xE578 },
    { L"Dandy J D SEL Portrait", 0x11858, 0x11878 },
    { L"Dandy J D HUD Portrait", 0x179D8, 0x179F8 },
};

const sGame_PaletteDataset WakuWaku7_A_DANDYJ_DARK_PALETTES[] =
{
    { L"Dandy J Dark", 0xE478, 0xE498 },
    { L"Natsumi and Ranpoo Dark", 0xE578, 0xE598 },
    { L"Dandy J Dark SEL Portrait", 0x11878, 0x11898 },
    { L"Dandy J Dark HUD Portrait", 0x179F8, 0x17A18 },
};

const sGame_PaletteDataset WakuWaku7_A_MAURU_A_PALETTES[] =
{
    { L"Mauru A", 0xee1C, 0xee3C },
    { L"Mugi A", 0xF298, 0xF2B8 },
    { L"Mauru A SEL Portrait", 0x11d58, 0x11db8 },
    { L"Mauru A HUD Portrait", 0x178d8, 0x178f8 },
};

const sGame_PaletteDataset WakuWaku7_A_MAURU_B_PALETTES[] =
{
    { L"Mauru B", 0xEE3C, 0xEE5C },
    { L"Mugi B", 0xF2B8, 0xF2D8 },
    { L"Mauru B SEL Portrait", 0x11db8, 0x11e18 },
    { L"Mauru B HUD Portrait", 0x178f8, 0x17918 },
};

const sGame_PaletteDataset WakuWaku7_A_MAURU_C_PALETTES[] =
{
    { L"Mauru C", 0xEE5C, 0xEE7C },
    { L"Mugi C", 0xF2D8, 0xF2F8 },
    { L"Mauru C SEL Portrait", 0x11e18, 0x11e78 },
    { L"Mauru C HUD Portrait", 0x17918, 0x17938 },
};

const sGame_PaletteDataset WakuWaku7_A_MAURU_D_PALETTES[] =
{
    { L"Mauru D", 0xEE7C, 0xEE9C },
    { L"Mugi D", 0xF2F8, 0xF318 },
    { L"Mauru D SEL Portrait", 0x11e78, 0x11ed8 },
    { L"Mauru D HUD Portrait", 0x17938, 0x17958 },
};

const sGame_PaletteDataset WakuWaku7_A_MAURU_DARK_PALETTES[] =
{
    { L"Mauru Dark", 0xf21c, 0xf23c },
    { L"Mugi Dark", 0xF698, 0xF6B8 },
    { L"Mauru Dark SEL Portrait", 0x11ED8, 0x11F38 },
    { L"Mauru Dark HUD Portrait", 0x17958, 0x17978 },
};

const sGame_PaletteDataset WakuWaku7_A_POLITANK_A_PALETTES[] =
{
    { L"Politank A", 0xF838, 0xF858 },
    { L"Politank A Flashing", 0x10238, 0x102b8 },
    { L"Chojuro and Hamusuke A", 0xFE38, 0xFE58 },
    { L"Chojuro and Hamusuke A Flashing", 0x10438, 0x104B8 },
    { L"Politank A SEL Portrait", 0x11958, 0x119d8 },
    { L"Chojuro and Hamusuke A SEL Portrait", 0x12358, 0x12458 },
    { L"Politank A HUD Portrait", 0x17A18, 0x17A38 },
};

const sGame_PaletteDataset WakuWaku7_A_POLITANK_B_PALETTES[] =
{
    { L"Politank B", 0xF858, 0xF878 },
    { L"Politank B Flashing", 0x102B8, 0x10338 },
    { L"Chojuro and Hamusuke B", 0xFE58, 0xFE78 },
    { L"Chojuro and Hamusuke B Flashing", 0x104B8, 0x10538 },
    { L"Politank B SEL Portrait", 0x119d8, 0x11A58 },
    { L"Chojuro and Hamusuke B SEL Portrait", 0x12458, 0x12558 },
    { L"Politank B HUD Portrait", 0x17A38, 0x17A58 },
};

const sGame_PaletteDataset WakuWaku7_A_POLITANK_C_PALETTES[] =
{
    { L"Politank C", 0xF878, 0xF898 },
    { L"Politank C Flashing", 0x10338, 0x103B8 },
    { L"Chojuro and Hamusuke C", 0xFE78, 0xFE98 },
    { L"Chojuro and Hamusuke C Flashing", 0x10538, 0x105B8 },
    { L"Politank C SEL Portrait", 0x11a58, 0x11Ad8 },
    { L"Chojuro and Hamusuke C SEL Portrait", 0x12558, 0x12658 },
    { L"Politank C HUD Portrait", 0x17A58, 0x17A78 },
};

const sGame_PaletteDataset WakuWaku7_A_POLITANK_D_PALETTES[] =
{
    { L"Politank D", 0xF898, 0xF8B8 },
    { L"Politank D Flashing", 0x103B8, 0x10438 },
    { L"Chojuro and Hamusuke D", 0xFE98, 0xFEB8 },
    { L"Chojuro and Hamusuke D Flashing", 0x105B8, 0x10638 },
    { L"Politank D SEL Portrait", 0x11ad8, 0x11b58 },
    { L"Chojuro and Hamusuke D SEL Portrait", 0x12658, 0x12758 },
    { L"Politank D HUD Portrait", 0x17A78, 0x17A98 },
};

const sGame_PaletteDataset WakuWaku7_A_POLITANK_DARK_PALETTES[] =
{
    { L"Politank Dark", 0xFC38, 0XFC58 },
    { L"Politank Dark Flashing", 0x10638, 0x106B8 },
    { L"Chojuro and Hamusuke Dark", 0xFCD8, 0xFCF8 },
    { L"Chojuro and Hamusuke Dark Flashing", 0x106B8, 0x10738 },
    { L"Politank Dark SEL Portrait", 0x11b58, 0x11bd8 },
    { L"Chojuro and Hamusuke Dark SEL Portrait", 0x12758, 0x12858 },
    { L"Politank Dark HUD Portrait", 0x17A98, 0x17AB8 },
};

const sGame_PaletteDataset WakuWaku7_A_SLASH_A_PALETTES[] =
{
    { L"Slash A", 0xD878, 0xD898 },
    { L"Slash A Flashing", 0xd9f8, 0xda18 },
    { L"Slash A SEL Portrait", 0x11758, 0x11778 },
    { L"Slash A HUD Portrait", 0x17AD8, 0x17AF8 },
};

const sGame_PaletteDataset WakuWaku7_A_SLASH_B_PALETTES[] =
{
    { L"Slash B", 0xD898, 0xD8B8 },
    { L"Slash B Flashing", 0xda18, 0xda38 },
    { L"Slash B SEL Portrait", 0x11778, 0x11798 },
    { L"Slash B HUD Portrait", 0x17AF8, 0x17B18 },
};

const sGame_PaletteDataset WakuWaku7_A_SLASH_C_PALETTES[] =
{
    { L"Slash C", 0xD8B8, 0xD8D8 },
    { L"Slash C Flashing", 0xda38, 0xda58 },
    { L"Slash C SEL Portrait", 0x11798, 0x117B8 },
    { L"Slash C HUD Portrait", 0x17B18, 0x17B38 },
};

const sGame_PaletteDataset WakuWaku7_A_SLASH_D_PALETTES[] =
{
    { L"Slash D", 0xD8D8, 0xD8F8 },
    { L"Slash D Flashing", 0xda58, 0xda78 },
    { L"Slash D SEL Portrait", 0x117B8, 0x117D8 },
    { L"Slash D HUD Portrait", 0x17B38, 0x17B58 },
};

const sGame_PaletteDataset WakuWaku7_A_SLASH_DARK_PALETTES[] =
{
    { L"Slash Dark", 0xDBB8, 0xDBD8 },
    { L"Slash Dark Flashing", 0xda78, 0xda98 },
    { L"Slash Dark SEL Portrait", 0x117D8, 0x117F8 },
    { L"Slash Dark HUD Portrait", 0x17B58, 0x17B78 },
};

const sGame_PaletteDataset WakuWaku7_A_TESSE_A_PALETTES[] =
{
    { L"Tesse A", 0xe918, 0xe938 },
    { L"Tesse A SEL Portrait", 0x11898, 0x118B8 },
    { L"Tesse A HUD Portrait", 0x17818, 0x17838 },
};

const sGame_PaletteDataset WakuWaku7_A_TESSE_B_PALETTES[] =
{
    { L"Tesse B", 0xE938, 0xE958 },
    { L"Tesse B SEL Portrait", 0x118B8, 0x118D8 },
    { L"Tesse B HUD Portrait", 0x17838, 0x17858 },
};

const sGame_PaletteDataset WakuWaku7_A_TESSE_C_PALETTES[] =
{
    { L"Tesse C", 0xE958, 0xE978 },
    { L"Tesse C SEL Portrait", 0x118D8, 0x118F8 },
    { L"Tesse C HUD Portrait", 0x17858, 0x17878 },
};

const sGame_PaletteDataset WakuWaku7_A_TESSE_D_PALETTES[] =
{
    { L"Tesse D", 0xE978, 0xE998 },
    { L"Tesse D SEL Portrait", 0x118F8, 0x11918 },
    { L"Tesse D HUD Portrait", 0x17878, 0x17898 },
};

const sGame_PaletteDataset WakuWaku7_A_TESSE_DARK_PALETTES[] =
{
    { L"Tesse Dark", 0xED18, 0xED38 },
    { L"Tesse Dark SEL Portrait", 0x11918, 0x11938 },
    { L"Tesse Dark HUD Portrait", 0x17898, 0x178b8 },
};

const sGame_PaletteDataset WakuWaku7_A_FERNANDEATH_A_PALETTES[] =
{
    { L"Fernandeath A", 0x10838, 0x10858 },
    { L"Fernandeath A SEL Portrait", 0x11FD8, 0x12098 },
    { L"Fernandeath A HUD Portrait", 0x17bf8, 0x17c18},
};

const sGame_PaletteDataset WakuWaku7_A_FERNANDEATH_B_PALETTES[] =
{
    { L"Fernandeath B", 0x10858, 0x10878 },
    { L"Fernandeath B SEL Portrait", 0x12098, 0x12158 },
    { L"Fernandeath B HUD Portrait", 0x17c18, 0x17c38},
};

const sGame_PaletteDataset WakuWaku7_A_FERNANDEATH_C_PALETTES[] =
{
    { L"Fernandeath C", 0x10878, 0x10898 },
    { L"Fernandeath C SEL Portrait", 0x12158, 0x12218 },
    { L"Fernandeath C HUD Portrait", 0x17c38, 0x17c58},
};

const sGame_PaletteDataset WakuWaku7_A_FERNANDEATH_D_PALETTES[] =
{
    { L"Fernandeath D", 0x10898, 0x108B8 },
    { L"Fernandeath D SEL Portrait", 0x12218, 0x122d8 },
    { L"Fernandeath D HUD Portrait", 0x17c58, 0x17c78},
};

const sGame_PaletteDataset WakuWaku7_A_BONUSKUN_A_PALETTES[] =
{
    { L"Bonus-Kun A", 0x10C78, 0x10C98 },
    { L"Bonus-Kun SEL Portrait", 0x11F58, 0x11F78 },
    { L"Bonus-Kun A HUD Portrait", 0x17b78, 0x17b98 },
};

const sGame_PaletteDataset WakuWaku7_A_BONUSKUN_B_PALETTES[] =
{
    { L"Bonus-Kun B", 0x10C98, 0x10CB8 },
    { L"Bonus-Kun B SEL Portrait", 0x11F78, 0x11F98 },
    { L"Bonus-Kun B HUD Portrait", 0x17b98, 0x17bb8 },
};

const sGame_PaletteDataset WakuWaku7_A_BONUSKUN_C_PALETTES[] =
{
    { L"Bonus-Kun C", 0x10CB8, 0x10CD8 },
    { L"Bonus-Kun C SEL Portrait", 0x11F98, 0x11FB8 },
    { L"Bonus-Kun C HUD Portrait", 0x17bb8, 0x17bd8 },
};

const sGame_PaletteDataset WakuWaku7_A_BONUSKUN_D_PALETTES[] =
{
    { L"Bonus-Kun D", 0x10CD8, 0x10CF8 },
    { L"Bonus-Kun D SEL Portrait", 0x11FB8, 0x11FD8 },
    { L"Bonus-Kun D HUD Portrait", 0x17bd8, 0x17bf8 },
};
