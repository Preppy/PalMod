...
const sGame_PaletteDataset DBZEB_DS_ZASSIST[] =
{
    ...
    { L"Cell (1st Form)",                   0x156188F0, 0x15618CF0, indexDBZEB_ZAssists, 0x0b },
    { L"Cell (2nd Form)",                   0x156361E0, 0x156365E0, indexDBZEB_ZAssists, 0x0c },
    { L"Cell Jr.",                          0x1561B180, 0x1561B580, indexDBZEB_ZAssists, 0x0d },
    { L"Chiaotzu",                          0x1564A980, 0x1564AD80, indexDBZEB_ZAssists, 0x0e },
    { L"Chi-Chi",                           0x1591F460, 0x1591F860, indexDBZEB_ZAssists, 0x0f },
    { L"Chi-Chi (Unused?) (1/5)",           0x1563E6A0, 0x1563EAA0, indexDBZEB_ZAssists, 0x0f }, // may be used for other regions, rom is stuck in USA
    { L"Chi-Chi (Unused?) (2/5)",           0x159248D0, 0x15924CD0, indexDBZEB_ZAssists, 0x0f },
    { L"Chi-Chi (Unused?) (3/5)",           0x15929D00, 0x1592A100, indexDBZEB_ZAssists, 0x0f },
    { L"Chi-Chi (Unused?) (4/5)",           0x1592F120, 0x1592F520, indexDBZEB_ZAssists, 0x0f },
    { L"Chi-Chi (Unused?) (5/5)",           0x159345D0, 0x159349D0, indexDBZEB_ZAssists, 0x0f },
    ...
    { L"Mecha Frieza",                      0x1579ECE0, 0x1579F0E0, indexDBZEB_ZAssists, 0x3a },
    { L"Mercenary Tao",                     0x1589CEB0, 0x1589D2B0, indexDBZEB_ZAssists, 0x3b },
    { L"Mercenary Tao (Extra 1)",           0x1589CAA0, 0x1589CEA0, indexDBZEB_ZAssists, 0x3c },
    { L"Meta-Cooler",                       0x157A9990, 0x157A9D90, indexDBZEB_ZAssists, 0x3d },
    { L"Mighty Mask (Trunks and Goten)",    0x157A6CF0, 0x157A70F0, indexDBZEB_ZAssists, 0x3e },
    { L"Monster Carrot",                    0x15895890, 0x15895C90, indexDBZEB_ZAssists, 0x3f },
    { L"Mr. Popo",                          0x157ABE90, 0x157AC290, indexDBZEB_ZAssists, 0x40 },
    { L"Mr. Satan",                         0x1580CB20, 0x1580CF20, indexDBZEB_ZAssists, 0x41 },
    { L"Naturon Shenron",                   0x15648E20, 0x15649220, indexDBZEB_ZAssists, 0x42 },
    { L"Nuova Shenron",                     0x15889060, 0x15889460, indexDBZEB_ZAssists, 0x43 },
    { L"Oceanus Shenron",                   0x157FB2C0, 0x157FB6C0, indexDBZEB_ZAssists, 0x44 },
    { L"Old Kai",                           0x157F26E0, 0x157F2AE0, indexDBZEB_ZAssists, 0x45 },
    { L"Omega Shenron",                     0x1587AA30, 0x1587AE30, indexDBZEB_ZAssists, 0x46 },
    { L"Oolong",                            0x158C7300, 0x158C7700, indexDBZEB_ZAssists, 0x47 },
    { L"Pan",                               0x157C7FA0, 0x157C83A0, indexDBZEB_ZAssists, 0x48 },
    { L"Pikkon",                            0x157D64E0, 0x157D68E0, indexDBZEB_ZAssists, 0x49 },
    { L"Pilaf Machine",                     0x157E1DB0, 0x157E21B0, indexDBZEB_ZAssists, 0x4a },
    { L"Puar",                              0x157E3F90, 0x157E4390, indexDBZEB_ZAssists, 0x4b },
    { L"Rage Shenron",                      0x158CC770, 0x158CCB70, indexDBZEB_ZAssists, 0x4c },
    { L"Recoome",                           0x157EF010, 0x157EF410, indexDBZEB_ZAssists, 0x4d },
    { L"Saibamen",                          0x15806300, 0x15806700, indexDBZEB_ZAssists, 0x4e },
    { L"Shenron",                           0x1586A6F0, 0x1586AAF0, indexDBZEB_ZAssists, 0x4f },
    { L"Supreme Kai",                       0x158710B0, 0x158714B0, indexDBZEB_ZAssists, 0x50 },
    { L"Supreme Kai (Cube)",                0x158714c0, 0x158718c0, indexDBZEB_ZAssists, 0x67 },
    ...
    { L"Super Gogeta",                      0x156C93D0, 0x156C97D0, indexDBZEB_ZAssists, 0x54 },
    { L"Super Janemba",                     0x1573A490, 0x1573A890, indexDBZEB_ZAssists, 0x55 },
    { L"Super Vegito",                      0x158D11A0, 0x158D15A0, indexDBZEB_ZAssists, 0x56 },
    { L"Tapion",                            0x1588C210, 0x1588C610, indexDBZEB_ZAssists, 0x57 },
    { L"Tien Shinhan",                      0x15892260, 0x15892660, indexDBZEB_ZAssists, 0x58 },
    { L"Trunks",                            0x1589FBA0, 0x1589FFA0, indexDBZEB_ZAssists, 0x59 },
    { L"Turles",                            0x158A8C00, 0x158A9000, indexDBZEB_ZAssists, 0x5a },
    { L"Turtle",                            0x158BF490, 0x158BF890, indexDBZEB_ZAssists, 0x5b },
    { L"Uub",                               0x158BBF40, 0x158BC340, indexDBZEB_ZAssists, 0x5c },
    { L"Vegeta (GT) (Super Saiyan 4)",      0x158D8920, 0x158D8D20, indexDBZEB_ZAssists, 0x5e },
    { L"Vegeta (SSGSS)",                    0x158ED5E0, 0x158ED9E0, indexDBZEB_ZAssists, 0x5d },
    { L"Videl",                             0x158E1410, 0x158E1810, indexDBZEB_ZAssists, 0x5f },
    { L"Whis",                              0x158F31B0, 0x158F35B0, indexDBZEB_ZAssists, 0x60 },
    { L"World Tournament Announcer",        0x155DCEB0, 0x155DD2B0, indexDBZEB_ZAssists, 0x61 },
    { L"Yajirobe",                          0x158F8220, 0x158F8620, indexDBZEB_ZAssists, 0x62 },
    { L"Yakon",                             0x1590D850, 0x1590DC50, indexDBZEB_ZAssists, 0x63 },
    { L"Yamcha",                            0x158FF240, 0x158FF640, indexDBZEB_ZAssists, 0x64 },
    { L"Yamu",                              0x15911440, 0x15911840, indexDBZEB_ZAssists, 0x65 },
    { L"Zarbon",                            0x15919F40, 0x1591A340, indexDBZEB_ZAssists, 0x66 },
};
