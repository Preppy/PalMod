...
const std::vector<UINT16> KOF96_A_IMGIDS_USED =
{
...
const sGame_PaletteDataset KOF96_A_KYO_A_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1020c2, 0x1020e2, indexKOF96Sprites_Kyo, 0x00 },
...
const sGame_PaletteDataset KOF96_A_KYO_D_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1022c2, 0x1022e2, indexKOF96Sprites_Kyo, 0x00 },
...
const sGame_PaletteDataset KOF96_A_BENIMARU_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x102442, 0x102462, indexKOF96Sprites_Benimaru, 0x00 },
...
const sGame_PaletteDataset KOF96_A_BENIMARU_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x102642, 0x102662, indexKOF96Sprites_Benimaru, 0x00 },
...
const sGame_PaletteDataset KOF96_A_DAIMON_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x102842, 0x102862, indexKOF96Sprites_Daimon, 0x00 },
...
const sGame_PaletteDataset KOF96_A_DAIMON_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x102a42, 0x102a62, indexKOF96Sprites_Daimon, 0x00 },
...
const sGame_PaletteDataset KOF96_A_TERRY_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x102c42, 0x102c62, indexKOF96Sprites_Terry, 0x00 },
...
const sGame_PaletteDataset KOF96_A_TERRY_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x102e42, 0x102e62, indexKOF96Sprites_Terry, 0x00 },
...
const sGame_PaletteDataset KOF96_A_ANDY_A_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1030c2, 0x1030e2, indexKOF96Sprites_Andy, 0x00 },
...
const sGame_PaletteDataset KOF96_A_ANDY_D_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1032c2, 0x1032e2, indexKOF96Sprites_Andy, 0x00 },
...
const sGame_PaletteDataset KOF96_A_JOE_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x103442, 0x103462, indexKOF96Sprites_Joe, 0x00 },
...
const sGame_PaletteDataset KOF96_A_JOE_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x103642, 0x103662, indexKOF96Sprites_Joe, 0x00 },
...
const sGame_PaletteDataset KOF96_A_RYO_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x103842, 0x103862, indexKOF96Sprites_Ryo, 0x00 },
...
const sGame_PaletteDataset KOF96_A_RYO_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x103a42, 0x103a62, indexKOF96Sprites_Ryo, 0x00 },
...
const sGame_PaletteDataset KOF96_A_ROBERT_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x103c42, 0x103c62, indexKOF96Sprites_Robert, 0x00 },
...
const sGame_PaletteDataset KOF96_A_ROBERT_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x103e42, 0x103e62, indexKOF96Sprites_Robert, 0x00 },
...
const sGame_PaletteDataset KOF96_A_YURI_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x104042, 0x104062, indexKOF96Sprites_Yuri, 0x00 },
...
const sGame_PaletteDataset KOF96_A_YURI_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x104242, 0x104262, indexKOF96Sprites_Yuri, 0x00 },
...
const sGame_PaletteDataset KOF96_A_LEONA_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x104442, 0x104462, indexKOF96Sprites_Leona, 0x00 },
...
const sGame_PaletteDataset KOF96_A_LEONA_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x104642, 0x104662, indexKOF96Sprites_Leona, 0x00 },
...
const sGame_PaletteDataset KOF96_A_RALF_A_PALETTES[] =
{
    ...
    { L"Extra 1", 0x104822, 0x104842, indexKOF96Sprites_Ralf, 0x01 },
    { L"Super Trail 1", 0x104842, 0x104862, indexKOF96Sprites_Ralf, 0x00, &pairNext },
    { L"Super Trail 2", 0x104862, 0x104882, indexKOF96Sprites_Ralf, 0x01 },
...
const sGame_PaletteDataset KOF96_A_RALF_D_PALETTES[] =
{
    ...
    { L"Extra 1", 0x104a22, 0x104a42, indexKOF96Sprites_Ralf, 0x01 },
    { L"Super Trail 1", 0x104a42, 0x104a62, indexKOF96Sprites_Ralf, 0x00, &pairNext },
    { L"Super Trail 2", 0x104a62, 0x104a82, indexKOF96Sprites_Ralf, 0x01 },
...
const sGame_PaletteDataset KOF96_A_CLARK_A_PALETTES[] =
{
    ...
    { L"Extra 1", 0x104c22, 0x104c42, indexKOF96Sprites_Clark, 0x01 },
    { L"Super Trail 1", 0x104c42, 0x104c62, indexKOF96Sprites_Clark, 0x00, &pairNext },
    { L"Super Trail 2", 0x104c62, 0x104c82, indexKOF96Sprites_Clark, 0x01 },
...
const sGame_PaletteDataset KOF96_A_CLARK_D_PALETTES[] =
{
    ...
    { L"Extra 1", 0x104e22, 0x104e42, indexKOF96Sprites_Clark, 0x01 },
    { L"Super Trail 1", 0x104e42, 0x104e62, indexKOF96Sprites_Clark, 0x00, &pairNext },
    { L"Super Trail 2", 0x104e62, 0x104e82, indexKOF96Sprites_Clark, 0x01 },
...
const sGame_PaletteDataset KOF96_A_KENSOU_A_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1054c2, 0x1054e2, indexKOF96Sprites_Kensou, 0x00 },
...
const sGame_PaletteDataset KOF96_A_KENSOU_D_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1056c2, 0x1056e2, indexKOF96Sprites_Kensou, 0x00 },
...
const sGame_PaletteDataset KOF96_A_CHIN_A_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1058c2, 0x1058e2, indexKOF96Sprites_Chin, 0x00 },
...
const sGame_PaletteDataset KOF96_A_CHIN_D_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x105ac2, 0x105ae2, indexKOF96Sprites_Chin, 0x00 },
...
const sGame_PaletteDataset KOF96_A_MAI_A_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1060c2, 0x1060e2, indexKOF96Sprites_Mai, 0x00 },
...
const sGame_PaletteDataset KOF96_A_MAI_D_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1062c2, 0x1062e2, indexKOF96Sprites_Mai, 0x00 },
...
const sGame_PaletteDataset KOF96_A_KIM_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x106842, 0x106862, indexKOF96Sprites_Kim, 0x00 },
...
const sGame_PaletteDataset KOF96_A_KIM_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x106a42, 0x106a62, indexKOF96Sprites_Kim, 0x00 },
...
const sGame_PaletteDataset KOF96_A_CHANG_A_PALETTES[] =
{
    ...
    { L"Extra 1", 0x106c22, 0x106c42, indexKOF96Sprites_Chang, 0x01 },
    { L"Super Trail 1", 0x106c42, 0x106c62, indexKOF96Sprites_Chang, 0x00, &pairNext },
    { L"Super Trail 2", 0x106c62, 0x106c82, indexKOF96Sprites_Chang, 0x01 },
...
const sGame_PaletteDataset KOF96_A_CHANG_D_PALETTES[] =
{
    ...
    { L"Extra 1", 0x106e22, 0x106e42, indexKOF96Sprites_Chang, 0x01 },
    { L"Super Trail 1", 0x106e42, 0x106e62, indexKOF96Sprites_Chang, 0x00, &pairNext },
    { L"Super Trail 2", 0x106e62, 0x106e82, indexKOF96Sprites_Chang, 0x01 },
...
const sGame_PaletteDataset KOF96_A_CHOI_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107042, 0x107062, indexKOF96Sprites_Choi, 0x00 },
...
const sGame_PaletteDataset KOF96_A_CHOI_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107242, 0x107262, indexKOF96Sprites_Choi, 0x00 },
...
const sGame_PaletteDataset KOF96_A_IORI_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107442, 0x107462, indexKOF96Sprites_Iori, 0x00 },
...
const sGame_PaletteDataset KOF96_A_IORI_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107642, 0x107662, indexKOF96Sprites_Iori, 0x00 },
...
const sGame_PaletteDataset KOF96_A_MATURE_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107842, 0x107862, indexKOF96Sprites_Mature, 0x00 },
...
const sGame_PaletteDataset KOF96_A_MATURE_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107a42, 0x107a62, indexKOF96Sprites_Mature, 0x00 },
...
const sGame_PaletteDataset KOF96_A_VICE_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107c42, 0x107c62, indexKOF96Sprites_Vice, 0x00 },
...
const sGame_PaletteDataset KOF96_A_VICE_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x107e42, 0x107e62, indexKOF96Sprites_Vice, 0x00 },
...
const sGame_PaletteDataset KOF96_A_GEESE_A_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x108042, 0x108062, indexKOF96Sprites_Geese, 0x00 },
...
const sGame_PaletteDataset KOF96_A_GEESE_D_PALETTES[] =
{
    ...
    { L"Super Trail 1", 0x108242, 0x108262, indexKOF96Sprites_Geese, 0x00 },
...
const sGame_PaletteDataset KOF96_A_GOENITZ_A_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1090c2, 0x1090e2, indexKOF96Sprites_Goenitz, 0x00 },
...
const sGame_PaletteDataset KOF96_A_GOENITZ_D_PALETTES[] =
{
    ...
    { L"Electric Palette?", 0x1092c2, 0x1092e2, indexKOF96Sprites_Goenitz, 0x00 },
