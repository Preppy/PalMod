...
const sGame_PaletteDataset KOF96_A_BENIMARU_A_PALETTES[] =
{
    ...
    { L"Special Moves and DMs Effects", 0x102502, 0x102522 },
...
const sGame_PaletteDataset KOF96_A_BENIMARU_D_PALETTES[] =
{
    ...
    { L"Special Moves and DMs Effects", 0x102702, 0x102722 },
...
const sGame_PaletteDataset KOF96_A_BONUS_HUD_PALETTES[] =
{
    ...
    { L"Round Numbers", 0x1010e2, 0x101102, indexKOF96Sprites_Bonus, -1, &pairNextAndNext },
    { L"Round Rings", 0x101142, 0x101162 },
    { L"Round Text", 0x1011c2, 0x101202 },
    { L"Ready Go!", 0x101122, 0x101142 },
    { L"K.O.", 0x100e02, 0x100e22 },
    { L"K.O. and Game Over Transitions", 0x100b82, 0x100bc2 },
    { L"Perfect", 0x1010c2, 0x1010e2 },
    { L"Winner", 0x101182, 0x1011a2 },
    { L"Time Over and Draw Game", 0x1011a2, 0x1011c2 },
};
...
const sGame_PaletteDataset KOF96_A_BONUS_BONUS_PALETTES[] =
{
    ...
    { L"Ranking Title Text", 0x100182, 0x1001a2 },
    { L"Grayed Ranking Text", 0x100162, 0x100182 },
    { L"Ranking Background", 0x1153c2, 0x1153e2 },
    ...
    { L"Character Selection Boxes", 0x115422, 0x115482 },
    ...
    { L"Order Select Versus", 0x115482, 0x1154a2, indexKOF96Sprites_Bonus, 0x05 },
    { L"Order Select Numbers", 0x1154a2, 0x1154e2, indexKOF96Sprites_Bonus, 0x01 },
    { L"Order Select First and Second", 0x114502, 0x114542 },
    { L"Continue and Game Over Text", 0x100e22, 0x100f02 },
    { L"Continue Countdown Explosion", 0x100f02, 0x100f22 },
    { L"Continue Background", 0x100702, 0x1007c2 },
    { L"Continue Background Grayed", 0x1007c2, 0x100882 },
    { L"Here Comes Challenger Text", 0x115562, 0x115582 },
    { L"New Challenger Background", 0x115382, 0x1153a2 },
};
