...
CGame_SAMSHO2_A::~CGame_SAMSHO2_A()
{
    safe_delete_array(CGame_SAMSHO2_A::SAMSHO2_A_EXTRA_CUSTOM);
    ClearDataBuffer();
...
uint32_t CGame_SAMSHO2_A::GetExtraCt(uint32_t nUnitId, BOOL fCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, SAMSHO2_A_NUMUNIT, nUnitId, SAMSHO2_A_EXTRA_CUSTOM);
}

uint32_t CGame_SAMSHO2_A::GetExtraLoc(uint32_t nUnitId)
{
...
sFileRule CGame_SAMSHO2_A::GetRule(uint32_t nUnitId)
{
...
uint32_t CGame_SAMSHO2_A::GetCollectionCountForUnit(uint32_t nUnitId)
{
...
uint32_t CGame_SAMSHO2_A::GetNodeCountForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
...
LPCWSTR CGame_SAMSHO2_A::GetDescriptionForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetDescriptionForCollection(SAMSHO2_A_UNITS, SAMSHO2_A_EXTRALOC, nUnitId, nCollectionId);
}

uint32_t CGame_SAMSHO2_A::GetPaletteCountForUnit(uint32_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_SAMSHO2_A::GetPaletteSet(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetPaletteSet(SAMSHO2_A_UNITS, nUnitId, nCollectionId);
}

uint32_t CGame_SAMSHO2_A::GetNodeSizeFromPaletteId(uint32_t nUnitId, uint32_t nPaletteId)
{
...
const sDescTreeNode* CGame_SAMSHO2_A::GetNodeFromPaletteId(uint32_t nUnitId, uint32_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_SAMSHO2_A::GetSpecificPalette(uint32_t nUnitId, uint32_t nPaletteId)
{
...
void CGame_SAMSHO2_A::LoadSpecificPaletteData(uint32_t nUnitId, uint32_t nPalId)
{
    ...
    else // SAMSHO2_A_EXTRALOC
    {
        ...
        stExtraDef* pCurrDef = &SAMSHO2_A_EXTRA_CUSTOM[GetExtraLoc(nUnitId) + nPalId];
...
{
    return _UpdatePalImg(SAMSHO2_A_UNITS, rgExtraCountAll, SAMSHO2_A_NUMUNIT, SAMSHO2_A_EXTRALOC, SAMSHO2_A_EXTRA_CUSTOM, Node01, Node02, Node03, Node03);
}
