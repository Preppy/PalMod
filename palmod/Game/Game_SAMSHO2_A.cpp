...
size_t CGame_SAMSHO2_A::rgExtraCountAll[SAMSHO2_A_NUMUNIT + 1];
size_t CGame_SAMSHO2_A::rgExtraLoc[SAMSHO2_A_NUMUNIT + 1];
...
size_t CGame_SAMSHO2_A::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, SAMSHO2_A_NUMUNIT, nUnitId, SAMSHO2_A_EXTRA_CUSTOM);
}

size_t CGame_SAMSHO2_A::GetExtraLoc(size_t nUnitId)
{
...
sFileRule CGame_SAMSHO2_A::GetRule(size_t nUnitId)
{
...
size_t CGame_SAMSHO2_A::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_SAMSHO2_A::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_SAMSHO2_A::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(SAMSHO2_A_UNITS, SAMSHO2_A_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_SAMSHO2_A::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_SAMSHO2_A::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(SAMSHO2_A_UNITS, nUnitId, nCollectionId);
}

size_t CGame_SAMSHO2_A::GetNodeSizeFromPaletteId(size_t nUnitId, size_t nPaletteId)
{
...
const sDescTreeNode* CGame_SAMSHO2_A::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_SAMSHO2_A::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_SAMSHO2_A::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
