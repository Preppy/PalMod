...
{
    { _T("LP Main"), 0x700600, 0x700680, 0x00, 0x00 },
    { _T("LP Portrait"), 0x763be0, 0x763c00, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_MP_PALETTES[] =
{
    { _T("MP Main"), 0x700680, 0x700700, 0x00, 0x00 },
    { _T("MP Portrait"), 0x763c00, 0x763c20, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_HP_PALETTES[] =
{
    { _T("HP Main"), 0x700700, 0x700780, 0x00, 0x00 },
    { _T("HP Portrait"), 0x763c20, 0x763c40, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_LK_PALETTES[] =
{
    { _T("LK Main"), 0x700780, 0x700800, 0x00, 0x00 },
    { _T("LK Portrait"), 0x763c40, 0x763c60, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_MK_PALETTES[] =
{
    { _T("MK Main"), 0x700800, 0x700880, 0x00, 0x00 },
    { _T("MK Portrait"), 0x763c60, 0x763c80, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_HK_PALETTES[] =
{
    { _T("HK Main"), 0x700880, 0x700900, 0x00, 0x00 },
    { _T("HK Portrait"), 0x763c80, 0x763ca0, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_EX_PALETTES[] =
{
    { _T("EX Main"), 0x700900, 0x700980, 0x00, 0x00 },
    { _T("EX Portrait"), 0x763ca0, 0x763cc0, 0x00, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ALEX_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x764e00, 0x764e80, 0x00, 0 },
    { _T("EX Attack (2)"), 0x76ae00, 0x76ae80, 0x00, 0 },
    { _T("????"), 0x765c00, 0x765c80, 0x00, 0 },
    { _T("????"), 0x765c80, 0x765d00, 0x00, 0 },
    { _T("????"), 0x765d00, 0x765d80, 0x00, 0 },
    { _T("????"), 0x765d80, 0x765e00, 0x00, 0 },
    { _T("????"), 0x765e00, 0x765e80, 0x00, 0 },
    { _T("????"), 0x765e80, 0x765f00, 0x00, 0 },
    { _T("????"), 0x765f00, 0x765f80, 0x00, 0 },
...
const sGame_PaletteDataset SFIII3_A_RYU_LP_PALETTES[] =
{
    ...
    { _T("LP Portrait"), 0x763cc0, 0x763ce0, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_MP_PALETTES[] =
{
    { _T("MP Main"), 0x700a00, 0x700a80, 0x01, 0x00 },
    { _T("MP Portrait"), 0x763ce0, 0x763d00, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_HP_PALETTES[] =
{
    { _T("HP Main"), 0x700a80, 0x700b00, 0x01, 0x00 },
    { _T("HP Portrait"), 0x763d00, 0x763d20, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_LK_PALETTES[] =
{
    { _T("LK Main"), 0x700b00, 0x700b80, 0x01, 0x00 },
    { _T("LK Portrait"), 0x763d20, 0x763d40, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_MK_PALETTES[] =
{
    { _T("MK Main"), 0x700b80, 0x700c00, 0x01, 0x00 },
    { _T("MK Portrait"), 0x763d40, 0x763d60, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_HK_PALETTES[] =
{
    { _T("HK Main"), 0x700c00, 0x700c80, 0x01, 0x00 },
    { _T("HK Portrait"), 0x763d60, 0x763d80, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_EX_PALETTES[] =
{
    { _T("EX Main"), 0x700c80, 0x700d00, 0x01, 0x00 },
    { _T("EX Portrait"), 0x763d80, 0x763da0, 0x01, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_RYU_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x764e80, 0x764f00, 0x01, 0 },
    { _T("EX Attack (2)"), 0x76ae80, 0x76af00, 0x01, 0 },
    { _T("????"), 0x766000, 0x766080, 0x01, 0 },
    { _T("????"), 0x766080, 0x766100, 0x01, 0 },
    { _T("????"), 0x766100, 0x766180, 0x01, 0 },
    { _T("????"), 0x766180, 0x766200, 0x01, 0 },
    { _T("????"), 0x766200, 0x766280, 0x01, 0 },
    { _T("????"), 0x766280, 0x766300, 0x01, 0 },
    { _T("????"), 0x766300, 0x766380, 0x01, 0 },
    { _T("????"), 0x766380, 0x766400, 0x01, 0 },
};
...
{
    { _T("LP Main"), 0x700d00, 0x700d80, 0x02, 0x00 },
    { _T("LP Portrait"), 0x763da0, 0x763dc0, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_MP_PALETTES[] =
{
    { _T("MP Main"), 0x700d80, 0x700e00, 0x02, 0x00 },
    { _T("MP Portrait"), 0x763dc0, 0x763de0, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_HP_PALETTES[] =
{
    { _T("HP Main"), 0x700e00, 0x700e80, 0x02, 0x00 },
    { _T("HP Portrait"), 0x763de0, 0x763e00, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_LK_PALETTES[] =
{
    { _T("LK Main"), 0x700e80, 0x700f00, 0x02, 0x00 },
    { _T("LK Portrait"), 0x763e00, 0x763e20, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_MK_PALETTES[] =
{
    { _T("MK Main"), 0x700f00, 0x700f80, 0x02, 0x00 },
    { _T("MK Portrait"), 0x763e20, 0x763e40, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_HK_PALETTES[] =
{
    { _T("HK Main"), 0x700f80, 0x701000, 0x02, 0x00 },
    { _T("HK Portrait"), 0x763e40, 0x763e60, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_EX_PALETTES[] =
{
    { _T("EX Main"), 0x701000, 0x701080, 0x02, 0x00 },
    { _T("EX Portrait"), 0x763e60, 0x763e80, 0x02, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YUN_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x764f00, 0x764f80, 0x02, 0 },
    { _T("EX Attack (2)"), 0x76af00, 0x76af80, 0x02, 0 },
    { _T("????"), 0x766400, 0x766480, 0x02, 0 },
    { _T("????"), 0x766480, 0x766500, 0x02, 0 },
    { _T("????"), 0x766500, 0x766580, 0x02, 0 },
    { _T("????"), 0x766580, 0x766600, 0x02, 0 },
    { _T("????"), 0x766600, 0x766680, 0x02, 0 },
    { _T("????"), 0x766680, 0x766700, 0x02, 0 },
    { _T("????"), 0x766700, 0x766780, 0x02, 0 },
    { _T("????"), 0x766780, 0x766800, 0x02, 0 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_LP_PALETTES[] =
{
    { _T("LP Main"), 0x701080, 0x701100, 0x03, 0x00 },
    { _T("LP Portrait"), 0x763e80, 0x763ea0, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_MP_PALETTES[] =
{
    { _T("MP Main"), 0x701100, 0x701180, 0x03, 0x00 },
    { _T("MP Portrait"), 0x763ea0, 0x763ec0, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_HP_PALETTES[] =
{
    { _T("HP Main"), 0x701180, 0x701200, 0x03, 0x00 },
    { _T("HP Portrait"), 0x763ec0, 0x763ee0, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_LK_PALETTES[] =
{
    { _T("LK Main"), 0x701200, 0x701280, 0x03, 0x00 },
    { _T("LK Portrait"), 0x763ee0, 0x763f00, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_MK_PALETTES[] =
{
    { _T("MK Main"), 0x701280, 0x701300, 0x03, 0x00 },
    { _T("MK Portrait"), 0x763f00, 0x763f20, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_HK_PALETTES[] =
{
    { _T("HK Main"), 0x701300, 0x701380, 0x03, 0x00 },
    { _T("HK Portrait"), 0x763f20, 0x763f40, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_EX_PALETTES[] =
{
    { _T("EX Main"), 0x701380, 0x701400, 0x03, 0x00 },
    { _T("EX Portrait"), 0x763f40, 0x763f60, 0x03, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_DUDLEY_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x764f80, 0x765000, 0x03, 0 },
    { _T("EX Attack (2)"), 0x76af80, 0x76b000, 0x03, 0 },
    { _T("????"), 0x766800, 0x766880, 0x03, 0 },
    { _T("????"), 0x766880, 0x766900, 0x03, 0 },
    { _T("????"), 0x766900, 0x766980, 0x03, 0 },
    { _T("????"), 0x766980, 0x766a00, 0x03, 0 },
    { _T("????"), 0x766a00, 0x766a80, 0x03, 0 },
    { _T("????"), 0x766a80, 0x766b00, 0x03, 0 },
    { _T("????"), 0x766b00, 0x766b80, 0x03, 0 },
...
const sGame_PaletteDataset SFIII3_A_NECRO_LP_PALETTES[] =
{
    ...
    { _T("LP Portrait"), 0x763f60, 0x763f80, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_MP_PALETTES[] =
{
    { _T("MP Main"), 0x701480, 0x701500, 0x04, 0x00 },
    { _T("MP Portrait"), 0x763f80, 0x763fa0, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_HP_PALETTES[] =
{
    { _T("HP Main"), 0x701500, 0x701580, 0x04, 0x00 },
    { _T("HP Portrait"), 0x763fa0, 0x763fc0, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_LK_PALETTES[] =
{
    { _T("LK Main"), 0x701580, 0x701600, 0x04, 0x00 },
    { _T("LK Portrait"), 0x763fc0, 0x763fe0, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_MK_PALETTES[] =
{
    { _T("MK Main"), 0x701600, 0x701680, 0x04, 0x00 },
    { _T("MK Portrait"), 0x763fe0, 0x764000, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_HK_PALETTES[] =
{
    { _T("HK Main"), 0x701680, 0x701700, 0x04, 0x00 },
    { _T("HK Portrait"), 0x764000, 0x764020, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_EX_PALETTES[] =
{
    { _T("EX Main"), 0x701700, 0x701780, 0x04, 0x00 },
    { _T("EX Portrait"), 0x764020, 0x764040, 0x04, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_NECRO_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765000, 0x765080, 0x04, 0 },
    { _T("EX Attack (2)"), 0x76b000, 0x76b080, 0x04, 0 },
    { _T("????"), 0x766c00, 0x766c80, 0x04, 0 },
    { _T("????"), 0x766c80, 0x766d00, 0x04, 0 },
    { _T("????"), 0x766d00, 0x766d80, 0x04, 0 },
    { _T("????"), 0x766d80, 0x766e00, 0x04, 0 },
    { _T("????"), 0x766e00, 0x766e80, 0x04, 0 },
    { _T("????"), 0x766e80, 0x766f00, 0x04, 0 },
    { _T("????"), 0x766f00, 0x766f80, 0x04, 0 },
    { _T("????"), 0x766f80, 0x767000, 0x04, 0 },
};
...
{
    { _T("LP Main"), 0x701780, 0x701800, 0x05, 0x00 },
    { _T("LP Portrait"), 0x764040, 0x764060, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_MP_PALETTES[] =
{
    { _T("MP Main"), 0x701800, 0x701880, 0x05, 0x00 },
    { _T("MP Portrait"), 0x764060, 0x764080, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_HP_PALETTES[] =
{
    { _T("HP Main"), 0x701880, 0x701900, 0x05, 0x00 },
    { _T("HP Portrait"), 0x764080, 0x7640a0, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_LK_PALETTES[] =
{
    { _T("LK Main"), 0x701900, 0x701980, 0x05, 0x00 },
    { _T("LK Portrait"), 0x7640a0, 0x7640c0, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_MK_PALETTES[] =
{
    { _T("MK Main"), 0x701980, 0x701a00, 0x05, 0x00 },
    { _T("MK Portrait"), 0x7640c0, 0x7640e0, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_HK_PALETTES[] =
{
    { _T("HK Main"), 0x701a00, 0x701a80, 0x05, 0x00 },
    { _T("HK Portrait"), 0x7640e0, 0x764100, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_EX_PALETTES[] =
{
    { _T("EX Main"), 0x701a80, 0x701b00, 0x05, 0x00 },
    { _T("EX Portrait"), 0x764100, 0x764120, 0x05, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765080, 0x765100, 0x05, 0 },
    { _T("EX Attack (2)"), 0x76b080, 0x76b100, 0x05, 0 },
    { _T("????"), 0x767000, 0x767080, 0x05, 0 },
    { _T("????"), 0x767080, 0x767100, 0x05, 0 },
    { _T("????"), 0x767100, 0x767180, 0x05, 0 },
    { _T("????"), 0x767180, 0x767200, 0x05, 0 },
    { _T("????"), 0x767200, 0x767280, 0x05, 0 },
    { _T("????"), 0x767280, 0x767300, 0x05, 0 },
    { _T("????"), 0x767300, 0x767380, 0x05, 0 },
    { _T("????"), 0x767380, 0x767400, 0x05, 0 },
};

const sGame_PaletteDataset SFIII3_A_HUGO_EXTRA_PALETTES[] =
{
    //Hugo
    { _T("Poison P1"), 0x705880, 0x705900, 0x05, 0x02 },
    { _T("Poison P2"), 0x705900, 0x705980, 0x05, 0x02 },
    { _T("Poison EX"), 0x705980, 0x705A00, 0x05, 0x02 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_LP_PALETTES[] =
{
    { _T("LP Main"), 0x701b00, 0x701b80, 0x06, 0x00 },
    { _T("LP Portrait"), 0x764120, 0x764140, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_MP_PALETTES[] =
{
    { _T("MP Main"), 0x701b80, 0x701c00, 0x06, 0x00 },
    { _T("MP Portrait"), 0x764140, 0x764160, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_HP_PALETTES[] =
{
    { _T("HP Main"), 0x701c00, 0x701c80, 0x06, 0x00 },
    { _T("HP Portrait"), 0x764160, 0x764180, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_LK_PALETTES[] =
{
    { _T("LK Main"), 0x701c80, 0x701d00, 0x06, 0x00 },
    { _T("LK Portrait"), 0x764180, 0x7641a0, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_MK_PALETTES[] =
{
    { _T("MK Main"), 0x701d00, 0x701d80, 0x06, 0x00 },
    { _T("MK Portrait"), 0x7641a0, 0x7641c0, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_HK_PALETTES[] =
{
    { _T("HK Main"), 0x701d80, 0x701e00, 0x06, 0x00 },
    { _T("HK Portrait"), 0x7641c0, 0x7641e0, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_EX_PALETTES[] =
{
    { _T("EX Main"), 0x701e00, 0x701e80, 0x06, 0x00 },
    { _T("EX Portrait"), 0x7641e0, 0x764200, 0x06, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_IBUKI_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765100, 0x765180, 0x06, 0 },
    { _T("EX Attack (2)"), 0x76b100, 0x76b180, 0x06, 0 },
    { _T("????"), 0x767400, 0x767480, 0x06, 0 },
    { _T("????"), 0x767480, 0x767500, 0x06, 0 },
    { _T("????"), 0x767500, 0x767580, 0x06, 0 },
    { _T("????"), 0x767580, 0x767600, 0x06, 0 },
    { _T("????"), 0x767600, 0x767680, 0x06, 0 },
    { _T("????"), 0x767680, 0x767700, 0x06, 0 },
    { _T("????"), 0x767700, 0x767780, 0x06, 0 },
...
const sGame_PaletteDataset SFIII3_A_ELENA_LP_PALETTES[] =
{
    ...
    { _T("LP Portrait"), 0x764200, 0x764220, 0x07, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ELENA_MP_PALETTES[] =
{
    { _T("MP Main"), 0x701f00, 0x701f80, 0x07, 0x00 },
    { _T("MP Portrait"), 0x764220, 0x764240, 0x07, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ELENA_HP_PALETTES[] =
{
    { _T("HP Main"), 0x701f80, 0x702000, 0x07, 0x00 },
    { _T("HP Portrait"), 0x764240, 0x764260, 0x07, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ELENA_LK_PALETTES[] =
{
    { _T("LK Main"), 0x702000, 0x702080, 0x07, 0x00 },
    { _T("LK Portrait"), 0x764260, 0x764280, 0x07, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ELENA_MK_PALETTES[] =
{
    { _T("MK Main"), 0x702080, 0x702100, 0x07, 0x00 },
    { _T("MK Portrait"), 0x764280, 0x7642a0, 0x07, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ELENA_HK_PALETTES[] =
{
    { _T("HK Main"), 0x702100, 0x702180, 0x07, 0x00 },
    { _T("HK Portrait"), 0x7642a0, 0x7642c0, 0x07, 0x01 },
};
...
{
    { _T("EX Attack (1)"), 0x765180, 0x765200, 0x07, 0 },
    { _T("EX Attack (2)"), 0x76b180, 0x76b200, 0x07, 0 },
    { _T("????"), 0x767800, 0x767880, 0x07, 0 },
    { _T("????"), 0x767880, 0x767900, 0x07, 0 },
    { _T("????"), 0x767900, 0x767980, 0x07, 0 },
    { _T("????"), 0x767980, 0x767a00, 0x07, 0 },
    { _T("????"), 0x767a00, 0x767a80, 0x07, 0 },
    { _T("????"), 0x767a80, 0x767b00, 0x07, 0 },
    { _T("????"), 0x767b00, 0x767b80, 0x07, 0 },
    { _T("????"), 0x767b80, 0x767c00, 0x07, 0 },
};

const sGame_PaletteDataset SFIII3_A_ORO_LP_PALETTES[] =
{
    { _T("LP Main"), 0x702200, 0x702280, 0x08, 0x00 },
    { _T("LP Portrait"), 0x7642e0, 0x764300, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_MP_PALETTES[] =
{
    { _T("MP Main"), 0x702280, 0x702300, 0x08, 0x00 },
    { _T("MP Portrait"), 0x764300, 0x764320, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_HP_PALETTES[] =
{
    { _T("HP Main"), 0x702300, 0x702380, 0x08, 0x00 },
    { _T("HP Portrait"), 0x764320, 0x764340, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_LK_PALETTES[] =
{
    { _T("LK Main"), 0x702380, 0x702400, 0x08, 0x00 },
    { _T("LK Portrait"), 0x764340, 0x764360, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_MK_PALETTES[] =
{
    { _T("MK Main"), 0x702400, 0x702480, 0x08, 0x00 },
    { _T("MK Portrait"), 0x764360, 0x764380, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_HK_PALETTES[] =
{
    { _T("HK Main"), 0x702480, 0x702500, 0x08, 0x00 },
    { _T("HK Portrait"), 0x764380, 0x7643a0, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_EX_PALETTES[] =
{
    { _T("EX Main"), 0x702500, 0x702580, 0x08, 0x00 },
    { _T("EX Portrait"), 0x7643a0, 0x7643c0, 0x08, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_ORO_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765200, 0x765280, 0x08, 0 },
    { _T("EX Attack (2)"), 0x76b200, 0x76b280, 0x08, 0 },
    { _T("????"), 0x767c00, 0x767c80, 0x08, 0 },
    { _T("????"), 0x767c80, 0x767d00, 0x08, 0 },
    { _T("????"), 0x767d00, 0x767d80, 0x08, 0 },
    { _T("????"), 0x767d80, 0x767e00, 0x08, 0 },
    { _T("????"), 0x767e00, 0x767e80, 0x08, 0 },
    { _T("????"), 0x767e80, 0x767f00, 0x08, 0 },
    { _T("????"), 0x767f00, 0x767f80, 0x08, 0 },
    { _T("????"), 0x767f80, 0x768000, 0x08, 0 },
};
...
{
    { _T("LP Main"), 0x702580, 0x702600, 0x09, 0x00 },
    { _T("LP Portrait"), 0x7643c0, 0x7643e0, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_MP_PALETTES[] =
{
    { _T("MP Main"), 0x702600, 0x702680, 0x09, 0x00 },
    { _T("MP Portrait"), 0x7643e0, 0x764400, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_HP_PALETTES[] =
{
    { _T("HP Main"), 0x702680, 0x702700, 0x09, 0x00 },
    { _T("HP Portrait"), 0x764400, 0x764420, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_LK_PALETTES[] =
{
    { _T("LK Main"), 0x702700, 0x702780, 0x09, 0x00 },
    { _T("LK Portrait"), 0x764420, 0x764440, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_MK_PALETTES[] =
{
    { _T("MK Main"), 0x702780, 0x702800, 0x09, 0x00 },
    { _T("MK Portrait"), 0x764440, 0x764460, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_HK_PALETTES[] =
{
    { _T("HK Main"), 0x702800, 0x702880, 0x09, 0x00 },
    { _T("HK Portrait"), 0x764460, 0x764480, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_EX_PALETTES[] =
{
    { _T("EX Main"), 0x702880, 0x702900, 0x09, 0x00 },
    { _T("EX Portrait"), 0x764480, 0x7644a0, 0x09, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_YANG_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765280, 0x765300, 0x09, 0 },
    { _T("EX Attack (2)"), 0x76b280, 0x76b300, 0x09, 0 },
    { _T("????"), 0x768000, 0x768080, 0x09, 0 },
    { _T("????"), 0x768080, 0x768100, 0x09, 0 },
    { _T("????"), 0x768100, 0x768180, 0x09, 0 },
    { _T("????"), 0x768180, 0x768200, 0x09, 0 },
    { _T("????"), 0x768200, 0x768280, 0x09, 0 },
    { _T("????"), 0x768280, 0x768300, 0x09, 0 },
    { _T("????"), 0x768300, 0x768380, 0x09, 0 },
    { _T("????"), 0x768380, 0x768400, 0x09, 0 },
};

const sGame_PaletteDataset SFIII3_A_KEN_LP_PALETTES[] =
{
    { _T("LP Main"), 0x702900, 0x702980, 0x0a, 0x00 },
    { _T("LP Portrait"), 0x7644a0, 0x7644c0, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_MP_PALETTES[] =
{
    { _T("MP Main"), 0x702980, 0x702a00, 0x0a, 0x00 },
    { _T("MP Portrait"), 0x7644c0, 0x7644e0, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_HP_PALETTES[] =
{
    { _T("HP Main"), 0x702a00, 0x702a80, 0x0a, 0x00 },
    { _T("HP Portrait"), 0x7644e0, 0x764500, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_LK_PALETTES[] =
{
    { _T("LK Main"), 0x702a80, 0x702b00, 0x0a, 0x00 },
    { _T("LK Portrait"), 0x764500, 0x764520, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_MK_PALETTES[] =
{
    { _T("MK Main"), 0x702b00, 0x702b80, 0x0a, 0x00 },
    { _T("MK Portrait"), 0x764520, 0x764540, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_HK_PALETTES[] =
{
    { _T("HK Main"), 0x702b80, 0x702c00, 0x0a, 0x00 },
    { _T("HK Portrait"), 0x764540, 0x764560, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_EX_PALETTES[] =
{
    { _T("EX Main"), 0x702c00, 0x702c80, 0x0a, 0x00 },
    { _T("EX Portrait"), 0x764560, 0x764580, 0x0a, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_KEN_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765300, 0x765380, 0x0a, 0 },
    { _T("EX Attack (2)"), 0x76b300, 0x76b380, 0x0a, 0 },
    { _T("????"), 0x768400, 0x768480, 0x0a, 0 },
    { _T("????"), 0x768480, 0x768500, 0x0a, 0 },
    { _T("????"), 0x768500, 0x768580, 0x0a, 0 },
    { _T("????"), 0x768580, 0x768600, 0x0a, 0 },
    { _T("????"), 0x768600, 0x768680, 0x0a, 0 },
    { _T("????"), 0x768680, 0x768700, 0x0a, 0 },
    { _T("????"), 0x768700, 0x768780, 0x0a, 0 },
    { _T("????"), 0x768780, 0x768800, 0x0a, 0 },
};
...
{
    { _T("LP Main"), 0x702c80, 0x702d00, 0x0b, 0x00 },
    { _T("LP Portrait"), 0x764580, 0x7645a0, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_MP_PALETTES[] =
{
    { _T("MP Main"), 0x702d00, 0x702d80, 0x0b, 0x00 },
    { _T("MP Portrait"), 0x7645a0, 0x7645c0, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_HP_PALETTES[] =
{
    { _T("HP Main"), 0x702d80, 0x702e00, 0x0b, 0x00 },
    { _T("HP Portrait"), 0x7645c0, 0x7645e0, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_LK_PALETTES[] =
{
    { _T("LK Main"), 0x702e00, 0x702e80, 0x0b, 0x00 },
    { _T("LK Portrait"), 0x7645e0, 0x764600, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_MK_PALETTES[] =
{
    { _T("MK Main"), 0x702e80, 0x702f00, 0x0b, 0x00 },
    { _T("MK Portrait"), 0x764600, 0x764620, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_HK_PALETTES[] =
{
    { _T("HK Main"), 0x702f00, 0x702f80, 0x0b, 0x00 },
    { _T("HK Portrait"), 0x764620, 0x764640, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_EX_PALETTES[] =
{
    { _T("EX Main"), 0x702f80, 0x703000, 0x0b, 0x00 },
    { _T("EX Portrait"), 0x764640, 0x764660, 0x0b, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_SEAN_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765380, 0x765400, 0x0b, 0 },
    { _T("EX Attack (2)"), 0x76b380, 0x76b400, 0x0b, 0 },
    { _T("????"), 0x768800, 0x768880, 0x0b, 0 },
    { _T("????"), 0x768880, 0x768900, 0x0b, 0 },
    { _T("????"), 0x768900, 0x768980, 0x0b, 0 },
    { _T("????"), 0x768980, 0x768a00, 0x0b, 0 },
    { _T("????"), 0x768a00, 0x768a80, 0x0b, 0 },
    { _T("????"), 0x768a80, 0x768b00, 0x0b, 0 },
    { _T("????"), 0x768b00, 0x768b80, 0x0b, 0 },
    { _T("????"), 0x768b80, 0x768c00, 0x0b, 0 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_LP_PALETTES[] =
{
    { _T("LP Main"), 0x703000, 0x703080, 0x0c, 0x00 },
    { _T("LP Portrait"), 0x764660, 0x764680, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_MP_PALETTES[] =
{
    { _T("MP Main"), 0x703080, 0x703100, 0x0c, 0x00 },
    { _T("MP Portrait"), 0x764680, 0x7646a0, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_HP_PALETTES[] =
{
    { _T("HP Main"), 0x703100, 0x703180, 0x0c, 0x00 },
    { _T("HP Portrait"), 0x7646a0, 0x7646c0, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_LK_PALETTES[] =
{
    { _T("LK Main"), 0x703180, 0x703200, 0x0c, 0x00 },
    { _T("LK Portrait"), 0x7646c0, 0x7646e0, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_MK_PALETTES[] =
{
    { _T("MK Main"), 0x703200, 0x703280, 0x0c, 0x00 },
    { _T("MK Portrait"), 0x7646e0, 0x764700, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_HK_PALETTES[] =
{
    { _T("HK Main"), 0x703280, 0x703300, 0x0c, 0x00 },
    { _T("HK Portrait"), 0x764700, 0x764720, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_EX_PALETTES[] =
{
    { _T("EX Main"), 0x703300, 0x703380, 0x0c, 0x00 },
    { _T("EX Portrait"), 0x764720, 0x764740, 0x0c, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_URIEN_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765400, 0x765480, 0x0c, 0 },
    { _T("EX Attack (2)"), 0x76b400, 0x76b480, 0x0c, 0 },
    { _T("????"), 0x768c00, 0x768c80, 0x0c, 0 },
    { _T("????"), 0x768c80, 0x768d00, 0x0c, 0 },
    { _T("????"), 0x768d00, 0x768d80, 0x0c, 0 },
    { _T("????"), 0x768d80, 0x768e00, 0x0c, 0 },
    { _T("????"), 0x768e00, 0x768e80, 0x0c, 0 },
    { _T("????"), 0x768e80, 0x768f00, 0x0c, 0 },
    { _T("????"), 0x768f00, 0x768f80, 0x0c, 0 },
    { _T("????"), 0x768f80, 0x769000, 0x0c, 0 },
};
...
{
    { _T("LP Main"), 0x703380, 0x703400, 0x0d, 0x00 },
    { _T("LP Portrait"), 0x764740, 0x764760, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_MP_PALETTES[] =
{
    { _T("MP Main"), 0x703400, 0x703480, 0x0d, 0x00 },
    { _T("MP Portrait"), 0x764760, 0x764780, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_HP_PALETTES[] =
{
    { _T("HP Main"), 0x703480, 0x703500, 0x0d, 0x00 },
    { _T("HP Portrait"), 0x764780, 0x7647a0, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_LK_PALETTES[] =
{
    { _T("LK Main"), 0x703500, 0x703580, 0x0d, 0x00 },
    { _T("LK Portrait"), 0x7647a0, 0x7647c0, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_MK_PALETTES[] =
{
    { _T("MK Main"), 0x703580, 0x703600, 0x0d, 0x00 },
    { _T("MK Portrait"), 0x7647c0, 0x7647e0, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_HK_PALETTES[] =
{
    { _T("HK Main"), 0x703600, 0x703680, 0x0d, 0x00 },
    { _T("HK Portrait"), 0x7647e0, 0x764800, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_EX_PALETTES[] =
{
    { _T("EX Main"), 0x703680, 0x703700, 0x0d, 0x00 },
    { _T("EX Portrait"), 0x764800, 0x764820, 0x0d, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_GOUKI_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765480, 0x765500, 0x0d, 0 },
    { _T("EX Attack (2)"), 0x76b480, 0x76b500, 0x0d, 0 },
    { _T("????"), 0x769000, 0x769080, 0x0d, 0 },
    { _T("SA Animation 1/Parry"), 0x769080, 0x769100, 0x0d, 0 },
    { _T("SA Animation 2"), 0x769100, 0x769180, 0x0d, 0 },
    { _T("SA Animation 3"), 0x769180, 0x769200, 0x0d, 0 },
    { _T("????"), 0x769200, 0x769280, 0x0d, 0 },
    { _T("????"), 0x769280, 0x769300, 0x0d, 0 },
    { _T("????"), 0x769300, 0x769380, 0x0d, 0 },
    { _T("????"), 0x769380, 0x769400, 0x0d, 0 },
};
...
{
    { _T("LP Main"), 0x703800, 0x703880, 0x0f, 0x00 },
    { _T("LP Portrait"), 0x764900, 0x764920, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_MP_PALETTES[] =
{
    { _T("MP Main"), 0x703880, 0x703900, 0x0f, 0x00 },
    { _T("MP Portrait"), 0x764920, 0x764940, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_HP_PALETTES[] =
{
    { _T("HP Main"), 0x703900, 0x703980, 0x0f, 0x00 },
    { _T("HP Portrait"), 0x764940, 0x764960, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_LK_PALETTES[] =
{
    { _T("LK Main"), 0x703980, 0x703a00, 0x0f, 0x00 },
    { _T("LK Portrait"), 0x764960, 0x764980, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_MK_PALETTES[] =
{
    { _T("MK Main"), 0x703a00, 0x703a80, 0x0f, 0x00 },
    { _T("MK Portrait"), 0x764980, 0x7649a0, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_HK_PALETTES[] =
{
    { _T("HK Main"), 0x703a80, 0x703b00, 0x0f, 0x00 },
    { _T("HK Portrait"), 0x7649a0, 0x7649c0, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_EX_PALETTES[] =
{
    { _T("EX Main"), 0x703b00, 0x703b80, 0x0f, 0x00 },
    { _T("EX Portrait"), 0x7649c0, 0x7649e0, 0x0f, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_CHUNLI_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765580, 0x765600, 0x0f, 0 },
    { _T("EX Attack (2)"), 0x76b580, 0x76b600, 0x0f, 0 },
    { _T("????"), 0x769800, 0x769880, 0x0f, 0 },
    { _T("????"), 0x769880, 0x769900, 0x0f, 0 },
    { _T("????"), 0x769900, 0x769980, 0x0f, 0 },
    { _T("????"), 0x769980, 0x769a00, 0x0f, 0 },
    { _T("????"), 0x769a00, 0x769a80, 0x0f, 0 },
...
{
    { _T("LP Main"), 0x703b80, 0x703c00, 0x10, 0x00 },
    { _T("LP Portrait"), 0x7649e0, 0x764a00, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_MP_PALETTES[] =
{
    { _T("MP Main"), 0x703c00, 0x703c80, 0x10, 0x00 },
    { _T("MP Portrait"), 0x764a00, 0x764a20, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_HP_PALETTES[] =
{
    { _T("HP Main"), 0x703c80, 0x703d00, 0x10, 0x00 },
    { _T("HP Portrait"), 0x764a20, 0x764a40, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_LK_PALETTES[] =
{
    { _T("LK Main"), 0x703d00, 0x703d80, 0x10, 0x00 },
    { _T("LK Portrait"), 0x764a40, 0x764a60, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_MK_PALETTES[] =
{
    { _T("MK Main"), 0x703d80, 0x703e00, 0x10, 0x00 },
    { _T("MK Portrait"), 0x764a60, 0x764a80, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_HK_PALETTES[] =
{
    { _T("HK Main"), 0x703e00, 0x703e80, 0x10, 0x00 },
    { _T("HK Portrait"), 0x764a80, 0x764aa0, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_EX_PALETTES[] =
{
    { _T("EX Main"), 0x703e80, 0x703f00, 0x10, 0x00 },
    { _T("EX Portrait"), 0x764aa0, 0x764ac0, 0x10, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_MAKOTO_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765600, 0x765680, 0x10, 0 },
    { _T("EX Attack (2)"), 0x76b600, 0x76b680, 0x10, 0 },
    { _T("????"), 0x769c00, 0x769c80, 0x10, 0 },
    { _T("????"), 0x769c80, 0x769d00, 0x10, 0 },
    { _T("????"), 0x769d00, 0x769d80, 0x10, 0 },
    { _T("????"), 0x769d80, 0x769e00, 0x10, 0 },
    { _T("????"), 0x769e00, 0x769e80, 0x10, 0 },
    { _T("????"), 0x769e80, 0x769f00, 0x10, 0 },
    { _T("????"), 0x769f00, 0x769f80, 0x10, 0 },
    { _T("????"), 0x769f80, 0x76a000, 0x10, 0 },
};

const sGame_PaletteDataset SFIII3_A_Q_LP_PALETTES[] =
{
    { _T("LP Main"), 0x703f00, 0x703f80, 0x11, 0x00 },
    { _T("LP Portrait"), 0x764ac0, 0x764ae0, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_MP_PALETTES[] =
{
    { _T("MP Main"), 0x703f80, 0x704000, 0x11, 0x00 },
    { _T("MP Portrait"), 0x764ae0, 0x764b00, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_HP_PALETTES[] =
{
    { _T("HP Main"), 0x704000, 0x704080, 0x11, 0x00 },
    { _T("HP Portrait"), 0x764b00, 0x764b20, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_LK_PALETTES[] =
{
    { _T("LK Main"), 0x704080, 0x704100, 0x11, 0x00 },
    { _T("LK Portrait"), 0x764b20, 0x764b40, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_MK_PALETTES[] =
{
    { _T("MK Main"), 0x704100, 0x704180, 0x11, 0x00 },
    { _T("MK Portrait"), 0x764b40, 0x764b60, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_HK_PALETTES[] =
{
    { _T("HK Main"), 0x704180, 0x704200, 0x11, 0x00 },
    { _T("HK Portrait"), 0x764b60, 0x764b80, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_EX_PALETTES[] =
{
    { _T("EX Main"), 0x704200, 0x704280, 0x11, 0x00 },
    { _T("EX Portrait"), 0x764b80, 0x764ba0, 0x11, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_Q_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765680, 0x765700, 0x11, 0 },
    { _T("EX Attack (2)"), 0x76b680, 0x76b700, 0x11, 0 },
    { _T("????"), 0x76a000, 0x76a080, 0x11, 0 },
    { _T("????"), 0x76a080, 0x76a100, 0x11, 0 },
    { _T("????"), 0x76a100, 0x76a180, 0x11, 0 },
    { _T("????"), 0x76a180, 0x76a200, 0x11, 0 },
    { _T("????"), 0x76a200, 0x76a280, 0x11, 0 },
    { _T("????"), 0x76a280, 0x76a300, 0x11, 0 },
    { _T("????"), 0x76a300, 0x76a380, 0x11, 0 },
    { _T("????"), 0x76a380, 0x76a400, 0x11, 0 },
};
...
{
    { _T("LP Main"), 0x704280, 0x704300, 0x12, 0x00 },
    { _T("LP Portrait"), 0x764ba0, 0x764bc0, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_MP_PALETTES[] =
{
    { _T("MP Main"), 0x704300, 0x704380, 0x12, 0x00 },
    { _T("MP Portrait"), 0x764bc0, 0x764be0, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_HP_PALETTES[] =
{
    { _T("HP Main"), 0x704380, 0x704400, 0x12, 0x00 },
    { _T("HP Portrait"), 0x764be0, 0x764c00, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_LK_PALETTES[] =
{
    { _T("LK Main"), 0x704400, 0x704480, 0x12, 0x00 },
    { _T("LK Portrait"), 0x764c00, 0x764c20, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_MK_PALETTES[] =
{
    { _T("MK Main"), 0x704480, 0x704500, 0x12, 0x00 },
    { _T("MK Portrait"), 0x764c20, 0x764c40, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_HK_PALETTES[] =
{
    { _T("HK Main"), 0x704500, 0x704580, 0x12, 0x00 },
    { _T("HK Portrait"), 0x764c40, 0x764c60, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_EX_PALETTES[] =
{
    { _T("EX Main"), 0x704580, 0x704600, 0x12, 0x00 },
    { _T("EX Portrait"), 0x764c60, 0x764c80, 0x12, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_TWELVE_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765700, 0x765780, 0x12, 0 },
    { _T("EX Attack (2)"), 0x76b700, 0x76b780, 0x12, 0 },
    { _T("????"), 0x76a400, 0x76a480, 0x12, 0 },
    { _T("????"), 0x76a480, 0x76a500, 0x12, 0 },
    { _T("????"), 0x76a500, 0x76a580, 0x12, 0 },
    { _T("????"), 0x76a580, 0x76a600, 0x12, 0 },
    { _T("????"), 0x76a600, 0x76a680, 0x12, 0 },
    { _T("????"), 0x76a680, 0x76a700, 0x12, 0 },
    { _T("????"), 0x76a700, 0x76a780, 0x12, 0 },
    { _T("????"), 0x76a780, 0x76a800, 0x12, 0 },
};

const sGame_PaletteDataset SFIII3_A_REMY_LP_PALETTES[] =
{
    { _T("LP Main"), 0x704600, 0x704680, 0x13, 0x00 },
    { _T("LP Portrait"), 0x764c80, 0x764ca0, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_MP_PALETTES[] =
{
    { _T("MP Main"), 0x704680, 0x704700, 0x13, 0x00 },
    { _T("MP Portrait"), 0x764ca0, 0x764cc0, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_HP_PALETTES[] =
{
    { _T("HP Main"), 0x704700, 0x704780, 0x13, 0x00 },
    { _T("HP Portrait"), 0x764cc0, 0x764ce0, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_LK_PALETTES[] =
{
    { _T("LK Main"), 0x704780, 0x704800, 0x13, 0x00 },
    { _T("LK Portrait"), 0x764ce0, 0x764d00, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_MK_PALETTES[] =
{
    { _T("MK Main"), 0x704800, 0x704880, 0x13, 0x00 },
    { _T("MK Portrait"), 0x764d00, 0x764d20, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_HK_PALETTES[] =
{
    { _T("HK Main"), 0x704880, 0x704900, 0x13, 0x00 },
    { _T("HK Portrait"), 0x764d20, 0x764d40, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_EX_PALETTES[] =
{
    { _T("EX Main"), 0x704900, 0x704980, 0x13, 0x00 },
    { _T("EX Portrait"), 0x764d40, 0x764d60, 0x13, 0x01 },
};

const sGame_PaletteDataset SFIII3_A_REMY_Support_PALETTES[] =
{
    { _T("EX Attack (1)"), 0x765780, 0x765800, 0x13, 0 },
    { _T("EX Attack (2)"), 0x76b780, 0x76b800, 0x13, 0 },
    { _T("????"), 0x76a800, 0x76a880, 0x13, 0 },
    { _T("????"), 0x76a880, 0x76a900, 0x13, 0 },
    { _T("????"), 0x76a900, 0x76a980, 0x13, 0 },
    { _T("????"), 0x76a980, 0x76aa00, 0x13, 0 },
    { _T("????"), 0x76aa00, 0x76aa80, 0x13, 0 },
    { _T("????"), 0x76aa80, 0x76ab00, 0x13, 0 },
    { _T("????"), 0x76ab00, 0x76ab80, 0x13, 0 },
...
{
    { _T("Akuma Stage Part 1"), 0x74C180, 0x74C380, 0x15, 0x0F },
    { _T("Akuma Stage Part 2"), 0x74C380, 0x74C580, 0x15, 0x10 },
    { _T("Akuma Stage Part 3"), 0x74C580, 0x74C780, 0x15, 0x11 },
    { _T("Akuma Stage Part 4"), 0x74C780, 0x74C980, 0x15, 0x12 },
    { _T("Akuma Stage Part 5"), 0x74C980, 0x74CA00, 0x15, 0x13 },
};

const sGame_PaletteDataset SFIII3_A_STAGES_AKUMA_FADED_PALETTES[] =
{
    { _T("Akuma Stage (Faded) Part 1"), 0x74CA00, 0x74CC00, 0x15, 0x0F },
    { _T("Akuma Stage (Faded) Part 2"), 0x74CC00, 0x74CE00, 0x15, 0x10 },
    { _T("Akuma Stage (Faded) Part 3"), 0x74CE00, 0x74D000, 0x15, 0x11 },
    { _T("Akuma Stage (Faded) Part 4"), 0x74D000, 0x74D200, 0x15, 0x12 },
    { _T("Akuma Stage (Faded) Part 5"), 0x74D200, 0x74D280, 0x15, 0x13 },
};

const sGame_PaletteDataset SFIII3_A_STAGES_ELENA_PALETTES[] =
{
    { _T("Elena Stage - Grass"), 0x743380, 0x743400, 0x15, 0x00 },
    { _T("Elena Stage - Bushes"), 0x743400, 0x743480, 0x15, 0x01 },
    { _T("Elena Stage - Sun"), 0x743480, 0x743500, 0x15, 0x02 },
    { _T("Elena Stage - Grass Pond Elephants"), 0x743500, 0x743580, 0x15, 0x03 },
    { _T("Elena Stage - Tree Left Side"), 0x743580, 0x743600, 0x15, 0x04 },
    { _T("Elena Stage - Tree Right Side"), 0x743600, 0x743680, 0x15, 0x05 },
};

const sGame_PaletteDataset SFIII3_A_STAGES_ELENA_FADED_PALETTES[] =
{
    { _T("Elena Stage (Faded) - Grass"), 0x743680, 0x743700, 0x15, 0x00 },
    { _T("Elena Stage (Faded) - Bushes"), 0x743700, 0x743780, 0x15, 0x01 },
    { _T("Elena Stage (Faded) - Sun"), 0x743780, 0x743800, 0x15, 0x02 },
    { _T("Elena Stage (Faded) - Grass Pond Elephants"), 0x743800, 0x743880, 0x15, 0x03 },
    { _T("Elena Stage (Faded) - Tree Left Side"), 0x743880, 0x743900, 0x15, 0x04 },
    { _T("Elena Stage (Faded) - Tree Right Side"), 0x743900, 0x743980, 0x15, 0x05 },
};

const sGame_PaletteDataset SFIII3_A_STAGES_MAKOTO_PALETTES[] =
{
    { _T("Makoto Stage Part 1"), 0x752F80, 0x753180, 0x15, 0x06 },
    { _T("Makoto Stage Part 2"), 0x753180, 0x753380, 0x15, 0x07 },
    { _T("Makoto Stage Part 3"), 0x753380, 0x753580, 0x15, 0x08 },
    { _T("Makoto Stage Part 4"), 0x753580, 0x753780, 0x15, 0x09 },
    { _T("Makoto Stage Part 5"), 0x753780, 0x753980, 0x15, 0x0A },
    { _T("Makoto Stage Part 6"), 0x753980, 0x753b80, 0x15, 0x0B },
    { _T("Makoto Stage Part 7"), 0x753b80, 0x753d80, 0x15, 0x0C },
    { _T("Makoto Stage Part 8"), 0x753d80, 0x753f80, 0x15, 0x0D },
    { _T("Makoto Stage Part 9"), 0x753f80, 0x754000, 0x15, 0x0E },
};

const sGame_PaletteDataset SFIII3_A_STAGES_MAKOTO_FADED_PALETTES[] =
{
    { _T("Makoto Stage (Faded) Part 1"), 0x754000, 0x754200, 0x15, 0x06 },
    { _T("Makoto Stage (Faded) Part 2"), 0x754200, 0x754400, 0x15, 0x07 },
    { _T("Makoto Stage (Faded) Part 3"), 0x754400, 0x754600, 0x15, 0x08 },
    { _T("Makoto Stage (Faded) Part 4"), 0x754600, 0x754800, 0x15, 0x09 },
    { _T("Makoto Stage (Faded) Part 5"), 0x754800, 0x754A00, 0x15, 0x0A },
    { _T("Makoto Stage (Faded) Part 6"), 0x754A00, 0x754C00, 0x15, 0x0B },
    { _T("Makoto Stage (Faded) Part 7"), 0x754C00, 0x754E00, 0x15, 0x0C },
    { _T("Makoto Stage (Faded) Part 8"), 0x754E00, 0x755000, 0x15, 0x0D },
