...
{
    { L"Jago 1", 0x3e06 - 0x08, 0x3e86 - 0x08 },
    { L"Jago 2", 0x3e86 - 0x08, 0x3f06 - 0x08 },
    { L"Jago 3", 0x3f06 - 0x08, 0x3f86 - 0x08 },
    { L"Jago 4", 0x3f86 - 0x08, 0x4006 - 0x08 },
    { L"Jago 5", 0x4006 - 0x08, 0x4086 - 0x08 },
    { L"Jago 6", 0x4086 - 0x08, 0x4106 - 0x08 },
    { L"Jago 7", 0x4106 - 0x08, 0x4186 - 0x08 },
    { L"Jago 8", 0x4186 - 0x08, 0x4206 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Combo_Portraits[] =
{
    { L"Combo 1", 0x4206 - 0x08, 0x4286 - 0x08 },
    { L"Combo 2", 0x4286 - 0x08, 0x4306 - 0x08 },
    { L"Combo 3", 0x4306 - 0x08, 0x4386 - 0x08 },
    { L"Combo 4", 0x4386 - 0x08, 0x4406 - 0x08 },
    { L"Combo 5", 0x4406 - 0x08, 0x4486 - 0x08 },
    { L"Combo 6", 0x4486 - 0x08, 0x4506 - 0x08 },
    { L"Combo 7", 0x4506 - 0x08, 0x4586 - 0x08 },
    { L"Combo 8", 0x4586 - 0x08, 0x4606 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Spinal_Portraits[] =
{
    { L"Spinal 1", 0x4606 - 0x08, 0x4646 - 0x08 },
    { L"Spinal 2", 0x4686 - 0x08, 0x46c6 - 0x08 },
    { L"Spinal 3", 0x4706 - 0x08, 0x4746 - 0x08 },
    { L"Spinal 4", 0x4786 - 0x08, 0x47c6 - 0x08 },
    { L"Spinal 5", 0x4806 - 0x08, 0x4846 - 0x08 },
    { L"Spinal 6", 0x4886 - 0x08, 0x48c6 - 0x08 },
    { L"Spinal 7", 0x4906 - 0x08, 0x4946 - 0x08 },
    { L"Spinal 8", 0x4986 - 0x08, 0x49c6 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Thunder_Portraits[] =
{
    { L"Thunder 1", 0x4a06 - 0x08, 0x4a86 - 0x08 },
    { L"Thunder 2", 0x4a86 - 0x08, 0x4b06 - 0x08 },
    { L"Thunder 3", 0x4b06 - 0x08, 0x4b86 - 0x08 },
    { L"Thunder 4", 0x4b86 - 0x08, 0x4c06 - 0x08 },
    { L"Thunder 5", 0x4c06 - 0x08, 0x4c86 - 0x08 },
    { L"Thunder 6", 0x4c86 - 0x08, 0x4d06 - 0x08 },
    { L"Thunder 7", 0x4d06 - 0x08, 0x4d86 - 0x08 },
    { L"Thunder 8", 0x4d86 - 0x08, 0x4e06 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Glacius_Portraits[] =
{
    { L"Glacius 1", 0x4e06 - 0x08, 0x4e86 - 0x08 },
    { L"Glacius 2", 0x4e86 - 0x08, 0x4f06 - 0x08 },
    { L"Glacius 3", 0x4f06 - 0x08, 0x4f86 - 0x08 },
    { L"Glacius 4", 0x4f86 - 0x08, 0x5006 - 0x08 },
    { L"Glacius 5", 0x5006 - 0x08, 0x5086 - 0x08 },
    { L"Glacius 6", 0x5086 - 0x08, 0x5106 - 0x08 },
    { L"Glacius 7", 0x5106 - 0x08, 0x5186 - 0x08 },
    { L"Glacius 8", 0x5186 - 0x08, 0x5206 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Fulgore_Portraits[] =
{
    { L"Fulgore 1", 0x5206 - 0x08, 0x5266 - 0x08 },
    { L"Fulgore 2", 0x5286 - 0x08, 0x52e6 - 0x08 },
    { L"Fulgore 3", 0x5306 - 0x08, 0x5366 - 0x08 },
    { L"Fulgore 4", 0x5386 - 0x08, 0x53e6 - 0x08 },
    { L"Fulgore 5", 0x5406 - 0x08, 0x5466 - 0x08 },
    { L"Fulgore 6", 0x5486 - 0x08, 0x54e6 - 0x08 },
    { L"Fulgore 7", 0x5506 - 0x08, 0x5566 - 0x08 },
    { L"Fulgore 8", 0x5586 - 0x08, 0x55e6 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Cinder_Portraits[] =
{
    { L"Cinder 1", 0x5606 - 0x08, 0x5686 - 0x08 },
    { L"Cinder 2", 0x5686 - 0x08, 0x5706 - 0x08 },
    { L"Cinder 3", 0x5706 - 0x08, 0x5786 - 0x08 },
    { L"Cinder 4", 0x5786 - 0x08, 0x5806 - 0x08 },
    { L"Cinder 5", 0x5806 - 0x08, 0x5886 - 0x08 },
    { L"Cinder 6", 0x5886 - 0x08, 0x5906 - 0x08 },
    { L"Cinder 7", 0x5906 - 0x08, 0x5986 - 0x08 },
    { L"Cinder 8", 0x5986 - 0x08, 0x5a06 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Sabrewulf_Portraits[] =
{
    { L"Sabrewulf 1", 0x5a06 - 0x08, 0x5a86 - 0x08 },
    { L"Sabrewulf 2", 0x5a86 - 0x08, 0x5b06 - 0x08 },
    { L"Sabrewulf 3", 0x5b06 - 0x08, 0x5b86 - 0x08 },
    { L"Sabrewulf 4", 0x5b86 - 0x08, 0x5c06 - 0x08 },
    { L"Sabrewulf 5", 0x5c06 - 0x08, 0x5c86 - 0x08 },
    { L"Sabrewulf 6", 0x5c86 - 0x08, 0x5d06 - 0x08 },
    { L"Sabrewulf 7", 0x5d06 - 0x08, 0x5d86 - 0x08 },
    { L"Sabrewulf 8", 0x5d86 - 0x08, 0x5e06 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Orchid_Portraits[] =
{
    { L"Orchid 1", 0x5e06 - 0x08, 0x5e86 - 0x08 },
    { L"Orchid 2", 0x5e86 - 0x08, 0x5f06 - 0x08 },
    { L"Orchid 3", 0x5f06 - 0x08, 0x5f86 - 0x08 },
    { L"Orchid 4", 0x5f86 - 0x08, 0x6006 - 0x08 },
    { L"Orchid 5", 0x6006 - 0x08, 0x6086 - 0x08 },
    { L"Orchid 6", 0x6086 - 0x08, 0x6106 - 0x08 },
    { L"Orchid 7", 0x6106 - 0x08, 0x6186 - 0x08 },
    { L"Orchid 8", 0x6186 - 0x08, 0x6206 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Riptor_Portraits[] =
{
    { L"Riptor 1", 0x6206 - 0x08, 0x6286 - 0x08 },
    { L"Riptor 2", 0x6286 - 0x08, 0x6306 - 0x08 },
    { L"Riptor 3", 0x6306 - 0x08, 0x6386 - 0x08 },
    { L"Riptor 4", 0x6386 - 0x08, 0x6406 - 0x08 },
    { L"Riptor 5", 0x6406 - 0x08, 0x6486 - 0x08 },
    { L"Riptor 6", 0x6486 - 0x08, 0x6506 - 0x08 },
    { L"Riptor 7", 0x6506 - 0x08, 0x6586 - 0x08 },
    { L"Riptor 8", 0x6586 - 0x08, 0x6606 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_Eyedol_Portraits[] =
{
    { L"Eyedol 1", 0x6606 - 0x08, 0x6626 - 0x08 },
    { L"Eyedol 2", 0x6626 - 0x08, 0x6646 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_BONUS_WinScreenBackgrounds[] =
{
    { L"Jago", 0x3ca6 - 0x08, 0x3cc6 - 0x08 },
    { L"Combo", 0x3cc6 - 0x08, 0x3ce6 - 0x08 },
    { L"Spinal", 0x3ce6 - 0x08, 0x3d06 - 0x08 },
    { L"Thunder", 0x3d06 - 0x08, 0x3d26 - 0x08 },
    { L"Glacius", 0x3d26 - 0x08, 0x3d46 - 0x08 },
    { L"Fulgore", 0x3d46 - 0x08, 0x3d66 - 0x08 },
    { L"Cinder", 0x3d66 - 0x08, 0x3d86 - 0x08 },
    { L"Sabrewulf", 0x3d86 - 0x08, 0x3da6 - 0x08 },
    { L"Orchid", 0x3da6 - 0x08, 0x3dc6 - 0x08 },
    { L"Riptor", 0x3dc6 - 0x08, 0x3de6 - 0x08 },
    { L"Eyedol", 0x3de6 - 0x08, 0x3e06 - 0x08 },
};
...
const sGame_PaletteDataset KI_SNES_BONUS_CharactersSpecials[] =
{
    ...
    { L"Fulgore Reflect", 0x52e6 - 0x08, 0x5306 - 0x08 },
...
{
    { L"Freezed Jago", 0x4846 - 0x08, 0x4866 - 0x08 },
    { L"Freezed Combo/Fulgore", 0x4866 - 0x08, 0x4886 - 0x08 },
    { L"Freezed Spinal", 0x4666 - 0x08, 0x4686 - 0x08 },
    { L"Freezed Thunder", 0x46c6 - 0x08, 0x46e6 - 0x08 },
    { L"Freezed Glacius", 0x48c6 - 0x08, 0x48e6 - 0x08 },
    { L"Freezed Cinder", 0x48e6 - 0x08, 0x4906 - 0x08 },
    { L"Freezed Sabrewulf", 0x4946 - 0x08, 0x4966 - 0x08 },
    { L"Freezed Orchid", 0x4966 - 0x08, 0x4986 - 0x08 },
    { L"Freezed Riptor", 0x49c6 - 0x08, 0x49e6 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_BONUS_CinderEffects[] =
{
    { L"Burned Jago", 0x49e6 - 0x08, 0x4a06 - 0x08 },
    { L"Burned Combo", 0x53e6 - 0x08, 0x5406 - 0x08 },
    { L"Burned Spinal/Fulgore", 0x5466 - 0x08, 0x5486 - 0x08 },
    { L"Burned Thunder", 0x54e6 - 0x08, 0x5506 - 0x08 },
    { L"Burned Glacius", 0x27a8 - 0x08, 0x27c8 - 0x08 },
    { L"Burned Cinder", 0x27c8 - 0x08, 0x27e8 - 0x08 },
    { L"Burned Sabrewulf", 0x27e8 - 0x08, 0x2808 - 0x08 },
    { L"Burned Orchid", 0x2808 - 0x08, 0x2828 - 0x08 },
    { L"Burned Riptor", 0x2828 - 0x08, 0x2848 - 0x08 },
    { L"Meltdown", 0x4646 - 0x08, 0x4666 - 0x08 },
};

const sGame_PaletteDataset KI_SNES_BONUS_Palettes[] =
{
    { L"Info Portraits", 0x359c - 0x08, 0x36dc - 0x08 },
    { L"Select Icons", 0x3bbe - 0x08, 0x3c5e - 0x08 },
};
