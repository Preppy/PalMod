...
const std::vector<uint16_t> KI_SNES_IMGIDS_USED =
{
...
{
    { L"Green Projectiles", 0x2558 - 0x08, 0x2566 - 0x08, indexKISprites_Bonus, 0x04 },
    { L"Jago Yellow Endokuken", 0x258a - 0x08, 0x2598 - 0x08, indexKISprites_Jago, 0x02 },
    { L"Jago Red Endokuken", 0x25aa - 0x08, 0x25b8 - 0x08, indexKISprites_Jago, 0x02 },
    ...
    { L"Orchid Lasaken", 0x2572 - 0x08, 0x257e - 0x08, indexKISprites_Orchid, 0x04 },
    { L"Orchid Fire Cat", 0x2848 - 0x08, 0x285a - 0x08, indexKISprites_Orchid, 0x02 },
    { L"Orchid Frog", 0x285a - 0x08, 0x287a - 0x08, indexKISprites_Orchid, 0x03 },
    { L"Orchid Eyes", 0x271e - 0x08, 0x272a - 0x08, indexKISprites_Orchid, 0x01 },
