...
size_t CGame_DBZHD_SNES::rgExtraCountAll[DBZHD_SNES_NUMUNIT + 1];
size_t CGame_DBZHD_SNES::rgExtraLoc[DBZHD_SNES_NUMUNIT + 1];
...
size_t CGame_DBZHD_SNES::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, DBZHD_SNES_NUMUNIT, nUnitId, DBZHD_SNES_EXTRA_CUSTOM);
}

size_t CGame_DBZHD_SNES::GetExtraLoc(size_t nUnitId)
{
...
sFileRule CGame_DBZHD_SNES::GetRule(size_t nUnitId)
{
...
size_t CGame_DBZHD_SNES::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_DBZHD_SNES::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_DBZHD_SNES::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(DBZHD_SNES_UNITS, DBZHD_SNES_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_DBZHD_SNES::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_DBZHD_SNES::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(DBZHD_SNES_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_DBZHD_SNES::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_DBZHD_SNES::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_DBZHD_SNES::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
