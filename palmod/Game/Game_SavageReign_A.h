...
{
private:
    static uint32_t m_nTotalPaletteCountForSAVAGEREIGN;
    ...
    static constexpr auto EXTRA_FILENAME_SAVAGEREIGN_A = L"SavageReignE.txt";
    static constexpr uint32_t m_nExpectedGameROMSize = 0x200000;

public:
    CGame_SAVAGEREIGN_A(uint32_t nConfirmedROMSize);
    ~CGame_SAVAGEREIGN_A();
