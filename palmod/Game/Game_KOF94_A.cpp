...
UINT32 CGame_KOF94_A::GetKnownCRC32DatasetsForGame(const sCRC32ValueSet** ppKnownROMSet, bool* pfNeedToValidateCRCs)
{
    static sCRC32ValueSet knownROMs[] =
    {
        ...
        { L"KOF '94 (Arcade)", L"242-p2.sp2", 0x940aba4c, 0 },
        { L"KOF '94 (Arcade)", L"kof94_p2.rom", 0x940aba4c, 0 },
        { L"KOF '94 (Arcade Alt)", L"242-ep.ep2", 0x6e474841, 0 },
    };
...
sDescTreeNode* CGame_KOF94_A::InitDescTree()
{
    ...
    _sntprintf_s(NewDescTree->szDesc, ARRAYSIZE(NewDescTree->szDesc), _TRUNCATE, L"%s", g_GameFriendlyName[KOF94_A]);
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < KOF94_A_EXTRALOC)
        {
            ...
            _sntprintf_s(UnitNode->szDesc, ARRAYSIZE(UnitNode->szDesc), _TRUNCATE, L"%s", KOF94_A_UNITS[iUnitCtr].szDesc);
...
{
    { L"Heidern", 0x176000 /* to 0x1761c0 */ },
    { L"Ralf", 0x176380 /* to 0x176540 */, true },
    { L"Clark", 0x176700 /* to 0x1768c0 */, true },
    { L"Athena", 0x176a80 /* to 0x176c40 */ },
    { L"Kensou", 0x176e00 /* to 0x176fc0 */ },
    { L"Chin", 0x177180 /* to 0x177340 */ },
    { L"Kyo", 0x177500 /* to 0x1776c0 */ },
    { L"Benimaru", 0x177880 /* to 0x177a40 */ },
    { L"Daimon", 0x177c00 /* to 0x177dc0 */ },
    { L"Heavy D!", 0x177f80 /* to 0x178140 */ },
    { L"Lucky", 0x178300 /* to 0x1784c0 */, true },
    { L"Brian", 0x178680 /* to 0x178840 */ },
    { L"Kim", 0x178a00 /* to 0x178bc0 */ },
    { L"Chang", 0x178d80 /* to 0x178f40 */, true },
    { L"Choi", 0x179100 /* to 0x1792c0 */ },
    { L"Terry", 0x179480 /* to 0x179640 */ },
    { L"Andy", 0x179800 /* to 0x1799c0 */ },
    { L"Joe", 0x179b80 /* to 0x179d40 */ },
    { L"Ryo", 0x179f00 /* to 0x17a0c0 */ },
    { L"Robert", 0x17a280 /* to 0x17a440 */ },
    { L"Takuma", 0x17a600 /* to 0x17a7c0 */ },
    { L"Yuri", 0x17a980 /* to 0x17ab40 */ },
    { L"Mai", 0x17ad00 /* to 0x17aec0 */ },
    { L"King", 0x17b080 /* to 0x17b240 */ },
    { L"Rugal", 0x17b400 /* to 0x17b5c0 */, true },
};
...
void CGame_KOF94_A::DumpPaletteHeaders()
{
    ...
    for (UINT16 nCharIndex = 0; nCharIndex < ARRAYSIZE(KOF94_A_CharacterEffectPalettes); nCharIndex++)
    {
        ...
        for (UINT16 nCharacterColor = 0; nCharacterColor < 2; nCharacterColor++)
        {
            ...
            for (UINT16 nStatusIndex = 0; nStatusIndex < nCountStatusEffects; nStatusIndex++)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    pszCurrentEffectName = KOF94_A_CharacterEffectPalettes[nCharIndex].fIsMultipart ? L"Electric Palette Extra" : L"Extra 2";
                    break;
                case 4:
                    // This is 4x length
                ...
                default:
                    DebugBreak();
                case 13:
                    pszCurrentEffectName = KOF94_A_CharacterEffectPalettes[nCharIndex].fIsMultipart ? L"MAX Flash Extra" : L"Extra 4";
                    break;
                };

                strOutput.Format(L"    { L\"%s\", 0x%x, 0x%x },\r\n", pszCurrentEffectName, nCurrentOffset, nTerminalOffset);
                OutputDebugString(strOutput);
            }
        ...
        strOutput.Format(L"const sGame_PaletteDataset KOF94_A_%s_EFFECTS_PALETTES[] = \r\n{\r\n", szCodeDesc);
        OutputDebugString(strOutput);

        UINT32 nFirePaletteOffset = 0x17b780 + (nCharIndex * KOF94_PALETTE_LENGTH);
        UINT32 nPressurePaletteOffset = 0x17bb00 + (nCharIndex * KOF94_PALETTE_LENGTH);

        strOutput.Format(L"    { L\"Fire Palette\", 0x%x, 0x%x },\r\n", nFirePaletteOffset, nFirePaletteOffset + KOF94_PALETTE_LENGTH);
        OutputDebugString(strOutput);
        strOutput.Format(L"    { L\"Gigantic Pressure Palette\", 0x%x, 0x%x },\r\n", nPressurePaletteOffset, nPressurePaletteOffset + KOF94_PALETTE_LENGTH);
        OutputDebugString(strOutput);
    ...
    for (UINT16 nCharIndex = 0; nCharIndex < ARRAYSIZE(KOF94_A_CharacterEffectPalettes); nCharIndex++)
    {
        ...
        strOutput.Format(L"    { L\"Effects\", DESC_NODETYPE_TREE, (void*)KOF94_A_%s_EFFECTS_PALETTES, ARRAYSIZE(KOF94_A_%s_EFFECTS_PALETTES) },\r\n", szCodeDesc, szCodeDesc);
        OutputDebugString(strOutput);
...
LPCTSTR CGame_KOF94_A::GetDescriptionForCollection(UINT16 nUnitId, UINT16 nCollectionId)
{
    if (nUnitId == KOF94_A_EXTRALOC)
    {
...
BOOL CGame_KOF94_A::LoadFile(CFile* LoadedFile, UINT16 nUnitId)
{
...
void CGame_KOF94_A::CreateDefPal(sDescNode* srcNode, UINT16 nSepId)
{
