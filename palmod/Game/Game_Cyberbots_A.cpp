...
uint32_t CGame_Cyberbots_A::GetExtraLoc(uint32_t nUnitId)
{
...
sFileRule CGame_Cyberbots_A::GetRule(uint32_t nUnitId)
{
...
uint32_t CGame_Cyberbots_A::GetCollectionCountForUnit(uint32_t nUnitId)
{
...
uint32_t CGame_Cyberbots_A::GetNodeCountForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
...
LPCWSTR CGame_Cyberbots_A::GetDescriptionForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetDescriptionForCollection(Cyberbots_A_UNITS, Cyberbots_A_EXTRALOC, nUnitId, nCollectionId);
}

uint32_t CGame_Cyberbots_A::GetPaletteCountForUnit(uint32_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_Cyberbots_A::GetPaletteSet(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetPaletteSet(Cyberbots_A_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_Cyberbots_A::GetNodeFromPaletteId(uint32_t nUnitId, uint32_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_Cyberbots_A::GetSpecificPalette(uint32_t nUnitId, uint32_t nPaletteId)
{
...
void CGame_Cyberbots_A::LoadSpecificPaletteData(uint32_t nUnitId, uint32_t nPalId)
{
