...
sDescTreeNode* CGame_SAMSHO3_A::InitDescTree()
{
    ...
    _stprintf(NewDescTree->szDesc, _T("%s"), g_GameFriendlyName[SAMSHO3_A]);
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < SAMSHO3_A_EXTRALOC)
        {
            ...
            _stprintf(UnitNode->szDesc, _T("%s"), SAMSHO3_A_UNITS[iUnitCtr].szDesc);
...
sFileRule CGame_SAMSHO3_A::GetRule(UINT16 nUnitId)
{
    ...
    _stprintf_s(NewFileRule.szFileName, MAX_FILENAME_LENGTH, _T("087-p5.p5"));
...
void CGame_SAMSHO3_A::UpdatePalData()
{
