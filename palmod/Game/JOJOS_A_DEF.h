...
{
    "HUD",           // JOJOS_A_50_HUD_COLLECTION
    "HUD Portraits", // JOJOS_A_50_HUD_PORTRAIT_COLLECTION
    "Stages",        // JOJOS_A_50_STAGE_COLLECTION
};
...
const sGame_PaletteDataset JOJOS_BONUS_INTRO_PALETTES[] =
{
...
#else
    { "Hol Horse intro background (1/2)", 0x030bb00, 0x030bd00 },
    { "Hol Horse intro background (2/2)", 0x030bd00, 0x030be00 },
#endif
#ifdef USE_LARGE_PALETTES
    { "Hol Horse intro ender background", 0x030be00, 0x030c300 },
#else
    { "Hol Horse intro ender background (1/3)", 0x030be00, 0x030c000 },
    { "Hol Horse intro ender background (2/3)", 0x030c000, 0x030c200 },
    { "Hol Horse intro ender background (3/3)", 0x030c200,  0x030c300 },
#endif
...
#else
    { "Vice intro background (1/4)", 0x030b100, 0x030b300 },
    { "Vice intro background (2/4)", 0x030b300, 0x030b500 },
    { "Vice intro background (3/4)", 0x030b500, 0x030b700 },
    ...
    { "Title Screen Logo",      0x030c680, 0x030c780 },
    // joined by request { "Title Screen Logo Ribbon", 0x030c700, 0x030c780 },
...
{
#ifndef USE_LARGE_PALETTES
    { "A Health Room TS (1/6)", 0x02d0e00, 0x02d1000 },
    { "A Health Room TS (2/6)", 0x02d1000, 0x02d1200 },
    { "A Health Room TS (3/6)", 0x02d1200,  0x02d1400 },
    { "A Health Room TS (4/6)", 0x02d1400, 0x02d1600 },
    { "A Health Room TS (5/6)", 0x02d1600, 0x02d1800 },
    { "A Health Room TS (6/6)", 0x02d1800, 0x02d1900 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "In A Airplane TS (1/17)", 0x02d1a00, 0x02d1c00 },
    { "In A Airplane TS (2/17)", 0x02d1c00, 0x02d1e00 },
    { "In A Airplane TS (3/17)", 0x02d1e00, 0x02d2000 },
    { "In A Airplane TS (4/17)", 0x02d2000, 0x02d2200 },
    { "In A Airplane TS (5/17)", 0x02d2200, 0x02d2400 },
    { "In A Airplane TS (6/17)", 0x02d2400, 0x02d2600 },
    { "In A Airplane TS (7/17)", 0x02d2600, 0x02d2800 },
    { "In A Airplane TS (8/17)", 0x02d2800, 0x02d2a00 },
    { "In A Airplane TS (9/17)", 0x02d2a00, 0x02d2c00 },
    { "In A Airplane TS (10/17)", 0x02d2c00, 0x02d2e00 },
    { "In A Airplane TS (11/17)", 0x02d2e00, 0x02d3000 },
    { "In A Airplane TS (12/17)", 0x02d3000, 0x02d3200 },
    { "In A Airplane TS (13/17)", 0x02d3200, 0x02d3400 },
    { "In A Airplane TS (14/17)", 0x02d3400, 0x02d3600 },
    { "In A Airplane TS (15/17)", 0x02d3600, 0x02d3800 },
    { "In A Airplane TS (16/17)", 0x02d3800, 0x02d3a00 },
    { "In A Airplane TS (17/17)", 0x02d3a00, 0x02d3b80 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Tigerbaum Garden TS (1/11)", 0x02d3c00, 0x02d3e00 },
    { "Tigerbaum Garden TS (2/11)", 0x02d3e00, 0x02d4000 },
    { "Tigerbaum Garden TS (3/11)", 0x02d4000, 0x02d4200 },
    { "Tigerbaum Garden TS (4/11)", 0x02d4200, 0x02d4400 },
    { "Tigerbaum Garden TS (5/11)", 0x02d4400, 0x02d4600 },
    { "Tigerbaum Garden TS (6/11)", 0x02d4600, 0x02d4800 },
    { "Tigerbaum Garden TS (7/11)", 0x02d4800, 0x02d4a00 },
    { "Tigerbaum Garden TS (8/11)", 0x02d4a00, 0x02d4c00 },
    { "Tigerbaum Garden TS (9/11)", 0x02d4c00, 0x02d4e00 },
    { "Tigerbaum Garden TS (10/11)", 0x02d4e00, 0x02d5000 },
    { "Tigerbaum Garden TS (11/11)", 0x02d5000, 0x02d5200 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Remains / New 1 TS (1/9)", 0x02d6100, 0x02d6300 },
    { "Remains / New 1 TS (2/9)", 0x02d6300, 0x02d6500 },
    { "Remains / New 1 TS (3/9)", 0x02d6500, 0x02d6700 },
    { "Remains / New 1 TS (4/9)", 0x02d6700, 0x02d6900 },
    { "Remains / New 1 TS (5/9)", 0x02d6900, 0x02d6b00 },
    { "Remains / New 1 TS (6/9)", 0x02d6b00, 0x02d6d00 },
    { "Remains / New 1 TS (7/9)", 0x02d6d00, 0x02d6f00 },
    { "Remains / New 1 TS (8/9)", 0x02d6f00, 0x02d7100 },
    { "Remains / New 1 TS (9/9)", 0x02d7100, 0x02d7300 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Hotel (Justice) TS (1/8)", 0x02d7400, 0x02d7600 },
    { "Hotel (Justice) TS (2/8)", 0x02d7600, 0x02d7800 },
    { "Hotel (Justice) TS (3/8)", 0x02d7800, 0x02d7a00 },
    { "Hotel (Justice) TS (4/8)", 0x02d7a00, 0x02d7c00 },
    { "Hotel (Justice) TS (5/8)", 0x02d7c00, 0x02d7e00 },
    { "Hotel (Justice) TS (6/8)", 0x02d7e00, 0x02d8000 },
    { "Hotel (Justice) TS (7/8)", 0x02d8000, 0x02d8200 },
    { "Hotel (Justice) TS (8/8)", 0x02d8200, 0x02d8280 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Small Island / New 3 TS (1/6)", 0x02d8300, 0x02d8500 },
    { "Small Island / New 3 TS (2/6)", 0x02d8500, 0x02d8700 },
    { "Small Island / New 3 TS (3/6)", 0x02d8700, 0x02d8900 },
    { "Small Island / New 3 TS (4/6)", 0x02d8900, 0x02d8b00 },
    { "Small Island / New 3 TS (5/6)", 0x02d8b00, 0x02d8d00 },
    { "Small Island / New 3 TS (6/6)", 0x02d8d00, 0x02d8f00 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Desert Morning / Twilight (1/8)", 0x02d9f00, 0x02da100 },
    { "Desert Morning / Twilight (2/8)", 0x02da100, 0x02da300 },
    { "Desert Morning / Twilight (3/8)", 0x02da300, 0x02da500 },
    { "Desert Morning / Twilight (4/8)", 0x02da500, 0x02da700 },
    { "Desert Morning / Twilight (5/8)", 0x02da700, 0x02da900 },
    { "Desert Morning / Twilight (6/8)", 0x02da900, 0x02dab00 },
    { "Desert Morning / Twilight (7/8)", 0x02dab00, 0x02dad00 },
    { "Desert Morning / Twilight (8/8)", 0x02dad00, 0x02dad80 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Ruins / New 4 TS (1/5)", 0x02dbd00, 0x02dbf00 },
    { "Ruins / New 4 TS (2/5)", 0x02dbf00, 0x02dc100 },
    { "Ruins / New 4 TS (3/5)", 0x02dc100, 0x02dc300 },
    { "Ruins / New 4 TS (4/5)", 0x02dc300, 0x02dc500 },
    { "Ruins / New 4 TS (5/5)", 0x02dc500, 0x02dc700 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Country Town Noon / Twilight / Night TS (1/21)", 0x02dc800, 0x02dca00 },
    { "Country Town Noon / Twilight / Night TS (2/21)", 0x02dca00, 0x02dcc00 },
    { "Country Town Noon / Twilight / Night TS (3/21)", 0x02dcc00, 0x02dce00 },
    { "Country Town Noon / Twilight / Night TS (4/21)", 0x02dce00, 0x02dd000 },
    { "Country Town Noon / Twilight / Night TS (5/21)", 0x02dd000, 0x02dd200 },
    { "Country Town Noon / Twilight / Night TS (6/21)", 0x02dd200, 0x02dd400 },
    { "Country Town Noon / Twilight / Night TS (7/21)", 0x02dd400, 0x02dd600 },
    { "Country Town Noon / Twilight / Night TS (8/21)", 0x02dd600, 0x02dd800 },
    { "Country Town Noon / Twilight / Night TS (9/21)", 0x02dd800, 0x02dda00 },
    { "Country Town Noon / Twilight / Night TS (10/21)", 0x02dda00, 0x02ddc00 },
    { "Country Town Noon / Twilight / Night TS (11/21)", 0x02ddc00, 0x02dde00 },
    { "Country Town Noon / Twilight / Night TS (12/21)", 0x02dde00, 0x02de000 },
    { "Country Town Noon / Twilight / Night TS (13/21)", 0x02de000, 0x02de200 },
    { "Country Town Noon / Twilight / Night TS (14/21)", 0x02de200, 0x02de400 },
    { "Country Town Noon / Twilight / Night TS (15/21)", 0x02de400, 0x02de600 },
    { "Country Town Noon / Twilight / Night TS (16/21)", 0x02de600, 0x02de800 },
    { "Country Town Noon / Twilight / Night TS (17/21)", 0x02de800, 0x02dea00 },
    { "Country Town Noon / Twilight / Night TS (18/21)", 0x02dea00, 0x02dec00 },
    { "Country Town Noon / Twilight / Night TS (19/21)", 0x02dec00, 0x02dee00 },
    { "Country Town Noon / Twilight / Night TS (20/21)", 0x02dee00, 0x02df000 },
    { "Country Town Noon / Twilight / Night TS (21/21)", 0x02df000, 0x02df180 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Underground Water / New 5 TS (1/8)", 0x02df200, 0x02df400 },
    { "Underground Water / New 5 TS (2/8)", 0x02df400, 0x02df600 },
    { "Underground Water / New 5 TS (3/8)", 0x02df600, 0x02df800 },
    { "Underground Water / New 5 TS (4/8)", 0x02df800, 0x02dfa00 },
    { "Underground Water / New 5 TS (5/8)", 0x02dfa00, 0x02dfc00 },
    { "Underground Water / New 5 TS (6/8)", 0x02dfc00, 0x02dfe00 },
    { "Underground Water / New 5 TS (7/8)", 0x02dfe00, 0x02e0000 },
    { "Underground Water / New 5 TS (8/8)", 0x02e0000, 0x02e0200 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Inside House / New 6 TS (1/8)", 0x02e0300, 0x02e0500 },
    { "Inside House / New 6 TS (2/8)", 0x02e0500, 0x02e0700 },
    { "Inside House / New 6 TS (3/8)", 0x02e0700, 0x02e0900 },
    { "Inside House / New 6 TS (4/8)", 0x02e0900, 0x02e0b00 },
    { "Inside House / New 6 TS (5/8)", 0x02e0b00, 0x02e0d00 },
    { "Inside House / New 6 TS (6/8)", 0x02e0d00, 0x02e0f00 },
    { "Inside House / New 6 TS (7/8)", 0x02e0f00, 0x02e1100 },
    { "Inside House / New 6 TS (8/8)", 0x02e1100, 0x02e1200 },
#else
...
{
#ifndef USE_LARGE_PALETTES
    { "Surburbs 1 / 2 / 3 TS (1/22)", 0x02e2300, 0x02e2500 },
    { "Surburbs 1 / 2 / 3 TS (2/22)", 0x02e2500, 0x02e2700 },
    { "Surburbs 1 / 2 / 3 TS (3/22)", 0x02e2700, 0x02e2900 },
    { "Surburbs 1 / 2 / 3 TS (4/22)", 0x02e2900, 0x02e2b00 },
    { "Surburbs 1 / 2 / 3 TS (5/22)", 0x02e2b00, 0x02e2d00 },
    { "Surburbs 1 / 2 / 3 TS (6/22)", 0x02e2d00, 0x02e2f00 },
    { "Surburbs 1 / 2 / 3 TS (7/22)", 0x02e2f00, 0x02e3100 },
    { "Surburbs 1 / 2 / 3 TS (8/22)", 0x02e3100, 0x02e3300 },
    { "Surburbs 1 / 2 / 3 TS (9/22)", 0x02e3300, 0x02e3500 },
    { "Surburbs 1 / 2 / 3 TS (10/22)", 0x02e3500, 0x02e3700 },
    { "Surburbs 1 / 2 / 3 TS (11/22)", 0x02e3700, 0x02e3900 },
    { "Surburbs 1 / 2 / 3 TS (12/22)", 0x02e3900, 0x02e3b00 },
    { "Surburbs 1 / 2 / 3 TS (13/22)", 0x02e3b00, 0x02e3d00 },
    { "Surburbs 1 / 2 / 3 TS (14/22)", 0x02e3d00, 0x02e3f00 },
    { "Surburbs 1 / 2 / 3 TS (15/22)", 0x02e3f00, 0x02e4100 },
    { "Surburbs 1 / 2 / 3 TS (16/22)", 0x02e4100, 0x02e4300 },
    { "Surburbs 1 / 2 / 3 TS (17/22)", 0x02e4300, 0x02e4500 },
    { "Surburbs 1 / 2 / 3 TS (18/22)", 0x02e4500, 0x02e4700 },
    { "Surburbs 1 / 2 / 3 TS (19/22)", 0x02e4700, 0x02e4900 },
    { "Surburbs 1 / 2 / 3 TS (20/22)", 0x02e4900, 0x02e4b00 },
    { "Surburbs 1 / 2 / 3 TS (21/22)", 0x02e4b00, 0x02e4d00 },
    { "Surburbs 1 / 2 / 3 TS (22/22)", 0x02e4d00, 0x02e4f00 },
#else
...
{
    { "HUD", DESC_NODETYPE_TREE,           (void*)JOJOS_A_50_HUD_COLLECTION, ARRAYSIZE(JOJOS_A_50_HUD_COLLECTION) },
    { "HUD Portraits", DESC_NODETYPE_TREE, (void*)JOJOS_A_50_HUD_PORTRAIT_COLLECTION, ARRAYSIZE(JOJOS_A_50_HUD_PORTRAIT_COLLECTION) },
    { "Stages", DESC_NODETYPE_TREE,        (void*)JOJOS_A_50_STAGE_COLLECTION, ARRAYSIZE(JOJOS_A_50_STAGE_COLLECTION) },
};
