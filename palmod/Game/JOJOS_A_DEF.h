...
{
    { L"A Lockup (1/7)", 0x07c3000, 0x07c3200, indexJojos50Stages, 0x3c, &pairFullyLinkedNode },
    { L"A Lockup (2/7)", 0x07c3200, 0x07c3400, indexJojos50Stages, 0x3d },
    { L"A Lockup (3/7)", 0x07c3400, 0x07c3600, indexJojos50Stages, 0x3e },
    { L"A Lockup (4/7)", 0x07c3600, 0x07c3800, indexJojos50Stages, 0x3f },
    { L"A Lockup (5/7)", 0x07c3800, 0x07c3a00, indexJojos50Stages, 0x40 },
    { L"A Lockup (6/7)", 0x07c3a00, 0x07c3c00, indexJojos50Stages, 0x41 },
    { L"A Lockup (7/7)", 0x07c3c00, 0x07c3d80, indexJojos50Stages, 0x42 },
};
...
{
    { L"In A Airplane (1/17)", 0x07c4a00, 0x07c4c00, indexJojos50Stages, 0x67, &pairFullyLinkedNode },
    { L"In A Airplane (2/17)", 0x07c4c00, 0x07c4e00, indexJojos50Stages, 0x68 },
    { L"In A Airplane (3/17)", 0x07c4e00, 0x07c5000, indexJojos50Stages, 0x69 },
    { L"In A Airplane (4/17)", 0x07c5000, 0x07c5200, indexJojos50Stages, 0x6a },
    { L"In A Airplane (5/17)", 0x07c5200, 0x07c5400, indexJojos50Stages, 0x6b },
    { L"In A Airplane (6/17)", 0x07c5400, 0x07c5600, indexJojos50Stages, 0x6c },
    { L"In A Airplane (7/17)", 0x07c5600, 0x07c5800, indexJojos50Stages, 0x6d },
    { L"In A Airplane (8/17)", 0x07c5800, 0x07c5a00, indexJojos50Stages, 0x6e },
    { L"In A Airplane (9/17)", 0x07c5a00, 0x07c5c00, indexJojos50Stages, 0x6f },
    { L"In A Airplane (10/17)", 0x07c5c00, 0x07c5e00, indexJojos50Stages, 0x70 },
    { L"In A Airplane (11/17)", 0x07c5e00, 0x07c6000, indexJojos50Stages, 0x71 },
    { L"In A Airplane (12/17)", 0x07c6000, 0x07c6200, indexJojos50Stages, 0x72 },
    { L"In A Airplane (13/17)", 0x07c6200, 0x07c6400, indexJojos50Stages, 0x73 },
    { L"In A Airplane (14/17)", 0x07c6400, 0x07c6600, indexJojos50Stages, 0x74 },
    { L"In A Airplane (15/17)", 0x07c6600, 0x07c6800, indexJojos50Stages, 0x75 },
    { L"In A Airplane (16/17)", 0x07c6800, 0x07c6a00, indexJojos50Stages, 0x76 },
    { L"In A Airplane (17/17)", 0x07c6a00, 0x07c6b80, indexJojos50Stages, 0x77 },
};
...
{
    { L"Hotel (Justice) (1/8)", 0x07cc500, 0x07cc700, indexJojos50Stages, 0x8d, &pairFullyLinkedNode },
    { L"Hotel (Justice) (2/8)", 0x07cc700, 0x07cc900, indexJojos50Stages, 0x8e },
    { L"Hotel (Justice) (3/8)", 0x07cc900, 0x07ccb00, indexJojos50Stages, 0x8f },
    { L"Hotel (Justice) (4/8)", 0x07ccb00, 0x07ccd00, indexJojos50Stages, 0x90 },
    { L"Hotel (Justice) (5/8)", 0x07ccd00, 0x07ccf00, indexJojos50Stages, 0x91 },
    { L"Hotel (Justice) (6/8)", 0x07ccf00, 0x07cd100, indexJojos50Stages, 0x92 },
    { L"Hotel (Justice) (7/8)", 0x07cd100, 0x07cd300, indexJojos50Stages, 0x93 },
    { L"Hotel (Justice) (8/8)", 0x07cd300, 0x07cd380, indexJojos50Stages, 0x94 },
};
...
{
    { L"Desert Noon (1/7)", 0x07d3100, 0x07d3300, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Noon (2/7)", 0x07d3300, 0x07d3500, indexJojos50Stages, 0x59 },
    { L"Desert Noon (3/7)", 0x07d3500, 0x07d3700, indexJojos50Stages, 0x5a },
    { L"Desert Noon (4/7)", 0x07d3700, 0x07d3900, indexJojos50Stages, 0x5b },
    { L"Desert Noon (5/7)", 0x07d3900, 0x07d3b00, indexJojos50Stages, 0x5c },
    { L"Desert Noon (6/7)", 0x07d3b00, 0x07d3d00, indexJojos50Stages, 0x5d },
    { L"Desert Noon (7/7)", 0x07d3d00, 0x07d3f00, indexJojos50Stages, 0x5e },
};
...
{
    { L"Country Town Noon (1/21)", 0x07d8300, 0x07d8500, indexJojos50Stages, 0x78, &pairFullyLinkedNode },
    { L"Country Town Noon (2/21)", 0x07d8500, 0x07d8700, indexJojos50Stages, 0x79 },
    { L"Country Town Noon (3/21)", 0x07d8700, 0x07d8900, indexJojos50Stages, 0x7a },
    { L"Country Town Noon (4/21)", 0x07d8900, 0x07d8b00, indexJojos50Stages, 0x7b },
    { L"Country Town Noon (5/21)", 0x07d8b00, 0x07d8d00, indexJojos50Stages, 0x7c },
    { L"Country Town Noon (6/21)", 0x07d8d00, 0x07d8f00, indexJojos50Stages, 0x7d },
    { L"Country Town Noon (7/21)", 0x07d8f00, 0x07d9100, indexJojos50Stages, 0x7e },
    { L"Country Town Noon (8/21)", 0x07d9100, 0x07d9300, indexJojos50Stages, 0x7f },
    { L"Country Town Noon (9/21)", 0x07d9300, 0x07d9500, indexJojos50Stages, 0x80 },
    { L"Country Town Noon (10/21)", 0x07d9500, 0x07d9700, indexJojos50Stages, 0x81 },
    { L"Country Town Noon (11/21)", 0x07d9700, 0x07d9900, indexJojos50Stages, 0x82 },
    { L"Country Town Noon (12/21)", 0x07d9900, 0x07d9b00, indexJojos50Stages, 0x83 },
    { L"Country Town Noon (13/21)", 0x07d9b00, 0x07d9d00, indexJojos50Stages, 0x84 },
    { L"Country Town Noon (14/21)", 0x07d9d00, 0x07d9f00, indexJojos50Stages, 0x85 },
    { L"Country Town Noon (15/21)", 0x07d9f00, 0x07da100, indexJojos50Stages, 0x86 },
    { L"Country Town Noon (16/21)", 0x07da100, 0x07da300, indexJojos50Stages, 0x87 },
    { L"Country Town Noon (17/21)", 0x07da300, 0x07da500, indexJojos50Stages, 0x88 },
    { L"Country Town Noon (18/21)", 0x07da500, 0x07da700, indexJojos50Stages, 0x89 },
    { L"Country Town Noon (19/21)", 0x07da700, 0x07da900, indexJojos50Stages, 0x8a },
    { L"Country Town Noon (20/21)", 0x07da900, 0x07dab00, indexJojos50Stages, 0x8b },
    { L"Country Town Noon (21/21)", 0x07dab00, 0x07dac80, indexJojos50Stages, 0x8c },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_UWATER[] =
{
    { L"Underground Water (1/8)", 0x07e0100, 0x07e0300, indexJojos50Stages, 0x5f, &pairFullyLinkedNode },
    { L"Underground Water (2/8)", 0x07e0300, 0x07e0500, indexJojos50Stages, 0x60 },
    { L"Underground Water (3/8)", 0x07e0500, 0x07e0700, indexJojos50Stages, 0x61 },
    { L"Underground Water (4/8)", 0x07e0700, 0x07e0900, indexJojos50Stages, 0x62 },
    { L"Underground Water (5/8)", 0x07e0900, 0x07e0b00, indexJojos50Stages, 0x63 },
    { L"Underground Water (6/8)", 0x07e0b00, 0x07e0d00, indexJojos50Stages, 0x64 },
    { L"Underground Water (7/8)", 0x07e0d00, 0x07e0f00, indexJojos50Stages, 0x65 },
    { L"Underground Water (8/8)", 0x07e0f00, 0x07e1100, indexJojos50Stages, 0x66 },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_INHOUSE[] =
{
    { L"Inside House (1/8)", 0x07e2300, 0x07e2500, indexJojos50Stages, 0x34 },
    { L"Inside House (2/8)", 0x07e2500, 0x07e2700, indexJojos50Stages, 0x35 },
    { L"Inside House (3/8)", 0x07e2700, 0x07e2900, indexJojos50Stages, 0x36 },
    { L"Inside House (4/8)", 0x07e2900, 0x07e2b00, indexJojos50Stages, 0x37 },
    { L"Inside House (5/8)", 0x07e2b00, 0x07e2d00, indexJojos50Stages, 0x38 },
    { L"Inside House (6/8)", 0x07e2d00, 0x07e2f00, indexJojos50Stages, 0x39 },
    { L"Inside House (7/8)", 0x07e2f00, 0x07e3100, indexJojos50Stages, 0x3a },
    { L"Inside House (8/8)", 0x07e3100, 0x07e3200, indexJojos50Stages, 0x3b },
};
...
{
    { L"Suburbs (1/22)", 0x07e6900, 0x07e6b00, indexJojos50Stages, 0x43, &pairFullyLinkedNode },
    { L"Suburbs (2/22)", 0x07e6b00, 0x07e6d00, indexJojos50Stages, 0x44 },
    { L"Suburbs (3/22)", 0x07e6d00, 0x07e6f00, indexJojos50Stages, 0x45 },
    { L"Suburbs (4/22)", 0x07e6f00, 0x07e7100, indexJojos50Stages, 0x46 },
    { L"Suburbs (5/22)", 0x07e7100, 0x07e7300, indexJojos50Stages, 0x47 },
    { L"Suburbs (6/22)", 0x07e7300, 0x07e7500, indexJojos50Stages, 0x48 },
    { L"Suburbs (7/22)", 0x07e7500, 0x07e7700, indexJojos50Stages, 0x49 },
    { L"Suburbs (8/22)", 0x07e7700, 0x07e7900, indexJojos50Stages, 0x4a },
    { L"Suburbs (9/22)", 0x07e7900, 0x07e7b00, indexJojos50Stages, 0x4b },
    { L"Suburbs (10/22)", 0x07e7b00, 0x07e7d00, indexJojos50Stages, 0x4c },
    { L"Suburbs (11/22)", 0x07e7d00, 0x07e7f00, indexJojos50Stages, 0x4d },
    { L"Suburbs (12/22)", 0x07e7f00, 0x07e8100, indexJojos50Stages, 0x4e },
    { L"Suburbs (13/22)", 0x07e8100, 0x07e8300, indexJojos50Stages, 0x4f },
    { L"Suburbs (14/22)", 0x07e8300, 0x07e8500, indexJojos50Stages, 0x50 },
    { L"Suburbs (15/22)", 0x07e8500, 0x07e8700, indexJojos50Stages, 0x51 },
    { L"Suburbs (16/22)", 0x07e8700, 0x07e8900, indexJojos50Stages, 0x52 },
    { L"Suburbs (17/22)", 0x07e8900, 0x07e8b00, indexJojos50Stages, 0x53 },
    { L"Suburbs (18/22)", 0x07e8b00, 0x07e8d00, indexJojos50Stages, 0x54 },
    { L"Suburbs (19/22)", 0x07e8d00, 0x07e8f00, indexJojos50Stages, 0x55 },
    { L"Suburbs (20/22)", 0x07e8f00, 0x07e9100, indexJojos50Stages, 0x56 },
    { L"Suburbs (21/22)", 0x07e9100, 0x07e9300, indexJojos50Stages, 0x57 },
...
{
    { L"Country Town Twilight (1/21)", 0x07dad00, 0x07daf00, indexJojos50Stages, 0x78, &pairFullyLinkedNode },
    { L"Country Town Twilight (2/21)", 0x07daf00, 0x07db100, indexJojos50Stages, 0x79 },
    { L"Country Town Twilight (3/21)", 0x07db100, 0x07db300, indexJojos50Stages, 0x7a },
    { L"Country Town Twilight (4/21)", 0x07db300, 0x07db500, indexJojos50Stages, 0x7b },
    { L"Country Town Twilight (5/21)", 0x07db500, 0x07db700, indexJojos50Stages, 0x7c },
    { L"Country Town Twilight (6/21)", 0x07db700, 0x07db900, indexJojos50Stages, 0x7d },
    { L"Country Town Twilight (7/21)", 0x07db900, 0x07dbb00, indexJojos50Stages, 0x7e },
    { L"Country Town Twilight (8/21)", 0x07dbb00, 0x07dbd00, indexJojos50Stages, 0x7f },
    { L"Country Town Twilight (9/21)", 0x07dbd00, 0x07dbf00, indexJojos50Stages, 0x80 },
    { L"Country Town Twilight (10/21)", 0x07dbf00, 0x07dc100, indexJojos50Stages, 0x81 },
    { L"Country Town Twilight (11/21)", 0x07dc100, 0x07dc300, indexJojos50Stages, 0x82 },
    { L"Country Town Twilight (12/21)", 0x07dc300, 0x07dc500, indexJojos50Stages, 0x83 },
    { L"Country Town Twilight (13/21)", 0x07dc500, 0x07dc700, indexJojos50Stages, 0x84 },
    { L"Country Town Twilight (14/21)", 0x07dc700, 0x07dc900, indexJojos50Stages, 0x85 },
    { L"Country Town Twilight (15/21)", 0x07dc900, 0x07dcb00, indexJojos50Stages, 0x86 },
    { L"Country Town Twilight (16/21)", 0x07dcb00, 0x07dcd00, indexJojos50Stages, 0x87 },
    { L"Country Town Twilight (17/21)", 0x07dcd00, 0x07dcf00, indexJojos50Stages, 0x88 },
    { L"Country Town Twilight (18/21)", 0x07dcf00, 0x07dd100, indexJojos50Stages, 0x89 },
    { L"Country Town Twilight (19/21)", 0x07dd100, 0x07dd300, indexJojos50Stages, 0x8a },
    { L"Country Town Twilight (20/21)", 0x07dd300, 0x07dd500, indexJojos50Stages, 0x8b },
    { L"Country Town Twilight (21/21)", 0x07dd500, 0x07dd680, indexJojos50Stages, 0x8c },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_DMORNING[] =
{
    { L"Desert Morning (1/8)", 0x07d4000, 0x07d4200, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Morning (2/8)", 0x07d4200, 0x07d4400, indexJojos50Stages, 0x59 },
    { L"Desert Morning (3/8)", 0x07d4400, 0x07d4600, indexJojos50Stages, 0x5a },
    { L"Desert Morning (4/8)", 0x07d4600, 0x07d4800, indexJojos50Stages, 0x5b },
    { L"Desert Morning (5/8)", 0x07d4800, 0x07d4a00, indexJojos50Stages, 0x5c },
    { L"Desert Morning (6/8)", 0x07d4a00, 0x07d4c00, indexJojos50Stages, 0x5d },
    { L"Desert Morning (7/8)", 0x07d4c00, 0x07d4e00, indexJojos50Stages, 0x5e },
    { L"Desert Morning (8/8)", 0x07d4e00, 0x07d4e80 },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_DTWILIGHT[] =
{
    { L"Desert Twilight (1/8)", 0x07d5e00, 0x07d6000, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Twilight (2/8)", 0x07d6000, 0x07d6200, indexJojos50Stages, 0x59 },
    { L"Desert Twilight (3/8)", 0x07d6200, 0x07d6400, indexJojos50Stages, 0x5a },
    { L"Desert Twilight (4/8)", 0x07d6400, 0x07d6600, indexJojos50Stages, 0x5b },
    { L"Desert Twilight (5/8)", 0x07d6600, 0x07d6800, indexJojos50Stages, 0x5c },
    { L"Desert Twilight (6/8)", 0x07d6800, 0x07d6a00, indexJojos50Stages, 0x5d },
    { L"Desert Twilight (7/8)", 0x07d6a00, 0x07d6c00, indexJojos50Stages, 0x5e },
    { L"Desert Twilight (8/8)", 0x07d6c00, 0x07d6c80 },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_DNIGHT[] =
{
    { L"Desert Night (1/8)", 0x07d4f00, 0x07d5100, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Night (2/8)", 0x07d5100, 0x07d5300, indexJojos50Stages, 0x59 },
    { L"Desert Night (3/8)", 0x07d5300, 0x07d5500, indexJojos50Stages, 0x5a },
    { L"Desert Night (4/8)", 0x07d5500, 0x07d5700, indexJojos50Stages, 0x5b },
    { L"Desert Night (5/8)", 0x07d5700, 0x07d5900, indexJojos50Stages, 0x5c },
    { L"Desert Night (6/8)", 0x07d5900, 0x07d5b00, indexJojos50Stages, 0x5d },
    { L"Desert Night (7/8)", 0x07d5b00, 0x07d5d00, indexJojos50Stages, 0x5e },
    { L"Desert Night (8/8)", 0x07d5d00, 0x07d5d80 },
};
...
{
    { L"Country Town Night (1/21)", 0x07dd700, 0x07dd900, indexJojos50Stages, 0x78, &pairFullyLinkedNode },
    { L"Country Town Night (2/21)", 0x07dd900, 0x07ddb00, indexJojos50Stages, 0x79 },
    { L"Country Town Night (3/21)", 0x07ddb00, 0x07ddd00, indexJojos50Stages, 0x7a },
    { L"Country Town Night (4/21)", 0x07ddd00, 0x07ddf00, indexJojos50Stages, 0x7b },
    { L"Country Town Night (5/21)", 0x07ddf00, 0x07de100, indexJojos50Stages, 0x7c },
    { L"Country Town Night (6/21)", 0x07de100, 0x07de300, indexJojos50Stages, 0x7d },
    { L"Country Town Night (7/21)", 0x07de300, 0x07de500, indexJojos50Stages, 0x7e },
    { L"Country Town Night (8/21)", 0x07de500, 0x07de700, indexJojos50Stages, 0x7f },
    { L"Country Town Night (9/21)", 0x07de700, 0x07de900, indexJojos50Stages, 0x80 },
    { L"Country Town Night (10/21)", 0x07de900, 0x07deb00, indexJojos50Stages, 0x81 },
    { L"Country Town Night (11/21)", 0x07deb00, 0x07ded00, indexJojos50Stages, 0x82 },
    { L"Country Town Night (12/21)", 0x07ded00, 0x07def00, indexJojos50Stages, 0x83 },
    { L"Country Town Night (13/21)", 0x07def00, 0x07df100, indexJojos50Stages, 0x84 },
    { L"Country Town Night (14/21)", 0x07df100, 0x07df300, indexJojos50Stages, 0x85 },
    { L"Country Town Night (15/21)", 0x07df300, 0x07df500, indexJojos50Stages, 0x86 },
    { L"Country Town Night (16/21)", 0x07df500, 0x07df700, indexJojos50Stages, 0x87 },
    { L"Country Town Night (17/21)", 0x07df700, 0x07df900, indexJojos50Stages, 0x88 },
    { L"Country Town Night (18/21)", 0x07df900, 0x07dfb00, indexJojos50Stages, 0x89 },
    { L"Country Town Night (19/21)", 0x07dfb00, 0x07dfd00, indexJojos50Stages, 0x8a },
    { L"Country Town Night (20/21)", 0x07dfd00, 0x07dff00, indexJojos50Stages, 0x8b },
    { L"Country Town Night (21/21)", 0x07dff00, 0x07e0080, indexJojos50Stages, 0x8c },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_SUBURB2[] =
{
    { L"Suburbs 2 (1/22)", 0x07e9500, 0x07e9700, indexJojos50Stages, 0x43, &pairFullyLinkedNode },
    { L"Suburbs 2 (2/22)", 0x07e9700, 0x07e9900, indexJojos50Stages, 0x44 },
    { L"Suburbs 2 (3/22)", 0x07e9900, 0x07e9b00, indexJojos50Stages, 0x45 },
    { L"Suburbs 2 (4/22)", 0x07e9b00, 0x07e9d00, indexJojos50Stages, 0x46 },
    { L"Suburbs 2 (5/22)", 0x07e9d00, 0x07e9f00, indexJojos50Stages, 0x47 },
    { L"Suburbs 2 (6/22)", 0x07e9f00, 0x07ea100, indexJojos50Stages, 0x48 },
    { L"Suburbs 2 (7/22)", 0x07ea100, 0x07ea300, indexJojos50Stages, 0x49 },
    { L"Suburbs 2 (8/22)", 0x07ea300, 0x07ea500, indexJojos50Stages, 0x4a },
    { L"Suburbs 2 (9/22)", 0x07ea500, 0x07ea700, indexJojos50Stages, 0x4b },
    { L"Suburbs 2 (10/22)", 0x07ea700, 0x07ea900, indexJojos50Stages, 0x4c },
    { L"Suburbs 2 (11/22)", 0x07ea900, 0x07eab00, indexJojos50Stages, 0x4d },
    { L"Suburbs 2 (12/22)", 0x07eab00, 0x07ead00, indexJojos50Stages, 0x4e },
    { L"Suburbs 2 (13/22)", 0x07ead00, 0x07eaf00, indexJojos50Stages, 0x4f },
    { L"Suburbs 2 (14/22)", 0x07eaf00, 0x07eb100, indexJojos50Stages, 0x50 },
    { L"Suburbs 2 (15/22)", 0x07eb100, 0x07eb300, indexJojos50Stages, 0x51 },
    { L"Suburbs 2 (16/22)", 0x07eb300, 0x07eb500, indexJojos50Stages, 0x52 },
    { L"Suburbs 2 (17/22)", 0x07eb500, 0x07eb700, indexJojos50Stages, 0x53 },
    { L"Suburbs 2 (18/22)", 0x07eb700, 0x07eb900, indexJojos50Stages, 0x54 },
    { L"Suburbs 2 (19/22)", 0x07eb900, 0x07ebb00, indexJojos50Stages, 0x55 },
    { L"Suburbs 2 (20/22)", 0x07ebb00, 0x07ebd00, indexJojos50Stages, 0x56 },
    { L"Suburbs 2 (21/22)", 0x07ebd00, 0x07ebf00, indexJojos50Stages, 0x57 },
    { L"Suburbs 2 (22/22)", 0x07ebf00, 0x07ec080 },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_SUBURB3[] =
{
    { L"Suburbs 3 (1/22)", 0x07ec100, 0x07ec300, indexJojos50Stages, 0x43, &pairFullyLinkedNode },
    { L"Suburbs 3 (2/22)", 0x07ec300, 0x07ec500, indexJojos50Stages, 0x44 },
    { L"Suburbs 3 (3/22)", 0x07ec500, 0x07ec700, indexJojos50Stages, 0x45 },
    { L"Suburbs 3 (4/22)", 0x07ec700, 0x07ec900, indexJojos50Stages, 0x46 },
    { L"Suburbs 3 (5/22)", 0x07ec900, 0x07ecb00, indexJojos50Stages, 0x47 },
    { L"Suburbs 3 (6/22)", 0x07ecb00, 0x07ecd00, indexJojos50Stages, 0x48 },
    { L"Suburbs 3 (7/22)", 0x07ecd00, 0x07ecf00, indexJojos50Stages, 0x49 },
    { L"Suburbs 3 (8/22)", 0x07ecf00, 0x07ed100, indexJojos50Stages, 0x4a },
    { L"Suburbs 3 (9/22)", 0x07ed100, 0x07ed300, indexJojos50Stages, 0x4b },
    { L"Suburbs 3 (10/22)", 0x07ed300, 0x07ed500, indexJojos50Stages, 0x4c },
    { L"Suburbs 3 (11/22)", 0x07ed500, 0x07ed700, indexJojos50Stages, 0x4d },
    { L"Suburbs 3 (12/22)", 0x07ed700, 0x07ed900, indexJojos50Stages, 0x4e },
    { L"Suburbs 3 (13/22)", 0x07ed900, 0x07edb00, indexJojos50Stages, 0x4f },
    { L"Suburbs 3 (14/22)", 0x07edb00, 0x07edd00, indexJojos50Stages, 0x50 },
    { L"Suburbs 3 (15/22)", 0x07edd00, 0x07edf00, indexJojos50Stages, 0x51 },
    { L"Suburbs 3 (16/22)", 0x07edf00, 0x07ee100, indexJojos50Stages, 0x52 },
    { L"Suburbs 3 (17/22)", 0x07ee100, 0x07ee300, indexJojos50Stages, 0x53 },
    { L"Suburbs 3 (18/22)", 0x07ee300, 0x07ee500, indexJojos50Stages, 0x54 },
    { L"Suburbs 3 (19/22)", 0x07ee500, 0x07ee700, indexJojos50Stages, 0x55 },
    { L"Suburbs 3 (20/22)", 0x07ee700, 0x07ee900, indexJojos50Stages, 0x56 },
    { L"Suburbs 3 (21/22)", 0x07ee900, 0x07eeb00, indexJojos50Stages, 0x57 },
    { L"Suburbs 3 (22/22)", 0x07eeb00, 0x07eec80 },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_NEW1[] = // aka Remains
{
    { L"New 1 (1/9)", 0x07cb200, 0x07cb280, indexJojos50Stages, 0x95, &pairFullyLinkedNode },
    { L"New 1 (2/9)", 0x07cb280, 0x07cb480, indexJojos50Stages, 0x96 },
    { L"New 1 (3/9)", 0x07cb480, 0x07cb680, indexJojos50Stages, 0x97 },
    { L"New 1 (4/9)", 0x07cb680, 0x07cb880, indexJojos50Stages, 0x98 },
    { L"New 1 (5/9)", 0x07cb880, 0x07cba80, indexJojos50Stages, 0x99 },
    { L"New 1 (6/9)", 0x07cba80, 0x07cbc80, indexJojos50Stages, 0x9a },
    { L"New 1 (7/9)", 0x07cbc80, 0x07cbe80, indexJojos50Stages, 0x9b },
    { L"New 1 (8/9)", 0x07cbe80, 0x07cc080, indexJojos50Stages, 0x9c },
    { L"New 1 (9/9)", 0x07cc080, 0x07cc280, indexJojos50Stages, 0x9d },
    // not actually shown { L"New 1 (10/10)", 0x07cc280, 0x07cc480 },
};
...
{
    { L"New 5 (1/8)", 0x07e1200, 0x07e1400, indexJojos50Stages, 0x5f, &pairFullyLinkedNode },
    { L"New 5 (2/8)", 0x07e1400, 0x07e1600, indexJojos50Stages, 0x60 },
    { L"New 5 (3/8)", 0x07e1600, 0x07e1800, indexJojos50Stages, 0x61 },
    { L"New 5 (4/8)", 0x07e1800, 0x07e1a00, indexJojos50Stages, 0x62 },
    { L"New 5 (5/8)", 0x07e1a00, 0x07e1c00, indexJojos50Stages, 0x63 },
    { L"New 5 (6/8)", 0x07e1c00, 0x07e1e00, indexJojos50Stages, 0x64 },
    { L"New 5 (7/8)", 0x07e1e00, 0x07e2000, indexJojos50Stages, 0x65 },
    { L"New 5 (8/8)", 0x07e2000, 0x07e2200, indexJojos50Stages, 0x66 },
};

const sGame_PaletteDataset JOJOS_A_STAGE_NODE_NEW6[] = // aka Inside House
{
    { L"New 6 (1/8)", 0x07e3300, 0x07e3500, indexJojos50Stages, 0x34 },
    { L"New 6 (2/8)", 0x07e3500, 0x07e3700, indexJojos50Stages, 0x35 },
    { L"New 6 (3/8)", 0x07e3700, 0x07e3900, indexJojos50Stages, 0x36 },
    { L"New 6 (4/8)", 0x07e3900, 0x07e3b00, indexJojos50Stages, 0x37 },
    { L"New 6 (5/8)", 0x07e3b00, 0x07e3d00, indexJojos50Stages, 0x38 },
    { L"New 6 (6/8)", 0x07e3d00, 0x07e3f00, indexJojos50Stages, 0x39 },
    { L"New 6 (7/8)", 0x07e3f00, 0x07e4100, indexJojos50Stages, 0x3a },
    { L"New 6 (8/8)", 0x07e4100, 0x07e4200, indexJojos50Stages, 0x3b },
};
...
const sGame_PaletteDataset JOJOS_A_CHARACTER_NODE_MARIAH_A[] =
{
    ...
    { L"Mariah Winpose Stuff A (1/2)", 0x0348000, 0x0348080, indexJojos51Mariah, 0x0a },
    { L"Mariah Winpose Stuff A (2/2)", 0x0348080, 0x0348100, indexJojos51Mariah, 0x0b },
...
const sGame_PaletteDataset JOJOS_A_CHARACTER_NODE_MARIAH_B[] =
{
    ...
    { L"Mariah Winpose Stuff B (1/2)", 0x035c500, 0x035c580, indexJojos51Mariah, 0x0a },
    { L"Mariah Winpose Stuff B (2/2)", 0x035c580, 0x035c600, indexJojos51Mariah, 0x0b },
...
const sGame_PaletteDataset JOJOS_A_CHARACTER_NODE_MARIAH_C[] =
{
    ...
    { L"Mariah Winpose Stuff C (1/2)", 0x0370a00, 0x0370a80, indexJojos51Mariah, 0x0a },
    { L"Mariah Winpose Stuff C (2/2)", 0x0370a80, 0x0370b00, indexJojos51Mariah, 0x0b },
...
const sGame_PaletteDataset JOJOS_A_CHARACTER_NODE_MARIAH_S[] =
{
    ...
    { L"Mariah Winpose Stuff S (1/2)", 0x0384f00, 0x0384f80, indexJojos51Mariah, 0x0a },
    { L"Mariah Winpose Stuff S (2/2)", 0x0384f80, 0x0385000, indexJojos51Mariah, 0x0b },
...
const sGame_PaletteDataset JOJOS_A_CHARACTER_NODE_MARIAH_Start[] =
{
    ...
    { L"Mariah Winpose Stuff Start (1/2)", 0x0399400, 0x0399480, indexJojos51Mariah, 0x0a },
    { L"Mariah Winpose Stuff Start (2/2)", 0x0399480, 0x0399500, indexJojos51Mariah, 0x0b },
...
const sGame_PaletteDataset JOJOS_BONUS_MENU_PALETTES[] =
{
    ...
    { L"Selector Rings", 0x0310080, 0x0310100, indexJojos51Bonus, 0x53 },
...
const sGame_PaletteDataset JOJOS_BONUS_INTRO_PALETTES[] =
{
    ...
    { L"Title Screen DIO",       0x030c500, 0x030c580, indexJojos51Bonus, 0x3A, &pairNext5 },
    { L"Title Screen DIO Fade 1", 0x030C780, 0x030C800, indexJojos51Bonus, 0x3A, &pairNext5 },
    { L"Title Screen DIO Fade 2", 0x030C800, 0x030C880, indexJojos51Bonus, 0x3A, &pairNext5 },
    { L"Title Screen DIO Fade 3", 0x030C880, 0x030C900, indexJojos51Bonus, 0x3A, &pairNext5 },
    { L"Title Screen DIO Manga", 0x030c900, 0x030c980, indexJojos51Bonus, 0x3A, &pairNext5 },
    { L"Title Screen Jotaro",    0x030c480, 0x030c500, indexJojos51Bonus, 0x39, &pairPrevious5 },
    { L"Title Screen Jotaro Fade 1", 0x030C980, 0x030CA00, indexJojos51Bonus, 0x39, &pairPrevious5 },
    { L"Title Screen Jotaro Fade 2", 0x030CA00, 0x030CA80, indexJojos51Bonus, 0x39, &pairPrevious5 },
    { L"Title Screen Jotaro Fade 3", 0x030CA80, 0x030CB00, indexJojos51Bonus, 0x39, &pairPrevious5 },
    { L"Title Screen Jotaro Manga", 0x030cb00, 0x030cb80, indexJojos51Bonus, 0x39, &pairPrevious5 },
...
const sGame_PaletteDataset JOJOS_BONUS_INGAME_PALETTES[] =
{
    ...
    { L"Blocksparks/OldSeph 360/Small Explosions", 0x03358a0, 0x0335900, indexJojos51Bonus, 0x52 },
...
{
    { L"A Lockup TS (1/7)", 0x02d0000, 0x02d0200, indexJojos50Stages, 0x3c, &pairFullyLinkedNode },
    { L"A Lockup TS (2/7)", 0x02d0200, 0x02d0400, indexJojos50Stages, 0x3d },
    { L"A Lockup TS (3/7)", 0x02d0400, 0x02d0600, indexJojos50Stages, 0x3e },
    { L"A Lockup TS (4/7)", 0x02d0600, 0x02d0800, indexJojos50Stages, 0x3f },
    { L"A Lockup TS (5/7)", 0x02d0800, 0x02d0a00, indexJojos50Stages, 0x40 },
    { L"A Lockup TS (6/7)", 0x02d0a00, 0x02d0c00, indexJojos50Stages, 0x41 },
    { L"A Lockup TS (7/7)", 0x02d0c00, 0x02d0d80, indexJojos50Stages, 0x42 },
};
...
{
    { L"In A Airplane TS (1/17)", 0x02d1a00, 0x02d1c00, indexJojos50Stages, 0x67, &pairFullyLinkedNode },
    { L"In A Airplane TS (2/17)", 0x02d1c00, 0x02d1e00, indexJojos50Stages, 0x68 },
    { L"In A Airplane TS (3/17)", 0x02d1e00, 0x02d2000, indexJojos50Stages, 0x69 },
    { L"In A Airplane TS (4/17)", 0x02d2000, 0x02d2200, indexJojos50Stages, 0x6a },
    { L"In A Airplane TS (5/17)", 0x02d2200, 0x02d2400, indexJojos50Stages, 0x6b },
    { L"In A Airplane TS (6/17)", 0x02d2400, 0x02d2600, indexJojos50Stages, 0x6c },
    { L"In A Airplane TS (7/17)", 0x02d2600, 0x02d2800, indexJojos50Stages, 0x6d },
    { L"In A Airplane TS (8/17)", 0x02d2800, 0x02d2a00, indexJojos50Stages, 0x6e },
    { L"In A Airplane TS (9/17)", 0x02d2a00, 0x02d2c00, indexJojos50Stages, 0x6f },
    { L"In A Airplane TS (10/17)", 0x02d2c00, 0x02d2e00, indexJojos50Stages, 0x70 },
    { L"In A Airplane TS (11/17)", 0x02d2e00, 0x02d3000, indexJojos50Stages, 0x71 },
    { L"In A Airplane TS (12/17)", 0x02d3000, 0x02d3200, indexJojos50Stages, 0x72 },
    { L"In A Airplane TS (13/17)", 0x02d3200, 0x02d3400, indexJojos50Stages, 0x73 },
    { L"In A Airplane TS (14/17)", 0x02d3400, 0x02d3600, indexJojos50Stages, 0x74 },
    { L"In A Airplane TS (15/17)", 0x02d3600, 0x02d3800, indexJojos50Stages, 0x75 },
    { L"In A Airplane TS (16/17)", 0x02d3800, 0x02d3a00, indexJojos50Stages, 0x76 },
    { L"In A Airplane TS (17/17)", 0x02d3a00, 0x02d3b80, indexJojos50Stages, 0x77 },
};
...
{
    { L"Remains / New 1 TS (1/9)", 0x02d6100, 0x02d6180, indexJojos50Stages, 0x95, &pairFullyLinkedNode },
    { L"Remains / New 1 TS (2/9)", 0x02d6180, 0x02d6380, indexJojos50Stages, 0x96 },
    { L"Remains / New 1 TS (3/9)", 0x02d6380, 0x02d6580, indexJojos50Stages, 0x97 },
    { L"Remains / New 1 TS (4/9)", 0x02d6580, 0x02d6780, indexJojos50Stages, 0x98 },
    { L"Remains / New 1 TS (5/9)", 0x02d6780, 0x02d6980, indexJojos50Stages, 0x99 },
    { L"Remains / New 1 TS (6/9)", 0x02d6980, 0x02d6b80, indexJojos50Stages, 0x9a },
    { L"Remains / New 1 TS (7/9)", 0x02d6b80, 0x02d6d80, indexJojos50Stages, 0x9b },
    { L"Remains / New 1 TS (8/9)", 0x02d6d80, 0x02d6f80, indexJojos50Stages, 0x9c },
    { L"Remains / New 1 TS (9/9)", 0x02d6f80, 0x02d7180, indexJojos50Stages, 0x9d },
};

const sGame_PaletteDataset JOJOS_A_TIMESTOP_NODE_HOTELJ[] =
{
    { L"Hotel (Justice) TS (1/8)", 0x02d7400, 0x02d7600, indexJojos50Stages, 0x8d, &pairFullyLinkedNode },
    { L"Hotel (Justice) TS (2/8)", 0x02d7600, 0x02d7800, indexJojos50Stages, 0x8e },
    { L"Hotel (Justice) TS (3/8)", 0x02d7800, 0x02d7a00, indexJojos50Stages, 0x8f },
    { L"Hotel (Justice) TS (4/8)", 0x02d7a00, 0x02d7c00, indexJojos50Stages, 0x90 },
    { L"Hotel (Justice) TS (5/8)", 0x02d7c00, 0x02d7e00, indexJojos50Stages, 0x91 },
    { L"Hotel (Justice) TS (6/8)", 0x02d7e00, 0x02d8000, indexJojos50Stages, 0x92 },
    { L"Hotel (Justice) TS (7/8)", 0x02d8000, 0x02d8200, indexJojos50Stages, 0x93 },
    { L"Hotel (Justice) TS (8/8)", 0x02d8200, 0x02d8280, indexJojos50Stages, 0x94 },
};
...
{
    { L"Desert Morning / Twilight TS (1/8)", 0x02d9f00, 0x02da100, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Morning / Twilight TS (2/8)", 0x02da100, 0x02da300, indexJojos50Stages, 0x59 },
    { L"Desert Morning / Twilight TS (3/8)", 0x02da300, 0x02da500, indexJojos50Stages, 0x5a },
    { L"Desert Morning / Twilight TS (4/8)", 0x02da500, 0x02da700, indexJojos50Stages, 0x5b },
    { L"Desert Morning / Twilight TS (5/8)", 0x02da700, 0x02da900, indexJojos50Stages, 0x5c },
    { L"Desert Morning / Twilight TS (6/8)", 0x02da900, 0x02dab00, indexJojos50Stages, 0x5d },
    { L"Desert Morning / Twilight TS (7/8)", 0x02dab00, 0x02dad00, indexJojos50Stages, 0x5e },
    { L"Desert Morning / Twilight TS (8/8)", 0x02dad00, 0x02dad80 },
};

const sGame_PaletteDataset JOJOS_A_TIMESTOP_NODE_DNOON[] =
{
    { L"Desert Noon TS (1/7)", 0x02d9000, 0x02d9200, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Noon TS (2/7)", 0x02d9200, 0x02d9400, indexJojos50Stages, 0x59 },
    { L"Desert Noon TS (3/7)", 0x02d9400, 0x02d9600, indexJojos50Stages, 0x5a },
    { L"Desert Noon TS (4/7)", 0x02d9600, 0x02d9800, indexJojos50Stages, 0x5b },
    { L"Desert Noon TS (5/7)", 0x02d9800, 0x02d9a00, indexJojos50Stages, 0x5c },
    { L"Desert Noon TS (6/7)", 0x02d9a00, 0x02d9c00, indexJojos50Stages, 0x5d },
    { L"Desert Noon TS (7/7)", 0x02d9c00, 0x02d9e00, indexJojos50Stages, 0x5e },
};

const sGame_PaletteDataset JOJOS_A_TIMESTOP_NODE_DNIGHT[] =
{
    { L"Desert Night TS (1/8)", 0x02dae00, 0x02db000, indexJojos50Stages, 0x58, &pairFullyLinkedNode },
    { L"Desert Night TS (2/8)", 0x02db000, 0x02db200, indexJojos50Stages, 0x59 },
    { L"Desert Night TS (3/8)", 0x02db200, 0x02db400, indexJojos50Stages, 0x5a },
    { L"Desert Night TS (4/8)", 0x02db400, 0x02db600, indexJojos50Stages, 0x5b },
    { L"Desert Night TS (5/8)", 0x02db600, 0x02db800, indexJojos50Stages, 0x5c },
    { L"Desert Night TS (6/8)", 0x02db800, 0x02dba00, indexJojos50Stages, 0x5d },
    { L"Desert Night TS (7/8)", 0x02dba00, 0x02dbc00, indexJojos50Stages, 0x5e },
    { L"Desert Night TS (8/8)", 0x02dbc00, 0x02dbc80 },
};
...
{
    { L"Country Town Noon / Twilight / Night TS (1/21)", 0x02dc800, 0x02dca00, indexJojos50Stages, 0x78, &pairFullyLinkedNode },
    { L"Country Town Noon / Twilight / Night TS (2/21)", 0x02dca00, 0x02dcc00, indexJojos50Stages, 0x79 },
    { L"Country Town Noon / Twilight / Night TS (3/21)", 0x02dcc00, 0x02dce00, indexJojos50Stages, 0x7a },
    { L"Country Town Noon / Twilight / Night TS (4/21)", 0x02dce00, 0x02dd000, indexJojos50Stages, 0x7b },
    { L"Country Town Noon / Twilight / Night TS (5/21)", 0x02dd000, 0x02dd200, indexJojos50Stages, 0x7c },
    { L"Country Town Noon / Twilight / Night TS (6/21)", 0x02dd200, 0x02dd400, indexJojos50Stages, 0x7d },
    { L"Country Town Noon / Twilight / Night TS (7/21)", 0x02dd400, 0x02dd600, indexJojos50Stages, 0x7e },
    { L"Country Town Noon / Twilight / Night TS (8/21)", 0x02dd600, 0x02dd800, indexJojos50Stages, 0x7f },
    { L"Country Town Noon / Twilight / Night TS (9/21)", 0x02dd800, 0x02dda00, indexJojos50Stages, 0x80 },
    { L"Country Town Noon / Twilight / Night TS (10/21)", 0x02dda00, 0x02ddc00, indexJojos50Stages, 0x81 },
    { L"Country Town Noon / Twilight / Night TS (11/21)", 0x02ddc00, 0x02dde00, indexJojos50Stages, 0x82 },
    { L"Country Town Noon / Twilight / Night TS (12/21)", 0x02dde00, 0x02de000, indexJojos50Stages, 0x83 },
    { L"Country Town Noon / Twilight / Night TS (13/21)", 0x02de000, 0x02de200, indexJojos50Stages, 0x84 },
    { L"Country Town Noon / Twilight / Night TS (14/21)", 0x02de200, 0x02de400, indexJojos50Stages, 0x85 },
    { L"Country Town Noon / Twilight / Night TS (15/21)", 0x02de400, 0x02de600, indexJojos50Stages, 0x86 },
    { L"Country Town Noon / Twilight / Night TS (16/21)", 0x02de600, 0x02de800, indexJojos50Stages, 0x87 },
    { L"Country Town Noon / Twilight / Night TS (17/21)", 0x02de800, 0x02dea00, indexJojos50Stages, 0x88 },
    { L"Country Town Noon / Twilight / Night TS (18/21)", 0x02dea00, 0x02dec00, indexJojos50Stages, 0x89 },
    { L"Country Town Noon / Twilight / Night TS (19/21)", 0x02dec00, 0x02dee00, indexJojos50Stages, 0x8a },
    { L"Country Town Noon / Twilight / Night TS (20/21)", 0x02dee00, 0x02df000, indexJojos50Stages, 0x8b },
    { L"Country Town Noon / Twilight / Night TS (21/21)", 0x02df000, 0x02df180, indexJojos50Stages, 0x8c },
};

const sGame_PaletteDataset JOJOS_A_TIMESTOP_NODE_UWATER[] =
{
    { L"Underground Water / New 5 TS (1/8)", 0x02df200, 0x02df400, indexJojos50Stages, 0x5f, &pairFullyLinkedNode },
    { L"Underground Water / New 5 TS (2/8)", 0x02df400, 0x02df600, indexJojos50Stages, 0x60 },
    { L"Underground Water / New 5 TS (3/8)", 0x02df600, 0x02df800, indexJojos50Stages, 0x61 },
    { L"Underground Water / New 5 TS (4/8)", 0x02df800, 0x02dfa00, indexJojos50Stages, 0x62 },
    { L"Underground Water / New 5 TS (5/8)", 0x02dfa00, 0x02dfc00, indexJojos50Stages, 0x63 },
    { L"Underground Water / New 5 TS (6/8)", 0x02dfc00, 0x02dfe00, indexJojos50Stages, 0x64 },
    { L"Underground Water / New 5 TS (7/8)", 0x02dfe00, 0x02e0000, indexJojos50Stages, 0x65 },
    { L"Underground Water / New 5 TS (8/8)", 0x02e0000, 0x02e0200, indexJojos50Stages, 0x66 },
};

const sGame_PaletteDataset JOJOS_A_TIMESTOP_NODE_INHOUSE[] =
{
    { L"Inside House / New 6 TS (1/8)", 0x02e0300, 0x02e0500, indexJojos50Stages, 0x34 },
    { L"Inside House / New 6 TS (2/8)", 0x02e0500, 0x02e0700, indexJojos50Stages, 0x35 },
    { L"Inside House / New 6 TS (3/8)", 0x02e0700, 0x02e0900, indexJojos50Stages, 0x36 },
    { L"Inside House / New 6 TS (4/8)", 0x02e0900, 0x02e0b00, indexJojos50Stages, 0x37 },
    { L"Inside House / New 6 TS (5/8)", 0x02e0b00, 0x02e0d00, indexJojos50Stages, 0x38 },
    { L"Inside House / New 6 TS (6/8)", 0x02e0d00, 0x02e0f00, indexJojos50Stages, 0x39 },
    { L"Inside House / New 6 TS (7/8)", 0x02e0f00, 0x02e1100, indexJojos50Stages, 0x3a },
    { L"Inside House / New 6 TS (8/8)", 0x02e1100, 0x02e1200, indexJojos50Stages, 0x3b },
};
...
{
    { L"Surburbs 1 / 2 / 3 TS (1/22)", 0x02e2300, 0x02e2500, indexJojos50Stages, 0x43, &pairFullyLinkedNode },
    { L"Surburbs 1 / 2 / 3 TS (2/22)", 0x02e2500, 0x02e2700, indexJojos50Stages, 0x44 },
    { L"Surburbs 1 / 2 / 3 TS (3/22)", 0x02e2700, 0x02e2900, indexJojos50Stages, 0x45 },
    { L"Surburbs 1 / 2 / 3 TS (4/22)", 0x02e2900, 0x02e2b00, indexJojos50Stages, 0x46 },
    { L"Surburbs 1 / 2 / 3 TS (5/22)", 0x02e2b00, 0x02e2d00, indexJojos50Stages, 0x47 },
    { L"Surburbs 1 / 2 / 3 TS (6/22)", 0x02e2d00, 0x02e2f00, indexJojos50Stages, 0x48 },
    { L"Surburbs 1 / 2 / 3 TS (7/22)", 0x02e2f00, 0x02e3100, indexJojos50Stages, 0x49 },
    { L"Surburbs 1 / 2 / 3 TS (8/22)", 0x02e3100, 0x02e3300, indexJojos50Stages, 0x4a },
    { L"Surburbs 1 / 2 / 3 TS (9/22)", 0x02e3300, 0x02e3500, indexJojos50Stages, 0x4b },
    { L"Surburbs 1 / 2 / 3 TS (10/22)", 0x02e3500, 0x02e3700, indexJojos50Stages, 0x4c },
    { L"Surburbs 1 / 2 / 3 TS (11/22)", 0x02e3700, 0x02e3900, indexJojos50Stages, 0x4d },
    { L"Surburbs 1 / 2 / 3 TS (12/22)", 0x02e3900, 0x02e3b00, indexJojos50Stages, 0x4e },
    { L"Surburbs 1 / 2 / 3 TS (13/22)", 0x02e3b00, 0x02e3d00, indexJojos50Stages, 0x4f },
    { L"Surburbs 1 / 2 / 3 TS (14/22)", 0x02e3d00, 0x02e3f00, indexJojos50Stages, 0x50 },
    { L"Surburbs 1 / 2 / 3 TS (15/22)", 0x02e3f00, 0x02e4100, indexJojos50Stages, 0x51 },
    { L"Surburbs 1 / 2 / 3 TS (16/22)", 0x02e4100, 0x02e4300, indexJojos50Stages, 0x52 },
    { L"Surburbs 1 / 2 / 3 TS (17/22)", 0x02e4300, 0x02e4500, indexJojos50Stages, 0x53 },
    { L"Surburbs 1 / 2 / 3 TS (18/22)", 0x02e4500, 0x02e4700, indexJojos50Stages, 0x54 },
    { L"Surburbs 1 / 2 / 3 TS (19/22)", 0x02e4700, 0x02e4900, indexJojos50Stages, 0x55 },
    { L"Surburbs 1 / 2 / 3 TS (20/22)", 0x02e4900, 0x02e4b00, indexJojos50Stages, 0x56 },
    { L"Surburbs 1 / 2 / 3 TS (21/22)", 0x02e4b00, 0x02e4d00, indexJojos50Stages, 0x57 },
...
const sDescTreeNode JOJOS_UNITS_51[ARRAYSIZE(JOJOS_A_UNITDESC_51)] =
{
    ...
    { L"Timestop Stages",           DESC_NODETYPE_TREE, (void*)JOJOS_TIMESTOP_COLLECTION, ARRAYSIZE(JOJOS_TIMESTOP_COLLECTION) },
