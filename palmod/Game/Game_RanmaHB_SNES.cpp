...
CGame_RANMAHB_SNES::CGame_RANMAHB_SNES(UINT32 nConfirmedROMSize)
{
    ...
    m_prgGameImageSet = RANMAHB_SNES_IMGIDS_USED;
...
size_t CGame_RANMAHB_SNES::rgExtraCountAll[RANMAHB_SNES_NUMUNIT + 1];
size_t CGame_RANMAHB_SNES::rgExtraLoc[RANMAHB_SNES_NUMUNIT + 1];
...
size_t CGame_RANMAHB_SNES::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, RANMAHB_SNES_NUMUNIT, nUnitId, RANMAHB_SNES_EXTRA_CUSTOM);
}

size_t CGame_RANMAHB_SNES::GetExtraLoc(size_t nUnitId)
{
...
sFileRule CGame_RANMAHB_SNES::GetRule(size_t nUnitId)
{
...
size_t CGame_RANMAHB_SNES::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_RANMAHB_SNES::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_RANMAHB_SNES::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(RANMAHB_SNES_UNITS, RANMAHB_SNES_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_RANMAHB_SNES::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_RANMAHB_SNES::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(RANMAHB_SNES_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_RANMAHB_SNES::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_RANMAHB_SNES::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_RANMAHB_SNES::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
