...
size_t CGame_MAGICALDROPIII_A::rgExtraCountAll[MAGICALDROPIII_A_NUMUNIT + 1];
size_t CGame_MAGICALDROPIII_A::rgExtraLoc[MAGICALDROPIII_A_NUMUNIT + 1];
...
size_t CGame_MAGICALDROPIII_A::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, MAGICALDROPIII_A_NUMUNIT, nUnitId, MAGICALDROPIII_A_EXTRA_CUSTOM);
}

size_t CGame_MAGICALDROPIII_A::GetExtraLoc(size_t nUnitId)
{
...
sFileRule CGame_MAGICALDROPIII_A::GetRule(size_t nUnitId)
{
...
size_t CGame_MAGICALDROPIII_A::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_MAGICALDROPIII_A::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_MAGICALDROPIII_A::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(MAGICALDROPIII_A_UNITS, MAGICALDROPIII_A_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_MAGICALDROPIII_A::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_MAGICALDROPIII_A::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(MAGICALDROPIII_A_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_MAGICALDROPIII_A::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_MAGICALDROPIII_A::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_MAGICALDROPIII_A::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
