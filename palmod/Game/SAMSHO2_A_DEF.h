...
{
    { L"Haohmaru P", 0x14a00, 0x14a20, indexSamSho1Sprites_Haohmaru, 0x00, &pairNext3 },
    { L"Haohmaru P Rage 1", 0x14a20, 0x14a40, indexSamSho1Sprites_Haohmaru, 0x00, &pairNext2 },
    { L"Haohmaru P Rage 2", 0x14a40, 0x14a60, indexSamSho1Sprites_Haohmaru, 0x00, &pairNext2 },
    { L"Haohmaru P Weapon 1", 0x14a60, 0x14a80, indexSamSho1Sprites_Haohmaru, 0x01 },
    { L"Haohmaru P Weapon 2", 0x14a80, 0x14aa0, indexSamSho1Sprites_Haohmaru, 0x01 },
    { L"Haohmaru P Burned", 0x14aa0, 0x14ac0, indexSamSho1Sprites_Haohmaru, 0x00 },
    { L"Haohmaru P Zapped", 0x14ac0, 0x14ae0, indexSamSho1Sprites_Haohmaru, 0x00 },
    { L"Haohmaru P Poisoned", 0x14ae0, 0x14b00, indexSamSho1Sprites_Haohmaru, 0x00 },
    { L"Haohmaru P Portrait/Doll", 0x16800, 0x16840 },
};

const sGame_PaletteDataset SAMSHO2_A_HAOHMARU_K[] =
{
    { L"Haohmaru K", 0x14b00, 0x14b20, indexSamSho1Sprites_Haohmaru, 0x00, &pairNext3 },
    { L"Haohmaru K Rage 1", 0x14b20, 0x14b40, indexSamSho1Sprites_Haohmaru, 0x00, &pairNext2 },
    { L"Haohmaru K Rage 2", 0x14b40, 0x14b60, indexSamSho1Sprites_Haohmaru, 0x00, &pairNext2 },
    { L"Haohmaru K Weapon 1", 0x14b60, 0x14b80, indexSamSho1Sprites_Haohmaru, 0x01 },
    { L"Haohmaru K Weapon 2", 0x14b80, 0x14ba0, indexSamSho1Sprites_Haohmaru, 0x01 },
    { L"Haohmaru K Burned", 0x14ba0, 0x14bc0, indexSamSho1Sprites_Haohmaru, 0x00 },
    { L"Haohmaru K Zapped", 0x14bc0, 0x14be0, indexSamSho1Sprites_Haohmaru, 0x00 },
    { L"Haohmaru K Poisoned", 0x14be0, 0x14c00, indexSamSho1Sprites_Haohmaru, 0x00 },
...
{
    { L"Nakoruru P", 0x14400, 0x14420 },
    { L"Nakoruru P Rage 1", 0x14420, 0x14440 },
    { L"Nakoruru P Rage 2", 0x14440, 0x14460 },
    { L"Nakoruru P Weapon 1", 0x14460, 0x14480 },
    { L"Nakoruru P Weapon 2", 0x14480, 0x144a0 },
    { L"Nakoruru P Burned", 0x144a0, 0x144c0 },
    { L"Nakoruru P Zapped", 0x144c0, 0x144e0 },
    { L"Nakoruru P Poisoned", 0x144e0, 0x14500 },
    { L"Mamahaha P", 0x17320, 0x17340 },
    { L"Nakoruru P Portrait/Doll", 0x16d00, 0x16d40 },
};

const sGame_PaletteDataset SAMSHO2_A_NAKORURU_K[] =
{
    { L"Nakoruru K", 0x14500, 0x14520 },
    { L"Nakoruru K Rage 1", 0x14520, 0x14540 },
    { L"Nakoruru K Rage 2", 0x14540, 0x14560 },
    { L"Nakoruru K Weapon 1", 0x14560, 0x14580 },
    { L"Nakoruru K Weapon 2", 0x14580, 0x145a0 },
    { L"Nakoruru K Burned", 0x145a0, 0x145c0 },
    { L"Nakoruru K Zapped", 0x145c0, 0x145e0 },
    { L"Nakoruru K Poisoned", 0x145e0, 0x14600 },
    { L"Mamahaha K", 0x17340, 0x17360 },
...
{
    { L"Hanzo P", 0x14e00, 0x14e20 },
    { L"Hanzo P Rage 1", 0x14e20, 0x14e40 },
    { L"Hanzo P Rage 2", 0x14e40, 0x14e60 },
    { L"Hanzo P Weapon 1", 0x14e60, 0x14e80 },
    { L"Hanzo P Weapon 2", 0x14e80, 0x14ea0 },
    { L"Hanzo P Burned", 0x14ea0, 0x14ec0 },
    { L"Hanzo P Zapped", 0x14ec0, 0x14ee0 },
    { L"Hanzo P Poisoned", 0x14ee0, 0x14f00 },
    { L"Hanzo P Portrait/Doll", 0x16880, 0x168c0 },
};

const sGame_PaletteDataset SAMSHO2_A_HANZO_K[] =
{
    { L"Hanzo K", 0x14f00, 0x14f20 },
    { L"Hanzo K Rage 1", 0x14f20, 0x14f40 },
    { L"Hanzo K Rage 2", 0x14f40, 0x14f60 },
    { L"Hanzo K Weapon 1", 0x14f60, 0x14f80 },
    { L"Hanzo K Weapon 2", 0x14f80, 0x14fa0 },
    { L"Hanzo K Burned", 0x14fa0, 0x14fc0 },
    { L"Hanzo K Zapped", 0x14fc0, 0x14fe0 },
    { L"Hanzo K Poisoned", 0x14fe0, 0x15000 },
    { L"Hanzo K Portrait/Doll", 0x168c0, 0x16900 },
};

const sGame_PaletteDataset SAMSHO2_A_GALFORD_P[] =
{
    { L"Galford P", 0x15000, 0x15020 },
    { L"Galford P Rage 1", 0x15020, 0x15040 },
    { L"Galford P Rage 2", 0x15040, 0x15060 },
    { L"Galford P Weapon 1", 0x15060, 0x15080 },
    { L"Galford P Weapon 2", 0x15080, 0x150a0 },
    { L"Galford P Burned", 0x150a0, 0x150c0 },
    { L"Galford P Zapped", 0x150c0, 0x150e0 },
    { L"Galford P Poisoned", 0x150e0, 0x15100 },
    { L"Poppy P", 0x172a0, 0x172c0 },
...
{
    { L"Galford K", 0x15100, 0x15120 },
    { L"Galford K Rage 1", 0x15120, 0x15140 },
    { L"Galford K Rage 2", 0x15140, 0x15160 },
    { L"Galford K Weapon 1", 0x15160, 0x15180 },
    { L"Galford K Weapon 2", 0x15180, 0x151a0 },
    { L"Galford K Burned", 0x151a0, 0x151c0 },
    { L"Galford K Zapped", 0x151c0, 0x151e0 },
    { L"Galford K Poisoned", 0x151e0, 0x15200 },
    { L"Poppy K", 0x172c0, 0x172e0 },
...
{
    { L"Wan-Fu P", 0x15c00, 0x15c20 },
    { L"Wan-Fu P Rage 1", 0x15c20, 0x15c40 },
    { L"Wan-Fu P Rage 2", 0x15c40, 0x15c60 },
    { L"Wan-Fu P Weapon 1", 0x15c60, 0x15c80 },
    { L"Wan-Fu P Weapon 2", 0x15c80, 0x15ca0 },
    { L"Wan-Fu P Burned", 0x15ca0, 0x15cc0 },
    { L"Wan-Fu P Zapped", 0x15cc0, 0x15ce0 },
    { L"Wan-Fu P Poisoned", 0x15ce0, 0x15d00 },
    { L"Wan-Fu P Portrait / Doll", 0x16b80, 0x16bc0 },
};

const sGame_PaletteDataset SAMSHO2_A_WANFU_K[] =
{
    { L"Wan-Fu K", 0x15d00, 0x15d20 },
    { L"Wan-Fu K Rage 1", 0x15d20, 0x15d40 },
    { L"Wan-Fu K Rage 2", 0x15d40, 0x15d60 },
    { L"Wan-Fu K Weapon 1", 0x15d60, 0x15d80 },
    { L"Wan-Fu K Weapon 2", 0x15d80, 0x15da0 },
    { L"Wan-Fu K Burned", 0x15da0, 0x15dc0 },
    { L"Wan-Fu K Zapped", 0x15dc0, 0x15de0 },
    { L"Wan-Fu K Poisoned", 0x15de0, 0x15e00 },
...
{
    { L"Ukyo P", 0x14600, 0x14620, indexSamSho1Sprites_Ukyo, 0x00, &pairNext3 },
    { L"Ukyo P Rage 1", 0x14620, 0x14640, indexSamSho1Sprites_Ukyo, 0x00, &pairNext2 },
    { L"Ukyo P Rage 2", 0x14640, 0x14660, indexSamSho1Sprites_Ukyo, 0x00, &pairNext2 },
    { L"Ukyo P Weapon 1", 0x14660, 0x14680, indexSamSho1Sprites_Ukyo, 0x01 },
    { L"Ukyo P Weapon 2", 0x14680, 0x146a0, indexSamSho1Sprites_Ukyo, 0x01 },
    { L"Ukyo P Burned", 0x146a0, 0x146c0, indexSamSho1Sprites_Ukyo, 0x00 },
    { L"Ukyo P Zapped", 0x146c0, 0x146e0, indexSamSho1Sprites_Ukyo, 0x00 },
    { L"Ukyo P Poisoned", 0x146e0, 0x14700, indexSamSho1Sprites_Ukyo, 0x00 },
    { L"Ukyo P Portrait/Doll", 0x16c00, 0x16c40 },
};

const sGame_PaletteDataset SAMSHO2_A_UKYO_K[] =
{
    { L"Ukyo K", 0x14700, 0x14720, indexSamSho1Sprites_Ukyo, 0x00, &pairNext3 },
    { L"Ukyo K Rage 1", 0x14720, 0x14740, indexSamSho1Sprites_Ukyo, 0x00, &pairNext2 },
    { L"Ukyo K Rage 2", 0x14740, 0x14760, indexSamSho1Sprites_Ukyo, 0x00, &pairNext2 },
    { L"Ukyo K Weapon 1", 0x14760, 0x14780, indexSamSho1Sprites_Ukyo, 0x01 },
    { L"Ukyo K Weapon 2", 0x14780, 0x147a0, indexSamSho1Sprites_Ukyo, 0x01 },
    { L"Ukyo K Burned", 0x147a0, 0x147c0, indexSamSho1Sprites_Ukyo, 0x00 },
    { L"Ukyo K Zapped", 0x147c0, 0x147e0, indexSamSho1Sprites_Ukyo, 0x00 },
    { L"Ukyo K Poisoned", 0x147e0, 0x14800, indexSamSho1Sprites_Ukyo, 0x00 },
...
{
    { L"Kyoshiro P", 0x15200, 0x15220 },
    { L"Kyoshiro P Rage 1", 0x15220, 0x15240 },
    { L"Kyoshiro P Rage 2", 0x15240, 0x15260 },
    { L"Kyoshiro P Weapon 1", 0x15260, 0x15280 },
    { L"Kyoshiro P Weapon 2", 0x15280, 0x152a0 },
    { L"Kyoshiro P Burned", 0x152a0, 0x152c0 },
    { L"Kyoshiro P Zapped", 0x152c0, 0x152e0 },
    { L"Kyoshiro P Poisoned", 0x152e0, 0x15300 },
    { L"Kyoshiro P Portrait/Doll", 0x16c80, 0x16cc0 },
};

const sGame_PaletteDataset SAMSHO2_A_KYOSHIRO_K[] =
{
    { L"Kyoshiro K", 0x15300, 0x15320 },
    { L"Kyoshiro K Rage 1", 0x15320, 0x15340 },
    { L"Kyoshiro K Rage 2", 0x15340, 0x15360 },
    { L"Kyoshiro K Weapon 1", 0x15360, 0x15380 },
    { L"Kyoshiro K Weapon 2", 0x15380, 0x153a0 },
    { L"Kyoshiro K Burned", 0x153a0, 0x153c0 },
    { L"Kyoshiro K Zapped", 0x153c0, 0x153e0 },
    { L"Kyoshiro K Poisoned", 0x153e0, 0x15400 },
...
{
    { L"Gen-an P", 0x15400, 0x15420 },
    { L"Gen-an P Rage 1", 0x15420, 0x15440 },
    { L"Gen-an P Rage 2", 0x15440, 0x15460 },
    { L"Gen-an P Weapon 1", 0x15460, 0x15480 },
    { L"Gen-an P Weapon 2", 0x15480, 0x154a0 },
    { L"Gen-an P Burned", 0x154a0, 0x154c0 },
    { L"Gen-an P Zapped", 0x154c0, 0x154e0 },
    { L"Gen-an P Poisoned", 0x154e0, 0x15500 },
    { L"Gen-an P Portrait/Doll", 0x16a00, 0x16a40 },
};

const sGame_PaletteDataset SAMSHO2_A_GENAN_K[] =
{
    { L"Gen-an K", 0x15500, 0x15520 },
    { L"Gen-an K Rage 1", 0x15520, 0x15540 },
    { L"Gen-an K Rage 2", 0x15540, 0x15560 },
    { L"Gen-an K Weapon 1", 0x15560, 0x15580 },
    { L"Gen-an K Weapon 2", 0x15580, 0x155a0 },
    { L"Gen-an K Burned", 0x155a0, 0x155c0 },
    { L"Gen-an K Zapped", 0x155c0, 0x155e0 },
    { L"Gen-an K Poisoned", 0x155e0, 0x15600 },
...
{
    { L"Earthquake P", 0x14c00, 0x14c20 },
    { L"Earthquake P Rage 1", 0x14c20, 0x14c40 },
    { L"Earthquake P Rage 2", 0x14c40, 0x14c60 },
    { L"Earthquake P Weapon 1", 0x14c60, 0x14c80 },
    { L"Earthquake P Weapon 2", 0x14c80, 0x14ca0 },
    { L"Earthquake P Burned", 0x14ca0, 0x14cc0 },
    { L"Earthquake P Zapped", 0x14cc0, 0x14ce0 },
    { L"Earthquake P Poisoned", 0x14ce0, 0x14d00 },
    { L"Earthquake P Portrait/Doll", 0x16b00, 0x16b40 },
};

const sGame_PaletteDataset SAMSHO2_A_EARTHQUAKE_K[] =
{
    { L"Earthquake K", 0x14d00, 0x14d20 },
    { L"Earthquake K Rage 1", 0x14d20, 0x14d40 },
    { L"Earthquake K Rage 2", 0x14d40, 0x14d60 },
    { L"Earthquake K Weapon 1", 0x14d60, 0x14d80 },
    { L"Earthquake K Weapon 2", 0x14d80, 0x14da0 },
    { L"Earthquake K Burned", 0x14da0, 0x14dc0 },
    { L"Earthquake K Zapped", 0x14dc0, 0x14de0 },
    { L"Earthquake K Poisoned", 0x14de0, 0x14e00 },
    { L"Earthquake K Portrait/Doll", 0x16b40, 0x16b80 },
};

const sGame_PaletteDataset SAMSHO2_A_JUBEI_P[] =
{
    { L"Jubei P", 0x15800, 0x15820 },
    { L"Jubei P Rage 1", 0x15820, 0x15840 },
    { L"Jubei P Rage 2", 0x15840, 0x15860 },
    { L"Jubei P Weapon 1", 0x15860, 0x15880 },
    { L"Jubei P Weapon 2", 0x15880, 0x158a0 },
    { L"Jubei P Burned", 0x158a0, 0x158c0 },
    { L"Jubei P Zapped", 0x158c0, 0x158e0 },
    { L"Jubei P Poisoned", 0x158e0, 0x15900 },
    { L"Jubei P Portrait/Doll", 0x16980, 0x169c0 },
};

const sGame_PaletteDataset SAMSHO2_A_JUBEI_K[] =
{
    { L"Jubei K", 0x15900, 0x15920 },
    { L"Jubei K Rage 1", 0x15920, 0x15940 },
    { L"Jubei K Rage 2", 0x15940, 0x15960 },
    { L"Jubei K Weapon 1", 0x15960, 0x15980 },
    { L"Jubei K Weapon 2", 0x15980, 0x159a0 },
    { L"Jubei K Burned", 0x159a0, 0x159c0 },
    { L"Jubei K Zapped", 0x159c0, 0x159e0 },
    { L"Jubei K Poisoned", 0x159e0, 0x15a00 },
    { L"Jubei K Portrait/Doll", 0x169c0, 0x16a00 },
};

const sGame_PaletteDataset SAMSHO2_A_CHARLOTTE_P[] =
{
    { L"Charlotte P", 0x14800, 0x14820 },
    { L"Charlotte P Rage 1", 0x14820, 0x14840 },
    { L"Charlotte P Rage 2", 0x14840, 0x14860 },
    { L"Charlotte P Weapon 1", 0x14860, 0x14880 },
    { L"Charlotte P Weapon 2", 0x14880, 0x148a0 },
    { L"Charlotte P Burned", 0x148a0, 0x148c0 },
    { L"Charlotte P Zapped", 0x148c0, 0x148e0 },
    { L"Charlotte P Poisoned", 0x148e0, 0x14900 },
    { L"Charlotte P Portrait/Doll", 0x16a80, 0x16ac0 },
};

const sGame_PaletteDataset SAMSHO2_A_CHARLOTTE_K[] =
{
    { L"Charlotte K", 0x14900, 0x14920 },
    { L"Charlotte K Rage 1", 0x14920, 0x14940 },
    { L"Charlotte K Rage 2", 0x14940, 0x14960 },
    { L"Charlotte K Weapon 1", 0x14960, 0x14980 },
    { L"Charlotte K Weapon 2", 0x14980, 0x149a0 },
    { L"Charlotte K Burned", 0x149a0, 0x149c0 },
    { L"Charlotte K Zapped", 0x149c0, 0x149e0 },
    { L"Charlotte K Poisoned", 0x149e0, 0x14a00 },
...
{
    { L"Genjuro P", 0x15600, 0x15620 },
    { L"Genjuro P Rage 1", 0x15620, 0x15640 },
    { L"Genjuro P Rage 2", 0x15640, 0x15660 },
    { L"Genjuro P Weapon 1", 0x15660, 0x15680 },
    { L"Genjuro P Weapon 2", 0x15680, 0x156a0 },
    { L"Genjuro P Burned", 0x156a0, 0x156c0 },
    { L"Genjuro P Zapped", 0x156c0, 0x156e0 },
    { L"Genjuro P Poisoned", 0x156e0, 0x15700 },
    { L"Genjuro P Portrait/Doll", 0x16e80, 0x16ec0 },
};

const sGame_PaletteDataset SAMSHO2_A_GENJURO_K[] =
{
    { L"Genjuro K", 0x15700, 0x15720 },
    { L"Genjuro K Rage 1", 0x15720, 0x15740 },
    { L"Genjuro K Rage 2", 0x15740, 0x15760 },
    { L"Genjuro K Weapon 1", 0x15760, 0x15780 },
    { L"Genjuro K Weapon 2", 0x15780, 0x157a0 },
    { L"Genjuro K Burned", 0x157a0, 0x157c0 },
    { L"Genjuro K Zapped", 0x157c0, 0x157e0 },
    { L"Genjuro K Poisoned", 0x157e0, 0x15800 },
...
{
    { L"Cham Cham P", 0x15a00, 0x15a20 },
    { L"Cham Cham P Rage 1", 0x15a20, 0x15a40 },
    { L"Cham Cham P Rage 2", 0x15a40, 0x15a60 },
    { L"Cham Cham P Weapon 1", 0x15a60, 0x15a80 },
    { L"Cham Cham P Weapon 2", 0x15a80, 0x15aa0 },
    { L"Cham Cham P Burned", 0x15aa0, 0x15ac0 },
    { L"Cham Cham P Zapped", 0x15ac0, 0x15ae0 },
    { L"Cham Cham P Poisoned", 0x15ae0, 0x15b00 },
    { L"Paku Paku P", 0x17660, 0x17680 },
    { L"Cham-Cham P Portrait/Doll", 0x16f80, 0x16fc0 },
};

const sGame_PaletteDataset SAMSHO2_A_CHAMCHAM_K[] =
{
    { L"Cham Cham K", 0x15b00, 0x15b20 },
    { L"Cham Cham K Rage 1", 0x15b20, 0x15b40 },
    { L"Cham Cham K Rage 2", 0x15b40, 0x15b60 },
    { L"Cham Cham K Weapon 1", 0x15b60, 0x15b80 },
    { L"Cham Cham K Weapon 2", 0x15b80, 0x15ba0 },
    { L"Cham Cham K Burned", 0x15ba0, 0x15bc0 },
    { L"Cham Cham K Zapped", 0x15bc0, 0x15be0 },
    { L"Cham Cham K Poisoned", 0x15be0, 0x15c00 },
    { L"Paku Paku K", 0x17680, 0x176a0 },
...
{
    { L"Sieger P", 0x15e00, 0x15e20 },
    { L"Sieger P Rage 1", 0x15e20, 0x15e40 },
    { L"Sieger P Rage 2", 0x15e40, 0x15e60 },
    { L"Sieger P Weapon 1", 0x15e60, 0x15e80 },
    { L"Sieger P Weapon 2", 0x15e80, 0x15ea0 },
    { L"Sieger P Burned", 0x15ea0, 0x15ec0 },
    { L"Sieger P Zapped", 0x15ec0, 0x15ee0 },
    { L"Sieger P Poisoned", 0x15ee0, 0x15f00 },
    { L"Sieger P Portrait/Doll", 0x16e00, 0x16e40 },
};

const sGame_PaletteDataset SAMSHO2_A_SIEGER_K[] =
{
    { L"Sieger K", 0x15f00, 0x15f20 },
    { L"Sieger K Rage 1", 0x15f20, 0x15f40 },
    { L"Sieger K Rage 2", 0x15f40, 0x15f60 },
    { L"Sieger K Weapon 1", 0x15f60, 0x15f80 },
    { L"Sieger K Weapon 2", 0x15f80, 0x15fa0 },
    { L"Sieger K Burned", 0x15fa0, 0x15fc0 },
    { L"Sieger K Zapped", 0x15fc0, 0x15fe0 },
    { L"Sieger K Poisoned", 0x15fe0, 0x16000 },
    { L"Sieger K Portrait/Doll", 0x16e40, 0x16e80 },
};

const sGame_PaletteDataset SAMSHO2_A_NICOTINE_P[] =
{
    { L"Nicotine P", 0x16000, 0x16020 },
    { L"Nicotine P Rage 1", 0x16020, 0x16040 },
    { L"Nicotine P Rage 2", 0x16040, 0x16060 },
    { L"Nicotine P Weapon 1", 0x16060, 0x16080 },
    { L"Nicotine P Weapon 2", 0x16080, 0x160a0 },
    { L"Nicotine P Burned", 0x160a0, 0x160c0 },
    { L"Nicotine P Zapped", 0x160c0, 0x160e0 },
    { L"Nicotine P Poisoned", 0x160e0, 0x16100 },
    { L"Nicotine P Portrait/Doll", 0x16f00, 0x16f40 },
};

const sGame_PaletteDataset SAMSHO2_A_NICOTINE_K[] =
{
    { L"Nicotine K", 0x16100, 0x16120 },
    { L"Nicotine K Rage 1", 0x16120, 0x16140 },
    { L"Nicotine K Rage 2", 0x16140, 0x16160 },
    { L"Nicotine K Weapon 1", 0x16160, 0x16180 },
    { L"Nicotine K Weapon 2", 0x16180, 0x161a0 },
    { L"Nicotine K Burned", 0x161a0, 0x161c0 },
    { L"Nicotine K Zapped", 0x161c0, 0x161e0 },
    { L"Nicotine K Poisoned", 0x161e0, 0x16200 },
...
{
    { L"Mizuki", 0x16300, 0x16320 },
    { L"Mizuki Rage 1", 0x16320, 0x16340 },
    { L"Mizuki Rage 2", 0x16340, 0x16360 },
    { L"Mizuki Weapon 1", 0x16360, 0x16380 },
    { L"Mizuki Weapon 2", 0x16380, 0x163a0 },
...
{
    { L"Kuroko", 0x16200, 0x16220 },
    { L"Kuroko Rage 1", 0x16220, 0x16240 },
    { L"Kuroko Rage 2", 0x16240, 0x16260 },
    { L"Kuroko Unused 1", 0x16260, 0x16280 },
    { L"Kuroko Unused 2", 0x16280, 0x162a0 },
    { L"Kuroko Burned", 0x162a0, 0x162c0 },
    { L"Kuroko Zapped", 0x162c0, 0x162e0 },
    { L"Kuroko Poisoned", 0x162e0, 0x16300 },
...
const sDescTreeNode SAMSHO2_A_UNITS[] =
{
    ...
    { L"Sieger", DESC_NODETYPE_TREE, (void*)SAMSHO2_A_SIEGER_COLLECTION, ARRAYSIZE(SAMSHO2_A_SIEGER_COLLECTION) },
