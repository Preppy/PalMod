...
sDescTreeNode* CGame_CFTE_SNES::InitDescTree()
{
    ...
    strMsg.Format(L"CGame_CFTE_SNES::InitDescTree: Building desc tree for CFTE_SNES %s extras...\n", fHaveExtras ? L"with" : L"without");
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < CFTE_SNES_EXTRALOC)
        {
            ...
            _snwprintf_s(UnitNode->szDesc, ARRAYSIZE(UnitNode->szDesc), _TRUNCATE, L"%s", CFTE_SNES_UNITS[iUnitCtr].szDesc);
    ...
    strMsg.Format(L"CGame_CFTE_SNES::InitDescTree: Loaded %u palettes for CFTE\n", nTotalPaletteCount);
    OutputDebugString(strMsg);
...
#if CFTE_SNES_DEBUG
        CString strMsg;
        strMsg.Format(L"CGame_CFTE_SNES::GetPaletteCountForUnit: %u for unit %u which has %u collections.\n", nCompleteCount, nUnitId, nCollectionCount);
        OutputDebugString(strMsg);
#endif
