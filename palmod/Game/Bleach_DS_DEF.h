...
//Yuchi Palettes
const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P1[] =
{
    { L"Yuchi P1", 0x272f034, 0x272f054 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P2[] =
{
    { L"Yuchi P2", 0x272f054, 0x272f074 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P3[] =
{
    { L"Yuchi P3", 0x272f074, 0x272f094 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P4[] =
{
    { L"Yuchi P4", 0x272f094, 0x272f0b4 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P5[] =
{
    { L"Yuchi P5", 0x272f0b4, 0x272f0d4 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P6[] =
{
    { L"Yuchi P6", 0x272f0d4, 0x272f0f4 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P7[] =
{
    { L"Yuchi P7", 0x272f0f4, 0x272f114 },
};

const sGame_PaletteDataset BLEACH_DS_YUCHI_PALETTES_P8[] =
{
    { L"Yuchi P8", 0x272f114, 0x272f134 },
};

const sDescTreeNode BLEACH_DS_YUCHI_COLLECTION[] =
{
    { L"Palette 1", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P1, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P1) },
    { L"Palette 2", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P2, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P2) },
    { L"Palette 3", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P3, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P3) },
    { L"Palette 4", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P4, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P4) },
    { L"Palette 5", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P5, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P5) },
    { L"Palette 6", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P6, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P6) },
    { L"Palette 7", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P7, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P7) },
    { L"Palette 8", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_PALETTES_P8, ARRAYSIZE(BLEACH_DS_YUCHI_PALETTES_P8) },
...
{
    { L"Byakuya P1", 0x201a440, 0x201a460 },
...
{
    { L"Byakuya P2", 0x201a4a0, 0x201a4c0 },
...
{
    { L"Byakuya P3", 0x201a500, 0x201a520 },
...
{
    { L"Byakuya P4", 0x201a560, 0x201a580 },
...
{
    { L"Byakuya P5", 0x201a5c0, 0x201a5e0 },
...
{
    { L"Byakuya P6", 0x201a620, 0x201a640 },
...
{
    { L"Byakuya P7", 0x201a680, 0x201a6a0 },
...
{
    { L"Byakuya P8", 0x201a6e0, 0x201a700 },
...
{
    { L"Yamamoto P1", 0x2091720, 0x2091740 },
...
{
    { L"Yamamoto P2", 0x2091820, 0x2091840 },
...
{
    { L"Yamamoto P3", 0x2091920, 0x2091940 },
...
{
    { L"Yamamoto P4", 0x2091a20, 0x2091a40 },
...
{
    { L"Yamamoto P5", 0x2091b20, 0x2091b40 },
...
{
    { L"Yamamoto P6", 0x2091c20, 0x2091c40 },
...
{
    { L"Yamamoto P7", 0x2091d20, 0x2091d40 },
...
{
    { L"Yamamoto P8", 0x2091e20, 0x2091e40 },
...
{
    { L"Mayuri P1", 0x2427440, 0x2427460 },
    { L"Nemu P1", 0x2431ca0, 0x2431cc0 },
...
{
    { L"Mayuri P2", 0x24274a0, 0x24274c0 },
    { L"Nemu P2", 0x2431cc0, 0x2431ce0 },
...
{
    { L"Mayuri P3", 0x2427500, 0x2427520 },
    { L"Nemu P3", 0x2431ce0, 0x2431d00 },
...
{
    { L"Mayuri P4", 0x2427560, 0x2427580 },
    { L"Nemu P4", 0x2431d00, 0x2431d20 },
...
{
    { L"Mayuri P5", 0x24275c0, 0x24275e0 },
    { L"Nemu P5", 0x2431d20, 0x2431d40 },
...
{
    { L"Mayuri P6", 0x2427620, 0x2427640 },
    { L"Nemu P6", 0x2431d40, 0x2431d60 },
...
{
    { L"Mayuri P7", 0x2427680, 0x24276a0 },
    { L"Nemu P7", 0x2431d60, 0x2431d80 },
...
{
    { L"Mayuri P8", 0x24276e0, 0x2427700 },
    { L"Nemu P8", 0x2431d80, 0x2431da0 },
...
{
    { L"Hanataro P1", 0x20b5358, 0x20b5378 },
...
{
    { L"Hanataro P2", 0x20b53b8, 0x20b53d8 },
...
{
    { L"Hanataro P3", 0x20b5418, 0x20b5438 },
...
{
    { L"Hanataro P4", 0x20b5478, 0x20b5498 },
...
{
    { L"Hanataro P5", 0x20b54d8, 0x20b54f8 },
...
{
    { L"Hanataro P6", 0x20b5538, 0x20b5558 },
...
{
    { L"Hanataro P7", 0x20b5598, 0x20b55b8 },
...
{
    { L"Hanataro P8", 0x20b55f8, 0x20b5618 },
...
{
    { L"Ikkaku P1", 0x2297a2c, 0x2297a4c },
...
{
    { L"Ikkaku P2", 0x2297a8c, 0x2297aac },
...
{
    { L"Ikkaku P3", 0x2297aec, 0x2297b0c },
...
{
    { L"Ikkaku P4", 0x2297b4c, 0x2297b6c },
...
{
    { L"Ikkaku P5", 0x2297bac, 0x2297bcc },
...
{
    { L"Ikkaku P6", 0x2297c0c, 0x2297c2c },
...
{
    { L"Ikkaku P7", 0x2297c6c, 0x2297c8c },
...
{
    { L"Ikkaku P8", 0x2297ccc, 0x2297cec },
...
{
    { L"Rangiku P1", 0x24be508, 0x24be528 },
...
{
    { L"Rangiku P2", 0x24be568, 0x24be588 },
...
{
    { L"Rangiku P3", 0x24be5c8, 0x24be5e8 },
...
{
    { L"Rangiku P4", 0x24be628, 0x24be648 },
...
{
    { L"Rangiku P5", 0x24be688, 0x24be6a8 },
...
{
    { L"Rangiku P6", 0x24be6e8, 0x24be708 },
...
{
    { L"Rangiku P7", 0x24be748, 0x24be768 },
...
{
    { L"Rangiku P8", 0x24be7a8, 0x24be7c8 },
...
{
    { L"Ichigo P1", 0x219e8cc, 0x219e8ec },
    { L"Extra 1 P1", 0x219e8ec, 0x219e90c },
    { L"Extra 2 P1", 0x219e90c, 0x219e92c },
...
{
    { L"Ichigo P7", 0x219ebcc, 0x219ebec },
    { L"Extra 1 P7", 0x219ebec, 0x219ec0c },
    { L"Extra 2 P7", 0x219ec0c, 0x219ec2c },
...
{
    { L"Ichigo P8", 0x219ec4c, 0x219ec6c },
    { L"Extra 1 P8", 0x219ec6c, 0x219ec8c },
    { L"Extra 2 P8", 0x219ec8c, 0x219ecac },
...
{
    { L"Kenpachi P1", 0x23296f0, 0x2329710 },
...
{
    { L"Kenpachi P2", 0x2329750, 0x2329770 },
...
{
    { L"Kenpachi P3", 0x23297b0, 0x23297d0 },
...
{
    { L"Kenpachi P4", 0x2329810, 0x2329830 },
...
{
    { L"Kenpachi P5", 0x2329870, 0x2329890 },
...
{
    { L"Kenpachi P6", 0x23298d0, 0x23298f0 },
...
{
    { L"Kenpachi P7", 0x2329930, 0x2329950 },
...
{
    { L"Kenpachi P8", 0x2329990, 0x23299b0 },
...
{
    { L"Rukia P1", 0x2519264, 0x2519284 },
...
{
    { L"Rukia P2", 0x25192c4, 0x25192e4 },
...
{
    { L"Rukia P3", 0x2519324, 0x2519344 },
...
{
    { L"Rukia P4", 0x2519384, 0x25193a4 },
...
{
    { L"Rukia P5", 0x25193e4, 0x2519404 },
...
{
    { L"Rukia P6", 0x2519444, 0x2519464 },
...
{
    { L"Rukia P7", 0x25194a4, 0x25194c4 },
...
{
    { L"Rukia P8", 0x2519504, 0x2519524 },
...
{
    { L"Hinamori P1", 0x20d5a40, 0x20d5a60 },
...
{
    { L"Hinamori P2", 0x20d5aa0, 0x20d5ac0 },
...
{
    { L"Hinamori P3", 0x20d5b00, 0x20d5b20 },
...
{
    { L"Hinamori P4", 0x20d5b60, 0x20d5b80 },
...
{
    { L"Hinamori P5", 0x20d5bc0, 0x20d5be0 },
...
{
    { L"Hinamori P6", 0x20d5c20, 0x20d5c40 },
...
{
    { L"Hinamori P7", 0x20d5c80, 0x20d5ca0 },
...
{
    { L"Hinamori P8", 0x20d5ce0, 0x20d5d00 },
...
{
    { L"Orihime P1", 0x2475974, 0x2475994 },
...
{
    { L"Orihime P2", 0x24759d4, 0x24759f4 },
...
{
    { L"Orihime P3", 0x2475a34, 0x2475a54 },
...
{
    { L"Orihime P4", 0x2475a94, 0x2475ab4 },
...
{
    { L"Orihime P5", 0x2475af4, 0x2475b14 },
...
{
    { L"Orihime P6", 0x2475b54, 0x2475b74 },
...
{
    { L"Orihime P7", 0x2475bb4, 0x2475bd4 },
...
{
    { L"Orihime P8", 0x2475c14, 0x2475c34 },
...
{
    { L"Kukaku P1", 0x23a95b8, 0x23a95d8 },
...
{
    { L"Kukaku P2", 0x23a9618, 0x23a9638 },
...
{
    { L"Kukaku P3", 0x23a9678, 0x23a9698 },
...
{
    { L"Kukaku P4", 0x23a96d8, 0x23a96f8 },
...
{
    { L"Kukaku P5", 0x23a9738, 0x23a9758 },
...
{
    { L"Kukaku P6", 0x23a9798, 0x23a97b8 },
...
{
    { L"Kukaku P7", 0x23a97f8, 0x23a9818 },
...
{
    { L"Kukaku P8", 0x23a9858, 0x23a9878 },
...
{
    { L"Hollow Ichigo P1", 0x21e4a34, 0x21e4a54 },
    { L"Extra 1 P1", 0x21e4a54, 0x21e4a74 },
    { L"Extra 2 P1", 0x21e4a74, 0x21e4a94 },
...
{
    { L"Hollow Ichigo P2", 0x21e4ad4, 0x21e4af4 },
    { L"Extra 1 P2", 0x21e4af4, 0x21e4b14 },
    { L"Extra 2 P2", 0x21e4b14, 0x21e4b34 },
...
{
    { L"Hollow Ichigo P3", 0x21e4b74, 0x21e4b94 },
    { L"Extra 1 P3", 0x21e4b94, 0x21e4bb4 },
    { L"Extra 2 P3", 0x21e4bb4, 0x21e4bd4 },
...
{
    { L"Hollow Ichigo P4", 0x21e4c14, 0x21e4c34 },
    { L"Extra 1 P4", 0x21e4c34, 0x21e4c54 },
    { L"Extra 2 P4", 0x21e4c54, 0x21e4c74 },
...
{
    { L"Hollow Ichigo P5", 0x21e4cb4, 0x21e4cd4 },
    { L"Extra 1 P5", 0x21e4cd4, 0x21e4cf4 },
    { L"Extra 2 P5", 0x21e4cf4, 0x21e4d14 },
...
{
    { L"Hollow Ichigo P6", 0x21e4d54, 0x21e4d74 },
    { L"Extra 1 P6", 0x21e4d74, 0x21e4d94 },
    { L"Extra 2 P6", 0x21e4d94, 0x21e4db4 },
...
{
    { L"Hollow Ichigo P7", 0x21e4df4, 0x21e4e14 },
    { L"Extra 1 P7", 0x21e4e14, 0x21e4e34 },
    { L"Extra 2 P7", 0x21e4e34, 0x21e4e54 },
...
{
    { L"Hollow Ichigo P8", 0x21e4e94, 0x21e4eb4 },
    { L"Extra 1 P8", 0x21e4eb4, 0x21e4ed4 },
    { L"Extra 2 P8", 0x21e4ed4, 0x21e4ef4 },
...
{
    { L"Yuchi", DESC_NODETYPE_TREE, (void*)BLEACH_DS_YUCHI_COLLECTION, ARRAYSIZE(BLEACH_DS_YUCHI_COLLECTION) },
