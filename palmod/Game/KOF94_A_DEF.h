...
const std::vector<uint16_t> KOF94_A_IMGIDS_USED =
{
...
const sGame_PaletteDataset KOF94_A_HEIDERN_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x176100, 0x176120, indexKOF94Sprites_Heidern, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x176120, 0x176140, indexKOF94Sprites_Heidern, 0x40 },
...
const sGame_PaletteDataset KOF94_A_HEIDERN_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x1762c0, 0x1762e0, indexKOF94Sprites_Heidern, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1762e0, 0x176300, indexKOF94Sprites_Heidern, 0x40 },
...
const sGame_PaletteDataset KOF94_A_RALF_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x176480, 0x1764a0, indexKOF94Sprites_Ralf, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1764a0, 0x1764c0, indexKOF94Sprites_Ralf, 0x40 },
...
const sGame_PaletteDataset KOF94_A_RALF_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x176640, 0x176660, indexKOF94Sprites_Ralf, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x176660, 0x176680, indexKOF94Sprites_Ralf, 0x40 },
...
const sGame_PaletteDataset KOF94_A_CLARK_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x176800, 0x176820, indexKOF94Sprites_Clark, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x176820, 0x176840, indexKOF94Sprites_Clark, 0x40 },
...
const sGame_PaletteDataset KOF94_A_CLARK_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x1769c0, 0x1769e0, indexKOF94Sprites_Clark, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1769e0, 0x176a00, indexKOF94Sprites_Clark, 0x40 },
...
const sGame_PaletteDataset KOF94_A_ATHENA_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x176b80, 0x176ba0, indexKOF94Sprites_Athena, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x176ba0, 0x176bc0, indexKOF94Sprites_Athena, 0x40 },
...
const sGame_PaletteDataset KOF94_A_ATHENA_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x176d40, 0x176d60, indexKOF94Sprites_Athena, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x176d60, 0x176d80, indexKOF94Sprites_Athena, 0x40 },
...
{
    { L"Kensou", 0x176e00, 0x176e20, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 1", 0x176e20, 0x176e40 },
    { L"Electric Palette", 0x176e40, 0x176e60, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 2", 0x176e60, 0x176e80 },
    { L"Win Portrait", 0x176e80, 0x176f00, indexKOF94Sprites_Kensou, 0x30 },
    { L"Lifebar Portrait", 0x176f00, 0x176f20, indexKOF94Sprites_Kensou, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x176f20, 0x176f40, indexKOF94Sprites_Kensou, 0x40 },
    { L"Darker Palette", 0x176f40, 0x176f60, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 3", 0x176f60, 0x176f80 },
    { L"MAX Flash", 0x176f80, 0x176fa0, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 4", 0x176fa0, 0x176fc0 },
};

const sGame_PaletteDataset KOF94_A_KENSOU_ALT_PALETTES[] =
{
    { L"Kensou", 0x176fc0, 0x176fe0, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 1", 0x176fe0, 0x177000 },
    { L"Electric Palette", 0x177000, 0x177020, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 2", 0x177020, 0x177040 },
    { L"Win Portrait", 0x177040, 0x1770c0, indexKOF94Sprites_Kensou, 0x30 },
    { L"Lifebar Portrait", 0x1770c0, 0x1770e0, indexKOF94Sprites_Kensou, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1770e0, 0x177100, indexKOF94Sprites_Kensou, 0x40 },
    { L"Darker Palette", 0x177100, 0x177120, indexKOF95Sprites_Kensou, 0x00 },
    { L"Extra 3", 0x177120, 0x177140 },
    { L"MAX Flash", 0x177140, 0x177160, indexKOF95Sprites_Kensou, 0x00 },
...
const sGame_PaletteDataset KOF94_A_CHIN_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x177280, 0x1772a0, indexKOF94Sprites_Chin, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1772a0, 0x1772c0, indexKOF94Sprites_Chin, 0x40 },
...
const sGame_PaletteDataset KOF94_A_CHIN_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x177440, 0x177460, indexKOF94Sprites_Chin, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x177460, 0x177480, indexKOF94Sprites_Chin, 0x40 },
...
{
    { L"Kyo", 0x177500, 0x177520, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 1", 0x177520, 0x177540, indexKOF95Sprites_Kyo, 0x00 },
    { L"Electric Palette", 0x177540, 0x177560, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 2", 0x177560, 0x177580 },
    { L"Win Portrait", 0x177580, 0x177600, indexKOF94Sprites_Kyo, 0x30 },
    { L"Lifebar Portrait", 0x177600, 0x177620, indexKOF94Sprites_Kyo, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x177620, 0x177640, indexKOF94Sprites_Kyo, 0x40 },
    { L"Darker Palette", 0x177640, 0x177660, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 3", 0x177660, 0x177680 },
    { L"MAX Flash", 0x177680, 0x1776a0, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 4", 0x1776a0, 0x1776c0, indexKOF95Sprites_Kyo, 0x00 },
};

const sGame_PaletteDataset KOF94_A_KYO_ALT_PALETTES[] =
{
    { L"Kyo", 0x1776c0, 0x1776e0, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 1", 0x1776e0, 0x177700, indexKOF95Sprites_Kyo, 0x00 },
    { L"Electric Palette", 0x177700, 0x177720, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 2", 0x177720, 0x177740 },
    { L"Win Portrait", 0x177740, 0x1777c0, indexKOF94Sprites_Kyo, 0x30 },
    { L"Lifebar Portrait", 0x1777c0, 0x1777e0, indexKOF94Sprites_Kyo, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1777e0, 0x177800, indexKOF94Sprites_Kyo, 0x40 },
    { L"Darker Palette", 0x177800, 0x177820, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 3", 0x177820, 0x177840 },
    { L"MAX Flash", 0x177840, 0x177860, indexKOF95Sprites_Kyo, 0x00 },
    { L"Extra 4", 0x177860, 0x177880, indexKOF95Sprites_Kyo, 0x00 },
};
...
const sGame_PaletteDataset KOF94_A_BENIMARU_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x177980, 0x1779a0, indexKOF94Sprites_Benimaru, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1779a0, 0x1779c0, indexKOF94Sprites_Benimaru, 0x40 },
...
const sGame_PaletteDataset KOF94_A_BENIMARU_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x177b40, 0x177b60, indexKOF94Sprites_Benimaru, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x177b60, 0x177b80, indexKOF94Sprites_Benimaru, 0x40 },
...
const sGame_PaletteDataset KOF94_A_DAIMON_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x177d00, 0x177d20, indexKOF94Sprites_Daimon, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x177d20, 0x177d40, indexKOF94Sprites_Daimon, 0x40 },
...
const sGame_PaletteDataset KOF94_A_DAIMON_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x177ec0, 0x177ee0, indexKOF94Sprites_Daimon, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x177ee0, 0x177f00, indexKOF94Sprites_Daimon, 0x40 },
...
const sGame_PaletteDataset KOF94_A_HEAVYD_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178080, 0x1780a0, indexKOF94Sprites_HeavyD, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1780a0, 0x1780c0, indexKOF94Sprites_HeavyD, 0x40 },
...
const sGame_PaletteDataset KOF94_A_HEAVYD_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178240, 0x178260, indexKOF94Sprites_HeavyD, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x178260, 0x178280, indexKOF94Sprites_HeavyD, 0x40 },
...
const sGame_PaletteDataset KOF94_A_LUCKY_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178400, 0x178420, indexKOF94Sprites_Lucky, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x178420, 0x178440, indexKOF94Sprites_Lucky, 0x40 },
...
const sGame_PaletteDataset KOF94_A_LUCKY_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x1785c0, 0x1785e0, indexKOF94Sprites_Lucky, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1785e0, 0x178600, indexKOF94Sprites_Lucky, 0x40 },
...
const sGame_PaletteDataset KOF94_A_BRIAN_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178780, 0x1787a0, indexKOF94Sprites_Brian, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1787a0, 0x1787c0, indexKOF94Sprites_Brian, 0x40 },
...
const sGame_PaletteDataset KOF94_A_BRIAN_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178940, 0x178960, indexKOF94Sprites_Brian, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x178960, 0x178980, indexKOF94Sprites_Brian, 0x40 },
...
const sGame_PaletteDataset KOF94_A_KIM_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178b00, 0x178b20, indexKOF94Sprites_Kim, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x178b20, 0x178b40, indexKOF94Sprites_Kim, 0x40 },
...
const sGame_PaletteDataset KOF94_A_KIM_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x178cc0, 0x178ce0, indexKOF94Sprites_Kim, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x178ce0, 0x178d00, indexKOF94Sprites_Kim, 0x40 },
...
{
    { L"Chang", 0x178d80, 0x178da0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Extra 1", 0x178da0, 0x178dc0, indexKOF94Sprites_Chang, 0x01 },
    { L"Electric Palette", 0x178dc0, 0x178de0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Electric Palette Extra", 0x178de0, 0x178e00, indexKOF94Sprites_Chang, 0x01 },
    { L"Win Portrait", 0x178e00, 0x178e80, indexKOF94Sprites_Chang, 0x30 },
    { L"Lifebar Portrait", 0x178e80, 0x178ea0, indexKOF94Sprites_Chang, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x178ea0, 0x178ec0, indexKOF94Sprites_Chang, 0x40 },
    { L"Darker Palette", 0x178ec0, 0x178ee0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Darker Palette Extra", 0x178ee0, 0x178f00, indexKOF94Sprites_Chang, 0x01 },
    { L"MAX Flash", 0x178f00, 0x178f20, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"MAX Flash Extra", 0x178f20, 0x178f40, indexKOF94Sprites_Chang, 0x01 },
};

const sGame_PaletteDataset KOF94_A_CHANG_ALT_PALETTES[] =
{
    { L"Chang", 0x178f40, 0x178f60, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Extra 1", 0x178f60, 0x178f80, indexKOF94Sprites_Chang, 0x01 },
    { L"Electric Palette", 0x178f80, 0x178fa0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Electric Palette Extra", 0x178fa0, 0x178fc0, indexKOF94Sprites_Chang, 0x01 },
    { L"Win Portrait", 0x178fc0, 0x179040, indexKOF94Sprites_Chang, 0x30 },
    { L"Lifebar Portrait", 0x179040, 0x179060, indexKOF94Sprites_Chang, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179060, 0x179080, indexKOF94Sprites_Chang, 0x40 },
    { L"Darker Palette", 0x179080, 0x1790a0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Darker Palette Extra", 0x1790a0, 0x1790c0, indexKOF94Sprites_Chang, 0x01 },
    { L"MAX Flash", 0x1790c0, 0x1790e0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"MAX Flash Extra", 0x1790e0, 0x179100, indexKOF94Sprites_Chang, 0x01 },
};

const sGame_PaletteDataset KOF94_A_CHOI_MAIN_PALETTES[] =
{
    { L"Choi", 0x179100, 0x179120, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 1", 0x179120, 0x179140 },
    { L"Electric Palette", 0x179140, 0x179160, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 2", 0x179160, 0x179180 },
    { L"Win Portrait", 0x179180, 0x179200, indexKOF94Sprites_Choi, 0x30 },
    { L"Lifebar Portrait", 0x179200, 0x179220, indexKOF94Sprites_Choi, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179220, 0x179240, indexKOF94Sprites_Choi, 0x40 },
    { L"Darker Palette", 0x179240, 0x179260, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 3", 0x179260, 0x179280 },
    { L"MAX Flash", 0x179280, 0x1792a0, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 4", 0x1792a0, 0x1792c0 },
};

const sGame_PaletteDataset KOF94_A_CHOI_ALT_PALETTES[] =
{
    { L"Choi", 0x1792c0, 0x1792e0, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 1", 0x1792e0, 0x179300 },
    { L"Electric Palette", 0x179300, 0x179320, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 2", 0x179320, 0x179340 },
    { L"Win Portrait", 0x179340, 0x1793c0, indexKOF94Sprites_Choi, 0x30 },
    { L"Lifebar Portrait", 0x1793c0, 0x1793e0, indexKOF94Sprites_Choi, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1793e0, 0x179400, indexKOF94Sprites_Choi, 0x40 },
    { L"Darker Palette", 0x179400, 0x179420, indexKOF94Sprites_Choi, 0x00 },
    { L"Extra 3", 0x179420, 0x179440 },
    { L"MAX Flash", 0x179440, 0x179460, indexKOF94Sprites_Choi, 0x00 },
...
const sGame_PaletteDataset KOF94_A_TERRY_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x179580, 0x1795a0, indexKOF94Sprites_Terry, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x1795a0, 0x1795c0, indexKOF94Sprites_Terry, 0x40 },
...
const sGame_PaletteDataset KOF94_A_TERRY_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x179740, 0x179760, indexKOF94Sprites_Terry, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179760, 0x179780, indexKOF94Sprites_Terry, 0x40 },
...
{
    { L"Andy", 0x179800, 0x179820, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 1", 0x179820, 0x179840, indexKOF95Sprites_Andy, 0x01 },
    { L"Electric Palette", 0x179840, 0x179860, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 2", 0x179860, 0x179880 },
    { L"Win Portrait", 0x179880, 0x179900, indexKOF94Sprites_Andy, 0x30 },
    { L"Lifebar Portrait", 0x179900, 0x179920, indexKOF94Sprites_Andy, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179920, 0x179940, indexKOF94Sprites_Andy, 0x40 },
    { L"Darker Palette", 0x179940, 0x179960, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 3", 0x179960, 0x179980 },
    { L"MAX Flash", 0x179980, 0x1799a0, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 4", 0x1799a0, 0x1799c0, indexKOF95Sprites_Andy, 0x01 },
};

const sGame_PaletteDataset KOF94_A_ANDY_ALT_PALETTES[] =
{
    { L"Andy", 0x1799c0, 0x1799e0, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 1", 0x1799e0, 0x179a00, indexKOF95Sprites_Andy, 0x01 },
    { L"Electric Palette", 0x179a00, 0x179a20, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 2", 0x179a20, 0x179a40 },
    { L"Win Portrait", 0x179a40, 0x179ac0, indexKOF94Sprites_Andy, 0x30 },
    { L"Lifebar Portrait", 0x179ac0, 0x179ae0, indexKOF94Sprites_Andy, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179ae0, 0x179b00, indexKOF94Sprites_Andy, 0x40 },
    { L"Darker Palette", 0x179b00, 0x179b20, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 3", 0x179b20, 0x179b40 },
    { L"MAX Flash", 0x179b40, 0x179b60, indexKOF95Sprites_Andy, 0x00 },
    { L"Extra 4", 0x179b60, 0x179b80, indexKOF95Sprites_Andy, 0x01 },
};
...
const sGame_PaletteDataset KOF94_A_JOE_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x179c80, 0x179ca0, indexKOF94Sprites_Joe, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179ca0, 0x179cc0, indexKOF94Sprites_Joe, 0x40 },
...
const sGame_PaletteDataset KOF94_A_JOE_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x179e40, 0x179e60, indexKOF94Sprites_Joe, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x179e60, 0x179e80, indexKOF94Sprites_Joe, 0x40 },
...
const sGame_PaletteDataset KOF94_A_ROBERT_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17a380, 0x17a3a0, indexKOF94Sprites_Robert, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17a3a0, 0x17a3c0, indexKOF94Sprites_Robert, 0x40 },
...
const sGame_PaletteDataset KOF94_A_ROBERT_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17a540, 0x17a560, indexKOF94Sprites_Robert, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17a560, 0x17a580, indexKOF94Sprites_Robert, 0x40 },
...
const sGame_PaletteDataset KOF94_A_TAKUMA_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17a700, 0x17a720, indexKOF94Sprites_Takuma, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17a720, 0x17a740, indexKOF94Sprites_Takuma, 0x40 },
...
const sGame_PaletteDataset KOF94_A_TAKUMA_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17a8c0, 0x17a8e0, indexKOF94Sprites_Takuma, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17a8e0, 0x17a900, indexKOF94Sprites_Takuma, 0x40 },
...
const sGame_PaletteDataset KOF94_A_YURI_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17aa80, 0x17aaa0, indexKOF94Sprites_Yuri, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17aaa0, 0x17aac0, indexKOF94Sprites_Yuri, 0x40 },
...
const sGame_PaletteDataset KOF94_A_YURI_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17ac40, 0x17ac60, indexKOF94Sprites_Yuri, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17ac60, 0x17ac80, indexKOF94Sprites_Yuri, 0x40 },
...
const sGame_PaletteDataset KOF94_A_MAI_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17ae00, 0x17ae20, indexKOF94Sprites_Mai, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17ae20, 0x17ae40, indexKOF94Sprites_Mai, 0x40 },
...
const sGame_PaletteDataset KOF94_A_MAI_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17afc0, 0x17afe0, indexKOF94Sprites_Mai, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17afe0, 0x17b000, indexKOF94Sprites_Mai, 0x40 },
...
const sGame_PaletteDataset KOF94_A_KING_MAIN_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17b180, 0x17b1a0, indexKOF94Sprites_King, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17b1a0, 0x17b1c0, indexKOF94Sprites_King, 0x40 },
...
const sGame_PaletteDataset KOF94_A_KING_ALT_PALETTES[] =
{
    ...
    { L"Lifebar Portrait", 0x17b340, 0x17b360, indexKOF94Sprites_King, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17b360, 0x17b380, indexKOF94Sprites_King, 0x40 },
...
{
    { L"Rugal", 0x17b400, 0x17b420, indexKOF94Sprites_Rugal, 0x00 },
    { L"Extra 1", 0x17b420, 0x17b440, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
    { L"Electric Palette", 0x17b440, 0x17b460, indexKOF94Sprites_Rugal, 0x00 },
    { L"Electric Palette Extra", 0x17b460, 0x17b480, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
    { L"Win Portrait", 0x17b480, 0x17b500, indexKOF94Sprites_Rugal, 0x30 },
    { L"Lifebar Portrait", 0x17b500, 0x17b520, indexKOF94Sprites_Rugal, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17b520, 0x17b540, indexKOF94Sprites_Rugal, 0x40 },
    { L"Darker Palette", 0x17b540, 0x17b560, indexKOF94Sprites_Rugal, 0x00 },
    { L"Darker Palette Extra", 0x17b560, 0x17b580, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
    { L"MAX Flash", 0x17b580, 0x17b5a0, indexKOF94Sprites_Rugal, 0x00 },
    { L"MAX Flash Extra", 0x17b5a0, 0x17b5c0, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
};

const sGame_PaletteDataset KOF94_A_RUGAL_ALT_PALETTES[] =
{
    { L"Rugal", 0x17b5c0, 0x17b5e0, indexKOF94Sprites_Rugal, 0x00 },
    { L"Extra 1", 0x17b5e0, 0x17b600, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
    { L"Electric Palette", 0x17b600, 0x17b620, indexKOF94Sprites_Rugal, 0x00 },
    { L"Electric Palette Extra", 0x17b620, 0x17b640, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
    { L"Win Portrait", 0x17b640, 0x17b6c0, indexKOF94Sprites_Rugal, 0x30 },
    { L"Lifebar Portrait", 0x17b6c0, 0x17b6e0, indexKOF94Sprites_Rugal, 0x40 },
    { L"Lifebar Portrait Defeated/Grayed", 0x17b6e0, 0x17b700, indexKOF94Sprites_Rugal, 0x40 },
    { L"Darker Palette", 0x17b700, 0x17b720, indexKOF94Sprites_Rugal, 0x00 },
    { L"Darker Palette Extra", 0x17b720, 0x17b740, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
    { L"MAX Flash", 0x17b740, 0x17b760, indexKOF94Sprites_Rugal, 0x00 },
    { L"MAX Flash Extra", 0x17b760, 0x17b780, indexKOF94Sprites_Rugal, 0x01, &pairPreviousFlipped },
};
