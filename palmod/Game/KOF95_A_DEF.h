...
const sGame_PaletteDataset KOF95_A_HEIDERN_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9080, 0xd90a0, indexKOF94Sprites_Heidern, 0x00 },
...
const sGame_PaletteDataset KOF95_A_HEIDERN_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9280, 0xd92a0, indexKOF94Sprites_Heidern, 0x00 },
...
const sGame_PaletteDataset KOF95_A_RALF_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9480, 0xd94a0, indexKOF94Sprites_Ralf, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xd94a0, 0xd94c0, indexKOF94Sprites_Ralf, 0x01 },
...
const sGame_PaletteDataset KOF95_A_RALF_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9680, 0xd96a0, indexKOF94Sprites_Ralf, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xd96a0, 0xd96c0, indexKOF94Sprites_Ralf, 0x01 },
...
const sGame_PaletteDataset KOF95_A_CLARK_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9880, 0xd98a0, indexKOF94Sprites_Clark, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xd98a0, 0xd98c0, indexKOF94Sprites_Clark, 0x01 },
...
const sGame_PaletteDataset KOF95_A_CLARK_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9a80, 0xd9aa0, indexKOF94Sprites_Clark, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xd9aa0, 0xd9ac0, indexKOF94Sprites_Clark, 0x01 },
...
const sGame_PaletteDataset KOF95_A_ATHENA_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9c80, 0xd9ca0, indexKOF94Sprites_Athena, 0x00 },
...
const sGame_PaletteDataset KOF95_A_ATHENA_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xd9e80, 0xd9ea0, indexKOF94Sprites_Athena, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KENSOU_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xda080, 0xda0a0, indexKOF94Sprites_Kensou, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KENSOU_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xda280, 0xda2a0, indexKOF94Sprites_Kensou, 0x00 },
...
const sGame_PaletteDataset KOF95_A_CHIN_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xda480, 0xda4a0, indexKOF94Sprites_Chin, 0x00 },
...
const sGame_PaletteDataset KOF95_A_CHIN_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xda680, 0xda6a0, indexKOF94Sprites_Chin, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KYO_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xda880, 0xda8a0, indexKOF94Sprites_Kyo, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KYO_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdaa80, 0xdaaa0, indexKOF94Sprites_Kyo, 0x00 },
...
const sGame_PaletteDataset KOF95_A_BENIMARU_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdac80, 0xdaca0, indexKOF94Sprites_Benimaru, 0x00 },
...
const sGame_PaletteDataset KOF95_A_BENIMARU_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdae80, 0xdaea0, indexKOF94Sprites_Benimaru, 0x00 },
...
const sGame_PaletteDataset KOF95_A_DAIMON_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdb080, 0xdb0a0, indexKOF94Sprites_Daimon, 0x00 },
...
const sGame_PaletteDataset KOF95_A_DAIMON_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdb280, 0xdb2a0, indexKOF94Sprites_Daimon, 0x00 },
...
{
    { L"Iori", 0xdb400, 0xdb420, indexKOFSprites_98Iori, 0x00 },
    { L"Extra 1", 0xdb420, 0xdb440 },
    { L"MAX Flash", 0xdb440, 0xdb460, indexKOFSprites_98Iori, 0x00 },
    { L"Extra 2", 0xdb460, 0xdb480 },
    { L"Extra 3", 0xdb480, 0xdb4a0, indexKOFSprites_98Iori, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdb5c0, 0xdb5e0, indexKOFSprites_98Iori, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdb5e0, 0xdb600, indexKOFSprites_98Iori, 0x00 },
};

const sGame_PaletteDataset KOF95_A_IORI_ALT_PALETTES[] =
{
    { L"Iori", 0xdb600, 0xdb620, indexKOFSprites_98Iori, 0x00 },
    { L"Extra 1", 0xdb620, 0xdb640 },
    { L"MAX Flash", 0xdb640, 0xdb660, indexKOFSprites_98Iori, 0x00 },
    { L"Extra 2", 0xdb660, 0xdb680 },
    { L"Extra 3", 0xdb680, 0xdb6a0, indexKOFSprites_98Iori, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdb7c0, 0xdb7e0, indexKOFSprites_98Iori, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdb7e0, 0xdb800, indexKOFSprites_98Iori, 0x00 },
};

const sGame_PaletteDataset KOF95_A_EIJI_MAIN_PALETTES[] =
{
    { L"Eiji", 0xdb800, 0xdb820, INVALID_UNIT_VALUE, 0x00 },
    { L"Extra 1", 0xdb820, 0xdb840 },
    { L"MAX Flash", 0xdb840, 0xdb860, INVALID_UNIT_VALUE, 0x00 },
    { L"Extra 2", 0xdb860, 0xdb880 },
    { L"Extra 3", 0xdb880, 0xdb8a0, INVALID_UNIT_VALUE, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdb9c0, 0xdb9e0, INVALID_UNIT_VALUE, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdb9e0, 0xdba00, INVALID_UNIT_VALUE, 0x00 },
};

const sGame_PaletteDataset KOF95_A_EIJI_ALT_PALETTES[] =
{
    { L"Eiji", 0xdba00, 0xdba20, INVALID_UNIT_VALUE, 0x00 },
    { L"Extra 1", 0xdba20, 0xdba40 },
    { L"MAX Flash", 0xdba40, 0xdba60, INVALID_UNIT_VALUE, 0x00 },
    { L"Extra 2", 0xdba60, 0xdba80 },
    { L"Extra 3", 0xdba80, 0xdbaa0, INVALID_UNIT_VALUE, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdbbc0, 0xdbbe0, INVALID_UNIT_VALUE, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdbbe0, 0xdbc00, INVALID_UNIT_VALUE, 0x00 },
};

const sGame_PaletteDataset KOF95_A_BILLY_MAIN_PALETTES[] =
{
    { L"Billy", 0xdbc00, 0xdbc20, indexKOFSprites_98Billy, 0x00 },
    { L"Extra 1", 0xdbc20, 0xdbc40 },
    { L"MAX Flash", 0xdbc40, 0xdbc60, indexKOFSprites_98Billy, 0x00 },
    { L"Extra 2", 0xdbc60, 0xdbc80 },
    { L"Extra 3", 0xdbc80, 0xdbca0, indexKOFSprites_98Billy, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdbdc0, 0xdbde0, indexKOFSprites_98Billy, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdbde0, 0xdbe00, indexKOFSprites_98Billy, 0x00 },
};

const sGame_PaletteDataset KOF95_A_BILLY_ALT_PALETTES[] =
{
    { L"Billy", 0xdbe00, 0xdbe20, indexKOFSprites_98Billy, 0x00 },
    { L"Extra 1", 0xdbe20, 0xdbe40 },
    { L"MAX Flash", 0xdbe40, 0xdbe60, indexKOFSprites_98Billy, 0x00 },
    { L"Extra 2", 0xdbe60, 0xdbe80 },
    { L"Extra 3", 0xdbe80, 0xdbea0, indexKOFSprites_98Billy, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdbfc0, 0xdbfe0, indexKOFSprites_98Billy, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdbfe0, 0xdc000, indexKOFSprites_98Billy, 0x00 },
};
...
const sGame_PaletteDataset KOF95_A_KIM_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdc080, 0xdc0a0, indexKOF94Sprites_Kim, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KIM_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdc280, 0xdc2a0, indexKOF94Sprites_Kim, 0x00 },
...
{
    { L"Chang", 0xdc400, 0xdc420, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Extra 1", 0xdc420, 0xdc440, indexKOF94Sprites_Chang, 0x01 },
    { L"MAX Flash", 0xdc440, 0xdc460, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"MAX Flash Extra", 0xdc460, 0xdc480, indexKOF94Sprites_Chang, 0x01 },
    { L"Extra 3", 0xdc480, 0xdc4a0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xdc4a0, 0xdc4c0, indexKOF94Sprites_Chang, 0x01 },
    ...
    { L"Lifebar Portrait", 0xdc5c0, 0xdc5e0, indexKOF94Sprites_Chang, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdc5e0, 0xdc600, indexKOF94Sprites_Chang, 0x00 },
};

const sGame_PaletteDataset KOF95_A_CHANG_ALT_PALETTES[] =
{
    { L"Chang", 0xdc600, 0xdc620, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Extra 1", 0xdc620, 0xdc640, indexKOF94Sprites_Chang, 0x01 },
    { L"MAX Flash", 0xdc640, 0xdc660, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"MAX Flash Extra", 0xdc660, 0xdc680, indexKOF94Sprites_Chang, 0x01 },
    { L"Extra 3", 0xdc680, 0xdc6a0, indexKOF94Sprites_Chang, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xdc6a0, 0xdc6c0, indexKOF94Sprites_Chang, 0x01 },
    ...
    { L"Lifebar Portrait", 0xdc7c0, 0xdc7e0, indexKOF94Sprites_Chang, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdc7e0, 0xdc800, indexKOF94Sprites_Chang, 0x00 },
};
...
const sGame_PaletteDataset KOF95_A_CHOI_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdc880, 0xdc8a0, indexKOF94Sprites_Choi, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdc9c0, 0xdc9e0, indexKOF94Sprites_Choi, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdc9e0, 0xdca00, indexKOF94Sprites_Choi, 0x00 },
};
...
const sGame_PaletteDataset KOF95_A_CHOI_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdca80, 0xdcaa0, indexKOF94Sprites_Choi, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdcbc0, 0xdcbe0, indexKOF94Sprites_Choi, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdcbe0, 0xdcc00, indexKOF94Sprites_Choi, 0x00 },
};
...
const sGame_PaletteDataset KOF95_A_TERRY_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdcc80, 0xdcca0, indexKOF94Sprites_Terry, 0x00 },
...
const sGame_PaletteDataset KOF95_A_TERRY_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdce80, 0xdcea0, indexKOF94Sprites_Terry, 0x00 },
...
const sGame_PaletteDataset KOF95_A_ANDY_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdd080, 0xdd0a0, indexKOF94Sprites_Andy, 0x00 },
...
const sGame_PaletteDataset KOF95_A_ANDY_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdd280, 0xdd2a0, indexKOF94Sprites_Andy, 0x00 },
...
const sGame_PaletteDataset KOF95_A_JOE_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdd480, 0xdd4a0, indexKOF94Sprites_Joe, 0x00 },
...
const sGame_PaletteDataset KOF95_A_JOE_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdd680, 0xdd6a0, indexKOF94Sprites_Joe, 0x00 },
...
const sGame_PaletteDataset KOF95_A_RYO_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdd880, 0xdd8a0, indexKOF94Sprites_Ryo, 0x00 },
...
const sGame_PaletteDataset KOF95_A_RYO_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdda80, 0xddaa0, indexKOF94Sprites_Ryo, 0x00 },
...
const sGame_PaletteDataset KOF95_A_ROBERT_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xddc80, 0xddca0, indexKOF94Sprites_Robert, 0x00 },
...
const sGame_PaletteDataset KOF95_A_ROBERT_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdde80, 0xddea0, indexKOF94Sprites_Robert, 0x00 },
...
const sGame_PaletteDataset KOF95_A_TAKUMA_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xde080, 0xde0a0, indexKOF94Sprites_Takuma, 0x00 },
...
const sGame_PaletteDataset KOF95_A_TAKUMA_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xde280, 0xde2a0, indexKOF94Sprites_Takuma, 0x00 },
...
const sGame_PaletteDataset KOF95_A_YURI_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xde480, 0xde4a0, indexKOF94Sprites_Yuri, 0x00 },
...
const sGame_PaletteDataset KOF95_A_YURI_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xde680, 0xde6a0, indexKOF94Sprites_Yuri, 0x00 },
...
const sGame_PaletteDataset KOF95_A_MAI_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xde880, 0xde8a0, indexKOF94Sprites_Mai, 0x00 },
...
const sGame_PaletteDataset KOF95_A_MAI_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdea80, 0xdeaa0, indexKOF94Sprites_Mai, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KING_MAIN_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdec80, 0xdeca0, indexKOF94Sprites_King, 0x00 },
...
const sGame_PaletteDataset KOF95_A_KING_ALT_PALETTES[] =
{
    ...
    { L"Extra 3", 0xdee80, 0xdeea0, indexKOF94Sprites_King, 0x00 },
...
{
    { L"Saisyu", 0xdf000, 0xdf020, indexKOFSprites_98Saisyu, 0x00 },
    { L"Extra 1", 0xdf020, 0xdf040 },
    { L"MAX Flash", 0xdf040, 0xdf060, indexKOFSprites_98Saisyu, 0x00 },
    { L"Extra 2", 0xdf060, 0xdf080 },
    { L"Extra 3", 0xdf080, 0xdf0a0, indexKOFSprites_98Saisyu, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdf1c0, 0xdf1e0, indexKOFSprites_98Saisyu, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdf1e0, 0xdf200, indexKOFSprites_98Saisyu, 0x00 },
};

const sGame_PaletteDataset KOF95_A_SAISYU_ALT_PALETTES[] =
{
    { L"Saisyu", 0xdf200, 0xdf220, indexKOFSprites_98Saisyu, 0x00 },
    { L"Extra 1", 0xdf220, 0xdf240 },
    { L"MAX Flash", 0xdf240, 0xdf260, indexKOFSprites_98Saisyu, 0x00 },
    { L"Extra 2", 0xdf260, 0xdf280 },
    { L"Extra 3", 0xdf280, 0xdf2a0, indexKOFSprites_98Saisyu, 0x00 },
    ...
    { L"Lifebar Portrait", 0xdf3c0, 0xdf3e0, indexKOFSprites_98Saisyu, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdf3e0, 0xdf400, indexKOFSprites_98Saisyu, 0x00 },
};

const sGame_PaletteDataset KOF95_A_OMEGARUGAL_MAIN_PALETTES[] =
{
    { L"Omega Rugal", 0xdf400, 0xdf420, indexKOF94Sprites_Rugal, 0x00, &pairNext },
    { L"Extra 1", 0xdf420, 0xdf440, indexKOF94Sprites_Rugal, 0x01 },
    { L"MAX Flash", 0xdf440, 0xdf460, indexKOF94Sprites_Rugal, 0x00, &pairNext },
    { L"MAX Flash Extra", 0xdf460, 0xdf480, indexKOF94Sprites_Rugal, 0x01 },
    { L"Extra 3", 0xdf480, 0xdf4a0, indexKOF94Sprites_Rugal, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xdf4a0, 0xdf4c0, indexKOF94Sprites_Rugal, 0x01 },
    ...
    { L"Lifebar Portrait", 0xdf5c0, 0xdf5e0, indexKOF94Sprites_Rugal, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdf5e0, 0xdf600, indexKOF94Sprites_Rugal, 0x00 },
};

const sGame_PaletteDataset KOF95_A_OMEGARUGAL_ALT_PALETTES[] =
{
    { L"Omega Rugal", 0xdf600, 0xdf620, indexKOF94Sprites_Rugal, 0x00, &pairNext },
    { L"Extra 1", 0xdf620, 0xdf640, indexKOF94Sprites_Rugal, 0x01 },
    { L"MAX Flash", 0xdf640, 0xdf660, indexKOF94Sprites_Rugal, 0x00, &pairNext },
    { L"MAX Flash Extra", 0xdf660, 0xdf680, indexKOF94Sprites_Rugal, 0x01 },
    { L"Extra 3", 0xdf680, 0xdf6a0, indexKOF94Sprites_Rugal, 0x00, &pairNext },
    { L"Extra 3 Extra", 0xdf6a0, 0xdf6c0, indexKOF94Sprites_Rugal, 0x01 },
    ...
    { L"Lifebar Portrait", 0xdf7c0, 0xdf7e0, indexKOF94Sprites_Rugal, 0x20 },
    { L"Extra 10: Monochrome palette?", 0xdf7e0, 0xdf800, indexKOF94Sprites_Rugal, 0x00 },
};
