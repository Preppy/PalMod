...
{
    { L"Sho A", 0x135eaa, 0x135eca },
    { L"Sho A Super Trail", 0x135f4a, 0x135f6a },
};

const sGame_PaletteDataset BREAKERS_A_SHO_PALETTES_B[] =
{
    { L"Sho B", 0x135eca, 0x135eea },
    { L"Sho B Super Trail", 0x135f6a, 0x135f8a },
};

const sGame_PaletteDataset BREAKERS_A_SHO_PALETTES_C[] =
{
    { L"Sho C", 0x135eea, 0x135f0a },
    { L"Sho C Super Trail", 0x135f8a, 0x135faa },
};

const sGame_PaletteDataset BREAKERS_A_SHO_PALETTES_D[] =
{
    { L"Sho D", 0x135f0a, 0x135f2a },
    { L"Sho D Super Trail", 0x135fca, 0x135fea },
};

const sGame_PaletteDataset BREAKERS_A_JIN_PALETTES[] =
{
    { L"Jin", 0x135f2a, 0x135f4a },
    { L"Jin Super Trail", 0x135faa, 0x135fca },
};

const sGame_PaletteDataset BREAKERS_A_DAO_PALETTES_A[] =
{
    { L"Dao A", 0x13ee5a, 0x13ee7a },
    { L"Dao A Super Trail", 0x13eefa, 0x13ef1a },
};

const sGame_PaletteDataset BREAKERS_A_DAO_PALETTES_B[] =
{
    { L"Dao B", 0x13ee7a, 0x13ee9a },
    { L"Dao B Super Trail", 0x13ef1a, 0x13ef3a },
};

const sGame_PaletteDataset BREAKERS_A_DAO_PALETTES_C[] =
{
    { L"Dao C", 0x13ee9a, 0x13eeba },
    { L"Dao C Super Trail", 0x13ef3a, 0x13ef5a },
};

const sGame_PaletteDataset BREAKERS_A_DAO_PALETTES_D[] =
{
    { L"Dao D", 0x13eeba, 0x13eeda },
    { L"Dao D Super Trail", 0x13ef5a, 0x13ef7a },
};

const sGame_PaletteDataset BREAKERS_A_LIU_PALETTES[] =
{
    { L"Liu", 0x13eeda, 0x13eefa },
    { L"Liu Super Trail", 0x13ef7a, 0x13ef9a },
};

const sGame_PaletteDataset BREAKERS_A_CONDOR_PALETTES_A[] =
{
    { L"Condor A", 0x146778, 0x146798 },
    { L"Condor A Super Trail", 0x146818, 0x146838 },
};

const sGame_PaletteDataset BREAKERS_A_CONDOR_PALETTES_B[] =
{
    { L"Condor B", 0x146798, 0x1467b8 },
    { L"Condor B Super Trail", 0x146838, 0x146858 },
};

const sGame_PaletteDataset BREAKERS_A_CONDOR_PALETTES_C[] =
{
    { L"Condor C", 0x1467b8, 0x1467d8 },
    { L"Condor C Super Trail", 0x146858, 0x146878 },
};

const sGame_PaletteDataset BREAKERS_A_CONDOR_PALETTES_D[] =
{
    { L"Condor D", 0x1467d8, 0x1467f8 },
    { L"Condor D Super Trail", 0x146878, 0x146898 },
};

const sGame_PaletteDataset BREAKERS_A_GIGARS_PALETTES[] =
{
    { L"Gigars", 0x1467f8, 0x146818 },
    { L"Gigars Super Trail", 0x146898, 0x1468b8 },
};

const sGame_PaletteDataset BREAKERS_A_TIA_PALETTES_A[] =
{
    { L"Tia A", 0x1524a8, 0x1524c8 },
    { L"Tia A Super Trail", 0x152548, 0x152568 },
};

const sGame_PaletteDataset BREAKERS_A_TIA_PALETTES_B[] =
{
    { L"Tia B", 0x1524c8, 0x1524e8 },
    { L"Tia B Super Trail", 0x152568, 0x152588 },
};

const sGame_PaletteDataset BREAKERS_A_TIA_PALETTES_C[] =
{
    { L"Tia C", 0x1524e8, 0x152508 },
    { L"Tia C Super Trail", 0x152588, 0x1525a8 },
};

const sGame_PaletteDataset BREAKERS_A_TIA_PALETTES_D[] =
{
    { L"Tia D", 0x152508, 0x152528 },
    { L"Tia D Super Trail", 0x1525a8, 0x1525c8 },
};

const sGame_PaletteDataset BREAKERS_A_SHELLY_PALETTES[] =
{
    { L"Shelly", 0x152528, 0x152548 },
    { L"Shelly Super Trail", 0x1525c8, 0x1525e8 },
};

const sGame_PaletteDataset BREAKERS_A_RILA_PALETTES_A[] =
{
    { L"Rila A", 0x15b354, 0x15b374 },
    { L"Rila A Super Trail", 0x15b3f4, 0x15b414 },
};

const sGame_PaletteDataset BREAKERS_A_RILA_PALETTES_B[] =
{
    { L"Rila B", 0x15b374, 0x15b394 },
    { L"Rila B Super Trail", 0x15b414, 0x15b434 },
};

const sGame_PaletteDataset BREAKERS_A_RILA_PALETTES_C[] =
{
    { L"Rila C", 0x15b394, 0x15b3b4 },
    { L"Rila C Super Trail", 0x15b434, 0x15b454 },
};

const sGame_PaletteDataset BREAKERS_A_RILA_PALETTES_D[] =
{
    { L"Rila D", 0x15b3b4, 0x15b3d4 },
    { L"Rila D Super Trail", 0x15b454, 0x15b474 },
};

const sGame_PaletteDataset BREAKERS_A_SANDRA_PALETTES[] =
{
    { L"Sandra", 0x15b3d4, 0x15b3f4 },
    { L"Sandra Super Trail", 0x15b474, 0x15b494 },
};

const sGame_PaletteDataset BREAKERS_A_ALSION_PALETTES_A[] =
{
    { L"Alsion A", 0x164206, 0x164226 },
    { L"Alsion A Super Trail", 0x1642a6, 0x1642c6 },
};

const sGame_PaletteDataset BREAKERS_A_ALSION_PALETTES_B[] =
{
    { L"Alsion B", 0x164226, 0x164246 },
    { L"Alsion B Super Trail", 0x1642c6, 0x1642e6 },
};

const sGame_PaletteDataset BREAKERS_A_ALSION_PALETTES_C[] =
{
    { L"Alsion C", 0x164246, 0x164266 },
    { L"Alsion C Super Trail", 0x1642e6, 0x164306 },
};

const sGame_PaletteDataset BREAKERS_A_ALSION_PALETTES_D[] =
{
    { L"Alsion D", 0x164266, 0x164286 },
    { L"Alsion D Super Trail", 0x164306, 0x164326 },
};

const sGame_PaletteDataset BREAKERS_A_ATOUM_PALETTES[] =
{
    { L"Atoum", 0x164286, 0x1642a6 },
    { L"Atoum Super Trail", 0x164326, 0x164346 },
};

const sGame_PaletteDataset BREAKERS_A_PIELLE_PALETTES_A[] =
{
    { L"Pielle A", 0x16d222, 0x16d242 },
    { L"Pielle A Super Trail", 0x16d2c2, 0x16d2e2 },
};

const sGame_PaletteDataset BREAKERS_A_PIELLE_PALETTES_B[] =
{
    { L"Pielle B", 0x16d242, 0x16d262 },
    { L"Pielle B Super Trail", 0x16d2e2, 0x16d302 },
};

const sGame_PaletteDataset BREAKERS_A_PIELLE_PALETTES_C[] =
{
    { L"Pielle C", 0x16d262, 0x16d282 },
    { L"Pielle C Super Trail", 0x16d302, 0x16d322 },
};

const sGame_PaletteDataset BREAKERS_A_PIELLE_PALETTES_D[] =
{
    { L"Pielle D", 0x16d282, 0x16d2a2 },
    { L"Pielle D Super Trail", 0x16d322, 0x16d342 },
};

const sGame_PaletteDataset BREAKERS_A_GEORGE_PALETTES[] =
{
    { L"George", 0x16d2a2, 0x16d2c2 },
    { L"George Super Trail", 0x16d342, 0x16d362 },
};

const sGame_PaletteDataset BREAKERS_A_MAHERL_PALETTES_A[] =
{
    { L"Maherl A", 0x177288, 0x1772a8 },
    { L"Maherl A Super Trail", 0x177328, 0x177348 },
};

const sGame_PaletteDataset BREAKERS_A_MAHERL_PALETTES_B[] =
{
    { L"Maherl B", 0x1772a8, 0x1772c8 },
    { L"Maherl B Super Trail", 0x177348, 0x177368 },
};

const sGame_PaletteDataset BREAKERS_A_MAHERL_PALETTES_C[] =
{
    { L"Maherl C", 0x1772c8, 0x1772e8 },
    { L"Maherl C Super Trail", 0x177368, 0x177388 },
};

const sGame_PaletteDataset BREAKERS_A_MAHERL_PALETTES_D[] =
{
    { L"Maherl D", 0x1772e8, 0x177308 },
    { L"Maherl D Super Trail", 0x177388, 0x1773a8 },
};

const sGame_PaletteDataset BREAKERS_A_JAVA_PALETTES[] =
{
    { L"Javar", 0x177308, 0x177328 },
    { L"Javar Super Trail", 0x1773a8, 0x1773c8 },
};

const sGame_PaletteDataset BREAKERS_A_SAIZO_PALETTES_A[] =
{
    { L"Saizo A", 0x1897fe, 0x18981e },
    { L"Saizo A Super Trail", 0x18989e, 0x1898be },
};

const sGame_PaletteDataset BREAKERS_A_SAIZO_PALETTES_B[] =
{
    { L"Saizo B", 0x18981e, 0x18983e },
    { L"Saizo B Super Trail", 0x1898be, 0x1898de },
};

const sGame_PaletteDataset BREAKERS_A_SAIZO_PALETTES_C[] =
{
    { L"Saizo C", 0x18983e, 0x18985e },
    { L"Saizo C Super Trail", 0x1898de, 0x1898fe },
};

const sGame_PaletteDataset BREAKERS_A_SAIZO_PALETTES_D[] =
{
    { L"Saizo D", 0x18985e, 0x18987e },
    { L"Saizo D Super Trail", 0x1898fe, 0x18991e },
};

const sGame_PaletteDataset BREAKERS_A_YUKIKAGE_PALETTES[] =
{
    { L"Yukikage", 0x18987e, 0x18989e },
    { L"Yukikage Super Trail", 0x18991e, 0x18993e },
};
