...
CGame_KOF99AE_A::CGame_KOF99AE_A(uint32_t nConfirmedROMSize, int nROMToLoad /*= 2*/)
{
...
uint32_t CGame_KOF99AE_A::GetExtraCt(uint32_t nUnitId, BOOL fCountVisibleOnly)
{
    if (UsePaletteSetForP2())
    {
