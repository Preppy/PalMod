...
{
    CString strMessage;
    strMessage.Format(L"CGame_WakuWaku7_A::CGame_WakuWaku7_A: Loading ROM...\n");
...
sDescTreeNode* CGame_WakuWaku7_A::InitDescTree()
{
    ...
    strMsg.Format(L"CGame_WakuWaku7_A::InitDescTree: Building desc tree for WakuWaku7_A %s extras...\n", fHaveExtras ? L"with" : L"without");
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < WakuWaku7_A_EXTRALOC)
        {
            ...
            _snwprintf_s(UnitNode->szDesc, ARRAYSIZE(UnitNode->szDesc), _TRUNCATE, L"%s", WakuWaku7_A_UNITS[iUnitCtr].szDesc);
    ...
    strMsg.Format(L"CGame_WakuWaku7_A::InitDescTree: Loaded %u palettes for WakuWaku7\n", nTotalPaletteCount);
    OutputDebugString(strMsg);
...
#if WakuWaku7_A_DEBUG
        CString strMsg;
        strMsg.Format(L"CGame_WakuWaku7_A::GetPaletteCountForUnit: %u for unit %u which has %u collections.\n", nCompleteCount, nUnitId, nCollectionCount);
        OutputDebugString(strMsg);
#endif
