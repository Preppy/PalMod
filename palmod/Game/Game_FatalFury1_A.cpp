...
uint32_t CGame_FatalFury1_A::m_nTotalPaletteCountForFatalFury1 = 0;
uint32_t CGame_FatalFury1_A::m_nConfirmedROMSize = -1;
...
CGame_FatalFury1_A::CGame_FatalFury1_A(uint32_t nConfirmedROMSize)
{
...
CGame_FatalFury1_A::~CGame_FatalFury1_A()
{
    safe_delete_array(CGame_FatalFury1_A::FatalFury1_A_EXTRA_CUSTOM);
    ClearDataBuffer();
...
uint32_t CGame_FatalFury1_A::GetExtraCt(uint32_t nUnitId, BOOL fCountVisibleOnly)
{
...
sDescTreeNode* CGame_FatalFury1_A::InitDescTree()
{
    ...
    LoadExtraFileForGame(EXTRA_FILENAME_FatalFury1_A, &FatalFury1_A_EXTRA_CUSTOM, FatalFury1_A_EXTRALOC, m_nConfirmedROMSize);

    uint16_t nUnitCt = FatalFury1_A_NUMUNIT + (GetExtraCt(FatalFury1_A_EXTRALOC) ? 1 : 0);
...
void CGame_FatalFury1_A::LoadSpecificPaletteData(uint32_t nUnitId, uint32_t nPalId)
{
    ...
    else // FatalFury1_A_EXTRALOC
    {
        ...
        stExtraDef* pCurrDef = &FatalFury1_A_EXTRA_CUSTOM[GetExtraLoc(nUnitId) + nPalId];
