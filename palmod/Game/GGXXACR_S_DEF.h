...
{
    { L"Type A Background (Left)", 0x110, 0x510 },
    { L"Type A Background (Right)", 0x162E0, 0x166E0 },
// Type B
    { L"Type B Background (Left)", 0x2D850, 0x2DC50 },
    { L"Type B Background (Right)", 0x43C20, 0x44020 },
// Type C Portraits
    { L"Type C A.B.A", 0x773D0, 0x777D0 },
    { L"Type C Anji", 0x7B8D0, 0x7BcD0 },
    { L"Type C Axl", 0x7F4B0, 0x7F8B0 },
    { L"Type C Baiken", 0x82d10, 0x83110 },
    { L"Type C Bridget", 0x865f0, 0x869f0 },
    { L"Type C Chipp", 0x8A6A0, 0x8AAA0 },
    { L"Type C Dizzy", 0x91C50, 0x92050 },
    { L"Type C Eddie", 0xd0f40, 0xd1340 },
    { L"Type C Faust", 0x96120, 0x96520 },
    { L"Type C I-no", 0x99A50, 0x99E50 },
    { L"Type C Jam", 0x9D2b0, 0x9D6b0 },
    { L"Type C Johnny", 0xA0C60, 0xA1060 },
    { L"Type C Justice", 0xA4890, 0xA4c90 },
    { L"Type C Kliff", 0x8DBC0, 0x8DFC0 },
    { L"Type C Ky", 0xA9070, 0xA9470 },
    { L"Type C May", 0xAC7f0, 0xACBf0 },
    { L"Type C Millia", 0xB0600, 0xB0A00 },
    { L"Type C Order-Sol", 0xB4350, 0xB4750 },
    { L"Type C Potemkin", 0xB83F0, 0xB87F0 },
    { L"Type C Robo-Ky", 0xBBA20, 0xBBE20 },
    { L"Type C Slayer", 0xBF2f0, 0xBF6f0 },
    { L"Type C Sol", 0xC2550, 0xC2950 },
    { L"Type C Testament", 0xC5AC0, 0xC5EC0 },
    { L"Type C Venom", 0xC9AD0, 0xC9ED0 },
    { L"Type C Zappa", 0xCCE20, 0xCD220 },
    { L"Type C Background (Left)", 0x599D0, 0x59DD0 },
    { L"Type C Background (Right)", 0x686D0, 0x68AD0 },
// Type D Portraits
    { L"Type D A.B.A", 0x2522a0, 0x2526A0 },
    { L"Type D Anji", 0x1b05c0, 0x1B09C0 },
    { L"Type D Axl", 0x11edb0, 0x11F1B0 },
    { L"Type D Baiken", 0x167e80, 0x168280 },
    { L"Type D Bridget", 0x22dba0, 0x22DFA0 },
    { L"Type D Chipp", 0x1427e0, 0x142BE0 },
    { L"Type D Dizzy", 0x1e7c40, 0x1E8040 },
    { L"Type D Eddie", 0x1559f0, 0x155DF0 },
    { L"Type D Faust", 0x178a50, 0x178E50 },
    { L"Type D I-No", 0x20af00, 0x20B300 },
    { L"Type D Jam", 0x19cb60, 0x19CF60 },
    { L"Type D Johnny", 0x1c2c50, 0x1C3050 },
    { L"Type D Justice", 0x28b810, 0x28BC10 },
    { L"Type D Kliff", 0x2773b0, 0x2777B0 },
    { L"Type D Ky", 0xe7620, 0xe7A20 },
    { L"Type D May", 0xf9ac0, 0xf9Ec0 },
    { L"Type D Millia", 0x10cee0, 0x10D2E0 },
    { L"Type D Order-Sol", 0x2656c0, 0x265AC0 },
    { L"Type D Potekin", 0x131090, 0x131490 },
    { L"Type D Robo-Ky", 0x2401A0, 0x2405A0 },
    { L"Type D Slayer", 0x1f9e80, 0x1FA280 },
    { L"Type D Sol", 0xd4cf0, 0xd50f0 },
    { L"Type D Testament", 0x189dc0, 0x18A1C0 },
    { L"Type D Venom", 0x1d4a40, 0x1D4E40 },
    { L"Type D Zappa", 0x21CCC0, 0x21D0C0 },
    { L"Type D Background", 0x29c220, 0x29C620 },
};
...
GGXXACRFileData GGXXACR_S_CharacterData[] =
{
    ...
    { L"side_belt.bin", L"Sidebar Portraits", 2794128,            nullptr,                                       0,        0x110,                         -1, GGXXACR_S_Sidebar_Portraits, ARRAYSIZE(GGXXACR_S_Sidebar_Portraits) },
};
