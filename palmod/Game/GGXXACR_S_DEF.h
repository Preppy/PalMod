...
const std::vector<sGame_PaletteDataset> GGXXACR_S_FA_EXTRAS =
{
...
const std::vector<sGame_PaletteDataset> GGXXACR_S_MY_EXTRAS =
{
...
const std::vector<sGame_PaletteDataset> GGXXACR_S_ML_EXTRAS =
{
...
const std::vector<sGame_PaletteDataset> GGXXACR_S_FR_EXTRAS =
{
    //General
...
const std::vector<sGame_PaletteDataset> GGXXACR_S_TS_EXTRAS =
{
    ...
    { L"Ground Throw 1/2", 0x4465a0, 0x4469a0, indexGGXXSprites_ACR_Testament, 0x0e },
    { L"Ground Throw 2/2", 0x447600, 0x447a00, indexGGXXSprites_ACR_Testament, 0x0e },

    { L"Phantom Soul (Aura)", 0x414ab0, 0x414af0, indexGGXXSprites_ACR_Testament, 0x0b, &pairNext }, // pair with Skull when we have previews
    { L"Phantom Soul (Skull)", 0x4169d0, 0x416a10, indexGGXXSprites_ACR_Testament, 0x0d }, // don't pair previous: it would obscure the skull
    { L"Phantom Soul (Ring)", 0x448660, 0x4486a0, indexGGXXSprites_ACR_Testament, 0x0c },
    ...
    { L"Nightmare Circular (Symbol)", 0x42a240, 0x42a280, indexGGXXSprites_ACR_Testament, 0x10, &pairNext }, // pair with Blood 1 when we have previews
...
const std::vector<sGame_PaletteDataset> GGXXACR_S_EXTRAS_JPF =
{
    ...
    { L"Roman Cancel",          0x1C9770, 0x1C97B0, indexGGXXSprites_ACR_Bonus, 0x08 },
    { L"Force Roman Cancel",    0x1C9970, 0x1C99B0, indexGGXXSprites_ACR_Bonus, 0x07 },
    { L"Chaos Roman Cancel",    0x1C9B70, 0x1C9BB0, indexGGXXSprites_ACR_Bonus, 0x08 },
    { L"Yellow Roman Cancel",   0x1C9D70, 0x1C9DB0, indexGGXXSprites_ACR_Bonus, 0x08 },

    { L"Burst (1/12)",          0x1807E0, 0x180BE0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (2/12)",          0x185F90, 0x186390, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (3/12)",          0x18A0D0, 0x18A4D0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (4/12)",          0x18C8D0, 0x18CCD0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (5/12)",          0x18DD30, 0x18E130, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (6/12)",          0x1903A0, 0x1907A0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (7/12)",          0x1930A0, 0x1934A0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (8/12)",          0x1960C0, 0x1964C0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (9/12)",          0x198A20, 0x198E20, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (10/12)",         0x19B090, 0x19B490, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (11/12)",         0x19D2D0, 0x19D6D0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Burst (12/12)",         0x19F100, 0x19F500, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (1/12)",     0x160660, 0x160A60, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (2/12)",     0x165E10, 0x166210, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (3/12)",     0x169F50, 0x16A350, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (4/12)",     0x16C750, 0x16CB50, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (5/12)",     0x16DBB0, 0x16DFB0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (6/12)",     0x170220, 0x170620, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (7/12)",     0x172F20, 0x173320, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (8/12)",     0x175F40, 0x176340, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (9/12)",     0x1788A0, 0x178CA0, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (10/12)",    0x17AF10, 0x17B310, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (11/12)",    0x17D150, 0x17D550, indexGGXXSprites_ACR_Bonus, 0x0b },
    { L"Gold Burst (12/12)",    0x17EF80, 0x17F380, indexGGXXSprites_ACR_Bonus, 0x0b },
...
const std::vector<GGXXACRFileData> GGXXACR_S_CharacterData =
{
    ...
    { L"Resource\\pr\\ver_100\\obj\\ab.bin",    L"A.B.A",           5715300,    GGXXACRPaletteNamesNormal,    0x48ab50, indexGGXXSprites_ACR_ABA, GGXXACR_S_AB_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\an.bin",    L"Anji Mito",       4518932,    GGXXACRPaletteNamesNormal,    0x3ea460, indexGGXXSprites_ACR_Anji, GGXXACR_S_AN_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\ax.bin",    L"Axl Low" ,        4225716,    GGXXACRPaletteNamesNormal,    0x35ebe0, indexGGXXSprites_ACR_Axl },
    { L"Resource\\pr\\ver_100\\obj\\bk.bin",    L"Baiken",          3573668,    GGXXACRPaletteNamesNormal,    0x308c20, indexGGXXSprites_ACR_Baiken, GGXXACR_S_BK_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\yy.bin",    L"Bridget",         4127716,    GGXXACRPaletteNamesNormal,    0x34b210, indexGGXXSprites_ACR_Bridget, GGXXACR_S_YY_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\ch.bin",    L"Chipp Zanuff",    3113988,    GGXXACRPaletteNamesNormal,    0x293560, indexGGXXSprites_ACR_Chipp, GGXXACR_S_CH_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\dz.bin",    L"Dizzy",           5352324,    GGXXACRPaletteNamesNormal,    0x45d720, indexGGXXSprites_ACR_Dizzy, GGXXACR_S_DZ_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\zt.bin",    L"Eddie",           3289156,    GGXXACRPaletteNamesNormal,    0x24e560, indexGGXXSprites_ACR_Eddie, GGXXACR_S_ZT_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\fa.bin",    L"Faust",           4773284,    GGXXACRPaletteNamesNormal,    0x3fe9a0, indexGGXXSprites_ACR_Faust, GGXXACR_S_FA_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\in.bin",    L"I-No",            5609060,    GGXXACRPaletteNamesNormal,    0x3e5370, indexGGXXSprites_ACR_Ino, GGXXACR_S_IN_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\jm.bin",    L"Jam Kuradoberi",  3827044,    GGXXACRPaletteNamesNormal,    0x2c4e80, indexGGXXSprites_ACR_Jam, GGXXACR_S_JM_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\jy.bin",    L"Johnny",          4205892,    GGXXACRPaletteNamesNormal,    0x3b0620, indexGGXXSprites_ACR_Johnny, GGXXACR_S_JY_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\js.bin",    L"Justice",         4556788,    GGXXACRPaletteNamesNormal,    0x3789b0, indexGGXXSprites_ACR_Justice, GGXXACR_S_JS_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\kr.bin",    L"Kliff Undersn",   3114036,    GGXXACRPaletteNamesNormal,    0x28abf0, indexGGXXSprites_ACR_Kliff, GGXXACR_S_KR_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\ky.bin",    L"Ky Kiske",        4571540,    GGXXACRPaletteNamesNormal,    0x38bbc0, indexGGXXSprites_ACR_Ky, GGXXACR_S_KY_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\my.bin",    L"May",             4311684,    GGXXACRPaletteNamesNormal,    0x363d50, indexGGXXSprites_ACR_May, GGXXACR_S_MY_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\ml.bin",    L"Millia Rage",     3034084,    GGXXACRPaletteNamesNormal,    0x2a4950, indexGGXXSprites_ACR_Millia, GGXXACR_S_ML_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\fr.bin",    L"Order-Sol",       5772356,    GGXXACRPaletteNamesNormal,    0x4377e0, indexGGXXSprites_ACR_OrderSol, GGXXACR_S_FR_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\po.bin",    L"Potemkin",        5277348,    GGXXACRPaletteNamesNormal,    0x489c70, indexGGXXSprites_ACR_Potemkin, GGXXACR_S_PO_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\rk.bin",    L"Robo-Ky",         4489668,    GGXXACRPaletteNamesNormal,    0x3a7450, indexGGXXSprites_ACR_RoboKy },
    { L"Resource\\pr\\ver_100\\obj\\sy.bin",    L"Slayer",          6215652,    GGXXACRPaletteNamesNormal,    0x39c960, indexGGXXSprites_ACR_Slayer, GGXXACR_S_SY_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\sl.bin",    L"Sol Badguy",      4613188,    GGXXACRPaletteNamesNormal,    0x339b60, indexGGXXSprites_ACR_Sol, GGXXACR_S_SL_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\ts.bin",    L"Testament",       4817508,    GGXXACRPaletteNamesNormal,    0x3ee950, indexGGXXSprites_ACR_Testament, GGXXACR_S_TS_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\ve.bin",    L"Venom",           2787412,    GGXXACRPaletteNamesNormal,    0x261c10, indexGGXXSprites_ACR_Venom, GGXXACR_S_VE_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\zp.bin",    L"Zappa",           6019988,    GGXXACRPaletteNamesNormal,    0x2a54f0, indexGGXXSprites_ACR_Zappa, GGXXACR_S_ZP_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\eab.bin",   L"EX A.B.A",        5912564,    GGXXACRPaletteNamesEx,        0x4b3ca0, indexGGXXSprites_ACR_ABA },
    { L"Resource\\pr\\ver_100\\obj\\ean.bin",   L"EX Anji Mito",    4520900,    GGXXACRPaletteNamesEx,        0x3eb460, indexGGXXSprites_ACR_Anji },
    { L"Resource\\pr\\ver_100\\obj\\eax.bin",   L"EX Axl Low",      4217220,    GGXXACRPaletteNamesEx,        0x35edf0, indexGGXXSprites_ACR_Axl },
    { L"Resource\\pr\\ver_100\\obj\\ebk.bin",   L"EX Baiken",       3601604,    GGXXACRPaletteNamesEx,        0x309920, indexGGXXSprites_ACR_Baiken },
    { L"Resource\\pr\\ver_100\\obj\\eyy.bin",   L"EX Bridget",      4206820,    GGXXACRPaletteNamesEx,        0x35d790, indexGGXXSprites_ACR_Bridget },
    { L"Resource\\pr\\ver_100\\obj\\ech.bin",   L"EX Chipp Zanuff", 3162804,    GGXXACRPaletteNamesEx,        0x29f630, indexGGXXSprites_ACR_Chipp },
    { L"Resource\\pr\\ver_100\\obj\\edz.bin",   L"EX Dizzy",        5594900,    GGXXACRPaletteNamesEx,        0x49a2c0, indexGGXXSprites_ACR_Dizzy },
    { L"Resource\\pr\\ver_100\\obj\\ezt.bin",   L"EX Eddie",        3185140,    GGXXACRPaletteNamesEx,        0x275d30, indexGGXXSprites_ACR_Eddie },
    { L"Resource\\pr\\ver_100\\obj\\efa.bin",   L"EX Faust",        4784260,    GGXXACRPaletteNamesEx,        0x3fe9f0, indexGGXXSprites_ACR_Faust },
    { L"Resource\\pr\\ver_100\\obj\\ein.bin",   L"EX I-No",         5762996,    GGXXACRPaletteNamesEx,        0x3f9060, indexGGXXSprites_ACR_Ino },
    { L"Resource\\pr\\ver_100\\obj\\ejm.bin",   L"EX Jam Kuradoberi",3812100,   GGXXACRPaletteNamesEx,        0x2c46d0, indexGGXXSprites_ACR_Jam },
    { L"Resource\\pr\\ver_100\\obj\\ejy.bin",   L"EX Johnny",       4210036,    GGXXACRPaletteNamesEx,        0x3b2250, indexGGXXSprites_ACR_Johnny },
    { L"Resource\\pr\\ver_100\\obj\\eky.bin",   L"EX Ky Kiske",     4859572,    GGXXACRPaletteNamesEx,        0x3cafd0, indexGGXXSprites_ACR_Ky },
    { L"Resource\\pr\\ver_100\\obj\\emy.bin",   L"EX May",          4675812,    GGXXACRPaletteNamesEx,        0x399780, indexGGXXSprites_ACR_May },
    { L"Resource\\pr\\ver_100\\obj\\eml.bin",   L"EX Millia Rage",  3003428,    GGXXACRPaletteNamesEx,        0x29d9c0, indexGGXXSprites_ACR_Millia },
    { L"Resource\\pr\\ver_100\\obj\\efr.bin",   L"EX Order-Sol",    5965396,    GGXXACRPaletteNamesEx,        0x45d9d0, indexGGXXSprites_ACR_OrderSol, GGXXACR_S_EFR_EXTRAS },
    { L"Resource\\pr\\ver_100\\obj\\epo.bin",   L"EX Potemkin",     5313412,    GGXXACRPaletteNamesEx,        0x494170, indexGGXXSprites_ACR_Potemkin },
    { L"Resource\\pr\\ver_100\\obj\\erk.bin",   L"EX Robo-Ky",      4599332,    GGXXACRPaletteNamesEx,        0x3cfc80, indexGGXXSprites_ACR_RoboKy },
    { L"Resource\\pr\\ver_100\\obj\\esy.bin",   L"EX Slayer",       6221972,    GGXXACRPaletteNamesEx,        0x39ea30, indexGGXXSprites_ACR_Slayer },
    { L"Resource\\pr\\ver_100\\obj\\esl.bin",   L"EX Sol Badguy",   4679684,    GGXXACRPaletteNamesEx,        0x33b380, indexGGXXSprites_ACR_Sol },
    { L"Resource\\pr\\ver_100\\obj\\ets.bin",   L"EX Testament",    4775796,    GGXXACRPaletteNamesEx,        0x3f4780, indexGGXXSprites_ACR_Testament },
    { L"Resource\\pr\\ver_100\\obj\\eve.bin",   L"EX Venom",        2848292,    GGXXACRPaletteNamesEx,        0x271200, indexGGXXSprites_ACR_Venom },
    { L"Resource\\pr\\ver_100\\obj\\ezp.bin",   L"EX Zappa",        6044292,    GGXXACRPaletteNamesEx,        0x2a2e90, indexGGXXSprites_ACR_Zappa },
    { L"Resource\\pr\\ver_100\\demo\\archive_jpf.bin",  L"Effects",                     3041088, {},    0x1806f0,   (uint32_t)-1, GGXXACR_S_EXTRAS_JPF },
    { L"Resource\\pr\\ver_100\\demo\\archive_jpf.bin",  L"HUD/Menu",                    3041088, {},    0x2e0,      (uint32_t)-1, GGXXACR_S_HUDMenu },
    { L"Resource\\pr\\ver_100\\demo\\archive_jpf.bin",  L"Round Start/End Messages",    3041088, {},    0x1efc0,    (uint32_t)-1, GGXXACR_S_RoundMessages },
    { L"Resource\\demo\\side_belt.bin",                 L"Sidebar Portraits",           2794128, {},    0x110,      (uint32_t)-1, GGXXACR_S_Sidebar_Portraits },
    { L"Resource\\pr\\ver_100\\demo\\select.bin",       L"Select Screen",               2960672, {},    0xe3260,    (uint32_t)-1, GGXXACR_S_SelectScreen },
    { L"Resource\\pr\\ver_100\\demo\\select.bin",       L"Select Screen Portraits",     2960672, {},    0x2f0,      (uint32_t)-1, GGXXACR_S_SelectScreenPortraits },
    { L"Resource\\pr\\ver_100\\demo\\titleall.bin",     L"Title Screen",                5281296, {},    0x7AC70,    (uint32_t)-1, GGXXACR_S_Title },
    { L"Resource\\mission\\missionall.bin",             L"Lobby / Mission Icons",       402800,  {},    0,          (uint32_t)-1, GGXXACR_S_MissionIcons },
};
