...
const std::vector<sGame_PaletteDataset> GGXXACR_S_EXTRAS_JPF =
{
    ...
    { L"Burst (1/12)",          0x1807E0, 0x180BE0 },
    { L"Burst (2/12)",          0x185F90, 0x186390 },
    { L"Burst (3/12)",          0x18A0D0, 0x18A4D0 },
    { L"Burst (4/12)",          0x18C8D0, 0x18CCD0 },
    { L"Burst (5/12)",          0x18DD30, 0x18E130 },
    { L"Burst (6/12)",          0x1903A0, 0x1907A0 },
    { L"Burst (7/12)",          0x1930A0, 0x1934A0 },
    { L"Burst (8/12)",          0x1960C0, 0x1964C0 },
    { L"Burst (9/12)",          0x198A20, 0x198E20 },
    { L"Burst (10/12)",         0x19B090, 0x19B490 },
    { L"Burst (11/12)",         0x19D2D0, 0x19D6D0 },
    { L"Burst (12/12)",         0x19F100, 0x19F500 },
    { L"Gold Burst (1/12)",     0x160660, 0x160A60 },
    { L"Gold Burst (2/12)",     0x165E10, 0x166210 },
    { L"Gold Burst (3/12)",     0x169F50, 0x16A350 },
    { L"Gold Burst (4/12)",     0x16C750, 0x16CB50 },
    { L"Gold Burst (5/12)",     0x16DBB0, 0x16DFB0 },
    { L"Gold Burst (6/12)",     0x170220, 0x170620 },
    { L"Gold Burst (7/12)",     0x172F20, 0x173320 },
    { L"Gold Burst (8/12)",     0x175F40, 0x176340 },
    { L"Gold Burst (9/12)",     0x1788A0, 0x178CA0 },
    { L"Gold Burst (10/12)",    0x17AF10, 0x17B310 },
    { L"Gold Burst (11/12)",    0x17D150, 0x17D550 },
    { L"Gold Burst (12/12)",    0x17EF80, 0x17F380 },
    ...
    { L"Jumping Dust Effects (1/8)", 0x1D4690, 0x1D46D0 },
    { L"Jumping Dust Effects (2/8)", 0x1D5DF0, 0x1D5E30 },
    { L"Jumping Dust Effects (3/8)", 0x1D6CD0, 0x1D6D10 },
    { L"Jumping Dust Effects (4/8)", 0x1D86E0, 0x1D8720 },
    { L"Jumping Dust Effects (5/8)", 0x1D9E00, 0x1D9E40 },
    { L"Jumping Dust Effects (6/8)", 0x1DB220, 0x1DB260 },
    { L"Jumping Dust Effects (7/8)", 0x1DC500, 0x1DC540 },
    { L"Jumping Dust Effects (8/8)", 0x1DD4A0, 0x1DD4E0 },
    { L"Landing Dust Effects",       0x1DFBE0, 0x1DFC20 },
    { L"Running Dust Effects (1/3)", 0x1DE2E0, 0x1DE320 },
    { L"Running Dust Effects (2/3)", 0x1DEA90, 0x1DEAD0 },
...
const std::vector<sGame_PaletteDataset> GGXXACR_S_HUDMenu =
{
    ...
    { L"Stagger joystick (1/3)",        0x1EE040, 0x1EE080 },
    { L"Stagger joystick (2/3)",        0x1EE270, 0x1EE2B0 },
    { L"Stagger joystick (3/3)",        0x1EE4D0, 0x1EE510 },
