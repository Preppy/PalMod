...
{
    { _T("Grant A - Main"), 0x13b00, 0x13b20, indexGarouAGrant },
    { _T("Grant A - Line1"), 0x13b20, 0x13b40 },
    { _T("Grant A - Line2"), 0x13b40, 0x13b60 },
    { _T("Grant A - On Fire"), 0x13b60, 0x13b80, indexGarouAGrant },
    { _T("Grant A - On Purple"), 0x13b80, 0x13ba0, indexGarouAGrant },
    { _T("Grant A - Gold"), 0x13ba0, 0x13bc0, indexGarouAGrant },
    { _T("Grant A - T.O.P."), 0x13bc0, 0x13be0, indexGarouAGrant },
    { _T("Grant A - Shade"), 0x13be0, 0x13c00, indexGarouAGrant },
    { _T("Grant A - Dark Red"), 0x13c00, 0x13c20, indexGarouAGrant },
    { _T("Grant A - Blue"), 0x13c20, 0x13c40, indexGarouAGrant },
...
{
    { _T("Grant B - Main"), 0x13d00, 0x13d20, indexGarouAGrant },
    { _T("Grant B - Line1"), 0x13d20, 0x13d40 },
    { _T("Grant B - Line2"), 0x13d40, 0x13d60 },
    { _T("Grant B - On Fire"), 0x13d60, 0x13d80, indexGarouAGrant },
    { _T("Grant B - On Purple"), 0x13d80, 0x13da0, indexGarouAGrant },
    { _T("Grant B - Gold"), 0x13da0, 0x13dc0, indexGarouAGrant },
    { _T("Grant B - T.O.P."), 0x13dc0, 0x13de0, indexGarouAGrant },
    { _T("Grant B - Shade"), 0x13de0, 0x13e00, indexGarouAGrant },
    { _T("Grant B - Dark Red"), 0x13e00, 0x13e20, indexGarouAGrant },
    { _T("Grant B - Blue"), 0x13e20, 0x13e40, indexGarouAGrant },
...
{
    { _T("Grant C - Main"), 0x13f00, 0x13f20, indexGarouAGrant },
    { _T("Grant C - Line1"), 0x13f20, 0x13f40 },
    { _T("Grant C - Line2"), 0x13f40, 0x13f60 },
    { _T("Grant C - On Fire"), 0x13f60, 0x13f80, indexGarouAGrant },
    { _T("Grant C - On Purple"), 0x13f80, 0x13fa0, indexGarouAGrant },
    { _T("Grant C - Gold"), 0x13fa0, 0x13fc0, indexGarouAGrant },
    { _T("Grant C - T.O.P."), 0x13fc0, 0x13fe0, indexGarouAGrant },
    { _T("Grant C - Shade"), 0x13fe0, 0x14000, indexGarouAGrant },
    { _T("Grant C - Dark Red"), 0x14000, 0x14020, indexGarouAGrant },
    { _T("Grant C - Blue"), 0x14020, 0x14040, indexGarouAGrant },
...
{
    { _T("Grant D - Main"), 0x14100, 0x14120, indexGarouAGrant },
    { _T("Grant D - Line1"), 0x14120, 0x14140 },
    { _T("Grant D - Line2"), 0x14140, 0x14160 },
    { _T("Grant D - On Fire"), 0x14160, 0x14180, indexGarouAGrant },
    { _T("Grant D - On Purple"), 0x14180, 0x141a0, indexGarouAGrant },
    { _T("Grant D - Gold"), 0x141a0, 0x141c0, indexGarouAGrant },
    { _T("Grant D - T.O.P."), 0x141c0, 0x141e0, indexGarouAGrant },
    { _T("Grant D - Shade"), 0x141e0, 0x14200, indexGarouAGrant },
    { _T("Grant D - Dark Red"), 0x14200, 0x14220, indexGarouAGrant },
    { _T("Grant D - Blue"), 0x14220, 0x14240, indexGarouAGrant },
...
{
    { _T("Grant Boss? - Main"), 0x14300, 0x14320, indexGarouAGrant },
    { _T("Grant Boss? - Line1"), 0x14320, 0x14340 },
    { _T("Grant Boss? - Line2"), 0x14340, 0x14360 },
    { _T("Grant Boss? - On Fire"), 0x14360, 0x14380, indexGarouAGrant },
    { _T("Grant Boss? - On Purple"), 0x14380, 0x143a0, indexGarouAGrant },
    { _T("Grant Boss? - Gold"), 0x143a0, 0x143c0, indexGarouAGrant },
    { _T("Grant Boss? - T.O.P."), 0x143c0, 0x143e0 },
    { _T("Grant Boss? - Shade"), 0x143e0, 0x14400, indexGarouAGrant },
    { _T("Grant Boss? - Dark Red"), 0x14400, 0x14420, indexGarouAGrant },
    { _T("Grant Boss? - Blue"), 0x14420, 0x14440, indexGarouAGrant },
...
{
    { _T("Kain A - Main"), 0x16d00, 0x16d20, indexGarouAKain },
    { _T("Kain A - Line1"), 0x16d20, 0x16d40 },
    { _T("Kain A - Line2"), 0x16d40, 0x16d60 },
    { _T("Kain A - On Fire"), 0x16d60, 0x16d80, indexGarouAKain },
    { _T("Kain A - On Purple"), 0x16d80, 0x16da0, indexGarouAKain },
    { _T("Kain A - Gold"), 0x16da0, 0x16dc0, indexGarouAKain },
    { _T("Kain A - T.O.P."), 0x16dc0, 0x16de0, indexGarouAKain },
    { _T("Kain A - Shade"), 0x16de0, 0x16e00, indexGarouAKain },
    { _T("Kain A - Dark Red"), 0x16e00, 0x16e20, indexGarouAKain },
    { _T("Kain A - Blue"), 0x16e20, 0x16e40, indexGarouAKain },
...
{
    { _T("Kain B - Main"), 0x16f00, 0x16f20, indexGarouAKain },
    { _T("Kain B - Line1"), 0x16f20, 0x16f40 },
    { _T("Kain B - Line2"), 0x16f40, 0x16f60 },
    { _T("Kain B - On Fire"), 0x16f60, 0x16f80, indexGarouAKain },
    { _T("Kain B - On Purple"), 0x16f80, 0x16fa0, indexGarouAKain },
    { _T("Kain B - Gold"), 0x16fa0, 0x16fc0, indexGarouAKain },
    { _T("Kain B - T.O.P."), 0x16fc0, 0x16fe0, indexGarouAKain },
    { _T("Kain B - Shade"), 0x16fe0, 0x17000, indexGarouAKain },
    { _T("Kain B - Dark Red"), 0x17000, 0x17020, indexGarouAKain },
    { _T("Kain B - Blue"), 0x17020, 0x17040, indexGarouAKain },
...
{
    { _T("Kain C - Main"), 0x17100, 0x17120, indexGarouAKain },
    { _T("Kain C - Line1"), 0x17120, 0x17140 },
    { _T("Kain C - Line2"), 0x17140, 0x17160 },
    { _T("Kain C - On Fire"), 0x17160, 0x17180, indexGarouAKain },
    { _T("Kain C - On Purple"), 0x17180, 0x171a0, indexGarouAKain },
    { _T("Kain C - Gold"), 0x171a0, 0x171c0, indexGarouAKain },
    { _T("Kain C - T.O.P."), 0x171c0, 0x171e0, indexGarouAKain },
    { _T("Kain C - Shade"), 0x171e0, 0x17200, indexGarouAKain },
    { _T("Kain C - Dark Red"), 0x17200, 0x17220, indexGarouAKain },
    { _T("Kain C - Blue"), 0x17220, 0x17240, indexGarouAKain },
...
{
    { _T("Kain D - Main"), 0x17300, 0x17320, indexGarouAKain },
    { _T("Kain D - Line1"), 0x17320, 0x17340 },
    { _T("Kain D - Line2"), 0x17340, 0x17360 },
    { _T("Kain D - On Fire"), 0x17360, 0x17380, indexGarouAKain },
    { _T("Kain D - On Purple"), 0x17380, 0x173a0, indexGarouAKain },
    { _T("Kain D - Gold"), 0x173a0, 0x173c0, indexGarouAKain },
    { _T("Kain D - T.O.P."), 0x173c0, 0x173e0, indexGarouAKain },
    { _T("Kain D - Shade"), 0x173e0, 0x17400, indexGarouAKain },
    { _T("Kain D - Dark Red"), 0x17400, 0x17420, indexGarouAKain },
    { _T("Kain D - Blue"), 0x17420, 0x17440, indexGarouAKain },
...
{
    { _T("Kain Boss? - Main"), 0x17500, 0x17520, indexGarouAKain },
    { _T("Kain Boss? - Line1"), 0x17520, 0x17540 },
    { _T("Kain Boss? - Line2"), 0x17540, 0x17560 },
    { _T("Kain Boss? - On Fire"), 0x17560, 0x17580, indexGarouAKain },
    { _T("Kain Boss? - On Purple"), 0x17580, 0x175a0, indexGarouAKain },
    { _T("Kain Boss? - Gold"), 0x175a0, 0x175c0, indexGarouAKain },
    { _T("Kain Boss? - T.O.P."), 0x175c0, 0x175e0, indexGarouAKain },
    { _T("Kain Boss? - Shade"), 0x175e0, 0x17600, indexGarouAKain },
    { _T("Kain Boss? - Dark Red"), 0x17600, 0x17620, indexGarouAKain },
    { _T("Kain Boss? - Blue"), 0x17620, 0x17640, indexGarouAKain },
...
{
    { _T("Grant Portrait Palette - A"), 0x2b500, 0x2b540, indexGarouAPortraits, indexGarouAGrant },
    { _T("Grant Portrait Palette - B"), 0x2b540, 0x2b580, indexGarouAPortraits, indexGarouAGrant },
    { _T("Grant Portrait Palette - C"), 0x2b580, 0x2b5c0, indexGarouAPortraits, indexGarouAGrant },
    { _T("Grant Portrait Palette - D"), 0x2b5c0, 0x2b600, indexGarouAPortraits, indexGarouAGrant },
};
...
{
    { _T("Kain Portrait Palette - A"), 0x2b600, 0x2b640, indexGarouAPortraits, indexGarouAKain },
    { _T("Kain Portrait Palette - B"), 0x2b640, 0x2b680, indexGarouAPortraits, indexGarouAKain },
    { _T("Kain Portrait Palette - C"), 0x2b680, 0x2b6c0, indexGarouAPortraits, indexGarouAKain },
    { _T("Kain Portrait Palette - D"), 0x2b6c0, 0x2b700, indexGarouAPortraits, indexGarouAKain },
};
