...
const sDescTreeNode Garou_A_STAGES_COLLECTION[] =
{
    ...
    { L"Gato 1 Stage: Barbaroi Falls (Morning)", DESC_NODETYPE_TREE, (void*)Garou_A_STAGE_PALETTES_Gato1, ARRAYSIZE(Garou_A_STAGE_PALETTES_Gato1) },
    { L"Gato 2 Stage: Barbaroi Falls (Night)", DESC_NODETYPE_TREE, (void*)Garou_A_STAGE_PALETTES_Gato2, ARRAYSIZE(Garou_A_STAGE_PALETTES_Gato2) },
    { L"Gato 3 Stage: Barbaroi Falls (Afternoon)", DESC_NODETYPE_TREE, (void*)Garou_A_STAGE_PALETTES_Gato3, ARRAYSIZE(Garou_A_STAGE_PALETTES_Gato3) },
