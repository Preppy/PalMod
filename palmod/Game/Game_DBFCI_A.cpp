...
size_t CGame_DBFCI_A::uRuleCtr = 0;
...
{
    { L"data\\_csel\\Yak.pal",    L"Akira",          65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Akira },
    { L"data\\_csel\\Ako.pal",    L"Ako",            65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Ako },
    { L"data\\_csel\\Asu.pal",    L"Asuna",          65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Asuna },
    { L"data\\_csel\\Emi.pal",    L"Emi",            65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Emi },
    { L"data\\_csel\\Krn.pal",    L"Kirino",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Kirino },
    { L"data\\_csel\\Krt.pal",    L"Kirito",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Kirito },
    { L"data\\_csel\\Krk.pal",    L"Kuroko",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Kuroko },
    { L"data\\_csel\\Kur.pal",    L"Kuroyukihime",   65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Kuroyukihime },
    { L"data\\_csel\\Mis.pal",    L"Mikoto",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Mikoto },
    { L"data\\_csel\\Sbm.pal",    L"Miyuki",         66564,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Miyuki },
    { L"data\\_csel\\Qen.pal",    L"Qwenthur",       65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Quenser },
    { L"data\\_csel\\Stm.pal",    L"Rentaro",        65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Rentaro },
    { L"data\\_csel\\Slv.pal",    L"Selvaria",       65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Selvaria },
    { L"data\\_csel\\Sha.pal",    L"Shana",          65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Shana },
    { L"data\\_csel\\Hiw.pal",    L"Shizuo",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Shizuo },
    { L"data\\_csel\\Tgr.pal",    L"Taiga",          65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Taiga },
    { L"data\\_csel\\Oni.pal",    L"Tatsuya",        65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Tatsuya },
    { L"data\\_csel\\Tmk.pal",    L"Tomoka",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Tomoka },
    { L"data\\_csel\\Ykn.pal",    L"Yukina",         65540,    DBFCIPaletteNamesNormal,    0x4,  indexFrenchBreadSprites_DBFCI_Yukina },
    ...
    { L"data\\Kur_0\\Kur_p1.pal",  L"Kuroyukihime (Red)", 65540,   DBFCIPaletteNamesEx,         0x4,  indexFrenchBreadSprites_DBFCI_Kuroyukihime },
    { L"data\\Kur_0\\Kur_p2.pal",  L"Kuroyukihime (Green)", 65540,   DBFCIPaletteNamesEx,       0x4,  indexFrenchBreadSprites_DBFCI_Kuroyukihime },
    { L"data\\Kur_0\\Kur_p3.pal",  L"Kuroyukihime (Blue)", 65540,   DBFCIPaletteNamesEx,        0x4,  indexFrenchBreadSprites_DBFCI_Kuroyukihime },
    { L"data\\Stm_0\\Stm_p1.pal",  L"Rentaro (Trump)",   65540, DBFCIPaletteNamesEx,            0x4,  indexFrenchBreadSprites_DBFCI_Rentaro },
    { L"data\\Tgr_0\\Tgr_p1.pal",  L"Taiga (Ryuji)",   65540,  DBFCIPaletteNamesEx,             0x4,  indexFrenchBreadSprites_DBFCI_Ryuji },
...
sFileRule CGame_DBFCI_A::GetRule(size_t nUnitId)
{
...
sDescTreeNode* CGame_DBFCI_A::InitDescTree()
{
    ...
    size_t nUnitCt = ARRAYSIZE(DBFCICharacterData);
...
size_t CGame_DBFCI_A::GetCollectionCountForUnit(size_t nUnitId)
{
    // Just one palette set per character
    return ARRAYSIZE(DBFCIPaletteNodes);
}

size_t CGame_DBFCI_A::GetNodeCountForCollection(size_t nUnitId, size_t /*nCollectionId*/)
{
    return DBFCICharacterData[nUnitId].ppszPaletteList.size();
}

size_t CGame_DBFCI_A::GetPaletteCountForUnit(size_t nUnitId)
{
    return DBFCICharacterData[nUnitId].ppszPaletteList.size() * ARRAYSIZE(DBFCIPaletteNodes);
}

LPCWSTR CGame_DBFCI_A::GetDescriptionForCollection(size_t /*nUnitId */, size_t nCollectionId)
{
    return DBFCIPaletteNodes[nCollectionId].pszNodeName;
}

void CGame_DBFCI_A::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
    // DBFCI palettes are all 0x400 long
    const int cbPaletteSizeOnDisc = 0x400;

    size_t nAdjustedPalId = nPalId % DBFCIPaletteNamesNormal.size();
    size_t nPaletteSet = nPalId / DBFCIPaletteNamesNormal.size();
...
BOOL CGame_DBFCI_A::UpdatePalImg(int Node01, int Node02, int Node03, int Node04)
{
    ...
    nTargetImgId = 0;
    size_t nImgUnitId = DBFCICharacterData[NodeGet->uUnitId].nSpriteIndex;
    ...
    int nSrcStart = (int)(NodeGet->uPalId % DBFCICharacterData[NodeGet->uUnitId].ppszPaletteList.size());
    size_t nSrcAmt = pButtonLabelSet.size();
    int nNodeIncrement = DBFCICharacterData[NodeGet->uUnitId].ppszPaletteList.size();
...
BOOL CGame_DBFCI_A::LoadFile(CFile* LoadedFile, size_t nUnitNumber)
{
    BOOL fSuccess = TRUE;
    CString strInfo;
...
BOOL CGame_DBFCI_A::SaveFile(CFile* SaveFile, size_t nUnitId)
{
