...
BOOL CGameLoad::SetGame(int nGameFlag)
{
    ...
    case BREAKERS_S:
    {
        GetRule = &CGame_BREAKERS_S::GetRule;
        return TRUE;
    }
    case BSSMSJR_SNES:
    {
    ...
    case FightFever_A:
    {
        GetRule = &CGame_FightFever_A::GetRule;
        return TRUE;
    }
    case FotNS_P:
    {
...
CGameClass* CGameLoad::CreateGame(int nGameFlag, uint32_t nConfirmedROMSize, int nExtraGameData /* = 0 */, LPCWSTR pszFilePath /* = nullptr */)
{
    ...
    case BREAKERS_S:
    {
        return new CGame_BREAKERS_S(nConfirmedROMSize);
    }
    case BSSMSJR_SNES:
    {
    ...
    case FightFever_A:
    {
        return new CGame_FightFever_A(nConfirmedROMSize);
    }
    case FotNS_P:
    {
