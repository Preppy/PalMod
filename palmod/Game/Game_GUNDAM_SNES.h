...
{
private:
    static UINT32 m_nTotalPaletteCountForGUNDAM;

    static size_t rgExtraCountAll[GUNDAM_SNES_NUMUNIT + 1];
    static size_t rgExtraLoc[GUNDAM_SNES_NUMUNIT + 1];
...
public:
    CGame_GUNDAM_SNES(UINT32 nConfirmedROMSize);
