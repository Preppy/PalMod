...
{
    { L"Chinta Nemoto P1", 0x27a5a, 0x27a7a },
    { L"Select Portrait P1", 0x27f1a, 0x27f3a },
    { L"VS Portrait P1", 0x28c5a, 0x28c7a },
    { L"Win Portrait 1/2 P1", 0x287da, 0x287fa },
    { L"Win Portrait 2/2 P1", 0x2881a, 0x2883a },
};

const sGame_PaletteDataset BattleFlipShot_A_ChintaNemoto_P2[] =
{
    { L"Chinta Nemoto P2", 0x27a7a, 0x27a9a },
    { L"Select Portrait P2", 0x27f3a, 0x27f5a },
    { L"VS Portrait P2", 0x28c7a, 0x28c9a },
    { L"Win Portrait 1/2 P2", 0x287fa, 0x2881a },
    { L"Win Portrait 2/2 P2", 0x2883a, 0x2885a },
};

const sGame_PaletteDataset BattleFlipShot_A_ChintaNemoto_Extras[] =
{
    { L"Shield", 0x27a9a, 0x27aba },
    { L"Special Attack", 0x27aba, 0x27ada },
    { L"Targets", 0x27ada, 0x27afa },
};

const sGame_PaletteDataset BattleFlipShot_A_Siren_P1[] =
{
    { L"Siren P1", 0x27afa, 0x27b1a },
    { L"Select Portrait P1", 0x27f5a, 0x27f7a },
    { L"VS Portrait P1", 0x28c9a, 0x28cba },
    { L"Win Portrait 1/2 P1", 0x2885a, 0x2887a },
    { L"Win Portrait 2/2 P1", 0x2889a, 0x288ba },
};

const sGame_PaletteDataset BattleFlipShot_A_Siren_P2[] =
{
    { L"Siren P2", 0x27b1a, 0x27b3a },
    { L"Select Portrait P2", 0x27f7a, 0x27f9a },
    { L"VS Portrait P2", 0x28cba, 0x28cda },
    { L"Win Portrait 1/2 P2", 0x2887a, 0x2889a },
    { L"Win Portrait 2/2 P2", 0x288ba, 0x288da },
};

const sGame_PaletteDataset BattleFlipShot_A_Siren_Extras[] =
{
    { L"Shield", 0x27b3a, 0x27b5a },
    { L"Special Attack", 0x27b5a, 0x27b7a },
    { L"Targets", 0x27b7a, 0x27b9a },
};

const sGame_PaletteDataset BattleFlipShot_A_Saimon_P1[] =
{
    { L"Saimon P1", 0x27b9a, 0x27bba },
    { L"Select Portrait P1", 0x27f9a, 0x27fda },
    { L"VS Portrait P1", 0x28cda, 0x28cfa },
    { L"Win Portrait 1/2 P1", 0x288da, 0x288fa },
    { L"Win Portrait 2/2 P1", 0x2891a, 0x2893a },
};

const sGame_PaletteDataset BattleFlipShot_A_Saimon_P2[] =
{
    { L"Saimon P2", 0x27bba, 0x27bda },
    { L"Select Portrait P2", 0x27fda, 0x2801a },
    { L"VS Portrait P2", 0x28cfa, 0x28d1a },
    { L"Win Portrait 1/2 P2", 0x288fa, 0x2891a },
    { L"Win Portrait 2/2 P2", 0x2893a, 0x2895a },
};

const sGame_PaletteDataset BattleFlipShot_A_Saimon_Extras[] =
{
    { L"Shield", 0x27bda, 0x27bfa },
    { L"Special Attack", 0x27bfa, 0x27c1a },
    { L"Targets", 0x27c1a, 0x27c3a },
};

const sGame_PaletteDataset BattleFlipShot_A_BloodyWolf_P1[] =
{
    { L"Bloody Wolf P1", 0x27cda, 0x27cfa },
    { L"Select Portrait P1", 0x2805a, 0x2807a },
    { L"VS Portrait P1", 0x28d5a, 0x28d7a },
    { L"Win Portrait 1/2 P1", 0x289da, 0x289fa },
    { L"Win Portrait 2/2 P1", 0x28a1a, 0x28a3a },
};

const sGame_PaletteDataset BattleFlipShot_A_BloodyWolf_P2[] =
{
    { L"Bloody Wolf P2", 0x27cfa, 0x27d1a },
    { L"Select Portrait P2", 0x2807a, 0x2809a },
    { L"VS Portrait P2", 0x28d7a, 0x28d9a },
    { L"Win Portrait 1/2 P2", 0x289fa, 0x28a1a },
    { L"Win Portrait 2/2 P2", 0x28a3a, 0x28a5a },
};

const sGame_PaletteDataset BattleFlipShot_A_BloodyWolf_Extras[] =
{
    { L"Shield", 0x27d1a, 0x27d3a },
    { L"Special Attack", 0x27d3a, 0x27d5a },
    { L"Targets", 0x27d5a, 0x27d7a },
};

const sGame_PaletteDataset BattleFlipShot_A_MrJustice_P1[] =
{
    { L"Mr.Justice P1", 0x27c3a, 0x27c5a },
    { L"Select Portrait P1", 0x2801a, 0x2803a },
    { L"VS Portrait P1", 0x28d1a, 0x28d3a },
    { L"Win Portrait 1/2 P1", 0x2895a, 0x2897a },
    { L"Win Portrait 2/2 P1", 0x2899a, 0x289ba },
};

const sGame_PaletteDataset BattleFlipShot_A_MrJustice_P2[] =
{
    { L"Mr.Justice P2", 0x27c5a, 0x27c7a },
    { L"Select Portrait P2", 0x2803a, 0x2805a },
    { L"VS Portrait P2", 0x28d3a, 0x28d5a },
    { L"Win Portrait 1/2 P2", 0x2897a, 0x2899a },
    { L"Win Portrait 2/2 P2", 0x289ba, 0x289da },
};

const sGame_PaletteDataset BattleFlipShot_A_MrJustice_Extras[] =
{
    { L"Shield", 0x27c7a, 0x27c9a },
    { L"Special Attack", 0x27c9a, 0x27cba },
    { L"Targets", 0x27cba, 0x27cda },
};
...
{
    { L"Shield", 0x27dba, 0x27dda },
    { L"Special Attack", 0x27dda, 0x27dfa },
    { L"Targets", 0x27dfa, 0x27e1a },
};
...
const sGame_PaletteDataset BattleFlipShot_A_BONUS_Intro[] =
{
    ...
    { L"Characters Information", 0x2945a, 0x2963a },
    { L"Characters Portraits", 0x2785a, 0x279ba },
...
{
    { L"Select Screen Background", 0x2923a, 0x2925a },
    { L"Select Screen Text", 0x2809a, 0x280ba },
    { L"Select Screen Numbers", 0x2767a, 0x2769a },
    { L"Select Screen Board", 0x28c3a, 0x28c5a },
    { L"Select Screen Icons", 0x28a5a, 0x28afa },
    { L"Select Screen Cursor", 0x280ba, 0x280da },
...
{
    { L"Ranking Background", 0x290ba, 0x290da },
    { L"Ranking Logo", 0x2905a, 0x2907a },
    { L"Ranking Text", 0x276da, 0x276fa },
    { L"Ranking Numbers", 0x277fa, 0x2781a },
    { L"Ranking Positions", 0x2907a, 0x2909a },
    { L"Ranking Name Entry", 0x2909a, 0x290ba },
};

const sGame_PaletteDataset BattleFlipShot_A_BONUS_Stages[] =
{
    { L"Chinta & Saimon's Stage", 0x2847a, 0x284fa },
    { L"Siren's Stage", 0x2827a, 0x2833a },
    { L"Bloody Wolf's Stage", 0x2837a, 0x2843a },
    { L"Mr.Justice's Stage", 0x2867a, 0x2873a },
    { L"Boss's Stage", 0x2857a, 0x2863a },
};
...
const sGame_PaletteDataset BattleFlipShot_A_BONUS_IngameExtras[] =
{
    ...
    { L"Slide Trail 1", 0x27eba, 0x27eda },
    { L"Slide Trail 2", 0x27eda, 0x27efa },
    { L"Slide Trail 3", 0x27efa, 0x27f1a },
};

const sGame_PaletteDataset BattleFlipShot_A_BONUS_BigTexts[] =
{
    { L"ROUNDS", 0x291ba, 0x291da },
    { L"FIGHT", 0x291da, 0x291fa },
    { L"1PLAYER", 0x2911a, 0x2913a },
    { L"2PLAYER", 0x2913a, 0x2915a },
    { L"WIN", 0x290da, 0x290fa },
    { L"LOSE", 0x290fa, 0x2911a },
    { L"DRAW", 0x2915a, 0x2917a },
    { L"NEW CHALLENGER", 0x2917a, 0x2919a },
    { L"CONTINUE", 0x2919a, 0x291ba },
