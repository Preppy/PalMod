...
uint32_t CGame_KI_SNES::GetExtraCt(uint32_t nUnitId, BOOL fCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, KI_SNES_NUMUNIT, nUnitId, KI_SNES_EXTRA_CUSTOM);
}

uint32_t CGame_KI_SNES::GetExtraLoc(uint32_t nUnitId)
{
...
sFileRule CGame_KI_SNES::GetRule(uint32_t nUnitId)
{
...
uint32_t CGame_KI_SNES::GetCollectionCountForUnit(uint32_t nUnitId)
{
...
uint32_t CGame_KI_SNES::GetNodeCountForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
...
LPCWSTR CGame_KI_SNES::GetDescriptionForCollection(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetDescriptionForCollection(KI_SNES_UNITS, KI_SNES_EXTRALOC, nUnitId, nCollectionId);
}

uint32_t CGame_KI_SNES::GetPaletteCountForUnit(uint32_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_KI_SNES::GetPaletteSet(uint32_t nUnitId, uint32_t nCollectionId)
{
    return _GetPaletteSet(KI_SNES_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_KI_SNES::GetNodeFromPaletteId(uint32_t nUnitId, uint32_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_KI_SNES::GetSpecificPalette(uint32_t nUnitId, uint32_t nPaletteId)
{
...
void CGame_KI_SNES::LoadSpecificPaletteData(uint32_t nUnitId, uint32_t nPalId)
{
