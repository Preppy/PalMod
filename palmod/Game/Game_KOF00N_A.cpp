...
size_t CGame_KOF00N_A::rgExtraCountAll[KOF00N_A_NUMUNIT + 1];
size_t CGame_KOF00N_A::rgExtraLoc[KOF00N_A_NUMUNIT + 1];
...
size_t CGame_KOF00N_A::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, KOF00N_A_NUMUNIT, nUnitId, KOF00N_A_EXTRA_CUSTOM);
}

size_t CGame_KOF00N_A::GetExtraLoc(size_t nUnitId)
{
...
sFileRule CGame_KOF00N_A::GetRule(size_t nUnitId)
{
...
size_t CGame_KOF00N_A::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_KOF00N_A::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_KOF00N_A::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(KOF00N_A_UNITS, KOF00N_A_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_KOF00N_A::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_KOF00N_A::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(KOF00N_A_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_KOF00N_A::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_KOF00N_A::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_KOF00N_A::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
