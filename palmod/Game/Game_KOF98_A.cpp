...
UINT32 CGame_KOF98_A::m_nGameROMSize = 0x400000;  // 4194304 bytes
...
CGame_KOF98_A::CGame_KOF98_A()
{
    CString strMessage;
    strMessage.Format("CGame_KOF98_A::CGame_KOF98_A: Loading ROM...\n" );
    ...
    m_nSafeCountForThisRom = GetExtraCt(m_nExtraUnit) + 1512;
...
sDescTreeNode* CGame_KOF98_A::InitDescTree()
{
    ...
    LoadExtraFileForGame(EXTRA_FILENAME_KOF98_A, KOF98_A_EXTRA, &KOF98_A_EXTRA_CUSTOM, KOF98_A_EXTRALOC, m_nGameROMSize);
    ...
    sprintf(NewDescTree->szDesc, "%s", g_GameFriendlyName[KOF98_A]);
    ...
    strMsg.Format("CGame_KOF98_A::InitDescTree: Building desc tree for KOF98_A %s extras...\n", fHaveExtras ? "with" : "without");
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < KOF98_A_EXTRALOC)
        {
            ...
            sprintf(UnitNode->szDesc, "%s", KOF98_A_UNITS[iUnitCtr].szDesc);
    ...
    strMsg.Format("CGame_KOF98_A::InitDescTree: Loaded %u palettes for KOF98\n", nTotalPaletteCount);
    OutputDebugString(strMsg);
...
LPCSTR CGame_KOF98_A::GetDescriptionForCollection(UINT16 nUnitId, UINT16 nCollectionId)
{
    if (nUnitId == KOF98_A_EXTRALOC)
    {
...
#if KOF98_A_DEBUG
        CString strMsg;
        strMsg.Format("CGame_KOF98_A::GetPaletteCountForUnit: %u for unit %u which has %u collections.\n", nCompleteCount, nUnitId, nCollectionCount);
        OutputDebugString(strMsg);
#endif
...
BOOL CGame_KOF98_A::SaveFile(CFile* SaveFile, UINT16 nUnitId)
{
    ...
    CString strMsg;
    strMsg.Format("CGame_KOF98_A::SaveFile: Saved 0x%x palettes to disk for %u units\n", nTotalPalettesSaved, nUnitAmt);
    OutputDebugString(strMsg);
...
COLORREF* CGame_KOF98_A::CreatePal(UINT16 nUnitId, UINT16 nPalId)
{
    LoadSpecificPaletteData(nUnitId, nPalId);
...
void CGame_KOF98_A::UpdatePalData()
{
