...
const sGame_PaletteDataset AOF1_A_ROBERT_P1[] =
{
    ...
    { L"Robert Damaged 1 P1", 0x47220, 0x47240, indexAoF1Sprites_RobertGarcia, 0x08 },
    { L"Robert Damaged 2 P1", 0x47240, 0x47260, indexAoF1Sprites_RobertGarcia, 0x08 },
...
const sGame_PaletteDataset AOF1_A_ROBERT_P2[] =
{
    ...
    { L"Robert Damaged 1 P2", 0x47280, 0x472a0, indexAoF1Sprites_RobertGarcia, 0x08 },
    { L"Robert Damaged 2 P2", 0x472a0, 0x472c0, indexAoF1Sprites_RobertGarcia, 0x08 },
...
const sGame_PaletteDataset AOF1_A_KING_P1[] =
{
    ...
    { L"King Damaged 1 P1", 0x47660, 0x47680, indexAoF1Sprites_King, 0x08 },
    { L"King Damaged 2 P1", 0x47680, 0x476a0, indexAoF1Sprites_King, 0x08 },
...
const sGame_PaletteDataset AOF1_A_KING_P2[] =
{
    ...
    { L"King Damaged 1 P2", 0x476c0, 0x476e0, indexAoF1Sprites_King, 0x08 },
    { L"King Damaged 2 P2", 0x476e0, 0x47700, indexAoF1Sprites_King, 0x08 },
...
const sGame_PaletteDataset AOF1_A_MICKY_P1[] =
{
    ...
    { L"Micky Damaged 1 P1", 0x47720, 0x47740, indexAoF1Sprites_MickeyRogers, 0x08 },
    { L"Micky Damaged 2 P1", 0x47740, 0x47760, indexAoF1Sprites_MickeyRogers, 0x08 },
...
const sGame_PaletteDataset AOF1_A_MICKY_P2[] =
{
    ...
    { L"Micky Damaged 1 P2", 0x47780, 0x477a0, indexAoF1Sprites_MickeyRogers, 0x08 },
    { L"Micky Damaged 2 P2", 0x477a0, 0x477c0, indexAoF1Sprites_MickeyRogers, 0x08 },
...
const sGame_PaletteDataset AOF1_A_JOHN_P1[] =
{
    ...
    { L"John Damaged 1 P1", 0x477e0, 0x47800, indexAoF1Sprites_JohnCrawley, 0x08 },
    { L"John Damaged 2 P1", 0x47800, 0x47820, indexAoF1Sprites_JohnCrawley, 0x08 },
...
const sGame_PaletteDataset AOF1_A_JOHN_P2[] =
{
    ...
    { L"John Damaged 1 P2", 0x47840, 0x47860, indexAoF1Sprites_JohnCrawley, 0x08 },
    { L"John Damaged 2 P2", 0x47860, 0x47880, indexAoF1Sprites_JohnCrawley, 0x08 },
