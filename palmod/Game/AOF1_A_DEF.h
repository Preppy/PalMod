...
{
    { L"Robert P1", 0x47200, 0x47220 },
    { L"Robert Damaged 1 P1", 0x47220, 0x47240 },
    { L"Robert Damaged 2 P1", 0x47240, 0x47260 },
    { L"Robert Portrait P1", 0x47100, 0x47120 },
};

const sGame_PaletteDataset AOF1_A_ROBERT_P2[] =
{
    { L"Robert P2", 0x47260, 0x47280 },
    { L"Robert Damaged 1 P2", 0x47280, 0x472a0 },
    { L"Robert Damaged 2 P2", 0x472a0, 0x472c0 },
    { L"Robert Portrait P2", 0x47120, 0x47140 },
};
...
{
    { L"Lee P1", 0x47580, 0x475a0 },
    { L"Lee Mask P1", 0x475a0, 0x475c0 },
    { L"Lee Portrait P1", 0x47300, 0x47320 },
    { L"Lee Mask Portrait P1", 0x472c0, 0x472e0 },
};

const sGame_PaletteDataset AOF1_A_LEE_P2[] =
{
    { L"Lee P2", 0x475e0, 0x47600 },
    { L"Lee Mask P2", 0x47600, 0x47620 },
    { L"Lee Portrait P2", 0x47320, 0x47340 },
    { L"Lee Mask Portrait P2", 0x472e0, 0x47300 },
};

const sGame_PaletteDataset AOF1_A_KING_P1[] =
{
    { L"King P1", 0x47640, 0x47660 },
    { L"King Damaged 1 P1", 0x47660, 0x47680 },
    { L"King Damaged 2 P1", 0x47680, 0x476a0 },
    { L"King Bra P1", 0x47d80, 0x47da0 },
    { L"King Portrait P1", 0x471c0, 0x471e0 },
};

const sGame_PaletteDataset AOF1_A_KING_P2[] =
{
    { L"King P2", 0x476a0, 0x476c0 },
    { L"King Damaged 1 P2", 0x476c0, 0x476e0 },
...
{
    { L"Micky P1", 0x47700, 0x47720 },
    { L"Micky Damaged 1 P1", 0x47720, 0x47740 },
    { L"Micky Damaged 2 P1", 0x47740, 0x47760 },
    { L"Micky Portrait P1", 0x47340, 0x47360 },
};

const sGame_PaletteDataset AOF1_A_MICKY_P2[] =
{
    { L"Micky P2", 0x47760, 0x47780 },
    { L"Micky Damaged 1 P2", 0x47780, 0x477a0 },
    { L"Micky Damaged 2 P2", 0x477a0, 0x477c0 },
    { L"Micky Portrait P2", 0x47360, 0x47380 },
};

const sGame_PaletteDataset AOF1_A_JOHN_P1[] =
{
    { L"John P1", 0x477c0, 0x477e0 },
    { L"John Damaged 1 P1", 0x477e0, 0x47800 },
    { L"John Damaged 2 P1", 0x47800, 0x47820 },
    { L"John Portrait P1", 0x47380, 0x473a0 },
};

const sGame_PaletteDataset AOF1_A_JOHN_P2[] =
{
    { L"John P2", 0x47820, 0x47840 },
    { L"John Damaged 1 P2", 0x47840, 0x47860 },
    { L"John Damaged 2 P2", 0x47860, 0x47880 },
    { L"John Portrait P2", 0x473a0, 0x473c0 },
};

const sGame_PaletteDataset AOF1_A_MRBIG_P1[] =
{
    { L"Mr.Big P1", 0x47880, 0x478a0 },
    { L"Mr.Big Damaged 1 P1", 0x478a0, 0x478c0 },
    { L"Mr.Big Damaged 2 P1", 0x478c0, 0x478e0 },
    { L"Mr.Big Portrait P1", 0x473c0, 0x473e0 },
};

const sGame_PaletteDataset AOF1_A_MRBIG_P2[] =
{
    { L"Mr.Big P2", 0x478e0, 0x47900 },
    { L"Mr.Big Damaged 1 P2", 0x47900, 0x47920 },
    { L"Mr.Big Damaged 2 P2", 0x47920, 0x47940 },
};

const sGame_PaletteDataset AOF1_A_MRKARATE_P1[] =
{
    { L"Mr.Karate P1", 0x47940, 0x47960 },
    { L"Mr.Karate Mask P1", 0x47960, 0x47980 },
    { L"Mr.Karate Portrait P1", 0x473e0, 0x47400 },
};

const sGame_PaletteDataset AOF1_A_MRKARATE_P2[] =
{
    { L"Mr.Karate P2", 0x479a0, 0x479c0 },
    { L"Mr.Karate Mask P2", 0x479c0, 0x479e0 },
    { L"Mr.Karate Portrait P2", 0x47be0, 0x47c00 },
};
...
const sDescTreeNode AOF1_A_UNITS[] =
{
    ...
    { L"Nr, Big", DESC_NODETYPE_TREE, (void*)AOF1_A_MRBIG_COLLECTION, ARRAYSIZE(AOF1_A_MRBIG_COLLECTION) },
