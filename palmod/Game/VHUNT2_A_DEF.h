...
const sDescTreeNode VHUNT2_UNITS[] =
{
    ...
    { _T("Bulleta (unplayable)"), DESC_NODETYPE_TREE, (void*)VHUNT2_A_BULLETA_COLLECTION,     ARRAYSIZE(VHUNT2_A_BULLETA_COLLECTION) }, // BB-Hood
    { _T("Q-Bee (unplayable)"), DESC_NODETYPE_TREE, (void*)VHUNT2_A_QUEENBEE_COLLECTION,      ARRAYSIZE(VHUNT2_A_QUEENBEE_COLLECTION) },
    { _T("Lilith (unplayable)"),DESC_NODETYPE_TREE, (void*)VHUNT2_A_LILITH_COLLECTION,        ARRAYSIZE(VHUNT2_A_LILITH_COLLECTION) },
    { _T("Jedah (unplayable)"), DESC_NODETYPE_TREE, (void*)VHUNT2_A_JEDAH_COLLECTION,         ARRAYSIZE(VHUNT2_A_JEDAH_COLLECTION) },
};
