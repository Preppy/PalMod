...
const sDescTreeNode SFZ3U_A_UNITS[] =
{
    ...
    { L"Win Portraits", DESC_NODETYPE_TREE, (void*)SFZ3U_A_WINPORTRAITS_COLLECTION, ARRAYSIZE(SFZ3U_A_WINPORTRAITS_COLLECTION) },
...
{
    { L"pl00_u.pac", 0xec000, L"Ryu", SFZ3U_A_RYU_COLLECTION, ARRAYSIZE(SFZ3U_A_RYU_COLLECTION)},
    { L"pl01_u.pac", 0xe6800, L"Ken", SFZ3U_A_KEN_COLLECTION, ARRAYSIZE(SFZ3U_A_KEN_COLLECTION) },
    { L"pl02_u.pac", 0xea800, L"Akuma", SFZ3U_A_AKUMA_COLLECTION, ARRAYSIZE(SFZ3U_A_AKUMA_COLLECTION) },
    { L"pl03_u.pac", 0xda800, L"Charlie", SFZ3U_A_CHARLIE_COLLECTION, ARRAYSIZE(SFZ3U_A_CHARLIE_COLLECTION) },
    { L"pl04_u.pac", 0xe7800, L"Chun-Li", SFZ3U_A_CHUNLI_COLLECTION, ARRAYSIZE(SFZ3U_A_CHUNLI_COLLECTION) },
    { L"pl05_u.pac", 0xf6000, L"Adon", SFZ3U_A_ADON_COLLECTION, ARRAYSIZE(SFZ3U_A_ADON_COLLECTION) },
    { L"pl06_u.pac", 0x102000, L"Sodom", SFZ3U_A_SODOM_COLLECTION, ARRAYSIZE(SFZ3U_A_SODOM_COLLECTION) },
    { L"pl07_u.pac", 0xd0800, L"Guy", SFZ3U_A_GUY_COLLECTION, ARRAYSIZE(SFZ3U_A_GUY_COLLECTION) },
    { L"pl08_u.pac", 0x124000, L"Birdie", SFZ3U_A_BIRDIE_COLLECTION, ARRAYSIZE(SFZ3U_A_BIRDIE_COLLECTION) },
    { L"pl09_u.pac", 0x121000, L"Rose", SFZ3U_A_ROSE_COLLECTION, ARRAYSIZE(SFZ3U_A_ROSE_COLLECTION) },

    { L"pl0a_u.pac", 0x140000, L"M.Bison", SFZ3U_A_MBISON_COLLECTION, ARRAYSIZE(SFZ3U_A_MBISON_COLLECTION) },
    { L"pl0b_u.pac", 0xfc000, L"Sagat", SFZ3U_A_SAGAT_COLLECTION, ARRAYSIZE(SFZ3U_A_SAGAT_COLLECTION) },
    { L"pl0c_u.pac", 0xd9800, L"Dan", SFZ3U_A_DAN_COLLECTION, ARRAYSIZE(SFZ3U_A_DAN_COLLECTION) },
    { L"pl0d_u.pac", 0x135000, L"Sakura", SFZ3U_A_SAKURA_COLLECTION, ARRAYSIZE(SFZ3U_A_SAKURA_COLLECTION) },
    { L"pl0e_u.pac", 0x126000, L"Rolento", SFZ3U_A_ROLENTO_COLLECTION, ARRAYSIZE(SFZ3U_A_ROLENTO_COLLECTION) },
    { L"pl0f_u.pac", 0x12f800, L"Dhalsim", SFZ3U_A_DHALSIM_COLLECTION, ARRAYSIZE(SFZ3U_A_DHALSIM_COLLECTION) },
    { L"pl10_u.pac", 0x180000, L"Zangief", SFZ3U_A_ZANGIEF_COLLECTION, ARRAYSIZE(SFZ3U_A_ZANGIEF_COLLECTION) },
    { L"pl11_u.pac", 0x113800, L"Gen", SFZ3U_A_GEN_COLLECTION, ARRAYSIZE(SFZ3U_A_GEN_COLLECTION) },
    { L"pl12_u.pac", 0xe9800, L"Chun-Li (X-Ism)", SFZ3U_A_CHUNLIXISM_COLLECTION, ARRAYSIZE(SFZ3U_A_CHUNLIXISM_COLLECTION) },
    { L"pl13_u.pac", 0x113800, L"Gen (Crane stance)", SFZ3U_A_GENCRANESTANCE_COLLECTION, ARRAYSIZE(SFZ3U_A_GENCRANESTANCE_COLLECTION) },

    { L"pl14_u.pac", 0x12e800, L"Sodom (X-Ism)", SFZ3U_A_SODOMXISM_COLLECTION, ARRAYSIZE(SFZ3U_A_SODOMXISM_COLLECTION) },
    { L"pl15_u.pac", 0xc5000, L"Balrog (Unused)", SFZ3U_A_BALROG_COLLECTION, ARRAYSIZE(SFZ3U_A_BALROG_COLLECTION) },
    { L"pl16_u.pac", 0x116000, L"Cammy", SFZ3U_A_CAMMY_COLLECTION, ARRAYSIZE(SFZ3U_A_CAMMY_COLLECTION) },
    { L"pl17_u.pac", 0x122800, L"Evil Ryu", SFZ3U_A_EVILRYU_COLLECTION, ARRAYSIZE(SFZ3U_A_EVILRYU_COLLECTION) },
    { L"pl18_u.pac", 0x113800, L"E.Honda", SFZ3U_A_EHONDA_COLLECTION, ARRAYSIZE(SFZ3U_A_EHONDA_COLLECTION) },
    { L"pl19_u.pac", 0x167800, L"Blanka", SFZ3U_A_BLANKA_COLLECTION, ARRAYSIZE(SFZ3U_A_BLANKA_COLLECTION) },
    { L"pl1a_u.pac", 0x174800, L"R.Mika", SFZ3U_A_RMIKA_COLLECTION, ARRAYSIZE(SFZ3U_A_RMIKA_COLLECTION) },
    { L"pl1b_u.pac", 0x157800, L"Cody", SFZ3U_A_CODY_COLLECTION, ARRAYSIZE(SFZ3U_A_CODY_COLLECTION) },
    { L"pl1c_u.pac", 0x14c800, L"Vega", SFZ3U_A_VEGA_COLLECTION, ARRAYSIZE(SFZ3U_A_VEGA_COLLECTION) },
    { L"pl1d_u.pac", 0x146000, L"Karin", SFZ3U_A_KARIN_COLLECTION, ARRAYSIZE(SFZ3U_A_KARIN_COLLECTION) },

    { L"pl1e_u.pac", 0x11e000, L"Juli", SFZ3U_A_JULI_COLLECTION, ARRAYSIZE(SFZ3U_A_JULI_COLLECTION) },
    { L"pl1f_u.pac", 0x124800, L"Juni", SFZ3U_A_JUNI_COLLECTION, ARRAYSIZE(SFZ3U_A_JUNI_COLLECTION) },
    { L"pl20_u.pac", 0x137000, L"Guile", SFZ3U_A_GUILE_COLLECTION, ARRAYSIZE(SFZ3U_A_GUILE_COLLECTION) },
    { L"pl21_u.pac", 0xfb800, L"Fei Long", SFZ3U_A_FEILONG_COLLECTION, ARRAYSIZE(SFZ3U_A_FEILONG_COLLECTION) },
    { L"pl22_u.pac", 0x11f000, L"Dee Jay", SFZ3U_A_DEEJAY_COLLECTION, ARRAYSIZE(SFZ3U_A_DEEJAY_COLLECTION) },
    { L"pl23_u.pac", 0x136000, L"T-Hawk", SFZ3U_A_THAWK_COLLECTION, ARRAYSIZE(SFZ3U_A_THAWK_COLLECTION) },
    { L"pl24_u.pac", 0xea800, L"Shin Akuma", SFZ3U_A_SHINAKUMA_COLLECTION, ARRAYSIZE(SFZ3U_A_SHINAKUMA_COLLECTION) },
    { L"pl25_u.pac", 0x10d000, L"Balrog", SFZ3U_A_BALROGFINISHED_COLLECTION, ARRAYSIZE(SFZ3U_A_BALROGFINISHED_COLLECTION) },

    { L"pl26_u.pac", 0x1a0800, L"Eagle", SFZ3M_S_EAGLE_COLLECTION, ARRAYSIZE(SFZ3M_S_EAGLE_COLLECTION) },
    { L"pl27_u.pac", 0x1aa800, L"Maki", SFZ3M_S_MAKI_COLLECTION, ARRAYSIZE(SFZ3M_S_MAKI_COLLECTION) },
    { L"pl28_u.pac", 0x1cc800, L"Yun", SFZ3M_S_YUN_COLLECTION, ARRAYSIZE(SFZ3M_S_YUN_COLLECTION) },
    { L"pl29_u.pac", 0x1fb800, L"Ingrid", SFZ3M_S_INGRID_COLLECTION, ARRAYSIZE(SFZ3M_S_INGRID_COLLECTION) },
    ...
    { L"select_u.pac", 0x124800, L"Bonus Palettes", SFZ3U_A_BONUS_COLLECTION, ARRAYSIZE(SFZ3U_A_BONUS_COLLECTION) },
};
