...
{
    { L"Ryu Normal 1/2", 0x9600 - 0x02, 0x9620 - 0x02, indexSF2Sprites_Bonus, 0x0d, &pairNext },
    { L"Ryu Normal 2/2", 0x95a0 - 0x02, 0x95c0 - 0x02, indexSF2Sprites_Bonus, 0x0e },
...
{
    { L"Blanka Normal 1/2", 0x9640 - 0x02, 0x9660 - 0x02, indexSF2Sprites_Bonus, 0x0d, &pairNext },
    { L"Blanka Normal 2/2", 0x97E0 - 0x02, 0x9800 - 0x02, indexSF2Sprites_Bonus, 0x0e },
...
{
    { L"Zangief Normal", 0x96c0 - 0x02, 0x96e0 - 0x02, indexSF2Sprites_Bonus, 0x1a },
...
{
    { L"Boxer Normal 1/2", 0x9740 - 0x02, 0x9760 - 0x02, indexSF2Sprites_Bonus, 0x0d, &pairNext },
    { L"Boxer Normal 2/2", 0x97a0 - 0x02, 0x97c0 - 0x02, indexSF2Sprites_Bonus, 0x0e },
...
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_BLANKA_P1_NODE, ARRAYSIZE(SF2HF_A_BLANKA_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_BLANKA_P2_NODE, ARRAYSIZE(SF2HF_A_BLANKA_P2_NODE) },
};

const sDescTreeNode SF2HF_A_CHUNLI_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_CHUNLI_P1_NODE, ARRAYSIZE(SF2HF_A_CHUNLI_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_CHUNLI_P2_NODE, ARRAYSIZE(SF2HF_A_CHUNLI_P2_NODE) },
};

const sDescTreeNode SF2HF_A_DHALSIM_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_DHALSIM_P1_NODE, ARRAYSIZE(SF2HF_A_DHALSIM_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_DHALSIM_P2_NODE, ARRAYSIZE(SF2HF_A_DHALSIM_P2_NODE) },
};

const sDescTreeNode SF2HF_A_EHONDA_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_EHONDA_P1_NODE, ARRAYSIZE(SF2HF_A_EHONDA_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_EHONDA_P2_NODE, ARRAYSIZE(SF2HF_A_EHONDA_P2_NODE) },
};

const sDescTreeNode SF2HF_A_GUILE_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_GUILE_P1_NODE, ARRAYSIZE(SF2HF_A_GUILE_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_GUILE_P2_NODE, ARRAYSIZE(SF2HF_A_GUILE_P2_NODE) },
};

const sDescTreeNode SF2HF_A_KEN_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_KEN_P1_NODE, ARRAYSIZE(SF2HF_A_KEN_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_KEN_P2_NODE, ARRAYSIZE(SF2HF_A_KEN_P2_NODE) },
};

const sDescTreeNode SF2HF_A_RYU_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_RYU_P1_NODE, ARRAYSIZE(SF2HF_A_RYU_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_RYU_P2_NODE, ARRAYSIZE(SF2HF_A_RYU_P2_NODE) },
};

const sDescTreeNode SF2HF_A_ZANGIEF_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_ZANGIEF_P1_NODE, ARRAYSIZE(SF2HF_A_ZANGIEF_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_ZANGIEF_P2_NODE, ARRAYSIZE(SF2HF_A_ZANGIEF_P2_NODE) },
};

const sDescTreeNode SF2HF_A_BOXER_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_BOXER_P1_NODE, ARRAYSIZE(SF2HF_A_BOXER_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_BOXER_P2_NODE, ARRAYSIZE(SF2HF_A_BOXER_P2_NODE) },
};

const sDescTreeNode SF2HF_A_CLAW_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_CLAW_P1_NODE, ARRAYSIZE(SF2HF_A_CLAW_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_CLAW_P2_NODE, ARRAYSIZE(SF2HF_A_CLAW_P2_NODE) },
};

const sDescTreeNode SF2HF_A_SAGAT_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_SAGAT_P1_NODE, ARRAYSIZE(SF2HF_A_SAGAT_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_SAGAT_P2_NODE, ARRAYSIZE(SF2HF_A_SAGAT_P2_NODE) },
};

const sDescTreeNode SF2HF_A_DICTATOR_COLLECTION[] =
{
    { L"Normal",         DESC_NODETYPE_TREE, (void*)SF2HF_A_DICTATOR_P1_NODE, ARRAYSIZE(SF2HF_A_DICTATOR_P1_NODE) },
    { L"Start",         DESC_NODETYPE_TREE, (void*)SF2HF_A_DICTATOR_P2_NODE, ARRAYSIZE(SF2HF_A_DICTATOR_P2_NODE) },
};
