...
{
private:
    static sFileRule GetRuleInternal(size_t nRuleId, int nSF3ModeToLoad);
...
public:
    ...
    static sFileRule GetRule10(size_t nRuleId) { return GetRuleInternal(nRuleId, SF3ROM_10); };
    static sFileRule GetRule4_10(size_t nRuleId) { return GetRuleInternal(nRuleId, SF3ROM_10_4rd); };
    static sFileRule GetRule4(size_t nRuleId) { return GetRuleInternal(nRuleId, SF3ROM_51_4rd); };
    static sFileRule GetRule51(size_t nRuleId) { return GetRuleInternal(nRuleId, SF3ROM_51); };
    static sFileRule GetRule3Ex(size_t nRuleId) { return GetRuleInternal(nRuleId, SF3ROM_70_EX); };
    ...
    BOOL SaveFile(CFile* SaveFile, size_t nSIMMNumber) override;
