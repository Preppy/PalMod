...
{
private:
    static uint32_t m_nTotalPaletteCountForROTD;

    static uint32_t rgExtraCountAll[ROTD_A_NUMUNIT + 1];
    static uint32_t rgExtraLoc[ROTD_A_NUMUNIT + 1];
    ...
    static constexpr auto EXTRA_FILENAME_ROTD_A = L"ROTDE.txt";
