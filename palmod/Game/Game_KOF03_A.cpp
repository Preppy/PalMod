...
CGame_KOF03_A::CGame_KOF03_A(UINT32 nConfirmedROMSize)
{
    ...
    nImgUnitAmt = ARRAYSIZE(KOF03_A_IMG_UNITS);
...
sDescTreeNode* CGame_KOF03_A::InitDescTree()
{
    ...
    strMsg.Format(L"CGame_KOF03_A::InitDescTree: Building desc tree for KOF03_A %s extras...\n", fHaveExtras ? L"with" : L"without");
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < KOF03_A_EXTRALOC)
        {
            ...
            _snwprintf_s(UnitNode->szDesc, ARRAYSIZE(UnitNode->szDesc), _TRUNCATE, L"%s", KOF03_A_UNITS[iUnitCtr].szDesc);
    ...
    strMsg.Format(L"CGame_KOF03_A::InitDescTree: Loaded %u palettes for KOF03\n", nTotalPaletteCount);
    OutputDebugString(strMsg);
...
#if KOF03_A_DEBUG
        CString strMsg;
        strMsg.Format(L"CGame_KOF03_A::GetPaletteCountForUnit: %u for unit %u which has %u collections.\n", nCompleteCount, nUnitId, nCollectionCount);
        OutputDebugString(strMsg);
#endif
