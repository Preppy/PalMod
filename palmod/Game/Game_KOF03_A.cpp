...
CGame_KOF03_A::CGame_KOF03_A(UINT32 nConfirmedROMSize)
{
    ...
    m_nSafeCountForThisRom = GetExtraCt(m_nExtraUnit) + 806;
...
sDescTreeNode* CGame_KOF03_A::InitDescTree()
{
    ...
    _stprintf(NewDescTree->szDesc, _T("%s"), g_GameFriendlyName[KOF03_A]);
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr < KOF03_A_EXTRALOC)
        {
            ...
            _stprintf(UnitNode->szDesc, _T("%s"), KOF03_A_UNITS[iUnitCtr].szDesc);
