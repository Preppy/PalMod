...
CGame_KOF03_A::CGame_KOF03_A(uint32_t nConfirmedROMSize)
{
    ...
    m_nSafeCountForThisRom = GetExtraCt(m_nExtraUnit) + 1924;
...
uint32_t CGame_KOF03_A::GetExtraCt(uint32_t nUnitId, BOOL fCountVisibleOnly)
{
