...
// * Update SurvivalArts_A_UNITS with the new character
// * Add an array below along the lines of SurvivalArts_A_VIPER_PALETTES_LP. 
// * Create a collection for those arrays along the lines of SurvivalArts_A_VIPER_COLLECTION
// That should be it.  Good luck.

const std::vector<uint16_t> SurvivalArts_A_IMGIDS_USED =
{
};

const sGame_PaletteDataset SurvivalArts_A_VIPER_PALETTES_LP[] =
{
...
{
    { L"Viper HP", 0x1a60c, 0x1a70c },
};

const sGame_PaletteDataset SurvivalArts_A_VIPER_PALETTES_LK[] =
{
    { L"Viper LK", 0x1a70c, 0x1a80c },
};

const sGame_PaletteDataset SurvivalArts_A_VIPER_PALETTES_MK[] =
{
    { L"Viper MK", 0x1a80c, 0x1a90c },
};

const sGame_PaletteDataset SurvivalArts_A_VIPER_PALETTES_HK[] =
{
...
{
    { L"Gunner MP", 0x1930c, 0x1940c },
};

const sGame_PaletteDataset SurvivalArts_A_GUNNER_PALETTES_HP[] =
{
    { L"Gunner HP", 0x18f0c, 0x1900c },
};

const sGame_PaletteDataset SurvivalArts_A_GUNNER_PALETTES_LK[] =
{
    { L"Gunner LK", 0x1900c, 0x1910c },
};

const sGame_PaletteDataset SurvivalArts_A_GUNNER_PALETTES_MK[] =
{
    { L"Gunner MK", 0x1910c, 0x1920c },
};

const sGame_PaletteDataset SurvivalArts_A_GUNNER_PALETTES_HK[] =
{
...
{
    { L"Gunner 2P/Alt", 0x13e0c, 0x13f0c },
};
...
{
    { L"Hanna HP", 0x1b50c, 0x1b60c },
};

const sGame_PaletteDataset SurvivalArts_A_HANNA_PALETTES_LK[] =
{
    { L"Hanna LK", 0x1b60c, 0x1b70c },
};

const sGame_PaletteDataset SurvivalArts_A_HANNA_PALETTES_MK[] =
{
    { L"Hanna MK", 0x1b70c, 0x1b80c },
};

const sGame_PaletteDataset SurvivalArts_A_HANNA_PALETTES_HK[] =
{
...
{
    { L"Hiryu HP", 0x1b00c, 0x1b10c },
};

const sGame_PaletteDataset SurvivalArts_A_HIRYU_PALETTES_LK[] =
{
    { L"Hiryu LK", 0x1b10c, 0x1b20c },
};

const sGame_PaletteDataset SurvivalArts_A_HIRYU_PALETTES_MK[] =
{
    { L"Hiryu MK", 0x1b20c, 0x1b30c },
};

const sGame_PaletteDataset SurvivalArts_A_HIRYU_PALETTES_HK[] =
{
...
{
    { L"Tasha HP", 0x1940c, 0x1950c },
};

const sGame_PaletteDataset SurvivalArts_A_TASHA_PALETTES_LK[] =
{
    { L"Tasha LK", 0x1950c, 0x1960c },
};

const sGame_PaletteDataset SurvivalArts_A_TASHA_PALETTES_MK[] =
{
    { L"Tasha MK", 0x1960c, 0x1970c },
};

const sGame_PaletteDataset SurvivalArts_A_TASHA_PALETTES_HK[] =
{
...
{
    { L"Mongo HP", 0x1a10c, 0x1a20c },
};

const sGame_PaletteDataset SurvivalArts_A_MONGO_PALETTES_LK[] =
{
    { L"Mongo LK", 0x1a20c, 0x1a30c },
};

const sGame_PaletteDataset SurvivalArts_A_MONGO_PALETTES_MK[] =
{
    { L"Mongo MK", 0x1a30c, 0x1a40c },
};

const sGame_PaletteDataset SurvivalArts_A_MONGO_PALETTES_HK[] =
{
...
{
    { L"LP", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_VIPER_PALETTES_LP, ARRAYSIZE(SurvivalArts_A_VIPER_PALETTES_LP) },
    { L"MP", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_VIPER_PALETTES_MP, ARRAYSIZE(SurvivalArts_A_VIPER_PALETTES_MP) },
    { L"HP", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_VIPER_PALETTES_HP, ARRAYSIZE(SurvivalArts_A_VIPER_PALETTES_HP) },
...
{
    { L"Viper", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_VIPER_COLLECTION, ARRAYSIZE(SurvivalArts_A_VIPER_COLLECTION) },
    { L"Gunner", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_GUNNER_COLLECTION, ARRAYSIZE(SurvivalArts_A_GUNNER_COLLECTION) },
    { L"Hanna", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_HANNA_COLLECTION, ARRAYSIZE(SurvivalArts_A_HANNA_COLLECTION) },
    { L"Hiryu", DESC_NODETYPE_TREE, (void*)SurvivalArts_A_HIRYU_COLLECTION, ARRAYSIZE(SurvivalArts_A_HIRYU_COLLECTION) },
