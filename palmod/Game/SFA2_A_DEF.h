...
const sDescTreeNode SFA2_A_BONUS08_COLLECTION[] =
{
    { L"Intro Portraits", DESC_NODETYPE_TREE, (void*)SFA2_A_INTROPORTRAIT_PALETTES, ARRAYSIZE(SFA2_A_INTROPORTRAIT_PALETTES) },
};
