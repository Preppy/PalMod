...
const sDescTreeNode DOUBLEDRAGON_A_ADOBO_COLLECTION[] =
{
    { L"A", DESC_NODETYPE_TREE, (void*)DOUBLEDRAGON_A_ADOBO_A, ARRAYSIZE(DOUBLEDRAGON_A_ADOBO_A) },
    { L"B", DESC_NODETYPE_TREE, (void*)DOUBLEDRAGON_A_ADOBO_B, ARRAYSIZE(DOUBLEDRAGON_A_ADOBO_B) },
    { L"C", DESC_NODETYPE_TREE, (void*)DOUBLEDRAGON_A_ADOBO_C, ARRAYSIZE(DOUBLEDRAGON_A_ADOBO_C) },
    { L"D", DESC_NODETYPE_TREE, (void*)DOUBLEDRAGON_A_ADOBO_D, ARRAYSIZE(DOUBLEDRAGON_A_ADOBO_D) },
};
...
const sDescTreeNode DOUBLEDRAGON_A_UNITS[] =
{
    ...
    { L"Adobo", DESC_NODETYPE_TREE, (void*)DOUBLEDRAGON_A_ADOBO_COLLECTION, ARRAYSIZE(DOUBLEDRAGON_A_ADOBO_COLLECTION) },
