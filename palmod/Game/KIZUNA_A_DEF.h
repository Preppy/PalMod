...
const sGame_PaletteDataset Kizuna_A_HAYATE_PALETTES_A[] =
{
    ...
    { L"Hayate Background A", 0x170400, 0x170440 },
};

const sGame_PaletteDataset Kizuna_A_HAYATE_PALETTES_D[] =
{
    { L"Hayate D", 0x172900, 0x172940 },
    { L"Hayate Background D", 0x172b00, 0x172b40 },
};

const sGame_PaletteDataset Kizuna_A_EAGLE_PALETTES_A[] =
{
    { L"Eagle A", 0x170500, 0x170540 },
    { L"Eagle Background A", 0x1706e0, 0x170720 },
};

const sGame_PaletteDataset Kizuna_A_EAGLE_PALETTES_D[] =
{
    { L"Eagle D", 0x172c00, 0x172c40 },
    { L"Eagle Background D", 0x172de0, 0x172e20 },
};

const sGame_PaletteDataset Kizuna_A_GOZU_PALETTES_A[] =
{
    { L"Gozu A", 0x170800, 0x170840 },
    { L"Gozu Background A", 0x170a00, 0x170a20 },
};

const sGame_PaletteDataset Kizuna_A_GOZU_PALETTES_D[] =
{
    { L"Gozu D", 0x172f00, 0x172f40 },
    { L"Gozu Background D", 0x173100, 0x173120 },
};

const sGame_PaletteDataset Kizuna_A_MEZU_PALETTES_A[] =
{
    { L"Mezu A", 0x170b00, 0x170b40 },
    { L"Mezu Background A", 0x170d00, 0x170d20 },
};

const sGame_PaletteDataset Kizuna_A_MEZU_PALETTES_D[] =
{
    { L"Mezu D", 0x173200, 0x173240 },
    { L"Mezu Background D", 0x173400, 0x173420 },
};

const sGame_PaletteDataset Kizuna_A_ROSA_PALETTES_A[] =
{
    { L"Rosa A", 0x170e00, 0x170e40 },
    { L"Rosa Background A", 0x171000, 0x171040 },
    { L"Rosa's Sword A", 0x170f60, 0x170f80 },
};

const sGame_PaletteDataset Kizuna_A_ROSA_PALETTES_D[] =
{
    { L"Rosa D", 0x173500, 0x173540 },
    { L"Rosa Background D", 0x173700, 0x173740 },
    { L"Rosa's Sword D", 0x173660, 0x173680 },
};

const sGame_PaletteDataset Kizuna_A_KIM_PALETTES_A[] =
{
    { L"Kim A", 0x171100, 0x171140 },
    { L"Kim Background A", 0x171300, 0x171320 },
};

const sGame_PaletteDataset Kizuna_A_KIM_PALETTES_D[] =
{
    { L"Kim D", 0x173800, 0x173840 },
    { L"Kim Background D", 0x173a00, 0x173a20 },
};

const sGame_PaletteDataset Kizuna_A_JOKER_PALETTES_A[] =
{
    { L"Joker A", 0x171400, 0x171440 },
    { L"Joker Background A", 0x171600, 0x171640 },
};

const sGame_PaletteDataset Kizuna_A_JOKER_PALETTES_D[] =
{
    { L"Joker D", 0x173b00, 0x173b40 },
    { L"Joker Background D", 0x173d00, 0x173d20 },
};

const sGame_PaletteDataset Kizuna_A_CHUNG_PALETTES_A[] =
{
    { L"Chung A", 0x171700, 0x171740 },
    { L"Chung Background A", 0x171900, 0x171940 },
    { L"Chung Rage A", 0x171840, 0x171880 },
};

const sGame_PaletteDataset Kizuna_A_CHUNG_PALETTES_D[] =
{
    { L"Chung D", 0x173e00, 0x173e40 },
    { L"Chung Background D", 0x174000, 0x174040 },
    { L"Chung Rage D", 0x173f40, 0x173f80 },
};

const sGame_PaletteDataset Kizuna_A_GORDON_PALETTES_A[] =
{
    { L"Gordon A", 0x171a00, 0x171a40 },
    { L"Gordon Background A", 0x171c00, 0x171c20 },
};

const sGame_PaletteDataset Kizuna_A_GORDON_PALETTES_D[] =
{
    { L"Gordon D", 0x174100, 0x174140 },
    { L"Gordon Background D", 0x174300, 0x174320 },
};

const sGame_PaletteDataset Kizuna_A_KINGLION_PALETTES_A[] =
{
    { L"King Lion A", 0x171d00, 0x171d40 },
    { L"King Lion Background A", 0x171ee0, 0x171f20 },
};

const sGame_PaletteDataset Kizuna_A_KINGLION_PALETTES_D[] =
{
    { L"King Lion D", 0x174400, 0x174440 },
    { L"King Lion Background D", 0x174600, 0x174620 },
};

const sGame_PaletteDataset Kizuna_A_KINGLION_PALETTES_SHARED[] =
{
    { L"Shin King Lion", 0x172000, 0x172040 }, };

const sGame_PaletteDataset Kizuna_A_JAZU_PALETTES[] =
{
    { L"Jazu", 0x172600, 0x172640 },
    { L"Jazu's Mask", 0x1727c0, 0x1727e0 },
};
