...
size_t CGame_VampireHunter_A::rgExtraCountAll[VampireHunter_A_NUMUNIT + 1] = { (size_t)-1 };
size_t CGame_VampireHunter_A::rgExtraLoc[VampireHunter_A_NUMUNIT + 1] = { (size_t)-1 };
...
size_t CGame_VampireHunter_A::GetExtraCt(size_t nUnitId, BOOL bCountVisibleOnly)
{
    return _GetExtraCount(rgExtraCountAll, VampireHunter_A_NUMUNIT, nUnitId, VampireHunter_A_EXTRA_CUSTOM);
}

size_t CGame_VampireHunter_A::GetExtraLoc(size_t nUnitId)
{
...
sFileRule CGame_VampireHunter_A::GetRule(size_t nUnitId)
{
...
size_t CGame_VampireHunter_A::GetCollectionCountForUnit(size_t nUnitId)
{
...
size_t CGame_VampireHunter_A::GetNodeCountForCollection(size_t nUnitId, size_t nCollectionId)
{
...
LPCWSTR CGame_VampireHunter_A::GetDescriptionForCollection(size_t nUnitId, size_t nCollectionId)
{
    return _GetDescriptionForCollection(VampireHunter_A_UNITS, VampireHunter_A_EXTRALOC, nUnitId, nCollectionId);
}

size_t CGame_VampireHunter_A::GetPaletteCountForUnit(size_t nUnitId)
{
...
const sGame_PaletteDataset* CGame_VampireHunter_A::GetPaletteSet(size_t nUnitId, size_t nCollectionId)
{
    return _GetPaletteSet(VampireHunter_A_UNITS, nUnitId, nCollectionId);
}

const sDescTreeNode* CGame_VampireHunter_A::GetNodeFromPaletteId(size_t nUnitId, size_t nPaletteId, bool fReturnBasicNodesOnly)
{
...
const sGame_PaletteDataset* CGame_VampireHunter_A::GetSpecificPalette(size_t nUnitId, size_t nPaletteId)
{
...
void CGame_VampireHunter_A::LoadSpecificPaletteData(size_t nUnitId, size_t nPalId)
{
