...
{
    { L"Jab", 0x43f9e, 0x43FBE, indexSF2Sprites_Ryu, 0x00 },
...
{
    { L"BG wall painting",                                      0xdbe0 + (0x00 * 0x20), 0xdbe0 + (0x01 * 0x20), indexSF2Sprites_Stages, 0x59, &pairFullyLinkedNode },
    { L"BG curtains + lamp",                                    0xdbe0 + (0x01 * 0x20), 0xdbe0 + (0x02 * 0x20), indexSF2Sprites_Stages, 0x5a },
    { L"BG columns",                                            0xdbe0 + (0x02 * 0x20), 0xdbe0 + (0x03 * 0x20), indexSF2Sprites_Stages, 0x5b },
    { L"BG elephant (static part)",                             0xdbe0 + (0x03 * 0x20), 0xdbe0 + (0x04 * 0x20), indexSF2Sprites_Stages, 0x5c },
    { L"BG topmost curtain + column piece",                     0xdbe0 + (0x04 * 0x20), 0xdbe0 + (0x05 * 0x20), indexSF2Sprites_Stages, 0x5d },
    { L"BG stairs",                                             0xdbe0 + (0x05 * 0x20), 0xdbe0 + (0x06 * 0x20), indexSF2Sprites_Stages, 0x5e },
    { L"parallaxed ground, stones",                             0xdbe0 + (0x06 * 0x20), 0xdbe0 + (0x07 * 0x20), indexSF2Sprites_Stages, 0x5f },
    { L"BG curtains + BG elephant ivory fangs (static part)",   0xdbe0 + (0x07 * 0x20), 0xdbe0 + (0x08 * 0x20), indexSF2Sprites_Stages, 0x60 },
    { L"BG purpley grid",                                       0xdbe0 + (0x08 * 0x20), 0xdbe0 + (0x09 * 0x20), indexSF2Sprites_Stages, 0x61 },
    { L"BG elephant feet",                                      0xdbe0 + (0x09 * 0x20), 0xdbe0 + (0x0a * 0x20), indexSF2Sprites_Stages, 0x62 },
    { L"?",                                                     0xdbe0 + (0x0a * 0x20), 0xdbe0 + (0x0b * 0x20) },
    { L"BG wall, after the purple grid",                        0xdbe0 + (0x0b * 0x20), 0xdbe0 + (0x0c * 0x20), indexSF2Sprites_Stages, 0x63 },

    { L"BG elephant head + curtain 1",                          0xdbe0 + (0x0c * 0x20), 0xdbe0 + (0x0d * 0x20), indexSF2Sprites_Stages, 0x64 },
    { L"BG elephant head + curtain 2",                          0xdbe0 + (0x0d * 0x20), 0xdbe0 + (0x0e * 0x20), indexSF2Sprites_Stages, 0x65 },
    { L"BG elephant head + curtain 3",                          0xdbe0 + (0x0e * 0x20), 0xdbe0 + (0x0f * 0x20), indexSF2Sprites_Stages, 0x66 },
    { L"BG elephant head + curtain 4",                          0xdbe0 + (0x0f * 0x20), 0xdbe0 + (0x10 * 0x20), indexSF2Sprites_Stages, 0x67 },
    { L"BG elephant head + curtain 5",                          0xdbe0 + (0x10 * 0x20), 0xdbe0 + (0x11 * 0x20), indexSF2Sprites_Stages, 0x68 },
    { L"BG elephant trunk + curtain",                           0xdbe0 + (0x11 * 0x20), 0xdbe0 + (0x12 * 0x20), indexSF2Sprites_Stages, 0x69 },
    { L"BG elephant back + purpley grid",                       0xdbe0 + (0x12 * 0x20), 0xdbe0 + (0x13 * 0x20), indexSF2Sprites_Stages, 0x6a },
    { L"BG elephant back + purpley grid",                       0xdbe0 + (0x13 * 0x20), 0xdbe0 + (0x14 * 0x20), indexSF2Sprites_Stages, 0x6b },
    { L"BG elephant back + purpley grid",                       0xdbe0 + (0x14 * 0x20), 0xdbe0 + (0x15 * 0x20), indexSF2Sprites_Stages, 0x6c },
    { L"BG wall, after the purple grid, but on the footer",     0xdbe0 + (0x15 * 0x20), 0xdbe0 + (0x16 * 0x20), indexSF2Sprites_Stages, 0x6d },

    { L"parallaxed ground, carpet",                             0xdbe0 + (0x16 * 0x20), 0xdbe0 + (0x17 * 0x20), indexSF2Sprites_Stages, 0x6e },
    { L"parallaxed ground, border between carpet and stones",   0xdbe0 + (0x17 * 0x20), 0xdbe0 + (0x18 * 0x20), indexSF2Sprites_Stages, 0x6f },
    { L"parallaxed ground, border between carpet and stones, topmost part", 0xdbe0 + (0x18 * 0x20), 0xdbe0 + (0x19 * 0x20), indexSF2Sprites_Stages, 0x70 },
    { L"BG wall painting, frame/border",                        0xdbe0 + (0x19 * 0x20), 0xdbe0 + (0x1a * 0x20), indexSF2Sprites_Stages, 0x71 },
    { L"BG wall painting, topmost part",                        0xdbe0 + (0x1a * 0x20), 0xdbe0 + (0x1b * 0x20), indexSF2Sprites_Stages, 0x72 },
    { L"BG curtains above the wall painting",                   0xdbe0 + (0x1b * 0x20), 0xdbe0 + (0x1c * 0x20), indexSF2Sprites_Stages, 0x73 },
    { L"BG wall painting, frame/border, topmost part",          0xdbe0 + (0x1c * 0x20), 0xdbe0 + (0x1d * 0x20), indexSF2Sprites_Stages, 0x74 },
            { L"BG elephant trunk, when it's raised (in front of column)",          0xdbe0 + (0x1d * 0x20), 0xdbe0 + (0x1e * 0x20) },
            { L"BG elephant trunk, when it's raised (in front of curtain)",         0xdbe0 + (0x1e * 0x20), 0xdbe0 + (0x1f * 0x20) },
            { L"BG elephant trunk, when it's raised (in front of foremost column)", 0xdbe0 + (0x1f * 0x20), 0xdbe0 + (0x20 * 0x20) },
...
{
    { L"Wall sign, part 1 (\"Meson\")",                     0xebe0 + (0x00 * 0x20), 0xebe0 + (0x01 * 0x20), indexSF2Sprites_Stages, 0x32, &pairFullyLinkedNode },
        { L"Wall sign, part 2 (\"Meson de\")",              0xebe0 + (0x01 * 0x20), 0xebe0 + (0x02 * 0x20), indexSF2Sprites_Stages, 0x32 },
        { L"Wall sign, part 3 (\"Meson de la\")",           0xebe0 + (0x02 * 0x20), 0xebe0 + (0x03 * 0x20), indexSF2Sprites_Stages, 0x32 },
        { L"Wall sign, part 5 (blank)",                     0xebe0 + (0x04 * 0x20), 0xebe0 + (0x05 * 0x20), indexSF2Sprites_Stages, 0x32 },
        // putting last for layering
        { L"Wall sign, part 4 (\"Meson de la Taberna\")",   0xebe0 + (0x03 * 0x20), 0xebe0 + (0x04 * 0x20), indexSF2Sprites_Stages, 0x32 },
    { L"Foreground wall, stairs (darkest shade)",           0xebe0 + (0x05 * 0x20), 0xebe0 + (0x06 * 0x20), indexSF2Sprites_Stages, 0x33 },
        { L"Foreground wall, stairs (middle shade)",        0xebe0 + (0x06 * 0x20), 0xebe0 + (0x07 * 0x20), indexSF2Sprites_Stages, 0x33 },
        { L"Foreground wall, stairs (lightest shade)",      0xebe0 + (0x07 * 0x20), 0xebe0 + (0x08 * 0x20), indexSF2Sprites_Stages, 0x33 },
    { L"Background wall, lamp wall (middle shade)",         0xebe0 + (0x08 * 0x20), 0xebe0 + (0x09 * 0x20), indexSF2Sprites_Stages, 0x34 },
        { L"Background wall, lamp wall (lightest shade)",   0xebe0 + (0x09 * 0x20), 0xebe0 + (0x0a * 0x20), indexSF2Sprites_Stages, 0x34 },
        { L"Background wall, lamp wall (darkest shade)",    0xebe0 + (0x0a * 0x20), 0xebe0 + (0x0b * 0x20), indexSF2Sprites_Stages, 0x34 },
    // { L"Unused",                                         0xebe0 + (0x0b * 0x20), 0xebe0 + (0x0c * 0x20) },
    { L"Foreground wall, lamp wall (darkest shade)",        0xebe0 + (0x0c * 0x20), 0xebe0 + (0x0d * 0x20), indexSF2Sprites_Stages, 0x35 },
        { L"Foreground wall, lamp wall (middle shade)",     0xebe0 + (0x0d * 0x20), 0xebe0 + (0x0e * 0x20), indexSF2Sprites_Stages, 0x35 },
        { L"Foreground wall, lamp wall (lightest shade)",   0xebe0 + (0x0e * 0x20), 0xebe0 + (0x0f * 0x20), indexSF2Sprites_Stages, 0x35 },
    { L"Foreground wall, footer + ground",                  0xebe0 + (0x0f * 0x20), 0xebe0 + (0x10 * 0x20), indexSF2Sprites_Stages, 0x36 },
        { L"????",                                          0xebe0 + (0x10 * 0x20), 0xebe0 + (0x11 * 0x20) },
        { L"????",                                          0xebe0 + (0x11 * 0x20), 0xebe0 + (0x12 * 0x20) },
    // { L"Unused",                                         0xebe0 + (0x12 * 0x20), 0xebe0 + (0x13 * 0x20) },
    // { L"Unused",                                         0xebe0 + (0x13 * 0x20), 0xebe0 + (0x14 * 0x20) },
    // { L"Unused",                                         0xebe0 + (0x14 * 0x20), 0xebe0 + (0x15 * 0x20) },
    // { L"Unused",                                         0xebe0 + (0x15 * 0x20), 0xebe0 + (0x16 * 0x20) },
    // { L"Unused",                                         0xebe0 + (0x16 * 0x20), 0xebe0 + (0x17 * 0x20) },
    { L"Background wall, archway lower part + people + red trimming on top of Foreground wall", 0xebe0 + (0x17 * 0x20), 0xebe0 + (0x18 * 0x20), indexSF2Sprites_Stages, 0x37 },
    { L"Background wall, archway upper part",               0xebe0 + (0x18 * 0x20), 0xebe0 + (0x19 * 0x20), indexSF2Sprites_Stages, 0x38 },
    { L"Background wall, torero & bull painting",           0xebe0 + (0x19 * 0x20), 0xebe0 + (0x1a * 0x20), indexSF2Sprites_Stages, 0x39 },
    { L"Unused, but in ram it will have the values of palettes 8, 9 & A (BG lamp wall)", 0xebe0 + (0x1a * 0x20), 0xebe0 + (0x1b * 0x20) },
    { L"Background wall, torero & bull painting (footer) + red trimming on top of Foreground wall + side wall pieces", 0xebe0 + (0x1b * 0x20), 0xebe0 + (0x1c * 0x20), indexSF2Sprites_Stages, 0x3a },
        { L"Unused, but in ram it will have the values of palettes 0 - 0x02, 1, 2, 3 & 4 (Wall sign)", 0xebe0 + (0x1c * 0x20), 0xebe0 + (0x1d * 0x20) },
        { L"Unused",                                        0xebe0 + (0x1d * 0x20), 0xebe0 + (0x1e * 0x20) },
        { L"Unused from CPS1",                              0xebe0 + (0x1e * 0x20), 0xebe0 + (0x1f * 0x20) },
    { L"Parallaxed ground",                                 0xebe0 + (0x1f * 0x20), 0xebe0 + (0x20 * 0x20), indexSF2Sprites_Stages, 0x3b },
    //{ L"Unused",                                          0xebe0 + (0x20 * 0x20), 0xebe0 + (0x21 * 0x20) },
    //{ L"Unused",                                          0xebe0 + (0x21 * 0x20), 0xebe0 + (0x22 * 0x20) },
    //{ L"Unused",                                          0xebe0 + (0x22 * 0x20), 0xebe0 + (0x23 * 0x20) },
    //{ L"Unused",                                          0xebe0 + (0x23 * 0x20), 0xebe0 + (0x24 * 0x20) },
    ...
    { L"Middle layer, neon footer + feet of dancers/guitar players, part 1",     0x17060 + (0x00 * 0x20), 0x17060 + (0x01 * 0x20), indexSF2Sprites_Stages, 0x3c },
        { L"Middle layer, neon footer + feet of dancers/guitar players, part 2", 0x17060 + (0x01 * 0x20), 0x17060 + (0x02 * 0x20), indexSF2Sprites_Stages, 0x3c },
        { L"Middle layer, neon footer + feet of dancers/guitar players, part 3", 0x17060 + (0x02 * 0x20), 0x17060 + (0x03 * 0x20), indexSF2Sprites_Stages, 0x3c },
    // { L"Unused",                                                 0x17060 + (0x03 * 0x20), 0x17060 + (0x04 * 0x20) },
    { L"Middle layer, people cheering on the table",                0x17060 + (0x04 * 0x20), 0x17060 + (0x05 * 0x20), indexSF2Sprites_Stages, 0x3d },
    { L"Middle layer, dancers",                                     0x17060 + (0x05 * 0x20), 0x17060 + (0x06 * 0x20), indexSF2Sprites_Stages, 0x3e },
    { L"Middle layer, guitar players",                              0x17060 + (0x06 * 0x20), 0x17060 + (0x07 * 0x20), indexSF2Sprites_Stages, 0x3f },
    // { L"Unused",                                                 0x17060 + (0x07 * 0x20), 0x17060 + (0x08 * 0x20) },
    // { L"Unused",                                                 0x17060 + (0x08 * 0x20), 0x17060 + (0x09 * 0x20) },
    { L"Middle layer, people cheering on the table",                0x17060 + (0x09 * 0x20), 0x17060 + (0x0a * 0x20), indexSF2Sprites_Stages, 0x40 },
    { L"Middle layer, people cheering on the table + pink waiter",  0x17060 + (0x0a * 0x20), 0x17060 + (0x0b * 0x20), indexSF2Sprites_Stages, 0x41 },
    { L"Middle layer, red waiter",                                  0x17060 + (0x0b * 0x20), 0x17060 + (0x0c * 0x20), indexSF2Sprites_Stages, 0x42 },

    { L"Cage + Brown wall on the sides",                    0x6be0, 0x6c00, indexSF2Sprites_Stages, 0x31 },
};
...
#ifdef NOT_PRESENT
    // "Barrel & Metal things" doesn't seem to be in the ROM given those colors
...
const sDescTreeNode HSF2_A_10_STAGES_COLLECTION[] =
{
    ...
    { L"Balrog's Casino (08 parts)",  DESC_NODETYPE_TREE, (void*)HSF2_A_BALROG_STAGE_NODE_10,    ARRAYSIZE(HSF2_A_BALROG_STAGE_NODE_10) },
...
const sDescTreeNode HSF2_A_UNITS_MONO[] =
{
    ...
    { L"Portraits: Guile",     DESC_NODETYPE_TREE, (void*)HSF2_A_GUILE_PORTRAIT_COLLECTION,    ARRAYSIZE(HSF2_A_GUILE_PORTRAIT_COLLECTION) },
    { L"Portraits: Ken",       DESC_NODETYPE_TREE, (void*)HSF2_A_KEN_PORTRAIT_COLLECTION,      ARRAYSIZE(HSF2_A_KEN_PORTRAIT_COLLECTION) },
    { L"Portraits: Chun-Li",   DESC_NODETYPE_TREE, (void*)HSF2_A_CHUNLI_PORTRAIT_COLLECTION,   ARRAYSIZE(HSF2_A_CHUNLI_PORTRAIT_COLLECTION) },
    { L"Portraits: Zangief",   DESC_NODETYPE_TREE, (void*)HSF2_A_ZANGIEF_PORTRAIT_COLLECTION,  ARRAYSIZE(HSF2_A_ZANGIEF_PORTRAIT_COLLECTION) },
    { L"Portraits: Dhalsim",   DESC_NODETYPE_TREE, (void*)HSF2_A_DHALSIM_PORTRAIT_COLLECTION,  ARRAYSIZE(HSF2_A_DHALSIM_PORTRAIT_COLLECTION) },
    { L"Portraits: M.Bison",   DESC_NODETYPE_TREE, (void*)HSF2_A_MBISON_PORTRAIT_COLLECTION,   ARRAYSIZE(HSF2_A_MBISON_PORTRAIT_COLLECTION) },
    { L"Portraits: Sagat",     DESC_NODETYPE_TREE, (void*)HSF2_A_SAGAT_PORTRAIT_COLLECTION,    ARRAYSIZE(HSF2_A_SAGAT_PORTRAIT_COLLECTION) },
    { L"Portraits: Balrog",    DESC_NODETYPE_TREE, (void*)HSF2_A_BALROG_PORTRAIT_COLLECTION,   ARRAYSIZE(HSF2_A_BALROG_PORTRAIT_COLLECTION) },
    { L"Portraits: Vega",      DESC_NODETYPE_TREE, (void*)HSF2_A_VEGA_PORTRAIT_COLLECTION,     ARRAYSIZE(HSF2_A_VEGA_PORTRAIT_COLLECTION) },
    { L"Portraits: Cammy",     DESC_NODETYPE_TREE, (void*)HSF2_A_CAMMY_PORTRAIT_COLLECTION,    ARRAYSIZE(HSF2_A_CAMMY_PORTRAIT_COLLECTION) },
