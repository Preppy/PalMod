...
const std::vector<sGameUnitsByFile> DAEMONBRIDE_NL_UNITS =
{
    ...
    //{ L"Flashrom\\Act\\Chara\\chara_19.pal",    2560, L"Pure Princess", DAEMONBRIDGE_NL_Pure_COLLECTION, ARRAYSIZE(DAEMONBRIDGE_NL_Pure_COLLECTION) },
    //{ L"Flashrom\\Act\\Chara\\chara_19b.pal",   2048, L"Pure Princess - Zadkiel", DAEMONBRIDGE_NL_PureZadkiel_COLLECTION, ARRAYSIZE(DAEMONBRIDGE_NL_PureZadkiel_COLLECTION) },
    //{ L"Flashrom\\Act\\Chara\\chara_19e.pal",   512,  L"Pure Princess - Effects", DAEMONBRIDGE_NL_PureEffects_COLLECTION, ARRAYSIZE(DAEMONBRIDGE_NL_PureEffects_COLLECTION) },
