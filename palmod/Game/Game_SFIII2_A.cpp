...
void CGame_SFIII2_A::PostSetPal(size_t nUnitId, size_t nPalId)
{
    CString strMessage;
    strMessage.Format(L"CGame_SFIII2_A::PostSetPal : Checking additional change requirements for unit %u palette %u.\n", nUnitId, nPalId);
