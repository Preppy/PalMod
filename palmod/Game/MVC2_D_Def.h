...
// This is sorted according to the CHARACTERS_CPS2::indexCPS2Sprites... enum values.
...
const std::array<uint8_t, MVC2_D_NUMUNIT_WITH_TEAMVIEW + 1> MVC2_D_UNITSORT = // plus one for terminal entry
{
    ...
    indexCPS2Sprites_Gambit,
    indexCPS2Sprites_Guile,
    indexCPS2Sprites_Hayato,
    indexCPS2Sprites_Hulk,
    indexCPS2Sprites_Iceman,
    indexCPS2Sprites_IronMan,
    indexCPS2Sprites_Jill,
    indexCPS2Sprites_Jin,
    indexCPS2Sprites_Juggy,
    indexCPS2Sprites_Ken,
    indexCPS2Sprites_Magneto,
    indexCPS2Sprites_Marrow,
    indexCPS2Sprites_Bison,
    indexCPS2Sprites_Megaman,
    indexCPS2Sprites_Morrigan,
    indexCPS2Sprites_OmegaRed,
    indexCPS2Sprites_Psylocke,
    indexCPS2Sprites_Rogue,
    indexCPS2Sprites_Roll,
    indexCPS2Sprites_Ruby,
    indexCPS2Sprites_Ryu,
    indexCPS2Sprites_Sabretooth,
    indexCPS2Sprites_Sakura,
    indexCPS2Sprites_Sentinel,
    indexCPS2Sprites_Kobun,
    indexCPS2Sprites_Shuma,
    indexCPS2Sprites_SilverSamurai,
    indexCPS2Sprites_SonSon,
    indexCPS2Sprites_Spidey,
    indexCPS2Sprites_Spiral,
    indexCPS2Sprites_Storm,
    indexCPS2Sprites_Strider,
    indexCPS2Sprites_Thanos,
    indexCPS2Sprites_Tron,
    indexCPS2Sprites_Venom,
    indexCPS2Sprites_WarMachine,
    indexCPS2Sprites_Wolverine,
    indexCPS2Sprites_Bonerine,
    indexCPS2Sprites_Zangief, // Zangief

    indexCPS2Sprites_Abyss1,
    indexCPS2Sprites_Abyss2,
    indexCPS2Sprites_Abyss3,
