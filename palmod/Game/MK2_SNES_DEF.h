...
const sDescTreeNode MK2_SNES_KINTARO_COLLECTION[] =
{
    { L"Palettes", DESC_NODETYPE_TREE, (void*)MK2_SNES_KINTARO_PALETTES, ARRAYSIZE(MK2_SNES_KINTARO_PALETTES) },
};
...
const sDescTreeNode MK2_SNES_UNITS[] =
{
    ...
    { L"Kintaro", DESC_NODETYPE_TREE, (void*)MK2_SNES_KINTARO_COLLECTION, ARRAYSIZE(MK2_SNES_KINTARO_COLLECTION) },
