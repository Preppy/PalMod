...
{
    { "Portraits",	 DESC_NODETYPE_TREE, (void*)SSF2T_A_PORTRAITS_NODES,         ARRAYSIZE(SSF2T_A_PORTRAITS_NODES) },
};

const sDescTreeNode SSF2T_A_UNITS_3C[SSF2T_A_NUM_IND_3C] =
{
    { "Portraits",   DESC_NODETYPE_TREE, (void*)SSF2T_A_PORTRAITS_COLLECTION,    ARRAYSIZE(SSF2T_A_PORTRAITS_COLLECTION) },
};
