...
const sGame_PaletteDataset SSF2T_A_PORTRAITS_NODES[] =
{
    ...
    { "Guile Portrait P2",    0x037bfe, 0x037c7e, 0x03, 0x10 },
    { "Ken Portrait P2",      0x0380fe, 0x03817e, 0x04, 0x10 },
    { "Chun-Li Portrait P2",  0x0385fe, 0x03867e, 0x05, 0x10 },
    { "Zangief Portrait P2",  0x038afe, 0x038b7e, 0x06, 0x10 },
    { "Dhalsim Portrait P2",  0x038ffe, 0x03907e, 0x07, 0x10 },
    { "M. Bison Portrait P2", 0x0394fe, 0x03957e, 0x08, 0x10 },
    { "Sagat Portrait P2",    0x0399fe, 0x039a7e, 0x09, 0x10 },
    { "Balrog Portrait P2",   0x039efe, 0x039f7e, 0x0A, 0x10 },
    { "Vega Portrait P2",     0x03a3fe, 0x03a47e, 0x0B, 0x10 },
    { "Cammy Portrait P2",    0x03a8fe, 0x03a97e, 0x0C, 0x10 },
