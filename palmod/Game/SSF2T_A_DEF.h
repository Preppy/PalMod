...
{
    { "Jab",        0x03FB2E, 0x03FB4E, 0x0},
    { "Strong",     0x03FBD0, 0x03FBF0, 0x0},
    { "Fierce",     0x03FC72, 0x03FC92, 0x0},
    { "Short",      0x03FD14, 0x03FD34, 0x0},
    { "Forward",    0x03FDB6, 0x03FDD6, 0x0},
    { "Roundhouse", 0x03FE58, 0x03FE78, 0x0},
    { "Start",      0x03FEFA, 0x03FF1A, 0x0},
    { "Hold",       0x03FF9C, 0x03FFBC, 0x0},
    { "Old 1P",     0x04003E, 0x04005E, 0x0},
    { "Old 2P",     0x0400E0, 0x040100, 0x0},
};
...
const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR0[] =
{
    { "Jab",        0x040E62, 0x040E82, 0x03},
    { "Jab Sonic Boom", 0x040e82, 0x040ea2 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR1[] =
{
    { "Strong",        0x040F04, 0x040F24, 0x03},
    { "Strong Sonic Boom", 0x040f24, 0x040f44 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR2[] =
{
    { "Fierce",        0x040FA6, 0x040FC6, 0x03},
    { "Fierce Sonic Boom", 0x040fc6, 0x040fe6 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR3[] =
{
    { "Short",        0x041048, 0x041068, 0x03},
    { "Short Sonic Boom", 0x041068, 0x041088 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR4[] =
{
    { "Forward",        0x0410EA, 0x04110A, 0x03},
    { "Forward Sonic Boom", 0x04110a, 0x04112a },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR5[] =
{
    { "Roundhouse",        0x04118C, 0x0411AC, 0x03},
    { "Roundhouse Sonic Boom", 0x0411ac, 0x0411cc },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR6[] =
{
    { "Start",        0x04122E, 0x04124E, 0x03},
    { "Start Sonic Boom", 0x04124e, 0x04126e },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR7[] =
{
    { "Hold",         0x0412D0, 0x0412F0, 0x03},
    { "Hold Sonic Boom", 0x0412f0, 0x041310 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR8[] =
{
    { "Old 1P",       0x041372, 0x041392, 0x03},
    { "Old 1P Sonic Boom", 0x041392, 0x0413b2 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PALETTES_COLOR9[] =
{
    { "Old 2P",       0x041414, 0x041434, 0x03},
    { "Old 2P Sonic Boom", 0x041434, 0x041454 },
};
...
const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR0[] =
{
    { "Jab",          0x041B3A, 0x041B5A, 0x05},
    { "Jab Kikouken", 0x041b5a, 0x041b7a },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR1[] =
{
    { "Strong",     0x041BDC, 0x041BFC, 0x05},
    { "Strong Kikouken", 0x041bfc, 0x041c1c },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR2[] =
{
    { "Fierce",     0x041C7E, 0x041C9E, 0x05},
    { "Fierce Kikouken", 0x041c9e, 0x041cbe },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR3[] =
{
    { "Short",      0x041D20, 0x041D40, 0x05},
    { "Short Kikouken", 0x041d40, 0x041d60 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR4[] =
{
    { "Forward",    0x041DC2, 0x041DE2, 0x05},
    { "Forward Kikouken", 0x041de2, 0x041e02 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR5[] =
{
    { "Roundhouse", 0x041E64, 0x041E84, 0x05},
    { "Roundhouse Kikouken", 0x041e84, 0x041ea4 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR6[] =
{
    { "Start",      0x041F06, 0x041F26, 0x05},
    { "Start Kikouken", 0x041f26, 0x041f46 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR7[] =
{
    { "Hold",       0x041FA8, 0x041FC8, 0x05},
    { "Hold Kikouken", 0x041fc8, 0x041fe8 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR8[] =
{
    { "Old 1P",     0x04204A, 0x04206A, 0x05},
    { "Old 1P Kikouken", 0x04206a, 0x04208a },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PALETTES_COLOR9[] =
{
    { "Old 2P",     0x0420EC, 0x04210C, 0x05},
    { "Old 2P Kikouken", 0x04210c, 0x04212c },
};
...
const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR0[] =
{
    { "Jab",        0x045B72, 0x045B92, 0x0F},
    { "Jab Air Slasher", 0x045b92, 0x045bb2 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR1[] =
{
    { "Strong",     0x045C14, 0x045C34, 0x0F},
    { "Strong Air Slasher", 0x045c34, 0x045c54 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR2[] =
{
    { "Fierce",     0x045CB6, 0x045CD6, 0x0F},
    { "Fierce Air Slasher", 0x045cd6, 0x045cf6 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR3[] =
{
    { "Short",      0x045D58, 0x045D78, 0x0F},
    { "Short Air Slasher", 0x045d78, 0x045d98 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR4[] =
{
    { "Forward",    0x045DFA, 0x045E1A, 0x0F},
    { "Forward Air Slasher", 0x045e1a, 0x045e3a },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR5[] =
{
    { "Roundhouse", 0x045E9C, 0x045EBC, 0x0F},
    { "Roundhouse Air Slasher", 0x045ebc, 0x045edc },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR6[] =
{
    { "Start",      0x045F3E, 0x045F5E, 0x0F},
    { "Start Air Slasher", 0x045f5e, 0x045f7e },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR7[] =
{
    { "Hold",       0x045FE0, 0x046000, 0x0F},
    { "Hold Air Slasher", 0x046000, 0x046020 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR8[] =
{
    { "Old 1P",     0x046082, 0x0460A2, 0x0F},
    { "Old 1P Air Slasher", 0x0460a2, 0x0460c2 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PALETTES_COLOR9[] =
{
    { "Old 2P",     0x046124, 0x046144, 0x0F},
    { "Old 2P Air Slasher", 0x046144, 0x046164 },
};
...
// THESE ARE IN sfxe.03c AND ARE CURRENTLY UNUSED.
const sGame_PaletteDataset SSF2T_A_PORTRAITS_NODES[] =
{
    { "Ryu Portrait P1", 0x031c48, 0x031cc8 },
    { "E. Honda Portrait P1", 0x032148, 0x0321c8 },
    { "Blanka Portrait P1", 0x032648, 0x0326c8 },
    { "Guile Portrait P1", 0x032b48, 0x032bc8 },
    { "Ken Portrait P1", 0x033048, 0x0330c8 },
    { "Chun-Li Portrait P1", 0x033548, 0x0335c8 },
    { "Zangief Portrait P1", 0x033a48, 0x033ac8 },
    { "Dhalsim Portrait P1", 0x033f48, 0x033fc8 },
    { "M. Bison Portrait P1", 0x034448, 0x0344c8 },
    { "Sagat Portrait P1", 0x034948, 0x0349c8 },
    { "Balrog Portrait P1", 0x034e48, 0x034ec8 },
    { "Vega Portrait P1", 0x035348, 0x0353c8 },
    { "Cammy Portrait P1", 0x035848, 0x0358c8 },
    { "T-Hawk Portrait P1", 0x035d48, 0x035dc8 },
    { "Fei Long Portrait P1", 0x036248, 0x0362c8 },
    { "Dee Jay Portrait P1", 0x036748, 0x0367c8 },

    { "Ryu Portrait P2", 0x036cfe, 0x036d7e },
    { "E. Honda Portrait P2", 0x0371fe, 0x03727e },
    { "Blanka Portrait P2", 0x0376fe, 0x03777e },
    { "Guile Portrait P2", 0x037bfe, 0x037c7e },
    { "Ken Portrait P2", 0x0380fe, 0x03817e },
    { "Chun-Li Portrait P2", 0x0385fe, 0x03867e },
    { "Zangief Portrait P2", 0x038afe, 0x038b7e },
    { "Dhalsim Portrait P2", 0x038ffe, 0x03907e },
    { "M. Bison Portrait P2", 0x0394fe, 0x03957e },
    { "Sagat Portrait P2", 0x0399fe, 0x039a7e },
    { "Balrog Portrait P2", 0x039efe, 0x039f7e },
    { "Vega Portrait P2", 0x03a3fe, 0x03a47e },
    { "Cammy Portrait P2", 0x03a8fe, 0x03a97e },
    { "T-Hawk Portrait P2", 0x03adfe, 0x03ae7e },
    { "Fei Long Portrait P2", 0x03b2fe, 0x03b37e },
    { "Dee Jay Portrait P2", 0x03b7fe, 0x03b87e },
};
...
{
    { "Jab",        DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR0,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR0) },
    { "Strong",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR1,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR1) },
    { "Fierce",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR2,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR2) },
    { "Short",      DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR3,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR3) },
    { "Forward",    DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR4,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR4) },
    { "Roundhouse", DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR5,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR5) },
    { "Start",      DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR6,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR6) },
    { "Hold",       DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR7,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR7) },
    { "Old 1P",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR8,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR8) },
    { "Old 2P",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_GUILE_PALETTES_COLOR9,        ARRAYSIZE(SSF2T_A_GUILE_PALETTES_COLOR9) },
};
...
{
    { "Jab",        DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR0,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR0) },
    { "Strong",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR1,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR1) },
    { "Fierce",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR2,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR2) },
    { "Short",      DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR3,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR3) },
    { "Forward",    DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR4,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR4) },
    { "Roundhouse", DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR5,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR5) },
    { "Start",      DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR6,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR6) },
    { "Hold",       DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR7,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR7) },
    { "Old 1P",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR8,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR8) },
    { "Old 2P",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_CHUNLI_PALETTES_COLOR9,        ARRAYSIZE(SSF2T_A_CHUNLI_PALETTES_COLOR9) },
};
...
{
    { "Jab",        DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR0,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR0) },
    { "Strong",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR1,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR1) },
    { "Fierce",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR2,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR2) },
    { "Short",      DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR3,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR3) },
    { "Forward",    DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR4,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR4) },
    { "Roundhouse", DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR5,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR5) },
    { "Start",      DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR6,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR6) },
    { "Hold",       DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR7,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR7) },
    { "Old 1P",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR8,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR8) },
    { "Old 2P",     DESC_NODETYPE_TREE,    (void*)SSF2T_A_DEEJAY_PALETTES_COLOR9,        ARRAYSIZE(SSF2T_A_DEEJAY_PALETTES_COLOR9) },
};
