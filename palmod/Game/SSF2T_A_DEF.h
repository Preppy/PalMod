...
{
    { L"Ryu Portrait - Jab 1/2", 0x31c48, 0x31cc8, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Jab 2/2", 0x36cfe, 0x36d7e, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_STRONG[] =
{
    { L"Ryu Portrait - Strong 1/2", 0x31cc8, 0x31d48, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Strong 2/2", 0x36d7e, 0x36dfe, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_FIERCE[] =
{
    { L"Ryu Portrait - Fierce 1/2", 0x31d48, 0x31dc8, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Fierce 2/2", 0x36dfe, 0x36e7e, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_SHORT[] =
{
    { L"Ryu Portrait - Short 1/2", 0x31dc8, 0x31e48, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Short 2/2", 0x36e7e, 0x36efe, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_FORWARD[] =
{
    { L"Ryu Portrait - Forward 1/2", 0x31e48, 0x31ec8, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Forward 2/2", 0x36efe, 0x36f7e, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Ryu Portrait - RH 1/2", 0x31ec8, 0x31f48, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - RH 2/2", 0x36f7e, 0x36ffe, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_START[] =
{
    { L"Ryu Portrait - Start 1/2", 0x31f48, 0x31fc8, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Start 2/2", 0x36ffe, 0x3707e, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_HOLD[] =
{
    { L"Ryu Portrait - Hold 1/2", 0x31fc8, 0x32048, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Hold 2/2", 0x3707e, 0x370fe, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_OLD1P[] =
{
    { L"Ryu Portrait - Old 1P 1/2", 0x32048, 0x320c8, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Old 1P 2/2", 0x370fe, 0x3717e, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_RYU_PORTRAITS_OLD2P[] =
{
    { L"Ryu Portrait - Old 2P 1/2", 0x320c8, 0x32148, indexSF2Sprites_Ryu, 0x10, &pairNext },
    { L"Ryu Portrait - Old 2P 2/2", 0x3717e, 0x371fe, indexSF2Sprites_Ryu, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_JAB[] =
{
    { L"E. Honda Portrait - Jab 1/2", 0x32148, 0x321c8, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Jab 2/2", 0x371fe, 0x3727e, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_STRONG[] =
{
    { L"E. Honda Portrait - Strong 1/2", 0x321c8, 0x32248, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Strong 2/2", 0x3727e, 0x372fe, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_FIERCE[] =
{
    { L"E. Honda Portrait - Fierce 1/2", 0x32248, 0x322c8, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Fierce 2/2", 0x372fe, 0x3737e, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_SHORT[] =
{
    { L"E. Honda Portrait - Short 1/2", 0x322c8, 0x32348, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Short 2/2", 0x3737e, 0x373fe, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_FORWARD[] =
{
    { L"E. Honda Portrait - Forward 1/2", 0x32348, 0x323c8, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Forward 2/2", 0x373fe, 0x3747e, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_ROUNDHOUSE[] =
{
    { L"E. Honda Portrait - RH 1/2", 0x323c8, 0x32448, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - RH 2/2", 0x3747e, 0x374fe, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_START[] =
{
    { L"E. Honda Portrait - Start 1/2", 0x32448, 0x324c8, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Start 2/2", 0x374fe, 0x3757e, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_HOLD[] =
{
    { L"E. Honda Portrait - Hold 1/2", 0x324c8, 0x32548, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Hold 2/2", 0x3757e, 0x375fe, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_OLD1P[] =
{
    { L"E. Honda Portrait - Old 1P 1/2", 0x32548, 0x325c8, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Old 1P 2/2", 0x375fe, 0x3767e, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_EHONDA_PORTRAITS_OLD2P[] =
{
    { L"E. Honda Portrait - Old 2P 1/2", 0x325c8, 0x32648, indexSF2Sprites_EHonda, 0x10, &pairNext },
    { L"E. Honda Portrait - Old 2P 2/2", 0x3767e, 0x376fe, indexSF2Sprites_EHonda, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_JAB[] =
{
    { L"Blanka Portrait - Jab 1/2", 0x32648, 0x326c8, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Jab 2/2", 0x376fe, 0x3777e, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_STRONG[] =
{
    { L"Blanka Portrait - Strong 1/2", 0x326c8, 0x32748, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Strong 2/2", 0x3777e, 0x377fe, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_FIERCE[] =
{
    { L"Blanka Portrait - Fierce 1/2", 0x32748, 0x327c8, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Fierce 2/2", 0x377fe, 0x3787e, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_SHORT[] =
{
    { L"Blanka Portrait - Short 1/2", 0x327c8, 0x32848, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Short 2/2", 0x3787e, 0x378fe, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_FORWARD[] =
{
    { L"Blanka Portrait - Forward 1/2", 0x32848, 0x328c8, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Forward 2/2", 0x378fe, 0x3797e, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Blanka Portrait - RH 1/2", 0x328c8, 0x32948, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - RH 2/2", 0x3797e, 0x379fe, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_START[] =
{
    { L"Blanka Portrait - Start 1/2", 0x32948, 0x329c8, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Start 2/2", 0x379fe, 0x37a7e, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_HOLD[] =
{
    { L"Blanka Portrait - Hold 1/2", 0x329c8, 0x32a48, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Hold 2/2", 0x37a7e, 0x37afe, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_OLD1P[] =
{
    { L"Blanka Portrait - Old 1P 1/2", 0x32a48, 0x32ac8, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Old 1P 2/2", 0x37afe, 0x37b7e, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BLANKA_PORTRAITS_OLD2P[] =
{
    { L"Blanka Portrait - Old 2P 1/2", 0x32ac8, 0x32b48, indexSF2Sprites_Blanka, 0x10, &pairNext },
    { L"Blanka Portrait - Old 2P 2/2", 0x37b7e, 0x37bfe, indexSF2Sprites_Blanka, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_JAB[] =
{
    { L"Guile Portrait - Jab 1/2", 0x32b48, 0x32bc8, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Jab 2/2", 0x37bfe, 0x37c7e, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_STRONG[] =
{
    { L"Guile Portrait - Strong 1/2", 0x32bc8, 0x32c48, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Strong 2/2", 0x37c7e, 0x37cfe, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_FIERCE[] =
{
    { L"Guile Portrait - Fierce 1/2", 0x32c48, 0x32cc8, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Fierce 2/2", 0x37cfe, 0x37d7e, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_SHORT[] =
{
    { L"Guile Portrait - Short 1/2", 0x32cc8, 0x32d48, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Short 2/2", 0x37d7e, 0x37dfe, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_FORWARD[] =
{
    { L"Guile Portrait - Forward 1/2", 0x32d48, 0x32dc8, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Forward 2/2", 0x37dfe, 0x37e7e, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Guile Portrait - RH 1/2", 0x32dc8, 0x32e48, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - RH 2/2", 0x37e7e, 0x37efe, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_START[] =
{
    { L"Guile Portrait - Start 1/2", 0x32e48, 0x32ec8, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Start 2/2", 0x37efe, 0x37f7e, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_HOLD[] =
{
    { L"Guile Portrait - Hold 1/2", 0x32ec8, 0x32f48, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Hold 2/2", 0x37f7e, 0x37ffe, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_OLD1P[] =
{
    { L"Guile Portrait - Old 1P 1/2", 0x32f48, 0x32fc8, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Old 1P 2/2", 0x37ffe, 0x3807e, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_GUILE_PORTRAITS_OLD2P[] =
{
    { L"Guile Portrait - Old 2P 1/2", 0x32fc8, 0x33048, indexSF2Sprites_Guile, 0x10, &pairNext },
    { L"Guile Portrait - Old 2P 2/2", 0x3807e, 0x380fe, indexSF2Sprites_Guile, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_JAB[] =
{
    { L"Ken Portrait - Jab 1/2", 0x33048, 0x330c8, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Jab 2/2", 0x380fe, 0x3817e, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_STRONG[] =
{
    { L"Ken Portrait - Strong 1/2", 0x330c8, 0x33148, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Strong 2/2", 0x3817e, 0x381fe, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_FIERCE[] =
{
    { L"Ken Portrait - Fierce 1/2", 0x33148, 0x331c8, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Fierce 2/2", 0x381fe, 0x3827e, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_SHORT[] =
{
    { L"Ken Portrait - Short 1/2", 0x331c8, 0x33248, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Short 2/2", 0x3827e, 0x382fe, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_FORWARD[] =
{
    { L"Ken Portrait - Forward 1/2", 0x33248, 0x332c8, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Forward 2/2", 0x382fe, 0x3837e, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Ken Portrait - RH 1/2", 0x332c8, 0x33348, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - RH 2/2", 0x3837e, 0x383fe, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_START[] =
{
    { L"Ken Portrait - Start 1/2", 0x33348, 0x333c8, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Start 2/2", 0x383fe, 0x3847e, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_HOLD[] =
{
    { L"Ken Portrait - Hold 1/2", 0x333c8, 0x33448, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Hold 2/2", 0x3847e, 0x384fe, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_OLD1P[] =
{
    { L"Ken Portrait - Old 1P 1/2", 0x33448, 0x334c8, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Old 1P 2/2", 0x384fe, 0x3857e, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_KEN_PORTRAITS_OLD2P[] =
{
    { L"Ken Portrait - Old 2P 1/2", 0x334c8, 0x33548, indexSF2Sprites_Ken, 0x10, &pairNext },
    { L"Ken Portrait - Old 2P 2/2", 0x3857e, 0x385fe, indexSF2Sprites_Ken, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_JAB[] =
{
    { L"Chun-Li Portrait - Jab 1/2", 0x33548, 0x335c8, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Jab 2/2", 0x385fe, 0x3867e, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_STRONG[] =
{
    { L"Chun-Li Portrait - Strong 1/2", 0x335c8, 0x33648, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Strong 2/2", 0x3867e, 0x386fe, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_FIERCE[] =
{
    { L"Chun-Li Portrait - Fierce 1/2", 0x33648, 0x336c8, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Fierce 2/2", 0x386fe, 0x3877e, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_SHORT[] =
{
    { L"Chun-Li Portrait - Short 1/2", 0x336c8, 0x33748, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Short 2/2", 0x3877e, 0x387fe, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_FORWARD[] =
{
    { L"Chun-Li Portrait - Forward 1/2", 0x33748, 0x337c8, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Forward 2/2", 0x387fe, 0x3887e, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Chun-Li Portrait - RH 1/2", 0x337c8, 0x33848, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - RH 2/2", 0x3887e, 0x388fe, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_START[] =
{
    { L"Chun-Li Portrait - Start 1/2", 0x33848, 0x338c8, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Start 2/2", 0x388fe, 0x3897e, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_HOLD[] =
{
    { L"Chun-Li Portrait - Hold 1/2", 0x338c8, 0x33948, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Hold 2/2", 0x3897e, 0x389fe, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_OLD1P[] =
{
    { L"Chun-Li Portrait - Old 1P 1/2", 0x33948, 0x339c8, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Old 1P 2/2", 0x389fe, 0x38a7e, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CHUNLI_PORTRAITS_OLD2P[] =
{
    { L"Chun-Li Portrait - Old 2P 1/2", 0x339c8, 0x33a48, indexSF2Sprites_ChunLi, 0x10, &pairNext },
    { L"Chun Li Portrait - Old 2P 2/2", 0x38a7e, 0x38afe, indexSF2Sprites_ChunLi, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_JAB[] =
{
    { L"Zangief Portrait - Jab 1/2", 0x33a48, 0x33ac8, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Jab 2/2", 0x38afe, 0x38b7e, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_STRONG[] =
{
    { L"Zangief Portrait - Strong 1/2", 0x33ac8, 0x33b48, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Strong 2/2", 0x38b7e, 0x38bfe, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_FIERCE[] =
{
    { L"Zangief Portrait - Fierce 1/2", 0x33b48, 0x33bc8, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Fierce 2/2", 0x38bfe, 0x38c7e, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_SHORT[] =
{
    { L"Zangief Portrait - Short 1/2", 0x33bc8, 0x33c48, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Short 2/2", 0x38c7e, 0x38cfe, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_FORWARD[] =
{
    { L"Zangief Portrait - Forward 1/2", 0x33c48, 0x33cc8, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Forward 2/2", 0x38cfe, 0x38d7e, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Zangief Portrait - RH 1/2", 0x33cc8, 0x33d48, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - RH 2/2", 0x38d7e, 0x38dfe, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_START[] =
{
    { L"Zangief Portrait - Start 1/2", 0x33d48, 0x33dc8, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Start 2/2", 0x38dfe, 0x38e7e, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_HOLD[] =
{
    { L"Zangief Portrait - Hold 1/2", 0x33dc8, 0x33e48, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Hold 2/2", 0x38e7e, 0x38efe, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_OLD1P[] =
{
    { L"Zangief Portrait - Old 1P 1/2", 0x33e48, 0x33ec8, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Old 1P 2/2", 0x38efe, 0x38f7e, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_ZANGIEF_PORTRAITS_OLD2P[] =
{
    { L"Zangief Portrait - Old 2P 1/2", 0x33ec8, 0x33f48, indexSF2Sprites_Zangief, 0x10, &pairNext },
    { L"Zangief Portrait - Old 2P 2/2", 0x38f7e, 0x38ffe, indexSF2Sprites_Zangief, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_JAB[] =
{
    { L"Dhalsim Portrait - Jab 1/2", 0x33f48, 0x33fc8, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Jab 2/2", 0x38ffe, 0x3907e, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_STRONG[] =
{
    { L"Dhalsim Portrait - Strong 1/2", 0x33fc8, 0x34048, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Strong 2/2", 0x3907e, 0x390fe, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_FIERCE[] =
{
    { L"Dhalsim Portrait - Fierce 1/2", 0x34048, 0x340c8, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Fierce 2/2", 0x390fe, 0x3917e, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_SHORT[] =
{
    { L"Dhalsim Portrait - Short 1/2", 0x340c8, 0x34148, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Short 2/2", 0x3917e, 0x391fe, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_FORWARD[] =
{
    { L"Dhalsim Portrait - Forward 1/2", 0x34148, 0x341c8, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Forward 2/2", 0x391fe, 0x3927e, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Dhalsim Portrait - RH 1/2", 0x341c8, 0x34248, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - RH 2/2", 0x3927e, 0x392fe, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_START[] =
{
    { L"Dhalsim Portrait - Start 1/2", 0x34248, 0x342c8, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Start 2/2", 0x392fe, 0x3937e, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_HOLD[] =
{
    { L"Dhalsim Portrait - Hold 1/2", 0x342c8, 0x34348, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Hold 2/2", 0x3937e, 0x393fe, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_OLD1P[] =
{
    { L"Dhalsim Portrait - Old 1P 1/2", 0x34348, 0x343c8, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Old 1P 2/2", 0x393fe, 0x3947e, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DHALSIM_PORTRAITS_OLD2P[] =
{
    { L"Dhalsim Portrait - Old 2P 1/2", 0x343c8, 0x34448, indexSF2Sprites_Dhalsim, 0x10, &pairNext },
    { L"Dhalsim Portrait - Old 2P 2/2", 0x3947e, 0x394fe, indexSF2Sprites_Dhalsim, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_JAB[] =
{
    { L"M. Bison Portrait - Jab 1/2", 0x34448, 0x344c8, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Jab 2/2", 0x394fe, 0x3957e, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_STRONG[] =
{
    { L"M. Bison Portrait - Strong 1/2", 0x344c8, 0x34548, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Strong 2/2", 0x3957e, 0x395fe, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_FIERCE[] =
{
    { L"M. Bison Portrait - Fierce 1/2", 0x34548, 0x345c8, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Fierce 2/2", 0x395fe, 0x3967e, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_SHORT[] =
{
    { L"M. Bison Portrait - Short 1/2", 0x345c8, 0x34648, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Short 2/2", 0x3967e, 0x396fe, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_FORWARD[] =
{
    { L"M. Bison Portrait - Forward 1/2", 0x34648, 0x346c8, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Forward 2/2", 0x396fe, 0x3977e, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_ROUNDHOUSE[] =
{
    { L"M. Bison Portrait - RH 1/2", 0x346c8, 0x34748, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - RH 2/2", 0x3977e, 0x397fe, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_START[] =
{
    { L"M. Bison Portrait - Start 1/2", 0x34748, 0x347c8, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Start 2/2", 0x397fe, 0x3987e, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_HOLD[] =
{
    { L"M. Bison Portrait - Hold 1/2", 0x347c8, 0x34848, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Hold 2/2", 0x3987e, 0x398fe, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_OLD1P[] =
{
    { L"M. Bison Portrait - Old 1P 1/2", 0x34848, 0x348c8, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Old 1P 2/2", 0x398fe, 0x3997e, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_MBISON_PORTRAITS_OLD2P[] =
{
    { L"M. Bison Portrait - Old 2P 1/2", 0x348c8, 0x34948, indexSF2Sprites_Bison, 0x10, &pairNext },
    { L"M. Bison Portrait - Old 2P 2/2", 0x3997e, 0x399fe, indexSF2Sprites_Bison, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_JAB[] =
{
    { L"Sagat Portrait - Jab 1/2", 0x34948, 0x349c8, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Jab 2/2", 0x399fe, 0x39a7e, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_STRONG[] =
{
    { L"Sagat Portrait - Strong 1/2", 0x349c8, 0x34a48, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Strong 2/2", 0x39a7e, 0x39afe, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_FIERCE[] =
{
    { L"Sagat Portrait - Fierce 1/2", 0x34a48, 0x34ac8, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Fierce 2/2", 0x39afe, 0x39b7e, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_SHORT[] =
{
    { L"Sagat Portrait - Short 1/2", 0x34ac8, 0x34b48, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Short 2/2", 0x39b7e, 0x39bfe, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_FORWARD[] =
{
    { L"Sagat Portrait - Forward 1/2", 0x34b48, 0x34bc8, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Forward 2/2", 0x39bfe, 0x39c7e, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Sagat Portrait - RH 1/2", 0x34bc8, 0x34c48, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - RH 2/2", 0x39c7e, 0x39cfe, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_START[] =
{
    { L"Sagat Portrait - Start 1/2", 0x34c48, 0x34cc8, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Start 2/2", 0x39cfe, 0x39d7e, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_HOLD[] =
{
    { L"Sagat Portrait - Hold 1/2", 0x34cc8, 0x34d48, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Hold 2/2", 0x39d7e, 0x39dfe, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_OLD1P[] =
{
    { L"Sagat Portrait - Old 1P 1/2", 0x34d48, 0x34dc8, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Old 1P 2/2", 0x39dfe, 0x39e7e, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_SAGAT_PORTRAITS_OLD2P[] =
{
    { L"Sagat Portrait - Old 2P 1/2", 0x34dc8, 0x34e48, indexSF2Sprites_Sagat, 0x10, &pairNext },
    { L"Sagat Portrait - Old 2P 2/2", 0x39e7e, 0x39efe, indexSF2Sprites_Sagat, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_JAB[] =
{
    { L"Balrog Portrait - Jab 1/2", 0x34e48, 0x34ec8, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Jab 2/2", 0x39efe, 0x39f7e, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_STRONG[] =
{
    { L"Balrog Portrait - Strong 1/2", 0x34ec8, 0x34f48, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Strong 2/2", 0x39f7e, 0x39ffe, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_FIERCE[] =
{
    { L"Balrog Portrait - Fierce 1/2", 0x34f48, 0x34fc8, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Fierce 2/2", 0x39ffe, 0x3a07e, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_SHORT[] =
{
    { L"Balrog Portrait - Short 1/2", 0x34fc8, 0x35048, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Short 2/2", 0x3a07e, 0x3a0fe, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_FORWARD[] =
{
    { L"Balrog Portrait - Forward 1/2", 0x35048, 0x350c8, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Forward 2/2", 0x3a0fe, 0x3a17e, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Balrog Portrait - RH 1/2", 0x350c8, 0x35148, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - RH 2/2", 0x3a17e, 0x3a1fe, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_START[] =
{
    { L"Balrog Portrait - Start 1/2", 0x35148, 0x351c8, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Start 2/2", 0x3a1fe, 0x3a27e, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_HOLD[] =
{
    { L"Balrog Portrait - Hold 1/2", 0x351c8, 0x35248, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Hold 2/2", 0x3a27e, 0x3a2fe, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_OLD1P[] =
{
    { L"Balrog Portrait - Old 1P 1/2", 0x35248, 0x352c8, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Old 1P 2/2", 0x3a2fe, 0x3a37e, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_BALROG_PORTRAITS_OLD2P[] =
{
    { L"Balrog Portrait - Old 2P 1/2", 0x352c8, 0x35348, indexSF2Sprites_Balrog, 0x10, &pairNext },
    { L"Balrog Portrait - Old 2P 2/2", 0x3a37e, 0x3a3fe, indexSF2Sprites_Balrog, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_JAB[] =
{
    { L"Vega Portrait - Jab 1/2", 0x35348, 0x353c8, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Jab 2/2", 0x3a3fe, 0x3a47e, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_STRONG[] =
{
    { L"Vega Portrait - Strong 1/2", 0x353c8, 0x35448, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Strong 2/2", 0x3a47e, 0x3a4fe, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_FIERCE[] =
{
    { L"Vega Portrait - Fierce 1/2", 0x35448, 0x354c8, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Fierce 2/2", 0x3a4fe, 0x3a57e, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_SHORT[] =
{
    { L"Vega Portrait - Short 1/2", 0x354c8, 0x35548, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Short 2/2", 0x3a57e, 0x3a5fe, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_FORWARD[] =
{
    { L"Vega Portrait - Forward 1/2", 0x35548, 0x355c8, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Forward 2/2", 0x3a5fe, 0x3a67e, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Vega Portrait - RH 1/2", 0x355c8, 0x35648, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - RH 2/2", 0x3a67e, 0x3a6fe, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_START[] =
{
    { L"Vega Portrait - Start 1/2", 0x35648, 0x356c8, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Start 2/2", 0x3a6fe, 0x3a77e, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_HOLD[] =
{
    { L"Vega Portrait - Hold 1/2", 0x356c8, 0x35748, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Hold 2/2", 0x3a77e, 0x3a7fe, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_OLD1P[] =
{
    { L"Vega Portrait - Old 1P 1/2", 0x35748, 0x357c8, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Old 1P 2/2", 0x3a7fe, 0x3a87e, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_VEGA_PORTRAITS_OLD2P[] =
{
    { L"Vega Portrait - Old 2P 1/2", 0x357c8, 0x35848, indexSF2Sprites_Vega, 0x10, &pairNext },
    { L"Vega Portrait - Old 2P 2/2", 0x3a87e, 0x3a8fe, indexSF2Sprites_Vega, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_JAB[] =
{
    { L"Cammy Portrait - Jab 1/2", 0x35848, 0x358c8, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Jab 2/2", 0x3a8fe, 0x3a97e, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_STRONG[] =
{
    { L"Cammy Portrait - Strong 1/2", 0x358c8, 0x35948, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Strong 2/2", 0x3a97e, 0x3a9fe, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_FIERCE[] =
{
    { L"Cammy Portrait - Fierce 1/2", 0x35948, 0x359c8, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Fierce 2/2", 0x3a9fe, 0x3aa7e, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_SHORT[] =
{
    { L"Cammy Portrait - Short 1/2", 0x359c8, 0x35a48, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Short 2/2", 0x3aa7e, 0x3aafe, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_FORWARD[] =
{
    { L"Cammy Portrait - Forward 1/2", 0x35a48, 0x35ac8, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Forward 2/2", 0x3aafe, 0x3ab7e, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Cammy Portrait - RH 1/2", 0x35ac8, 0x35b48, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - RH 2/2", 0x3ab7e, 0x3abfe, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_START[] =
{
    { L"Cammy Portrait - Start 1/2", 0x35b48, 0x35bc8, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Start 2/2", 0x3abfe, 0x3ac7e, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_HOLD[] =
{
    { L"Cammy Portrait - Hold 1/2", 0x35bc8, 0x35c48, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Hold 2/2", 0x3ac7e, 0x3acfe, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_OLD1P[] =
{
    { L"Cammy Portrait - Old 1P 1/2", 0x35c48, 0x35cc8, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Old 1P 2/2", 0x3acfe, 0x3ad7e, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_CAMMY_PORTRAITS_OLD2P[] =
{
    { L"Cammy Portrait - Old 2P 1/2", 0x35cc8, 0x35d48, indexSF2Sprites_Cammy, 0x10, &pairNext },
    { L"Cammy Portrait - Old 2P 2/2", 0x3ad7e, 0x3adfe, indexSF2Sprites_Cammy, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_JAB[] =
{
    { L"T-Hawk Portrait - Jab 1/2", 0x35d48, 0x35dc8, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Jab 2/2", 0x3adfe, 0x3ae7e, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_STRONG[] =
{
    { L"T-Hawk Portrait - Strong 1/2", 0x35dc8, 0x35e48, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Strong 2/2", 0x3ae7e, 0x3aefe, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_FIERCE[] =
{
    { L"T-Hawk Portrait - Fierce 1/2", 0x35e48, 0x35ec8, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Fierce 2/2", 0x3aefe, 0x3af7e, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_SHORT[] =
{
    { L"T-Hawk Portrait - Short 1/2", 0x35ec8, 0x35f48, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Short 2/2", 0x3af7e, 0x3affe, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_FORWARD[] =
{
    { L"T-Hawk Portrait - Forward 1/2", 0x35f48, 0x35fc8, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Forward 2/2", 0x3affe, 0x3b07e, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_ROUNDHOUSE[] =
{
    { L"T-Hawk Portrait - RH 1/2", 0x35fc8, 0x36048, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - RH 2/2", 0x3b07e, 0x3b0fe, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_START[] =
{
    { L"T-Hawk Portrait - Start 1/2", 0x36048, 0x360c8, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Start 2/2", 0x3b0fe, 0x3b17e, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_HOLD[] =
{
    { L"T-Hawk Portrait - Hold 1/2", 0x360c8, 0x36148, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Hold 2/2", 0x3b17e, 0x3b1fe, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_OLD1P[] =
{
    { L"T-Hawk Portrait - Old 1P 1/2", 0x36148, 0x361c8, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Old 1P 2/2", 0x3b1fe, 0x3b27e, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_THAWK_PORTRAITS_OLD2P[] =
{
    { L"T-Hawk Portrait - Old 2P 1/2", 0x361c8, 0x36248, indexSF2Sprites_THawk, 0x10, &pairNext },
    { L"T-Hawk Portrait - Old 2P 2/2", 0x3b27e, 0x3b2fe, indexSF2Sprites_THawk, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_JAB[] =
{
    { L"Fei Long Portrait - Jab 1/2", 0x36248, 0x362c8, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Jab 2/2", 0x3b2fe, 0x3b37e, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_STRONG[] =
{
    { L"Fei Long Portrait - Strong 1/2", 0x362c8, 0x36348, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Strong 2/2", 0x3b37e, 0x3b3fe, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_FIERCE[] =
{
    { L"Fei Long Portrait - Fierce 1/2", 0x36348, 0x363c8, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Fierce 2/2", 0x3b3fe, 0x3b47e, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_SHORT[] =
{
    { L"Fei Long Portrait - Short 1/2", 0x363c8, 0x36448, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Short 2/2", 0x3b47e, 0x3b4fe, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_FORWARD[] =
{
    { L"Fei Long Portrait - Forward 1/2", 0x36448, 0x364c8, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Forward 2/2", 0x3b4fe, 0x3b57e, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Fei Long Portrait - RH 1/2", 0x364c8, 0x36548, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - RH 2/2", 0x3b57e, 0x3b5fe, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_START[] =
{
    { L"Fei Long Portrait - Start 1/2", 0x36548, 0x365c8, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Start 2/2", 0x3b5fe, 0x3b67e, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_HOLD[] =
{
    { L"Fei Long Portrait - Hold 1/2", 0x365c8, 0x36648, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Hold 2/2", 0x3b67e, 0x3b6fe, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_OLD1P[] =
{
    { L"Fei Long Portrait - Old 1P 1/2", 0x36648, 0x366c8, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Old 1P 2/2", 0x3b6fe, 0x3b77e, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_FEILONG_PORTRAITS_OLD2P[] =
{
    { L"Fei Long Portrait - Old 2P 1/2", 0x366c8, 0x36748, indexSF2Sprites_FeiLong, 0x10, &pairNext },
    { L"Fei Long Portrait - Old 2P 2/2", 0x3b77e, 0x3b7fe, indexSF2Sprites_FeiLong, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_JAB[] =
{
    { L"Dee Jay Portrait - Jab 1/2", 0x36748, 0x367c8, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Jab 2/2", 0x3b7fe, 0x3b87e, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_STRONG[] =
{
    { L"Dee Jay Portrait - Strong 1/2", 0x367c8, 0x36848, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Strong 2/2", 0x3b87e, 0x3b8fe, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_FIERCE[] =
{
    { L"Dee Jay Portrait - Fierce 1/2", 0x36848, 0x368c8, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Fierce 2/2", 0x3b8fe, 0x3b97e, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_SHORT[] =
{
    { L"Dee Jay Portrait - Short 1/2", 0x368c8, 0x36948, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Short 2/2", 0x3b97e, 0x3b9fe, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_FORWARD[] =
{
    { L"Dee Jay Portrait - Forward 1/2", 0x36948, 0x369c8, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Forward 2/2", 0x3b9fe, 0x3ba7e, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_ROUNDHOUSE[] =
{
    { L"Dee Jay Portrait - RH 1/2", 0x369c8, 0x36a48, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - RH 2/2", 0x3ba7e, 0x3bafe, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_START[] =
{
    { L"Dee Jay Portrait - Start 1/2", 0x36a48, 0x36ac8, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Start 2/2", 0x3bafe, 0x3bb7e, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_HOLD[] =
{
    { L"Dee Jay Portrait - Hold 1/2", 0x36ac8, 0x36b48, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Hold 2/2", 0x3bb7e, 0x3bbfe, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_OLD1P[] =
{
    { L"Dee Jay Portrait - Old 1P 1/2", 0x36b48, 0x36bc8, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Old 1P 2/2", 0x3bbfe, 0x3bc7e, indexSF2Sprites_DeeJay, 0x11 },
};

const sGame_PaletteDataset SSF2T_A_DEEJAY_PORTRAITS_OLD2P[] =
{
    { L"Dee Jay Portrait - Old 2P 1/2", 0x36bc8, 0x36c48, indexSF2Sprites_DeeJay, 0x10, &pairNext },
    { L"Dee Jay Portrait - Old 2P 2/2", 0x3bc7e, 0x3bcfe, indexSF2Sprites_DeeJay, 0x11 },
};
