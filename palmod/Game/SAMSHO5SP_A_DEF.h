...
const sGame_PaletteDataset SAMSHOW5SP_A_Amakusa_PALETTES_A[] =
{
    ...
    { L"Amakusa A (Tenshou Fuu'ou Jin)",    0xe0280, 0xe02a0, indexSamSho5Sprites_Amakusa, 0x0c },
    { L"Amakusa A (Misc Poses/Effects)",    0xe02a0, 0xe02c0, indexSamSho5Sprites_Amakusa, 0x08 },
    { L"Amakusa A (Oumagatoki/Misc)",       0xe02c0, 0xe02e0, indexSamSho5Sprites_Amakusa, 0x0b },
    { L"Amakusa A (Nanji/Misc)",            0xe0300, 0xe0320, indexSamSho5Sprites_Amakusa, 0x09 },
    { L"Amakusa A (Orb Slash Effect)",      0xe0380, 0xe03a0, indexSamSho5Sprites_Amakusa, 0x0a },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Amakusa_PALETTES_B[] =
{
    ...
    { L"Amakusa B (Tenshou Fuu'ou Jin)", 0xe0680, 0xe06a0, indexSamSho5Sprites_Amakusa, 0x0c },
    { L"Amakusa B (Misc Poses/Effects)", 0xe06a0, 0xe06c0, indexSamSho5Sprites_Amakusa, 0x08 },
    { L"Amakusa B (Oumagatoki/Misc)", 0xe06c0, 0xe06e0, indexSamSho5Sprites_Amakusa, 0x0b },
    { L"Amakusa B (Nanji/Misc)", 0xe0700, 0xe0720, indexSamSho5Sprites_Amakusa, 0x09 },
    { L"Amakusa B (Orb Slash Effect)", 0xe0780, 0xe07a0, indexSamSho5Sprites_Amakusa, 0x0a },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Amakusa_PALETTES_C[] =
{
    ...
    { L"Amakusa C (Tenshou Fuu'ou Jin)", 0xe0a80, 0xe0aa0, indexSamSho5Sprites_Amakusa, 0x0c },
    { L"Amakusa C (Misc Poses/Effects)", 0xe0aa0, 0xe0ac0, indexSamSho5Sprites_Amakusa, 0x08 },
    { L"Amakusa C (Oumagatoki/Misc)", 0xe0ac0, 0xe0ae0, indexSamSho5Sprites_Amakusa, 0x0b },
    { L"Amakusa C (Nanji/Misc)", 0xe0b00, 0xe0b20, indexSamSho5Sprites_Amakusa, 0x09 },
    { L"Amakusa C (Orb Slash Effect)", 0xe0b80, 0xe0ba0, indexSamSho5Sprites_Amakusa, 0x0a },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Amakusa_PALETTES_D[] =
{
    ...
    { L"Amakusa D (Tenshou Fuu'ou Jin)", 0xe0e80, 0xe0ea0, indexSamSho5Sprites_Amakusa, 0x0c },
    { L"Amakusa D (Misc Poses/Effects)", 0xe0ea0, 0xe0ec0, indexSamSho5Sprites_Amakusa, 0x08 },
    { L"Amakusa D (Oumagatoki/Misc)", 0xe0ec0, 0xe0ee0, indexSamSho5Sprites_Amakusa, 0x0b },
    { L"Amakusa D (Nanji/Misc)", 0xe0f00, 0xe0f20, indexSamSho5Sprites_Amakusa, 0x09 },
    { L"Amakusa D (Orb Slash Effect)", 0xe0f80, 0xe0fa0, indexSamSho5Sprites_Amakusa, 0x0a },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Basara_PALETTES_A[] =
{
    ...
    { L"Basara A (Bats)", 0xdd280, 0xdd2a0, indexSS5_Basara, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Basara_PALETTES_B[] =
{
    ...
    { L"Basara B (Bats)", 0xdd680, 0xdd6a0, indexSS5_Basara, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Basara_PALETTES_C[] =
{
    ...
    { L"Basara C (Bats)", 0xdda80, 0xddaa0, indexSS5_Basara, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Basara_PALETTES_D[] =
{
    ...
    { L"Basara D (Bats)", 0xdde80, 0xddea0, indexSS5_Basara, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaira_PALETTES_A[] =
{
    ...
    { L"Gaira A (Enshinsatsu)", 0xdf080, 0xdf0a0, indexSS5_Gaira, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaira_PALETTES_B[] =
{
    ...
    { L"Gaira B (Enshinsatsu)", 0xdf480, 0xdf4a0, indexSS5_Gaira, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaira_PALETTES_C[] =
{
    ...
    { L"Gaira C (Enshinsatsu)", 0xdf880, 0xdf8a0, indexSS5_Gaira, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaira_PALETTES_D[] =
{
    ...
    { L"Gaira D (Enshinsatsu)", 0xdfc80, 0xdfca0, indexSS5_Gaira, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaoh_PALETTES_A[] =
{
    ...
    { L"Gaoh A (Overkill 1)", 0xef280, 0xef2c0, indexSS5_Gaoh, 0x08 },
    { L"Gaoh A (Overkill 2)", 0xef2c0, 0xef2e0, indexSS5_Gaoh, 0x09, &pairNext },
    { L"Gaoh A (Overkill 3)", 0xef2e0, 0xef300, indexSS5_Gaoh, 0x0a },
    { L"Gaoh A (Slash Effects)", 0xef340, 0xef360, indexSS5_Gaoh, 0x0b },
    { L"Gaoh A (Misc Specials)", 0xef360, 0xef380, indexSS5_Gaoh, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaoh_PALETTES_B[] =
{
    ...
    { L"Gaoh B (Overkill 1)", 0xef680, 0xef6c0, indexSS5_Gaoh, 0x08 },
    { L"Gaoh B (Overkill 2)", 0xef6c0, 0xef6e0, indexSS5_Gaoh, 0x09, &pairNext },
    { L"Gaoh B (Overkill 3)", 0xef6e0, 0xef700, indexSS5_Gaoh, 0x0a },
    { L"Gaoh B (Slash Effects)", 0xef740, 0xef760, indexSS5_Gaoh, 0x0b },
    { L"Gaoh B (Misc Specials)", 0xef760, 0xef780, indexSS5_Gaoh, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaoh_PALETTES_C[] =
{
    ...
    { L"Gaoh C (Overkill 1)", 0xefa80, 0xefac0, indexSS5_Gaoh, 0x08 },
    { L"Gaoh C (Overkill 2)", 0xefac0, 0xefae0, indexSS5_Gaoh, 0x09, &pairNext },
    { L"Gaoh C (Overkill 3)", 0xefae0, 0xefb00, indexSS5_Gaoh, 0x0a },
    { L"Gaoh C (Slash Effects)", 0xefb40, 0xefb60, indexSS5_Gaoh, 0x0b },
    { L"Gaoh C (Misc Specials)", 0xefb60, 0xefb80, indexSS5_Gaoh, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Gaoh_PALETTES_D[] =
{
    ...
    { L"Gaoh D (Overkill 1)", 0xefe80, 0xefec0, indexSS5_Gaoh, 0x08 },
    { L"Gaoh D (Overkill 2)", 0xefec0, 0xefee0, indexSS5_Gaoh, 0x09, &pairNext },
    { L"Gaoh D (Overkill 3)", 0xefee0, 0xeff00, indexSS5_Gaoh, 0x0a },
    { L"Gaoh D (Slash Effects)", 0xeff40, 0xeff60, indexSS5_Gaoh, 0x0b },
    { L"Gaoh D (Misc Specials)", 0xeff60, 0xeff80, indexSS5_Gaoh, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Genjuro_PALETTES_A[] =
{
    ...
    { L"Genjuro A (Darkest Card Effects)", 0xdc0a0, 0xdc0c0, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro A (Colored Card Effect)", 0xdc1c0, 0xdc1e0, indexSS5_Genjuro, 0x08 },
    { L"Genjuro A (Darker Card Effect)", 0xdc1e0, 0xdc200, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro A (Oukazan 2/Slash Effects)", 0xdc340, 0xdc360, indexSS5_Genjuro, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Genjuro_PALETTES_B[] =
{
    ...
    { L"Genjuro B (Darkest Card Effects)", 0xdc4a0, 0xdc4c0, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro B (Colored Card Effect)", 0xdc5c0, 0xdc5e0, indexSS5_Genjuro, 0x08 },
    { L"Genjuro B (Darker Card Effect)", 0xdc5e0, 0xdc600, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro B (Oukazan 2/Slash Effects)", 0xdc740, 0xdc760, indexSS5_Genjuro, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Genjuro_PALETTES_C[] =
{
    ...
    { L"Genjuro C (Darkest Card Effects)", 0xdc8a0, 0xdc8c0, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro C (Colored Card Effect)", 0xdc9c0, 0xdc9e0, indexSS5_Genjuro, 0x08 },
    { L"Genjuro C (Darker Card Effect)", 0xdc9e0, 0xdca00, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro C (Oukazan 2/Slash Effects)", 0xdcb40, 0xdcb60, indexSS5_Genjuro, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Genjuro_PALETTES_D[] =
{
    ...
    { L"Genjuro D (Darkest Card Effects)", 0xdcca0, 0xdccc0, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro D (Colored Card Effect)", 0xdcdc0, 0xdcde0, indexSS5_Genjuro, 0x08 },
    { L"Genjuro D (Darker Card Effect)", 0xdcde0, 0xdce00, indexSS5_Genjuro, 0x08 },
    ...
    { L"Genjuro D (Oukazan 2/Slash Effects)", 0xdcf40, 0xdcf60, indexSS5_Genjuro, 0x09 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Haohmaru_PALETTES_A[] =
{
    ...
    { L"Haohmaru A (Overkill)", 0xd5280, 0xd52a0, indexSS5_Haohmaru, 0x09 },
    { L"Haohmaru A (Kogetsuzan Trail)", 0xd52c0, 0xd5300, indexSamSho5Sprites_Haohmaru },
    { L"Haohmaru A (Slash Effects)", 0xd5340, 0xd5360, indexSS5_Haohmaru, 0x0b },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Haohmaru_PALETTES_B[] =
{
    ...
    { L"Haohmaru B (Overkill)", 0xd5680, 0xd56a0, indexSS5_Haohmaru, 0x09 },
    { L"Haohmaru B (Kogetsuzan Trail)", 0xd56c0, 0xd5700, indexSamSho5Sprites_Haohmaru },
    { L"Haohmaru B (Slash Effects)", 0xd5740, 0xd5760, indexSS5_Haohmaru, 0x0b },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Haohmaru_PALETTES_C[] =
{
    ...
    { L"Haohmaru C (Overkill)", 0xd5a80, 0xd5aa0, indexSS5_Haohmaru, 0x09 },
    { L"Haohmaru C (Kogetsuzan Trail)", 0xd5ac0, 0xd5b00, indexSamSho5Sprites_Haohmaru },
    { L"Haohmaru C (Slash Effects)", 0xd5b40, 0xd5b60, indexSS5_Haohmaru, 0x0b },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Haohmaru_PALETTES_D[] =
{
    ...
    { L"Haohmaru D (Overkill)", 0xd5e80, 0xd5ea0, indexSS5_Haohmaru, 0x09 },
    { L"Haohmaru D (Kogetsuzan Trail)", 0xd5ec0, 0xd5f00, indexSamSho5Sprites_Haohmaru },
    { L"Haohmaru D (Slash Effects)", 0xd5f40, 0xd5f60, indexSS5_Haohmaru, 0x0b },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Jubei_PALETTES_A[] =
{
    ...
    { L"Jubei A (Overkill Effect)", 0xe12c0, 0xe12e0, indexSS5_Jubei, 0x0a },
    { L"Jubei A (Slash Effect/Bird 1)", 0xe1340, 0xe1360, indexSS5_Jubei, 0x0b },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Jubei_PALETTES_B[] =
{
    ...
    { L"Jubei B (Overkill Effect)", 0xe16c0, 0xe16e0, indexSS5_Jubei, 0x0a },
    { L"Jubei B (Slash Effect/Bird 1)", 0xe1740, 0xe1760, indexSS5_Jubei, 0x0b },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Jubei_PALETTES_C[] =
{
    ...
    { L"Jubei C (Overkill Effect)", 0xe1ac0, 0xe1ae0, indexSS5_Jubei, 0x0a },
    { L"Jubei C (Slash Effect/Bird 1)", 0xe1b40, 0xe1b60, indexSS5_Jubei, 0x0b },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Jubei_PALETTES_D[] =
{
    ...
    { L"Jubei D (Overkill Effect)", 0xe1ec0, 0xe1ee0, indexSS5_Jubei, 0x0a },
    { L"Jubei D (Slash Effect/Bird 1)", 0xe1f40, 0xe1f60, indexSS5_Jubei, 0x0b },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Kazuki_PALETTES_A[] =
{
    ...
    { L"Kazuki A (Special Effects 1)", 0xe5300, 0xe5320, indexSamSho5Sprites_Kazuki, 0x09 },
    { L"Kazuki A (Special Effects 2)", 0xe5320, 0xe5340, indexSamSho5Sprites_Kazuki, 0x0a },
    { L"Kazuki A (Slash Effect/Saien)", 0xe5340, 0xe5360, indexSamSho5Sprites_Kazuki, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Kazuki_PALETTES_B[] =
{
    ...
    { L"Kazuki B (Special Effects 1)", 0xe5700, 0xe5720, indexSamSho5Sprites_Kazuki, 0x09 },
    { L"Kazuki B (Special Effects 2)", 0xe5720, 0xe5740, indexSamSho5Sprites_Kazuki, 0x0a },
    { L"Kazuki B (Slash Effect/Saien)", 0xe5740, 0xe5760, indexSamSho5Sprites_Kazuki, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Kazuki_PALETTES_C[] =
{
    ...
    { L"Kazuki C (Special Effects 1)", 0xe5b00, 0xe5b20, indexSamSho5Sprites_Kazuki, 0x09 },
    { L"Kazuki C (Special Effects 2)", 0xe5b20, 0xe5b40, indexSamSho5Sprites_Kazuki, 0x0a },
    { L"Kazuki C (Slash Effect/Saien)", 0xe5b40, 0xe5b60, indexSamSho5Sprites_Kazuki, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Kazuki_PALETTES_D[] =
{
    ...
    { L"Kazuki D (Special Effects 1)", 0xe5f00, 0xe5f20, indexSamSho5Sprites_Kazuki, 0x09 },
    { L"Kazuki D (Special Effects 2)", 0xe5f20, 0xe5f40, indexSamSho5Sprites_Kazuki, 0x0a },
    { L"Kazuki D (Slash Effect/Saien)", 0xe5f40, 0xe5f60, indexSamSho5Sprites_Kazuki, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Mina_PALETTES_A[] =
{
    ...
    { L"Mina A (Sleeping Champuru)", 0xed2a0, 0xed2c0, indexSS5_Mina, 0x0b, &pairNext },
    { L"Mina A (Champuru Tears)", 0xed2c0, 0xed2e0, indexSS5_Mina, 0x07 },
    { L"Mina A (Mina Gown and Hat)", 0xed320, 0xed340, indexSS5_Mina, 0x08 },
    { L"Mina A (Normal Arrow Effect)", 0xed360, 0xed380, indexSS5_Mina, 0x0a },
    { L"Mina A (Misc Specials)", 0xed380, 0xed3a0, indexSS5_Mina, 0x09 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Mina_PALETTES_B[] =
{
    ...
    { L"Mina B (Sleeping Champuru)", 0xed6a0, 0xed6c0, indexSS5_Mina, 0x0b, &pairNext },
    { L"Mina B (Champuru Tears)", 0xed6c0, 0xed6e0, indexSS5_Mina, 0x07 },
    { L"Mina B (Mina Gown and Hat)", 0xed720, 0xed740, indexSS5_Mina, 0x08 },
    { L"Mina B (Normal Arrow Effect)", 0xed760, 0xed780, indexSS5_Mina, 0x0a },
    { L"Mina B (Misc Specials)", 0xed780, 0xed7a0, indexSS5_Mina, 0x09 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Mina_PALETTES_C[] =
{
    ...
    { L"Mina C (Sleeping Champuru)", 0xedaa0, 0xedac0, indexSS5_Mina, 0x0b, &pairNext },
    { L"Mina C (Champuru Tears)", 0xedac0, 0xedae0, indexSS5_Mina, 0x07 },
    { L"Mina C (Mina Gown and Hat)", 0xedb20, 0xedb40, indexSS5_Mina, 0x08 },
    { L"Mina C (Normal Arrow Effect)", 0xedb60, 0xedb80, indexSS5_Mina, 0x0a },
    { L"Mina C (Misc Specials)", 0xedb80, 0xedba0, indexSS5_Mina, 0x09 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Mina_PALETTES_D[] =
{
    ...
    { L"Mina D (Sleeping Champuru)", 0xedea0, 0xedec0, indexSS5_Mina, 0x0b, &pairNext },
    { L"Mina D (Champuru Tears)", 0xedec0, 0xedee0, indexSS5_Mina, 0x07 },
    { L"Mina D (Mina Gown and Hat)", 0xedf20, 0xedf40, indexSS5_Mina, 0x08 },
    { L"Mina D (Normal Arrow Effect)", 0xedf60, 0xedf80, indexSS5_Mina, 0x0a },
    { L"Mina D (Misc Specials)", 0xedf80, 0xedfa0, indexSS5_Mina, 0x09 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Nakoruru_PALETTES_A[] =
{
    ...
    { L"Nakoruru A (Annu/Rera Mutsube)", 0xd62e0, 0xd6300, indexSS5_Nakoruru, 0x07 },
    { L"Nakoruru A (Kamui Rimse/Slash Effect)", 0xd6340, 0xd6360, indexSS5_Nakoruru, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Nakoruru_PALETTES_B[] =
{
    ...
    { L"Nakoruru B (Annu/Rera Mutsube)", 0xd66e0, 0xd6700, indexSS5_Nakoruru, 0x07 },
    { L"Nakoruru B (Kamui Rimse/Slash Effect)", 0xd6740, 0xd6760, indexSS5_Nakoruru, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Nakoruru_PALETTES_C[] =
{
    ...
    { L"Nakoruru C (Annu/Rera Mutsube)", 0xd6ae0, 0xd6b00, indexSS5_Nakoruru, 0x07 },
    { L"Nakoruru C (Kamui Rimse/Slash Effect)", 0xd6b40, 0xd6b60, indexSS5_Nakoruru, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Nakoruru_PALETTES_D[] =
{
    ...
    { L"Nakoruru D (Annu/Rera Mutsube)", 0xd6ee0, 0xd6f00, indexSS5_Nakoruru, 0x07 },
    { L"Nakoruru D (Kamui Rimse/Slash Effect)", 0xd6f40, 0xd6f60, indexSS5_Nakoruru, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Rimururu_PALETTES_A[] =
{
    ...
    { L"Rimururu A (Slash Effects)", 0xd7340, 0xd7360, indexSS5_Rimururu, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Rimururu_PALETTES_B[] =
{
    ...
    { L"Rimururu B (Slash Effects)", 0xd7740, 0xd7760, indexSS5_Rimururu, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Rimururu_PALETTES_C[] =
{
    ...
    { L"Rimururu C (Slash Effects)", 0xd7b40, 0xd7b60, indexSS5_Rimururu, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Rimururu_PALETTES_D[] =
{
    ...
    { L"Rimururu D (Slash Effects)", 0xd7f40, 0xd7f60, indexSS5_Rimururu, 0x07 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Shizumaru_PALETTES_A[] =
{
    ...
    { L"Shizumaru A (Overkill Zankuro)", 0xde280, 0xde2c0, indexSamSho5Sprites_Zankuro, 0x00 },
    { L"Shizumaru A (Slash Effects)", 0xde2c0, 0xde2e0, indexSS5_Shizumaru, 0x08 },
    { L"Shizumaru A (Overkill Projectile)", 0xde2e0, 0xde300, indexSS5_Shizumaru, 0x0a },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Shizumaru_PALETTES_B[] =
{
    ...
    { L"Shizumaru B (Overkill Zankuro)", 0xde680, 0xde6c0, indexSamSho5Sprites_Zankuro, 0x00 },
    { L"Shizumaru B (Slash Effects)", 0xde6c0, 0xde6e0, indexSS5_Shizumaru, 0x08 },
    { L"Shizumaru B (Overkill Projectile)", 0xde6e0, 0xde700, indexSS5_Shizumaru, 0x0a },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Shizumaru_PALETTES_C[] =
{
    ...
    { L"Shizumaru C (Overkill Zankuro)", 0xdea80, 0xdeac0, indexSamSho5Sprites_Zankuro, 0x00 },
    { L"Shizumaru C (Slash Effects)", 0xdeac0, 0xdeae0, indexSS5_Shizumaru, 0x08 },
    { L"Shizumaru C (Overkill Projectile)", 0xdeae0, 0xdeb00, indexSS5_Shizumaru, 0x0a },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Shizumaru_PALETTES_D[] =
{
    ...
    { L"Shizumaru D (Overkill Zankuro)", 0xdee80, 0xdeec0, indexSamSho5Sprites_Zankuro, 0x00 },
    { L"Shizumaru D (Slash Effects)", 0xdeec0, 0xdeee0, indexSS5_Shizumaru, 0x08 },
    { L"Shizumaru D (Overkill Projectile)", 0xdeee0, 0xdef00, indexSS5_Shizumaru, 0x0a },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Ukyo_PALETTES_A[] =
{
    ...
    { L"Ukyo A (Overkill Symbols)", 0xdb2e0, 0xdb300, indexSS5_Ukyo, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Ukyo_PALETTES_B[] =
{
    ...
    { L"Ukyo B (Overkill Symbols)", 0xdb6e0, 0xdb700, indexSS5_Ukyo, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Ukyo_PALETTES_C[] =
{
    ...
    { L"Ukyo C (Overkill Symbols)", 0xdbae0, 0xdbb00, indexSS5_Ukyo, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Ukyo_PALETTES_D[] =
{
    ...
    { L"Ukyo D (Overkill Symbols)", 0xdbee0, 0xdbf00, indexSS5_Ukyo, 0x08 },
...
const sGame_PaletteDataset SAMSHOW5SP_A_Zankuro_PALETTES_A[] =
{
    ...
    { L"Zankuro A (Overkill Beam)", 0xe22a0, 0xe22c0, indexSamSho5Sprites_Zankuro, 0x0a },
    { L"Zankuro A (Overkill Startup)", 0xe22c0, 0xe22e0, indexSamSho5Sprites_Zankuro, 0x0b },
    { L"Zankuro A (Slash Effect)", 0xe2300, 0xe2320, indexSamSho5Sprites_Zankuro, 0x0c },
    { L"Zankuro A (Mugen-ryuu Tenhouzan)", 0xe2320, 0xe2340, indexSamSho5Sprites_Zankuro, 0x09 },
    { L"Zankuro A (Assorted Specials)", 0xe2340, 0xe2360, indexSamSho5Sprites_Zankuro, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Zankuro_PALETTES_B[] =
{
    ...
    { L"Zankuro B (Overkill Beam)", 0xe26a0, 0xe26c0, indexSamSho5Sprites_Zankuro, 0x0a },
    { L"Zankuro B (Overkill Startup)", 0xe26c0, 0xe26e0, indexSamSho5Sprites_Zankuro, 0x0b },
    { L"Zankuro B (Slash Effect)", 0xe2700, 0xe2720, indexSamSho5Sprites_Zankuro, 0x0c },
    { L"Zankuro B (Mugen-ryuu Tenhouzan)", 0xe2720, 0xe2740, indexSamSho5Sprites_Zankuro, 0x09 },
    { L"Zankuro B (Assorted Specials)", 0xe2740, 0xe2760, indexSamSho5Sprites_Zankuro, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Zankuro_PALETTES_C[] =
{
    ...
    { L"Zankuro C (Overkill Beam)", 0xe2aa0, 0xe2ac0, indexSamSho5Sprites_Zankuro, 0x0a },
    { L"Zankuro C (Overkill Startup)", 0xe2ac0, 0xe2ae0, indexSamSho5Sprites_Zankuro, 0x0b },
    { L"Zankuro C (Slash Effect)", 0xe2b00, 0xe2b20, indexSamSho5Sprites_Zankuro, 0x0c },
    { L"Zankuro C (Mugen-ryuu Tenhouzan)", 0xe2b20, 0xe2b40, indexSamSho5Sprites_Zankuro, 0x09 },
    { L"Zankuro C (Assorted Specials)", 0xe2b40, 0xe2b60, indexSamSho5Sprites_Zankuro, 0x08 },
};
...
const sGame_PaletteDataset SAMSHOW5SP_A_Zankuro_PALETTES_D[] =
{
    ...
    { L"Zankuro D (Overkill Beam)", 0xe2ea0, 0xe2ec0, indexSamSho5Sprites_Zankuro, 0x0a },
    { L"Zankuro D (Overkill Startup)", 0xe2ec0, 0xe2ee0, indexSamSho5Sprites_Zankuro, 0x0b },
    { L"Zankuro D (Slash Effect)", 0xe2f00, 0xe2f20, indexSamSho5Sprites_Zankuro, 0x0c },
    { L"Zankuro D (Mugen-ryuu Tenhouzan)", 0xe2f20, 0xe2f40, indexSamSho5Sprites_Zankuro, 0x09 },
    { L"Zankuro D (Assorted Specials)", 0xe2f40, 0xe2f60, indexSamSho5Sprites_Zankuro, 0x08 },
};
...
const sDescTreeNode SAMSHO5SP_A_UNITS[] =
{
    ...
    { L"Bonus Palettes", DESC_NODETYPE_TREE, (void*)SAMSHO5SP_A_BONUS_COLLECTION, ARRAYSIZE(SAMSHO5SP_A_BONUS_COLLECTION) },
};
