...
{
    { L"Sasuke A", 0x08166c, 0x08168c },
    { L"Weapon A", 0x08172c, 0x08174c },
    { L"Hyper Changing A", 0x08168c, 0x0816ac },
    { L"Weapon Changing A", 0x08174c, 0x08176c },
    { L"Supertrail A", 0x0816ac, 0x0816cc },
    { L"Weapon Supertrail A", 0x0816cc, 0x0816ec },
    { L"Super Combo A", 0x0816ec, 0x08170c },
    { L"Weapon Super Combo A", 0x08170c, 0x08172c },
    { L"Darkness Combo A", 0x0817ec, 0x08180c },
    { L"Weapon Darkness Combo A", 0x08180c, 0x08182c },
    { L"Desperation Move A", 0x08182c, 0x08184c },
    { L"Weapon Desperation Move A", 0x08184c, 0x08186c },
...
{
    { L"Sasuke B", 0x082e90, 0x082eb0 },
    { L"Weapon B", 0x082f50, 0x082f70 },
    { L"Hyper Changing B", 0x082eb0, 0x082ed0 },
    { L"Weapon Changing B", 0x082f70, 0x082f90 },
    { L"Supertrail B", 0x082ed0, 0x082ef0 },
    { L"Weapon Supertrail B", 0x082ef0, 0x082f10 },
    { L"Super Combo B", 0x082f10, 0x082f30 },
    { L"Weapon Super Combo B", 0x082f30, 0x082f50 },
    { L"Darkness Combo B", 0x083010, 0x083030 },
    { L"Weapon Darkness Combo B", 0x083030, 0x083050 },
    { L"Desperation Move B", 0x083050, 0x083070 },
    { L"Weapon Desperation Move B", 0x083070, 0x083090 },
...
{
    { L"Kamui A", 0x08186c, 0x08188c },
    { L"Weapon A", 0x08192c, 0x08194c },
    { L"Hyper Changing A", 0x08188c, 0x0818ac },
    { L"Weapon Changing A", 0x08194c, 0x08196c },
    { L"Supertrail A", 0x0818ac, 0x0818cc },
    { L"Weapon Supertrail A", 0x0818cc, 0x0818ec },
    { L"Super Combo A", 0x0818ec, 0x08190c },
    { L"Weapon Super Combo A", 0x08190c, 0x08192c },
    { L"Darkness Combo A", 0x0819ec, 0x081a0c },
    { L"Weapon Darkness Combo A", 0x081a0c, 0x081a2c },
    { L"Desperation Move A", 0x081a2c, 0x081a4c },
    { L"Weapon Desperation Move A", 0x081a4c, 0x081a6c },
...
{
    { L"Kamui B", 0x083090, 0x0830b0 },
    { L"Weapon B", 0x083150, 0x083170 },
    { L"Hyper Changing B", 0x0830b0, 0x0830d0 },
    { L"Weapon Changing B", 0x083170, 0x083190 },
    { L"Supertrail B", 0x0830d0, 0x0830f0 },
    { L"Weapon Supertrail B", 0x0830f0, 0x083110 },
    { L"Super Combo B", 0x083110, 0x083130 },
    { L"Weapon Super Combo B", 0x083130, 0x083150 },
    { L"Darkness Combo B", 0x083210, 0x083230 },
    { L"Weapon Darkness Combo B", 0x083230, 0x083250 },
    { L"Desperation Move B", 0x083250, 0x083270 },
    { L"Weapon Desperation Move B", 0x083270, 0x083290 },
...
{
    { L"Raiga A", 0x081a6c, 0x081a8c },
    { L"Weapon A", 0x081b2c, 0x081b4c },
    { L"Hyper Changing A", 0x081a8c, 0x081aac },
    { L"Weapon Changing A", 0x081b4c, 0x081b6c },
    { L"Supertrail A", 0x081aac, 0x081acc },
    { L"Weapon Supertrail A", 0x081acc, 0x081aec },
    { L"Super Combo A", 0x081aec, 0x081b0c },
    { L"Weapon Super Combo A", 0x081b0c, 0x081b2c },
    { L"Darkness Combo A", 0x081bec, 0x081c0c },
    { L"Weapon Darkness Combo A", 0x081c0c, 0x081c2c },
    { L"Desperation Move A", 0x081c2c, 0x081c4c },
    { L"Weapon Desperation Move A", 0x081c4c, 0x081c6c },
...
{
    { L"Raiga B", 0x083290, 0x0832b0 },
    { L"Weapon B", 0x083350, 0x083370 },
    { L"Hyper Changing B", 0x0832b0, 0x0832d0 },
    { L"Weapon Changing B", 0x083370, 0x083390 },
    { L"Supertrail B", 0x0832d0, 0x0832f0 },
    { L"Weapon Supertrail B", 0x0832f0, 0x083310 },
    { L"Super Combo B", 0x083310, 0x083330 },
    { L"Weapon Super Combo B", 0x083330, 0x083350 },
    { L"Darkness Combo B", 0x083410, 0x083430 },
    { L"Weapon Darkness Combo B", 0x083430, 0x083450 },
    { L"Desperation Move B", 0x083450, 0x083470 },
    { L"Weapon Desperation Move B", 0x083470, 0x083490 },
...
{
    { L"Tenho A", 0x081c6c, 0x081c8c },
    { L"Weapon A", 0x081d2c, 0x081d4c },
    { L"Hyper Changing A", 0x081c8c, 0x081cac },
    { L"Weapon Changing A", 0x081d4c, 0x081d6c },
    { L"Supertrail A", 0x081cac, 0x081ccc },
    { L"Weapon Supertrail A", 0x081ccc, 0x081cec },
    { L"Super Combo A", 0x081cec, 0x081d0c },
    { L"Weapon Super Combo A", 0x081d0c, 0x081d2c },
    { L"Darkness Combo A", 0x081dec, 0x081e0c },
    { L"Weapon Darkness Combo A", 0x081e0c, 0x081e2c },
    { L"Desperation Move A", 0x081e2c, 0x081e4c },
    { L"Weapon Desperation Move A", 0x081e4c, 0x081e6c },
...
{
    { L"Tenho B", 0x083490, 0x0834b0 },
    { L"Weapon B", 0x083550, 0x083570 },
    { L"Hyper Changing B", 0x0834b0, 0x0834d0 },
    { L"Weapon Changing B", 0x083570, 0x083590 },
    { L"Supertrail B", 0x0834d0, 0x0834f0 },
    { L"Weapon Supertrail B", 0x0834f0, 0x083510 },
    { L"Super Combo B", 0x083510, 0x083530 },
    { L"Weapon Super Combo B", 0x083530, 0x083550 },
    { L"Darkness Combo B", 0x083610, 0x083630 },
...
{
    { L"Karasu A", 0x081e6c, 0x081e8c },
    { L"Weapon A", 0x081f2c, 0x081f4c },
    { L"Hyper Changing A", 0x081e8c, 0x081eac },
    { L"Weapon Changing A", 0x081f4c, 0x081f6c },
    { L"Supertrail A", 0x081eac, 0x081ecc },
    { L"Weapon Supertrail A", 0x081ecc, 0x081eec },
    { L"Super Combo A", 0x081eec, 0x081f0c },
    { L"Weapon Super Combo A", 0x081f0c, 0x081f2c },
    { L"Darkness Combo A", 0x081fec, 0x08200c },
    { L"Weapon Darkness Combo A", 0x08200c, 0x08202c },
    { L"Desperation Move A", 0x08202c, 0x08204c },
    { L"Weapon Desperation Move A", 0x08204c, 0x08206c },
...
{
    { L"Karasu B", 0x083690, 0x0836b0 },
    { L"Weapon B", 0x083750, 0x083770 },
    { L"Hyper Changing B", 0x0836b0, 0x0836d0 },
    { L"Weapon Changing B", 0x083770, 0x083790 },
    { L"Supertrail B", 0x0836d0, 0x0836f0 },
    { L"Weapon Supertrail B", 0x0836f0, 0x083710 },
    { L"Super Combo B", 0x083710, 0x083730 },
    { L"Weapon Super Combo B", 0x083730, 0x083750 },
    { L"Darkness Combo B", 0x083810, 0x083830 },
    { L"Weapon Darkness Combo B", 0x083830, 0x083850 },
    { L"Desperation Move B", 0x083850, 0x083870 },
    { L"Weapon Desperation Move B", 0x083870, 0x083890 },
...
{
    { L"Houoh A", 0x08206c, 0x08208c },
    { L"Weapon A", 0x08212c, 0x08214c },
    { L"Hyper Changing A", 0x08208c, 0x0820ac },
    { L"Weapon Changing A", 0x08214c, 0x08216c },
    { L"Supertrail A", 0x0820ac, 0x0820cc },
    { L"Weapon Supertrail A", 0x0820cc, 0x0820ec },
    { L"Super Combo A", 0x0820ec, 0x08210c },
    { L"Weapon Super Combo A", 0x08210c, 0x08212c },
    { L"Darkness Combo A", 0x0821ec, 0x08220c },
    { L"Weapon Darkness Combo A", 0x08220c, 0x08222c },
    { L"Desperation Move A", 0x08222c, 0x08224c },
    { L"Weapon Desperation Move A", 0x08224c, 0x08226c },
...
{
    { L"Houoh B", 0x083890, 0x0838b0 },
    { L"Weapon B", 0x083950, 0x083970 },
    { L"Hyper Changing B", 0x0838b0, 0x0838d0 },
    { L"Weapon Changing B", 0x083970, 0x083990 },
    { L"Supertrail B", 0x0838d0, 0x0838f0 },
    { L"Weapon Supertrail B", 0x0838f0, 0x083910 },
    { L"Super Combo B", 0x083910, 0x083930 },
    { L"Weapon Super Combo B", 0x083930, 0x083950 },
    { L"Darkness Combo B", 0x083a10, 0x083a30 },
    { L"Weapon Darkness Combo B", 0x083a30, 0x083a50 },
    { L"Desperation Move B", 0x083a50, 0x083a70 },
    { L"Weapon Desperation Move B", 0x083a70, 0x083a90 },
...
{
    { L"Natsume A", 0x08226c, 0x08228c },
    { L"Weapon A", 0x08232c, 0x08234c },
    { L"Hyper Changing A", 0x08228c, 0x0822ac },
    { L"Weapon Changing A", 0x08234c, 0x08236c },
    { L"Supertrail A", 0x0822ac, 0x0822cc },
    { L"Weapon Supertrail A", 0x0822cc, 0x0822ec },
    { L"Super Combo A", 0x0822ec, 0x08230c },
    { L"Weapon Super Combo A", 0x08230c, 0x08232c },
    { L"Darkness Combo A", 0x0823ec, 0x08240c },
    { L"Weapon Darkness Combo A", 0x08240c, 0x08242c },
    { L"Desperation Move A", 0x08242c, 0x08244c },
    { L"Weapon Desperation Move A", 0x08244c, 0x08246c },
...
{
    { L"Natsume B", 0x083a90, 0x083ab0 },
    { L"Weapon B", 0x083b50, 0x083b70 },
    { L"Hyper Changing B", 0x083ab0, 0x083ad0 },
    { L"Weapon Changing B", 0x083b70, 0x083b90 },
    { L"Supertrail B", 0x083ad0, 0x083af0 },
    { L"Weapon Supertrail B", 0x083af0, 0x083b10 },
    { L"Super Combo B", 0x083b10, 0x083b30 },
    { L"Weapon Super Combo B", 0x083b30, 0x083b50 },
    { L"Darkness Combo B", 0x083c10, 0x083c30 },
    { L"Weapon Darkness Combo B", 0x083c30, 0x083c50 },
    { L"Desperation Move B", 0x083c50, 0x083c70 },
    { L"Weapon Desperation Move B", 0x083c70, 0x083c90 },
...
{
    { L"Goemon A", 0x08246c, 0x08248c },
    { L"Weapon A", 0x08252c, 0x08254c },
    { L"Hyper Changing A", 0x08248c, 0x0824ac },
    { L"Weapon Changing A", 0x08254c, 0x08256c },
    { L"Supertrail A", 0x0824ac, 0x0824cc },
    { L"Weapon Supertrail A", 0x0824cc, 0x0824ec },
    { L"Super Combo A", 0x0824ec, 0x08250c },
    { L"Weapon Super Combo A", 0x08250c, 0x08252c },
    { L"Darkness Combo A", 0x0825ec, 0x08260c },
    { L"Weapon Darkness Combo A", 0x08260c, 0x08262c },
    { L"Desperation Move A", 0x08262c, 0x08264c },
    { L"Weapon Desperation Move A", 0x08264c, 0x08266c },
...
{
    { L"Goemon B", 0x083c90, 0x083cb0 },
    { L"Weapon B", 0x083d50, 0x083d70 },
    { L"Hyper Changing B", 0x083cb0, 0x083cd0 },
    { L"Weapon Changing B", 0x083d70, 0x083d90 },
    { L"Supertrail B", 0x083cd0, 0x083cf0 },
    { L"Weapon Supertrail B", 0x083cf0, 0x083d10 },
    { L"Super Combo B", 0x083d10, 0x083d30 },
    { L"Weapon Super Combo B", 0x083d30, 0x083d50 },
    { L"Darkness Combo B", 0x083e10, 0x083e30 },
    { L"Weapon Darkness Combo B", 0x083e30, 0x083e50 },
    { L"Desperation Move B", 0x083e50, 0x083e70 },
    { L"Weapon Desperation Move B", 0x083e70, 0x083e90 },
...
{
    { L"Unzen A", 0x08266c, 0x08268c },
    { L"Weapon A", 0x08272c, 0x08274c },
    { L"Hyper Changing A", 0x08268c, 0x0826ac },
    { L"Weapon Changing A", 0x08274c, 0x08276c },
    { L"Supertrail A", 0x0826ac, 0x0826cc },
    { L"Weapon Supertrail A", 0x0826cc, 0x0826ec },
    { L"Super Combo A", 0x0826ec, 0x08270c },
    { L"Weapon Super Combo A", 0x08270c, 0x08272c },
    { L"Darkness Combo A", 0x0827ec, 0x08280c },
    { L"Weapon Darkness Combo A", 0x08280c, 0x08282c },
    { L"Desperation Move A", 0x08282c, 0x08284c },
    { L"Weapon Desperation Move A", 0x08284c, 0x08286c },
...
{
    { L"Unzen B", 0x083e90, 0x083eb0 },
    { L"Weapon B", 0x083f50, 0x083f70 },
    { L"Hyper Changing B", 0x083eb0, 0x083ed0 },
    { L"Weapon Changing B", 0x083f70, 0x083f90 },
    { L"Supertrail B", 0x083ed0, 0x083ef0 },
    { L"Weapon Supertrail B", 0x083ef0, 0x083f10 },
    { L"Super Combo B", 0x083f10, 0x083f30 },
    { L"Weapon Super Combo B", 0x083f30, 0x083f50 },
    { L"Darkness Combo B", 0x084010, 0x084030 },
    { L"Weapon Darkness Combo B", 0x084030, 0x084050 },
    { L"Desperation Move B", 0x084050, 0x084070 },
    { L"Weapon Desperation Move B", 0x084070, 0x084090 },
...
{
    { L"Kasumi A", 0x08286c, 0x08288c },
    { L"Weapon A", 0x08292c, 0x08294c },
    { L"Hyper Changing A", 0x08288c, 0x0828ac },
    { L"Weapon Changing A", 0x08294c, 0x08296c },
    { L"Supertrail A", 0x0828ac, 0x0828cc },
    { L"Weapon Supertrail A", 0x0828cc, 0x0828ec },
    { L"Super Combo A", 0x0828ec, 0x08290c },
    { L"Weapon Super Combo A", 0x08290c, 0x08292c },
    { L"Darkness Combo A", 0x0829ec, 0x082a0c },
    { L"Weapon Darkness Combo A", 0x082a0c, 0x082a2c },
    { L"Desperation Move A", 0x082a2c, 0x082a4c },
    { L"Weapon Desperation Move A", 0x082a4c, 0x082a6c },
...
{
    { L"Kasumi B", 0x084090, 0x0840b0 },
    { L"Weapon B", 0x084150, 0x084170 },
    { L"Hyper Changing B", 0x0840b0, 0x0840d0 },
    { L"Weapon Changing B", 0x084170, 0x084190 },
    { L"Supertrail B", 0x0840d0, 0x0840f0 },
    { L"Weapon Supertrail B", 0x0840f0, 0x084110 },
    { L"Super Combo B", 0x084110, 0x084130 },
    { L"Weapon Super Combo B", 0x084130, 0x084150 },
    { L"Darkness Combo B", 0x084210, 0x084230 },
    { L"Weapon Darkness Combo B", 0x084230, 0x084250 },
    { L"Desperation Move B", 0x084250, 0x084270 },
    { L"Weapon Desperation Move B", 0x084270, 0x084290 },
...
{
    { L"Ranmaru A", 0x082a6c, 0x082a8c },
    { L"Weapon A", 0x082b2c, 0x082b4c },
    { L"Hyper Changing A", 0x082a8c, 0x082aac },
    { L"Weapon Changing A", 0x082b4c, 0x082b6c },
    { L"Supertrail A", 0x082aac, 0x082acc },
    { L"Weapon Supertrail A", 0x082acc, 0x082aec },
    { L"Super Combo A", 0x082aec, 0x082b0c },
    { L"Weapon Super Combo A", 0x082b0c, 0x082b2c },
    { L"Darkness Combo A", 0x082bec, 0x082c0c },
    { L"Weapon Darkness Combo A", 0x082c0c, 0x082c2c },
    { L"Desperation Move A", 0x082c2c, 0x082c4c },
    { L"Weapon Desperation Move A", 0x082c4c, 0x082c6c },
...
{
    { L"Ranmaru B", 0x084290, 0x0842b0 },
    { L"Weapon B", 0x084350, 0x084370 },
    { L"Hyper Changing B", 0x0842b0, 0x0842d0 },
    { L"Weapon Changing B", 0x084370, 0x084390 },
    { L"Supertrail B", 0x0842d0, 0x0842f0 },
    { L"Weapon Supertrail B", 0x0842f0, 0x084310 },
    { L"Super Combo B", 0x084310, 0x084330 },
    { L"Weapon Super Combo B", 0x084330, 0x084350 },
    { L"Darkness Combo B", 0x084410, 0x084430 },
    { L"Weapon Darkness Combo B", 0x084430, 0x084450 },
    { L"Desperation Move B", 0x084450, 0x084470 },
    { L"Weapon Desperation Move B", 0x084470, 0x084490 },
...
{
    { L"Nobunaga A", 0x082c6c, 0x082c8c },
    { L"Weapon A", 0x082d2c, 0x082d4c },
    { L"Hyper Changing A", 0x082c8c, 0x082cac },
    { L"Weapon Changing A", 0x082d4c, 0x082d6c },
    { L"Supertrail A", 0x082cac, 0x082ccc },
    { L"Weapon Supertrail A", 0x082ccc, 0x082cec },
    { L"Super Combo A", 0x082cec, 0x082d0c },
    { L"Weapon Super Combo A", 0x082d0c, 0x082d2c },
    { L"Darkness Combo A", 0x082dec, 0x082e0c },
    { L"Weapon Darkness Combo A", 0x082e0c, 0x082e2c },
    { L"Desperation Move A", 0x082e2c, 0x082e4c },
    { L"Weapon Desperation Move A", 0x082e4c, 0x082e6c },
...
{
    { L"Nobunaga B", 0x084490, 0x0844b0 },
    { L"Weapon B", 0x084550, 0x084570 },
    { L"Hyper Changing B", 0x0844b0, 0x0844d0 },
    { L"Weapon Changing B", 0x084570, 0x084590 },
    { L"Supertrail B", 0x0844d0, 0x0844f0 },
    { L"Weapon Supertrail B", 0x0844f0, 0x084510 },
    { L"Super Combo B", 0x084510, 0x084530 },
    { L"Weapon Super Combo B", 0x084530, 0x084550 },
    { L"Darkness Combo B", 0x084610, 0x084630 },
    { L"Weapon Darkness Combo B", 0x084630, 0x084650 },
    { L"Desperation Move B", 0x084650, 0x084670 },
    { L"Weapon Desperation Move B", 0x084670, 0x084690 },
