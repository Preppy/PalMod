...
class CGame_SFIII1_S : public CGameClassByDir
{
private:
    static inline const sDirectoryLoadingData m_sFileLoadingData =
    {
    ...
    // alex offset in cps3 is 0x3d0600
    ...
    const sCoreGameData m_sCoreGameData
    {
        ...
        SFIII1_A_50_UNITS,
        ARRAYSIZE(SFIII1_A_50_UNITS),
        L"SFIII1Se.txt",             // Extra filename
        631,                        // Count of palettes listed in the header
        0x3b0000,                   // Lowest known location used for palettes
    };

public:
    CGame_SFIII1_S(uint32_t nConfirmedROMSize) { InitializeGame(nConfirmedROMSize, m_sCoreGameData); };
