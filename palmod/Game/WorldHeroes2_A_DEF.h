...
{
    { L"Hanzou A", 0x101200, 0x101220, indexWHPSprites_Hanzou, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_HanzouHattori_B[] =
{
    { L"Hanzou B", 0x101220, 0x101240, indexWHPSprites_Hanzou, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_FuumaKotaro_A[] =
{
    { L"Fuuma A", 0x101240, 0x101260, indexWHPSprites_Fuuma, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_FuumaKotaro_B[] =
{
    { L"Fuuma B", 0x101260, 0x101280, indexWHPSprites_Fuuma, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_KimDragon_A[] =
{
    { L"Dragon A", 0x101280, 0x1012a0, indexWHPSprites_Dragon, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_KimDragon_B[] =
{
    { L"Dragon B", 0x1012a0, 0x1012c0, indexWHPSprites_Dragon, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_JeannedArc_A[] =
{
    { L"Jeanne A", 0x1012c0, 0x1012e0, indexWHPSprites_Jeanne, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_JeannedArc_B[] =
{
    { L"Jeanne B", 0x1012e0, 0x101300, indexWHPSprites_Jeanne, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_JuliusCarn_A[] =
{
    { L"J. Carn A", 0x101300, 0x101320, indexWHPSprites_JCarn, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_JuliusCarn_B[] =
{
    { L"J. Carn B", 0x101320, 0x101340, indexWHPSprites_JCarn, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_MusclePower_A[] =
{
    { L"Muscle Power A", 0x101340, 0x101360, indexWHPSprites_MusclePower, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_MusclePower_B[] =
{
    { L"Muscle Power B", 0x101360, 0x101380, indexWHPSprites_MusclePower, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_Brocken_A[] =
{
    { L"Brocken A", 0x101380, 0x1013a0, indexWHPSprites_Brocken, 0x50, &pairNext },
    { L"Attack Effects A", 0x101600, 0x101620, indexWHPSprites_Brocken, 0x51 },
};

const sGame_PaletteDataset WorldHeroes2_A_Brocken_B[] =
{
    { L"Brocken B", 0x1013a0, 0x1013c0, indexWHPSprites_Brocken, 0x50, &pairNext },
    { L"Attack Effects B", 0x101620, 0x101640, indexWHPSprites_Brocken, 0x51 },
};

const sGame_PaletteDataset WorldHeroes2_A_Rasputin_A[] =
{
    { L"Rasputin A", 0x1013c0, 0x1013e0, indexWHPSprites_Rasputin, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_Rasputin_B[] =
{
    { L"Rasputin B", 0x1013e0, 0x101400, indexWHPSprites_Rasputin, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_ShuraNaiKhanotmtom_A[] =
{
    { L"Shura A", 0x101400, 0x101420, indexWHPSprites_Shura, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_ShuraNaiKhanotmtom_B[] =
{
    { L"Shura B", 0x101420, 0x101440, indexWHPSprites_Shura, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_RyokoIzumo_A[] =
{
    { L"Ryoko A", 0x101440, 0x101460, indexWHPSprites_Ryoko, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_RyokoIzumo_B[] =
{
    { L"Ryoko B", 0x101460, 0x101480, indexWHPSprites_Ryoko, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_CaptainKidd_A[] =
{
    { L"Captain Kidd A", 0x101480, 0x1014a0, indexWHPSprites_CaptainKidd, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_CaptainKidd_B[] =
{
    { L"Captain Kidd B", 0x1014a0, 0x1014c0, indexWHPSprites_CaptainKidd, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_Mudman_A[] =
{
    { L"Mudman A", 0x1014c0, 0x1014e0, indexWHPSprites_Mudman, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_Mudman_B[] =
{
    { L"Mudman B", 0x1014e0, 0x101500, indexWHPSprites_Mudman, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_EricktheViking_A[] =
{
    { L"Erick A", 0x101500, 0x101520, indexWHPSprites_Erick, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_EricktheViking_B[] =
{
    { L"Erick B", 0x101520, 0x101540, indexWHPSprites_Erick, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_JohnnyMaximum_A[] =
{
    { L"J. Max A", 0x101540, 0x101560, indexWHPSprites_JMax, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_JohnnyMaximum_B[] =
{
    { L"J. Max B", 0x101560, 0x101580, indexWHPSprites_JMax, 0x50 },
};

const sGame_PaletteDataset WorldHeroes2_A_NeoDio_Palettes[] =
{
    { L"Neo Dio", 0x101580, 0x1015a0, indexWH2Sprites_Dio, 0x00 },
};

const sGame_PaletteDataset WorldHeroes2_A_NeoGeegus_Palettes[] =
{
    { L"Neo Geegus",                0x1015a0, 0x1015c0, indexWH2Sprites_NeoGeegus, 0x00 },
    { L"Hanzou, Fuuma, Ryoko, J. Max", 0x101d40, 0x101d60, indexWH2Sprites_NeoGeegus, 0x03 },
    { L"Dragon",                    0x101d60, 0x101d80, indexWHPSprites_Dragon, 0x50 },
    { L"Jeanne",                    0x101d80, 0x101da0, indexWHPSprites_Jeanne, 0x50 },
    { L"J. Carn",                   0x101da0, 0x101dc0, indexWHPSprites_JCarn, 0x50 },
    { L"Muscle Power",              0x101dc0, 0x101de0, indexWHPSprites_MusclePower, 0x50 },
    { L"Brocken",                   0x101de0, 0x101e00, indexWH2Sprites_NeoGeegus, 0x01 },
    { L"Rasputin",                  0x101e00, 0x101e20, indexWHPSprites_Rasputin, 0x50 },
    { L"Shura",                     0x101e20, 0x101e40, indexWHPSprites_Shura, 0x50 },
    { L"Captain Kidd and Mudman",   0x101e40, 0x101e60, indexWH2Sprites_NeoGeegus, 0x02 },
    { L"Erick",                     0x101e60, 0x101e80, indexWHPSprites_Erick, 0x50 },
    { L"???",                       0x101e80, 0x101ea0 },
};

const sGame_PaletteDataset WorldHeroes2_A_Portraits_Palettes[] =
{
    { L"Fuuma A",                           0x101800, 0x101840, indexWH2Sprites_Portraits, 0x09 },
    { L"Fuuma B",                           0x1082c0, 0x108300, indexWH2Sprites_Portraits, 0x09 },
    { L"Hanzou A 1/2",                      0x101840, 0x101860, indexWH2Sprites_Portraits, 0x0a, &pairNext },
    { L"Hanzou A 2/2",                      0x101b40, 0x101b60, indexWH2Sprites_Portraits, 0x0b },
    { L"Hanzou B 1/2",                      0x108420, 0x108440, indexWH2Sprites_Portraits, 0x0a, &pairNext },
    { L"Hanzou B 2/2",                      0x108c00, 0x108c20, indexWH2Sprites_Portraits, 0x0b },
    
    { L"Jeanne A 1/2",                      0x101860, 0x101880, indexWH2Sprites_Portraits, 0x0d, &pairNext3Palettes },
    { L"Rasputin A 1/2",                    0x101940, 0x101960, indexWH2Sprites_Portraits, 0x16 },
    { L"Neo Dio A 1/2",                     0x101a80, 0x101aa0, indexWH2Sprites_Portraits, 0x04 },
    { L"Jeanne Rasputin and Neo Dio A 2/2", 0x101880, 0x1018a0, indexWH2Sprites_Portraits, 0x10 },
    
    { L"Jeanne B 1/2",                      0x108460, 0x108480, indexWH2Sprites_Portraits, 0x0e, &pairNext },
    { L"Jeanne B 2/2",                      0x108480, 0x1084a0, indexWH2Sprites_Portraits, 0x0f },
    { L"Rasputin B 1/2",                    0x1084a0, 0x1084c0, indexWH2Sprites_Portraits, 0x17, &pairNext },
    { L"Rasputin B 2/2",                    0x1084c0, 0x1084e0, indexWH2Sprites_Portraits, 0x18 },
    { L"J. Carn A",                         0x1018a0, 0x1018e0, indexWH2Sprites_Portraits, 0x0c },
    { L"J. Carn B",                         0x1084e0, 0x108520, indexWH2Sprites_Portraits, 0x0c },
    { L"Geegus",                            0x1018e0, 0x101900, indexWH2Sprites_Portraits, 0x15 },
    { L"Dragon A 1/2",                      0x101920, 0x101940, indexWH2Sprites_Portraits, 0x05, &pairNext },
    { L"Dragon A 2/2",                      0x101b60, 0x101b80, indexWH2Sprites_Portraits, 0x06 },
    { L"Dragon B 1/2",                      0x108320, 0x108340, indexWH2Sprites_Portraits, 0x05, &pairNext },
    { L"Dragon B 2/2",                      0x108ea0, 0x108ec0, indexWH2Sprites_Portraits, 0x06 },
    { L"J. Max A",                          0x101960, 0x1019a0, indexWH2Sprites_Portraits, 0x11 },
    { L"J. Max B",                          0x108340, 0x108380, indexWH2Sprites_Portraits, 0x11 },
    { L"Captain Kidd A",                    0x1019a0, 0x1019e0, indexWH2Sprites_Portraits, 0x03 },
    { L"Captain Kidd B",                    0x108380, 0x1083c0, indexWH2Sprites_Portraits, 0x03 },
    
    { L"Brocken A 1/2",                     0x1019e0, 0x101a00, indexWH2Sprites_Portraits, 0x00, &pairNext4Palettes },
    { L"Brocken B 1/2",                     0x108520, 0x108540, indexWH2Sprites_Portraits, 0x02 },
    { L"Mudman A 1/2",                      0x101a20, 0x101a40, indexWH2Sprites_Portraits, 0x12 },
    { L"Mudman B 1/2",                      0x108540, 0x108560, indexWH2Sprites_Portraits, 0x13 },
    { L"Brocken and Mudman A 2/2",          0x101a00, 0x101a20, indexWH2Sprites_Portraits, 0x01 },
    { L"Muscle Power A",                    0x101a40, 0x101a80, indexWH2Sprites_Portraits, 0x14 },
    { L"Muscle Power B",                    0x108560, 0x1085a0, indexWH2Sprites_Portraits, 0x14 },
    { L"Ryoko A and Erick 1/2",             0x101aa0, 0x101ac0, indexWH2Sprites_Portraits, 0x1c, &pairNext3Palettes },
    { L"Ryoko A 2/2",                       0x101ac0, 0x101ae0, indexWH2Sprites_Portraits, 0x19 },
    { L"Erick A 2/2",                       0x101ae0, 0x101b00, indexWH2Sprites_Portraits, 0x07 },
    { L"Erick B 2/2",                       0x1083e0, 0x108400, indexWH2Sprites_Portraits, 0x08 },
    { L"Ryoko B 1/2",                       0x108440, 0x108460, indexWH2Sprites_Portraits, 0x1a, &pairNext },
    { L"Ryoko B 2/2",                       0x108400, 0x108420, indexWH2Sprites_Portraits, 0x1b },
    { L"Shura A 1/2",                       0x101b00, 0x101b20, indexWH2Sprites_Portraits, 0x1d, &pairNext },
    { L"Shura B 2/2",                       0x101b20, 0x101b40, indexWH2Sprites_Portraits, 0x1e },
    { L"Shura B 1/2",                       0x108300, 0x108320, indexWH2Sprites_Portraits, 0x1d, &pairNext },
    { L"Shura B 2/2",                       0x108be0, 0x108c00, indexWH2Sprites_Portraits, 0x1e },
};

const sGame_PaletteDataset WorldHeroes2_A_BonusPalettes_HUD[] =
{
    { L"Erick Portrait Extra, Text 1/2", 0x101000, 0x101020, indexWH2Sprites_Bonus, 0x00, &pairNext },
    { L"Text 2/2", 0x1011a0, 0x1011c0, indexWH2Sprites_Bonus, 0x01 },
