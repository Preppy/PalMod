...
const sGame_PaletteDataset MSH_A_BLACKHEART_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_CAPTAINAMERICA_PALETTES[] =
{
    {"Captain America P1", 0x61CEE, 0x61D0E, 0x0B },
    {"P1 Shield", 0x61D0E, 0x61D2E, 0x0B, 1 },
    {"Captain America P2", 0x61D6E, 0x61D8E, 0x0B },
    {"P2 Shield", 0x61D8E, 0x61DAE, 0x0B, 1 },
};

const sGame_PaletteDataset MSH_A_DRDOOM_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_HULK_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_IRONMAN_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_JUGGY_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_MAGNETO_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_PSYLOCKE_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_SPIDERMAN_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_THANOS_PALETTES[] =
{
...
const sGame_PaletteDataset MSH_A_WOLVERINE_PALETTES[] =
{
    {"Wolverine P1", 0x61F8E, 0x61FAE, 0x07 },
    {"P1 Claws", 0x61FAE, 0x61FCE, 0x07, 1 },
    {"P1 Berserker Barrage", 0x61FCE, 0x61FEE, 0x07, 2 },
    {"Wolverine P2", 0x6200E, 0x6202E, 0x07 },
...
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_BLACKHEART_PALETTES,      ARRAYSIZE(MSH_A_BLACKHEART_PALETTES) },
};

const sDescTreeNode MSH_A_CAPTAINAMERICA_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_CAPTAINAMERICA_PALETTES,  ARRAYSIZE(MSH_A_CAPTAINAMERICA_PALETTES) },
};

const sDescTreeNode MSH_A_DRDOOM_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_DRDOOM_PALETTES,          ARRAYSIZE(MSH_A_DRDOOM_PALETTES) },
};

const sDescTreeNode MSH_A_HULK_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_HULK_PALETTES,            ARRAYSIZE(MSH_A_HULK_PALETTES) },
};

const sDescTreeNode MSH_A_IRONMAN_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_IRONMAN_PALETTES,         ARRAYSIZE(MSH_A_IRONMAN_PALETTES) },
};

const sDescTreeNode MSH_A_JUGGY_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_JUGGY_PALETTES,           ARRAYSIZE(MSH_A_JUGGY_PALETTES) },
};

const sDescTreeNode MSH_A_MAGNETO_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_MAGNETO_PALETTES,         ARRAYSIZE(MSH_A_MAGNETO_PALETTES) },
};

const sDescTreeNode MSH_A_PSYLOCKE_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_PSYLOCKE_PALETTES,        ARRAYSIZE(MSH_A_PSYLOCKE_PALETTES) },
};

const sDescTreeNode MSH_A_SPIDERMAN_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_SPIDERMAN_PALETTES,       ARRAYSIZE(MSH_A_SPIDERMAN_PALETTES) },
};

const sDescTreeNode MSH_A_THANOS_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_THANOS_PALETTES,          ARRAYSIZE(MSH_A_THANOS_PALETTES) },
};

const sDescTreeNode MSH_A_WOLVERINE_COLLECTION[] =
{
    { "Palettes", DESC_NODETYPE_TREE, (void*)MSH_A_WOLVERINE_PALETTES,       ARRAYSIZE(MSH_A_WOLVERINE_PALETTES) },
};
