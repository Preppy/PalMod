...
#include "AvgrsGS_SNES_DIR_DEF.h"

class CGame_AvgrsGS_SNES_DIR : public CGameClassByDir
{
public:
    static sFileRule GetNextRule();
    static sFileRule GetRule(uint32_t nRuleId);

    CGame_AvgrsGS_SNES_DIR(uint32_t nConfirmedROMSize = -1);
    ~CGame_AvgrsGS_SNES_DIR();
