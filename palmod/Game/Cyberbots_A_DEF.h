...
{
    { L"P1 Blodia Top", 0x4Fb86, 0x4Fba6 },
    { L"P1 Blodia Legs", 0x50406, 0x50426 },
    { L"P1 Blodia Arm", 0x50C06, 0x50C26 },
    { L"P1 Blodia Weapon", 0x51b06, 0x51b26 },
    { L"P1 Blodia Shield", 0x513e6, 0x51406 },
};

const sGame_PaletteDataset Cyberbots_A_BLODIA_P2_PALETTES[] =
{
    { L"P2 Blodia Top", 0x4Fc06, 0x4Fc26 },
    { L"P2 Blodia Legs", 0x50486, 0x504a6 },
    { L"P2 Blodia Arm", 0x50c86, 0x50ca6 },
    { L"P2 Blodia Weapon", 0x51c86, 0x51ca6 },
    { L"P2 Blodia Shield", 0x51446, 0x51466 },
};

const sGame_PaletteDataset Cyberbots_A_BLODIA_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Blodia Top Underwater", 0x4fe86, 0x4fea6 },
    { L"P1 Blodia Legs Underwater", 0x50706, 0x50726 },
    { L"P1 Blodia Arm Underwater", 0x50f06, 0x50f26 },
    { L"P1 Blodia Weapon Underwater", 0x51e06, 0x51e26 },
    { L"P1 Blodia Shield Underwater", 0x51626, 0x51646 },
};

const sGame_PaletteDataset Cyberbots_A_BLODIA_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Blodia Top Underwater", 0x4ff06, 0x4ff26 },
    { L"P2 Blodia Legs Underwater", 0x50786, 0x507a6 },
    { L"P2 Blodia Arm Underwater", 0x50f86, 0x50fa6 },
    { L"P2 Blodia Weapon Underwater", 0x51f86, 0x51fa6 },
    { L"P2 Blodia Shield Underwater", 0x51686, 0x516a6 },
};

const sGame_PaletteDataset Cyberbots_A_BLODIA_PORTRAIT_PALETTES[] =
{
    { L"P1 Blodia Portrait", 0x553e4, 0x55424 },
    { L"P2 Blodia Portrait", 0x565e4, 0x56624 },
};
...
{
    { L"P1 Swordsman Top", 0x4FC86, 0x4FCA6 },
    { L"P1 Swordsman Treads", 0x50506, 0x50526 },
    { L"P1 Swordsman Arm", 0x50D06, 0x50D26 },
    { L"P1 Swordsman Weapon", 0x51B26, 0x51B46 },
    { L"P1 Swordsman Shield", 0x514a6, 0x514c6 },
    { L"P1 Swordsman Laser", 0x52446, 0x52466 },
};

const sGame_PaletteDataset Cyberbots_A_SWORDSMAN_P2_PALETTES[] =
{
    { L"P2 Swordsman Top", 0x4Fd06, 0x4Fd26 },
    { L"P2 Swordsman Treads", 0x50586, 0x505a6 },
    { L"P2 Swordsman Arm", 0x50d86, 0x50da6 },
    { L"P2 Swordsman Weapon", 0x51ca6, 0x51cc6 },
    { L"P2 Swordsman Shield", 0x51506, 0x51526 },
    { L"P2 Swordsman Laser", 0x524c6, 0x524e6 },
};

const sGame_PaletteDataset Cyberbots_A_SWORDSMAN_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Swordsman Top Underwater", 0x4ff86, 0x4ffa6 },
    { L"P1 Swordsman Treads Underwater", 0x50806, 0x50826 },
    { L"P1 Swordsman Arm Underwater", 0x51006, 0x51026 },
    { L"P1 Swordsman Weapon Underwater", 0x51e26, 0x51e46 },
    { L"P1 Swordsman Shield Underwater", 0x516e6, 0x51706 },
    { L"P1 Swordsman Laser Underwater", 0x52746, 0x52766 },
};

const sGame_PaletteDataset Cyberbots_A_SWORDSMAN_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Swordsman Top Underwater", 0x50006, 0x50026 },
    { L"P2 Swordsman Treads Underwater", 0x50886, 0x508a6 },
    { L"P2 Swordsman Arm Underwater", 0x51086, 0x510a6 },
    { L"P2 Swordsman Weapon Underwater", 0x51fa6, 0x51fc6 },
    { L"P2 Swordsman Shield Underwater", 0x51746, 0x51766 },
    { L"P2 Swordsman Laser Underwater", 0x527c6, 0x527e6 },
};

const sGame_PaletteDataset Cyberbots_A_SWORDSMAN_PORTRAIT_PALETTES[] =
{
    { L"P1 Swordsman Portrait", 0x555e4, 0x55644 },
    { L"P2 Swordsman Portrait", 0x567e4, 0x56844 },
};
...
{
    { L"P1 Riot Top", 0x4Fd86, 0x4Fda6 },
    { L"P1 Riot Jets", 0x50606, 0x50626 },
    { L"P1 Riot Arm", 0x50e06, 0x50e26 },
    { L"P1 Riot Weapon", 0x51b46, 0x51b66 },
    { L"P1 Riot Shield", 0x51566, 0x51586 },
    { L"P1 Riot Jet Effects", 0x51a06, 0x51a26 },
};

const sGame_PaletteDataset Cyberbots_A_RIOT_P2_PALETTES[] =
{
    { L"P2 Riot Top", 0x4Fe06, 0x4Fe26 },
    { L"P2 Riot Jets", 0x50686, 0x506a6 },
    { L"P2 Riot Arm", 0x50e86, 0x50ea6 },
    { L"P2 Riot Weapon", 0x51cc6, 0x51ce6 },
    { L"P2 Riot Shield", 0x515c6, 0x515e6 },
    { L"P2 Riot Jet Effects", 0x51a26, 0x51a46 },
};

const sGame_PaletteDataset Cyberbots_A_RIOT_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Riot Top Underwater", 0x50086, 0x500a6 },
    { L"P1 Riot Jets Underwater", 0x50906, 0x50926 },
    { L"P1 Riot Arm Underwater", 0x51106, 0x51126 },
    { L"P1 Riot Weapon Underwater", 0x51e46, 0x51e66 },
    { L"P1 Riot Shield Underwater", 0x517a6, 0x517c6 },
    { L"P1 Riot Jet Effects Underwater", 0x51ac6, 0x51ae6 },
};

const sGame_PaletteDataset Cyberbots_A_RIOT_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Riot Top Underwater", 0x50106, 0x50126 },
    { L"P2 Riot Jets Underwater", 0x50986, 0x509a6 },
    { L"P2 Riot Arm Underwater", 0x51186, 0x511a6 },
    { L"P2 Riot Weapon Underwater", 0x51fc6, 0x51fe6 },
    { L"P2 Riot Shield Underwater", 0x51806, 0x51826 },
    { L"P2 Riot Jet Effects Underwater", 0x51ae6, 0x51b06 },
};

const sGame_PaletteDataset Cyberbots_A_RIOT_PORTRAIT_PALETTES[] =
{
    { L"P1 Riot Portrait", 0x55864, 0x558c4 },
    { L"P2 Riot Portrait", 0x56a64, 0x56ac4 },
};
...
{
    { L"P1 Reptos Top", 0x4Fb46, 0x4Fb66 },
    { L"P1 Reptos Legs", 0x503c6, 0x503e6 },
    { L"P1 Reptos Arm", 0x50bc6, 0x50be6 },
    { L"P1 Reptos Weapon", 0x51b66, 0x51b86 },
    { L"P1 Reptos Shield", 0x513c6, 0x513e6 },
};

const sGame_PaletteDataset Cyberbots_A_REPTOS_P2_PALETTES[] =
{
    { L"P2 Reptos Top", 0x4Fbc6, 0x4Fbe6 },
    { L"P2 Reptos Legs", 0x50446, 0x50466 },
    { L"P2 Reptos Arm", 0x50c46, 0x50c66 },
    { L"P2 Reptos Weapon", 0x51ce6, 0x51d06 },
    { L"P2 Reptos Shield", 0x51426, 0x51446 },
};

const sGame_PaletteDataset Cyberbots_A_REPTOS_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Reptos Top Underwater", 0x4fe46, 0x4fe66 },
    { L"P1 Reptos Legs Underwater", 0x506c6, 0x506e6 },
    { L"P1 Reptos Arm Underwater", 0x50ec6, 0x50ee6 },
    { L"P1 Reptos Weapon Underwater", 0x51e66, 0x51e86 },
    { L"P1 Reptos Shield Underwater", 0x51606, 0x51626 },
};

const sGame_PaletteDataset Cyberbots_A_REPTOS_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Reptos Top Underwater", 0x4fec6, 0x4fee6 },
    { L"P2 Reptos Legs Underwater", 0x50746, 0x50766 },
    { L"P2 Reptos Arm Underwater", 0x50f46, 0x50f66 },
    { L"P2 Reptos Weapon Underwater", 0x51fe6, 0x52006 },
    { L"P2 Reptos Shield Underwater", 0x51666, 0x51686 },
};

const sGame_PaletteDataset Cyberbots_A_REPTOS_PORTRAIT_PALETTES[] =
{
    { L"P1 Reptos Portrait", 0x55464, 0x554a4 },
    { L"P2 Reptos Portrait", 0x56664, 0x566a4 },
};
...
{
    { L"P1 Lightning Top", 0x4Fc46, 0x4Fc66 },
    { L"P1 Lightning Treads", 0x504c6, 0x504e6 },
    { L"P1 Lightning Arm", 0x50cc6, 0x50ce6 },
    { L"P1 Lightning Weapon", 0x51b86, 0x51ba6 },
    { L"P1 Lightning Shield", 0x51486, 0x514a6 },
    { L"P1 Lightning Electricity", 0x52406, 0x52426 },
};

const sGame_PaletteDataset Cyberbots_A_LIGHTNING_P2_PALETTES[] =
{
    { L"P2 Lightning Top", 0x4Fcc6, 0x4Fce6 },
    { L"P2 Lightning Treads", 0x50546, 0x50566 },
    { L"P2 Lightning Arm", 0x50d46, 0x50d66 },
    { L"P2 Lightning Weapon", 0x51d06, 0x51d26 },
    { L"P2 Lightning Shield", 0x514e6, 0x51506 },
    { L"P2 Lightning Electricity", 0x52486, 0x524a6 },
};

const sGame_PaletteDataset Cyberbots_A_LIGHTNING_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Lightning Top Underwater", 0x4ff46, 0x4ff66 },
    { L"P1 Lightning Treads Underwater", 0x507c6, 0x507e6 },
    { L"P1 Lightning Arm Underwater", 0x50fc6, 0x50fe6 },
    { L"P1 Lightning Weapon Underwater", 0x51e86, 0x51ea6 },
    { L"P1 Lightning Shield Underwater", 0x516c6, 0x516e6 },
...
{
    { L"P2 Lightning Top Underwater", 0x4ffc6, 0x4ffe6 },
    { L"P2 Lightning Treads Underwater", 0x50846, 0x50866 },
    { L"P2 Lightning Arm Underwater", 0x51046, 0x51066 },
    { L"P2 Lightning Weapon Underwater", 0x52006, 0x52026 },
    { L"P2 Lightning Shield Underwater", 0x51726, 0x51746 },
    { L"P2 Lightning Electricity Underwater", 0x52786, 0x527a6 },
};

const sGame_PaletteDataset Cyberbots_A_LIGHTNING_PORTRAIT_PALETTES[] =
{
    { L"P1 Lightning Portrait", 0x55664, 0x556e4 },
    { L"P2 Lightning Portrait", 0x56864, 0x568e4 },
};
...
{
    { L"P1 Jackal Top", 0x4Fd46, 0x4Fd66 },
    { L"P1 Jackal Legs", 0x505c6, 0x505e6 },
    { L"P1 Jackal Arm", 0x50dc6, 0x50de6 },
    { L"P1 Jackal Weapon", 0x51ba6, 0x51bc6 },
    { L"P1 Jackal Shield", 0x51546, 0x51566 },
};

const sGame_PaletteDataset Cyberbots_A_JACKAL_P2_PALETTES[] =
{
    { L"P2 Jackal Top", 0x4Fdc6, 0x4Fde6 },
    { L"P2 Jackal Legs", 0x50646, 0x50666 },
    { L"P2 Jackal Arm", 0x50e46, 0x50e66 },
    { L"P2 Jackal Weapon", 0x51d26, 0x51d46 },
    { L"P2 Jackal Shield", 0x515a6, 0x515c6 },
};

const sGame_PaletteDataset Cyberbots_A_JACKAL_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Jackal Top Underwater", 0x50046, 0x50066 },
    { L"P1 Jackal Legs Underwater", 0x508c6, 0x508e6 },
    { L"P1 Jackal Arm Underwater", 0x510c6, 0x510e6 },
    { L"P1 Jackal Weapon Underwater", 0x51ea6, 0x51ec6 },
    { L"P1 Jackal Shield Underwater", 0x51786, 0x517a6 },
};

const sGame_PaletteDataset Cyberbots_A_JACKAL_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Jackal Top Underwater", 0x500c6, 0x500e6 },
    { L"P2 Jackal Legs Underwater", 0x50946, 0x50966 },
    { L"P2 Jackal Arm Underwater", 0x51146, 0x51166 },
    { L"P2 Jackal Weapon Underwater", 0x52026, 0x52046 },
    { L"P2 Jackal Shield Underwater", 0x517e6, 0x51806 },
};

const sGame_PaletteDataset Cyberbots_A_JACKAL_PORTRAIT_PALETTES[] =
{
    { L"P1 Jackal Portrait", 0x556e4, 0x55724 },
    { L"P2 Jackal Portrait", 0x568e4, 0x56924 },
};
...
{
    { L"P1 Fordy Top", 0x4FBA6, 0x4Fbc6 },
    { L"P1 Fordy Legs", 0x50426, 0x50446 },
    { L"P1 Fordy Arm", 0x50c26, 0x50c46 },
    { L"P1 Fordy Weapon", 0x51c26, 0x51c46 },
    { L"P1 Fordy Shield", 0x51406, 0x51426 },
};

const sGame_PaletteDataset Cyberbots_A_FORDY_P2_PALETTES[] =
{
    { L"P2 Fordy Top", 0x4Fc26, 0x4Fc46 },
    { L"P2 Fordy Legs", 0x504a6, 0x504c6 },
    { L"P2 Fordy Arm", 0x50ca6, 0x50cc6 },
    { L"P2 Fordy Weapon", 0x51da6, 0x51dc6 },
    { L"P2 Fordy Shield", 0x51466, 0x51486 },
};

const sGame_PaletteDataset Cyberbots_A_FORDY_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Fordy Top Underwater", 0x4fea6, 0x4fec6 },
    { L"P1 Fordy Legs Underwater", 0x50726, 0x50746 },
    { L"P1 Fordy Arm Underwater", 0x50f26, 0x50f46 },
    { L"P1 Fordy Weapon Underwater", 0x51f26, 0x51f46 },
    { L"P1 Fordy Shield Underwater", 0x51646, 0x51666 },
};

const sGame_PaletteDataset Cyberbots_A_FORDY_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Fordy Top Underwater", 0x4ff26, 0x4ff46 },
    { L"P2 Fordy Legs Underwater", 0x507a6, 0x507c6 },
    { L"P2 Fordy Arm Underwater", 0x50fa6, 0x50fc6 },
    { L"P2 Fordy Weapon Underwater", 0x520a6, 0x520c6 },
    { L"P2 Fordy Shield Underwater", 0x516a6, 0x516c6 },
};

const sGame_PaletteDataset Cyberbots_A_FORDY_PORTRAIT_PALETTES[] =
{
    { L"P1 Fordy Portrait", 0x554e4, 0x55564 },
    { L"P2 Fordy Portrait", 0x566e4, 0x56764 },
};
...
{
    { L"P1 Tarantula Top", 0x4FCA6, 0x4FCC6 },
    { L"P1 Tarantula Legs", 0x50526, 0x50546 },
    { L"P1 Tarantula Arm", 0x50d26, 0x50d46 },
    { L"P1 Tarantula Weapon", 0x51c46, 0x51c66 },
    { L"P1 Tarantula Shield", 0x514c6, 0x514e6 },
};

const sGame_PaletteDataset Cyberbots_A_TARANTULA_P2_PALETTES[] =
{
    { L"P2 Tarantula Top", 0x4Fd26, 0x4Fd46 },
    { L"P2 Tarantula Legs", 0x505a6, 0x505c6 },
    { L"P2 Tarantula Arm", 0x50da6, 0x50dc6 },
    { L"P2 Tarantula Weapon", 0x51dc6, 0x51de6 },
    { L"P2 Tarantula Shield", 0x51526, 0x51546 },
};

const sGame_PaletteDataset Cyberbots_A_TARANTULA_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Tarantula Top Underwater", 0x4ffa6, 0x4ffc6 },
    { L"P1 Tarantula Legs Underwater", 0x50826, 0x50846 },
    { L"P1 Tarantula Arm Underwater", 0x51026, 0x51046 },
    { L"P1 Tarantula Weapon Underwater", 0x51f46, 0x51f66 },
    { L"P1 Tarantula Shield Underwater", 0x51706, 0x51726 },
};

const sGame_PaletteDataset Cyberbots_A_TARANTULA_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Tarantula Top Underwater", 0x50026, 0x50046 },
    { L"P2 Tarantula Legs Underwater", 0x508a6, 0x508c6 },
    { L"P2 Tarantula Arm Underwater", 0x510a6, 0x510c6 },
    { L"P2 Tarantula Weapon Underwater", 0x520c6, 0x520e6 },
    { L"P2 Tarantula Shield Underwater", 0x51766, 0x51786 },
};

const sGame_PaletteDataset Cyberbots_A_TARANTULA_PORTRAIT_PALETTES[] =
{
    { L"P1 Tarantula Portrait", 0x558e4, 0x55964 },
    { L"P2 Tarantula Portrait", 0x56ae4, 0x56b64 },
};
...
{
    { L"P1 Killer Bee Top", 0x4FDA6, 0x4FDC6 },
    { L"P1 Killer Bee Jets", 0x50626, 0x50646 },
    { L"P1 Killer Bee Arm", 0x50e26, 0x50e46 },
    { L"P1 Killer Bee Weapon", 0x51c66, 0x51c86 },
    { L"P1 Killer Bee Shield", 0x51586, 0x515a6 },
    { L"P1 Killer Bee Laser", 0x52566, 0x52586 },
};

const sGame_PaletteDataset Cyberbots_A_KILLERBEE_P2_PALETTES[] =
{
    { L"P2 Killer Bee Top", 0x4Fe26, 0x4Fe46 },
    { L"P2 Killer Bee Jets", 0x506a6, 0x506c6 },
    { L"P2 Killer Bee Arm", 0x50ea6, 0x50ec6 },
    { L"P2 Killer Bee Weapon", 0x51de6, 0x51e06 },
    { L"P2 Killer Bee Shield", 0x515e6, 0x51606 },
    { L"P2 Killer Bee Laser", 0x525e6, 0x52606 },
};

const sGame_PaletteDataset Cyberbots_A_KILLERBEE_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Killer Bee Top Underwater", 0x500a6, 0x500c6 },
    { L"P1 Killer Bee Jets Underwater", 0x50926, 0x50946 },
    { L"P1 Killer Bee Arm Underwater", 0x51126, 0x51146 },
    { L"P1 Killer Bee Weapon Underwater", 0x51f66, 0x51f86 },
    { L"P1 Killer Bee Shield Underwater", 0x517c6, 0x517e6 },
    { L"P1 Killer Bee Laser Underwater", 0x52866, 0x52886 },
};

const sGame_PaletteDataset Cyberbots_A_KILLERBEE_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Killer Bee Top Underwater", 0x50126, 0x50146 },
    { L"P2 Killer Bee Jets Underwater", 0x509a6, 0x509c6 },
    { L"P2 Killer Bee Arm Underwater", 0x511a6, 0x511c6 },
    { L"P2 Killer Bee Weapon Underwater", 0x520e6, 0x52106 },
    { L"P2 Killer Bee Shield Underwater", 0x51826, 0x51846 },
    { L"P2 Killer Bee Laser Underwater", 0x528e6, 0x52906 },
};

const sGame_PaletteDataset Cyberbots_A_KILLERBEE_PORTRAIT_PALETTES[] =
{
    { L"P1 Killer Bee Portrait", 0X55b64, 0X55be4 },
    { L"P2 Killer Bee Portrait", 0X56d64, 0X56de4 },
};
...
{
    { L"P1 Guldin Top", 0x4Fb66, 0x4FB86 },
    { L"P1 Guldin Treads", 0x503e6, 0x50406 },
    { L"P1 Guldin Arm", 0x50be6, 0x50c06 },
    { L"P1 Guldin Weapon", 0x51bc6, 0x51be6 },
};

const sGame_PaletteDataset Cyberbots_A_GULDIN_P2_PALETTES[] =
{
    { L"P2 Guldin Top", 0x4Fbe6, 0x4Fc06 },
    { L"P2 Guldin Treads", 0x50466, 0x50486 },
    { L"P2 Guldin Arm", 0x50c66, 0x50c86 },
    { L"P2 Guldin Weapon", 0x51d46, 0x51d66 },
};

const sGame_PaletteDataset Cyberbots_A_GULDIN_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Guldin Top Underwater", 0x4fe66, 0x4fe86 },
    { L"P1 Guldin Treads Underwater", 0x506e6, 0x50706 },
    { L"P1 Guldin Arm Underwater", 0x50ee6, 0x50f06 },
    { L"P1 Guldin Weapon Underwater", 0x51ec6, 0x51ee6 },
};

const sGame_PaletteDataset Cyberbots_A_GULDIN_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Guldin Top Underwater", 0x4fee6, 0x4ff06 },
    { L"P2 Guldin Treads Underwater", 0x50766, 0x50786 },
    { L"P2 Guldin Arm Underwater", 0x50f66, 0x50f86 },
    { L"P2 Guldin Weapon Underwater", 0x52046, 0x52066 },
};

const sGame_PaletteDataset Cyberbots_A_GULDIN_PORTRAIT_PALETTES[] =
{
    { L"P1 Guldin Portrait", 0x55564, 0x555e4 },
    { L"P2 Guldin Portrait", 0x56764, 0x567e4 },
};
...
{
    { L"P1 Vise Top", 0x4Fc66, 0x4Fc86 },
    { L"P1 Vise Treads", 0x504e6, 0x50506 },
    { L"P1 Vise Arm", 0x50ce6, 0x50d06 },
    { L"P1 Vise Weapon", 0x51be6, 0x51c06 },
};

const sGame_PaletteDataset Cyberbots_A_VISE_P2_PALETTES[] =
{
    { L"P2 Vise Top", 0x4Fce6, 0x4Fd06 },
    { L"P2 Vise Treads", 0x50566, 0x50586 },
    { L"P2 Vise Arm", 0x50d66, 0x50d86 },
    { L"P2 Vise Weapon", 0x51d66, 0x51d86 },
};

const sGame_PaletteDataset Cyberbots_A_VISE_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Vise Top Underwater", 0x4ff66, 0x4ff86 },
    { L"P1 Vise Treads Underwater", 0x507e6, 0x50806 },
    { L"P1 Vise Arm Underwater", 0x50fe6, 0x51006 },
    { L"P1 Vise Weapon Underwater", 0x51ee6, 0x51f06 },
};

const sGame_PaletteDataset Cyberbots_A_VISE_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Vise Top Underwater", 0x4ffe6, 0x50006 },
    { L"P2 Vise Treads Underwater", 0x50866, 0x50886 },
    { L"P2 Vise Arm Underwater", 0x51066, 0x51086 },
    { L"P2 Vise Weapon Underwater", 0x52066, 0x52086 },
};

const sGame_PaletteDataset Cyberbots_A_VISE_PORTRAIT_PALETTES[] =
{
    { L"P1 Vise Portrait", 0x55764, 0x557e4 },
    { L"P2 Vise Portrait", 0x56964, 0x569e4 },
};
...
{
    { L"P1 Cyclone Top", 0x4Fd66, 0x4Fd86 },
    { L"P1 Cyclone Legs", 0x505e6, 0x50606 },
    { L"P1 Cyclone Arm", 0x50de6, 0x50e06 },
    { L"P1 Cyclone Weapon", 0x51c06, 0x51c26 },
};

const sGame_PaletteDataset Cyberbots_A_CYCLONE_P2_PALETTES[] =
{
    { L"P2 Cyclone Top", 0x4Fde6, 0x4Fe06 },
    { L"P2 Cyclone Legs", 0x50666, 0x50686 },
    { L"P2 Cyclone Arm", 0x50e66, 0x50e86 },
    { L"P2 Cyclone Weapon", 0x51d86, 0x51da6 },
};

const sGame_PaletteDataset Cyberbots_A_CYCLONE_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Cyclone Top Underwater", 0x50066, 0x50086 },
    { L"P1 Cyclone Legs Underwater", 0x508e6, 0x50906 },
    { L"P1 Cyclone Arm Underwater", 0x510e6, 0x51106 },
    { L"P1 Cyclone Weapon Underwater", 0x51f06, 0x51f26 },
};

const sGame_PaletteDataset Cyberbots_A_CYCLONE_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Cyclone Top Underwater", 0x500e6, 0x50106 },
    { L"P2 Cyclone Legs Underwater", 0x50966, 0x50986 },
    { L"P2 Cyclone Arm Underwater", 0x51166, 0x51186 },
    { L"P2 Cyclone Weapon Underwater", 0x52086, 0x520a6 },
};

//Shared--
const sGame_PaletteDataset Cyberbots_A_CYCLONE_SHARED_PALETTES[] =
{
    { L"Cyclone Drill", 0x51906, 0x51926 },
};

const sGame_PaletteDataset Cyberbots_A_CYCLONE_PORTRAIT_PALETTES[] =
{
    { L"P1 Cyclone Portrait", 0x557e4, 0x55824 },
    { L"P2 Cyclone Portrait", 0x569e4, 0x56a24 },
};
...
{
    { L"P1 Gaits", 0x502c6, 0x502e6 },
    { L"P1 Gaits Shield", 0x51946, 0x51966 },
    { L"P1 Gaits Teleport", 0x50a66, 0x50a86 },
    { L"P1 Gaits Dash Attack", 0x51266, 0x51286 },
    { L"P1 Gaits Rising Uppercut", 0x521a6, 0x521c6 },
    { L"P1 Gaits Electricity", 0x52986, 0x529a6 },
};

const sGame_PaletteDataset Cyberbots_A_GAITS_P2_PALETTES[] =
{
    { L"P2 Gaits", 0x50186, 0x501a6 },
    { L"P2 Gaits Shield", 0x51846, 0x51866 },
    { L"P2 Gaits Teleport", 0x509e6, 0x50a06 },
    { L"P2 Gaits Dash Attack", 0x511e6, 0x51206 },
    { L"P2 Gaits Rising Uppercut", 0x52126, 0x52146 },
    { L"P2 Gaits Electricity", 0x52926, 0x52946 },
};

const sGame_PaletteDataset Cyberbots_A_GAITS_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Gaits Underwater", 0x50366, 0x50386 },
    { L"P1 Gaits Shield Underwater", 0x51966, 0x51986 },
    { L"P1 Gaits Teleport Underwater", 0x50b66, 0x50b86 },
    { L"P1 Gaits Dash Attack Underwater", 0x51366, 0x51386 },
    { L"P1 Gaits Rising Uppercut Underwater", 0x522a6, 0x522c6 },
    { L"P1 Gaits Electricity Underwater", 0x52a46, 0x52a66 },
};

const sGame_PaletteDataset Cyberbots_A_GAITS_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Gaits Underwater", 0x50226, 0x50246 },
    { L"P2 Gaits Shield Underwater", 0x51866, 0x51886 },
    { L"P2 Gaits Teleport Underwater", 0x50ae6, 0x50b06 },
    { L"P2 Gaits Dash Attack Underwater", 0x512e6, 0x51306 },
    { L"P2 Gaits Rising Uppercut Underwater", 0x52226, 0x52246 },
    { L"P2 Gaits Electricity Underwater", 0x529e6, 0x52a06 },
};

const sGame_PaletteDataset Cyberbots_A_GAITS_PORTRAIT_PALETTES[] =
{
    { L"P1 Gaits Portrait", 0x55a64, 0x55aa4 },
    { L"P2 Gaits Portrait", 0x56c64, 0x56ca4 },
};
...
{
    { L"P1 Super-8", 0x502e6, 0x50306 },
    { L"P1 Super-8 Weapon", 0x50a86, 0x50aa6 },
    { L"P1 Super-8 Rocket", 0x51286, 0x512a6 },
    { L"P1 Super-8 Magnet", 0x521c6, 0x521e6 },
    { L"P1 Super-8 Laser", 0x529a6, 0x529c6 },
};

const sGame_PaletteDataset Cyberbots_A_SUPER8_P2_PALETTES[] =
{
    { L"P2 Super-8", 0x501a6, 0x501c6 },
    { L"P2 Super-8 Weapon", 0x50a06, 0x50a26 },
    { L"P2 Super-8 Rocket", 0x51206, 0x51226 },
    { L"P2 Super-8 Magnet", 0x52146, 0x52166 },
    { L"P2 Super-8 Laser", 0x52946, 0x52966 },
};

const sGame_PaletteDataset Cyberbots_A_SUPER8_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Super-8 Underwater", 0x50386, 0x503a6 },
    { L"P1 Super-8 Weapon Underwater", 0x50b86, 0x50ba6 },
    { L"P1 Super-8 Rocket Underwater", 0x51386, 0x513a6 },
    { L"P1 Super-8 Magnet Underwater", 0x522c6, 0x522e6 },
    { L"P1 Super-8 Laser Underwater", 0x52a66, 0x52a86 },
};

const sGame_PaletteDataset Cyberbots_A_SUPER8_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Super-8 Underwater", 0x50246, 0x50266 },
    { L"P2 Super-8 Weapon Underwater", 0x50b06, 0x50b26 },
    { L"P2 Super-8 Rocket Underwater", 0x51306, 0x51326 },
    { L"P2 Super-8 Magnet Underwater", 0x52246, 0x52266 },
    { L"P2 Super-8 Laser Underwater", 0x52a06, 0x52a26 },
};

const sGame_PaletteDataset Cyberbots_A_SUPER8_PORTRAIT_PALETTES[] =
{
    { L"P1 Super-8 Portrait", 0x55a04, 0x55a44 },
    { L"P2 Super-8 Portrait", 0x56c04, 0x56c44 },
};
...
{
    { L"P1 Helion", 0x50286, 0x502a6 },
    { L"P1 Helion Effects", 0x50a46, 0x50a66 },
    { L"P1 Helion Laser", 0x51246, 0x51266 },
    { L"P1 Helion Bombs", 0x52186, 0x521a6 },
};

const sGame_PaletteDataset Cyberbots_A_HELION_P2_PALETTES[] =
{
    { L"P2 Helion", 0x50146, 0x50166 },
    { L"P2 Helion Effects", 0x509c6, 0x509e6 },
    { L"P2 Helion Laser", 0x511c6, 0x511e6 },
    { L"P2 Helion Bombs", 0x52106, 0x52126 },
};

const sGame_PaletteDataset Cyberbots_A_HELION_P1_UNDERWATER_PALETTES[] =
{
    { L"P1 Helion Underwater", 0x50326, 0x50346 },
    { L"P1 Helion Effects Underwater", 0x50b46, 0x50b66 },
    { L"P1 Helion Laser Underwater", 0x51346, 0x51366 },
    { L"P1 Helion Bombs Underwater", 0x52286, 0x522a6 },
};

const sGame_PaletteDataset Cyberbots_A_HELION_P2_UNDERWATER_PALETTES[] =
{
    { L"P2 Helion Underwater", 0x501e6, 0x50206 },
    { L"P2 Helion Effects Underwater", 0x50ac6, 0x50ae6 },
    { L"P2 Helion Laser Underwater", 0x512c6, 0x512e6 },
    { L"P2 Helion Bombs Underwater", 0x52206, 0x52226 },
};

const sGame_PaletteDataset Cyberbots_A_HELION_SHARED_PALETTES[] =
{
    {L"Helion Laser", 0x51886, 0x518a6 },
    { L"Helion Laser Underwater", 0x518a6, 0x518c6 },
};

const sGame_PaletteDataset Cyberbots_A_HELION_PORTRAIT_PALETTES[] =
{
    { L"P1 Helion Portrait", 0x55964, 0x559a4 },
    { L"P2 Helion Portrait", 0x56b64, 0x56ba4 },
};
...
const sGame_PaletteDataset Cyberbots_A_PILOTS_BAOMAO_PALETTES[] =
{
    ...
    { L"Bao & Mao VS/Cutscenes (1/2)", 0x54bc4, 0x54c24 },
    { L"Bao & Mao VS/Cutscenes (2/2)", 0x54e04, 0x54e64 },
...
const sGame_PaletteDataset Cyberbots_A_PILOTS_ARIETA_PALETTES[] =
{
    ...
    { L"Arieta VS/Cutscenes", 0x54b04, 0x54b64 },
    { L"Arieta HUD", 0x54f44, 0x54f64 },
};
...
const sGame_PaletteDataset Cyberbots_A_PILOTS_EXTRA_PALETTES[] =
{
    ...
    { L"Shared BG (BaoMao/Mary)", 0x54e84, 0x54ea4 },
};
