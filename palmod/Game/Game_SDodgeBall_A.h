...
constexpr auto EXTRA_FILENAME_SDODGEBALL_A = _T("SDODGEBALLE.txt");
...
private:
    ...
    static int rgExtraCountAll[SDODGEBALL_A_NUMUNIT + 1];
    static int rgExtraLoc[SDODGEBALL_A_NUMUNIT + 1];
