...
sDescTreeNode* CGame_SSF2T_A::InitDescTree(int nROMPaletteSetToUse)
{
    ...
    for (UINT16 iUnitCtr = 0; iUnitCtr < nUnitCt; iUnitCtr++)
    {
        ...
        if (iUnitCtr != nCurrentExtraLocation)
        {
            ...
            {
            case 3:
                _stprintf(UnitNode->szDesc, _T("%s"), SSF2T_A_UNITS_3C[iUnitCtr].szDesc);
                break;
            case 4:
            default:
                _stprintf(UnitNode->szDesc, _T("%s"), SSF2T_A_UNITS_4A[iUnitCtr].szDesc);
                break;
            case 8:
                _stprintf(UnitNode->szDesc, _T("%s"), SSF2T_A_UNITS_8[iUnitCtr].szDesc);
                break;
            }
...
sFileRule CGame_SSF2T_A::GetRule(UINT16 nUnitId)
{
    ...
    {
    case 3:
        _stprintf_s(NewFileRule.szFileName, MAX_FILENAME_LENGTH, _T("sfxe.03c"));
        break;
    case 4:
    default:
        _stprintf_s(NewFileRule.szFileName, MAX_FILENAME_LENGTH, _T("sfxe.04a"));
        break;
    case 8:
        _stprintf_s(NewFileRule.szFileName, MAX_FILENAME_LENGTH, _T("sfxe.08"));
        break;
    }
