...
void CGame_SSF2T_A::SetSpecialRuleForFileName(std::wstring strFileName)
{
    ...
    const std::map<std::wstring, SSF2TLoadingKey> m_rgFileNameToVersion =
    {
        ...
        { L"sfnl.04", SSF2TLoadingKey::ROM04nl },
        { L"sfnl.08", SSF2TLoadingKey::ROM08nl },
        ...
        { L"sfxj.03d", SSF2TLoadingKey::ROM03 },
        { L"sfxj.04a", SSF2TLoadingKey::ROM04 },
        { L"sfxj.08", SSF2TLoadingKey::ROM08 },
        { L"sfxo.03c", SSF2TLoadingKey::ROM03 },
        { L"sfxo.04a", SSF2TLoadingKey::ROM04 },
        { L"sfxo.08", SSF2TLoadingKey::ROM08 },
...
CGame_SSF2T_A::CGame_SSF2T_A(uint32_t nConfirmedROMSize)
{
    ...
    case SSF2TLoadingKey::ROM04:
        ...
        break;
    case SSF2TLoadingKey::ROM04nl:
        InitializeGame(nConfirmedROMSize, m_sCoreGameData_ROM04nl);
        break;
    case SSF2TLoadingKey::ROM08:
        InitializeGame(nConfirmedROMSize, m_sCoreGameData_ROM08);
        break;
    case SSF2TLoadingKey::ROM08nl:
        InitializeGame(nConfirmedROMSize, m_sCoreGameData_ROM08nl);
        break;
