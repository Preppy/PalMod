...
{
private:
    static UINT32 m_nTotalPaletteCountForDBZHD;

    static size_t rgExtraCountAll[DBZHD_SNES_NUMUNIT + 1];
    static size_t rgExtraLoc[DBZHD_SNES_NUMUNIT + 1];
...
public:
    CGame_DBZHD_SNES(UINT32 nConfirmedROMSize);
    ~CGame_DBZHD_SNES(void);
