...
BEGIN_MESSAGE_MAP(CPalModDlg, CDialog)
    ...
    ON_WM_GETMINMAXINFO()
    ON_COMMAND(ID_LDJOJOS50, &CPalModDlg::OnLoadDir_Jojos50)
    ON_COMMAND(ID_LDJOJOS51, &CPalModDlg::OnLoadDir_Jojos51)
    ON_COMMAND(ID_LDMVC2ARCADE, &CPalModDlg::OnLoadDir_MVC2ArcadeAll)
    ON_COMMAND(ID_LDMVC2DCUSA, &CPalModDlg::OnLoadDir_MVC2DCUSA)
    ON_COMMAND(ID_LDMVC2PS2USA, &CPalModDlg::OnLoadDir_MVC2PS2USA)
    ON_COMMAND(ID_LDSFIII3DCALL, &CPalModDlg::OnLoadDir_SFIII3DCAll)
    ON_COMMAND(ID_LDSFIII3ARCADEALL, &CPalModDlg::OnLoadDir_SFIII3ArcadeAll)
END_MESSAGE_MAP()
